    ...
    implements com.actionbarsherlock.view.mClickListener
{
    ...
    {
        if (getDisplayedScreen() != ansitScreen.ABOUT_SCREEN)
        {
            TransitActivity.access$5(TransitActivity.this, new AboutScreen(), ansitScreen.ABOUT_SCREEN, true);
            return true;
        } else
        {
            return false;
