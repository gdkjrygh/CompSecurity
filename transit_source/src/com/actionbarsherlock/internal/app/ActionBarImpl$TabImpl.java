...
public class mPosition extends com.actionbarsherlock.app..TabImpl
{
    ...
    {
        return setContentDescription(ActionBarImpl.access$7(ActionBarImpl.this).getResources().getText(i));
    }
    ...
    public com.actionbarsherlock.app..TabImpl setContentDescription(CharSequence charsequence)
    {
        ...
        if (mPosition >= 0)
        {
            ActionBarImpl.access$8(ActionBarImpl.this).updateTab(mPosition);
        }
        return this;
    }
    ...
    {
        return setIcon(ActionBarImpl.access$7(ActionBarImpl.this).getResources().getDrawable(i));
    }
    ...
    {
        return setText(ActionBarImpl.access$7(ActionBarImpl.this).getResources().getText(i));
    }
