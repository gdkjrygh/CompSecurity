    ...
    implements SafeParcelable
{
    ...
    {
        dm.a(latlng, "null camera target");
        boolean flag;
        if (0.0F <= f1 && f1 <= 90F)
        {
            flag = true;
        ...
        dm.b(flag, "Tilt needs to be between 0 and 90 inclusive");
        iM = i;
        target = latlng;
        zoom = f;
        tilt = f1 + 0.0F;
    ...
    {
        return dl.d(this).a("target", target).a("zoom", Float.valueOf(zoom)).a("tilt", Float.valueOf(tilt)).a("bearing", Float.valueOf(bearing)).toString();
    }
