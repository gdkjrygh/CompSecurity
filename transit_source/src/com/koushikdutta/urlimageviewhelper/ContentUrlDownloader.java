...
public class ContentUrlDownloader
    implements UrlDownloader
{

    public ContentUrlDownloader()
    {
    }
    ...
    public void download(final Context context, final String url, String s, final UrlDownloader.UrlDownloaderCallback callback, final Runnable completion)
    {
        UrlImageViewHelper.executeTask(new AsyncTask() {
            ...
            protected transient Void doInBackground(Void avoid[])
            {
                try
                {
                    avoid = context.getContentResolver().openInputStream(Uri.parse(url));
                    callback.onDownloadComplete(ContentUrlDownloader.this, avoid, null);
                }
            ...
            {
                this$0 = ContentUrlDownloader.this;
                context = context1;
                url = s;
