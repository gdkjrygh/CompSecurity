...
# virtual methods
.method public dX()Ljava/util/ArrayList;
    .locals 1
...
.method public dZ()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public ea()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/fv;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/fv$c;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/fv;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/fv$c;ILjava/lang/String;)V
...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->ea()Lcom/google/android/gms/plus/model/people/Person;
...
.method public getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/gg;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    new-instance v0, Lcom/google/android/gms/internal/fv$c;

    const-string v1, "image"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/gg;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/fv$c;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/fv$e;->aa(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->dX()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->dY()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/gg;->dZ()Ljava/util/ArrayList;
