...
_L2:
        ...
        if (Log.isLoggable("RequestQueue_Blocked", 4) && mQueue.size() > 0)
        {
            Log.i("RequestQueue_Blocked", (new StringBuilder()).append("Http request is blocked - queue size: ").append(mQueue.size()).toString());
        }
        ...
        catch (Object obj1)
        {
            ...
            mDelivery.postError(((Request) (obj)), new VolleyError(((Throwable) (obj1))));
        }
