...
_L1:
        return;
_L2:
        if (!(obj instanceof kt)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(cg(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String av(String s)
    {
        int j = s.length();
    ...
    private static String ch(String s)
    {
        String s1 = s;
    ...
    public static String e(kt kt1)
    {
        ...
        try
        {
            a(null, kt1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (kt kt1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(kt1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (kt kt1)
        {
