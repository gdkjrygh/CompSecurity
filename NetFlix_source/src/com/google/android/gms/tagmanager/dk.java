...
class dk
{
    ...
    private static by a(by by1)
    {
        ...
        try
        {
            by2 = new by(dh.r(cd(dh.j((com.google.android.gms.internal.d.a)by1.getObject()))), by1.kQ());
        }
    ...
    private static by a(by by1, int i)
    {
        ...
        {
        default:
            bh.w((new StringBuilder()).append("Unsupported Value Escaping: ").append(i).toString());
            return by1;
