    ...
    implements SafeParcelable
{
    ...
    StreetViewPanoramaCamera(int i, float f, float f1, float f2)
    {
        ...
        bearing = f % 360F;
        Tr = (new StreetViewPanoramaOrientation.Builder()).tilt(f1).bearing(f2).build();
    }
    ...
    {
        return fo.e(this).a("zoom", Float.valueOf(zoom)).a("tilt", Float.valueOf(tilt)).a("bearing", Float.valueOf(bearing)).toString();
    }
