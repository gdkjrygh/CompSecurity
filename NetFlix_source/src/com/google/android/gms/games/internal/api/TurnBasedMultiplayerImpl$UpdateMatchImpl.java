...
private static abstract class <init> extends com.google.android.gms.games.ateMatchImpl
{
    ...
    public com.google.android.gms.games.multiplayer.turnbased.Q W(Status status)
    {
        return new com.google.android.gms.games.multiplayer.turnbased.TurnBasedMultiplayer.UpdateMatchResult(status) {

            final TurnBasedMultiplayerImpl.UpdateMatchImpl Lo;
            final Status wz;
            ...
            {
                Lo = TurnBasedMultiplayerImpl.UpdateMatchImpl.this;
                wz = status;
                super();
            }
        };
