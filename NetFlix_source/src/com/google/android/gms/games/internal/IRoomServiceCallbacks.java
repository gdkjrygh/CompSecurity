...
_L1:
    ...
    public abstract void aR(String s)
        throws RemoteException;

    public abstract void aS(String s)
        throws RemoteException;

    public abstract void aT(String s)
        throws RemoteException;

    public abstract void aU(String s)
        throws RemoteException;
    ...
    public abstract void r(String s, int i)
        throws RemoteException;
}
