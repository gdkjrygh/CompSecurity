...
_L3:
        ...
        if (f4 <= (float)mTouchSlop || f4 <= f5) goto _L6; else goto _L5
_L5:
...
_L5:
    ...
    public void endFakeDrag()
    {
        ...
        } else
        {
            ...
            setCurrentItemInternal(determineTargetPage(((ItemInfo) (obj)).position, ((float)k / (float)j - ((ItemInfo) (obj)).offset) / ((ItemInfo) (obj)).widthFactor, i, (int)(mLastMotionX - mInitialMotionX)), true, true, i, true);
            endDrag();
            mFakeDragging = false;
            return;
        }
...
_L3:
        ...
        if (mIsBeingDragged)
        {
            ...
            int l = getScrollX();
            obj = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(((ItemInfo) (obj)).position, ((float)l / (float)j - ((ItemInfo) (obj)).offset) / ((ItemInfo) (obj)).widthFactor, i, (int)(MotionEventCompat.getX(motionevent, MotionEventCompat.findPointerIndex(motionevent, mActivePointerId)) - mInitialMotionX)), true, true, i, true);
            mActivePointerId = -1;
            endDrag();
...
_L25:
    ...
    {
        setCurrentItem(i, flag, true);
    }

    public void setCurrentItem(int i, boolean flag, boolean flag1)
    {
        mPopulatePending = false;
        setCurrentItemInternal(i, flag, true, flag1);
    }

    void setCurrentItemInternal(int i, boolean flag, boolean flag1)
    {
        setCurrentItemInternal(i, flag, flag1, false);
    }

    void setCurrentItemInternal(int i, boolean flag, boolean flag1, int j, boolean flag2)
    {
        boolean flag3;
        flag3 = true;
        if (mAdapter == null || mAdapter.getCount() <= 0)
...
_L3:
    ...
    void setCurrentItemInternal(int i, boolean flag, boolean flag1, boolean flag2)
    {
        setCurrentItemInternal(i, flag, flag1, 0, flag2);
    }
