    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        TargetContext.access$700(TargetContext.this).getSession().sendMessage(TargetContext.access$1100(TargetContext.this), playergetcurrentstate.messageName(), playergetcurrentstate.messageObject());
    }
