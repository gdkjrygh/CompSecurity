...
class is._cls0 extends ArrayList
{
    ...
    is._cls0()
    {
        ...
        super();
        add(NetflixService.access$500(_fld0));
        add(NetflixService.access$600(_fld0));
        add(NetflixService.access$700(_fld0));
        add(NetflixService.access$800(_fld0));
    }

    // Unreferenced inner class com/netflix/mediaclient/service/NetflixService$1

/* anonymous class */
    class NetflixService._cls1
        implements ServiceAgent.InitCallback
    {

        private final ArrayList agentsToInitBatch1 = new NetflixService._cls1._cls1();
        private final ArrayList agentsToInitBatch2 = new NetflixService._cls1._cls2();
...
/* anonymous class */
        class NetflixService._cls1._cls1 extends ArrayList
        {
