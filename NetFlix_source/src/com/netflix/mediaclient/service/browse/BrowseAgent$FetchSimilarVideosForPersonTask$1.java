...
class this._cls1 extends SimpleBrowseAgentCallback
{
    ...
    public void onSimilarVideosFetched(final VideoList videoList, final int statusCode)
    {
        ...
        BrowseAgent.access$5200(_fld0).post(new Runnable() {

            final BrowseAgent.FetchSimilarVideosForPersonTask._cls1 this$2;
            ...
            {
                this$2 = BrowseAgent.FetchSimilarVideosForPersonTask._cls1.this;
                videoList = videolist;
                statusCode = i;
                super();
            }
