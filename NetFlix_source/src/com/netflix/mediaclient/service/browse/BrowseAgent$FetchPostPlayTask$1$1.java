    ...
    implements Runnable
{
    ...
    public void run()
    {
        allback().onPostPlayVideosFetched(val$postPlayVideos, val$statusCode);
    }

    is._cls1()
    {
        this$2 = final__pcls1;
        val$postPlayVideos = list;
...
/* anonymous class */
    class BrowseAgent.FetchPostPlayTask._cls1 extends SimpleBrowseAgentCallback
    {
        ...
        {
            BrowseAgent.access$2200(this$0).post(i. new BrowseAgent.FetchPostPlayTask._cls1._cls1());
        }
