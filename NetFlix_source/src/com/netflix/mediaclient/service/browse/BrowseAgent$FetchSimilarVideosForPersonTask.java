...
private class this._cls0 extends this._cls0
{
    ...
    private final BrowseAgentCallback webClientCallback = new SimpleBrowseAgentCallback() {
        ...
        public void onSimilarVideosFetched(final VideoList videoList, int j)
        {
            ...
            BrowseAgent.access$5200(this$0).post(j. new Runnable() {
    ...
    public void run()
    {
        ...
        if (videolist == null)
        {
            BrowseAgent.access$000(BrowseAgent.this).fetchSimilarVideosForPerson(getCategory(), getToIndex(), webClientCallback);
            return;
        } else
        {
