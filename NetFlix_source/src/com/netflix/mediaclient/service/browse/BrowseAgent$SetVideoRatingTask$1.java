...
class this._cls1 extends SimpleBrowseAgentCallback
{
    ...
    public void onVideoRatingSet(final int statusCode)
    {
        BrowseAgent.access$3300(_fld0).post(new Runnable() {

            final BrowseAgent.SetVideoRatingTask._cls1 this$2;
            ...
            {
                this$2 = BrowseAgent.SetVideoRatingTask._cls1.this;
                statusCode = i;
                super();
            }
        });
