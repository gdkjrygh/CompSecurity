...
/* anonymous class */
    class BrowseAgent.FetchSimilarVideosForQuerySuggestionTask._cls1 extends SimpleBrowseAgentCallback
    {
        ...
        public void onSimilarVideosFetched(final VideoList videoList, int i)
        {
            ...
            BrowseAgent.access$5300(this$0).post(i. new BrowseAgent.FetchSimilarVideosForQuerySuggestionTask._cls1._cls1());
        }
