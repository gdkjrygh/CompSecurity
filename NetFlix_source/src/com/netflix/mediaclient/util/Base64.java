...
_L9:
        ...
        byte abyte1[];
        Object obj2;
        byte abyte2[] = decode(((byte []) (s)), 0, s.length, i);
        Object obj1;
        byte abyte3[];
...
_L1:
        abyte1 = abyte2;
        if (abyte2.length < 4) goto _L2; else goto _L3
_L3:
        abyte1 = abyte2;
        if (i != 0) goto _L2; else goto _L4
_L4:
        abyte1 = abyte2;
        if (35615 != (abyte2[0] & 0xff | abyte2[1] << 8 & 0xff00)) goto _L2; else goto _L5
_L5:
        abyte1 = null;
        obj1 = null;
        obj = null;
...
_L8:
        i = ((GZIPInputStream) (obj2)).read(abyte3);
...
_L1:
        ...
        s = new Base64InputStream(new BufferedInputStream(new FileInputStream(s)), 0);
_L3:
...
_L4:
    ...
    {
        Object obj = null;
        s1 = new Base64OutputStream(new FileOutputStream(s1), 0);
...
_L1:
        ...
        try
        {
            obj1 = new Base64OutputStream(((OutputStream) (obj)), k | 1);
        }
        catch (IOException ioexception)
        {
            abyte0 = ((byte []) (obj));
...
_L1:
        ...
        throws IOException
    {
        ...
        int i = 0;
        s = new Base64InputStream(new BufferedInputStream(new FileInputStream(s)), 1);
_L2:
...
_L3:
        ...
        throws IOException
    {
        ...
        obj4 = null;
        Object obj = new ByteArrayOutputStream();
        obj5 = new Base64OutputStream(((OutputStream) (obj)), i | 1);
        if ((i & 2) == 0) goto _L2; else goto _L1
_L1:
        obj2 = obj7;
        obj1 = new GZIPOutputStream(((OutputStream) (obj5)));
        obj2 = new ObjectOutputStream(((OutputStream) (obj1)));
        obj4 = obj2;
_L4:
        obj2 = obj1;
        obj3 = obj4;
...
_L2:
        obj2 = obj7;
        obj4 = new ObjectOutputStream(((OutputStream) (obj5)));
        obj1 = obj6;
        if (true) goto _L4; else goto _L3
_L3:
        obj;
        obj3 = obj4;
        serializable = ((Serializable) (obj5));
_L6:
        try
        {
...
_L5:
        ...
        throws IOException
    {
        ...
        obj = null;
        s = new Base64OutputStream(new FileOutputStream(s), 1);
        s.write(abyte0);
        try
        {
            s.close();
...
_L1:
    ...
    {
        boolean flag;
        if (!com/netflix/mediaclient/util/Base64.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
