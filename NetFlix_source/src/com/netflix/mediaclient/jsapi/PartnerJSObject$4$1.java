    ...
    implements ResponseListener
{
    ...
    public void onResponseReceived(Response response)
    {
        try
        {
            PartnerJSObject.access$300(_fld0, "nrdpPartner.Signup._handleExternalUserConfirmation", response.toJson());
            return;
        }
    ...
    // Unreferenced inner class com/netflix/mediaclient/jsapi/PartnerJSObject$4

/* anonymous class */
    class PartnerJSObject._cls4
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (obj == null)
            {
                try
                {
                    ...
                    PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Signup._handleExternalUserConfirmation", PartnerJSObject.access$200(null, idx, service, "101", "Service not found!"));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Object obj)
            ...
            if (((Partner) (obj)).getSignup() == null)
            {
                ...
                PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Signup._handleExternalUserConfirmation", PartnerJSObject.access$200(userId, idx, service, "102", "Service does not support Signup!"));
                return;
            }
            break MISSING_BLOCK_LABEL_132;
            return;
            ((Partner) (obj)).getSignup().requestExternalUserConfirmation(service, userId, idx, new PartnerJSObject._cls4._cls1());
            return;
        }
