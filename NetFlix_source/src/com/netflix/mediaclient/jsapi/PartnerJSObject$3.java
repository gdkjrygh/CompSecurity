    ...
    public void run()
    {
        ...
        if (obj == null)
        {
            try
            {
                ...
                PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Signup._handleExternalUserData", PartnerJSObject.access$200(null, val$idx, val$service, "101", "Service not found!"));
                return;
            }
        ...
        if (((Partner) (obj)).getSignup() == null)
        {
            ...
            PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Signup._handleExternalUserData", PartnerJSObject.access$200(val$userId, val$idx, val$service, "102", "Service does not support Signup!"));
            return;
        }
        break MISSING_BLOCK_LABEL_132;
        return;
        ((Partner) (obj)).getSignup().ExternalUserData(val$service, val$userId, val$idx, new ResponseListener() {

            final PartnerJSObject._cls3 this$1;

            public void onResponseReceived(Response response)
            {
                try
                {
                    PartnerJSObject.access$300(this$0, "nrdpPartner.Signup._handleExternalUserData", response.toJson());
                    return;
                }
                // Misplaced declaration of an exception variable
            ...
            {
                this$1 = PartnerJSObject._cls3.this;
                super();
            }
        });
        return;
