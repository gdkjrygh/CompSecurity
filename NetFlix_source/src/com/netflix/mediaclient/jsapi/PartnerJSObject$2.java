    ...
    public void run()
    {
        ...
        if (obj == null)
        {
            try
            {
                ...
                PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Sso._handleExternalUserAuth", PartnerJSObject.access$200(null, val$idx, val$service, "101", "Service not found!"));
                return;
            }
        ...
        if (((Partner) (obj)).getSSO() == null)
        {
            ...
            PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Sso._handleExternalUserAuth", PartnerJSObject.access$200(null, val$idx, val$service, "102", "Service does not support SSO!"));
            return;
        }
        break MISSING_BLOCK_LABEL_129;
        return;
        ((Partner) (obj)).getSSO().tExternalUserAuth(val$service, val$idx, new ResponseListener() {

            final PartnerJSObject._cls2 this$1;

            public void onResponseReceived(Response response)
            {
                try
                {
                    PartnerJSObject.access$300(this$0, "nrdpPartner.Sso._handleExternalUserAuth", response.toJson());
                    return;
                }
                // Misplaced declaration of an exception variable
            ...
            {
                this$1 = PartnerJSObject._cls2.this;
                super();
            }
        });
        return;
