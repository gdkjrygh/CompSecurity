    ...
    implements ResponseListener
{
    ...
    public void onResponseReceived(Response response)
    {
        try
        {
            PartnerJSObject.access$300(_fld0, "nrdpPartner.Sso._handleExternalUserToken", response.toJson());
            return;
        }
    ...
    // Unreferenced inner class com/netflix/mediaclient/jsapi/PartnerJSObject$1

/* anonymous class */
    class PartnerJSObject._cls1
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (obj == null)
            {
                try
                {
                    ...
                    PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Sso._handleExternalUserToken", PartnerJSObject.access$200(null, idx, service, "101", "Service not found!"));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Object obj)
            ...
            if (((Partner) (obj)).getSSO() == null)
            {
                ...
                PartnerJSObject.access$300(PartnerJSObject.this, "nrdpPartner.Sso._handleExternalUserToken", PartnerJSObject.access$200(null, idx, service, "102", "Service does not support SSO!"));
                return;
            }
            break MISSING_BLOCK_LABEL_129;
            return;
            ((Partner) (obj)).getSSO().getExternalUserToken(service, idx, new PartnerJSObject._cls1._cls1());
            return;
        }
