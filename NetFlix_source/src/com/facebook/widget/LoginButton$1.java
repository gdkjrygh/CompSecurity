    ...
    implements com.facebook.serCallback
{
    ...
    {
        if (val$currentSession == LoginButton.access$300(LoginButton.this).getOpenSession())
        {
            LoginButton.access$402(LoginButton.this, graphuser);
            if (LoginButton.access$500(LoginButton.this) != null)
            {
                LoginButton.access$500(LoginButton.this).onUserInfoFetched(LoginButton.access$400(LoginButton.this));
            }
        }
