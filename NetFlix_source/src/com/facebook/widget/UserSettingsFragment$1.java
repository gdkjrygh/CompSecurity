    ...
    implements com.facebook.ck
{
    ...
    public void onCompleted(GraphUser graphuser, Response response)
    {
        if (val$currentSession == getSession())
        {
            ...
            UserSettingsFragment.access$100(UserSettingsFragment.this);
        }
        if (response.getError() != null)
        {
            UserSettingsFragment.access$200(UserSettingsFragment.this).handleError(response.getError().getException());
        }
    }
