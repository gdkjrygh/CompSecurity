    ...
    implements Serializable
{
    ...
    static class TokenRefreshRequestHandler extends Handler
    {
        ...
        private final WeakReference refreshRequestWeakReference;
        private final WeakReference sessionWeakReference;
...
_L11:
    ...
    public static Session openActiveSession(Activity activity, boolean flag, StatusCallback statuscallback, String s)
    {
        return openActiveSession(((Context) (activity)), flag, (new OpenRequest(activity)).setCallback(statuscallback), s);
    }
    ...
    {
        return openActiveSession((new Builder(context)).build(), flag, openrequest);
    }

    private static Session openActiveSession(Context context, boolean flag, OpenRequest openrequest, String s)
    {
        return openActiveSession((new Builder(context)).setApplicationId(s).build(), flag, openrequest);
    }

    private static Session openActiveSession(Session session, boolean flag, OpenRequest openrequest)
    {
