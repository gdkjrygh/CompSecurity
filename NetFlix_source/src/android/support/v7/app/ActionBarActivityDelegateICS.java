...
class ActionBarActivityDelegateICS extends ActionBarActivityDelegate
{
    ...
    public void onActionModeFinished(ActionMode actionmode)
    {
        mActivity.onSupportActionModeFinished(new ActionModeWrapper(getActionBarThemedContext(), actionmode));
    }

    public void onActionModeStarted(ActionMode actionmode)
    {
        mActivity.onSupportActionModeStarted(new ActionModeWrapper(getActionBarThemedContext(), actionmode));
    }
    ...
    public android.support.v7.view.ActionMode startSupportActionMode(android.support.v7.view.ActionMode.Callback callback)
    {
        ...
        android.content.Context context = getActionBarThemedContext();
        android.support.v7.internal.view.ActionModeWrapper.CallbackWrapper callbackwrapper = new android.support.v7.internal.view.ActionModeWrapper.CallbackWrapper(context, callback);
        callback = null;
        ActionMode actionmode = mActivity.startActionMode(callbackwrapper);
        if (actionmode != null)
        {
            callback = new ActionModeWrapper(context, actionmode);
