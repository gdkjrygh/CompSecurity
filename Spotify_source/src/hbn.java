    ...
    implements hbl
{
    ...
    public final JSONObject a()
    {
        ...
        obj2 = null;
        obj1 = null;
        gya.a().a("Fabric", "Reading cached settings...");
        Object obj = new File((new hbc(a)).a(), "com.crashlytics.settings.json");
...
_L2:
        gya.a().a("Fabric", "No cached settings found.");
        obj = null;
...
_L8:
        obj1 = obj;
        gya.a().c("Fabric", "Failed to fetch cached settings", ((Throwable) (obj2)));
...
_L7:
    ...
    {
        Object obj;
        gya.a().a("Fabric", "Writing settings to cache file...");
        if (jsonobject == null)
        {
        ...
        filewriter = new FileWriter(new File((new hbc(a)).a(), "com.crashlytics.settings.json"));
        obj = filewriter;
...
_L4:
        obj = jsonobject;
        gya.a().c("Fabric", "Failed to cache settings", exception);
