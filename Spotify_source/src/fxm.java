...
public final class fxm extends fui
{
    ...
    public fxm(Context context, String s, fxu fxu1)
    {
        d = context;
        e = s;
        f = fxu1;
    ...
    private fxr b()
    {
        ...
        (new emv(d, ((Resolver) (obj)), new epc(hashmap, ((Semaphore) (obj2))) {
        ...
        {
            return fxr.a(e, ((enw) (obj)).getName(), obj);
        }
        obj1;
        throw new ItemLoadException();
        obj1;
