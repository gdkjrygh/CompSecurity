...
public abstract class cfn extends Binder
    implements cfm
{
    ...
    public static cfm a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cfm))
        {
            return (cfm)iinterface;
        } else
        {
            return new cfo(ibinder);
        }
    }
