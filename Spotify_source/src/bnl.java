...
final class bnl extends SQLiteOpenHelper
{

    private bnk a;

    bnl(bnk bnk1, Context context, String s)
    {
        a = bnk1;
...
_L1:
    ...
    public final SQLiteDatabase getWritableDatabase()
    {
        ...
        catch (SQLiteException sqliteexception)
        {
            ...
            Object obj = bnk.o();
            ((bnc) (a)).f.a.getDatabasePath(((String) (obj))).delete();
            try
            {
