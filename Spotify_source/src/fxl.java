...
public final class fxl extends fui
{
    ...
    public fxl(Context context, String s, fxu fxu1)
    {
        d = context;
        e = s;
        f = fxu1;
    ...
    private fxr b()
    {
        ...
        (new fif(d, ((Resolver) (obj)), new epc(hashmap, ((Semaphore) (obj2))) {
