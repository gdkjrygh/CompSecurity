...
public abstract class chc extends Binder
    implements chb
{

    public static chb a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof chb))
        {
            return (chb)iinterface;
        } else
        {
            return new chd(ibinder);
        }
    }
