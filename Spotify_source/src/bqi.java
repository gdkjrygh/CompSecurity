...
public final class bqi
{
    ...
    private static final bqi b = new bqi();
    ...
    public static Dialog a(Activity activity, int i, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        return GooglePlayServicesUtil.getErrorDialog(i, activity, 1, oncancellistener);
    }
    ...
    public static Dialog a(Activity activity, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        ...
        ((android.app.AlertDialog.Builder) (obj)).setMessage(activity.getResources().getString(0x7f08002f, new Object[] {
            obj1
        }));
        ((android.app.AlertDialog.Builder) (obj)).setTitle(0x7f080030);
    ...
    public static Intent a(Context context, int i, String s)
    {
        ...
        case 1: // '\001'
        case 2: // '\002'
            return bst.a("com.google.android.gms", b(context, s));

        case 42: // '*'
            return bst.a();

        case 3: // '\003'
            return bst.a("com.google.android.gms");
        }
    }
