...
public abstract class byc extends Binder
    implements byb
{
    ...
    public static byb a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof byb))
        {
            return (byb)iinterface;
        } else
        {
            return new byd(ibinder);
        }
    }
