...
public abstract class cpz extends Binder
    implements cpy
{
    ...
    public static cpy a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cpy))
        {
            return (cpy)iinterface;
        } else
        {
            return new cqa(ibinder);
        }
    }
