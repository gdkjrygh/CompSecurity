...
public class SurveyChoiceView extends CheckedTextView
{
    ...
    public static float a(SurveyChoiceView surveychoiceview, float f)
    {
    ...
    public static float b(SurveyChoiceView surveychoiceview, float f)
    {
...
_L6:
    ...
    public void setChecked(boolean flag)
    {
        ...
        if (isChecked() && !flag1)
        {
            cyj cyj1 = new cyj(this, (byte)0);
            cyj1.setDuration(300L);
            startAnimation(cyj1);
        }
    }
}
