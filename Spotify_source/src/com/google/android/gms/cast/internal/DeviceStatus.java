    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new bpq();
    public final int a;
    public double b;
    public boolean c;
    public int d;
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (b != ((DeviceStatus) (obj)).b || c != ((DeviceStatus) (obj)).c || d != ((DeviceStatus) (obj)).d || !bpp.a(e, ((DeviceStatus) (obj)).e) || f != ((DeviceStatus) (obj)).f)
            {
                return false;
            }
        }
