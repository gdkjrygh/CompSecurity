    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new btn();
    public final int a;
    public IBinder b;
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!c.equals(((ResolveAccountResponse) (obj)).c) || !bsv.a(b).equals(bsv.a(((ResolveAccountResponse) (obj)).b)))
            {
                return false;
            }
        }
