...
_L9:
    ...
    public static GraphObjectList createList(JSONArray jsonarray, Class class1)
    {
            ...
            implements GraphObjectList
        {
            ...
            {
                ars.a(jsonarray, "state");
                ars.a(class1, "itemType");
                state = jsonarray;
                itemType = class1;
            }
        }
    ...
    private static void verifyCanProxyClass(Class class1)
    {
        ...
        for (int i = 0; i < j;)
        {
            ...
            if (method.getDeclaringClass().isAssignableFrom(com/facebook/model/GraphObject) || (k != 1 || class2 != Void.TYPE ? k == 0 && class2 != Void.TYPE && (flag ? !arp.a(((PropertyName)method.getAnnotation(com/facebook/model/PropertyName)).value()) : s.startsWith("get") && s.length() > 3) : flag ? !arp.a(((PropertyName)method.getAnnotation(com/facebook/model/PropertyName)).value()) : s.startsWith("set") && s.length() > 3))
            {
                i++;
            } else
            {
