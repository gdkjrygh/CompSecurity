    ...
    implements ateObserver
{
    ...
    final bscriptionProxy val$subscription;

    public void onConnected()
    {
        bscriptionProxy.access._mth100(val$subscription, DeferredResolver.access$001(DeferredResolver.this, val$request, val$receiver));
    }
    ...
    ceiver()
    {
        ...
        val$subscription = bscriptionproxy;
