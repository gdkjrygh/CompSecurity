    ...
    implements an
{
    ...
    // Unreferenced inner class com/spotify/mobile/android/ui/cell/settings/FacebookSettingsCell$3

/* anonymous class */
    final class FacebookSettingsCell._cls3
        implements android.widget.CompoundButton.OnCheckedChangeListener
    {
        ...
        public final void onCheckedChanged(CompoundButton compoundbutton, boolean flag)
        {
            if (flag != FacebookSettingsCell.b(a))
            {
                ...
                if (flag)
                {
                    FacebookSettingsCell.d(a).a(new FacebookSettingsCell._cls3._cls1(this));
                }
            }
        }
