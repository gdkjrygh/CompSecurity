    ...
    implements Runnable
{
    ...
    {
        fng fng1 = SpotifyService.i(b.b).c;
        if (a)
        {
            fng1.c();
            return;
...
/* anonymous class */
    final class SpotifyService._cls7 extends OrbitServiceObserver
    {
        ...
        {
            SpotifyService.j(a).post(new SpotifyService._cls7._cls1(this, flag));
        }
        ...
        {
            SpotifyService.j(a).post(new SpotifyService._cls7._cls2(flag));
        }
        ...
        // Unreferenced inner class com/spotify/mobile/android/service/SpotifyService$7$2

/* anonymous class */
        final class SpotifyService._cls7._cls2
            implements Runnable
        {
