...
public final class ProtoCollectionAlbumsResponse extends Message
{
    ...
    private ProtoCollectionAlbumsResponse(Builder builder)
    {
        super(builder);
        item = e(builder.item);
    ...
    ProtoCollectionAlbumsResponse(Builder builder, byte byte0)
    {
        this(builder);
    }
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            obj = (ProtoCollectionAlbumsResponse)obj;
            if (!a(item, ((ProtoCollectionAlbumsResponse) (obj)).item) || !a(unfiltered_length, ((ProtoCollectionAlbumsResponse) (obj)).unfiltered_length) || !a(unranged_length, ((ProtoCollectionAlbumsResponse) (obj)).unranged_length) || !a(loading_contents, ((ProtoCollectionAlbumsResponse) (obj)).loading_contents))
            {
                return false;
            }
        }
    ...
    private class Builder extends gxc
    {
        ...
        public Builder(ProtoCollectionAlbumsResponse protocollectionalbumsresponse)
        {
