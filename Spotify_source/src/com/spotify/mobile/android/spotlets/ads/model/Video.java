    ...
    implements Parcelable, JacksonModel
{
    ...
    private final String mVideoHexId;
    ...
    private Video(Parcel parcel)
    {
        ...
        mVideoHexId = parcel.readString();
    }


    public Video(String s, int i, int j, boolean flag, boolean flag1, boolean flag2, int k, 
            String s1, String s2)
    {
        mMimeType = s;
        mWidth = i;
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            obj = (Video)obj;
            if (mBitrate != ((Video) (obj)).mBitrate)
            {
                return false;
            }
            if (mHasDisplay != ((Video) (obj)).mHasDisplay)
            {
                return false;
            }
            if (mHeight != ((Video) (obj)).mHeight)
            {
                return false;
            }
            if (mLockedRatio != ((Video) (obj)).mLockedRatio)
            {
                return false;
            }
            if (mScalable != ((Video) (obj)).mScalable)
            {
                return false;
            }
            if (mWidth != ((Video) (obj)).mWidth)
            {
                return false;
            }
            if (mMimeType == null ? ((Video) (obj)).mMimeType != null : !mMimeType.equals(((Video) (obj)).mMimeType))
            {
                return false;
            }
            if (mUrl == null ? ((Video) (obj)).mUrl != null : !mUrl.equals(((Video) (obj)).mUrl))
            {
                return false;
            }
            if (mVideoHexId == null ? ((Video) (obj)).mVideoHexId != null : !mVideoHexId.equals(((Video) (obj)).mVideoHexId))
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        ...
        if (mVideoHexId != null)
        {
            j1 = mVideoHexId.hashCode();
        }
        return (i1 + (((k + (j + ((i * 31 + k1) * 31 + l1) * 31) * 31) * 31 + l) * 31 + i2) * 31) * 31 + j1;
    }
    ...
    public void writeToParcel(Parcel parcel, int i)
    {
        ...
        parcel.writeString(mVideoHexId);
    }
