...
/* anonymous class */
        ...
        implements fli
    {
        ...
        public final void a(LegacyAdsVideoPlayerService.AdsVideoPlaybackState adsvideoplaybackstate)
        {
            ...
            {
            default:
                a.runOnUiThread(new BackgroundableVideoPlayerActivity._cls1._cls2());
                return;
        ...
        public final void b()
        {
            ...
            {
                a.runOnUiThread(new BackgroundableVideoPlayerActivity._cls1._cls3(this));
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/spotify/mobile/android/spotlets/video/BackgroundableVideoPlayerActivity$1$2

/* anonymous class */
        final class BackgroundableVideoPlayerActivity._cls1._cls2
            implements Runnable
        {
