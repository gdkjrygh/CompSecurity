...
public class JsonProcessingException extends IOException
{
    ...
    public JsonProcessingException(String s, JsonLocation jsonlocation)
    {
        this(s, jsonlocation, null);
    }

    public JsonProcessingException(String s, JsonLocation jsonlocation, Throwable throwable)
    {
        super(s);
        if (throwable != null)
        {
    ...
    public JsonProcessingException(String s, Throwable throwable)
    {
