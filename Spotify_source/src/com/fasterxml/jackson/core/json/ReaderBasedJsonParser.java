...
_L22:
        ...
        _textBuffer.setCurrentLength(k1);
        return reset(flag, i, j, l1);
_L2:
        ac2 = _inputBuffer;
        i = _inputPtr;
        _inputPtr = i + 1;
...
_L6:
        ...
        _inputPtr = k1 + 1;
        c = ac2[k1];
        if (c < '0' || c > '9') goto _L17; else goto _L16
_L16:
        i1++;
        if (l >= ac1.length)
        {
...
_L7:
        if (c1 != '"' || base64variant.usesPadding()) goto _L10; else goto _L9
_L9:
        j = l + 1;
        abyte0[l] = (byte)(l1 >> 4);
        l = j;
...
_L8:
        ...
        if (j == -2)
        {
            ...
            {
                throw reportInvalidBase64Char(base64variant, c1, 3, (new StringBuilder("expected padding character '")).append(base64variant.getPaddingChar()).append("'").toString());
            }
            i1 = l + 1;
            abyte0[l] = (byte)(l1 >> 4);
            j = i;
