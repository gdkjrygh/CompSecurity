    ...
    implements Serializable
{
    ...
    private static final long serialVersionUID = 0xc476a1ce9f6dd831L;
    ...
    {
        return JsonMappingException.from(_parser, (new StringBuilder("Can not deserialize instance of ")).append(_calcName(class1)).append(" out of ").append(jsontoken).append(" token").toString());
    }
    ...
    {
        String s1 = (new StringBuilder("Unexpected token (")).append(jsonparser.getCurrentToken()).append("), expected ").append(jsontoken).toString();
        jsontoken = s1;
        if (s != null)
        {
