    ...
    implements TypeResolverBuilder
{
    ...
    public TypeDeserializer buildTypeDeserializer(DeserializationConfig deserializationconfig, JavaType javatype, Collection collection)
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Do not know how to construct standard type serializer for inclusion type: ")).append(_includeAs).toString());
    ...
    protected TypeIdResolver idResolver(MapperConfig mapperconfig, JavaType javatype, Collection collection, boolean flag, boolean flag1)
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Do not know how to construct standard type id resolver for idType: ")).append(_idType).toString());
