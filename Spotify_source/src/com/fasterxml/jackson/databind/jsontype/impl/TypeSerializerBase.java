...
public abstract class TypeSerializerBase extends TypeSerializer
{
    ...
    protected String idFromValue(Object obj)
    {
        ...
        if (s == null)
        {
            ...
            throw new IllegalArgumentException((new StringBuilder("Can not resolve type id for ")).append(((String) (obj))).append(" (using ").append(_idResolver.getClass().getName()).append(")").toString());
        } else
        {
            return s;
        }
