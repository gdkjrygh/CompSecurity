...
_L7:
    ...
    protected JavaType _typeFromId(String s, TypeFactory typefactory)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("Invalid type id '")).append(s).append("' (for id type 'Id.class'): ").append(typefactory.getMessage()).toString(), typefactory);
        }
        return typefactory;
    }
