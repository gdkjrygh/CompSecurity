...
public class PropertyBasedObjectIdGenerator extends com.fasterxml.jackson.annotation.ObjectIdGenerators.PropertyGenerator
{
    ...
    public Object generateId(Object obj)
    {
        ...
        {
            throw new IllegalStateException((new StringBuilder("Problem accessing property '")).append(_property.getName()).append("': ").append(((Exception) (obj)).getMessage()).toString(), ((Throwable) (obj)));
        }
        return obj;
    }
