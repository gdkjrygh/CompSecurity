...
label0:
    ...
    protected Object _deserializeFromObjectId(JsonParser jsonparser, DeserializationContext deserializationcontext)
    {
        ...
        if (obj1 == null)
        {
            throw new UnresolvedForwardReference((new StringBuilder("Could not resolve Object Id [")).append(obj).append("] -- unresolved forward-reference?").toString(), jsonparser.getCurrentLocation(), deserializationcontext);
        } else
        {
            return obj1;
        }
