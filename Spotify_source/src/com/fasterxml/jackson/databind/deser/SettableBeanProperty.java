    ...
    implements BeanProperty, Serializable
{
    ...
    public SettableBeanProperty(PropertyName propertyname, JavaType javatype, PropertyName propertyname1, TypeDeserializer typedeserializer, Annotations annotations, PropertyMetadata propertymetadata)
    {
        _propertyIndex = -1;
        if (propertyname == null)
        {
