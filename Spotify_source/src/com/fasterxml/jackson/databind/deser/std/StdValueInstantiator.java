...
label0:
        ...
        throw deserializationcontext.mappingException((new StringBuilder("Can not instantiate value of type ")).append(getValueTypeDesc()).append(" from Boolean value (").append(flag).append("); no single-boolean/Boolean-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw deserializationcontext.mappingException((new StringBuilder("Can not instantiate value of type ")).append(getValueTypeDesc()).append(" from Floating-point number (").append(d).append("); no one-double/Double-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw deserializationcontext.mappingException((new StringBuilder("Can not instantiate value of type ")).append(getValueTypeDesc()).append(" from Integral number (").append(i).append("); no single-int-arg constructor/factory method").toString());
    }
...
label0:
        ...
        throw deserializationcontext.mappingException((new StringBuilder("Can not instantiate value of type ")).append(getValueTypeDesc()).append(" from Long integral number (").append(l).append("); no single-long-arg constructor/factory method").toString());
    }
