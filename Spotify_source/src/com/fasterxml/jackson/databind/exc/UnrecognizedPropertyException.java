...
public class UnrecognizedPropertyException extends PropertyBindingException
{
    ...
    public static UnrecognizedPropertyException from(JsonParser jsonparser, Object obj, String s, Collection collection)
    {
        ...
        jsonparser = new UnrecognizedPropertyException((new StringBuilder("Unrecognized field \"")).append(s).append("\" (class ").append(class1.getName()).append("), not marked as ignorable").toString(), jsonparser.getCurrentLocation(), class1, s, collection);
