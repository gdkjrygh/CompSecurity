...
public class IgnoredPropertyException extends PropertyBindingException
{
    ...
    public static IgnoredPropertyException from(JsonParser jsonparser, Object obj, String s, Collection collection)
    {
        ...
        jsonparser = new IgnoredPropertyException((new StringBuilder("Ignored field \"")).append(s).append("\" (class ").append(class1.getName()).append(") encountered; mapper configured not to allow this").toString(), jsonparser.getCurrentLocation(), class1, s, collection);
