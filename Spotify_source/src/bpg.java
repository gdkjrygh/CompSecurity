...
public final class bpg
{
    ...
    public final JSONObject b()
    {
        ...
        if (b != 0)
        {
            jsonobject.put("foregroundColor", a(b));
        }
        if (c != 0)
        {
            jsonobject.put("backgroundColor", a(c));
        }
        d;
...
_L7:
        if (g != 0)
        {
            jsonobject.put("windowColor", a(g));
        }
        if (f == 2)
        {
...
_L2:
        ...
        if (l == null || ((bpg) (obj)).l == null)
        {
            break; /* Loop/switch isn't completed */
        }
        flag2 = flag3;
        if (!cnu.a(l, ((bpg) (obj)).l)) goto _L4; else goto _L3
_L3:
        flag2 = flag3;
        if (a == ((bpg) (obj)).a)
        {
