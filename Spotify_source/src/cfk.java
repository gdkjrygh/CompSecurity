...
public abstract class cfk extends Binder
    implements cfj
{
    ...
    public static cfj a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cfj))
        {
            return (cfj)iinterface;
        } else
        {
            return new cfl(ibinder);
        }
    }
