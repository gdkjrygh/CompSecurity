...
public final class ajp
{
    ...
    {
        if (ajv.a(context, "android.permission.ACCESS_WIFI_STATE").booleanValue() && ((ConnectivityManager)context.getSystemService("connectivity")).getNetworkInfo(1).isConnected())
        {
    ...
    {
        if (ajv.a(context, "android.permission.ACCESS_NETWORK_STATE").booleanValue())
        {
    ...
    {
        if (ajv.a(context, "android.permission.ACCESS_NETWORK_STATE").booleanValue() && android.os.Build.VERSION.SDK_INT >= 13)
        {
    ...
    {
        if (ajv.a(context, "android.permission.READ_PHONE_STATE").booleanValue())
        {
