    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    public cic(Context context, VersionInfoParcel versioninfoparcel, Thread.UncaughtExceptionHandler uncaughtexceptionhandler, Thread.UncaughtExceptionHandler uncaughtexceptionhandler1)
    {
    ...
    public static cic a(Context context, Thread thread, VersionInfoParcel versioninfoparcel)
    {
        ...
        context = new cic(context, versioninfoparcel, uncaughtexceptionhandler, Thread.getDefaultUncaughtExceptionHandler());
        if (uncaughtexceptionhandler == null || !(uncaughtexceptionhandler instanceof cic))
        {
            try
            {
        ...
        {
            return (cic)uncaughtexceptionhandler;
        }
    }
    ...
    {
        cax cax = cbb.c;
        return ((Boolean)bkv.n().a(cax)).booleanValue();
    }
    ...
    private static boolean a(String s)
    {
        ...
        try
        {
            flag = Class.forName(s).isAnnotationPresent(cid);
        }
        catch (Exception exception)
        {
            bka.a((new StringBuilder("Fail to check class type for class ")).append(s).toString(), exception);
            return false;
        }
        return flag;
    }
...
_L4:
        if (throwable != null)
        {
            ...
            bkv.e();
            arraylist.add(throwable.appendQueryParameter("device", cjj.b()).appendQueryParameter("js", d.b).appendQueryParameter("appid", c.getApplicationContext().getPackageName()).appendQueryParameter("stacktrace", stringwriter.toString()).appendQueryParameter("eids", TextUtils.join(",", cbb.a())).appendQueryParameter("trapped", String.valueOf(flag)).toString());
            bkv.e();
            cjj.a(c, d.b, arraylist, bkv.h().f());
            return;
        }
