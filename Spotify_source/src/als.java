...
final class als
{
    ...
    public als(IdManager idmanager)
    {
        ...
        abyte0 = CommonUtils.a(new byte[] {
            byte0, byte1, byte2, byte3, byte4, byte5, byte6, byte7, byte8, byte9
        });
        b = String.format(Locale.US, "%s-%s-%s-%s", new Object[] {
            abyte0.substring(0, 12), abyte0.substring(12, 16), abyte0.subSequence(16, 20), idmanager.substring(0, 12)
