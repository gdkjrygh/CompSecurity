    ...
    implements aoq
{
    ...
    public aos(OutputStream outputstream, arb arb1)
    {
        c = true;
        a = outputstream;
        b = arb1;
    ...
    private void a(String s, ParcelFileDescriptor parcelfiledescriptor, String s1)
    {
        ...
        a(s, s, s2);
        if (!(a instanceof aol)) goto _L2; else goto _L1
_L1:
        int i;
        ((aol)a).a(parcelfiledescriptor.getStatSize());
        i = 0;
_L6:
        b("", new Object[0]);
        a();
        if (b != null)
        {
            arb.a((new StringBuilder("    ")).append(s).toString(), String.format("<Data: %d>", new Object[] {
                Integer.valueOf(i)
            }));
        }
        return;
...
_L7:
    ...
    public final void a(String s, Object obj, Request request)
    {
        ...
        if (!Request.a(obj)) goto _L2; else goto _L1
_L1:
        a(s, Request.b(obj));
_L4:
        return;
_L2:
        ...
        if (b != null)
        {
            arb.a((new StringBuilder("    ")).append(s).toString(), "<Image>");
            return;
        }
        if (true) goto _L4; else goto _L3
_L3:
        ...
        } else
        {
            ...
            if (obj instanceof com.facebook.Request.ParcelFileDescriptorWithMimeType)
            {
                obj = (com.facebook.Request.ParcelFileDescriptorWithMimeType)obj;
                a(s, ((com.facebook.Request.ParcelFileDescriptorWithMimeType) (obj)).b, ((com.facebook.Request.ParcelFileDescriptorWithMimeType) (obj)).a);
                return;
            } else
            {
...
_L5:
    ...
    public final void a(String s, String s1)
    {
        ...
        if (b != null)
        {
            arb.a((new StringBuilder("    ")).append(s).toString(), s1);
        }
    }
    ...
    public final void a(String s, JSONArray jsonarray, Collection collection)
    {
        ...
        } else
        {
            ...
            if (b != null)
            {
                arb.a((new StringBuilder("    ")).append(s).toString(), jsonarray.toString());
                return;
            }
        }
    }
