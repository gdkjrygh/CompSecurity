...
public final class cjt
{
    ...
    public cjt(Context context, String s)
    {
        this(context);
        b = s;
    }
...
_L11:
        ...
        {
            bka.c("Can not create dialog without Activity Context");
            return;
        }
        obj = b;
...
_L12:
        ...
        bkv.e();
        obj1 = cjj.a(((android.net.Uri) (obj1)));
        String s;
...
_L14:
        ...
        builder.setPositiveButton("Share", new android.content.DialogInterface.OnClickListener(((String) (obj))) {
            ...
            {
                bkv.e();
                cjj.a(b.a, Intent.createChooser((new Intent("android.intent.action.SEND")).setType("text/plain").putExtra("android.intent.extra.TEXT", a), "Share via"));
            }
