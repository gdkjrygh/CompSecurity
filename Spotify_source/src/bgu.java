...
public abstract class bgu extends Binder
    implements bgt
{

    public static bgt a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof bgt))
        {
            return (bgt)iinterface;
        } else
        {
            return new bgv(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = a(byc.a(parcel.readStrongBinder()), parcel.readInt());
