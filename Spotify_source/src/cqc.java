...
public abstract class cqc extends Binder
    implements cqb
{
    ...
    public static cqb a(IBinder ibinder)
    {
        ...
        if (iinterface != null && (iinterface instanceof cqb))
        {
            return (cqb)iinterface;
        } else
        {
            return new cqd(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 2: // '\002'
            ...
            a(authaccountrequest, cpz.a(parcel.readStrongBinder()));
        ...
        case 5: // '\005'
            ...
            } else
            {
                ...
                if (iinterface != null && (iinterface instanceof btd))
                {
                    parcel = (btd)iinterface;
                } else
                {
                    parcel = new btf(parcel);
                }
            }
        ...
        case 8: // '\b'
            ...
            a(i, account, cpz.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 9: // '\t'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            bsu bsu = bsv.a(parcel.readStrongBinder());
            i = parcel.readInt();
            boolean flag1 = flag2;
            if (parcel.readInt() != 0)
            {
        ...
        case 10: // '\n'
            ...
            a(recordconsentrequest, cpz.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 11: // '\013'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            a(cpz.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
