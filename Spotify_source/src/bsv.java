...
public abstract class bsv extends Binder
    implements bsu
{

    public static bsu a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof bsu))
        {
            return (bsu)iinterface;
        } else
        {
            return new bsw(ibinder);
        }
    }
