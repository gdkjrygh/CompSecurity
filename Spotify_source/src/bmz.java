...
public final class bmz
{
    ...
    public static cob a(bmp bmp1, String s)
    {
        btl.a(bmp1);
        ...
        {
            bmp1.d("No valid campaign data found", s);
            return null;
        }
        bmp1 = new HashMap(s.size());
        NameValuePair namevaluepair;
        for (s = s.iterator(); s.hasNext(); bmp1.put(namevaluepair.getName(), namevaluepair.getValue()))
        {
            namevaluepair = (NameValuePair)s.next();
        }

        s = new cob();
        s.e = (String)bmp1.get("utm_content");
        s.c = (String)bmp1.get("utm_medium");
        s.a = (String)bmp1.get("utm_campaign");
        s.b = (String)bmp1.get("utm_source");
        s.d = (String)bmp1.get("utm_term");
        s.f = (String)bmp1.get("utm_id");
        s.g = (String)bmp1.get("anid");
        s.h = (String)bmp1.get("gclid");
        s.i = (String)bmp1.get("dclid");
        s.j = (String)bmp1.get("aclid");
        return s;
    }
