...
public final class fxi extends fui
{
    ...
    public fxi(Context context, String s, fxu fxu1)
    {
        d = context;
        e = s;
        f = fxu1;
    ...
    private fxr b()
    {
        ...
        (new emt(d, ((Resolver) (obj)), new epc(hashmap, ((Semaphore) (obj2))) {
        ...
        {
            return fxr.a(e, ((enr) (obj)).getName(), obj);
        }
        obj1;
        throw new ItemLoadException();
        obj1;
