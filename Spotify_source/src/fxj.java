...
public final class fxj extends fui
{
    ...
    public fxj(Context context, String s, fxu fxu1)
    {
        d = context;
        e = s;
        f = fxu1;
    ...
    private fxr b()
    {
        ...
        (new emu(d, ((Resolver) (obj)), new epc(hashmap, ((Semaphore) (obj2))) {
        ...
        {
            return fxr.a(e, ((ent) (obj)).getName(), obj);
        }
        obj1;
        throw new ItemLoadException();
        obj1;
