...
public abstract class cgz extends Binder
    implements cgy
{
    ...
    public static cgy a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cgy))
        {
            return (cgy)iinterface;
        } else
        {
            return new cha(ibinder);
        }
    }
