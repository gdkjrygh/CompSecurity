...
public final class cdu extends cjc
{

    private final String a;
    private final ckw b;

    public cdu(ckw ckw1, String s)
    {
        b = ckw1;
        a = s;
    }
...
_L2:
        ...
        bkv.e();
        cjj.a(b.getContext(), ((Intent) (obj1)));
        return;
_L3:
...
_L4:
        ...
        Map map;
        int j;
        bkv.e().a(b.getContext(), b.n().b, false, httpurlconnection);
...
_L7:
        bka.e("Arrived at landing page, this ideally should not happen. Will open it in browser.");
...
_L8:
        ...
        obj1;
_L14:
        bka.c((new StringBuilder("Error while parsing ping URL: ")).append(((String) (obj))).toString(), ((Throwable) (obj1)));
          goto _L2
        obj1;
_L13:
        bka.c((new StringBuilder("Error while pinging URL: ")).append(((String) (obj))).toString(), ((Throwable) (obj1)));
          goto _L2
        obj1;
_L12:
        bka.c((new StringBuilder("Error while pinging URL: ")).append(((String) (obj))).toString(), ((Throwable) (obj1)));
