...
public final class cil
{
    ...
    public cil(Context context, cik cik1)
    {
        PackageManager packagemanager = context.getPackageManager();
        a(context);
        a(context, packagemanager);
...
_L4:
    ...
    private void a(Context context, PackageManager packagemanager)
    {
        ...
        l = -1;
        bkv.e();
        if (cjj.a(packagemanager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE"))
        {
    ...
    public final cik a()
    {
        return new cik(a, p, q, g, r, s, t, b, c, u, v, d, h, i, j, e, f, w, x, y, m, n, k, l, o);
    }
}
