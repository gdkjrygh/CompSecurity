...
_L3:
        ...
        obj = HttpResponseCache.install(file, gwm.a(file));
        a = obj;
        obj2;
...
_L2:
        ...
        if (j >= 300)
        {
            ...
            throw new com.squareup.picasso.Downloader.ResponseException((new StringBuilder()).append(j).append(" ").append(((HttpURLConnection) (obj1)).getResponseMessage()).toString(), i, j);
        } else
        {
            long l = ((HttpURLConnection) (obj1)).getHeaderFieldInt("Content-Length", -1);
            boolean flag = gwm.a(((HttpURLConnection) (obj1)).getHeaderField("X-Android-Response-Source"));
            return new gvm(((HttpURLConnection) (obj1)).getInputStream(), flag, l);
        }
        obj1;
        obj2;
        JVM INSTR monitorexit ;
