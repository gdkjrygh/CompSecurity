...
public final class gyx
{
    ...
    public static String a(Context context)
    {
        ...
        if (TextUtils.isEmpty(s1))
        {
            ...
            if (j == 0)
            {
                gya.a().a("Fabric", "Falling back to Crashlytics key lookup from Strings");
        ...
        if (TextUtils.isEmpty(s))
        {
            ...
            gya.a().e("Fabric", "Fabric could not be initialized, API key missing from AndroidManifest.xml. Add the following tag to your Application element \n\t<meta-data android:name=\"io.fabric.ApiKey\" android:value=\"YOUR_API_KEY\"/>");
        }
        return s;
    }
    ...
    private static String b(Context context)
    {
        ...
        {
            gya.a().a("Fabric", (new StringBuilder("Caught non-fatal exception while retrieving apiKey: ")).append(context).toString());
            return s;
        }
        s = s1;
        ...
        s = s1;
        gya.a().a("Fabric", "Falling back to Crashlytics key lookup from Manifest");
        s = s1;
