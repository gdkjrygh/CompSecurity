...
public abstract class bnq extends bnc
{

    private bnr a;

    public bnq(bnf bnf1, bnr bnr1)
    {
        super(bnf1);
        a = bnr1;
    }

    private bnp a(XmlResourceParser xmlresourceparser)
    {
        int i;
...
_L17:
    ...
    public final bnp a(int i)
    {
        ...
        try
        {
            bnp = a(super.f.b.getResources().getXml(i));
        }
