...
public final class big extends cgt
{
    ...
    public big(String s, ArrayList arraylist, Context context, String s1)
    {
        c = s;
        d = arraylist;
        a = s1;
    ...
    private String a(String s, HashMap hashmap)
    {
        ...
        {
            bka.c("Error to retrieve app version", ((Throwable) (obj)));
            obj = "";
        }
        l = bkv.h().b().b;
    ...
    private void b()
    {
        ...
        {
            bka.e("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
            return;
        }
        ...
        {
            bka.c("Fail to report a conversion.", exception);
        }
    }
