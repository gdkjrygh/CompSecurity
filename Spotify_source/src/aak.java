    ...
    implements android.view.View.OnTouchListener
{
    ...
    private boolean a(MotionEvent motionevent)
    {
        ...
        } else
        {
            ...
            boolean flag2 = ((aaj) (obj)).a(motionevent1, i);
            motionevent1.recycle();
            int k = jo.a(motionevent);
            boolean flag;
            if (k != 1 && k != 3)
            {
                flag = true;
    ...
    static void b(aak aak1)
    {
        aak1.d();
        View view;
        for (view = aak1.d; !view.isEnabled() || view.isLongClickable() || !aak1.b();)
        {
            return;
        }
...
_L6:
        ...
        if (e == null)
        {
            e = new aal(this, (byte)0);
        }
        view.postDelayed(e, b);
        if (f == null)
        {
            f = new aam(this, (byte)0);
        }
