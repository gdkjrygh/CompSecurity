...
public final class ViewStubCompat extends View
{
    ...
    public ViewStubCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        b = 0;
        context = context.obtainStyledAttributes(attributeset, sr.cE, i, 0);
        c = context.getResourceId(sr.cG, -1);
        b = context.getResourceId(sr.cH, 0);
        setId(context.getResourceId(sr.cF, -1));
        context.recycle();
        setVisibility(8);
        setWillNotDraw(true);
    }
