    ...
    implements ju, jw, kg
{
    ...
    private static final po v = new po();
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (jo.b(motionevent, i1) == q)
        {
            ...
            f = (int)jo.d(motionevent, i1);
            q = jo.b(motionevent, i1);
            if (k != null)
            {
                k.clear();
            }
...
_L7:
    ...
    {
        if ((jo.d(motionevent) & 2) == 0) goto _L2; else goto _L1
_L1:
...
_L3:
        ...
        int l1;
        float f1;
        if (j || (f1 = jo.e(motionevent, 9)) == 0.0F)
        {
...
_L3:
        ...
        q = -1;
        b();
        if (c.a(getScrollX(), getScrollY(), c()))
        {
            km.d(this);
        }
        stopNestedScroll();
...
_L4:
        ...
        if (a(0, i1, 0, getScrollY(), i2) && !hasNestedScrollingParent())
        {
            k.clear();
        }
        k2 = getScrollY() - j2;
        if (dispatchNestedScroll(0, k2, 0, i1 - k2, r))
        {
            f = f - r[1];
            motionevent1.offsetLocation(0.0F, r[1]);
            t = t + r[1];
...
_L8:
        d.a((float)i1 / (float)getHeight(), jo.c(motionevent, l1) / (float)getWidth());
        if (!e.a())
        {
            e.c();
        }
...
_L9:
        if (k1 > i2)
        {
            e.a((float)i1 / (float)getHeight(), 1.0F - jo.c(motionevent, l1) / (float)getWidth());
            if (!d.a())
            {
                d.c();
            }
...
_L11:
        ...
        i1 = (int)ki.b(motionevent, q);
        if (Math.abs(i1) <= o) goto _L14; else goto _L13
_L13:
        e(-i1);
_L12:
        q = -1;
...
_L5:
        if (j && getChildCount() > 0 && c.a(getScrollX(), getScrollY(), c()))
        {
            km.d(this);
        }
        q = -1;
        ...
        continue; /* Loop/switch isn't completed */
_L6:
        int j1 = jo.b(motionevent);
        f = (int)jo.d(motionevent, j1);
        q = jo.b(motionevent, j1);
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        f = (int)jo.d(motionevent, jo.a(motionevent, q));
