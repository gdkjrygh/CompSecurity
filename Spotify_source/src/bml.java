...
public abstract class bml extends Binder
    implements bmk
{

    public static bmk a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof bmk))
        {
            return (bmk)iinterface;
        } else
        {
            return new bmm(ibinder);
        }
    }
