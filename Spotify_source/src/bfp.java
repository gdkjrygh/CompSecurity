    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(AdSizeParcel adsizeparcel, Parcel parcel, int i)
    {
        ...
        brp.b(parcel, 1, adsizeparcel.a);
        brp.a(parcel, 2, adsizeparcel.b);
        brp.b(parcel, 3, adsizeparcel.c);
        brp.b(parcel, 4, adsizeparcel.d);
        brp.a(parcel, 5, adsizeparcel.e);
        brp.b(parcel, 6, adsizeparcel.f);
        brp.b(parcel, 7, adsizeparcel.g);
        brp.a(parcel, 8, adsizeparcel.h, i);
        brp.a(parcel, 9, adsizeparcel.i);
        brp.a(parcel, 10, adsizeparcel.j);
        brp.b(parcel, j);
    }
