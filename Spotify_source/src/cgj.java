...
public abstract class cgj extends Binder
    implements cgi
{
    ...
    public static cgi a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cgi))
        {
            return (cgi)iinterface;
        } else
        {
            return new cgk(ibinder);
        }
    }
