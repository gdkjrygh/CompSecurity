...
public abstract class bzr extends Binder
    implements bzq
{

    public static bzq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof bzq))
        {
            return (bzq)iinterface;
        } else
        {
            return new bzs(ibinder);
        }
    }
