    ...
    implements gtt
{
    ...
    public final gsq a(hcj hcj, boolean flag)
    {
        return new gtr(hcj, flag);
    }

    public final gss a(hci hci, boolean flag)
    {
        return new gts(hci, flag);
    }
