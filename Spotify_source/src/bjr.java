...
public abstract class bjr extends Binder
    implements bjq
{

    public static bjq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof bjq))
        {
            return (bjq)iinterface;
        } else
        {
            return new bjs(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = a(byc.a(parcel.readStrongBinder()), cey.a(parcel.readStrongBinder()), parcel.readInt());
