    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(AdRequestInfoParcel adrequestinfoparcel, Parcel parcel, int i)
    {
        ...
        brp.b(parcel, 1, adrequestinfoparcel.a);
        brp.a(parcel, 2, adrequestinfoparcel.b);
        brp.a(parcel, 3, adrequestinfoparcel.c, i);
        brp.a(parcel, 4, adrequestinfoparcel.d, i);
        brp.a(parcel, 5, adrequestinfoparcel.e);
        brp.a(parcel, 6, adrequestinfoparcel.f, i);
        brp.a(parcel, 7, adrequestinfoparcel.g, i);
        brp.a(parcel, 8, adrequestinfoparcel.h);
        brp.a(parcel, 9, adrequestinfoparcel.i);
        brp.a(parcel, 10, adrequestinfoparcel.j);
        brp.a(parcel, 11, adrequestinfoparcel.k, i);
        brp.a(parcel, 12, adrequestinfoparcel.l);
        brp.b(parcel, 13, adrequestinfoparcel.m);
        brp.a(parcel, 14, adrequestinfoparcel.n);
        brp.a(parcel, 15, adrequestinfoparcel.o);
        brp.a(parcel, 17, adrequestinfoparcel.q, i);
        brp.a(parcel, 16, adrequestinfoparcel.p);
        brp.b(parcel, 19, adrequestinfoparcel.s);
        brp.b(parcel, 18, adrequestinfoparcel.r);
        brp.a(parcel, 21, adrequestinfoparcel.u);
        brp.a(parcel, 20, adrequestinfoparcel.t);
        brp.a(parcel, 25, adrequestinfoparcel.v);
        brp.a(parcel, 27, adrequestinfoparcel.x);
        brp.a(parcel, 26, adrequestinfoparcel.w);
        brp.a(parcel, 29, adrequestinfoparcel.z, i);
        brp.a(parcel, 28, adrequestinfoparcel.y);
        brp.a(parcel, 31, adrequestinfoparcel.B);
        brp.a(parcel, 30, adrequestinfoparcel.A);
        brp.a(parcel, 32, adrequestinfoparcel.C, i);
        brp.a(parcel, 33, adrequestinfoparcel.D);
        brp.b(parcel, j);
    }
