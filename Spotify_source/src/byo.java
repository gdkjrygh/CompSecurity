...
public final class byo
{
    ...
    private byo(Context context, String s)
    {
        b = context;
        ...
        {
            context = ct.a(new File(context.getApplicationInfo().dataDir, "no_backup"));
        }
...
_L1:
    ...
    final KeyPair a(String s, long l)
    {
        ...
        a(editor, s, "|P|", byh.a(keypair.getPublic().getEncoded()));
        a(editor, s, "|K|", byh.a(keypair.getPrivate().getEncoded()));
