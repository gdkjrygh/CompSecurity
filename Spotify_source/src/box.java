...
public final class box
{
    ...
    private int l;
    private int m;
    private final boy n = new boy(this);
...
_L2:
        ...
        if (jsonobject.has("currentTime"))
        {
            ...
            if ((i1 & 2) == 0)
            {
                l3 = bpp.a(jsonobject.getDouble("currentTime"));
                j1 = k1;
                if (l3 != g)
                {
                    g = l3;
...
_L19:
        i1 = k1;
_L34:
        if (((boy) (obj)).a == i1) goto _L13; else goto _L24
_L24:
        obj.a = i1;
        i1 = 1;
          goto _L25
...
_L25:
        ...
        if (jsonobject.has("items"))
        {
            ...
            while (k1 < l1) 
            {
                ...
                jsonobject = (Integer)((boy) (obj)).c.get(i2);
                if (jsonobject == null)
                {
                    jsonobject = null;
                } else
                {
                    jsonobject = (bov)((boy) (obj)).b.get(jsonobject.intValue());
                }
                if (jsonobject != null)
                {
                    ...
                    abov[k1] = jsonobject;
                    i2 = ((Integer) (obj2)).intValue();
                    if (k1 != ((Integer)((boy) (obj)).c.get(i2)).intValue())
                    {
                        i1 = 1;
                    }
                } else
                {
                    i1 = 1;
                    if (((Integer) (obj2)).intValue() == ((boy) (obj)).d.b)
                    {
                        jsonobject = new bow(((boy) (obj)).d.c);
                        obj2 = ((bow) (jsonobject)).a;
                        if (((bov) (obj2)).a == null)
                        {
                            throw new IllegalArgumentException("media cannot be null.");
                        }
                        if (Double.isNaN(((bov) (obj2)).c) || ((bov) (obj2)).c < 0.0D)
                        {
                            throw new IllegalArgumentException("startTime cannot be negative or NaN.");
                        }
                        if (Double.isNaN(((bov) (obj2)).d))
                        {
                            throw new IllegalArgumentException("playbackDuration cannot be NaN.");
                        }
                        if (Double.isNaN(((bov) (obj2)).e) || ((bov) (obj2)).e < 0.0D)
                        {
                            throw new IllegalArgumentException("preloadTime cannot be negative or Nan.");
                        }
                        abov[k1] = ((bow) (jsonobject)).a;
                        abov[k1].a(jsonobject1);
                        i1 = 1;
                    } else
                    {
                        abov[k1] = new bov(jsonobject1);
                    }
                }
                k1++;
            }
            if (((boy) (obj)).b.size() != l1)
            {
                i1 = 1;
            }
            ((boy) (obj)).a(abov);
...
_L35:
        jsonobject = n;
        jsonobject.a = 0;
        ((boy) (jsonobject)).b.clear();
        ((boy) (jsonobject)).c.clear();
        return j1 | 8;
_L13:
        i1 = 0;
