...
_L3:
        ...
        intent = ((gvi) (context)).f;
        context = ((gvi) (context)).f;
        int i;
        if (flag)
        {
            i = 1;
...
_L4:
        intent = (ConnectivityManager)gwm.a(context, "connectivity");
        context = a;
        intent = intent.getActiveNetworkInfo();
        ((gvi) (context)).f.sendMessage(((gvi) (context)).f.obtainMessage(9, intent));
        return;
    }
}
