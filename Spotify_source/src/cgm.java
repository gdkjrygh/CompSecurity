...
public abstract class cgm extends Binder
    implements cgl
{

    public static cgl a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof cgl))
        {
            return (cgl)iinterface;
        } else
        {
            return new cgn(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = a(byc.a(parcel.readStrongBinder()));
