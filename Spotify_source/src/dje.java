...
final class dje extends dja
{

    private final dja a;

    dje(djj djj1, Context context, Fragment fragment)
    {
        dgm dgm = djj1.i;
        int j = djj1.b;
        if (dgm != null)
        ...
        if (j == 1)
        {
            a = new djg(djj1, context, fragment);
            return;
        }
        if (j == 2)
        {
        ...
        if (j == 3)
        {
            a = new djh(djj1, context, fragment);
            return;
        } else
        {
            a = new dji(djj1, context, fragment);
            return;
        }
    }
