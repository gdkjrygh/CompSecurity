    ...
    implements lback
{
    ...
    private final AccessToken val$accessToken;
    private final Set val$declinedPermissions;
    private final Set val$permissions;
    private final AtomicBoolean val$permissionsCallSucceeded;
    private final freshResult val$refreshResult;
    ...
    public void onBatchCompleted(GraphRequestBatch graphrequestbatch)
    {
        ...
        if (i == 0)
        {
            AccessTokenManager.access$1(AccessTokenManager.this).set(false);
            return;
        }
