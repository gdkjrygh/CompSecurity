...
public final class DefaultAudience extends Enum
{
    ...
    private static final DefaultAudience ENUM$VALUES[];
    ...
    {
        DefaultAudience adefaultaudience[] = ENUM$VALUES;
        int i = adefaultaudience.length;
        DefaultAudience adefaultaudience1[] = new DefaultAudience[i];
        System.arraycopy(adefaultaudience, 0, adefaultaudience1, 0, i);
        return adefaultaudience1;
    }
    ...
    static 
    {
        ...
        ENUM$VALUES = (new DefaultAudience[] {
