    ...
    implements Runnable
{
    ...
    private final com.facebook.internal.ppSettings val$settings;

    public void run()
    {
        LoginButton.access$5(_fld0, val$settings);
    }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            LoginButton.access$3(LoginButton.this).runOnUiThread(fetchedappsettings. new LoginButton._cls1._cls1());
        }
