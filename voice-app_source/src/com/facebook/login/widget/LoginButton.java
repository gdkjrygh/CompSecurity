...
public class LoginButton extends FacebookButtonBase
{
    ...
    public static final class ToolTipMode extends Enum
    {
        ...
        {
            ToolTipMode atooltipmode[];
            int j;
            int k;
            atooltipmode = values();
            k = atooltipmode.length;
            j = 0;
_L6:
...
_L4:
            return tooltipmode;
_L2:
            ToolTipMode tooltipmode1;
            tooltipmode1 = atooltipmode[j];
            tooltipmode = tooltipmode1;
            if (tooltipmode1.getValue() == i) goto _L4; else goto _L3
_L3:
            j++;
...
_L5:
    ...
    private static int $SWITCH_TABLE$com$facebook$login$widget$LoginButton$ToolTipMode[];
    ...
    static int[] $SWITCH_TABLE$com$facebook$login$widget$LoginButton$ToolTipMode()
    {
        int ai[] = $SWITCH_TABLE$com$facebook$login$widget$LoginButton$ToolTipMode;
        if (ai != null)
        {
            return ai;
        }
        ai = new int[ToolTipMode.values().length];
        try
        {
            ai[ToolTipMode.AUTOMATIC.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror2) { }
        try
        {
            ai[ToolTipMode.DISPLAY_ALWAYS.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            ai[ToolTipMode.NEVER_DISPLAY.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror) { }
        $SWITCH_TABLE$com$facebook$login$widget$LoginButton$ToolTipMode = ai;
        return ai;
    }
    ...
    {
        switch ($SWITCH_TABLE$com$facebook$login$widget$LoginButton$ToolTipMode()[toolTipMode.ordinal()])
        {
        default:
            return;
            ...
            FacebookSdk.getExecutor().execute(new Runnable() {
                ...
                public void run()
                {
                    ...
                    getActivity().runOnUiThread(fetchedappsettings. new Runnable() {
                        ...
                        final _cls1 this$1;
                        private final com.facebook.internal.Utility.FetchedAppSettings val$settings;
