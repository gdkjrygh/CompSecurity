    ...
    implements Parcelable
{
        ...
        implements Parcelable
    {
        ...
        boolean hasPublishPermission()
        {
            ...
            } while (!LoginManager.isPublishPermission((String)iterator.next()));
            return true;
        }
        ...
        Request(Parcel parcel, Request request)
        {
            this(parcel);
        }
        ...
        implements Parcelable
    {
        ...
        Result(Parcel parcel, Result result)
        {
            this(parcel);
        }
    ...
    {
        if (graphresponse.getError() == null) goto _L2; else goto _L1
_L1:
        return null;
_L2:
        if ((graphresponse = graphresponse.getJSONObject()) == null || ((graphresponse = graphresponse.optJSONArray("data")) == null || graphresponse.length() == 0)) goto _L1; else goto _L3
_L3:
        ArrayList arraylist;
        ArrayList arraylist1;
        int i;
        arraylist = new ArrayList(graphresponse.length());
        arraylist1 = new ArrayList(graphresponse.length());
        i = 0;
_L5:
        String s;
        Object obj;
        ...
        obj = graphresponse.optJSONObject(i);
        s = ((JSONObject) (obj)).optString("permission");
...
_L7:
    ...
    void tryNextHandler()
    {
        ...
        do
        {
            if (handlersToTry == null || currentHandler >= handlersToTry.length - 1)
            {
                if (pendingRequest != null)
                {
                    completeWithFailure();
