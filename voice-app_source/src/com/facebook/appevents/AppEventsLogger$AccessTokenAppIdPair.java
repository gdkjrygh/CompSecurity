    ...
    implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (Utility.areObjectsEqual(((SerializationProxyV1) (obj = (SerializationProxyV1)obj)).accessTokenString, accessTokenString) && Utility.areObjectsEqual(((accessTokenString) (obj)).applicationId, applicationId))
            {
                return true;
            }
        }
