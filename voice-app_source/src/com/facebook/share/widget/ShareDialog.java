    ...
    implements Sharer
{
    ...
    private class NativeHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
    {
        ...
        NativeHandler(NativeHandler nativehandler)
        {
            this();
        }
    }
    ...
    private class WebShareHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
    {
        ...
        WebShareHandler(WebShareHandler websharehandler)
        {
            this();
        }
    }
    ...
    private static int $SWITCH_TABLE$com$facebook$share$widget$ShareDialog$Mode[];
    ...
    static int[] $SWITCH_TABLE$com$facebook$share$widget$ShareDialog$Mode()
    {
        int ai[] = $SWITCH_TABLE$com$facebook$share$widget$ShareDialog$Mode;
        if (ai != null)
        {
            return ai;
        }
        ...
        try
        {
            ai[Mode.AUTOMATIC.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror3) { }
        try
        {
            ai[Mode.FEED.ordinal()] = 4;
        }
        catch (NoSuchFieldError nosuchfielderror2) { }
        try
        {
            ai[Mode.NATIVE.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            ai[Mode.WEB.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror) { }
        $SWITCH_TABLE$com$facebook$share$widget$ShareDialog$Mode = ai;
        return ai;
    }
    ...
    private void logDialogShare(Context context, ShareContent sharecontent, Mode mode)
    {
        ...
        $SWITCH_TABLE$com$facebook$share$widget$ShareDialog$Mode()[mode.ordinal()];
