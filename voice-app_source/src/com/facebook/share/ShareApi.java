...
_L6:
        ...
        throws JSONException
    {
        ...
        do
        {
            ...
            bundle.putString(String.format(Locale.ROOT, "image[%d][%s]", new Object[] {
                Integer.valueOf(i), s
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent shareopengraphcontent, final FacebookCallback callback)
    {
        ...
        stageOpenGraphAction(parameters, new com.facebook.internal.CollectionMapper.OnMapperCompleteListener() {
            ...
            final ShareApi this$0;
            private final ShareOpenGraphAction val$action;
            private final FacebookCallback val$callback;
            private final Bundle val$parameters;
            private final com.facebook.GraphRequest.Callback val$requestCallback;
    ...
    private void sharePhotoContent(SharePhotoContent sharephotocontent, FacebookCallback facebookcallback)
    {
        ...
        callback = new com.facebook.GraphRequest.Callback() {
            ...
            final ShareApi this$0;
            private final FacebookCallback val$callback;
            private final ArrayList val$errorResponses;
            private final Mutable val$requestCount;
            ...
            public void onCompleted(GraphResponse graphresponse)
            {
                ...
                obj = requestCount;
                obj.value = Integer.valueOf(((Integer)((Mutable) (obj)).value).intValue() - 1);
...
_L6:
    ...
    private void stageArrayList(final ArrayList arrayList, final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener onArrayListStagedListener)
    {
        ...
        stageCollectionValues(new com.facebook.internal.CollectionMapper.Collection() {
            ...
            private final JSONArray val$stagedObject;
            ...
            public Iterator keyIterator()
            {
                ...
                return i. new Iterator() {
                    ...
                    final _cls5 this$1;
                    private final Mutable val$current;
                    ...
                    public Integer next()
                    {
                        ...
                        mutable.value = Integer.valueOf(integer.intValue() + 1);
                        return integer;
                    }
            ...
            final ShareApi this$0;
            private final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener val$onArrayListStagedListener;
            private final JSONArray val$stagedObject;
    ...
    private void stageOpenGraphObject(final ShareOpenGraphObject object, final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener onOpenGraphObjectStagedListener)
    {
        ...
        } else
        {
            ...
            stageCollectionValues(new com.facebook.internal.CollectionMapper.Collection() {
                ...
                final ShareApi this$0;
                private final ShareOpenGraphObject val$object;
                private final JSONObject val$stagedObject;
            ...
            
            {
                ...
                final ShareApi this$0;
                private final String val$ogType;
                private final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener val$onOpenGraphObjectStagedListener;
                private final com.facebook.GraphRequest.Callback val$requestCallback;
                private final JSONObject val$stagedObject;
    ...
    private void stagePhoto(final SharePhoto photo, final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener onPhotoStagedListener)
    {
        ...
        if (obj != null || uri != null)
        {
            photo = new com.facebook.GraphRequest.Callback() {
                ...
                final ShareApi this$0;
                private final com.facebook.internal.CollectionMapper.OnMapValueCompleteListener val$onPhotoStagedListener;
                private final SharePhoto val$photo;
