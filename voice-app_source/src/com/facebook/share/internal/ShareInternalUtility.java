...
label0:
        ...
        sharephotocontent = Utility.map(sharephotocontent, new com.facebook.internal.Utility.Mapper() {
        ...
        appCallId = Utility.map(sharephotocontent, new com.facebook.internal.Utility.Mapper() {
    ...
    {
        return new ResultProcessor(final_facebookcallback) {
...
label0:
    ...
    public static void registerSharerCallback(final int requestCode, CallbackManager callbackmanager, final FacebookCallback callback)
    {
        ...
        {
            ((CallbackManagerImpl)callbackmanager).registerCallback(requestCode, new com.facebook.internal.CallbackManagerImpl.Callback() {
    ...
    {
        CallbackManagerImpl.registerStaticCallback(requestCode, new com.facebook.internal.CallbackManagerImpl.Callback() {
...
_L9:
        ...
        jsonobject = jsonobject1;
        if (jsonobject2.length() <= 0) goto _L4; else goto _L3
_L3:
...
_L5:
        Object obj = removeNamespacesFromOGJsonObject((JSONObject)obj1, true);
_L8:
        Object obj2;
...
_L6:
        obj = obj1;
        if (!(obj1 instanceof JSONArray)) goto _L8; else goto _L7
_L7:
    ...
    {
        Object obj;
        obj = shareopengraphcontent.getAction();
        final ArrayList attachments = new ArrayList();
        obj = OpenGraphJSONUtility.toJSONObject(((com.facebook.share.model.ShareOpenGraphAction) (obj)), new OpenGraphJSONUtility.PhotoJSONProcessor() {

            private final ArrayList val$attachments;
...
_L3:
        ...
        if (shareopengraphcontent.getPeopleIds() == null) goto _L2; else goto _L1
_L1:
        ...
        shareopengraphcontent = shareopengraphcontent.getPeopleIds().iterator();
_L6:
        if (shareopengraphcontent.hasNext()) goto _L4; else goto _L3
_L3:
        ((JSONObject) (obj)).put("tags", new ArrayList(callId));
_L2:
        return ((JSONObject) (obj));
_L4:
        callId.add((String)shareopengraphcontent.next());
