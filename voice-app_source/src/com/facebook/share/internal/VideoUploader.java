...
public class VideoUploader
{
    ...
    private static class UploadContext
    {
        ...
        UploadContext(ShareVideoContent sharevideocontent, String s, FacebookCallback facebookcallback, UploadContext uploadcontext)
        {
        ...
        implements Runnable
    {
        ...
        private boolean attemptRetry(int i)
        {
            if (completedRetries < 2 && getTransientErrorCodes().contains(Integer.valueOf(i)))
            {
                ...
                VideoUploader.getHandler().postDelayed(new Runnable() {
                    ...
                    final UploadWorkItemBase this$1;
            ...
            {
                this$1 = UploadWorkItemBase.this;
                super();
            }
                }, i * 5000);
                return true;
        ...
        {
            VideoUploader.getHandler().post(s. new Runnable() {
            ...
            {
                this$1 = final_uploadworkitembase;
    ...
    private static void cancelAllRequests()
    {
        ...
        Iterator iterator = pendingUploads.iterator();
_L1:
        ...
        throws IOException
    {
        ...
        i = (int)(Long.parseLong(s1) - l);
        s = new ByteArrayOutputStream();
        abyte0 = new byte[Math.min(8192, i)];
_L5:
