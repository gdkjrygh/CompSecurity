...
private class setRequest extends setRequest
{
    ...
    {
        Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$0(), "Error fetching engagement for object '%s' with type '%s' : %s", new Object[] {
            objectId, objectType, facebookrequesterror
        });
        LikeActionController.access$1(LikeActionController.this, "get_engagement", facebookrequesterror);
    }
    ...
    (String s, com.facebook.share.widget.r r)
    {
        ...
        likeCountStringWithLike = LikeActionController.access$3(LikeActionController.this);
        likeCountStringWithoutLike = LikeActionController.access$4(LikeActionController.this);
        socialSentenceStringWithLike = LikeActionController.access$5(LikeActionController.this);
        socialSentenceStringWithoutLike = LikeActionController.access$6(LikeActionController.this);
