...
private class setRequest extends setRequest
{
    ...
    protected void processError(FacebookRequestError facebookrequesterror)
    {
        ...
        {
            Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$0(), "Error liking object '%s' with type '%s' : %s", new Object[] {
                objectId, objectType, facebookrequesterror
            });
            LikeActionController.access$1(LikeActionController.this, "publish_like", facebookrequesterror);
            return;
        }
    }
