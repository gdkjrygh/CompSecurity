...
public class ShareContentValidation
{
    private static class ApiValidator extends Validator
    {
        ...
        ApiValidator(ApiValidator apivalidator)
        {
            this();
        }
    }
    ...
    private static class Validator
    {
        ...
        Validator(Validator validator, Validator validator1)
        {
            this();
        }
    }
    ...
    private static class WebShareValidator extends Validator
    {
        ...
        WebShareValidator(WebShareValidator websharevalidator)
        {
            this();
        }
    }
    ...
    private static Validator getDefaultValidator()
    {
        ...
        {
            DefaultValidator = new Validator(null, null);
        }
    ...
    private static void validateOpenGraphContent(ShareOpenGraphContent shareopengraphcontent, Validator validator)
    {
        ...
        {
            throw new FacebookException((new StringBuilder("Property \"")).append(validator).append("\" was not found on the action. ").append("The name of the preview property must match the name of an ").append("action property.").toString());
        } else
        {
            return;
        }
    ...
    {
        Iterator iterator = shareopengraphvaluecontainer.keySet().iterator();
        do
        {
            if (!iterator.hasNext())
            {
    ...
    private static void validatePhotoContent(SharePhotoContent sharephotocontent, Validator validator)
    {
        ...
        sharephotocontent = sharephotocontent.iterator();
        do
        {
            ...
            validator.validate((SharePhoto)sharephotocontent.next());
        } while (true);
    }
