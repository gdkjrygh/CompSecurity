...
private class setRequest extends setRequest
{
    ...
    {
        Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$0(), "Error unliking object with unlike token '%s' : %s", new Object[] {
            unlikeToken, facebookrequesterror
        });
        LikeActionController.access$1(LikeActionController.this, "publish_unlike", facebookrequesterror);
    }
