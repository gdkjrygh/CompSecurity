    ...
    implements setRequest
{
    ...
    {
        Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$0(), "Error fetching like status for page id '%s': %s", new Object[] {
            pageId, facebookrequesterror
        });
        LikeActionController.access$1(LikeActionController.this, "get_page_like", facebookrequesterror);
    }
