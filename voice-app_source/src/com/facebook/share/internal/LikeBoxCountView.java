...
public class LikeBoxCountView extends FrameLayout
{
    public static final class LikeBoxCountViewCaretPosition extends Enum
    {
        ...
        static 
        {
            ...
            ENUM$VALUES = (new LikeBoxCountViewCaretPosition[] {
    ...
    private static int $SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition[];
    ...
    static int[] $SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition()
    {
        int ai[] = $SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition;
        if (ai != null)
        {
            return ai;
        }
        ai = new int[LikeBoxCountViewCaretPosition.values().length];
        try
        {
            ai[LikeBoxCountViewCaretPosition.BOTTOM.ordinal()] = 4;
        }
        catch (NoSuchFieldError nosuchfielderror3) { }
        try
        {
            ai[LikeBoxCountViewCaretPosition.LEFT.ordinal()] = 1;
        }
        catch (NoSuchFieldError nosuchfielderror2) { }
        try
        {
            ai[LikeBoxCountViewCaretPosition.RIGHT.ordinal()] = 3;
        }
        catch (NoSuchFieldError nosuchfielderror1) { }
        try
        {
            ai[LikeBoxCountViewCaretPosition.TOP.ordinal()] = 2;
        }
        catch (NoSuchFieldError nosuchfielderror) { }
        $SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition = ai;
        return ai;
    }
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        $SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition()[caretPosition.ordinal()];
...
_L6:
    ...
    public void setCaretPosition(LikeBoxCountViewCaretPosition likeboxcountviewcaretposition)
    {
        ...
        switch ($SWITCH_TABLE$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition()[likeboxcountviewcaretposition.ordinal()])
        {
        default:
            return;
