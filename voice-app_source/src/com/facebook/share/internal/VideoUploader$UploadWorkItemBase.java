    ...
    implements Runnable
{
    ...
    private boolean attemptRetry(int i)
    {
        if (completedRetries < 2 && getTransientErrorCodes().contains(Integer.valueOf(i)))
        {
            ...
            VideoUploader.access$5().postDelayed(new Runnable() {

                final VideoUploader.UploadWorkItemBase this$1;
            ...
            {
                this$1 = VideoUploader.UploadWorkItemBase.this;
                super();
            }
            }, i * 5000);
            return true;
    ...
    {
        VideoUploader.access$5().post(new Runnable() {
            ...
            public void run()
            {
                VideoUploader.access$6(uploadContext, error, videoId);
            }
