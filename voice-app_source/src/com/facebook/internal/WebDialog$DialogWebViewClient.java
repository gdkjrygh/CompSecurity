...
private class <init> extends WebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        if (!WebDialog.access$0(WebDialog.this))
        {
            WebDialog.access$1(WebDialog.this).dismiss();
        }
        WebDialog.access$2(WebDialog.this).setBackgroundColor(0);
        WebDialog.access$3(WebDialog.this).setVisibility(0);
        WebDialog.access$4(WebDialog.this).setVisibility(0);
        WebDialog.access$5(WebDialog.this, true);
    }
    ...
    public void onPageStarted(WebView webview, String s, Bitmap bitmap)
    {
        ...
        if (!WebDialog.access$0(WebDialog.this))
        {
            WebDialog.access$1(WebDialog.this).show();
        }
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webview, String s)
    {
        ...
        if (s.startsWith(WebDialog.access$6(WebDialog.this)))
        {
