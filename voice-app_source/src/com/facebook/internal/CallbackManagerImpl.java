    ...
    implements CallbackManager
{
    ...
    public static final class RequestCodeOffset extends Enum
    {
        ...
        private static final RequestCodeOffset ENUM$VALUES[];
        ...
        {
            RequestCodeOffset arequestcodeoffset[] = ENUM$VALUES;
            int i = arequestcodeoffset.length;
            RequestCodeOffset arequestcodeoffset1[] = new RequestCodeOffset[i];
            System.arraycopy(arequestcodeoffset, 0, arequestcodeoffset1, 0, i);
            return arequestcodeoffset1;
        }
        ...
        static 
        {
            ...
            ENUM$VALUES = (new RequestCodeOffset[] {
