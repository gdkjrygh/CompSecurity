...
public static final class offset extends Enum
{
    ...
    private static final AppInvite ENUM$VALUES[];
    ...
    {
        offset aoffset[] = ENUM$VALUES;
        int i = aoffset.length;
        offset aoffset1[] = new ENUM.VALUES[i];
        System.arraycopy(aoffset, 0, aoffset1, 0, i);
        return aoffset1;
    }
