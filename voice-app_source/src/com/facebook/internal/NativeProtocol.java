...
_L4:
    ...
    private static TreeSet fetchAllAvailableProtocolVersionsForAppInfo(NativeAppInfo nativeappinfo)
    {
        ...
        nativeappinfo2 = null;
        nativeappinfo1 = obj;
        if (FacebookSdk.getApplicationContext().getPackageManager().resolveContentProvider((new StringBuilder(String.valueOf(nativeappinfo.getPackage()))).append(".provider.PlatformProvider").toString(), 0) == null) goto _L2; else goto _L1
_L1:
        nativeappinfo1 = obj;
...
_L3:
    ...
    private static int getLatestAvailableProtocolVersionForAppInfoList(List list, int ai[])
    {
        ...
        do
        {
            ...
            i = computeLatestAvailableVersionFromVersionSpec(((NativeAppInfo)list.next()).getAvailableVersions(), getLatestKnownVersion(), ai);
        } while (i == -1);
        return i;
    }
    ...
    public static void updateAllAvailableProtocolVersionsAsync()
    {
        ...
        } else
        {
            FacebookSdk.getExecutor().execute(new Runnable() {
                ...
                public void run()
                {
                    Iterator iterator = NativeProtocol.facebookAppInfoList.iterator();
_L1:
