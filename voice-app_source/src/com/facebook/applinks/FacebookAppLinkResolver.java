    ...
    implements AppLinkResolver
{
    ...
    public Task getAppLinkFromUrlsInBackground(final List taskCompletionSource)
    {
        ...
        Iterator iterator = taskCompletionSource.iterator();
        do
        {
            Uri uri;
            AppLink applink;
...
_L4:
                            ...
                            } while (!graphresponse.has(uri1.toString()));
...
_L2:
                            ...
                            throw exception;
                            bolts.AppLink.Target target = FacebookAppLinkResolver.getAndroidTargetFromJson(((JSONArray) (obj1)).getJSONObject(i));
                            if (target == null)
                            {
