...
public final class BitmapDescriptorFactory
{
    ...
    public static BitmapDescriptor defaultMarker()
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(zzvH().zzvN());
        }
    ...
    public static BitmapDescriptor defaultMarker(float f)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(zzvH().zzh(f));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromAsset(String s)
    {
        try
        {
            s = new BitmapDescriptor(zzvH().zzdu(s));
        }
    ...
    public static BitmapDescriptor fromFile(String s)
    {
        try
        {
            s = new BitmapDescriptor(zzvH().zzdv(s));
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
    ...
    public static BitmapDescriptor fromPath(String s)
    {
        try
        {
            s = new BitmapDescriptor(zzvH().zzdw(s));
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
