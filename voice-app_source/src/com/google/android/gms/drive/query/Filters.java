...
public class Filters
{
    ...
    {
        return new LogicalFilter(Operator.zzaim, filter, afilter);
    }
    ...
    {
        return new ComparisonFilter(Operator.zzaip, searchablemetadatafield, s);
    }

    public static Filter eq(CustomPropertyKey custompropertykey, String s)
    {
        return new HasFilter(SearchableField.zzahN, (new com.google.android.gms.drive.metadata.internal.AppVisibleCustomProperties.zza()).zza(custompropertykey, s).zzpU());
    }

    public static Filter eq(SearchableMetadataField searchablemetadatafield, Object obj)
    {
        return new ComparisonFilter(Operator.zzaih, searchablemetadatafield, obj);
    }

    public static Filter greaterThan(SearchableOrderedMetadataField searchableorderedmetadatafield, Comparable comparable)
    {
        return new ComparisonFilter(Operator.zzaik, searchableorderedmetadatafield, comparable);
    }
    ...
    {
        return new ComparisonFilter(Operator.zzail, searchableorderedmetadatafield, comparable);
    }
    ...
    {
        return new ComparisonFilter(Operator.zzaii, searchableorderedmetadatafield, comparable);
    }

    public static Filter lessThanEquals(SearchableOrderedMetadataField searchableorderedmetadatafield, Comparable comparable)
    {
        return new ComparisonFilter(Operator.zzaij, searchableorderedmetadatafield, comparable);
    }
    ...
    {
        return new LogicalFilter(Operator.zzain, filter, afilter);
    }
