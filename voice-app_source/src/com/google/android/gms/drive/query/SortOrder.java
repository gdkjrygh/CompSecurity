    ...
    implements SafeParcelable
{
    public static class Builder
    {
        ...
        private final List zzahO = new ArrayList();
        private boolean zzahP;

        public Builder addSortAscending(SortableMetadataField sortablemetadatafield)
        {
            zzahO.add(new FieldWithSortOrder(sortablemetadatafield.getName(), true));
            return this;
        }

        public Builder addSortDescending(SortableMetadataField sortablemetadatafield)
        {
            zzahO.add(new FieldWithSortOrder(sortablemetadatafield.getName(), false));
            return this;
        }

        public SortOrder build()
        {
            return new SortOrder(zzahO, zzahP);
        }
    ...
    public String toString()
    {
        return String.format(Locale.US, "SortOrder[%s, %s]", new Object[] {
            TextUtils.join(",", zzahO), Boolean.valueOf(zzahP)
        });
    }
