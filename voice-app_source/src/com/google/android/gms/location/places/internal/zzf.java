        ...
        implements zzf
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = LatLngBounds.CREATOR.zzeO(parcel);
                } else
                {
                    parcel1 = null;
                }
                ...
                if (parcel.readInt() != 0)
                {
                    obj = PlaceFilter.CREATOR.zzer(parcel);
                } else
                {
                    obj = null;
                }
                if (parcel.readInt() != 0)
                {
                    placesparams = PlacesParams.CREATOR.zzeB(parcel);
                }
                zza(parcel1, i, s1, ((PlaceFilter) (obj)), placesparams, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 3: // '\003'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = PlacesParams.CREATOR.zzeB(parcel);
                }
                zza(((String) (obj)), parcel1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 4: // '\004'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = LatLng.CREATOR.zzeP(parcel);
                } else
                {
                    parcel1 = null;
                }
                ...
                if (parcel.readInt() != 0)
                {
                    obj1 = PlacesParams.CREATOR.zzeB(parcel);
                }
                zza(parcel1, ((PlaceFilter) (obj)), ((PlacesParams) (obj1)), zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 5: // '\005'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = PlaceFilter.CREATOR.zzer(parcel);
                } else
                {
                    parcel1 = null;
                }
                if (parcel.readInt() != 0)
                {
                    obj = PlacesParams.CREATOR.zzeB(parcel);
                }
                zzb(parcel1, ((PlacesParams) (obj)), zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 6: // '\006'
                ...
                zzb(((String) (obj)), parcel1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 7: // '\007'
                ...
                zza(((List) (obj)), parcel1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 17: // '\021'
                ...
                zzb(((List) (obj)), parcel1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 8: // '\b'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = UserDataType.CREATOR.zzew(parcel);
                } else
                {
                    parcel1 = null;
                }
                ...
                if (parcel.readInt() != 0)
                {
                    placesparams1 = PlacesParams.CREATOR.zzeB(parcel);
                } else
                {
                    placesparams1 = null;
                }
                zza(parcel1, ((LatLngBounds) (obj)), arraylist, placesparams1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 11: // '\013'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = NearbyAlertRequest.CREATOR.zzeq(parcel);
                } else
                {
                    parcel1 = null;
                }
            ...
            case 13: // '\r'
                ...
                if (parcel.readInt() != 0)
                {
                    obj = AutocompleteFilter.CREATOR.zzeo(parcel);
                } else
                {
                    obj = null;
                }
                if (parcel.readInt() != 0)
                {
                    placesparams2 = PlacesParams.CREATOR.zzeB(parcel);
                } else
                {
                    placesparams2 = null;
                }
                zza(s2, parcel1, ((AutocompleteFilter) (obj)), placesparams2, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 14: // '\016'
                ...
                zza(parcel1, ((PlacesParams) (obj)), zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 16: // '\020'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel1 = PlaceAlias.CREATOR.zzeF(parcel);
                } else
                {
                    parcel1 = null;
                }
                ...
                zza(parcel1, s, s3, ((PlacesParams) (obj)), zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 18: // '\022'
                ...
                zza(((String) (obj)), i, parcel1, zzh.zza.zzcc(parcel.readStrongBinder()));
                return true;
            ...
            case 19: // '\023'
                ...
                zza(((String) (obj)), parcel1, zzg.zza.zzcb(parcel.readStrongBinder()));
                return true;
            ...
            zza(((String) (obj)), i, j, k, parcel1, zzg.zza.zzcb(parcel.readStrongBinder()));
            return true;
        }
    }
...
_L4:
            ...
            zznF.transact(14, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L3:
            ...
            placesparams.writeToParcel(parcel, 0);
_L4:
            zznF.transact(15, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L4:
            ...
            zznF.transact(16, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L4:
            ...
            zznF.transact(20, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L4:
            ...
            s = zzh1.asBinder();
            parcel.writeStrongBinder(s);
            zznF.transact(18, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L4:
            ...
            s = zzg1.asBinder();
            parcel.writeStrongBinder(s);
            zznF.transact(19, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L4:
            ...
            list = zzh1.asBinder();
            parcel.writeStrongBinder(list);
            zznF.transact(17, parcel, null, 1);
            parcel.recycle();
            return;
_L2:
            parcel.writeInt(0);
...
_L3:
    ...
    public abstract void zza(String s, int i, int j, int k, PlacesParams placesparams, zzg zzg)
        throws RemoteException;

    public abstract void zza(String s, int i, PlacesParams placesparams, zzh zzh)
        throws RemoteException;

    public abstract void zza(String s, PlacesParams placesparams, zzg zzg)
        throws RemoteException;
