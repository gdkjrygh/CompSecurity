...
_L4:
    ...
    public static com.google.android.gms.location.places.internal.zze zzbZ(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            ...
            zza(placerequest, ((PlacesParams) (obj)), pendingintent, zzcc(parcel.readStrongBinder()));
        ...
        case 3: // '\003'
            ...
            zza(placesparams, ((PendingIntent) (obj)), zzcc(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 4: // '\004'
            ...
            if (parcel.readInt() != 0)
            {
                nearbyalertrequest = NearbyAlertRequest.CREATOR.zzeq(parcel);
            } else
            {
                nearbyalertrequest = null;
            }
            ...
            zza(nearbyalertrequest, ((PlacesParams) (obj)), pendingintent, zzcc(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 5: // '\005'
            ...
            zzb(placesparams1, ((PendingIntent) (obj)), zzcc(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 6: // '\006'
            ...
            if (parcel.readInt() != 0)
            {
                placefilter = PlaceFilter.CREATOR.zzer(parcel);
            } else
            {
                placefilter = null;
            }
            ...
            zza(placefilter, ((PlacesParams) (obj)), zzcc(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        zza(placereport, ((PlacesParams) (obj)), zzcc(parcel.readStrongBinder()));
        parcel1.writeNoException();
        return true;
    }
}
