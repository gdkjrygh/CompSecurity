...
public class PutDataMapRequest
{
    ...
    {
        zzaSW = putdatarequest;
        if (datamap != null)
        {
            zzaSV.putAll(datamap);
        }
    }
    ...
    {
        com.google.android.gms.internal.zzrb.zza zza = zzrb.zza(zzaSV);
        zzaSW.setData(zzrn.zzf(zza.zzaVj));
        int j = zza.zzaVk.size();
        for (int i = 0; i < j; i++)
        {
