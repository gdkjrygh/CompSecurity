...
public class DataMap
{
    ...
    private final HashMap zzaSU = new HashMap();
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        try
        {
            abyte0 = zzrb.zza(new com.google.android.gms.internal.zzrb.zza(zzrc.zzw(abyte0), new ArrayList()));
        }
...
_L8:
    ...
    public int hashCode()
    {
        return zzaSU.hashCode() * 29;
    }

    public boolean isEmpty()
    {
        return zzaSU.isEmpty();
    }
    ...
    {
        String s;
        for (Iterator iterator = datamap.keySet().iterator(); iterator.hasNext(); zzaSU.put(s, datamap.get(s)))
        {
            s = (String)iterator.next();
        }
    ...
    {
        zzaSU.put(s, Boolean.valueOf(flag));
    }

    public void putByte(String s, byte byte0)
    {
        zzaSU.put(s, Byte.valueOf(byte0));
    }
    ...
    {
        zzaSU.put(s, arraylist);
    }

    public void putDouble(String s, double d)
    {
        zzaSU.put(s, Double.valueOf(d));
    }

    public void putFloat(String s, float f)
    {
        zzaSU.put(s, Float.valueOf(f));
    }
    ...
    public Bundle toBundle()
    {
        ...
        String s;
        for (Iterator iterator = zzaSU.keySet().iterator(); iterator.hasNext(); zza(bundle, s, zzaSU.get(s)))
        {
            s = (String)iterator.next();
        }
