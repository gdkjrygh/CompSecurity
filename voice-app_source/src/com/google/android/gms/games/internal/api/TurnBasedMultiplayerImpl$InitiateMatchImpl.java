...
private static abstract class <init> extends com.google.android.gms.games.ateMatchImpl
{
    ...
    public com.google.android.gms.games.multiplayer.turnbased. zzaz(Status status)
    {
        return new com.google.android.gms.games.multiplayer.turnbased.TurnBasedMultiplayer.InitiateMatchResult(status) {

            final Status zzOl;
            final TurnBasedMultiplayerImpl.InitiateMatchImpl zzasx;
            ...
            {
                zzasx = TurnBasedMultiplayerImpl.InitiateMatchImpl.this;
                zzOl = status;
                super();
            }
        };
