...
class adImpl extends adImpl
{
    ...
    public volatile void zza(com.google.android.gms.common.api.sImpl._cls2 _pcls2)
    ...
    adImpl(EventsImpl eventsimpl, GoogleApiClient googleapiclient, boolean flag)
    {
        zzaqL = eventsimpl;
        zzaqy = flag;
