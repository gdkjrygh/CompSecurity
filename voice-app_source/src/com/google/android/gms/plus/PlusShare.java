...
public final class PlusShare
{
    public static class Builder
    {
        ...
        {
            zzu.zza(zzaHj, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            Bundle bundle;
            boolean flag;
            ...
            zzu.zzb(flag, "Must provide a call to action URL");
            bundle = new Bundle();
            ...
            {
                zzu.zza(PlusShare.zzdU(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            zzu.zza(flag1, "Call-to-action buttons are only available for URLs.");
            ...
            zzu.zza(flag1, "The content URL is required for interactive posts.");
            flag1 = flag2;
            if (flag4)
            {
                flag1 = flag2;
            ...
            zzu.zza(flag1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
                zzu.zza(PlusShare.zzdU(mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
            if (!flag && flag3)
            {
                mIntent.setAction("android.intent.action.SEND");
                if (zzaHk != null && !zzaHk.isEmpty())
                {
                    mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)zzaHk.get(0));
                } else
                {
            ...
            if (flag && !flag3)
            {
                ...
                if (zzaHk != null && !zzaHk.isEmpty())
                {
                    mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", zzaHk);
                } else
                {
                    mIntent.removeExtra("android.intent.extra.STREAM");
                }
        ...
        {
            zzu.zzb(zzaHj, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean flag;
            if (!TextUtils.isEmpty(s))
            {
                flag = true;
            ...
            zzu.zzb(flag, "The deepLinkId parameter is required.");
