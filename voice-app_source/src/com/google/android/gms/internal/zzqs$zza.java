...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            zza(parcel1, bundle, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 2: // '\002'
            ...
            zza(parcel1, bundle1, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 3: // '\003'
            ...
            zza(s, s1, parcel1, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 5: // '\005'
            ...
            zza(parcel1, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 6: // '\006'
            ...
            zza(parcel1, bundle2, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 7: // '\007'
            ...
            zza(parcel1, bundle3, zzdJ(parcel.readStrongBinder()));
            return true;
        ...
        case 8: // '\b'
            ...
            zza(parcel1, bundle4, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        case 11: // '\013'
            ...
            zzb(parcel1, zzdK(parcel.readStrongBinder()));
            return true;
        ...
        zza(parcel1, bundle5, zzdK(parcel.readStrongBinder()));
        return true;
    }
}
