    ...
    extends IInterface
{
        ...
        implements zzcm
    {
        ...
        public static zzcm zzu(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof zzcm))
            {
                return (zzcm)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                zza(parcel.readString(), com.google.android.gms.dynamic.zzd.zza.zzbg(parcel.readStrongBinder()));
            ...
            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
                zzb(com.google.android.gms.dynamic.zzd.zza.zzbg(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
