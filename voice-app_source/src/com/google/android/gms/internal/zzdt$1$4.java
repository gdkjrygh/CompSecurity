...
class zzwV extends TimerTask
{

    final zzbb zzwV;
    final client.zzb.zzaB zzwW;
...
label0:
        {
            ...
            {
                if (zzwW.wT.getStatus() != -1 && zzwW.wT.getStatus() != 1)
                {
                    break label0;
                }
            }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            (new Timer()).schedule(new zzdt._cls1._cls4(this, zzbb1), zzdt.zza.zzxc);
        }
