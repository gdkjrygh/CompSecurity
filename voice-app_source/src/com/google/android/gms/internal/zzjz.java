...
public class zzjz
{
    ...
    private static final String zzVt = (new StringBuilder()).append("yyyyMMdd'T'HHmmss").append(zzVs[0]).toString();
    ...
    public static String zza(Calendar calendar)
    {
        ...
        } else
        {
            ...
            {
                return ((String) (obj)).replace("+0000", zzVs[0]);
            }
        }
        return calendar;
    }
...
_L1:
    ...
    public static Calendar zzbK(String s)
    {
        ...
        {
            zzQW.zzb("Error parsing string: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
    ...
    private static String zzbL(String s)
    {
        ...
        {
            zzQW.zze("Error extracting the date: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L2:
        ...
        {
            zzQW.zzb("Error extracting the time substring: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L3:
        return null;
_L4:
        if (!zzbN(s)) goto _L7; else goto _L6
_L6:
        return s.replaceAll("([\\+\\-]\\d\\d):(\\d\\d)", "$1$2");
        if (s.length() != "HHmmss".length() + zzVs[0].length()) goto _L7; else goto _L8
_L8:
