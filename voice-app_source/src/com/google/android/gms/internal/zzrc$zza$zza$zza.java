...
public static final class zzBp extends zzrh
{
...
_L2:
        ...
        obj = (zzBp)obj;
        flag = flag1;
        if (!Arrays.equals(zzaVq, ((zzaVq) (obj)).zzaVq))
        {
            continue; /* Loop/switch isn't completed */
        }
        if (zzaVr != null)
        ...
        flag = flag1;
        if (((zzaVr) (obj)).zzaVr != null)
        {
            continue; /* Loop/switch isn't completed */
        }
_L5:
        flag = flag1;
        if (Double.doubleToLongBits(zzaVs) == Double.doubleToLongBits(((zzaVs) (obj)).zzaVs))
        {
            flag = flag1;
            if (Float.floatToIntBits(zzaVt) == Float.floatToIntBits(((zzaVt) (obj)).zzaVt))
            {
                flag = flag1;
                if (zzaVu == ((zzaVu) (obj)).zzaVu)
                {
                    flag = flag1;
                    if (zzaVv == ((zzaVv) (obj)).zzaVv)
                    {
                        flag = flag1;
                        if (zzaVw == ((zzaVw) (obj)).zzaVw)
                        {
                            flag = flag1;
                            if (zzaVx == ((zzaVx) (obj)).zzaVx)
                            {
                                flag = flag1;
                                if (zzrl.equals(zzaVy, ((zzaVy) (obj)).zzaVy))
                                {
                                    flag = flag1;
                                    if (zzrl.equals(zzaVz, ((zzaVz) (obj)).zzaVz))
                                    {
                                        flag = flag1;
                                        if (zzrl.equals(zzaVA, ((zzaVA) (obj)).zzaVA))
                                        {
                                            flag = flag1;
                                            if (zzrl.equals(zzaVB, ((zzaVB) (obj)).zzaVB))
                                            {
                                                flag = flag1;
                                                if (zzrl.equals(zzaVC, ((zzaVC) (obj)).zzaVC))
                                                {
                                                    flag = flag1;
                                                    if (zzaVD == ((zzaVD) (obj)).zzaVD)
                                                    {
                                                        return zza(((zzrh) (obj)));
                                                    }
                                                }
...
_L3:
        if (!zzaVr.equals(((zzaVr) (obj)).zzaVr))
        {
            return false;
        }
          goto _L5
        ...
        throws IOException
    {
        do
        {
            ...
            case 74: // 'J'
                ...
                if (j != 0)
                {
                    System.arraycopy(zzaVy, 0, azzy, 0, j);
                    i2 = j;
                }
            ...
            case 82: // 'R'
                ...
                azzy1 = new zzaVz[j2 + k];
                j2 = k;
                if (k != 0)
                {
                    System.arraycopy(zzaVz, 0, azzy1, 0, k);
                    j2 = k;
                }
