        ...
        if (UAirship.shared().isFlying())
        {
            ...
            instance.locationConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName componentname, IBinder ibinder)
                {
                    ...
                    {
                        UALocationManager.context.sendBroadcast((new Intent(UALocationManager.context, UALocationManager.instance.intentReceiver)).setAction("com.urbanairship.location.LOCATION_SERVICE_BOUND"));
                    }
                }
                ...
                public void onServiceDisconnected(ComponentName componentname)
                {
                    ...
                    if (UALocationManager.instance.intentReceiver != null)
                    {
                        UALocationManager.context.sendBroadcast((new Intent(UALocationManager.context, UALocationManager.instance.intentReceiver)).setAction("com.urbanairship.location.LOCATION_SERVICE_UNBOUND"));
                    }
