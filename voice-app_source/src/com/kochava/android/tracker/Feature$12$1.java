...
class val.fAdUrl extends Thread
{
    ...
    public void run()
    {
        ...
        adWebview.setOnTouchListener(new android.view.View.OnTouchListener() {
            ...
            final Feature._cls12._cls1 this$2;
            ...
            {
                this$2 = Feature._cls12._cls1.this;
                super();
            }
        });
        adWebview.getSettings().setJavaScriptEnabled(true);
        Logging.Log((new StringBuilder()).append("Loading add ").append(val$fAdUrl).toString());
        adWebview.loadUrl(val$fAdUrl);
    }
