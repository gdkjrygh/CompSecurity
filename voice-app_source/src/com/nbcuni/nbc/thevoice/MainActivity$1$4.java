    ...
    implements android.content.nCancelListener
{
    ...
    {
        dialoginterface = (new StringBuilder("{\"commandId\":\"")).append(val$commandId).append("\",\"type\":\"CommandResult\",\"subject\":\"OpenDialog\",\"payload\":{\"pressed\":\"Nothing\"}}").toString();
        ...
        implements JavaScriptListener
    {
        ...
        public void openDialog(String s, String s1, final String commandId, final String firstButton, final String secondButton)
        {
            ...
            } else
            {
                ...
                (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 5)).setTitle(s2).setMessage(s1).setView(s).setPositiveButton(firstButton, new MainActivity._cls1._cls2()).setNegativeButton(secondButton, new MainActivity._cls1._cls3()).setOnCancelListener(commandId. new MainActivity._cls1._cls4()).show();
                return;
            }
        }
