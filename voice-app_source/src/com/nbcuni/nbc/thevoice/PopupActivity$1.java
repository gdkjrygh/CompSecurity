    ...
    implements PopupJSListener
{
    ...
    public void hideLoadingScreen()
    {
        runOnUiThread(new Runnable() {
            ...
            final PopupActivity._cls1 this$1;

            public void run()
            {
                PopupActivity.access$6(this$0).clearAnimation();
                PopupActivity.access$7(this$0).setVisibility(8);
                if (PopupActivity.access$8(this$0) != null)
                {
                    PopupActivity.access$8(this$0).cancel();
                }
            }

            
            {
                this$1 = PopupActivity._cls1.this;
                super();
            }
        });
    }
    ...
    {
        android.content.s.Editor editor = sharedPreferences.edit();
