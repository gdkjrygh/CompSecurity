    ...
    implements android.content.CancelListener
{
    ...
    {
        this$1 = final__pcls0;
        val$result = JsPromptResult.this;
        super();
    }
...
/* anonymous class */
    class MainActivity._cls13 extends WebChromeClient
    {
        ...
        public boolean onJsPrompt(WebView webview, String s, String s1, String s2, final JsPromptResult result)
        {
            ...
            (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 4)).setTitle("Dialog").setView(webview).setPositiveButton(0x104000a, new MainActivity._cls13._cls4()).setNegativeButton(0x1040000, new MainActivity._cls13._cls5()).setOnCancelListener(result. new MainActivity._cls13._cls6()).show();
            return true;
        }
        ...
        // Unreferenced inner class com/nbcuni/nbc/thevoice/MainActivity$13$1

/* anonymous class */
        class MainActivity._cls13._cls1 extends WebViewClient
        {
            ...
            public boolean shouldOverrideUrlLoading(WebView webview, String s)
            {
                if (s.contains("emopenwebview"))
                {
                    ...
                    {
                        webview = new Intent(this$0, com/nbcuni/nbc/thevoice/PopupActivity);
