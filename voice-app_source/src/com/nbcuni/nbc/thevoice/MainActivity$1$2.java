    ...
    implements android.content.nClickListener
{
    ...
    {
        dialoginterface = (new StringBuilder("{\"commandId\":\"")).append(val$commandId).append("\",\"type\":\"CommandResult\",\"subject\":\"OpenDialog\",\"payload\":{\"pressed\":\"").append(val$firstButton).append("\"}}").toString();
...
/* anonymous class */
        ...
        implements JavaScriptListener
    {
        ...
        public void openDialog(String s, String s1, final String commandId, String s2, final String secondButton)
        {
            String s3 = s;
            if (s == null)
            {
            ...
            } else
            {
                ...
                (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 5)).setTitle(s3).setMessage(s1).setView(s).setPositiveButton(s2, s2. new MainActivity._cls1._cls2()).setNegativeButton(secondButton, new MainActivity._cls1._cls3()).setOnCancelListener(new MainActivity._cls1._cls4()).show();
                return;
            }
        }
