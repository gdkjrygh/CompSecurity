    ...
    implements com.facebook.back
{
    ...
    {
        String s = (new StringBuilder("{\"commandId\":\"")).append(val$commandId).append("\",\"type\":\"CommandResult\",\"subject\":\"FacebookGraphRequest\",\"payload\":").append(graphresponse.getRawResponse()).append("}").toString();
        sendMessageToJS(s);
...
/* anonymous class */
        ...
        implements JavaScriptListener
    {
        ...
        public void facebookGraphRequest(String s, String s1, HttpMethod httpmethod, String s2)
        {
            ...
            (new GraphRequest(AccessToken.getCurrentAccessToken(), (new StringBuilder("/")).append(s1).toString(), bundle, httpmethod, s. new MainActivity._cls1._cls1())).executeAsync();
        }
        ...
        public void openDialog(String s, String s1, final String commandId, final String firstButton, final String secondButton)
        {
            String s2 = s;
            if (s == null)
            {
                s2 = getString(0x7f080049);
            }
            ...
            } else
            {
                ...
                (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 5)).setTitle(s2).setMessage(s1).setView(s).setPositiveButton(firstButton, new MainActivity._cls1._cls2()).setNegativeButton(secondButton, new MainActivity._cls1._cls3()).setOnCancelListener(new MainActivity._cls1._cls4()).show();
                return;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/nbcuni/nbc/thevoice/MainActivity$1$3

/* anonymous class */
        class MainActivity._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
