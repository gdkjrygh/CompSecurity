...
/* anonymous class */
    class MainActivity._cls13 extends WebChromeClient
    {
        ...
        public boolean onJsPrompt(WebView webview, String s, String s1, String s2, final JsPromptResult result)
        {
            ...
            (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 4)).setTitle("Dialog").setView(webview).setPositiveButton(0x104000a, new MainActivity._cls13._cls4()).setNegativeButton(0x1040000, result. new MainActivity._cls13._cls5()).setOnCancelListener(new MainActivity._cls13._cls6()).show();
            return true;
        }
