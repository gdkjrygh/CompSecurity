...
/* anonymous class */
    class MainActivity._cls13 extends WebChromeClient
    {
        ...
        {
            (new android.app.AlertDialog.Builder(MainActivity.access$8(MainActivity.this), 4)).setTitle("Dialog").setMessage(s1).setPositiveButton(0x104000a, new MainActivity._cls13._cls2()).setNegativeButton(0x1040000, result. new MainActivity._cls13._cls3()).create();
