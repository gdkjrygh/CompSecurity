...
_L1:
    ...
    private static String getBaseURL()
    {
        if (analyticsGetBaseURL_pred)
        {
            ...
            baseURL = stringbuilder.append(s).append(MobileConfig.getInstance().getTrackingServer()).append("/b/ss/").append(StaticMethods.URLEncode(MobileConfig.getInstance().getReportSuiteIds())).append("/0/JAVA-").append("4.5.0-AN").append("/s").toString();
