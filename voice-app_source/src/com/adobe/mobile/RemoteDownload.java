...
_L3:
            ...
            obj3 = RemoteDownload.createRFC2822Formatter();
...
_L5:
            ...
            if (obj != null)
            {
                ...
                {
                    httpurlconnection.setRequestProperty("If-Modified-Since", ((SimpleDateFormat) (obj3)).format(long1));
                }
                if (s != null)
                {
...
_L18:
            ...
            StaticMethods.logWarningFormat("Cached Files - IOException while making request (%s)", new Object[] {
                ((IOException) (obj4)).getLocalizedMessage()
            });
            obj1 = obj7;
            obj3 = ioexception;
            if (callback == null)
...
_L16:
            ...
            StaticMethods.logWarningFormat("Cached Files - Unexpected exception while attempting to get remote file (%s)", new Object[] {
                ((Exception) (obj5)).getLocalizedMessage()
            });
            obj1 = ioexception;
            obj3 = obj4;
            if (callback == null)
