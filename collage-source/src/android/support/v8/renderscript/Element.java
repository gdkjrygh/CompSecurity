...
_L5:
    ...
    private void updateVisibleSubElements()
    {
        if (mElements != null)
        {
            ...
            mVisibleElementMap = new int[j];
            i = 0;
            j = 0;
            while (j < i1) 
            {
                if (mElementNames[j].charAt(0) != '#')
                {
    ...
    {
        return renderscript.nIncElementCreate(mType.mID, mKind.mID, mNormalized, mVectorSize);
    }
