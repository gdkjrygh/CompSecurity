...
public class ScriptIntrinsicConvolve3x3 extends ScriptIntrinsic
{
    ...
    ScriptIntrinsicConvolve3x3(long l, RenderScript renderscript)
    {
    ...
    public static ScriptIntrinsicConvolve3x3 create(RenderScript renderscript, Element element)
    {
        ...
        renderscript = new ScriptIntrinsicConvolve3x3(renderscript.nScriptIntrinsicCreate(1, element.getID(renderscript), flag), renderscript);
