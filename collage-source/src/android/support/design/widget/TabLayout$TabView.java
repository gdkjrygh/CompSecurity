...
label0:
        {
            flag = true;
            int l = android.view.etSize(i);
            int j1 = android.view.etMode(i);
            int l1 = TabLayout.access$800(TabLayout.this);
            k = i;
            if (l1 <= 0)
            {
                break label0;
            ...
            k = android.view.akeMeasureSpec(TabLayout.access$900(TabLayout.this), j1);
        }
        super.onMeasure(k, j);
