    ...
    implements d
{
        ...
        throws Exception
    {
        ...
        if (context != null)
        {
            ...
            {
                c.h().e("Beta", "Failed to close the APK file", context);
                obj = obj1;
...
_L2:
        d1 = (double)(System.nanoTime() - l1) / 1000000D;
        c.h().a("Beta", (new StringBuilder()).append("Beta device token load took ").append(d1).append("ms").toString());
        return ((String) (obj));
        context;
        obj = obj1;
        c.h().e("Beta", "Failed to find this app in the PackageManager", context);
        obj = s;
        if (obj1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context1;
        c.h().e("Beta", "Failed to find the APK file", context);
        obj = s;
        if (context1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context2;
        c.h().e("Beta", "Failed to read the APK file", context);
        obj = s;
        if (context2 == null)
        {
            continue; /* Loop/switch isn't completed */
...
_L1:
        ...
        if (obj != null)
        {
            ...
            {
                c.h().e("Beta", "Failed to close the APK file", ioexception);
            }
        }
        throw context;
    }
