...
public class SamplingEventFilter
    implements EventFilter
{
    ...
    {
        return !EVENTS_TYPE_TO_SAMPLE.contains(sessionevent.type) || sessionevent.sessionEventMetadata.betaDeviceToken != null;
    }

    boolean shouldSkipEventBasedOnInstallID(SessionEvent sessionevent)
    {
        return Math.abs(sessionevent.sessionEventMetadata.installationId.hashCode() % samplingRate) != 0;
    }
