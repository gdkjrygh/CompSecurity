    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (a != null)
        {
            f.a(a.b(), a.c(), a.d(), StickersActivity.c(c.c).d());
        } else
        {
            f.a(new com.cardinalblue.android.piccollage.model.._cls5.b(b.b()));
        }
        o.a().a(StickersActivity.c(c.c));
    }
...
_L4:
            ...
            arraylist.add(a);
            b.a.a(true, arraylist, new StickersActivity._cls5._cls1(g1));
...
_L2:
            ...
            (new Handler()).post(new StickersActivity._cls5._cls2(this, g1, e1));
            return;
        }
        ...
        // Unreferenced inner class com/cardinalblue/android/piccollage/activities/StickersActivity$5$1

/* anonymous class */
        class StickersActivity._cls5._cls1
