    ...
    implements FacebookCallback
{
    ...
    public void a(LoginResult loginresult)
    {
        ...
        GraphRequest.newMeRequest(loginresult.getAccessToken(), new com.facebook.GraphRequest.GraphJSONObjectCallback() {

            final FbLoginForReadActivity._cls1 a;
            ...
            {
                a = FbLoginForReadActivity._cls1.this;
                super();
            }
        }).executeAsync();
    }
    ...
    _cls1.a(FbLoginForReadActivity fbloginforreadactivity)
    {
