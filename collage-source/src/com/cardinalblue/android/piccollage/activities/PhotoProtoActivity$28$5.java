    ...
    implements i
{
    ...
    public Void a(j j)
        throws Exception
    {
        boolean flag = PhotoProtoActivity.r(b.b).hasText();
        j = a.ab();
        PhotoProtoActivity.r(b.b).setText(j);
        boolean flag1 = PhotoProtoActivity.r(b.b).hasText();
        if (flag ^ flag1)
        {
            com.cardinalblue.android.piccollage.activities.PhotoProtoActivity.b(b.b, true);
        }
        if (flag1)
        {
            com.cardinalblue.android.piccollage.activities.PhotoProtoActivity.b(b.b, String.valueOf(PhotoProtoActivity.r(b.b).getText()));
        }
        return null;
    }
...
/* anonymous class */
        ...
        implements net.a.a.c.a
    {
        ...
        public void a(c c, int l, int i1, ImageView imageview, TextView textview)
        {
...
_L10:
            ...
            a("copy");
            k.a(a, new PhotoProtoActivity._cls28._cls6(g1), a.getString(0x7f0701fa)).c(new PhotoProtoActivity._cls28._cls5(this, g1), k.a).a(new PhotoProtoActivity._cls28._cls4(), k.a);
              goto _L5
        }
