...
class b
    implements com.cardinalblue.android.piccollage.iab.util._cls3
{
    ...
    public void a(e e1, g g1)
    {
        ...
        if (e1.d() && !flag)
        {
            ...
            e1.add(a);
            IabBackgroundActivity.c(c).a(true, e1, new com.cardinalblue.android.piccollage.iab.util.d.e(g1) {
                ...
                public void a(e e2, f f1)
                {
                    if (!e2.d())
                    {
                        ...
                        if (a != null)
                        {
                            IabBackgroundActivity.c(b.c).a(e2, null);
                            return;
                        }
                    }
                }
...
_L3:
    ...
    _cls2.a(IabBackgroundActivity iabbackgroundactivity, String s, StickerBundle stickerbundle)
    {
