    ...
    implements i
{
        ...
        throws Exception
    {
        ...
        k k2;
        for (Iterator iterator = PhotoProtoActivity.d(c.c).t().iterator(); iterator.hasNext(); hashtable.put(Long.valueOf(k2.U()), Integer.valueOf(k2.W())))
        {
            k2 = (k)iterator.next();
        }

        if (!PhotoProtoActivity.e(c.c).c((k)j1.e()))
        {
            return null;
        }
        com.cardinalblue.android.piccollage.activities.PhotoProtoActivity.k(c.c).a("push scrap to bottom");
        j1 = PhotoProtoActivity.d(c.c).t().iterator();
        do
        {
            if (!j1.hasNext())
            {
            ...
            if (l != i1)
            {
                com.cardinalblue.android.piccollage.activities.PhotoProtoActivity.k(c.c).a(new ChangeZIndexOp(k1.U(), l, i1));
            }
        } while (true);
        com.cardinalblue.android.piccollage.activities.PhotoProtoActivity.k(c.c).d();
        PhotoProtoActivity.l(c.c);
        a.setText(PhotoProtoActivity.x(c.c));
        b.setImageDrawable(PhotoProtoActivity.y(c.c));
        return null;
    }
    ...
    b(b b1, TextView textview, ImageView imageview)
    {
        c = b1;
        a = textview;
        b = imageview;
...
/* anonymous class */
        ...
        implements net.a.a.c.a
    {
        ...
        public void a(c c1, int l, int i1, ImageView imageview, TextView textview)
        {
...
_L5:
            ...
            } else
            {
                ...
                PhotoProtoActivity.q(a).c(PhotoProtoActivity.v(a)).c(new PhotoProtoActivity._cls28._cls8(this, textview, imageview), j.b);
                return;
            }
_L3:
...
_L9:
            ...
            {
                com.cardinalblue.android.b.k.a(a, new PhotoProtoActivity._cls28._cls3(g1), a.getString(0x7f0701fa)).c(new PhotoProtoActivity._cls28._cls2(), com.cardinalblue.android.b.k.a).a(new PhotoProtoActivity._cls28._cls1(), com.cardinalblue.android.b.k.a);
            }
              goto _L5
_L10:
            ...
            a("copy");
            com.cardinalblue.android.b.k.a(a, new PhotoProtoActivity._cls28._cls6(g1), a.getString(0x7f0701fa)).c(new PhotoProtoActivity._cls28._cls5(g1), com.cardinalblue.android.b.k.a).a(new PhotoProtoActivity._cls28._cls4(), com.cardinalblue.android.b.k.a);
              goto _L5
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/cardinalblue/android/piccollage/activities/PhotoProtoActivity$28$6

/* anonymous class */
        class PhotoProtoActivity._cls28._cls6
            implements Callable
        {
