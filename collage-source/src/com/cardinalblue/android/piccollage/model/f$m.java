...
public static class  extends f
{
    ...
    {
        list.add(new g(1.0F, 0.33F, 0.0F, 0.67F, b));
        list.add(new g(0.33F, 0.67F, 0.0F, 0.0F, b));
        list.add(new g(0.34F, 0.67F, 0.33F, 0.0F, b));
        list.add(new g(0.33F, 0.67F, 0.67F, 0.0F, b));
        b(i - 4, list);
    }
