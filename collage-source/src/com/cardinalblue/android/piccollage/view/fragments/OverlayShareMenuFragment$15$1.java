    ...
    implements Callable
{
    ...
    // Unreferenced inner class com/cardinalblue/android/piccollage/view/fragments/OverlayShareMenuFragment$15

/* anonymous class */
    class OverlayShareMenuFragment._cls15
        implements i
    {
        ...
        public j a(j j1)
            throws Exception
        {
            j.a(new OverlayShareMenuFragment._cls15._cls1(this, j1));
