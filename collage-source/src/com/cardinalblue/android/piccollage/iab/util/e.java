...
public class e
{
    ...
    public e(int i, String s)
    {
        ...
        {
            b = com.cardinalblue.android.piccollage.iab.util.d.a(i);
            return;
        } else
        {
            b = (new StringBuilder()).append(s).append(" (response: ").append(com.cardinalblue.android.piccollage.iab.util.d.a(i)).append(")").toString();
            return;
        }
    }
