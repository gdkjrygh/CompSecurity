...
public final class FlurryEventRecordStatus extends Enum
{
    ...
    static 
    {
        ...
        a = (new FlurryEventRecordStatus[] {
            kFlurryEventFailed, kFlurryEventRecorded, kFlurryEventUniqueCountExceeded, kFlurryEventParamsCountExceeded, kFlurryEventLogCountExceeded, kFlurryEventLoggingDelayed
        });
    }
}
