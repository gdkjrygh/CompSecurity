...
public class c
{
    ...
    public c(q q1, Map map, long l, boolean flag)
    {
        this(q1, map, l, flag, 0L, 0, null);
    }

    public c(q q1, Map map, long l, boolean flag, long l1, 
            int i)
    {
        this(q1, map, l, flag, l1, i, null);
    }
            ...
            int i, List list)
    {
        ...
        do
        {
            ...
            if (a(entry1.getKey()))
            {
                String s1 = a(q1, entry1.getKey());
                if (s1 != null)
                {
                    list.put(s1, b(q1, entry1.getValue()));
                }
            }
        } while (true);
        ...
        do
        {
            ...
            if (!a(entry.getKey()))
            {
                String s = a(q1, entry.getKey());
                if (s != null)
                {
                    list.put(s, b(q1, entry.getValue()));
                }
            }
        } while (true);
    ...
    public static c a(q q1, c c1, Map map)
    {
        return new c(q1, map, c1.d(), c1.f(), c1.c(), c1.a(), c1.e());
    }

    private static String a(q q1, Object obj)
    {
        if (obj == null)
        {
            q1 = null;
        } else
        {
            ...
            if (i > 256)
            {
                ...
                q1.c("Hit param name is too long and will be trimmed", Integer.valueOf(i), obj1);
            }
            q1 = ((q) (obj1));
    ...
    private String a(String s, String s1)
    {
        ...
        z.b(flag, "Short param name required");
        s = (String)a.get(s);
        if (s != null)
        {
            return s;
...
_L6:
    ...
    private static String b(q q1, Object obj)
    {
        Object obj1;
        int i;
        if (obj == null)
        ...
        if (i > 8192)
        {
            ...
            q1.c("Hit param value is too long and will be trimmed", Integer.valueOf(i), obj1);
        }
        return ((String) (obj1));
    }
