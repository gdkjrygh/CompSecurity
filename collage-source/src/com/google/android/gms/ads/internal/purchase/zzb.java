...
public class zzb
{
    ...
    {
        zzBM = mContext.getClassLoader().loadClass("com.android.vending.billing.IInAppBillingService$Stub").getDeclaredMethod("asInterface", new Class[] {
            android/os/IBinder
...
_L1:
    ...
    public int zza(int i, String s, String s1)
    {
        try
        {
            ...
            }).invoke(class1.cast(zzBM), new Object[] {
