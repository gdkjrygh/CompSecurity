...
public class zzh
{
    public class zza extends SQLiteOpenHelper
    {
        ...
        {
            sqlitedatabase.execSQL(zzh.zzfj());
        }
...
_L2:
        ...
        sqliteexception;
        obj1 = obj;
        com.google.android.gms.ads.internal.util.client.zzb.zzaE((new StringBuilder()).append("Error getting record count").append(sqliteexception.getMessage()).toString());
...
_L1:
    ...
    public void zzb(zzf zzf1)
    {
        ...
        zzf1.zzCd = sqlitedatabase.insert("InAppPurchase", null, contentvalues);
