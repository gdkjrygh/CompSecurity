    ...
    implements MediationBannerAdapter, MediationInterstitialAdapter, com.millennialmedia.InlineAd.f, com.millennialmedia.InterstitialAd.d
{
    ...
    private static final String a = com/google/ads/mediation/millennial/MillennialAdapter.getSimpleName();
...
label0:
    ...
    static MediationBannerListener a(MillennialAdapter millennialadapter)
    {
        return millennialadapter.f;
    }
    ...
    static MediationInterstitialListener b(MillennialAdapter millennialadapter)
    {
        return millennialadapter.g;
    }
    ...
    public void a(InlineAd inlinead)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdLoaded(a);
            }

            
            {
                a = MillennialAdapter.this;
                super();
            }
        });
    ...
    public void a(InlineAd inlinead, com.millennialmedia.InlineAd.e e1)
    {
        ...
        default:
            b.post(new Runnable() {
                ...
                public void run()
                {
                    com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdFailedToLoad(a, 3);
                }
        ...
        case 7: // '\007'
            b.post(new Runnable() {
                ...
                public void run()
                {
                    com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdFailedToLoad(a, 0);
                }
        ...
        case 6: // '\006'
            b.post(new Runnable() {
                ...
                public void run()
                {
                    com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdFailedToLoad(a, 2);
                }
    ...
    public void a(InterstitialAd interstitialad)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdLoaded(a);
            }
...
_L1:
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdFailedToLoad(a, 3);
            }
...
_L6:
        Log.i(a, (new StringBuilder()).append("Millennial interstitial request failed (").append(c1.a()).append("): ").append(c1.b()).toString());
        return;
_L4:
...
_L2:
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdFailedToLoad(a, 0);
            }
...
_L3:
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdFailedToLoad(a, 2);
            }
...
_L5:
    ...
    public boolean a(Bundle bundle, Bundle bundle1)
    {
        ...
        try
        {
            a1 = (new a()).b("AdMobMillennialAdapter").a(null);
        }
    ...
    public void b(InlineAd inlinead)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdClicked(a);
            }
    ...
    public void b(InterstitialAd interstitialad)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdOpened(a);
            }
    ...
    public void c(InlineAd inlinead)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdOpened(a);
            }
    ...
    public void c(InterstitialAd interstitialad)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdClosed(a);
            }
    ...
    public void d(InlineAd inlinead)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdClosed(a);
            }
    ...
    public void d(InterstitialAd interstitialad)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdClicked(a);
            }
    ...
    public void e(InlineAd inlinead)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdLeftApplication(a);
            }
    ...
    public void e(InterstitialAd interstitialad)
    {
        b.post(new Runnable() {
            ...
            public void run()
            {
                com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdLeftApplication(a);
            }
    ...
    public void onDestroy()
    {
        if (c != null)
        {
            c.a(new com.millennialmedia.InlineAd.c() {
                ...
                public void a(InlineAd inlinead)
                {
                    Log.d(com.google.ads.mediation.millennial.MillennialAdapter.a(), "Abort succeeded.");
                }

                public void b(InlineAd inlinead)
                {
                    Log.w(com.google.ads.mediation.millennial.MillennialAdapter.a(), "Request to abort failed.");
                }
    ...
    public void requestBannerAd(Context context, MediationBannerListener mediationbannerlistener, Bundle bundle, AdSize adsize, MediationAdRequest mediationadrequest, Bundle bundle1)
    {
        ...
        {
            c = InlineAd.a(s, e);
            mediationbannerlistener = (new com.millennialmedia.InlineAd.d()).a(new com.millennialmedia.InlineAd.a(mediationbannerlistener.getWidth(), mediationbannerlistener.getHeight()));
        }
        // Misplaced declaration of an exception variable
        catch (MediationBannerListener mediationbannerlistener)
        {
            Log.e(a, (new StringBuilder()).append("MMSDK Adapter error: ").append(mediationbannerlistener.getMessage()).toString(), mediationbannerlistener);
            ((Activity)context).runOnUiThread(new Runnable() {
                ...
                public void run()
                {
                    com.google.ads.mediation.millennial.MillennialAdapter.a(a).onAdFailedToLoad(a, 1);
                }
    ...
    public void requestInterstitialAd(Context context, MediationInterstitialListener mediationinterstitiallistener, Bundle bundle, MediationAdRequest mediationadrequest, Bundle bundle1)
    {
        ...
        // Misplaced declaration of an exception variable
        catch (MediationInterstitialListener mediationinterstitiallistener)
        {
            Log.e(a, (new StringBuilder()).append("MMSDK Adapter error: ").append(mediationinterstitiallistener.getMessage()).toString(), mediationinterstitiallistener);
            ((Activity)context).runOnUiThread(new Runnable() {
                ...
                public void run()
                {
                    com.google.ads.mediation.millennial.MillennialAdapter.b(a).onAdFailedToLoad(a, 1);
                }
