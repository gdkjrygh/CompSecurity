...
_L2:
        ...
        com.aviary.android.feather.cds.AviaryCdsService.a(f, f.getBaseContext(), a1, b, 1, c);
        com.aviary.android.feather.common.utils.d.a(a1);
          goto _L3
        Object obj;
        obj;
        com.aviary.android.feather.cds.AviaryCdsService.a.Context("onParseJsonContent failed: '%s' for packUrl: %s", new Object[] {
    ...
    (AviaryCdsService aviarycdsservice, AtomicBoolean atomicboolean, int i, String s, String s1, AtomicInteger atomicinteger)
    {
        f = aviarycdsservice;
        a = atomicboolean;
        b = i;
