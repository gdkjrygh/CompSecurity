...
public final class ex extends ArrayAdapter
{
    ...
    public ex(Context context, List list, int i)
    {
    ...
    public final View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        viewgroup = dz.a(viewgroup.getContext(), "20dip", "20dip", 9);
        viewgroup.addRule(0, 2303);
        relativelayout.addView(((View) (obj)), viewgroup);
        dz.b(((View) (obj)), "6dip", "6dip", "6dip", "6dip");
