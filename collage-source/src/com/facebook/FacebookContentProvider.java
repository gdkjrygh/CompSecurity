...
public class FacebookContentProvider extends ContentProvider
{
    ...
    private static final String TAG = com/facebook/FacebookContentProvider.getName();
        ...
        throws FileNotFoundException
    {
        ...
        try
        {
            uri = ParcelFileDescriptor.open(NativeAppCallAttachmentStore.openAttachment((UUID)((Pair) (uri)).first, (String)((Pair) (uri)).second), 0x10000000);
        }
