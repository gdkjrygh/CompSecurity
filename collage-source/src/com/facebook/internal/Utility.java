        ...
        } else
        {
            ...
            FacebookSdk.getExecutor().execute(new Runnable(context, s1, s) {
                ...
                public void run()
                {
                    ...
                    Object obj = sharedpreferences.getString(settingsKey, null);
                    ...
                    obj = Utility.getAppSettingsQueryResponse(applicationId);
                    if (obj != null)
                    {
                        Utility.parseAppSettingsFromJSON(applicationId, ((JSONObject) (obj)));
                        sharedpreferences.edit().putString(settingsKey, ((JSONObject) (obj)).toString()).apply();
                    }
