...
public class b
{
    ...
    {
        int i = 0;
        com.facebook.ads.internal.server.d d1 = new com.facebook.ads.internal.server.d();
        Object obj = jsonobject.getJSONArray("placements").getJSONObject(0);
        jsonobject = d.a(((JSONObject) (obj)).getJSONObject("definition"));
        d1.a.a(jsonobject);
        jsonobject = jsonobject.a();
        if (((JSONObject) (obj)).has("ads"))
        {
            for (obj = ((JSONObject) (obj)).getJSONArray("ads"); i < ((JSONArray) (obj)).length(); i++)
            {
    ...
    {
        return new e(jsonobject.optString("message", ""));
    }
