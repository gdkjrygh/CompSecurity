...
public class o extends AsyncTask
{
    ...
    private boolean a(String s1)
    {
        ...
        if (d == null || d.size() == 0)
        {
            ...
            int i;
            if (((HttpClient) (obj)).execute(new HttpGet(s1)).getStatusLine().getStatusCode() == 200)
            {
                flag = true;
            } else
            {
        ...
        try
        {
            ...
            for (iterator = d.entrySet().iterator(); iterator.hasNext(); arraylist.add(new BasicNameValuePair((String)entry.getKey(), (String)entry.getValue())))
            {
        ...
        {
            Log.e(a, (new StringBuilder()).append("Error opening url: ").append(s1).toString(), ((Throwable) (obj)));
            return false;
        }
