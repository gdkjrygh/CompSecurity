...
//            RemoteDownloadingResult

public interface IWatchWarningBoxUtilService
    extends IInterface
{
        ...
        implements IWatchWarningBoxUtilService
    {
        ...
        public static IWatchWarningBoxUtilService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.wsi.android.framework.wxdata.geodata.helpers.IWatchWarningBoxUtilService");
...
_L3:
    ...
    public abstract RemoteDownloadingResult getWatchWarningBoxCollection(String s, int i, String s1, long l, boolean flag)
        throws RemoteException;
}
