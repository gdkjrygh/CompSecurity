    ...
    implements SessionListener
{
    ...
    {
        if (fq. != null && state.isStarted())
        {
            if (state == com.sessionm.api.nM.State.STARTED_ONLINE && fq.session.C().isOptedOut() == fq.)
            {
                fq..OptInSucceeded();
            } else
            {
...
_L1:
            session.a(new g._cls1._cls1(this));
...
_L2:
            ...
            obj1 = session.N();
            ((RequestQueue) (obj1)).a(((Request) (obj)), new g._cls1._cls2());
        ...
        // Unreferenced inner class com/sessionm/core/g$1$2

/* anonymous class */
        class g._cls1._cls2 extends c
        {
