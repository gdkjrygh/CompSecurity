...
public final class Analytics
{
    public static final class BEACON_PROXIMITY extends Enum
    {
        ...
        static 
        {
            PROXIMITY_UNKNOWN = new BEACON_PROXIMITY("PROXIMITY_UNKNOWN", 0);
            PROXIMITY_IMMEDIATE = new BEACON_PROXIMITY("PROXIMITY_IMMEDIATE", 1);
            PROXIMITY_NEAR = new BEACON_PROXIMITY("PROXIMITY_NEAR", 2);
            PROXIMITY_FAR = new BEACON_PROXIMITY("PROXIMITY_FAR", 3);
            $VALUES = (new BEACON_PROXIMITY[] {
                PROXIMITY_UNKNOWN, PROXIMITY_IMMEDIATE, PROXIMITY_NEAR, PROXIMITY_FAR
            });
        }

        private BEACON_PROXIMITY(String s, int i)
        {
            super(s, i);
        }
    }
