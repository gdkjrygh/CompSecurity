...
public class Call
{
        ...
        implements Interceptor.Chain
    {
            ...
            throws IOException
        {
            ...
            {
                request1 = new ApplicationInterceptorChain(index + 1, request1);
                return ((Interceptor)client.interceptors().get(index)).intercept(request1);
            } else
            {
                return getResponse(request1, false);
            }
        }
        ...
        ApplicationInterceptorChain(int i, Request request1)
        {
            this$0 = Call.this;
            super();
            index = i;
...
_L7:
        ...
        throws IOException
    {
        ...
        obj = getResponseWithInterceptorChain();
        if (obj != null)
        {
