...
public class AlertShareableMessage
    implements ShareableMessage
{
    ...
    public AlertShareableMessage(Collection collection, LocationManager locationmanager, ConfigurationManagers configurationmanagers)
    {
    ...
    public String getHTMLMessageBody()
    {
        ...
        for (Iterator iterator = messages.iterator(); iterator.hasNext(); stringbuilder.append(alertmessage.getPresentationName()).append("<br/>").append(AbstractTwcApplication.getRootContext().getResources().getString(com.weather.commons.R.string.share_post_text, new Object[] {
