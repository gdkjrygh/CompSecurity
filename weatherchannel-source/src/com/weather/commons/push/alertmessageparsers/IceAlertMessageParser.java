...
public class IceAlertMessageParser
    implements JsonParser
{

    public IceAlertMessageParser()
    {
    }

    public IceAlertMessage parse(JSONObject jsonobject)
        throws JSONException
    {
        return new IceAlertMessage(jsonobject.getString(AlertResponseField.SIGNIFICANT_WEATHER_ALERT_LOCALIZED_TEXT.getName()));
    }
