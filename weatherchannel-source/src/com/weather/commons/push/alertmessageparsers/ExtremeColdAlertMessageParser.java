...
public class ExtremeColdAlertMessageParser
    implements JsonParser
{

    public ExtremeColdAlertMessageParser()
    {
    }

    public ExtremeColdAlertMessage parse(JSONObject jsonobject)
        throws JSONException
    {
        return new ExtremeColdAlertMessage(jsonobject.getString(AlertResponseField.SIGNIFICANT_WEATHER_ALERT_LOCALIZED_TEXT.getName()));
    }
