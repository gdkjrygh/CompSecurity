...
public class ThunderStormAlertMessage extends SignificantWeatherAlertMessage
{

    public ThunderStormAlertMessage(String s)
    {
        super(ProductType.THUNDERSTORM, AbstractTwcApplication.getRootContext().getString(com.weather.commons.R.string.significant_weather_thunderstorm_title), s);
    }
    ...
    protected String getUrlTemplate(ConfigurationManagers configurationmanagers)
    {
        try
        {
            configurationmanagers = configurationmanagers.getFlagshipConfig().thunderstormAlertShareUrl;
        }
