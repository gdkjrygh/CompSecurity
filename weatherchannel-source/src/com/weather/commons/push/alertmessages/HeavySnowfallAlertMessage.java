...
public class HeavySnowfallAlertMessage extends SignificantWeatherAlertMessage
{
    ...
    public HeavySnowfallAlertMessage(String s)
    {
        super(ProductType.HEAVY_SNOWFALL, AbstractTwcApplication.getRootContext().getString(com.weather.commons.R.string.significant_weather_heavy_snowfall_title), s);
    }
    ...
    protected String getUrlTemplate(ConfigurationManagers configurationmanagers)
    {
        try
        {
            configurationmanagers = configurationmanagers.getFlagshipConfig().heavySnowfallAlertShareUrl;
        }
