...
public class DenseFogAlertMessage extends SignificantWeatherAlertMessage
{
    ...
    public DenseFogAlertMessage(String s)
    {
        super(ProductType.DENSE_FOG, AbstractTwcApplication.getRootContext().getString(com.weather.commons.R.string.significant_weather_dense_fog_title), s);
    }
    ...
    protected String getUrlTemplate(ConfigurationManagers configurationmanagers)
    {
        try
        {
            configurationmanagers = configurationmanagers.getFlagshipConfig().denseFogAlertShareUrl;
        }
