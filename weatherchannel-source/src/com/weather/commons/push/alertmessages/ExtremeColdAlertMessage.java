...
public class ExtremeColdAlertMessage extends SignificantWeatherAlertMessage
{

    public ExtremeColdAlertMessage(String s)
    {
        super(ProductType.EXTREME_COLD, AbstractTwcApplication.getRootContext().getString(com.weather.commons.R.string.significant_weather_extreme_cold_title), s);
    }
    ...
    protected String getUrlTemplate(ConfigurationManagers configurationmanagers)
    {
        try
        {
            configurationmanagers = configurationmanagers.getFlagshipConfig().extremeColdAlertShareUrl;
        }
