    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        cess._mth000(this._cls1.this).onCompletion(VideoAssetList.fromJsonString(s).getVideos(), val$userData);
        return;
        Object obj;
        obj;
_L2:
        VideoDmaConnection.access$200(_fld0).invalidate(cess._mth100(this._cls1.this));
