    ...
    implements Runnable
{
    ...
    public void run()
    {
        java.util.List list = VideoOrderedListEndpoint.fromJsonString(Files.toString(new File(val$result), Charsets.UTF_8)).getVideos();
        cess._mth000(this._cls1.this).onCompletion(list, val$userData);
        return;
        Object obj;
        obj;
_L2:
        VideoPlaylistConnection.access$200(_fld0).invalidate(cess._mth100(this._cls1.this));
