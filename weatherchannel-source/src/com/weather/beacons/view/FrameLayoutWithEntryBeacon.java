...
public class FrameLayoutWithEntryBeacon extends FrameLayout
    implements ViewGroupWithEntryBeacon
{
    ...
    public FrameLayoutWithEntryBeacon(Context context, AttributeSet attributeset)
    {
        ...
        context = context.getTheme().obtainStyledAttributes(attributeset, com.weather.ads2.R.styleable.FrameLayoutWithEntryBeacon, 0, 0);
        entryBeaconString = context.getString(com.weather.ads2.R.styleable.FrameLayoutWithEntryBeacon_entry_beacon);
        context.recycle();
    }
    ...
    public FrameLayoutWithEntryBeacon(Context context, AttributeSet attributeset, int i)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, com.weather.ads2.R.styleable.FrameLayoutWithEntryBeacon, i, 0);
        entryBeaconString = context.getString(com.weather.ads2.R.styleable.FrameLayoutWithEntryBeacon_entry_beacon);
        context.recycle();
    }
