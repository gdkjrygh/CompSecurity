...
public interface CurrentConditionsRecord
    extends Record
{
    public static interface CurrentConditionsDoc
    {
    ...
    public static interface CurrentConditionsDoc.CurrentConditionsData
    {
    ...
    public static interface CurrentConditionsDoc.CurrentConditionsHeader
    {
    ...
    public abstract CurrentConditionsDoc getMoDoc();
}
