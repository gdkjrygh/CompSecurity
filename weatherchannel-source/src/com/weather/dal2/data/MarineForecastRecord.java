...
public interface MarineForecastRecord
    extends Record
{
    public static interface MarineForecastDoc
    {
    ...
    public static interface MarineForecastDoc.MarineForecastData
    {
    ...
    public static interface MarineForecastDoc.MarineForecastHeader
    {
    ...
    public abstract MarineForecastDoc getMarineForecastDoc();
}
