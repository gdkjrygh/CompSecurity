    ...
    extends Freezable
{
    ...
    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$AgeRange
    /* block-local class not found */
    class AgeRange {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$Cover
    /* block-local class not found */
    class Cover {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$Gender
    /* block-local class not found */
    class Gender {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$Name
    /* block-local class not found */
    class Name {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$ObjectType
    /* block-local class not found */
    class ObjectType {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$Organizations
    /* block-local class not found */
    class Organizations {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$PlacesLived
    /* block-local class not found */
    class PlacesLived {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$RelationshipStatus
    /* block-local class not found */
    class RelationshipStatus {}


    // Unreferenced inner class com/google/android/gms/plus/model/people/Person$Urls
    /* block-local class not found */
    class Urls {}
