...
class or extends AbstractIterator
{
    ...
    protected  computeNext()
    {
        if (val$iterator1.hasNext())
        {
            ...
            return Multisets.immutableEntry(obj, .getCount() + multiset2.count(obj));
        }
    ...
    // Unreferenced inner class com/google/common/collect/Multisets$3

/* anonymous class */
    static final class Multisets._cls3 extends AbstractMultiset
    {
        ...
        {
            return multiset2.entrySet().iterator(). new Multisets._cls3._cls1();
        }
