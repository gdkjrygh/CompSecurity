...
_L3:
            ...
            throws ExecutionException
        {
            ...
            listenablefuture1 = listenablefuture;
            throw new CacheLoader.InvalidCacheLoadException((new StringBuilder(s.length() + 35)).append("CacheLoader returned null for key ").append(s).append(".").toString());
            listenablefuture;
...
_L2:
            ...
            throws ExecutionException
        {
            ...
            referenceentry = String.valueOf(String.valueOf(obj));
            throw new CacheLoader.InvalidCacheLoadException((new StringBuilder(referenceentry.length() + 35)).append("CacheLoader returned null for key ").append(referenceentry).append(".").toString());
            referenceentry;
            statsCounter.recordMisses(1);
            throw referenceentry;
...
_L5:
        ...
        j = i;
        iterable = String.valueOf(String.valueOf(obj3));
        j = i;
        try
        {
            throw new CacheLoader.InvalidCacheLoadException((new StringBuilder(iterable.length() + 37)).append("loadAll failed to return a value for ").append(iterable).toString());
        }
        // Misplaced declaration of an exception variable
...
_L8:
        ...
        throws ExecutionException
    {
        ...
        {
            globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
            set = String.valueOf(String.valueOf(cacheloader));
            throw new CacheLoader.InvalidCacheLoadException((new StringBuilder(set.length() + 31)).append(set).append(" returned null map from loadAll").toString());
        }
        ...
        if (flag1)
        {
            globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
            set = String.valueOf(String.valueOf(cacheloader));
            throw new CacheLoader.InvalidCacheLoadException((new StringBuilder(set.length() + 42)).append(set).append(" returned null keys or values from loadAll").toString());
        } else
        {
