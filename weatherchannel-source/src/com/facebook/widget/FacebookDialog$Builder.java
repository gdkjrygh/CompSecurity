...
public static abstract class plicationId
{
    ...
    protected addImageAttachment addVideoAttachment(String s, File file)
    {
        mediaAttachmentFiles.put(s, file);
        return this;
    }
    ...
    public FacebookDialog build()
    {
        ...
        if (intent == null)
        {
            FacebookDialog.access$500(activity, fragment, FacebookDialog.access$400(s, bundle.containsKey("com.facebook.platform.extra.PHOTOS"), false), "Failed");
    ...
    tCallback getOnPresentCallback()
    {
        return new FacebookDialog.OnPresentCallback() {
                ...
                throws Exception
            {
                ...
                {
                    FacebookDialog.access$900().addAttachmentFilesForCall(context, appCall.getCallId(), mediaAttachmentFiles);
                }
            }
    ...
    protected String getWebFallbackUrlInternal()
    {
        ...
        if (obj != null)
        {
            Uri uri1 = ((com.facebook.internal.nfig) (obj)).getFallbackUrl();
            if (uri1 != null)
            {
