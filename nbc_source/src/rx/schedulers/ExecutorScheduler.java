...
{
    static final class ExecutorSchedulerWorker extends rx.Scheduler.Worker
        implements Runnable
    {
        ...
        public Subscription schedule(final Action0 action, long l, TimeUnit timeunit)
        {
            ...
            tasks.add(mas);
            subscription = Subscriptions.create(mas. new Action0() {
            ...
            {
                this$0 = final_executorschedulerworker;
                mas = MultipleAssignmentSubscription.this;
                super();
            }
            });
            action = new ScheduledAction(subscription. new Action0() {
