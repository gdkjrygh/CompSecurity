...
//            OperatorSwitch, NotificationLite

private static final class InnerSubscriber.requested extends Subscriber
{
...
/*
        static long access$102(InnerSubscriber innersubscriber, long l)
        {
...
/*
        static long access$110(InnerSubscriber innersubscriber)
        {
...
*/
        ...
        public InnerSubscriber(int i, long l)
        {
...
_L3:
    ...
    public _cls1.this._cls0(Subscriber subscriber)
    {
        infinite = false;
...
_L7:
                if (infinite)
                {
                    ((InnerSubscriber) (obj1)).requestMore(0x7fffffffffffffffL);
                    return;
                } else
                {
                    ((InnerSubscriber) (obj1)).requestMore(l);
                    return;
                }
_L6:
                initialRequested = l1;
