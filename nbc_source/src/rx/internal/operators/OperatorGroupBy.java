...
//            NotificationLite, BackpressureUtils, BufferUntilSubscriber
    ...
    implements rx.Observable.Operator
{
    static final class GroupBySubscriber extends Subscriber
    {
        ...
        private GroupState createNewGroup(Object obj)
        {
            final GroupState groupState = new GroupState();
            GroupedObservable groupedobservable = GroupedObservable.create(getKey(obj), ((_cls2) (obj)). new rx.Observable.OnSubscribe() {

                final GroupBySubscriber this$0;
                final GroupBySubscriber.GroupState val$groupState;
                ...
                public void call(final Subscriber final_subscriber)
                {
                    final_subscriber.setProducer(new Producer() {
                        ...
                        final GroupBySubscriber._cls2 this$1;
            ...
            {
                this$1 = GroupBySubscriber._cls2.this;
                super();
            }
                    });
            ...
            if ((GroupState)groups.putIfAbsent(obj, groupState) != null)
            {
...
_L3:
    ...
    private static class GroupBySubscriber.GroupState
    {
        ...
        private GroupBySubscriber.GroupState()
        {
    ...
    // Unreferenced inner class rx/internal/operators/OperatorGroupBy$GroupBySubscriber$1

/* anonymous class */
    class GroupBySubscriber._cls1
        implements Action0
    {
