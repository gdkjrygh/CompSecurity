...
{
    private static final class DisposeAction extends AtomicBoolean
    ...
    public void call(Subscriber subscriber)
    {
        Object obj;
        Object obj1;
        obj = resourceFactory.call();
        obj1 = new DisposeAction(dispose, obj);
        subscriber.add(((Subscription) (obj1)));
        obj = (Observable)observableFactory.call(obj);
        if (disposeEagerly)
        {
            obj = ((Observable) (obj)).doOnTerminate(((Action0) (obj1)));
        }
        ((Observable) (obj)).unsafeSubscribe(Subscribers.wrap(subscriber));
        return;
        Throwable throwable;
        throwable;
        obj1 = disposeEagerlyIfRequested(((Action0) (obj1)));
        if (obj1 != null)
        {
            try
            {
