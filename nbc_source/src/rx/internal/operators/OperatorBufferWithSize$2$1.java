    ...
    implements Producer
{
        ...
        if (l != 0L)
        {
            ...
            if (!infinite)
            {
                ...
                if (firstRequest)
                {
                    ...
                    {
                        val$producer.request((long)count + (long)skip * (l - 1L));
                        return;
                    }
                }
                ...
                {
                    val$producer.request((long)skip * l);
                    return;
                }
            }
        }
    ...
    // Unreferenced inner class rx/internal/operators/OperatorBufferWithSize$2

/* anonymous class */
    class OperatorBufferWithSize._cls2 extends Subscriber
    {
...
_L1:
        ...
        {
            child.setProducer(producer1. new OperatorBufferWithSize._cls2._cls1());
        }
