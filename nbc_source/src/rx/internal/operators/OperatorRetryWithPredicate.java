            ...
            inner.schedule(observable. new Action0() {
                ...
                public void call()
                {
                    ...
                    Subscriber subscriber = new Subscriber() {
                        ...
                        boolean done;
                        final SourceSubscriber._cls1 this$1;
...
label0:
        ...
        public SourceSubscriber(Subscriber subscriber, Func2 func2, rx.Scheduler.Worker worker, SerialSubscription serialsubscription)
        {
            child = subscriber;
            predicate = func2;
            inner = worker;
    ...
    public Subscriber call(Subscriber subscriber)
    {
        ...
        return new SourceSubscriber(subscriber, predicate, worker, serialsubscription);
    }
}
