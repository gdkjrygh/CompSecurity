    ...
    implements Action0
{
    ...
    // Unreferenced inner class rx/internal/operators/OperatorTimeout$2

/* anonymous class */
    class OperatorTimeout._cls2
        implements OperatorTimeoutBase.TimeoutStub
    {
        ...
        {
            return worker.schedule(long1. new OperatorTimeout._cls2._cls1(), timeout, timeUnit);
        }
