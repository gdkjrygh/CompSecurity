...
class InitBuffState extends States
{
    ...
    {
        hashmap.put(CSMAKEYS.bufferingtime.toString(), Integer.toString(timeSpent(i, j)));
        if (_stateActive)
        {
            hashmap.put(CSMAKEYS.playerstate.toString(), "IB");
        }
    }
}
