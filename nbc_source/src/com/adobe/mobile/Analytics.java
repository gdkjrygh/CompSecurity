...
public final class Analytics
{
    public static final class BEACON_PROXIMITY extends Enum
    {
        ...
        static 
        {
            PROXIMITY_IMMEDIATE = new BEACON_PROXIMITY("PROXIMITY_IMMEDIATE", 0);
            PROXIMITY_NEAR = new BEACON_PROXIMITY("PROXIMITY_NEAR", 1);
            PROXIMITY_FAR = new BEACON_PROXIMITY("PROXIMITY_FAR", 2);
            PROXIMITY_UNKNOWN = new BEACON_PROXIMITY("PROXIMITY_UNKNOWN", 3);
