...
_L2:
        ...
        map4 = obj3;
        s = obj4;
        if (s2.trim().length() <= 0) goto _L2; else goto _L1
_L1:
        map1 = obj;
        map2 = obj1;
        map3 = obj2;
        ...
        if (map1 != null)
        {
            ...
            {
                StaticMethods.logErrorFormat("Analytics - Exception when attempting to close socket(%s)", new Object[] {
                    s.getLocalizedMessage()
                });
            }
        }
