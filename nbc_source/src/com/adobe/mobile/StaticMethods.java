...
final class StaticMethods
{
    ...
    protected static final String LIBRARY_VERSION = "4.3.0-AN";
    ...
    protected static String URLEncode(String s)
    {
        ...
        {
            s = s.getBytes("UTF-8");
            stringbuilder = new StringBuilder(s.length << 1);
            j = s.length;
        }
        ...
        byte0 = s[i];
        stringbuilder.append(encodedChars[byte0 & 0xff]);
        i++;
...
_L2:
        ...
        do
        {
            ...
            hashmap.put(cleanContextDataKey((String)map.getKey()), map.getValue());
        } while (true);
...
_L3:
    ...
    protected static String cleanContextDataKey(String s)
    {
        ...
        {
            return s.replaceAll("[^\\p{L}\\p{N}._]|^[.]+|[.]+$", "").replaceAll("([.]){2,}", ".");
        }
    }
...
label0:
    ...
    private static String serializeKeyValuePair(String s, Object obj)
    {
        if (s == null || s.length() <= 0)
        {
            return "";
        ...
        if ((obj instanceof String) || (obj instanceof Integer) || (obj instanceof Double) || (obj instanceof Float))
        {
            ...
            {
                return (new StringBuilder()).append("&").append(s).append("=").append(URLEncode(obj.toString())).toString();
            } else
            {
                return "";
            }
        ...
        {
            return (new StringBuilder()).append("&").append(s).append("=").append(URLEncode(join((List)obj, ","))).toString();
        }
        if (obj != null)
        {
            return (new StringBuilder()).append("&").append(s).append("=").append(URLEncode(obj.toString())).toString();
    ...
    protected static String serializeToQueryString(Map map)
    {
        if (map == null)
        {
            return "";
        ...
        do
        {
            ...
            if (s != null)
            {
                ...
                if (obj instanceof ContextData)
                {
                    ...
                    {
                        stringbuilder.append(serializeKeyValuePair(s, ((ContextData) (obj)).value));
                    }
                    if (((ContextData) (obj)).contextData != null && ((ContextData) (obj)).contextData.size() > 0)
                    {
                        ...
                        stringbuilder.append(s);
                        stringbuilder.append(".");
                        stringbuilder.append(serializeToQueryString(((Map) (((ContextData) (obj)).contextData))));
                        stringbuilder.append("&.");
                        stringbuilder.append(s);
                    }
                } else
                {
                    stringbuilder.append(serializeKeyValuePair(s, obj));
                }
            }
        } while (true);
        return stringbuilder.toString();
