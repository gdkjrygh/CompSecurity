...
class this._cls0
    implements android.content.tingsFragment._cls18
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        String s = config.getAdobePassRequestorId();
        String s1 = config.getAdobePassSignedRequestorId();
        intent.putExtra("requestorId", s);
        intent.putExtra("apiKey", s1);
