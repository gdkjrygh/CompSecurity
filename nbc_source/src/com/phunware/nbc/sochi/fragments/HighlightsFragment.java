...
public class HighlightsFragment extends BaseContentFragment
{

    TextView highlightsTab;
    LinearLayout layout;
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        bundle = adManager.getAdView(getActivity(), "highlights");
    ...
    {
        layoutinflater = layoutinflater.inflate(0x7f040039, viewgroup, false);
        ButterKnife.bind(this, layoutinflater);
        if (upcomingLabel != null && !NBCSystem.IS_TAB)
        {
            upcomingLabel.setText(0x7f07011b);
            upcomingLabel.setSelected(true);
            return layoutinflater;
        } else
        {
            highlightsTab.setSelected(true);
            return layoutinflater;
        }
    }
}
