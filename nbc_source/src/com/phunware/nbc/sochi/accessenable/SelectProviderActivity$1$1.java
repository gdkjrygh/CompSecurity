    ...
    implements Runnable
{
    ...
    public void run()
    {
        SelectProviderActivity.access$000(_fld0).setVisibility(0);
        SelectProviderActivity.access$000(_fld0).setCallback(new com.nbcsports.liveextra.ui.tve.AuthenticationWebView.Callback() {
        ...
        SelectProviderActivity.access$000(_fld0).loadUrl(val$url);
    }
...
/* anonymous class */
    class SelectProviderActivity._cls1 extends AuthDelegate
    {
        ...
        public void navigateToUrl(String s)
        {
            ...
            runOnUiThread(s. new SelectProviderActivity._cls1._cls1());
        }
        ...
        public void setAuthenticationStatus(final int status, final String errorCode)
        {
            ...
            runOnUiThread(new SelectProviderActivity._cls1._cls4());
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/phunware/nbc/sochi/accessenable/SelectProviderActivity$1$4

/* anonymous class */
        class SelectProviderActivity._cls1._cls4
            implements Runnable
        {
