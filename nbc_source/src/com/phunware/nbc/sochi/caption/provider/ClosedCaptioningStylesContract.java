...
public class ClosedCaptioningStylesContract
{
    ...
    private static String initAuthority()
    {
        ...
        try
        {
            s = com/phunware/nbc/sochi/caption/provider/ClosedCaptioningStylesContract.getClassLoader().loadClass("com.phunware.nbc.sports.closedcaption.data.Authority").getDeclaredField("CONTENT_AUTHORITY").get(null).toString();
        }
        catch (ClassNotFoundException classnotfoundexception)
        {
            return "notify.phunware.if.this.is.used";
        }
