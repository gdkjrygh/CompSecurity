...
public class Constants
{
    ...
    public static final int KEEP_ALIVE_PERIOD = 0x124f80;
    ...
    public static final int PAUSED_ON_BUFFERING_PERIOD = 500;
    ...
    public static final String STREAMSENSE_VERSION = "4.1401.31";
