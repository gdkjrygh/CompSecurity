...
final class TargetAction extends Action
{
    ...
    TargetAction(Picasso picasso, Target target, Request request, int i, int j, Drawable drawable, String s, 
            Object obj, int k)
    {
        super(picasso, target, request, i, j, k, drawable, s, obj, false);
    }
