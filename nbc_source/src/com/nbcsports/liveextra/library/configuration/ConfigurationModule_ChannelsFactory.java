...
public final class ConfigurationModule_ChannelsFactory
    implements Factory
{
    ...
    public ConfigurationModule_ChannelsFactory(ConfigurationModule configurationmodule, Provider provider)
    {
    ...
    public Map get()
    {
        Map map = module.channels((MvpdLookups)mvpdLookupsProvider.get());
        if (map == null)
        {
    ...
    {
        boolean flag;
        if (!com/nbcsports/liveextra/library/configuration/ConfigurationModule_ChannelsFactory.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
