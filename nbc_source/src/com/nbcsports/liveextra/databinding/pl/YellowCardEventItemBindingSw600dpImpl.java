...
public class YellowCardEventItemBindingSw600dpImpl extends YellowCardEventItemBinding
{
    ...
    public YellowCardEventItemBindingSw600dpImpl(View view)
    {
        this(view, mapBindings(view, 8, sIncludes, sViewsWithIds));
    }

    private YellowCardEventItemBindingSw600dpImpl(View view, Object aobj[])
    {
