...
//            RedCardEventItemBinding

public class RedCardEventItemBindingSw720dpImpl extends RedCardEventItemBinding
{
    ...
    public RedCardEventItemBindingSw720dpImpl(View view)
    {
        this(view, mapBindings(view, 9, sIncludes, sViewsWithIds));
    }

    private RedCardEventItemBindingSw720dpImpl(View view, Object aobj[])
    {
