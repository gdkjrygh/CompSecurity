...
public class PlayerCardBindingSw600dpImpl extends PlayerCardBinding
{
    ...
    public PlayerCardBindingSw600dpImpl(View view)
    {
        this(view, mapBindings(view, 13, sIncludes, sViewsWithIds));
    }

    private PlayerCardBindingSw600dpImpl(View view, Object aobj[])
    {
        super(view, 10, null, (ViewPager)aobj[10], (RelativeLayout)aobj[11], (FrameLayout)aobj[12], null, (ViewPager)aobj[9]);
        mDirtyFlags = -1L;
        ...
        mboundView3 = (FrameLayout)aobj[3];
...
_L2:
    ...
    protected void executeBindings()
    {
        ...
        if ((2081L & l4) != 0L)
        {
            ...
            mboundView6.setVisibility(l);
        }
        if ((2057L & l4) != 0L)
        {
            PlayerCardsView.bindFormation(mboundView2, s3);
        }
        if ((2081L & l4) != 0L)
        {
            mboundView3.setVisibility(j1);
            mboundView8.setVisibility(j1);
        }
        if ((2177L & l4) != 0L)
        {
            PlayerCardsView.bindFormation(mboundView4, s2);
        }
        if ((3072L & l4) != 0L)
        {
            obj1 = mboundView5;
        ...
        if ((2113L & l4) != 0L)
        {
            mboundView5.setText(s1);
        }
        if ((2081L & l4) != 0L)
        {
            BindingUtils.setSelected(mboundView5, flag4);
        }
        if ((2065L & l4) != 0L && getBuildSdkInt() >= 16)
        {
            mboundView6.setBackground(Converters.convertColorToDrawable(l1));
        }
        if ((3072L & l4) != 0L)
        {
            obj1 = mboundView7;
        ...
        if ((2051L & l4) != 0L)
        {
            mboundView7.setText(((CharSequence) (obj4)));
        }
        if ((2081L & l4) != 0L)
        {
            BindingUtils.setSelected(mboundView7, flag5);
        }
        if ((2305L & l4) != 0L && getBuildSdkInt() >= 16)
        {
    ...
    static 
    {
        ...
        sViewsWithIds.put(0x7f0f0141, 11);
        sViewsWithIds.put(0x7f0f0142, 12);
    }
}
