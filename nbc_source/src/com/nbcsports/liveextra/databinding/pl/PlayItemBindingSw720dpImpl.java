...
public class PlayItemBindingSw720dpImpl extends PlayItemBinding
{
    ...
    public PlayItemBindingSw720dpImpl(View view)
    {
        this(view, mapBindings(view, 5, sIncludes, sViewsWithIds));
    }

    private PlayItemBindingSw720dpImpl(View view, Object aobj[])
    {
