...
public class HighLevelStatsBindingImpl extends HighLevelStatsBinding
{
    ...
    public HighLevelStatsBindingImpl(View view)
    {
        this(view, mapBindings(view, 18, sIncludes, sViewsWithIds));
    }

    private HighLevelStatsBindingImpl(View view, Object aobj[])
    {
