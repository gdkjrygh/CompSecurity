...
public class EventItemBindingSw600dpImpl extends EventItemBinding
{
    ...
    public EventItemBindingSw600dpImpl(View view)
    {
        this(view, mapBindings(view, 6, sIncludes, sViewsWithIds));
    }

    private EventItemBindingSw600dpImpl(View view, Object aobj[])
    {
