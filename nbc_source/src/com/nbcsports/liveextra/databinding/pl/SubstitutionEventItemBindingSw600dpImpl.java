...
public class SubstitutionEventItemBindingSw600dpImpl extends SubstitutionEventItemBinding
{
    ...
    public SubstitutionEventItemBindingSw600dpImpl(View view)
    {
        this(view, mapBindings(view, 8, sIncludes, sViewsWithIds));
    }

    private SubstitutionEventItemBindingSw600dpImpl(View view, Object aobj[])
    {
