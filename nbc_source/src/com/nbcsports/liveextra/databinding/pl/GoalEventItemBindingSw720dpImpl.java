...
public class GoalEventItemBindingSw720dpImpl extends GoalEventItemBinding
{
    ...
    public GoalEventItemBindingSw720dpImpl(View view)
    {
        this(view, mapBindings(view, 9, sIncludes, sViewsWithIds));
    }

    private GoalEventItemBindingSw720dpImpl(View view, Object aobj[])
    {
