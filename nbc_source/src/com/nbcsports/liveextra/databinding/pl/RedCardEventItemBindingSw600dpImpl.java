...
public class RedCardEventItemBindingSw600dpImpl extends RedCardEventItemBinding
{
    ...
    public RedCardEventItemBindingSw600dpImpl(View view)
    {
        this(view, mapBindings(view, 8, sIncludes, sViewsWithIds));
    }

    private RedCardEventItemBindingSw600dpImpl(View view, Object aobj[])
    {
