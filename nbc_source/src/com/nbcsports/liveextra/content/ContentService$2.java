    ...
    implements rx.cribe
{
    ...
    {
        String s = ((Configuration)ContentService.access$000(ContentService.this).get()).getUpcomingRequestURL().trim();
        ContentService.access$100(ContentService.this, subscriber, s);
    }
