...
class this._cls0 extends Subscriber
{
    ...
    public void onNext(List list)
    {
        ...
        {
            ((sBinder)PlayerCardsPresenter.access$200(PlayerCardsPresenter.this)).awayPlayers.clear();
            ((awayPlayers)PlayerCardsPresenter.access$300(PlayerCardsPresenter.this)).awayPlayers.addAll(list);
            return;
        }
    }
