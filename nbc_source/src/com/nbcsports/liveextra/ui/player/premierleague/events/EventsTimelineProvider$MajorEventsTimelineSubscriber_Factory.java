    ...
    implements Factory
{
    ...
    {
        boolean flag;
        if (!com/nbcsports/liveextra/ui/player/premierleague/events/EventsTimelineProvider$MajorEventsTimelineSubscriber_Factory.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
    ...
    public y(MembersInjector membersinjector, Provider provider, Provider provider1)
    {
