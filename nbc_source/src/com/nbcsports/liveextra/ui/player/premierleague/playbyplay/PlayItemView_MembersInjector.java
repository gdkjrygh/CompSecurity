...
//            PlayItemPresenter, PlayItemView

public final class PlayItemView_MembersInjector
    implements MembersInjector
{
    ...
    public PlayItemView_MembersInjector(MembersInjector membersinjector, Provider provider)
    {
    ...
    public void injectMembers(PlayItemView playitemview)
    {
        ...
        {
            supertypeInjector.injectMembers(playitemview);
            playitemview.presenter = (PlayItemPresenter)presenterProvider.get();
            return;
        }
    }
    ...
    {
        injectMembers((PlayItemView)obj);
    }

    static 
    {
        boolean flag;
        if (!com/nbcsports/liveextra/ui/player/premierleague/playbyplay/PlayItemView_MembersInjector.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
