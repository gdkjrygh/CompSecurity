...
final class WireFormat
{
    static class FieldType extends Enum
    {
        ...
        {
            return (FieldType)Enum.valueOf(com/crashlytics/android/WireFormat$FieldType, s);
        }
    ...
    static final class JavaType extends Enum
    {
        ...
        {
            return (JavaType)Enum.valueOf(com/crashlytics/android/WireFormat$JavaType, s);
        }
