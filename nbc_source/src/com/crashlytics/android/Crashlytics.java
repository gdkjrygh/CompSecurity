...
//            CrashlyticsUncaughtExceptionHandler, DialogStringResolver, CrashTest, ReportUploader, 
//            BuildIdValidator, DefaultCreateReportSpiCall, CrashlyticsMissingDependencyException, CrashlyticsListener, 
//            PinningInfoProvider, CreateReportSpiCall
    ...
    implements KitGroup
{
    public static class Builder
    {
        ...
        private com.crashlytics.android.PinningInfoProvider pinningInfoProvider;
        ...
        public Builder pinningInfo(com.crashlytics.android.PinningInfoProvider pinninginfoprovider)
        {
    ...
    Crashlytics(float f, CrashlyticsListener crashlyticslistener, com.crashlytics.android.PinningInfoProvider pinninginfoprovider, boolean flag)
    {
    ...
    Crashlytics(float f, CrashlyticsListener crashlyticslistener, com.crashlytics.android.PinningInfoProvider pinninginfoprovider, boolean flag, ExecutorService executorservice)
    {
        userId = null;
        userEmail = null;
        userName = null;
        ...
        disabled = flag;
        crashHandlerExecutor = executorservice;
    ...
    private void finishInitSynchronously()
    {
        ...
        for (Iterator iterator = getDependencies().iterator(); iterator.hasNext(); ((PriorityCallable) (obj)).addDependency((Dependency)iterator.next())) { }
        obj = getFabric().getExecutorService().submit(((java.util.concurrent.Callable) (obj)));
    ...
    public static void setPinningInfoProvider(com.crashlytics.android.PinningInfoProvider pinninginfoprovider)
    {
    ...
    protected Void doInBackground()
    {
        ...
        boolean flag1;
        boolean flag2;
        handler.markInitializationStarted();
        ...
        handler.markInitializationComplete();
        return null;
        flag = flag2;
...
_L4:
    ...
    boolean onPreExecute(Context context)
    {
        ...
        s = ApiKey.getApiKey(context, Fabric.isDebuggable());
        if (s == null)
        {
            return false;
        }
...
_L1:
        httpRequestFactory.setPinningInfoProvider(null);
_L12:
...
_L9:
        ...
        flag = flag1;
        handler = new CrashlyticsUncaughtExceptionHandler(Thread.getDefaultUncaughtExceptionHandler(), listener, crashHandlerExecutor, buildId, getIdManager(), this);
        flag = flag1;
        flag1 = handler.didPreviousInitializationComplete();
        flag = flag1;
...
_L5:
        if (!CommonUtils.canTryConnection(getContext())) goto _L6; else goto _L7
_L7:
        finishInitSynchronously();
        return false;
_L2:
        httpRequestFactory.setPinningInfoProvider(new PinningInfoProvider() {
...
_L4:
        ...
        Fabric.getLogger().e("Fabric", "Error setting up app properties", exception);
          goto _L9
        context;
        Fabric.getLogger().e("Fabric", "There was a problem installing the exception handler.", context);
          goto _L10
_L6:
        return true;
