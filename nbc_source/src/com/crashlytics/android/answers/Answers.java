...
public class Answers extends Kit
{
    ...
    private void initializeSessionAnalytics(Context context)
    {
        ...
        sessionAnalyticsManager = new AutoSessionAnalyticsManager(((Application) (obj1)), ((SessionEventMetadata) (obj)), sessionanalyticsfilesmanager, new DefaultHttpRequestFactory(Fabric.getLogger()));
_L2:
        ...
        sessionAnalyticsManager = new SessionAnalyticsManager(context, ((SessionEventMetadata) (obj)), sessionanalyticsfilesmanager, new DefaultHttpRequestFactory(Fabric.getLogger()));
...
_L1:
    ...
    protected boolean onPreExecute()
    {
        ...
        preferenceStore = new PreferenceStoreImpl(Fabric.getKit(com/crashlytics/android/answers/Answers));
        context = getContext();
