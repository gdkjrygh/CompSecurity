...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            Crashlytics._cls5._cls1 _lcls1 = new Crashlytics._cls5._cls1();
            ...
            {
                android.content.DialogInterface.OnClickListener onclicklistener = new Crashlytics._cls5._cls2();
                builder.setNegativeButton(stringResolver.getCancelButtonTitle(), onclicklistener);
            }
            if (promptData.showAlwaysSendButton)
            {
                android.content.DialogInterface.OnClickListener onclicklistener1 = new Crashlytics._cls5._cls3();
...
/* anonymous class */
        ...
        // Unreferenced inner class com/crashlytics/android/Crashlytics$5$3

/* anonymous class */
        class Crashlytics._cls5._cls3
            implements android.content.DialogInterface.OnClickListener
        {
