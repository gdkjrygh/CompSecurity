    ...
    implements tener
{
    ...
    public void onAddFinished(tener tener)
    {
        ...
        if (!tener(tener))
        {
            RecyclerView.access$5200(RecyclerView.this, tener._fld0);
        }
    }
    ...
    public void onChangeFinished(this._cls0 _pcls0)
    {
        ...
        {
            RecyclerView.access$5200(RecyclerView.this, _pcls0._fld0);
        }
    }
    ...
    {
        _pcls0._mth0(true);
        if (!RecyclerView.access$5200(RecyclerView.this, _pcls0._fld0) && _pcls0._mth0())
        {
