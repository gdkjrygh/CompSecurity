...
public abstract class AbstractSpiCall
{
    ...
    {
        return requestFactory.buildHttpRequest(method, getUrl(), map).useCaches(false).connectTimeout(10000).header("User-Agent", (new StringBuilder()).append("Crashlytics Android SDK/").append(kit.getVersion()).toString()).header("X-CRASHLYTICS-DEVELOPER-TOKEN", "bca6990fc3c15a8105800c0673517a4b579634a1");
    }
