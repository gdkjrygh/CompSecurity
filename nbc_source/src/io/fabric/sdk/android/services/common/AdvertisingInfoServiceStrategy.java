    ...
    implements AdvertisingInfoStrategy
{
    ...
    public AdvertisingInfo getAdvertisingInfo()
    {
        ...
        if (!context.bindService(((Intent) (obj1)), ((ServiceConnection) (obj)), 1))
        {
        ...
        Object obj2;
        obj2;
        Fabric.getLogger().w("Fabric", "Exception in binding to Google Play Service to capture AdvertisingId", ((Throwable) (obj2)));
        context.unbindService(((ServiceConnection) (obj)));
        return null;
        obj2;
        context.unbindService(((ServiceConnection) (obj)));
