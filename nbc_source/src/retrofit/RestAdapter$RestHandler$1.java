...
//            RestAdapter, ResponseWrapper, RestMethodInfo, RequestInterceptor
    ...
    implements val.args
{
    ...
    {
        return (ResponseWrapper)cess._mth100(this._cls1.this, requestinterceptor, val$methodInfo, val$args);
    }
