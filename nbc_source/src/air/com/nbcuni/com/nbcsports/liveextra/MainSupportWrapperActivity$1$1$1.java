...
class this._cls2
    implements android.content.tWrapperActivity._cls1._cls1._cls1
{
...
/* anonymous class */
    ...
    // Unreferenced inner class air/com/nbcuni/com/nbcsports/liveextra/MainSupportWrapperActivity$1$1

/* anonymous class */
    class MainSupportWrapperActivity._cls1._cls1
        implements Runnable
    {
        ...
        public void run()
        {
            (new android.app.AlertDialog.Builder(this$0)).setTitle(getString(0x7f0700b6)).setMessage(0x7f0700b7).setPositiveButton(0x104000a, new MainSupportWrapperActivity._cls1._cls1._cls1()).create().show();
        }
