    ...
    extends Sink
{
    ...
    public abstract BufferedSink writeString(String s, int i, int j, Charset charset)
        throws IOException;
    ...
    public abstract BufferedSink writeUtf8(String s, int i, int j)
        throws IOException;

    public abstract BufferedSink writeUtf8CodePoint(int i)
        throws IOException;
}
