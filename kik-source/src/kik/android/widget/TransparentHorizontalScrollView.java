...
public class TransparentHorizontalScrollView extends HorizontalScrollView
{

    public TransparentHorizontalScrollView(Context context)
    {
        super(context, null);
        a();
    }

    public TransparentHorizontalScrollView(Context context, AttributeSet attributeset)
    {
        super(context, attributeset, 0);
        a();
    }

    public TransparentHorizontalScrollView(Context context, AttributeSet attributeset, int i)
    {
