...
_L5:
    ...
    public void setText(CharSequence charsequence, android.widget.TextView.BufferType buffertype)
    {
        ...
        if (!isInEditMode() && DeviceUtils.d() && charsequence != null)
        {
            charsequence = d.a(charsequence.toString(), getResources());
            if (charsequence != null)
            {
                setContentDescription((new StringBuilder("AUTOMATION_")).append(charsequence.toUpperCase()).toString());
            }
        }
    }
}
