...
public class NotificationCompat
{
    ...
    public static final class Action.Builder
    {
        ...
        public final Action.Builder addExtras(Bundle bundle)
        {
            if (bundle != null)
            {
        ...
        public final Action.Builder addRemoteInput(RemoteInput remoteinput)
        {
        ...
        public final Action.Builder extend(Action.Extender extender)
        {
        ...
        implements Action.Extender
    {
        ...
        public final Action.WearableExtender clone()
        {
        ...
        public final Action.Builder extend(Action.Builder builder)
        {
        ...
        public final Action.WearableExtender setAvailableOffline(boolean flag)
        {
            setFlag(1, flag);
            return this;
        }

        public final Action.WearableExtender setCancelLabel(CharSequence charsequence)
        {
            mCancelLabel = charsequence;
            return this;
        }

        public final Action.WearableExtender setConfirmLabel(CharSequence charsequence)
        {
            mConfirmLabel = charsequence;
            return this;
        }

        public final Action.WearableExtender setInProgressLabel(CharSequence charsequence)
        {
...
label0:
    ...
    public static class CarExtender.UnreadConversation extends NotificationCompatBase.UnreadConversation
    {
            ...
            implements NotificationCompatBase.UnreadConversation.Factory
        {
            ...
            public final CarExtender.UnreadConversation build(String as[], RemoteInputCompatBase.RemoteInput remoteinput, PendingIntent pendingintent, PendingIntent pendingintent1, String as1[], long l)
            {
        ...
        implements Extender
    {
        ...
        public final WearableExtender setContentIntentAvailableOffline(boolean flag)
        {
            setFlag(1, flag);
            return this;
        }
        ...
        public final WearableExtender setHintAvoidBackgroundClipping(boolean flag)
        {
            setFlag(16, flag);
            return this;
        }

        public final WearableExtender setHintHideIcon(boolean flag)
        {
            setFlag(2, flag);
            return this;
        }
        ...
        public final WearableExtender setHintShowBackgroundOnly(boolean flag)
        {
            setFlag(4, flag);
            return this;
        }

        public final WearableExtender setStartScrollBottom(boolean flag)
        {
            setFlag(8, flag);
            return this;
        }
