...
private class <init> extends <init>
{
    ...
    public int clampViewPositionHorizontal(View view, int i, int j)
    {
        ...
        if (SlidingPaneLayout.access$700(SlidingPaneLayout.this))
        {
            ...
            j -= ((this._cls0) (view)).argin + k + SlidingPaneLayout.access$400(SlidingPaneLayout.this).getWidth();
            k = SlidingPaneLayout.access$800(SlidingPaneLayout.this);
