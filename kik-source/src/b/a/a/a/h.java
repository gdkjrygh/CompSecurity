...
_L5:
        zipfile = inputstream;
        d.c().b("Fabric", (new StringBuilder("Error when parsing fabric properties ")).append(zipentry.getName()).toString(), ((Throwable) (obj)));
        j.a(inputstream);
        return null;
_L3:
        zipfile = inputstream;
...
_L4:
    ...
    private Map a()
    {
        ...
        d.c();
        (new StringBuilder("finish scanning in ")).append(System.currentTimeMillis() - l).append(" reading:").append(i);
        return hashmap;
    }
