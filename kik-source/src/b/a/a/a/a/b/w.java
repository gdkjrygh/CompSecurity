    ...
    implements Closeable
{
    ...
    private static final Logger b = Logger.getLogger(b/a/a/a/a/b/w.getName());
    int a;
    ...
    static RandomAccessFile a(w w1)
    {
        return w1.c;
    }
    ...
    static void a(w w1, int i, byte abyte0[], int j, int k)
    {
        w1.a(i, abyte0, j, k);
    }
