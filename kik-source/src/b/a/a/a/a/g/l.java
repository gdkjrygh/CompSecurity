    ...
    implements x
{
    ...
    public final JSONObject a(w w1)
    {
        ...
        d2 = a(((Map) (hashmap)));
        b.a.a.a.a.e.d d1 = d2;
        d2 = d2.a("X-CRASHLYTICS-API-KEY", w1.a).a("X-CRASHLYTICS-API-CLIENT-TYPE", "android").a("X-CRASHLYTICS-D", w1.b).a("X-CRASHLYTICS-API-CLIENT-VERSION", a.a()).a("Accept", "application/json");
        d1 = d2;
        d.c();
        d1 = d2;
...
_L2:
        d1 = d2;
        d.c().b("Fabric", (new StringBuilder("Failed to retrieve settings from ")).append(a()).toString());
        w1 = obj;
