...
abstract class a extends b.a.a.a.a.b.a
{
    ...
    private d a(d d1, b.a.a.a.a.g.d d2)
    {
        ...
        obj = null;
        d1 = null;
        java.io.InputStream inputstream = a.v().getResources().openRawResource(d2.j.b);
        d1 = inputstream;
        obj = inputstream;
        ...
        j.a(inputstream, "Failed to close app icon InputStream.");
_L2:
        if (d2.k != null)
        {
    ...
    d2.a()
        ...
        notfoundexception;
        obj = d1;
        b.a.a.a.d.c().b("Fabric", (new StringBuilder("Failed to find app icon with resource ID: ")).append(d2.j.b).toString(), notfoundexception);
        j.a(d1, "Failed to close app icon InputStream.");
        if (true) goto _L2; else goto _L1
_L1:
        d1;
        j.a(((java.io.Closeable) (obj)), "Failed to close app icon InputStream.");
        throw d1;
        return d3;
    }
    ...
    {
        d d2 = a(b().a("X-CRASHLYTICS-API-KEY", d1.a).a("X-CRASHLYTICS-API-CLIENT-TYPE", "android").a("X-CRASHLYTICS-API-CLIENT-VERSION", a.a()), d1);
        b.a.a.a.d.c();
