...
public class X509Extension
{
    ...
    public static ASN1Primitive a(X509Extension x509extension)
    {
        try
        {
            x509extension = ASN1Primitive.a(x509extension.G.d());
        }
        // Misplaced declaration of an exception variable
        catch (X509Extension x509extension)
        {
            throw new IllegalArgumentException((new StringBuilder("can't convert extension: ")).append(x509extension).toString());
        }
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (((X509Extension) (obj = (X509Extension)obj)).G.equals(G) && ((X509Extension) (obj)).F == F)
            {
                return true;
            }
        }
