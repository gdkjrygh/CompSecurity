...
public class X509DefaultEntryConverter extends X509NameEntryConverter
{
    ...
    public final ASN1Primitive a(ASN1ObjectIdentifier asn1objectidentifier, String s)
    {
        int i = 0;
...
_L4:
        try
        {
            s = (new ASN1InputStream(((byte []) (obj)))).b();
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
            throw new RuntimeException((new StringBuilder("can't recode value for oid ")).append(asn1objectidentifier.c()).toString());
        }
        return s;
_L2:
        obj = s;
