...
public class ECGOST3410NamedCurves
{
    ...
    {
        s = (ASN1ObjectIdentifier)a.get(s);
        if (s != null)
        {
    ...
    {
        return (ASN1ObjectIdentifier)a.get(s);
    }
    ...
    static 
    {
        ...
        obj1 = new org.spongycastle.math.ec.ECCurve.Fp(((BigInteger) (obj1)), new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"));
        obj = new ECDomainParameters(((org.spongycastle.math.ec.ECCurve) (obj1)), new org.spongycastle.math.ec.ECPoint.Fp(((org.spongycastle.math.ec.ECCurve) (obj1)), new org.spongycastle.math.ec.ECFieldElement.Fp(((org.spongycastle.math.ec.ECCurve.Fp) (obj1)).e(), new BigInteger("1")), new org.spongycastle.math.ec.ECFieldElement.Fp(((org.spongycastle.math.ec.ECCurve.Fp) (obj1)).e(), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612"))), ((BigInteger) (obj)));
        ...
        org.spongycastle.math.ec.ECCurve.Fp fp = new org.spongycastle.math.ec.ECCurve.Fp(((BigInteger) (obj)), new BigInteger("57896044618658097711785492504343953926634992332820282019728792003956564823190"), new BigInteger("28091019353058090096996979000309560759124368558014865957655842872397301267595"));
        obj = new ECDomainParameters(fp, new org.spongycastle.math.ec.ECPoint.Fp(fp, new org.spongycastle.math.ec.ECFieldElement.Fp(((BigInteger) (obj)), new BigInteger("1")), new org.spongycastle.math.ec.ECFieldElement.Fp(((BigInteger) (obj)), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124"))), ((BigInteger) (obj1)));
        ...
        fp = new org.spongycastle.math.ec.ECCurve.Fp(((BigInteger) (obj)), new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"));
        obj = new ECDomainParameters(fp, new org.spongycastle.math.ec.ECPoint.Fp(fp, new org.spongycastle.math.ec.ECFieldElement.Fp(((BigInteger) (obj)), new BigInteger("0")), new org.spongycastle.math.ec.ECFieldElement.Fp(((BigInteger) (obj)), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247"))), ((BigInteger) (obj1)));
