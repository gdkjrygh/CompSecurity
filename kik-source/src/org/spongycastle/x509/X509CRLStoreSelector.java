    ...
    implements Selector
{
    ...
    {
        org.spongycastle.asn1.ASN1Integer asn1integer;
        X509CRL x509crl;
        ...
        try
        {
            abyte1 = x509crl.getExtensionValue(X509Extensions.l.c());
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
        ...
        asn1integer = DERInteger.a(X509ExtensionUtil.a(abyte1));
        ...
        if (asn1integer != null && c != null && asn1integer.d().compareTo(c) == 1)
        {
            return false;
        }
        if (e)
        {
            byte abyte0[] = x509crl.getExtensionValue(X509Extensions.m.c());
            if (d == null)
            {
                if (abyte0 != null)
                {
    ...
    public Object clone()
    {
        ...
        x509crlstoreselector.d = Arrays.b(d);
        return x509crlstoreselector;
    }
