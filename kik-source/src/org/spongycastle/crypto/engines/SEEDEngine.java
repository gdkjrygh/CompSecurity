    ...
    implements BlockCipher
{
    ...
    {
        return a(a(i ^ j ^ (k ^ l)) + (i ^ j));
    }

    private static long a(int i, int j, long l)
    {
        int k = (int)(l >> 32);
        int i1 = (int)l;
        int j1 = a(a(k, i, i1, j) + a(k ^ i ^ (i1 ^ j)));
        return (long)(a(k, i, i1, j) + j1) << 32 | (long)j1 & 0xffffffffL;
    }
    ...
    private static void a(byte abyte0[], int i, long l)
    {
        for (int j = 0; j < 8; j++)
        {
    ...
    public final void a(boolean flag, CipherParameters cipherparameters)
    {
        ...
        int ai[] = new int[32];
        long l1 = a(((byte []) (cipherparameters)), 0);
        long l2 = a(((byte []) (cipherparameters)), 8);
        int j = (int)(l1 >> 32);
        int k = (int)l1;
        int i1 = (int)(l2 >> 32);
        int l = (int)l2;
