    ...
    implements BlockCipher
{
    ...
    private static void a(String s, byte abyte0[])
    {
        l.put(Strings.b(s), abyte0);
    }

    private void a(int ai[], byte abyte0[], int i1, byte abyte1[], int j1)
    {
        byte byte0 = 7;
        int k2 = a(abyte0, i1);
        int k1 = a(abyte0, i1 + 4);
        int l2;
        if (b)
        {
            l2 = 0;
    ...
    private int[] a(boolean flag, byte abyte0[])
    {
        b = flag;
        if (abyte0.length != 32)
        {
    ...
    public final void a(boolean flag, CipherParameters cipherparameters)
    {
        if (cipherparameters instanceof ParametersWithSBox)
        {
            ...
            {
                a = a(flag, ((KeyParameter)cipherparameters.b()).a());
            }
        } else
        {
