    ...
    implements BlockCipher
{
    ...
    private void b(byte abyte0[], int i1, byte abyte1[], int j1)
    {
        int k1 = a(abyte0, i1);
        int l1 = a(abyte0, i1 + 4);
        k1 ^= j[0];
        for (i1 = 1; i1 < 16; i1 += 2)
        {
            l1 ^= a(k1) ^ j[i1];
    ...
    private void c(byte abyte0[], int i1, byte abyte1[], int j1)
    {
        int k1 = a(abyte0, i1);
        int l1 = a(abyte0, i1 + 4);
        k1 ^= j[17];
    ...
    public final void a(boolean flag, CipherParameters cipherparameters)
    {
        if (cipherparameters instanceof KeyParameter)
        {
            ...
            int j2 = cipherparameters.length;
            int j1 = 0;
            int i1 = 0;
            for (; j1 < 18; j1++)
            {
