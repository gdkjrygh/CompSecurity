    ...
    implements BlockCipher
{
    ...
    private static void a(int l, byte abyte0[], int i1)
    {
        boolean flag = false;
        int j1 = l;
    ...
    private static void a(int l, int ai[], int i1, int ai1[], int j1)
    {
...
_L5:
    ...
    private static void a(int ai[], int ai1[], int l)
    {
        int i1 = ai[0] ^ ai1[l + 0];
        int j1 = i[i1 & 0xff];
        int k1 = k[i1 >>> 8 & 0xff];
    ...
    private int b(byte abyte0[], int l, byte abyte1[], int i1)
    {
        for (int j1 = 0; j1 < 4; j1++)
        {
            f[j1] = a(abyte0, j1 * 4 + l);
            int ai[] = f;
            ai[j1] = ai[j1] ^ d[j1];
        }
    ...
    private static void b(int l, int ai[], int i1, int ai1[], int j1)
    {
    ...
    private static void b(int ai[], int ai1[], int l)
    {
        ai[1] = ai[1] ^ b(ai[0] & ai1[l + 0]);
        ai[0] = ai[0] ^ (ai1[l + 1] | ai[1]);
        ai[2] = ai[2] ^ (ai1[l + 3] | ai[3]);
        ai[3] = ai[3] ^ b(ai1[l + 2] & ai[2]);
    }

    private int c(byte abyte0[], int l, byte abyte1[], int i1)
    {
        for (int j1 = 0; j1 < 4; j1++)
        {
            f[j1] = a(abyte0, j1 * 4 + l);
    ...
    private static void c(int l, int ai[], int i1, int ai1[], int j1)
    {
    ...
    private static void d(int l, int ai[], int i1, int ai1[], int j1)
    {
    ...
    public final int a(byte abyte0[], int l, byte abyte1[], int i1)
    {
        if (!a)
        {
        ...
        if (b)
        {
            return b(abyte0, l, abyte1, i1);
        } else
        {
            return c(abyte0, l, abyte1, i1);
        }
    }
