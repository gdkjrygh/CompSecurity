...
_L4:
    ...
    private void b(byte abyte0[], int i, byte abyte1[], int j)
    {
        ...
        for (; l <= 16; l += 4)
        {
            j1 = a(j1 + (~i & i1) + (k & i) + b[l], 1);
            i1 = a(i1 + (~j1 & k) + (i & j1) + b[l + 1], 2);
            k = a(k + (~i1 & i) + (j1 & i1) + b[l + 2], 3);
            i = a(i + (~k & j1) + (i1 & k) + b[l + 3], 5);
        }
        ...
        for (i = 44; i < 64; i += 4)
        {
            j1 = a(j1 + (~k & i1) + (l & k) + b[i], 1);
            i1 = a(i1 + (~j1 & l) + (k & j1) + b[i + 1], 2);
            l = a(l + (~i1 & k) + (j1 & i1) + b[i + 2], 3);
            k = a(k + (~l & j1) + (i1 & l) + b[i + 3], 5);
        }
    ...
    private void c(byte abyte0[], int i, byte abyte1[], int j)
    {
        ...
        for (k = 60; k >= 44; k -= 4)
        {
            j1 = a(j1, 11) - ((~i1 & i) + (l & i1) + b[k + 3]);
            i1 = a(i1, 13) - ((~l & j1) + (i & l) + b[k + 2]);
            l = a(l, 14) - ((~i & i1) + (j1 & i) + b[k + 1]);
            i = a(i, 15) - ((~j1 & l) + (i1 & j1) + b[k]);
        }
        ...
        for (i = 16; i >= 0; i -= 4)
        {
            j1 = a(j1, 11) - ((~i1 & k) + (l & i1) + b[i + 3]);
            i1 = a(i1, 13) - ((~l & j1) + (k & l) + b[i + 2]);
            l = a(l, 14) - ((~k & i1) + (j1 & k) + b[i + 1]);
            k = a(k, 15) - ((~j1 & l) + (i1 & j1) + b[i]);
        }
    ...
    public final void a(boolean flag, CipherParameters cipherparameters)
    {
        ...
        if (cipherparameters instanceof RC2Parameters)
        {
            ...
            b = a(cipherparameters.a(), cipherparameters.b());
            return;
        }
        if (cipherparameters instanceof KeyParameter)
        {
            cipherparameters = ((KeyParameter)cipherparameters).a();
            b = a(((byte []) (cipherparameters)), cipherparameters.length * 8);
            return;
        } else
        {
