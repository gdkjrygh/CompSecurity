    ...
    implements BlockCipher
{
    ...
    public final void a(boolean flag, CipherParameters cipherparameters)
    {
        ...
        {
            byte abyte0[] = ((KeyParameter)cipherparameters).a();
            ...
            {
                cipherparameters[j1 >> 2][j1 & 3] = abyte0[i2] & 0xff | (abyte0[i2 + 1] & 0xff) << 8 | (abyte0[i2 + 2] & 0xff) << 16 | abyte0[i2 + 3] << 24;
                i2 += 4;
            }
            ...
            while (i2 < k3 + 1 << 2) 
            {
                int i3 = cipherparameters[i2 - 1 >> 2][i2 - 1 & 3];
                int k1;
                if (i2 % k2 == 0)
                {
                ...
                cipherparameters[i2 >> 2][i2 & 3] = k1 ^ cipherparameters[i2 - k2 >> 2][i2 - k2 & 3];
                i2++;
            }
            if (!flag)
            {
                for (int l1 = 1; l1 < f; l1++)
                {
                    ...
                    {
                        Object obj = cipherparameters[l1];
                        int i4 = cipherparameters[l1][j2];
                        int l2 = a(i4);
                        int j3 = a(l2);
                        int l3 = a(j3);
                        i4 ^= l3;
