    ...
    implements ExtendedDigest
{
    ...
    private static long b(long l1, long l2, long l3)
    {
    ...
    private void g()
    {
        ...
        for (int i1 = 16; i1 <= 79; i1++)
        {
            ...
            long l4 = n[i1 - 7];
            long l6 = n[i1 - 15];
            al[i1] = (l2 >>> 6 ^ ((l2 << 45 | l2 >>> 19) ^ (l2 << 3 | l2 >>> 61))) + l4 + (l6 >>> 7 ^ ((l6 << 63 | l6 >>> 1) ^ (l6 << 56 | l6 >>> 8))) + n[i1 - 16];
        }
        ...
        int j1 = 0;
        int i2;
        for (int l1 = 0; j1 < 10; l1 = i2 + 1)
        {
            long l13 = b(l5);
            long l14 = a(l5, l8, l10);
            long l15 = i[l1];
            long al1[] = n;
            i2 = l1 + 1;
            l12 += al1[l1] + (l13 + l14 + l15);
            l11 += l12;
            l12 += a(l3) + b(l3, l7, l9);
            l13 = b(l11);
            l14 = a(l11, l5, l8);
            ...
            al1 = n;
            l1 = i2 + 1;
            l5 += l13 + l14 + l15 + al1[i2];
            l3 += l5;
            l13 = a(l8);
            l5 = b(l8, l10, l12) + l13 + l5;
            l13 = b(l3);
            l14 = a(l3, l7, l9);
            l15 = i[l1];
            al1 = n;
            i2 = l1 + 1;
            l11 += l13 + l14 + l15 + al1[l1];
            l12 += l11;
            l13 = a(l5);
            l11 += b(l5, l8, l10) + l13;
            l13 = b(l12);
            ...
            al1 = n;
            i2 = l1 + 1;
            l7 = l14 + l13 + l15 + al1[l1] + l7;
            l8 += l7;
            l13 = a(l9);
            l7 += b(l9, l11, l5) + l13;
            l13 = b(l8);
            l13 = l3 + (a(l8, l10, l12) + l13 + i[i2] + n[i2]);
            l3 = l13 + (a(l7) + b(l7, l9, l11));
            j1++;
            l5 += l13;
        }
