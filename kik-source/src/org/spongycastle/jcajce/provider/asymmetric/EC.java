...
public class EC
{
    public static class Mappings extends AsymmetricAlgorithmProvider
    {
        ...
        public final void a(ConfigurableProvider configurableprovider)
        {
            ...
            a(configurableprovider, X9ObjectIdentifiers.k, "EC", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.EC())));
            a(configurableprovider, X9ObjectIdentifiers.X, "EC", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.EC())));
            a(configurableprovider, X9ObjectIdentifiers.Z, "ECMQV", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.ECMQV())));
