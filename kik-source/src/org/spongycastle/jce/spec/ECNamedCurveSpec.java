...
public class ECNamedCurveSpec extends ECParameterSpec
{
    ...
    public ECNamedCurveSpec(String s, ECCurve eccurve, org.spongycastle.math.ec.ECPoint ecpoint, BigInteger biginteger, BigInteger biginteger1, byte abyte0[])
    {
        if (eccurve instanceof org.spongycastle.math.ec.ECCurve.Fp)
        {
            eccurve = new EllipticCurve(new ECFieldFp(((org.spongycastle.math.ec.ECCurve.Fp)eccurve).e()), eccurve.c().a(), eccurve.d().a(), abyte0);
        } else
        {
