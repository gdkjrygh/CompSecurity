    ...
    implements PBE
{
    ...
    public static class DESPBEKeyFactory extends JCESecretKeyFactory
    {
        ...
        protected SecretKey engineGenerateSecret(KeySpec keyspec)
        {
            if (keyspec instanceof PBEKeySpec)
            {
                ...
                if (c)
                {
                    keyspec = org.spongycastle.jcajce.provider.symmetric.util.PBE.Util.a(pbekeyspec, d, e, f, g);
                } else
                {
                    keyspec = org.spongycastle.jcajce.provider.symmetric.util.PBE.Util.a(pbekeyspec, d, e, f);
                }
    ...
    public static class PBEWithMD2AndDES extends DESPBEKeyFactory
    {
        ...
        {
            super("PBEwithMD2andDES", PKCSObjectIdentifiers.O_, 0, 5, 64);
        }
    }
    ...
    public static class PBEWithMD2AndRC2 extends PBEKeyFactory
    {
        ...
        {
            super("PBEwithMD2andRC2", PKCSObjectIdentifiers.P_, true, 0, 5, 64, 64);
        }
    }
