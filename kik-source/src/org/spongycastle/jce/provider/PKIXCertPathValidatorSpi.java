...
public class PKIXCertPathValidatorSpi extends CertPathValidatorSpi
{
    ...
    public CertPathValidatorResult engineValidate(CertPath certpath, CertPathParameters certpathparameters)
    {
        ...
        try
        {
            trustanchor = CertPathValidatorUtilities.a((X509Certificate)list.get(list.size() - 1), extendedpkixparameters.getTrustAnchors(), extendedpkixparameters.getSigProvider());
        }
        ...
        try
        {
            certpathparameters = CertPathValidatorUtilities.a(x509certificate);
        ...
        try
        {
            CertPathValidatorUtilities.a(((java.security.PublicKey) (obj)));
        }
        // Misplaced declaration of an exception variable
        catch (CertPathParameters certpathparameters)
        {
        ...
        if (extendedpkixparameters.h() != null && !extendedpkixparameters.h().a((X509Certificate)list.get(0)))
        {
        ...
        while (i1 >= 0) 
        {
            ...
            RFC3280CertPathUtilities.a(certpath, extendedpkixparameters, i1, publickey, flag, certpathparameters, x509certificate);
            RFC3280CertPathUtilities.a(certpath, i1, pkixnameconstraintvalidator);
            obj3 = RFC3280CertPathUtilities.a(certpath, i1, RFC3280CertPathUtilities.a(certpath, i1, hashset, ((PKIXPolicyNode) (obj1)), aarraylist, j1));
            RFC3280CertPathUtilities.a(certpath, i1, ((PKIXPolicyNode) (obj3)), l);
            if (j2 - i1 != j2)
            {
                ...
                RFC3280CertPathUtilities.a(certpath, i1);
                obj1 = RFC3280CertPathUtilities.a(certpath, i1, aarraylist, ((PKIXPolicyNode) (obj3)), k);
                RFC3280CertPathUtilities.b(certpath, i1, pkixnameconstraintvalidator);
                l = RFC3280CertPathUtilities.f(certpath, i1, l);
                k = RFC3280CertPathUtilities.g(certpath, i1, k);
                int l1 = RFC3280CertPathUtilities.h(certpath, i1, j1);
                j1 = RFC3280CertPathUtilities.a(certpath, i1, l);
                k = RFC3280CertPathUtilities.b(certpath, i1, k);
                l1 = RFC3280CertPathUtilities.c(certpath, i1, l1);
                RFC3280CertPathUtilities.b(certpath, i1);
                l = RFC3280CertPathUtilities.e(certpath, i1, RFC3280CertPathUtilities.d(certpath, i1, j));
                RFC3280CertPathUtilities.c(certpath, i1);
                ...
                if (certpathparameters != null)
                {
                    ...
                    certpathparameters.remove(RFC3280CertPathUtilities.m);
                    certpathparameters.remove(RFC3280CertPathUtilities.a);
                    certpathparameters.remove(RFC3280CertPathUtilities.b);
                    certpathparameters.remove(RFC3280CertPathUtilities.c);
                    certpathparameters.remove(RFC3280CertPathUtilities.d);
                    certpathparameters.remove(RFC3280CertPathUtilities.f);
                    certpathparameters.remove(RFC3280CertPathUtilities.g);
                    certpathparameters.remove(RFC3280CertPathUtilities.h);
                    certpathparameters.remove(RFC3280CertPathUtilities.j);
                    certpathparameters.remove(RFC3280CertPathUtilities.k);
                } else
                {
                    certpathparameters = new HashSet();
                }
                RFC3280CertPathUtilities.a(certpath, i1, certpathparameters, list1);
                obj3 = CertPathValidatorUtilities.a(((X509Certificate) (obj)));
                try
                {
                    publickey = CertPathValidatorUtilities.a(certpath.getCertificates(), i1);
                }
                // Misplaced declaration of an exception variable
                catch (CertPathParameters certpathparameters)
                {
                ...
                CertPathValidatorUtilities.a(publickey);
                j = j1;
        ...
        j = RFC3280CertPathUtilities.i(certpath, i1 + 1, RFC3280CertPathUtilities.a(l, ((X509Certificate) (obj))));
        certpathparameters = ((X509Certificate) (obj)).getCriticalExtensionOIDs();
        if (certpathparameters != null)
        {
            certpathparameters = new HashSet(certpathparameters);
            ...
            certpathparameters.remove(RFC3280CertPathUtilities.j);
            certpathparameters.remove(RFC3280CertPathUtilities.k);
            certpathparameters.remove(RFC3280CertPathUtilities.i);
        } else
        {
            certpathparameters = new HashSet();
        }
        RFC3280CertPathUtilities.a(certpath, i1 + 1, list1, certpathparameters);
        certpathparameters = RFC3280CertPathUtilities.a(certpath, extendedpkixparameters, set, i1 + 1, aarraylist, ((PKIXPolicyNode) (obj1)), hashset);
