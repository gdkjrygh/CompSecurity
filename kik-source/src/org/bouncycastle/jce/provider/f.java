...
//            BouncyCastleProvider, AnnotatedException, CertPathValidatorUtilities, b, 
//            h, RFC3280CertPathUtilities
...
final class f
{
    ...
    private static void a(DistributionPoint distributionpoint, X509AttributeCertificate x509attributecertificate, ExtendedPKIXParameters extendedpkixparameters, Date date, b b1, h h1, List list)
    {
        if (x509attributecertificate.getExtensionValue(X509Extensions.D.e()) == null) goto _L2; else goto _L1
_L1:
        return;
_L2:
...
_L4:
        ...
        h2 = RFC3280CertPathUtilities.a(x509crl1, distributionpoint);
        if (!h2.c(h1)) goto _L4; else goto _L3
_L3:
        ...
        RFC3280CertPathUtilities.a(date, x509crl, x509attributecertificate, b1, extendedpkixparameters);
        RFC3280CertPathUtilities.a(date, x509crl1, x509attributecertificate, b1);
        if (b1.a == 8)
        {
            b1.a = 11;
        }
...
_L5:
        try
        {
            adistributionpoint = ((CRLDistPoint) (obj)).e();
        }
        // Misplaced declaration of an exception variable
        catch (X509AttributeCertificate x509attributecertificate)
        {
        ...
        a(adistributionpoint[i], x509attributecertificate, ((ExtendedPKIXParameters) (obj)), date, b1, h1, list);
        flag = true;
        i++;
...
_L7:
        ...
        obj1 = (new ASN1InputStream(((X500Principal)x509attributecertificate.d().a()[0]).getEncoded())).a();
        a(new DistributionPoint(new DistributionPointName(new GeneralNames(new GeneralName(4, ((org.bouncycastle.asn1.ASN1Encodable) (obj1)))))), x509attributecertificate, (ExtendedPKIXParameters)extendedpkixparameters.clone(), date, b1, h1, list);
        flag = true;
        obj1 = obj;
_L10:
        if (!flag)
...
_L9:
        if (b1.a != 11)
        {
            x509attributecertificate = (new StringBuilder("Attribute certificate revocation after ")).append(b1.b).toString();
            throw new CertPathValidatorException((new StringBuilder()).append(x509attributecertificate).append(", reason: ").append(RFC3280CertPathUtilities.o[b1.a]).toString());
        }
        if (!h1.a() && b1.a == 11)
        {
            b1.a = 12;
...
_L11:
    ...
    protected static CertPath d(X509AttributeCertificate x509attributecertificate, ExtendedPKIXParameters extendedpkixparameters)
    {
        ...
        do
        {
            if (((Iterator) (obj2)).hasNext())
            {
                ...
                extendedpkixbuilderparameters.a(((org.bouncycastle.util.Selector) (obj1)));
                try
                {
    ...
    static 
    {
        a = X509Extensions.E.e();
        b = X509Extensions.D.e();
        c = X509Extensions.p.e();
        d = X509Extensions.x.e();
    }
}
