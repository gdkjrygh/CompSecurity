...
public class EC5Util
{
    ...
    public static EllipticCurve a(ECCurve eccurve)
    {
        ...
        {
            return new EllipticCurve(new ECFieldFp(((org.bouncycastle.math.ec.ECCurve.Fp)eccurve).e()), eccurve.c().a(), eccurve.d().a(), null);
        }
    ...
    public static org.bouncycastle.math.ec.ECPoint a(java.security.spec.ECParameterSpec ecparameterspec, ECPoint ecpoint)
    {
        return a(a(ecparameterspec.getCurve()), ecpoint, false);
    }

    public static org.bouncycastle.math.ec.ECPoint a(ECCurve eccurve, ECPoint ecpoint, boolean flag)
    {
