...
public class X509AttrCertParser extends X509StreamParserSpi
{
    ...
    private X509AttributeCertificate b()
    {
        if (b != null)
        {
            while (c < b.f()) 
            {
                ...
                c = i + 1;
                obj = ((ASN1Set) (obj)).a(i);
                if ((obj instanceof ASN1TaggedObject) && ((ASN1TaggedObject)obj).e() == 2)
                {
                    return new X509V2AttributeCertificate(ASN1Sequence.a((ASN1TaggedObject)obj, false).a());
                }
            }
        }
        return null;
    ...
    public final Object a()
    {
        ...
        return new X509V2AttributeCertificate(asn1sequence.a());
        d.reset();
        obj = d;
        ...
        obj = new X509V2AttributeCertificate(((ASN1Sequence) (obj)).a());
        return obj;
    }
