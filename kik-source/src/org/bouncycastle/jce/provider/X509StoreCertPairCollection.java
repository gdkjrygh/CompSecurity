...
public class X509StoreCertPairCollection extends X509StoreSpi
{
    ...
    public final void a(X509StoreParameters x509storeparameters)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("Initialization parameters must be an instance of ")).append(org/bouncycastle/x509/X509CollectionStoreParameters.getName()).append(".").toString());
        } else
        {
