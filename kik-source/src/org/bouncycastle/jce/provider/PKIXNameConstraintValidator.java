...
public class PKIXNameConstraintValidator
{
    ...
    private static Set a(Set set, Set set1)
    {
        ...
        {
            ASN1Sequence asn1sequence = ASN1Sequence.a(((GeneralSubtree)set1.next()).e().f().c());
            if (set == null)
            {
...
_L2:
        return false;
        if (asn1sequence1.f() <= 0 || asn1sequence1.f() > asn1sequence.f()) goto _L2; else goto _L1
_L1:
        int k = asn1sequence1.f() - 1;
label0:
        do
        {
label1:
...
_L3:
    ...
    private static Set b(Set set, Set set1)
    {
        ...
        for (set1 = set1.iterator(); set1.hasNext();)
        {
            String s = c(((GeneralSubtree)set1.next()).e());
            if (set == null)
            {
                if (s != null)
                {
    ...
    {
        return DERIA5String.a(generalname.f()).n_();
    }
    ...
    private static Set c(Set set, Set set1)
    {
        ...
        do
        {
            ...
            byte abyte0[] = ASN1OctetString.a(((GeneralSubtree)iterator.next()).e().f()).f();
            if (set == null)
            {
                if (abyte0 != null)
                {
...
label0:
        {
            Object obj = f;
            if (obj != null && (!((Set) (obj)).isEmpty() || asn1sequence.f() != 0))
            {
...
_L3:
        set = g;
        generalname = DERIA5String.a(generalname.f()).n_();
        if (set == null)
        {
            continue; /* Loop/switch isn't completed */
        }
...
_L4:
        a(ASN1Sequence.a(generalname.f().c()));
        return;
_L5:
        set = i;
        generalname = DERIA5String.a(generalname.f()).n_();
...
_L6:
        generalname = ASN1OctetString.a(generalname.f()).f();
        set = j;
        if (set != null)
        {
...
_L12:
    ...
    {
        generalsubtree = generalsubtree.e();
        switch (generalsubtree.e())
        {
        case 3: // '\003'
        case 5: // '\005'
        default:
        ...
        case 4: // '\004'
            a = a(a, (ASN1Sequence)generalsubtree.f().c());
            return;
        ...
        case 7: // '\007'
            e = a(e, ASN1OctetString.a(generalsubtree.f()).f());
            return;
        }
    }
...
_L4:
        b(ASN1Sequence.a(generalname.f().c()));
        return;
_L5:
        Object obj2 = d;
        generalname = DERIA5String.a(generalname.f()).n_();
...
_L8:
    ...
    public final void c(ASN1Sequence asn1sequence)
    {
        ...
        Integer integer;
        for (asn1sequence = asn1sequence.e(); asn1sequence.hasMoreElements(); ((Set)hashmap.get(integer)).add(generalsubtree))
        {
            generalsubtree = GeneralSubtree.a(asn1sequence.nextElement());
            integer = new Integer(generalsubtree.e().e());
