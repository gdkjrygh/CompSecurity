...
public class ElGamalUtil
{
    ...
    public static AsymmetricKeyParameter a(PrivateKey privatekey)
    {
        if (privatekey instanceof ElGamalPrivateKey)
        {
            ...
            return new ElGamalPrivateKeyParameters(privatekey.getX(), new ElGamalParameters(privatekey.a().a(), privatekey.a().b()));
        }
    ...
    public static AsymmetricKeyParameter a(PublicKey publickey)
    {
        if (publickey instanceof ElGamalPublicKey)
        {
            ...
            return new ElGamalPublicKeyParameters(publickey.getY(), new ElGamalParameters(publickey.a().a(), publickey.a().b()));
        }
