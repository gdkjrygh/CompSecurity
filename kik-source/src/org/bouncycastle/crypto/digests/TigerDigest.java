    ...
    implements ExtendedDigest
{
    ...
    public TigerDigest(TigerDigest tigerdigest)
    {
        ...
        f = tigerdigest.f;
        g = tigerdigest.g;
        System.arraycopy(tigerdigest.k, 0, k, 0, tigerdigest.k.length);
        l = tigerdigest.l;
        System.arraycopy(tigerdigest.i, 0, i, 0, tigerdigest.i.length);
        j = tigerdigest.j;
        h = tigerdigest.h;
    }
    ...
    {
        long al[] = k;
        al[0] = al[0] - (k[7] ^ 0xa5a5a5a5a5a5a5a5L);
        al = k;
        al[1] = al[1] ^ k[0];
        al = k;
        al[2] = al[2] + k[1];
        al = k;
        al[3] = al[3] - (k[2] ^ ~k[1] << 19);
        al = k;
        al[4] = al[4] ^ k[3];
        al = k;
        al[5] = al[5] + k[4];
        al = k;
        al[6] = al[6] - (k[5] ^ ~k[4] >>> 23);
        al = k;
        al[7] = al[7] ^ k[6];
        al = k;
        al[0] = al[0] + k[7];
        al = k;
        al[1] = al[1] - (k[0] ^ ~k[7] << 19);
        al = k;
        al[2] = al[2] ^ k[1];
        al = k;
        al[3] = al[3] + k[2];
        al = k;
        al[4] = al[4] - (k[3] ^ ~k[2] >>> 23);
        al = k;
        al[5] = al[5] ^ k[4];
        al = k;
        al[6] = al[6] + k[5];
        al = k;
        al[7] = al[7] - (k[6] ^ 0x123456789abcdefL);
    }
    ...
    private void processLength(long l1)
    {
        k[7] = l1;
    }

    private void processWord(byte abyte0[], int i1)
    {
        long al[] = k;
        int j1 = l;
        l = j1 + 1;
        al[j1] = (long)(abyte0[i1 + 7] & 0xff) << 56 | (long)(abyte0[i1 + 6] & 0xff) << 48 | (long)(abyte0[i1 + 5] & 0xff) << 40 | (long)(abyte0[i1 + 4] & 0xff) << 32 | (long)(abyte0[i1 + 3] & 0xff) << 24 | (long)(abyte0[i1 + 2] & 0xff) << 16 | (long)(abyte0[i1 + 1] & 0xff) << 8 | (long)(abyte0[i1 + 0] & 0xff);
        if (l == k.length)
        {
            processBlock();
        }
    ...
    private void roundABC(long l1, long l2)
    {
        g = g ^ l1;
        e = e - (a[(int)g & 0xff] ^ b[(int)(g >> 16) & 0xff] ^ c[(int)(g >> 32) & 0xff] ^ d[(int)(g >> 48) & 0xff]);
        f = f + (d[(int)(g >> 8) & 0xff] ^ c[(int)(g >> 24) & 0xff] ^ b[(int)(g >> 40) & 0xff] ^ a[(int)(g >> 56) & 0xff]);
        f = f * l2;
    }

    private void roundBCA(long l1, long l2)
    {
        e = e ^ l1;
        f = f - (a[(int)e & 0xff] ^ b[(int)(e >> 16) & 0xff] ^ c[(int)(e >> 32) & 0xff] ^ d[(int)(e >> 48) & 0xff]);
        g = g + (d[(int)(e >> 8) & 0xff] ^ c[(int)(e >> 24) & 0xff] ^ b[(int)(e >> 40) & 0xff] ^ a[(int)(e >> 56) & 0xff]);
        g = g * l2;
    }

    private void roundCAB(long l1, long l2)
    {
        f = f ^ l1;
        g = g - (a[(int)f & 0xff] ^ b[(int)(f >> 16) & 0xff] ^ c[(int)(f >> 32) & 0xff] ^ d[(int)(f >> 48) & 0xff]);
        e = e + (d[(int)(f >> 8) & 0xff] ^ c[(int)(f >> 24) & 0xff] ^ b[(int)(f >> 40) & 0xff] ^ a[(int)(f >> 56) & 0xff]);
        e = e * l2;
    }
    ...
    {
        finish();
        unpackWord(e, abyte0, i1);
        unpackWord(f, abyte0, i1 + 8);
        unpackWord(g, abyte0, i1 + 16);
        reset();
        return 24;
    }
    ...
    public void reset()
    {
        e = 0x123456789abcdefL;
        f = 0xfedcba9876543210L;
        g = 0xf096a5b4c3b2e187L;
        l = 0;
        for (int i1 = 0; i1 != k.length; i1++)
        {
            k[i1] = 0L;
    ...
    public void unpackWord(long l1, byte abyte0[], int i1)
    {
        abyte0[i1 + 7] = (byte)(int)(l1 >> 56);
        abyte0[i1 + 6] = (byte)(int)(l1 >> 48);
        abyte0[i1 + 5] = (byte)(int)(l1 >> 40);
        abyte0[i1 + 4] = (byte)(int)(l1 >> 32);
        abyte0[i1 + 3] = (byte)(int)(l1 >> 24);
        abyte0[i1 + 2] = (byte)(int)(l1 >> 16);
