    ...
    implements BlockCipher
{
    ...
    private void Bits32ToBytes(int i1, byte abyte0[], int j1)
    {
        abyte0[j1 + 3] = (byte)i1;
    ...
    private int BytesTo32bits(byte abyte0[], int i1)
    {
    ...
    {
        return (f[i1 >>> 24] + g[i1 >>> 16 & 0xff] ^ h[i1 >>> 8 & 0xff]) + i[i1 & 0xff];
    }

    private void decryptBlock(byte abyte0[], int i1, byte abyte1[], int j1)
    {
        int k1 = BytesTo32bits(abyte0, i1);
        int l1 = BytesTo32bits(abyte0, i1 + 4);
        k1 ^= j[17];
        for (i1 = 16; i1 > 0; i1 -= 2)
        {
            l1 ^= F(k1) ^ j[i1];
        ...
        Bits32ToBytes(j[0] ^ l1, abyte1, j1);
        Bits32ToBytes(k1, abyte1, j1 + 4);
    }

    private void encryptBlock(byte abyte0[], int i1, byte abyte1[], int j1)
    {
        int k1 = BytesTo32bits(abyte0, i1);
        int l1 = BytesTo32bits(abyte0, i1 + 4);
        k1 ^= j[0];
        ...
        Bits32ToBytes(j[17] ^ l1, abyte1, j1);
        Bits32ToBytes(k1, abyte1, j1 + 4);
    }

    private void processTable(int i1, int j1, int ai[])
    {
        int i2 = ai.length;
        for (int k1 = 0; k1 < i2;)
        {
    ...
    {
        System.arraycopy(b, 0, f, 0, 256);
        System.arraycopy(c, 0, g, 0, 256);
        System.arraycopy(d, 0, h, 0, 256);
        System.arraycopy(e, 0, i, 0, 256);
        System.arraycopy(a, 0, j, 0, 18);
        ...
        for (; j1 < 18; j1++)
        {
            ...
            int k1;
            byte byte0;
            for (k1 = 0; l1 < 4; k1 = byte0 & 0xff | k1 << 8)
            {
                int i2 = i1 + 1;
                byte0 = abyte0[i1];
                i1 = i2;
        ...
        processTable(0, 0, j);
        processTable(j[16], j[17], f);
        processTable(f[254], f[255], g);
        processTable(g[254], g[255], h);
        processTable(h[254], h[255], i);
    }
    ...
    public final int processBlock(byte abyte0[], int i1, byte abyte1[], int j1)
    {
        if (l == null)
        {
        ...
        if (k)
        {
            encryptBlock(abyte0, i1, abyte1, j1);
        } else
        {
            decryptBlock(abyte0, i1, abyte1, j1);
        }
        return 8;
    }
