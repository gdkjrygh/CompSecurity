    ...
    implements BlockCipher
{
    ...
    private int G(int i)
    {
        return b[i & 0xff] ^ c[i >> 8 & 0xff] ^ d[i >> 16 & 0xff] ^ e[i >> 24 & 0xff];
    }
    ...
    {
        h = flag;
        g = createWorkingKey(((KeyParameter)cipherparameters).getKey());
    }
    ...
    public int processBlock(byte abyte0[], int i, byte abyte1[], int j)
    {
        ...
        long l1 = bytesToLong(abyte0, i + 0);
        long l = bytesToLong(abyte0, i + 8);
        long l2;
        long l3;
        if (h)
        {
        ...
        longToBytes(abyte1, j + 0, l2);
        longToBytes(abyte1, j + 8, l3);
        return 16;
    }
