    ...
    implements AsymmetricBlockCipher
{
    ...
    public void init(boolean flag, CipherParameters cipherparameters)
    {
        if (cipherparameters instanceof ParametersWithRandom)
        {
            ...
            a = (ElGamalKeyParameters)cipherparameters.getParameters();
        ...
        c = flag;
        d = a.getParameters().getP().bitLength();
        if (flag)
        {
...
label0:
        {
            ...
            biginteger2 = a.getParameters().getP();
            if (a instanceof ElGamalPrivateKeyParameters)
            {
                ...
                return BigIntegers.a(abyte0.modPow(biginteger2.subtract(f).subtract(elgamalprivatekeyparameters.getX()), biginteger2).multiply(biginteger).mod(biginteger2));
            }
            if (i == 0)
            {
                abyte2 = abyte0;
        ...
        BigInteger biginteger3 = a.getParameters().getG().modPow(abyte0, biginteger2);
