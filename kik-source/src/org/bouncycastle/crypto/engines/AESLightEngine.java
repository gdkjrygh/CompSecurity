    ...
    implements BlockCipher
{
    ...
    private void decryptBlock(int ai[][])
    {
        ...
        for (k = d - 1; k > 1;)
        {
            int j1 = inv_mcol(b[f & 0xff] & 0xff ^ (b[i >> 8 & 0xff] & 0xff) << 8 ^ (b[h >> 16 & 0xff] & 0xff) << 16 ^ b[g >> 24 & 0xff] << 24) ^ ai[k][0];
            int l1 = inv_mcol(b[g & 0xff] & 0xff ^ (b[f >> 8 & 0xff] & 0xff) << 8 ^ (b[i >> 16 & 0xff] & 0xff) << 16 ^ b[h >> 24 & 0xff] << 24) ^ ai[k][1];
            int j2 = inv_mcol(b[h & 0xff] & 0xff ^ (b[g >> 8 & 0xff] & 0xff) << 8 ^ (b[f >> 16 & 0xff] & 0xff) << 16 ^ b[i >> 24 & 0xff] << 24) ^ ai[k][2];
            int l2 = inv_mcol(b[i & 0xff] & 0xff ^ (b[h >> 8 & 0xff] & 0xff) << 8 ^ (b[g >> 16 & 0xff] & 0xff) << 16 ^ b[f >> 24 & 0xff] << 24);
            int l = k - 1;
            k = ai[k][3] ^ l2;
            f = inv_mcol(b[j1 & 0xff] & 0xff ^ (b[k >> 8 & 0xff] & 0xff) << 8 ^ (b[j2 >> 16 & 0xff] & 0xff) << 16 ^ b[l1 >> 24 & 0xff] << 24) ^ ai[l][0];
            g = inv_mcol(b[l1 & 0xff] & 0xff ^ (b[j1 >> 8 & 0xff] & 0xff) << 8 ^ (b[k >> 16 & 0xff] & 0xff) << 16 ^ b[j2 >> 24 & 0xff] << 24) ^ ai[l][1];
            h = inv_mcol(b[j2 & 0xff] & 0xff ^ (b[l1 >> 8 & 0xff] & 0xff) << 8 ^ (b[j1 >> 16 & 0xff] & 0xff) << 16 ^ b[k >> 24 & 0xff] << 24) ^ ai[l][2];
            j1 = inv_mcol(b[k & 0xff] & 0xff ^ (b[j2 >> 8 & 0xff] & 0xff) << 8 ^ (b[l1 >> 16 & 0xff] & 0xff) << 16 ^ b[j1 >> 24 & 0xff] << 24);
            k = l - 1;
            i = j1 ^ ai[l][3];
        }

        int i1 = inv_mcol(b[f & 0xff] & 0xff ^ (b[i >> 8 & 0xff] & 0xff) << 8 ^ (b[h >> 16 & 0xff] & 0xff) << 16 ^ b[g >> 24 & 0xff] << 24) ^ ai[k][0];
        int k1 = inv_mcol(b[g & 0xff] & 0xff ^ (b[f >> 8 & 0xff] & 0xff) << 8 ^ (b[i >> 16 & 0xff] & 0xff) << 16 ^ b[h >> 24 & 0xff] << 24) ^ ai[k][1];
        int i2 = inv_mcol(b[h & 0xff] & 0xff ^ (b[g >> 8 & 0xff] & 0xff) << 8 ^ (b[f >> 16 & 0xff] & 0xff) << 16 ^ b[i >> 24 & 0xff] << 24) ^ ai[k][2];
        int k2 = inv_mcol(b[i & 0xff] & 0xff ^ (b[h >> 8 & 0xff] & 0xff) << 8 ^ (b[g >> 16 & 0xff] & 0xff) << 16 ^ b[f >> 24 & 0xff] << 24);
        k = ai[k][3] ^ k2;
    ...
    private void encryptBlock(int ai[][])
    {
        ...
        for (k = 1; k < d - 1;)
        {
            int j1 = mcol(a[f & 0xff] & 0xff ^ (a[g >> 8 & 0xff] & 0xff) << 8 ^ (a[h >> 16 & 0xff] & 0xff) << 16 ^ a[i >> 24 & 0xff] << 24) ^ ai[k][0];
            int l1 = mcol(a[g & 0xff] & 0xff ^ (a[h >> 8 & 0xff] & 0xff) << 8 ^ (a[i >> 16 & 0xff] & 0xff) << 16 ^ a[f >> 24 & 0xff] << 24) ^ ai[k][1];
            int j2 = mcol(a[h & 0xff] & 0xff ^ (a[i >> 8 & 0xff] & 0xff) << 8 ^ (a[f >> 16 & 0xff] & 0xff) << 16 ^ a[g >> 24 & 0xff] << 24) ^ ai[k][2];
            int l2 = mcol(a[i & 0xff] & 0xff ^ (a[f >> 8 & 0xff] & 0xff) << 8 ^ (a[g >> 16 & 0xff] & 0xff) << 16 ^ a[h >> 24 & 0xff] << 24);
            int l = k + 1;
            k = ai[k][3] ^ l2;
            f = mcol(a[j1 & 0xff] & 0xff ^ (a[l1 >> 8 & 0xff] & 0xff) << 8 ^ (a[j2 >> 16 & 0xff] & 0xff) << 16 ^ a[k >> 24 & 0xff] << 24) ^ ai[l][0];
            g = mcol(a[l1 & 0xff] & 0xff ^ (a[j2 >> 8 & 0xff] & 0xff) << 8 ^ (a[k >> 16 & 0xff] & 0xff) << 16 ^ a[j1 >> 24 & 0xff] << 24) ^ ai[l][1];
            h = mcol(a[j2 & 0xff] & 0xff ^ (a[k >> 8 & 0xff] & 0xff) << 8 ^ (a[j1 >> 16 & 0xff] & 0xff) << 16 ^ a[l1 >> 24 & 0xff] << 24) ^ ai[l][2];
            j1 = mcol(a[k & 0xff] & 0xff ^ (a[j1 >> 8 & 0xff] & 0xff) << 8 ^ (a[l1 >> 16 & 0xff] & 0xff) << 16 ^ a[j2 >> 24 & 0xff] << 24);
            k = l + 1;
            i = j1 ^ ai[l][3];
        }

        int i1 = mcol(a[f & 0xff] & 0xff ^ (a[g >> 8 & 0xff] & 0xff) << 8 ^ (a[h >> 16 & 0xff] & 0xff) << 16 ^ a[i >> 24 & 0xff] << 24) ^ ai[k][0];
        int k1 = mcol(a[g & 0xff] & 0xff ^ (a[h >> 8 & 0xff] & 0xff) << 8 ^ (a[i >> 16 & 0xff] & 0xff) << 16 ^ a[f >> 24 & 0xff] << 24) ^ ai[k][1];
        int i2 = mcol(a[h & 0xff] & 0xff ^ (a[i >> 8 & 0xff] & 0xff) << 8 ^ (a[f >> 16 & 0xff] & 0xff) << 16 ^ a[g >> 24 & 0xff] << 24) ^ ai[k][2];
        int i3 = mcol(a[i & 0xff] & 0xff ^ (a[f >> 8 & 0xff] & 0xff) << 8 ^ (a[g >> 16 & 0xff] & 0xff) << 16 ^ a[h >> 24 & 0xff] << 24);
        int k2 = k + 1;
        k = ai[k][3] ^ i3;
    ...
    {
        int i2 = abyte0.length / 4;
        if (i2 != 4 && i2 != 6 && i2 != 8 || i2 * 4 != abyte0.length)
        {
        ...
        int k1 = 0;
        for (int l = 0; k1 < abyte0.length; l++)
        {
            ai[l >> 2][l & 3] = abyte0[k1] & 0xff | (abyte0[k1 + 1] & 0xff) << 8 | (abyte0[k1 + 2] & 0xff) << 16 | abyte0[k1 + 3] << 24;
            k1 += 4;
        }
        ...
        while (k1 < k2 + 1 << 2) 
        {
            ...
            if (k1 % i2 == 0)
            {
                i1 = subWord(shift(j2, 8)) ^ c[k1 / i2 - 1];
            } else
            {
                i1 = j2;
                if (i2 > 6)
    ...
    private int inv_mcol(int k)
    {
        int l = FFmulX(k);
        int i1 = FFmulX(l);
        int j1 = FFmulX(i1);
        k ^= j1;
        return shift(l ^ k, 8) ^ (j1 ^ (l ^ i1)) ^ shift(i1 ^ k, 16) ^ shift(k, 24);
    }

    private int mcol(int k)
    {
        int l = FFmulX(k);
        return l ^ shift(k ^ l, 8) ^ shift(k, 16) ^ shift(k, 24);
    }

    private void packBlock(byte abyte0[], int k)
    {
        int l = k + 1;
        abyte0[k] = (byte)f;
        k = l + 1;
    ...
    private int shift(int k, int l)
    {
        return k >>> l | k << -l;
    }

    private int subWord(int k)
    {
        return a[k & 0xff] & 0xff | (a[k >> 8 & 0xff] & 0xff) << 8 | (a[k >> 16 & 0xff] & 0xff) << 16 | a[k >> 24 & 0xff] << 24;
    }

    private void unpackBlock(byte abyte0[], int k)
    {
        int l = k + 1;
        f = abyte0[k] & 0xff;
        int i1 = f;
    ...
    public void init(boolean flag, CipherParameters cipherparameters)
    {
        ...
        {
            e = generateWorkingKey(((KeyParameter)cipherparameters).getKey(), flag);
            j = flag;
            return;
        } else
        {
    ...
    public int processBlock(byte abyte0[], int k, byte abyte1[], int l)
    {
        if (e == null)
        {
