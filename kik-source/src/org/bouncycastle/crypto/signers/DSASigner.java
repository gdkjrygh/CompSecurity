    ...
    implements DSA
{
    ...
    {
        DSAParameters dsaparameters = a.getParameters();
        ...
        return (new BigInteger[] {
            biginteger1, biginteger.modInverse(dsaparameters.getQ()).multiply(abyte0.add(((DSAPrivateKeyParameters)a).getX().multiply(biginteger1))).mod(dsaparameters.getQ())
        });
    }
    ...
    public void init(boolean flag, CipherParameters cipherparameters)
    {
        if (flag)
        {
            if (cipherparameters instanceof ParametersWithRandom)
            {
                ...
                a = (DSAPrivateKeyParameters)cipherparameters.getParameters();
                return;
            } else
            {
                b = new SecureRandom();
    ...
    public boolean verifySignature(byte abyte0[], BigInteger biginteger, BigInteger biginteger1)
    {
        ...
        return dsaparameters.getG().modPow(abyte0, dsaparameters.getP()).multiply(((DSAPublicKeyParameters)a).getY().modPow(biginteger1, dsaparameters.getP())).mod(dsaparameters.getP()).mod(dsaparameters.getQ()).equals(biginteger);
    }
}
