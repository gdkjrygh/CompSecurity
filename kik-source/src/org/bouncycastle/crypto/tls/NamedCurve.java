...
public class NamedCurve
{
    ...
    static ECDomainParameters getECParameters(int i)
    {
        ...
        if (i >= 0 && i < a.length)
        {
            if ((x9ecparameters = SECNamedCurves.a(a[i])) != null)
            {
                return new ECDomainParameters(x9ecparameters.e(), x9ecparameters.f(), x9ecparameters.g(), x9ecparameters.h(), x9ecparameters.i());
            }
        }
        return null;
    }
