    ...
    implements p
{
    ...
    public final byte[] calculateRawSignature(SecureRandom securerandom, AsymmetricKeyParameter asymmetrickeyparameter, byte abyte0[])
    {
    ...
    public final Signer createVerifyer(AsymmetricKeyParameter asymmetrickeyparameter)
    {
