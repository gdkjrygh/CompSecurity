...
_L3:
        ...
        obj = ((X509AttributeCertificate) (obj)).getExtensionValue(X509Extensions.E.e());
        if (obj == null)
        {
            break; /* Loop/switch isn't completed */
        }
        try
        {
            obj = TargetInformation.a((new ASN1InputStream(((DEROctetString)DEROctetString.a(((byte []) (obj)))).f())).a());
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
...
label0:
            {
                ...
                if (j < atarget.length)
                {
                    if (!f.contains(GeneralName.a(atarget[j].f())))
                    {
                        break label0;
                    }
                    flag1 = true;
...
label1:
                {
                    ...
                    if (j < atarget.length)
                    {
                        if (!g.contains(GeneralName.a(atarget[j].e())))
                        {
                            break label1;
                        }
                        flag1 = true;
