...
public interface NTTObjectIdentifiers
{
    ...
    public static final ASN1ObjectIdentifier a = new ASN1ObjectIdentifier("1.2.392.200011.61.1.1.1.2");
    public static final ASN1ObjectIdentifier b = new ASN1ObjectIdentifier("1.2.392.200011.61.1.1.1.3");
