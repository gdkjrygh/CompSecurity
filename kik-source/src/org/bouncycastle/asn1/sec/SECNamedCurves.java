...
public class SECNamedCurves
{
    ...
    {
        s1 = (DERObjectIdentifier)H.get(Strings.c(s1));
        if (s1 != null)
        {
    ...
    {
        derobjectidentifier = (X9ECParametersHolder)I.get(derobjectidentifier);
    ...
    {
        H.put(s1, derobjectidentifier);
        J.put(derobjectidentifier, s1);
    ...
    {
        return (DERObjectIdentifier)H.get(Strings.c(s1));
    }
