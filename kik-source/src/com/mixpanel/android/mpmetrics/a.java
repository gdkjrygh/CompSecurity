...
final class com.mixpanel.android.mpmetrics.a
{
    ...
    private final class b
    {
        ...
        static void a(b b1)
        {
            ...
            if (b1.f > 0L)
            {
                b1.e = ((l1 - b1.f) + b1.e * b1.d) / l2;
                long l3 = b1.e / 1000L;
                com.mixpanel.android.mpmetrics.a.a((new StringBuilder("Average send frequency approximately ")).append(l3).append(" seconds.").toString());
            }
            b1.f = l1;
            b1.d = l2;
        }
...
_L1:
    ...
    private final class b.a extends Handler
    {
        ...
        private JSONObject a()
        {
            ...
            i1 = GooglePlayServicesUtil.isGooglePlayServicesAvailable(com.mixpanel.android.mpmetrics.a.a(a.a));
            i1;
...
_L7:
            ...
            obj = Boolean.valueOf(b.d(a).b());
            if (obj != null)
            {
                jsonobject.put("$has_nfc", ((Boolean) (obj)).booleanValue());
            }
            obj = Boolean.valueOf(b.d(a).c());
            if (obj != null)
            {
...
_L3:
            String s2 = as[i1];
            byte abyte0[] = ae.a(s2, arraylist, b.d(a).a());
...
_L11:
        ...
        public final void handleMessage(Message message)
        {
            if (b == null)
            {
                ...
                b.a(System.currentTimeMillis() - (long)com.mixpanel.android.mpmetrics.a.b(a.a).c(), u.b.b);
            }
...
_L1:
            ...
            int i1 = -1;
_L8:
            if (i1 >= com.mixpanel.android.mpmetrics.a.b(a.a).a())
            {
...
_L3:
            ...
            {
                com.mixpanel.android.mpmetrics.a.a((new StringBuilder("Queue depth ")).append(i1).append(" - Adding flush in ").append(c).toString());
                if (c >= 0L)
                {
                    sendEmptyMessageDelayed(com.mixpanel.android.mpmetrics.a.d(), c);
                    return;
...
_L7:
        ...
        public b.a(b b1, Looper looper)
        {
            ...
            super(looper);
            b = null;
            e = new g(com.mixpanel.android.mpmetrics.a.a(b1.a), com.mixpanel.android.mpmetrics.a.b(b1.a));
            d = com.mixpanel.android.mpmetrics.a.b(b1.a).d();
            c = com.mixpanel.android.mpmetrics.a.b(b1.a).b();
            b.a(b1, new ak(com.mixpanel.android.mpmetrics.a.a(b1.a)));
        }
    }
    ...
    private com.mixpanel.android.mpmetrics.a(Context context)
    {
        b = context;
        c = t.a(context);
    }
...
_L2:
        return context;
        context = (com.mixpanel.android.mpmetrics.a)l.get(context1);
        if (true) goto _L2; else goto _L1
_L1:
        context;
        map;
    ...
    static void a(String s)
    {
        if (t.a)
        {
            (new StringBuilder()).append(s).append(" (Thread ").append(Thread.currentThread().getId()).append(")");
        }
    }

    protected static ae b()
    {
        return new ae();
    }

    static t b(com.mixpanel.android.mpmetrics.a a1)
    {
        return a1.c;
    }

    protected static u b(Context context)
    {
