...
public static final class j extends FilterOutputStream
{
...
label0:
        {
            if (b > 0)
            {
                ...
                out.write(com.kik.m.e.a(g, c, b, i));
                b = 0;
            }
            super.close();
            c = null;
...
_L2:
        ...
        if (b >= d)
        {
            out.write(com.kik.m.e.a(g, c, d, i));
            e = e + 4;
            if (f && e >= 76)
            {
                out.write(10);
...
_L6:
    ...
    public Stream(OutputStream outputstream, int k)
    {
        boolean flag1 = true;
        super(outputstream);
        int l;
