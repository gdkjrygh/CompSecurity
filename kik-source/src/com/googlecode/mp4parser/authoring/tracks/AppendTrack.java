...
public class AppendTrack extends AbstractTrack
{
    ...
    public static transient String appendTracknames(Track atrack[])
    {
        int j = atrack.length;
        String s = "";
        int i = 0;
        do
        {
            ...
            Track track = atrack[i];
            s = (new StringBuilder(String.valueOf(s))).append(track.getName()).append(" + ").toString();
            i++;
        } while (true);
    }
...
_L6:
        if (j >= i1)
        {
          ...
          goto _L3
_L2:
        j += al[i].getSampleDurations().length;
        i++;
          goto _L4
_L3:
        long al1[];
        int j1;
        al1 = atrack[j].getSampleDurations();
        j1 = al1.length;
          goto _L5
        exception;
        throw exception;
