...
_L2:
        i = ((PlayReadyRecord)((Iterator) (obj)).next()).getValue().rewind().limit() + (i + 4);
          goto _L3
    ...
    static 
    {
        ...
        ProtectionSpecificHeader.uuidRegistry.put(PROTECTION_SYSTEM_ID, com/googlecode/mp4parser/contentprotection/PlayReadyHeader);
    }
}
