    ...
    implements ViewPager.a
{
        ...
        implements b
    {
        ...
        public void a(TextView textview)
        {
            android.support.v4.view.p.a(textview);
        }
...
_L4:
    ...
    void a(o o1, o o2)
    {
        ...
        {
            o2.a(l);
            m = new WeakReference(o2);
        }
        if (a != null)
        {
            f = -1;
            g = -1F;
            a(a.getCurrentItem(), o2);
            requestLayout();
        }
    }
