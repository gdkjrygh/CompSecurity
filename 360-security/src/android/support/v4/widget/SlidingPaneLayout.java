...
public class SlidingPaneLayout extends ViewGroup
{
    ...
    class a extends android.support.v4.view.a
    {
        ...
        public void a(View view, android.support.v4.view.a.a a1)
        {
            ...
            a1.a(view);
            view = android.support.v4.view.s.f(view);
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            if (a.getParent() == b)
            {
                android.support.v4.view.s.a(a, 0, null);
...
_L3:
        ...
        implements e
    {
        ...
        {
            android.support.v4.view.s.a(slidingpanelayout, view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        }
    ...
    public SlidingPaneLayout(Context context, AttributeSet attributeset, int i1)
    {
        ...
        q = android.support.v4.widget.j.a(this, 0.5F, new c());
        q.a(f1 * 400F);
    }
...
label0:
    ...
    private void a(View view, float f1, int i1)
    {
        ...
        if (f1 > 0.0F && i1 != 0)
        {
            ...
            if (android.support.v4.view.s.d(view) != 2)
            {
                android.support.v4.view.s.a(view, 2, layoutparams.d);
            }
            g(view);
        } else
        if (android.support.v4.view.s.d(view) != 0)
        {
            ...
            view = new b(view);
            u.add(view);
            android.support.v4.view.s.a(this, view);
            return;
        }
    }
    ...
    static j b(SlidingPaneLayout slidingpanelayout)
    {
    ...
    private boolean f()
    {
        return android.support.v4.view.s.e(this) == 1;
    }
