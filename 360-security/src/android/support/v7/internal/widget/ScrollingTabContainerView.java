    ...
    implements AdapterViewICS.OnItemClickListener
{
    private class TabAdapter extends BaseAdapter
    {
        ...
        public View getView(int i, View view, ViewGroup viewgroup)
        {
            if (view == null)
            {
                return createTabView((android.support.v7.app.ActionBar.c)getItem(i), true);
            } else
            {
                ((TabView)view).bindTab((android.support.v7.app.ActionBar.c)getItem(i));
                return view;
            }
        }
    ...
    public static class TabView extends LinearLayout
    {
        ...
        private android.support.v7.app.ActionBar.c mTab;
        private TextView mTextView;

        void attach(ScrollingTabContainerView scrollingtabcontainerview, android.support.v7.app.ActionBar.c c, boolean flag)
        {
        ...
        public void bindTab(android.support.v7.app.ActionBar.c c)
        {
            mTab = c;
            update();
        }
        ...
        public void update()
        {
            ...
            } else
            {
                ...
                if (charsequence != null)
                {
                    if (mTextView == null)
                    {
                        CompatTextView compattextview = new CompatTextView(getContext(), null, android.support.v7.a.a.b.actionBarTabTextStyle);
                ...
                if (mIconView != null)
                {
                    mIconView.setContentDescription(((android.support.v7.app.ActionBar.c) (obj)).e());
                    return;
                }
            }
        }
    ...
    public ScrollingTabContainerView(Context context)
    {
        ...
        mTabLayout = (LinearLayout)mInflater.inflate(android.support.v7.a.a.g.abc_action_bar_tabbar, this, false);
        addView(mTabLayout, new android.view.ViewGroup.LayoutParams(-2, -1));
    }

    private SpinnerICS createSpinner()
    {
        SpinnerICS spinnerics = new SpinnerICS(getContext(), null, android.support.v7.a.a.b.actionDropDownStyle);
        spinnerics.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-2, -1));
        spinnerics.setOnItemClickListenerInt(this);
        return spinnerics;
    }

    private TabView createTabView(android.support.v7.app.ActionBar.c c, boolean flag)
    {
        TabView tabview = (TabView)mInflater.inflate(android.support.v7.a.a.g.abc_action_bar_tab, mTabLayout, false);
        tabview.attach(this, c, flag);
        if (flag)
        {
    ...
    public void addTab(android.support.v7.app.ActionBar.c c, int i, boolean flag)
    {
        c = createTabView(c, false);
        mTabLayout.addView(c, i, new android.widget.LinearLayout.LayoutParams(0, -1, 1.0F));
        if (mTabSpinner != null)
        {
    ...
    public void addTab(android.support.v7.app.ActionBar.c c, boolean flag)
    {
        c = createTabView(c, false);
        mTabLayout.addView(c, new android.widget.LinearLayout.LayoutParams(0, -1, 1.0F));
        if (mTabSpinner != null)
        {
            ((TabAdapter)mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
