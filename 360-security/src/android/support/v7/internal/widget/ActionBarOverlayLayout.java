...
public class ActionBarOverlayLayout extends FrameLayout
{
    ...
    private boolean applyInsets(View view, Rect rect, boolean flag, boolean flag1, boolean flag2, boolean flag3)
    {
        ...
        if (flag2 && ((android.widget.FrameLayout.LayoutParams) (view)).bottomMargin != rect.bottom)
        {
    ...
    void pullChildren()
    {
        if (mContent == null)
        {
            mContent = findViewById(android.support.v7.a.a.e.action_bar_activity_content);
            if (mContent == null)
            {
                mContent = findViewById(0x1020002);
            }
            mActionBarTop = findViewById(android.support.v7.a.a.e.top_action_bar);
            mContainerView = (ActionBarContainer)findViewById(android.support.v7.a.a.e.action_bar_container);
            mActionView = (ActionBarView)findViewById(android.support.v7.a.a.e.action_bar);
            mActionBarBottom = findViewById(android.support.v7.a.a.e.split_action_bar);
        }
    }
    ...
    static 
    {
        mActionBarSizeAttr = (new int[] {
            android.support.v7.a.a.b.actionBarSize
        });
    }
}
