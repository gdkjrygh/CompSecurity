...
public class ActionBarContextView extends AbsActionBarView
{
    ...
    {
        this(context, attributeset, android.support.v7.a.a.b.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, i);
        context = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.ActionMode, i, 0);
...
label0:
    ...
    public void initForMode(final a mode)
    {
        android.view.ViewGroup.LayoutParams layoutparams;
        if (mClose == null)
        {
            mClose = LayoutInflater.from(getContext()).inflate(android.support.v7.a.a.g.abc_action_mode_close_item, this, false);
            addView(mClose);
        } else
        ...
        mClose.findViewById(android.support.v7.a.a.e.action_mode_close_button).setOnClickListener(new android.view.View.OnClickListener() {
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        if (mClose != null && mClose.getVisibility() != 8)
        {
            ...
            j = marginlayoutparams.rightMargin + (j + l);
        } else
        {
            j = i1;
        }
