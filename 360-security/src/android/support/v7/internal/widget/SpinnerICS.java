    ...
    implements android.content.DialogInterface.OnClickListener
{
    ...
    {
        this(context, null, android.support.v7.a.a.b.spinnerStyle, i);
    }

    SpinnerICS(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, android.support.v7.a.a.b.spinnerStyle);
    }
    ...
    SpinnerICS(Context context, AttributeSet attributeset, int i, int j)
    {
        ...
        super(context, attributeset, i);
        mTempRect = new Rect();
        typedarray = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.Spinner, i, 0);
        k = j;
        if (j == -1)
        {
