...
label0:
            {
                ...
                obj = LayoutInflater.from(getContext()).inflate(android.support.v7.a.a.g.abc_activity_chooser_view_list_item, viewgroup, false);
                ((View) (obj)).setId(1);
                ((TextView)((View) (obj)).findViewById(android.support.v7.a.a.e.title)).setText(getContext().getString(android.support.v7.a.a.h.abc_activity_chooser_view_see_all));
            }
_L8:
            return ((View) (obj));
_L2:
...
_L4:
            View view1 = view;
            if (view.getId() == android.support.v7.a.a.e.list_item) goto _L6; else goto _L5
_L5:
            view1 = LayoutInflater.from(getContext()).inflate(android.support.v7.a.a.g.abc_activity_chooser_view_list_item, viewgroup, false);
_L6:
            view = getContext().getPackageManager();
            viewgroup = (ImageView)view1.findViewById(android.support.v7.a.a.e.icon);
            obj = (ResolveInfo)getItem(i);
            viewgroup.setImageDrawable(((ResolveInfo) (obj)).loadIcon(view));
            ((TextView)view1.findViewById(android.support.v7.a.a.e.title)).setText(((ResolveInfo) (obj)).loadLabel(view));
            obj = view1;
            if (mShowDefaultActivity)
            {
                obj = view1;
...
_L6:
    ...
    public ActivityChooserView(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.ActivityChooserView, i, 0);
        mInitialActivityCount = attributeset.getInt(0, 4);
        Drawable drawable = attributeset.getDrawable(1);
        attributeset.recycle();
        LayoutInflater.from(getContext()).inflate(android.support.v7.a.a.g.abc_activity_chooser_view, this, true);
        mCallbacks = new Callbacks();
        mActivityChooserContent = (LinearLayout)findViewById(android.support.v7.a.a.e.activity_chooser_view_content);
        mActivityChooserContentBackground = mActivityChooserContent.getBackground();
        mDefaultActivityButton = (FrameLayout)findViewById(android.support.v7.a.a.e.default_activity_button);
        mDefaultActivityButton.setOnClickListener(mCallbacks);
        mDefaultActivityButton.setOnLongClickListener(mCallbacks);
        mDefaultActivityButtonImage = (ImageView)mDefaultActivityButton.findViewById(android.support.v7.a.a.e.image);
        mExpandActivityOverflowButton = (FrameLayout)findViewById(android.support.v7.a.a.e.expand_activities_button);
        mExpandActivityOverflowButton.setOnClickListener(mCallbacks);
        mExpandActivityOverflowButtonImage = (ImageView)mExpandActivityOverflowButton.findViewById(android.support.v7.a.a.e.image);
        ...
        mListPopupMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(android.support.v7.a.a.d.abc_config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int i)
    {
        ...
        if (!listpopupwindow.isShowing())
        {
            ...
            listpopupwindow.getListView().setContentDescription(getContext().getString(android.support.v7.a.a.h.abc_activitychooserview_choose_application));
        }
    }
