...
abstract class AbsActionBarView extends ViewGroup
{
    ...
    public void animateToVisibility(int i)
    {
        ...
        if (i != getVisibility())
        {
            ...
            if (i == 0)
            {
                j = android.support.v7.a.a.a.abc_fade_in;
            } else
            {
                j = android.support.v7.a.a.a.abc_fade_out;
            }
    ...
    protected void onConfigurationChanged(Configuration configuration)
    {
        ...
        TypedArray typedarray = getContext().obtainStyledAttributes(null, android.support.v7.a.a.j.ActionBar, android.support.v7.a.a.b.actionBarStyle, 0);
        setContentHeight(typedarray.getLayoutDimension(1, 0));
        typedarray.recycle();
        if (mSplitWhenNarrow)
        {
            setSplitActionBar(getContext().getResources().getBoolean(android.support.v7.a.a.c.abc_split_action_bar_is_narrow));
        }
        if (mActionMenuPresenter != null)
        {
