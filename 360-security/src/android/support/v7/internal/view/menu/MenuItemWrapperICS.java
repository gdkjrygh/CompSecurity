    ...
    implements b
{
    class ActionProviderWrapper extends ActionProvider
    {
        ...
        public ActionProviderWrapper(d d1)
        {
        ...
        implements CollapsibleActionView
    {
        ...
        final android.support.v7.b.b mWrappedView;
        ...
        CollapsibleActionViewWrapper(View view)
        {
            ...
            mWrappedView = (android.support.v7.b.b)view;
            addView(view);
        }
    }
        ...
        implements android.view.MenuItem.OnActionExpandListener
    {
        ...
        {
            return ((android.support.v4.view.j.e)mWrappedObject).b(getMenuItemWrapper(menuitem));
        }

        public boolean onMenuItemActionExpand(MenuItem menuitem)
        {
            return ((android.support.v4.view.j.e)mWrappedObject).a(getMenuItemWrapper(menuitem));
        }

        OnActionExpandListenerWrapper(android.support.v4.view.j.e e)
        {
            this$0 = MenuItemWrapperICS.this;
            super(e);
        }
    ...
    final boolean checkActionProviderOverrideVisibility()
    {
        ...
        {
            d d1 = getSupportActionProvider();
            flag = flag1;
            if (d1 != null)
            {
                flag = flag1;
                if (d1.overridesItemVisibility())
                {
                    flag = flag1;
                    if (!d1.isVisible())
                    {
    ...
    ActionProviderWrapper createActionProviderWrapper(d d1)
    {
        return new ActionProviderWrapper(d1);
    }
    ...
    public b setSupportActionProvider(d d1)
    {
        ...
        if (d1 != null)
        {
            d1 = createActionProviderWrapper(d1);
        } else
        {
            d1 = null;
        }
    ...
    public b setSupportOnActionExpandListener(android.support.v4.view.j.e e)
    {
        MenuItem menuitem = (MenuItem)mWrappedObject;
        if (e != null)
        {
            e = new OnActionExpandListenerWrapper(e);
        } else
        {
            e = null;
        }
        menuitem.setOnActionExpandListener(e);
        return null;
    }
