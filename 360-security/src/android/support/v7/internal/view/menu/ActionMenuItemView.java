    ...
    implements ActionMenuView.ActionMenuChildView, MenuView.ItemView, android.view.View.OnClickListener, android.view.View.OnLongClickListener
{
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mAllowTextWithIcon = context.getResources().getBoolean(android.support.v7.a.a.c.abc_config_allowActionMenuItemTextWithIcon);
        context = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.ActionMenuItemView, 0, 0);
