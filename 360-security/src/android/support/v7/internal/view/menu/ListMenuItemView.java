    ...
    implements MenuView.ItemView
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mContext = context;
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.MenuView, i, 0);
    ...
    {
        mCheckBox = (CheckBox)getInflater().inflate(android.support.v7.a.a.g.abc_list_menu_item_checkbox, this, false);
        addView(mCheckBox);
    }

    private void insertIconView()
    {
        mIconView = (ImageView)getInflater().inflate(android.support.v7.a.a.g.abc_list_menu_item_icon, this, false);
        addView(mIconView, 0);
    }

    private void insertRadioButton()
    {
        mRadioButton = (RadioButton)getInflater().inflate(android.support.v7.a.a.g.abc_list_menu_item_radio, this, false);
    ...
    protected void onFinishInflate()
    {
        ...
        mTitleView = (TextView)findViewById(android.support.v7.a.a.e.title);
        if (mTextAppearance != -1)
        {
            mTitleView.setTextAppearance(mTextAppearanceContext, mTextAppearance);
        }
        mShortcutView = (TextView)findViewById(android.support.v7.a.a.e.shortcut);
    }
