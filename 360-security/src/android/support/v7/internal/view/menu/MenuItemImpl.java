    ...
    implements b
{
    ...
    private android.support.v4.view.j.e mOnActionExpandListener;
    ...
    public boolean collapseActionView()
    {
        if ((mShowAsAction & 8) != 0)
        {
            ...
            if (mOnActionExpandListener == null || mOnActionExpandListener.b(this))
            {
    ...
    {
        while ((mShowAsAction & 8) == 0 || mActionView == null || mOnActionExpandListener != null && !mOnActionExpandListener.a(this)) 
        {
            return false;
        }
...
_L5:
    ...
    public b setSupportActionProvider(d d1)
    {
        if (mActionProvider != d1)
        {
            ...
            if (d1 != null)
            {
                d1.setVisibilityListener(new android.support.v4.view.d.b() {
