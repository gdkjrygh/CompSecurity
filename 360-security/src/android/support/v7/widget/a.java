...
class android.support.v7.widget.a extends f
    implements android.view.View.OnClickListener
{
    private static final class a
    {
        ...
        public a(View view)
        {
            ...
            e = (ImageView)view.findViewById(android.support.v7.a.e.edit_query);
        }
    }
    ...
    {
        super(context, android.support.v7.a.g.abc_search_dropdown_item_icons_2line, null, true);
        o = false;
        p = 1;
        r = -1;
        s = -1;
...
_L1:
    ...
    private CharSequence b(CharSequence charsequence)
    {
        if (q == null)
        {
            ...
            d.getTheme().resolveAttribute(android.support.v7.a.b.textColorSearchUrl, typedvalue, true);
