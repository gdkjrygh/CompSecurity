...
public class j
{
    ...
    private j(String s, String s1, String s2, List list, String s3, String s4)
    {
        a = s;
        b = s1;
        c = s2;
    ...
    public static j a(JSONObject jsonobject)
    {
        ...
        return new j(s, s1, s2, arraylist, jsonobject.optString("market_uri"), jsonobject.optString("fallback_url"));
    }
