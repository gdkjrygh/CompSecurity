...
public class InstallStatisticianProvider extends ContentProvider
{
    ...
    public InstallStatisticianProvider()
    {
    }
...
label0:
    ...
    {
        b = new UriMatcher(-1);
        b.addURI("com.qihoo.security.lite.installreport", "log", 1);
        c = new HashMap();
        c.put("_id", "_id");
        c.put("tp", "tp");
        c.put("pn", "pn");
