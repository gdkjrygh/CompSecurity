...
public class c extends SQLiteOpenHelper
{
    ...
    private static final String a = com/qihoo/security/installreport/c.getSimpleName();
    private SQLiteDatabase b;

    public c(Context context)
    {
        super(context, "installbi.db", null, 1);
    }
