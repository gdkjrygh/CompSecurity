    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        a a2;
        if (com.qihoo.security.enginehelper.clean.a.p(b.b) == null)
        {
            break MISSING_BLOCK_LABEL_61;
        }
        a2 = (b)com.qihoo.security.enginehelper.clean.a.p(b.b).get();
        if (a2 == null)
        {
            break MISSING_BLOCK_LABEL_61;
        }
        a2.b(com.qihoo.security.enginehelper.clean.b(b), a);
        a1;
...
/* anonymous class */
        ...
        implements a
    {
        ...
        public void a(int i, int j, TrashType trashtype, TrashInfo trashinfo, Map map)
        {
            ...
            com.qihoo.security.enginehelper.clean.a.o(a).execute(new a._cls3._cls3(this, map));
        }
