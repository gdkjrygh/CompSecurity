    ...
    implements Runnable
{
    ...
    public void run()
    {
        a.a.a(com.qihoo.security.ui.exam._DANGER, true);
        com.qihoo.security.ui.antivirus.VirusScanFragmentV3.a(a.a, true);
        if (VirusScanFragmentV3.T(a.a).(0))
        {
            VirusScanFragmentV3.U(a.a).ges(0);
        }
            ...
            if (a.isAdded() && com.qihoo.security.ui.antivirus.VirusScanFragmentV3.a(a) == 3)
            {
                ...
                do
                {
                    ...
                    if (maliciousinfo.state == 127 && maliciousinfo.isWarning())
                    {
                        ...
                        VirusScanFragmentV3.g(a).runOnUiThread(new VirusScanFragmentV3._cls12._cls9());
                    }
                    ...
                    if (maliciousinfo.state == 127 && maliciousinfo.isTrojan() && (!maliciousinfo.isSystem || !com.qihoo360.mobilesafe.b.a.b(VirusScanFragmentV3.h(a), maliciousinfo.packageName) || VirusScanFragmentV3.i(a)) && !c.a(VirusScanFragmentV3.h(a), maliciousinfo) && maliciousinfo.isFileExist())
                    {
                        ...
                        VirusScanFragmentV3.g(a).runOnUiThread(new VirusScanFragmentV3._cls12._cls13(this));
                    }
                } while (true);
                if (!d.a)
                {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/qihoo/security/ui/antivirus/VirusScanFragmentV3$12$9

/* anonymous class */
        class VirusScanFragmentV3._cls12._cls9
            implements Runnable
        {
