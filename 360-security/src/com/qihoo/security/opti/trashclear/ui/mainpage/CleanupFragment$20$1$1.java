...
label0:
        {
            synchronized (a(b.b))
            {
                if (!CleanupFragment.a(b.b.b) && b.b.b.isAdded())
                {
                    break label0;
                }
            }
        ...
        if (!com.qihoo.security.opti.trashclear.ui.mainpage.(b.b))
        {
        ...
        JVM INSTR monitorexit ;
        throw exception;
        CleanupFragment.A(b.b.b).setText(a[0]);
        CleanupFragment.B(b.b.b).setText(a[1]);
        abyte0;
        JVM INSTR monitorexit ;
    }
...
/* anonymous class */
        ...
        implements com.qihoo.security.enginehelper.clean.a.b
    {
        ...
        public void a()
        {
            ...
            CleanupFragment.a(a, new CleanupFragment.b(new CleanupFragment._cls20._cls1(this), 1));
