    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        throw exception;
        synchronized (CleanupFragment.E(c.c.c))
        {
            CleanupFragment.E(c.c.c).setTag(Long.valueOf(a));
            CleanupFragment.E(c.c.c).setTitle(b);
            if (a > 0L)
            {
                CleanupFragment.E(c.c.c).setTitleColor(CleanupFragment.D(c.c.c));
                CleanupFragment.E(c.c.c).setColor(CleanupFragment.D(c.c.c));
                CleanupFragment.E(c.c.c).setSummaryColor(CleanupFragment.D(c.c.c));
            }
        }
        abyte0;
        JVM INSTR monitorexit ;
...
/* anonymous class */
        ...
        implements com.qihoo.security.enginehelper.clean.a.b
    {
        ...
        public void a()
        {
            ...
            CleanupFragment.c(a, new CleanupFragment.b(new CleanupFragment._cls20._cls3(this), 1));
