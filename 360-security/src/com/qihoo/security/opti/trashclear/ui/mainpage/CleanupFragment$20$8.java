    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (!CleanupFragment.a(b.b) && b.b.isAdded())
        {
            ed(b, a);
        }
        CleanupFragment.J(b.b);
    }
...
/* anonymous class */
        ...
        implements com.qihoo.security.enginehelper.clean.a.b
    {
        ...
        public void b(int i, Map map)
        {
            ...
            com.qihoo.security.opti.trashclear.ui.mainpage.CleanupFragment.b(a).runOnUiThread(new CleanupFragment._cls20._cls8(this, map));
            CleanupFragment.K(a);
