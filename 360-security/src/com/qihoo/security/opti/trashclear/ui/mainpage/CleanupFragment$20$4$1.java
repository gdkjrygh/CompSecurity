    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        throw exception;
        synchronized (CleanupFragment.F(c.c.c))
        {
            CleanupFragment.F(c.c.c).setTag(Long.valueOf(a));
            CleanupFragment.F(c.c.c).setTitle(b);
            if (a > 0L)
            {
                CleanupFragment.F(c.c.c).setTitleColor(CleanupFragment.D(c.c.c));
                CleanupFragment.F(c.c.c).setColor(CleanupFragment.D(c.c.c));
                CleanupFragment.F(c.c.c).setSummaryColor(CleanupFragment.D(c.c.c));
            }
        }
        abyte0;
        JVM INSTR monitorexit ;
...
/* anonymous class */
        ...
        implements com.qihoo.security.enginehelper.clean.a.b
    {
        ...
        public void a()
        {
            ...
            com.qihoo.security.opti.trashclear.ui.mainpage.CleanupFragment.b(a, new CleanupFragment.b(new CleanupFragment._cls20._cls2(), 1));
            CleanupFragment.v(a).a();
            CleanupFragment.c(a, new CleanupFragment.b(new CleanupFragment._cls20._cls3(), 1));
            CleanupFragment.w(a).a();
            com.qihoo.security.opti.trashclear.ui.mainpage.CleanupFragment.d(a, new CleanupFragment.b(new CleanupFragment._cls20._cls4(this), 1));
...
/* anonymous class */
        ...
        // Unreferenced inner class com/qihoo/security/opti/trashclear/ui/mainpage/CleanupFragment$20$2$1

/* anonymous class */
        class CleanupFragment._cls20._cls2._cls1
            implements Runnable
        {

            final long a;
            final String b;
            final CleanupFragment._cls20._cls2 c;
