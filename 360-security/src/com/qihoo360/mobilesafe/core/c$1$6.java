    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (c.f(com.qihoo360.mobilesafe.core.b(a)) != null)
        {
            c.f(com.qihoo360.mobilesafe.core.a(a)).unregister(b);
        }
    }

    <init>(<init> <init>1, a a1)
    {
        a = <init>1;
        b = a1;
        super();
...
/* anonymous class */
    class c._cls1 extends com.qihoo360.mobilesafe.core.c.c.a
    {
            ...
            throws RemoteException
        {
            ...
            if (com.qihoo360.mobilesafe.core.c.b(a) != null)
            {
                com.qihoo360.mobilesafe.core.c.b(a).post(new c._cls1._cls6(this, a1));
            }
        }
