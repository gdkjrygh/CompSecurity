    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (com.qihoo360.mobilesafe.core.c.e(com.qihoo360.mobilesafe.core.b(a)) != null)
        {
            c.b(com.qihoo360.mobilesafe.core.a(a), b);
        }
    }

    <init>(<init> <init>1, List list)
    {
        a = <init>1;
        b = list;
        super();
...
/* anonymous class */
    class c._cls1 extends com.qihoo360.mobilesafe.core.c.c.a
    {
            ...
            throws RemoteException
        {
            ...
            if (com.qihoo360.mobilesafe.core.c.b(a) != null)
            {
                com.qihoo360.mobilesafe.core.c.b(a).post(new c._cls1._cls4(this, list));
            }
        }
