...
class y
{
    ...
    void a(AttributeSet attributeset, int i)
    {
        ...
        if (j != -1)
        {
            TypedArray typedarray1 = context.obtainStyledAttributes(j, k.TextAppearance);
            if (typedarray1.hasValue(k.TextAppearance_textAllCaps))
            {
                a(typedarray1.getBoolean(k.TextAppearance_textAllCaps, false));
            }
            typedarray1.recycle();
        }
        ...
        if (attributeset != null && !attributeset.isStateful())
        {
            ...
            {
                i = ag.c(context, 0x1010038);
            } else
            {
                i = ag.a(context, 0x1010038);
            }
            c.setTextColor(ag.a(attributeset.getDefaultColor(), i));
        }
    }
