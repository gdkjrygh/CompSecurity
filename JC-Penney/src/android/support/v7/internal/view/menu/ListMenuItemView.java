    ...
    implements x
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        l = context;
        attributeset = context.obtainStyledAttributes(attributeset, k.MenuView, i1, 0);
        g = attributeset.getDrawable(k.MenuView_android_itemBackground);
        h = attributeset.getResourceId(k.MenuView_android_itemTextAppearance, -1);
        j = attributeset.getBoolean(k.MenuView_preserveIconSpacing, false);
        i = context;
    ...
    private void b()
    {
        b = (ImageView)getInflater().inflate(h.abc_list_menu_item_icon, this, false);
        addView(b, 0);
    }

    private void c()
    {
        c = (RadioButton)getInflater().inflate(h.abc_list_menu_item_radio, this, false);
        addView(c);
    }

    private void d()
    {
        e = (CheckBox)getInflater().inflate(h.abc_list_menu_item_checkbox, this, false);
        addView(e);
    }
    ...
    protected void onFinishInflate()
    {
        ...
        d = (TextView)findViewById(f.title);
        if (h != -1)
        {
            d.setTextAppearance(i, h);
        }
        f = (TextView)findViewById(f.shortcut);
    }
