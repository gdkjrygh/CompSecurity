...
public class ViewPager extends ViewGroup
{
    ...
    private static final dm ai = new dm();
    private static final Comparator c = new da();
    private static final Interpolator d = new db();
    private boolean A;
    private boolean B;
    private int C;
    private int D;
    ...
    private int a(int i1, float f1, int j1, int k1)
    {
        ...
        {
            de de1 = (de)e.get(0);
            de de2 = (de)e.get(e.size() - 1);
            j1 = Math.max(de1.b, Math.min(i1, de2.b));
        }
        return j1;
    }
    ...
    static bi a(ViewPager viewpager)
    {
        return viewpager.h;
    }
    ...
    private void a(int i1, int j1, int k1, int l1)
    {
        if (j1 > 0 && !e.isEmpty())
        {
            ...
            if (!m.isFinished())
            {
                ...
                l1 = m.timePassed();
                de de1 = b(i);
                m.startScroll(j1, 0, (int)(de1.e * (float)i1), 0, k1 - l1);
            }
        } else
        {
            de de2 = b(i);
    ...
    private void a(int i1, boolean flag, int j1, boolean flag1)
    {
        ...
        if (de1 != null)
        {
            ...
            k1 = (int)(Math.max(s, Math.min(de1.e, t)) * f1);
        } else
        {
            k1 = 0;
        }
    ...
    private void a(de de1, int i1, de de2)
    {
        int i3 = h.b();
        ...
        if (de2 != null)
        {
            ...
            if (j1 < de1.b)
            {
                float f1 = de2.e + de2.d + f4;
                j1++;
                int j2;
                for (int k1 = 0; j1 <= de1.b && k1 < e.size(); j1 = j2 + 1)
                {
                    de2 = (de)e.get(k1);
                    float f5;
                    do
        ...
        for (; i2 >= 0; i2--)
        {
            for (de2 = (de)e.get(i2); j1 > de2.b; j1--)
            {
                f3 -= h.c(j1) + f4;
            }
        ...
        for (; j1 < l2; j1++)
        {
            for (de1 = (de)e.get(j1); i1 < de1.b; i1++)
            {
                f3 = h.c(i1) + f4 + f3;
            }
    ...
    {
        int i1 = ba.b(motionevent);
        if (ba.b(motionevent, i1) == J)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            F = ba.c(motionevent, i1);
            J = ba.b(motionevent, i1);
            if (K != null)
            {
                K.clear();
            }
...
_L3:
    ...
    private boolean d(int i1)
    {
        ...
        } else
        {
            ...
            int j1 = de1.b;
            f1 = ((float)i1 / (float)k1 - de1.e) / (de1.d + f1);
    ...
    private void j()
    {
        ...
        {
            j1 = i1;
            if (!((df)getChildAt(i1).getLayoutParams()).a)
            {
                removeViewAt(i1);
                j1 = i1 - 1;
            }
...
_L20:
        ...
        obj = (de)e.get(i1);
        if (((de) (obj)).b < i) goto _L6; else goto _L5
_L5:
        if (((de) (obj)).b != i)
        {
            break MISSING_BLOCK_LABEL_1273;
...
_L7:
        ...
        {
            f2 = (2.0F - ((de) (obj2)).d) + (float)getPaddingLeft() / (float)i3;
        }
        j1 = i;
        f3 = 0.0F;
        l1 = j1 - 1;
...
_L12:
        ...
        } else
        {
          ...
          goto _L22
_L19:
        if (j1 == ((de) (obj)).b && !((de) (obj)).c)
        {
            e.remove(i1);
            h.a(this, j1, ((de) (obj)).a);
            if (i1 < e.size())
            {
                obj = (de)e.get(i1);
            } else
...
_L8:
        ...
        ((bi) (obj1)).b(this, i1, obj);
        h.b(this);
        j1 = getChildCount();
        for (i1 = 0; i1 < j1; i1++)
        {
            obj1 = getChildAt(i1);
            obj = (df)((View) (obj1)).getLayoutParams();
            obj.f = i1;
            if (!((df) (obj)).a && ((df) (obj)).c == 0.0F)
            {
                obj1 = a(((View) (obj1)));
                if (obj1 != null)
                {
...
_L25:
        ...
        if (obj != null && ((de) (obj)).b == i) goto _L4; else goto _L26
_L26:
        i1 = 0;
_L29:
...
_L27:
        obj = getChildAt(i1);
        obj1 = a(((View) (obj)));
        if (obj1 != null && ((de) (obj1)).b == i && ((View) (obj)).requestFocus(byte1)) goto _L4; else goto _L28
_L28:
        i1++;
          goto _L29
        obj = null;
...
_L2:
        if (flag && bq.a(view, -i1)) goto _L4; else goto _L6
_L6:
        return false;
...
_L7:
    ...
    public void addView(View view, int i1, android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        df df1 = (df)layoutparams;
        df1.a = df1.a | (view instanceof dd);
        if (w)
        {
            if (df1 != null && df1.a)
            {
    ...
    void b()
    {
        ...
        if (l1 != 0)
        {
            ...
            for (j1 = 0; j1 < k1; j1++)
            {
                obj = (df)getChildAt(j1).getLayoutParams();
                if (!((df) (obj)).a)
                {
                    obj.c = 0.0F;
                }
    ...
    public void b(float f1)
    {
        ...
        float f2 = i1;
        float f4 = t;
        Object obj = (de)e.get(0);
        de de1 = (de)e.get(e.size() - 1);
        long l1;
        if (((de) (obj)).b != 0)
        {
            f1 = ((de) (obj)).e * (float)i1;
        } else
        {
            f1 *= f5;
        }
...
_L2:
        ...
        do
        {
            ...
            {
                de de1 = a(view);
                if (de1 != null && de1.b == i && view.dispatchPopulateAccessibilityEvent(accessibilityevent))
                {
                    return true;
                }
            }
...
_L3:
    ...
    public void e()
    {
        ...
        } else
        {
            ...
            int i1 = (int)bl.a(((VelocityTracker) (obj)), J);
            y = true;
            int j1 = getClientWidth();
            int k1 = getScrollX();
            obj = l();
            a(a(((de) (obj)).b, ((float)k1 / (float)j1 - ((de) (obj)).e) / ((de) (obj)).d, i1, (int)(F - H)), true, true, i1);
            m();
            P = false;
            return;
        }
    ...
    protected int getChildDrawingOrder(int i1, int j1)
    {
        ...
        return ((df)((View)ah.get(k1)).getLayoutParams()).f;
    }
...
_L3:
        for (; i1 > ((de) (obj)).b && j1 < i2; obj = (de)((ArrayList) (obj)).get(j1))
        {
            obj = e;
            j1++;
        }
        ...
        if (i1 == ((de) (obj)).b)
        {
            f2 = (((de) (obj)).e + ((de) (obj)).d) * (float)l1;
            f1 = ((de) (obj)).e + ((de) (obj)).d + f3;
        } else
        {
            float f4 = h.c(i1);
            f2 = (f1 + f4) * (float)l1;
...
_L7:
        ...
        j1 = ba.a(motionevent, j1);
        f3 = ba.c(motionevent, j1);
        f1 = f3 - F;
        f5 = Math.abs(f1);
        f4 = ba.d(motionevent, j1);
        f6 = Math.abs(f4 - I);
...
_L3:
        df df1 = (df)view.getLayoutParams();
        if (!df1.a) goto _L4; else goto _L5
_L5:
        int l5;
        l1 = df1.b;
        l5 = df1.b;
...
_L2:
        ...
        for (l1 = 0; l1 < l4; l1++)
        {
            ...
            df df2 = (df)view1.getLayoutParams();
            if (df2.a)
            {
                continue;
            }
            ...
            float f1 = i2;
            int l2 = (int)(de1.e * f1) + j1;
            if (df2.d)
            {
                df2.d = false;
                float f2 = i2;
                view1.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)(df2.c * f2), 0x40000000), android.view.View.MeasureSpec.makeMeasureSpec(i5 - i1 - k1, 0x40000000));
            }
...
label1:
            ...
            for (j1 = 0; j1 < k1; j1++)
            {
                ...
                {
                    f1 = i1;
                    view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)(df1.c * f1), 0x40000000), v);
                }
            }
    ...
    protected boolean onRequestFocusInDescendants(int i1, Rect rect)
    {
        ...
        for (; j1 != k1; j1 += byte0)
        {
            ...
            de de1 = a(view);
            if (de1 != null && de1.b == i && view.requestFocus(i1, rect))
            {
                return true;
            }
        }
...
_L4:
        if (!A)
        {
            i1 = ba.a(motionevent, J);
            float f2 = android.support.v4.view.ba.c(motionevent, i1);
            float f4 = Math.abs(f2 - F);
            float f3 = ba.d(motionevent, i1);
        ...
        if (A)
        {
            i1 = false | c(android.support.v4.view.ba.c(motionevent, ba.a(motionevent, J)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        i1 = j1;
        if (A)
        {
            Object obj = K;
            ((VelocityTracker) (obj)).computeCurrentVelocity(1000, M);
            i1 = (int)bl.a(((VelocityTracker) (obj)), J);
            y = true;
            j1 = getClientWidth();
            int k1 = getScrollX();
            obj = l();
            a(a(((de) (obj)).b, ((float)k1 / (float)j1 - ((de) (obj)).e) / ((de) (obj)).d, i1, (int)(android.support.v4.view.ba.c(motionevent, ba.a(motionevent, J)) - H)), true, true, i1);
            J = -1;
            m();
            boolean flag = R.c();
            i1 = S.c() | flag;
...
_L7:
        i1 = ba.b(motionevent);
        F = android.support.v4.view.ba.c(motionevent, i1);
        J = ba.b(motionevent, i1);
        i1 = j1;
        continue; /* Loop/switch isn't completed */
_L8:
        a(motionevent);
        F = android.support.v4.view.ba.c(motionevent, ba.a(motionevent, J));
        i1 = j1;
...
_L9:
    ...
    void setOnAdapterChangeListener(dh dh1)
    {
        ad = dh1;
    }
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = android.support.v4.d.c.a(new dl());
        int a;
        Parcelable b;
        ClassLoader c;
