...
public class av
{
    ...
    private static final Interpolator v = new aw();
    private int a;
    private int b;
    private int c;
    private float d[];
    ...
    private av(Context context, ViewGroup viewgroup, ay ay1)
    {
        c = -1;
        if (viewgroup == null)
        {
    ...
    public static av a(ViewGroup viewgroup, float f1, ay ay1)
    {
        viewgroup = a(viewgroup, ay1);
        viewgroup.b = (int)((float)((av) (viewgroup)).b * (1.0F / f1));
        return viewgroup;
    }

    public static av a(ViewGroup viewgroup, ay ay1)
    {
        return new av(viewgroup.getContext(), viewgroup, ay1);
    }
...
_L6:
    ...
    {
        int j1 = ba.c(motionevent);
        for (int i1 = 0; i1 < j1; i1++)
        {
            int k1 = ba.b(motionevent, i1);
            float f1 = ba.c(motionevent, i1);
            float f2 = ba.d(motionevent, i1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void g()
    {
        ...
        a(a(bl.a(l, c), n, m), a(bl.b(l, c), n, m));
    }
...
_L2:
        ...
        if ((p & j1) != 0)
        {
          ...
          goto _L7
_L5:
        j1 = ba.b(motionevent, i1);
        float f2 = ba.c(motionevent, i1);
        float f5 = ba.d(motionevent, i1);
        a(f2, f5, j1);
        if (a == 0)
        {
            i1 = h[j1];
...
_L9:
        l1 = ba.b(motionevent, i1);
        float f3 = ba.c(motionevent, i1);
        float f6 = ba.d(motionevent, i1);
        f7 = f3 - d[l1];
        f8 = f6 - e[l1];
...
_L6:
        float f2;
        float f4;
        i1 = ba.b(motionevent, k1);
        f2 = ba.c(motionevent, k1);
        f4 = ba.d(motionevent, k1);
        a(f2, f4, i1);
        if (a != 0)
        {
...
_L4:
        if (a == 1)
        {
            i1 = ba.a(motionevent, c);
            f2 = ba.c(motionevent, i1);
            f4 = ba.d(motionevent, i1);
            i1 = (int)(f2 - f[c]);
            j1 = (int)(f4 - g[c]);
