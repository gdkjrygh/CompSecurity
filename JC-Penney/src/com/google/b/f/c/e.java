...
public final class e
{
    ...
    private static void a(int j, int k, b b1)
    {
        int i1 = 1 << k - 1;
        int l;
        int j1;
    ...
    private void a(CharSequence charsequence, int j, int k, int l, a a1)
    {
        int l1 = 0;
        int k1 = 0;
        while (k1 < k) 
        {
            ...
            if (i2 == 1)
            {
                j1 = (k - 1) % 3 + ((k1 / 3) * 30 + l * 3);
                i1 = (k1 / 3) * 30 + (k - 1) / 3;
            } else
            {
                j1 = (j - 1) + (k1 / 3) * 30;
                i1 = (k1 / 3) * 30 + l * 3 + (k - 1) % 3;
            }
            a(a[i2][j1], 17, a1.b());
            for (j1 = 0; j1 < j; j1++)
            {
                a(a[i2][charsequence.charAt(l1)], 17, a1.b());
                l1++;
            }
...
label0:
        {
            ...
            if (ai1 == null)
            {
                throw new v("Unable to fit message in columns");
            } else
            {
                return ai1;
            }
...
_L1:
        f3 = ((float)(l * 17 + 69) * 0.357F) / ((float)i1 * 2.0F);
        if (ai == null) goto _L4; else goto _L3
_L3:
        f2 = f1;
        if (Math.abs(f3 - 3F) > Math.abs(f1 - 3F)) goto _L5; else goto _L4
_L4:
        ai = new int[2];
        ai[0] = l;
        ai[1] = i1;
    ...
    {
        int k = 0;
        int k1 = com.google.b.f.c.f.a(j);
        String s1 = com.google.b.f.c.g.a(s, d, e);
        int l1 = s1.length();
        int ai[] = a(l1, k1);
        int l = ai[0];
        int i1 = ai[1];
        ...
        if (k1 + l1 + 1 > 929)
        {
            throw new v((new StringBuilder()).append("Encoded message contains to many code words, message to big (").append(s.length()).append(" bytes)").toString());
        }
        k1 = l1 + j1 + 1;
        s = new StringBuilder(k1);
        s.append((char)k1);
        s.append(s1);
        for (; k < j1; k++)
        {
        ...
        s = s.toString();
        s1 = com.google.b.f.c.f.a(s, j);
        s = (new StringBuilder()).append(s).append(s1).toString();
        b = new a(i1, l);
        a(((CharSequence) (s)), l, i1, j, b);
    }
