...
public class i
{
    ...
    public Map a()
    {
        ...
        {
            hashmap.putAll(((c)iterator.next()).a(q.e(j)));
        }

        iterator = d.iterator();
        for (int k = 1; iterator.hasNext(); k++)
        {
            hashmap.putAll(((a)iterator.next()).a(com.google.android.gms.analytics.q.c(k)));
        }
        ...
        for (int l = 1; iterator.hasNext(); l++)
        {
            ...
            {
                hashmap.putAll(((a)((Iterator) (obj)).next()).a((new StringBuilder()).append(s).append(q.g(i1)).toString()));
            }
