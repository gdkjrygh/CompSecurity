...
public class d
{
    ...
    public d(y y1, Map map, long l, boolean flag)
    {
        this(y1, map, l, flag, 0L, 0, null);
    }

    public d(y y1, Map map, long l, boolean flag, long l1, 
            int i)
    {
        this(y1, map, l, flag, l1, i, null);
    }
            ...
            int i, List list)
    {
        ...
        do
        {
            ...
            if (a(entry1.getKey()))
            {
                String s1 = a(y1, entry1.getKey());
                if (s1 != null)
                {
                    list.put(s1, b(y1, entry1.getValue()));
                }
            }
        } while (true);
        ...
        do
        {
            ...
            if (!a(entry.getKey()))
            {
                String s = a(y1, entry.getKey());
                if (s != null)
                {
                    list.put(s, b(y1, entry.getValue()));
                }
            }
        } while (true);
    ...
    public static d a(y y1, d d1, Map map)
    {
        return new d(y1, map, d1.d(), d1.f(), d1.c(), d1.a(), d1.e());
    }

    private static String a(y y1, Object obj)
    {
        if (obj == null)
        {
            y1 = null;
        } else
        {
            ...
            if (i > 256)
            {
                ...
                y1.c("Hit param name is too long and will be trimmed", Integer.valueOf(i), obj1);
            }
            y1 = ((y) (obj1));
    ...
    private String a(String s, String s1)
    {
        ...
        u.b(flag, "Short param name required");
        s = (String)a.get(s);
        if (s != null)
        {
            return s;
...
_L6:
    ...
    private static String b(y y1, Object obj)
    {
        Object obj1;
        int i;
        if (obj == null)
        ...
        if (i > 8192)
        {
            ...
            y1.c("Hit param value is too long and will be trimmed", Integer.valueOf(i), obj1);
        }
        return ((String) (obj1));
    }
