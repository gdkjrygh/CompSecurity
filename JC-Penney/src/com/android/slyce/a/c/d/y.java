...
class y
{
    ...
    byte[] a(byte abyte0[])
    {
        ...
        do
        {
            ...
            for (i += 8; i >= 8;)
            {
                z1 = z.a(z1)[k >>> i - 8 & 0xff];
                if (z.a(z1) == null)
                {
                    bytearrayoutputstream.write(z.b(z1));
                    i -= z.c(z1);
                    z1 = d;
                } else
                {
        ...
        while (l > 0 && (z.a(abyte0 = z.a(z2)[k << 8 - l & 0xff]) == null && z.c(abyte0) <= l)) 
        {
            bytearrayoutputstream.write(z.b(abyte0));
            l -= z.c(abyte0);
            z2 = d;
        }
