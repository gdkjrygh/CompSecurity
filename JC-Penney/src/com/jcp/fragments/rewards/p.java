...
class p extends DebouncingOnClickListener
{
    ...
    p(RewardsConnectAccountsSignInToJCPFragment..ViewInjector viewinjector, RewardsConnectAccountsSignInToJCPFragment rewardsconnectaccountssignintojcpfragment)
    {
        b = viewinjector;
