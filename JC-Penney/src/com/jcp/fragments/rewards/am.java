...
class am extends DebouncingOnClickListener
{
    ...
    am(RewardsEnrollOptionalInfoFragment..ViewInjector viewinjector, RewardsEnrollOptionalInfoFragment rewardsenrolloptionalinfofragment)
    {
        b = viewinjector;
