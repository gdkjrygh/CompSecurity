...
class q extends DebouncingOnClickListener
{
    ...
    q(RewardsConnectAccountsSignInToJCPFragment..ViewInjector viewinjector, RewardsConnectAccountsSignInToJCPFragment rewardsconnectaccountssignintojcpfragment)
    {
        b = viewinjector;
