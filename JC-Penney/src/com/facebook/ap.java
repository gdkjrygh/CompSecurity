...
final class ap
{
    ...
    private static final String a = com/facebook/ap.getSimpleName();
    private String b;
...
_L5:
    ...
    public Bundle a()
    {
        ...
        do
        {
            ...
            {
                z.a(aq.d, 5, a, (new StringBuilder()).append("Error reading cached value for key: '").append(s).append("' -- ").append(obj).toString());
                return null;
            }
        } while (true);
        return ((Bundle) (obj));
