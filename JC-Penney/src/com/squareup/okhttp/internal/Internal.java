...
public abstract class Internal
{
    ...
    public abstract void addLenient(com.squareup.okhttp.Headers.Builder builder, String s, String s1);
    ...
    public abstract i connectionRawSink(Connection connection);

    public abstract j connectionRawSource(Connection connection);
