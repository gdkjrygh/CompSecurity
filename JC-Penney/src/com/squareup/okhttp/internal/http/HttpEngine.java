...
//            RequestException, RouteException, CacheStrategy, HttpMethod, 
...
_L3:
    ...
    public void disconnect()
    {
        ...
        if (connection1 != null)
        {
            try
            {
                Internal.instance.closeIfOwnedBy(connection1, this);
                return;
            }
            catch (IOException ioexception) { }
        }
    ...
    public Request followUpRequest()
    {
        ...
        obj = userRequest.httpUrl().resolve(((String) (obj)));
        if (obj == null)
        {
            return null;
        }
        if (!((HttpUrl) (obj)).scheme().equals(userRequest.httpUrl().scheme()) && !client.getFollowSslRedirects())
        {
            return null;
        }
        ...
        if (!sameConnection(((HttpUrl) (obj))))
        {
            builder.removeHeader("Authorization");
        }
        return builder.url(((HttpUrl) (obj))).build();
    }
    ...
    public HttpEngine recover(IOException ioexception, ac ac1)
    {
        if (routeSelector != null && connection != null)
        {
        ...
        boolean flag;
        if (ac1 == null || (ac1 instanceof RetryableSink))
        {
            flag = true;
        } else
        {
        ...
        {
            ioexception = close();
            return new HttpEngine(client, userRequest, bufferRequestBody, callerWritesRequestBody, forWebSocket, ioexception, routeSelector, (RetryableSink)ac1, priorResponse);
        }
    }
    ...
    {
        HttpUrl httpurl1 = userRequest.httpUrl();
        return httpurl1.host().equals(httpurl.host()) && httpurl1.port() == httpurl.port() && httpurl1.scheme().equals(httpurl.scheme());
    }
...
_L2:
            ...
            {
                i j = r.a(transport.createRequestBody(request1, request1.body().contentLength()));
