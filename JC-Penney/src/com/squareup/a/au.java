...
final class au extends BitmapDrawable
{
    ...
    au(Context context, Bitmap bitmap, Drawable drawable, aq aq1, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, aq aq1, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new au(context, bitmap, drawable, aq1, flag, flag1));
    }
