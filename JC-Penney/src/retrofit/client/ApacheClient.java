    ...
    implements Client
{
    ...
    private class GenericEntityHttpRequest extends HttpEntityEnclosingRequestBase
    {
        private class TypedOutputEntity extends AbstractHttpEntity
        {
    ...
    private class GenericHttpRequest extends HttpRequestBase
    {
