...
public final class ip extends gr
{

    public static final gr b = new ip();
    ...
    {
        if (a && (gl1 instanceof gi))
        {
            gl1 = (gi)gl1;
            nr nr = ((gi) (gl1)).a;
            if ((nr instanceof ol) || (nr instanceof op))
            {
                gl1 = gl1.f;
                Object aobj[] = ((pe) (gl1)).K;
                if (((pe) (gl1)).K.length == 0 || c(gl1) && e(gl1.b(0).e()) && e(gl1.b()))
                {
                    return true;
                }
            }
