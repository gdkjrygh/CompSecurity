...
public final class nl
{
    ...
    public nl(int i, ot ot1, ov ov1, int j, String s)
    {
        this(i, ot1, ov1, ((ov) (os.a)), j, false, s);
    }

    private nl(int i, ot ot1, ov ov1, ov ov2, int j, boolean flag, String s)
    {
        if (ot1 == null)
        {
    ...
    public nl(int i, ot ot1, ov ov1, ov ov2, String s)
    {
        this(i, ot1, ov1, ov2, 6, false, s);
    }

    public nl(int i, ot ot1, ov ov1, String s)
    {
        this(i, ot1, ov1, ((ov) (os.a)), 1, false, s);
    }

    public nl(int i, ov ov1, ov ov2)
    {
        this(i, ot.i, ov1, ov2, 6, true, null);
    }
    ...
    public final boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            obj = (nl)obj;
            if (a != ((nl) (obj)).a || c != ((nl) (obj)).c || f != ((nl) (obj)).f || !g.equals(((nl) (obj)).g) || !b.equals(((nl) (obj)).b))
            {
                return false;
            }
        }
...
_L1:
        String s = (new StringBuilder("unknown-")).append(pf.d(i)).toString();
_L61:
...
_L62:
        stringbuffer.append((new StringBuilder(" ")).append(pf.d(c)).toString());
_L60:
        stringbuffer.append('}');
