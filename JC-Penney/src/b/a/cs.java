    ...
    implements cr
{
    ...
    public static final String a = String.format("%s %d (%s)", new Object[] {
        "Logcat data is not collected for Android APIs before", Integer.valueOf(16), "Jellybean"
    });
...
_L2:
        ...
        exception1;
        obj1 = obj;
        eu.b("Unable to collect logcat data", exception1);
        obj1 = obj;
