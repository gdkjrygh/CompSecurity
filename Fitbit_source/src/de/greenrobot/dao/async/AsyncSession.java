...
public class AsyncSession
{
    ...
    {
        operationtype = new AsyncOperation(operationtype, daoSession.getDao(class1), obj, i);
        executor.enqueue(operationtype);
        return operationtype;
    }

    private AsyncOperation enqueueDatabaseOperation(AsyncOperation.OperationType operationtype, Object obj, int i)
    {
        operationtype = new AsyncOperation(operationtype, daoSession.getDatabase(), obj, i);
        executor.enqueue(operationtype);
        return operationtype;
    }
