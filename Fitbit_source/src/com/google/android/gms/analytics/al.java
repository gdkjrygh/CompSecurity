...
abstract class al
{
    ...
    public al(Context context, a a1)
    {
        a = context;
        b = a1;
    }

    private ak a(XmlResourceParser xmlresourceparser)
    {
        int i;
...
_L10:
        b.b(s, s2);
          goto _L4
        xmlresourceparser;
        p.a((new StringBuilder()).append("Error parsing tracker configuration file: ").append(xmlresourceparser).toString());
_L2:
        return b.b();
_L9:
...
_L14:
        ...
        p.a((new StringBuilder()).append("Error parsing bool configuration value: ").append(s).toString());
          goto _L4
        xmlresourceparser;
        p.a((new StringBuilder()).append("Error parsing tracker configuration file: ").append(xmlresourceparser).toString());
          goto _L2
...
_L17:
        ...
        b.a(numberformatexception, j);
          goto _L4
        numberformatexception;
        p.a((new StringBuilder()).append("Error parsing int configuration value: ").append(s).toString());
          goto _L4
    }
    ...
    public ak a(int i)
    {
        ...
        try
        {
            ak = a(a.getResources().getXml(i));
        }
        catch (android.content.res.Resources.NotFoundException notfoundexception)
        {
            p.d((new StringBuilder()).append("inflate() called with unknown resourceId: ").append(notfoundexception).toString());
            return null;
        }
        return ak;
    }
