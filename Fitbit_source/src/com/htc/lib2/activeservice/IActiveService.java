...
//            TransportModeRecord, TransportRecordsQueryResult, ITransportModeListener
    ...
    extends IInterface
{
        ...
        implements IActiveService
    {
        ...
        public static IActiveService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.htc.lib2.activeservice.IActiveService");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                boolean flag5 = registerTransportModeListener(ITransportModeListener.Stub.asInterface(parcel.readStrongBinder()));
            ...
            case 2: // '\002'
                parcel.enforceInterface("com.htc.lib2.activeservice.IActiveService");
                unregisterTransportModeListener(ITransportModeListener.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
    ...
    public abstract boolean disableWithPermission()
        throws RemoteException;

    public abstract boolean enableWithPermission()
        throws RemoteException;

    public abstract TransportModeRecord getLatestTransportMode()
        throws RemoteException;
    ...
    public abstract TransportRecordsQueryResult queryTransportModeRecords(long l, long l1)
        throws RemoteException;

    public abstract boolean registerTransportModeListener(ITransportModeListener itransportmodelistener)
        throws RemoteException;

    public abstract void unregisterTransportModeListener(ITransportModeListener itransportmodelistener)
        throws RemoteException;
}
