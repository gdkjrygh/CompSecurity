...
_L1:
    ...
    public static ITransportModeListener asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.htc.lib2.activeservice.ITransportModeListener");
        ...
        throws RemoteException
    {
        ...
        if (parcel.readInt() != 0)
        {
            parcel = (TransportModeRecord)TransportModeRecord.CREATOR.mParcel(parcel);
        } else
        {
            parcel = null;
        }
