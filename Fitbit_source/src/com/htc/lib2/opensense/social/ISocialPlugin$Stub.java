...
_L1:
    ...
    private static final String DESCRIPTOR = "com.htc.lib2.opensense.social.ISocialPlugin";
    ...
    public static ISocialPlugin asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.htc.lib2.opensense.social.ISocialPlugin");
        ...
        throws RemoteException
    {
        ...
        case 1598968902: 
            parcel1.writeString("com.htc.lib2.opensense.social.ISocialPlugin");
            return true;

        case 1: // '\001'
            parcel.enforceInterface("com.htc.lib2.opensense.social.ISocialPlugin");
            isocialpluginresponse1 = se.Stub.asInterface(parcel.readStrongBinder());
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.htc.lib2.opensense.social.ISocialPlugin");
            isocialpluginresponse = se.Stub.asInterface(parcel.readStrongBinder());
            aaccount3 = (Account[])parcel.createTypedArray(Account.CREATOR);
        ...
        case 4: // '\004'
            parcel.enforceInterface("com.htc.lib2.opensense.social.ISocialPlugin");
            getDataSources(se.Stub.asInterface(parcel.readStrongBinder()), parcel.createStringArray());
            return true;
