...
/* anonymous class */
        ...
        implements com.fitbit.food.barcode.b.b.a
    {
        ...
        private com.fitbit.util.SimpleConfirmDialogFragment.a b()
        {
            if (b == null)
            {
                b = new BarcodeScannerActivity._cls4._cls1();
            }
            return b;
        }
        ...
        private com.fitbit.util.SimpleConfirmDialogFragment.a c()
        {
            if (c == null)
            {
                c = new BarcodeScannerActivity._cls4._cls2(this);
            }
            return c;
        }
        ...
        // Unreferenced inner class com/fitbit/food/barcode/ui/BarcodeScannerActivity$4$1

/* anonymous class */
        class BarcodeScannerActivity._cls4._cls1
