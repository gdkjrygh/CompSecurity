...
public class k extends j
{
    ...
    private static final String n = "DisplaySecretCommand";

    public k(g g1, Bundle bundle, d.a a1)
    {
        super(g1, bundle, a1);
    }
    ...
    protected void g()
    {
        ...
        if (galileoprofile.writeValue(k.l(), com.fitbit.galileo.ota.b.k()))
        {
            s();
            return;
        } else
