...
public class StepsChartFragment extends AbsActivityChartFragment
{
    ...
    public StepsChartFragment()
    {
        l = new android.support.v4.app.LoaderManager.LoaderCallbacks() {
            ...
            {
                a = StepsChartFragment.this;
                super();
            }
        };
    }

    static void a(StepsChartFragment stepschartfragment)
    {
        stepschartfragment.o();
    }

    static boolean b(StepsChartFragment stepschartfragment)
    {
        return stepschartfragment.m();
    }

    static void c(StepsChartFragment stepschartfragment)
    {
        stepschartfragment.p();
    }

    protected void a(FitbitChartView fitbitchartview)
    {
        super.a(fitbitchartview);
        b.c(getResources().getDrawable(0x7f020272));
        h().a(this);
    }
    ...
    protected void b()
    {
        ...
        b(true);
        getLoaderManager().restartLoader(121, a(f(), g(), new Bundle()), l);
    }
