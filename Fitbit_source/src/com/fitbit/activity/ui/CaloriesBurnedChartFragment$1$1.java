...
class a extends a
{
    ...
    public g_ g_()
    {
        ...
        {
            obj = com.fitbit.data.domain.rceType.CALORIES_INTRADAY;
        } else
        {
            obj = com.fitbit.data.domain.rceType.CALORIES;
        }
        obj = fs1.a(((com.fitbit.data.domain.rceType) (obj)), date, ((Date) (obj1)));
        rcetype.rceType = t.a().a(com.fitbit.data.domain.AL, ((Date) (obj1)));
        d = ValueGoal.a(rcetype.AL);
        ...
        if (l() != null)
        {
            ...
            {
                c = CaloriesBurnedChartFragment._cls1._cls1.this;
                a = d;
                b = drawable;
                super();
            }
...
/* anonymous class */
        ...
        implements android.support.v4.app.LoaderManager.LoaderCallbacks
    {
        ...
        public void a(Loader loader, AbsActivityChartFragment.a a1)
        {
            ...
            ((ChartSeries) (obj)).F().a(a1.a, new CaloriesBurnedChartFragment._cls1._cls2());
        ...
        public Loader onCreateLoader(int i, Bundle bundle)
        {
            ...
            return new CaloriesBurnedChartFragment._cls1._cls1(this, a.getActivity(), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_START_DATE"), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_END_DATE"), Filter.a(a.k()), intentfilter);
        }
        ...
        // Unreferenced inner class com/fitbit/activity/ui/CaloriesBurnedChartFragment$1$2

/* anonymous class */
        class CaloriesBurnedChartFragment._cls1._cls2
