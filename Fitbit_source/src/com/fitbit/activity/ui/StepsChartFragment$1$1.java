...
class a extends a
{
    ...
    public t.a s_()
    {
        ...
        {
            obj = com.fitbit.data.domain.riesResourceType.STEPS_INTRADAY;
        } else
        {
            obj = com.fitbit.data.domain.riesResourceType.STEPS;
        }
        obj = fs1.a(((com.fitbit.data.domain.riesResourceType) (obj)), date, ((Date) (obj1)));
        ...
        if (l() != null)
        {
            ...
            {
                c = StepsChartFragment._cls1._cls1.this;
                a = d;
                b = drawable;
                super();
            }
