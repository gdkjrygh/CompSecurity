...
//            StepsChartFragment, FitbitActivityChartActivity
    ...
    implements t
{
    ...
    // Unreferenced inner class com/fitbit/activity/ui/StepsChartFragment$1

/* anonymous class */
    class StepsChartFragment._cls1
        implements android.support.v4.app.LoaderManager.LoaderCallbacks
    {

        final StepsChartFragment a;

        public void a(Loader loader, AbsActivityChartFragment.a a1)
        {
            AbsActivityChartFragment.a a2 = a.a;
            a.a = null;
            if (!LoadSavedState.a(a.k()))
            {
                a.b(true);
                return;
            }
            ...
            if (com.fitbit.multipledevice.a.a().j().a())
            {
                ...
                do
                {
                    ...
                    if (o.i(new Date((long)j1.a())))
                    {
                        ...
                        if (livedatapacket != null && livedatapacket.a() != -1)
                        {
                            j1.a(j1.a(), livedatapacket.a());
                        }
                    }
                } while (true);
            }
            a.a = a1;
            com.fitbit.activity.ui.StepsChartFragment.a(a);
            a.a(a1.c);
            a.a(a1.b);
            Object obj = new PostfixDecimalFormat(a.getString(0x7f08056c));
            ((DecimalFormat) (obj)).setMaximumFractionDigits(1);
            a.h().a(((java.text.Format) (obj)));
            a.h().p();
            obj = (ChartSeries)a.h().h().a("MAIN_SERIES");
            boolean flag = StepsChartFragment.b(a);
            ((ChartSeries) (obj)).F().clear();
            ((ChartSeries) (obj)).F().a(a1.a, new StepsChartFragment._cls1._cls2(this));
        ...
        public Loader onCreateLoader(int i, Bundle bundle)
        {
            ...
            return new StepsChartFragment._cls1._cls1(a.getActivity(), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_START_DATE"), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_END_DATE"), Filter.a(a.k()), intentfilter);
        }
        ...
        public void onLoaderReset(Loader loader)
        {
            ...
            {
                a = stepschartfragment;
                super();
            }

        // Unreferenced inner class com/fitbit/activity/ui/StepsChartFragment$1$1

/* anonymous class */
        class StepsChartFragment._cls1._cls1 extends com.fitbit.weight.ui.a
        {

            final StepsChartFragment._cls1 a;
            ...
            public AbsActivityChartFragment.a s_()
            {
                Date date = h();
                Object obj1 = i();
                ...
                {
                    obj = com.fitbit.data.domain.TimeSeriesObject.TimeSeriesResourceType.STEPS_INTRADAY;
                } else
                {
                    obj = com.fitbit.data.domain.TimeSeriesObject.TimeSeriesResourceType.STEPS;
                }
                obj = fs1.a(((com.fitbit.data.domain.TimeSeriesObject.TimeSeriesResourceType) (obj)), date, ((Date) (obj1)));
                a1.c = com.fitbit.data.bl.t.a().a(com.fitbit.data.domain.Goal.GoalType.STEPS_GOAL, ((Date) (obj1)));
                d = ValueGoal.a(a1.c);
                ...
                do
                {
                    ...
                    Object obj2 = (Steps)((Iterator) (obj)).next();
                    double d1 = ((Steps) (obj2)).c().doubleValue();
                    obj2 = new j(((Steps) (obj2)).a().getTime(), new double[] {
                        d1
                    });
                    if (d1 > 0.0D)
                    {
                ...
                if (l() != null)
                {
                    ...
                    obj = l().a(((List) (obj1)), new StepsChartFragment._cls1._cls1._cls1(this, d, ((Drawable) (obj))));
                }
                double d9 = 0.0D;
                double d6 = 0.0D;
                ...
                return a1;
                    ...
                    {
                        a = StepsChartFragment._cls1.this;
                        super(context, date, date1, filter, intentfilter);
                    }
        }


        // Unreferenced inner class com/fitbit/activity/ui/StepsChartFragment$1$1$1

/* anonymous class */
        class StepsChartFragment._cls1._cls1._cls1
            implements com.fitbit.util.chart.Filter.a
        {

            final double a;
            final Drawable b;
            final StepsChartFragment._cls1._cls1 c;
