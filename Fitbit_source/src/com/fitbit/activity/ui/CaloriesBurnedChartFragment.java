...
public class CaloriesBurnedChartFragment extends AbsActivityChartFragment
{
    ...
    public CaloriesBurnedChartFragment()
    {
        l = new android.support.v4.app.LoaderManager.LoaderCallbacks() {
            ...
            {
                a = CaloriesBurnedChartFragment.this;
                super();
            }
        };
    }

    static void a(CaloriesBurnedChartFragment caloriesburnedchartfragment)
    {
        caloriesburnedchartfragment.o();
    }

    static boolean b(CaloriesBurnedChartFragment caloriesburnedchartfragment)
    {
        return caloriesburnedchartfragment.m();
    }

    static void c(CaloriesBurnedChartFragment caloriesburnedchartfragment)
    {
        caloriesburnedchartfragment.p();
    }

    protected void a(FitbitChartView fitbitchartview)
    {
        super.a(fitbitchartview);
        b.c(getResources().getDrawable(0x7f02026e));
        h().a(this);
    }
    ...
    protected void b()
    {
        ...
        b(true);
        getLoaderManager().restartLoader(122, a(f(), g(), new Bundle()), l);
    }
