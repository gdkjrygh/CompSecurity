...
/* anonymous class */
        ...
        implements android.support.v4.app.LoaderManager.LoaderCallbacks
    {
        ...
        public void a(Loader loader, AbsActivityChartFragment.a a1)
        {
            ...
            chartseries.F().clear();
            chartseries.F().a(a1.a, new MinutesVeryActiveChartFragment._cls1._cls2(this));
        ...
        {
            return new MinutesVeryActiveChartFragment._cls1._cls1(a.getActivity(), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_START_DATE"), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_END_DATE"), Filter.a(a.k()), new IntentFilter("com.fibit.data.bl.BROADCAST_CHART_UPDATE"));
        }
...
/* anonymous class */
        class MinutesVeryActiveChartFragment._cls1._cls1 extends com.fitbit.weight.ui.a
        {
            ...
            public AbsActivityChartFragment.a r_()
            {
                ...
                a1.c = com.fitbit.data.bl.t.a().a(com.fitbit.data.domain.Goal.GoalType.MINUTES_VERY_ACTIVE_GOAL, ((Date) (obj)));
        ...
        // Unreferenced inner class com/fitbit/activity/ui/MinutesVeryActiveChartFragment$1$1$1

/* anonymous class */
        class MinutesVeryActiveChartFragment._cls1._cls1._cls1
            implements com.fitbit.util.chart.Filter.a
        {

            final double a;
            final Drawable b;
            final MinutesVeryActiveChartFragment._cls1._cls1 c;
