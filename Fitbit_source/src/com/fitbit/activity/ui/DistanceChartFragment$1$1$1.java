    ...
    implements com.fitbit.util.chart.
{
    ...
    esourceType(esourceType esourcetype, double d, Drawable drawable)
    {
        c = esourcetype;
        a = d;
        b = drawable;
...
/* anonymous class */
        ...
        implements android.support.v4.app.LoaderManager.LoaderCallbacks
    {
        ...
        public void a(Loader loader, DistanceChartFragment.a a1)
        {
            ...
            ((ChartSeries) (obj)).F().a(a1.a, new DistanceChartFragment._cls1._cls2());
        ...
        {
            return new DistanceChartFragment._cls1._cls1(this, a.getActivity(), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_START_DATE"), (Date)bundle.get("com.fitbit.weight.ui.AbsChartFragment.EXTRA_END_DATE"), Filter.a(a.k()), new IntentFilter("com.fibit.data.bl.BROADCAST_CHART_UPDATE"));
        }
        ...
        // Unreferenced inner class com/fitbit/activity/ui/DistanceChartFragment$1$2

/* anonymous class */
        class DistanceChartFragment._cls1._cls2
