...
public class BodyFatLogEntry
{
    ...
    public BodyFatLogEntry(Long long1)
    {
        id = long1;
    }

    public BodyFatLogEntry(Long long1, Long long2, String s, Date date, Date date1, Integer integer, Double double1, 
            String s1, Date date2)
    {
        id = long1;
        serverId = long2;
        uuid = s;
