...
public class DaoMaster extends AbstractDaoMaster
{
    ...
    public DaoMaster(SQLiteDatabase sqlitedatabase)
    {
        ...
        registerDaoClass(com/fitbit/data/repo/greendao/logging/WeightLogEntryDao);
        registerDaoClass(com/fitbit/data/repo/greendao/logging/BodyFatLogEntryDao);
        registerDaoClass(com/fitbit/data/repo/greendao/logging/WaterLogEntryDao);
        registerDaoClass(com/fitbit/data/repo/greendao/logging/SleepLogEntryDao);
    }

    public static void createAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        WeightLogEntryDao.createTable(sqlitedatabase, flag);
        BodyFatLogEntryDao.createTable(sqlitedatabase, flag);
        WaterLogEntryDao.createTable(sqlitedatabase, flag);
        SleepLogEntryDao.createTable(sqlitedatabase, flag);
    }

    public static void dropAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        WeightLogEntryDao.dropTable(sqlitedatabase, flag);
        BodyFatLogEntryDao.dropTable(sqlitedatabase, flag);
        WaterLogEntryDao.dropTable(sqlitedatabase, flag);
        SleepLogEntryDao.dropTable(sqlitedatabase, flag);
    }
