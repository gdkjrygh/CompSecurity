...
//            DaoSession, HeartRateDailySummaryDao, HeartRateZoneDao
...
public class HeartRateDailySummary
{
    ...
    public HeartRateDailySummary(Long long1)
    {
        id = long1;
    }

    public HeartRateDailySummary(Long long1, Date date, Integer integer, Integer integer1)
    {
        id = long1;
        dateTime = date;
    ...
    public void __setDaoSession(DaoSession daosession)
    {
        ...
        if (daosession != null)
        {
            daosession = daosession.getHeartRateDailySummaryDao();
        } else
        {
            daosession = null;
        }
...
_L1:
        ...
        List list = daoSession.getHeartRateZoneDao()._queryHeartRateDailySummary_CustomZones(id);
        this;
...
_L1:
        ...
        List list = daoSession.getHeartRateZoneDao()._queryHeartRateDailySummary_Zones(id);
        this;
        JVM INSTR monitorenter ;
        if (zones == null)
        {
