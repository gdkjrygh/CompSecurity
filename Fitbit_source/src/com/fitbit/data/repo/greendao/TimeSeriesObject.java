...
public class TimeSeriesObject
{
    ...
    public TimeSeriesObject(Long long1)
    {
        id = long1;
    }

    public TimeSeriesObject(Long long1, Date date, Double double1, Integer integer, Integer integer1, Integer integer2, Long long2)
    {
        id = long1;
        dateTime = date;
        value = double1;
