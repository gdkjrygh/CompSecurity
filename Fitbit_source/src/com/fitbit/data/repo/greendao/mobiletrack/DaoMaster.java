...
//            PedometerMinuteDataDao, DaoSession
...
public class DaoMaster extends AbstractDaoMaster
{
    ...
    public DaoMaster(SQLiteDatabase sqlitedatabase)
    {
        ...
        registerDaoClass(com/fitbit/data/repo/greendao/mobiletrack/PedometerMinuteDataDao);
    }

    public static void createAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        PedometerMinuteDataDao.createTable(sqlitedatabase, flag);
    }

    public static void dropAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        PedometerMinuteDataDao.dropTable(sqlitedatabase, flag);
    }
