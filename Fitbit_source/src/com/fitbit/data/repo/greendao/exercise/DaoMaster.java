...
public class DaoMaster extends AbstractDaoMaster
{
    ...
    public DaoMaster(SQLiteDatabase sqlitedatabase)
    {
        ...
        registerDaoClass(com/fitbit/data/repo/greendao/exercise/ExerciseSessionDao);
        registerDaoClass(com/fitbit/data/repo/greendao/exercise/ExerciseEventDao);
        registerDaoClass(com/fitbit/data/repo/greendao/exercise/ExerciseSegmentDao);
        registerDaoClass(com/fitbit/data/repo/greendao/exercise/SplitDao);
    }

    public static void createAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ExerciseSessionDao.createTable(sqlitedatabase, flag);
        ExerciseEventDao.createTable(sqlitedatabase, flag);
        ExerciseSegmentDao.createTable(sqlitedatabase, flag);
        SplitDao.createTable(sqlitedatabase, flag);
    }

    public static void dropAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ExerciseSessionDao.dropTable(sqlitedatabase, flag);
        ExerciseEventDao.dropTable(sqlitedatabase, flag);
        ExerciseSegmentDao.dropTable(sqlitedatabase, flag);
        SplitDao.dropTable(sqlitedatabase, flag);
    }
