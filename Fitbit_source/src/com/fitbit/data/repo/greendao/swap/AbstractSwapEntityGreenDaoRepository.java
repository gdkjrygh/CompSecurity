...
public abstract class AbstractSwapEntityGreenDaoRepository extends a
{
    ...
    public void configure(DaoSession daosession)
    {
        if (mapper == null)
        {
            mapper = createMapper(daosession);
        }
        entityDao = getDaoFrom(daosession);
    }

    protected abstract EntityMapper createMapper(DaoSession daosession);
    ...
    protected abstract AbstractDao getDaoFrom(DaoSession daosession);
