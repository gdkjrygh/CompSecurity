...
//            SwapTimeSeriesObjectDao, SwapHeartRateZoneDao, SwapHeartRateExerciseSummaryDao, DaoSession
...
public class DaoMaster extends AbstractDaoMaster
{
    ...
    public DaoMaster(SQLiteDatabase sqlitedatabase)
    {
        ...
        registerDaoClass(com/fitbit/data/repo/greendao/swap/SwapTimeSeriesObjectDao);
        registerDaoClass(com/fitbit/data/repo/greendao/swap/SwapHeartRateZoneDao);
        registerDaoClass(com/fitbit/data/repo/greendao/swap/SwapHeartRateExerciseSummaryDao);
    }

    public static void createAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        SwapTimeSeriesObjectDao.createTable(sqlitedatabase, flag);
        SwapHeartRateZoneDao.createTable(sqlitedatabase, flag);
        SwapHeartRateExerciseSummaryDao.createTable(sqlitedatabase, flag);
    }

    public static void dropAllTables(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        SwapTimeSeriesObjectDao.dropTable(sqlitedatabase, flag);
        SwapHeartRateZoneDao.dropTable(sqlitedatabase, flag);
        SwapHeartRateExerciseSummaryDao.dropTable(sqlitedatabase, flag);
    }
