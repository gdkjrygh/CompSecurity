...
class a extends bf
{
    ...
    protected List a()
    {
        ...
        obj1 = new com.fitbit.data.bl.Logic.Request(((Calendar) (obj1)).getTime(), 0, 10, Integer.valueOf((int)com.fitbit.runtrack.ui.RecentSummary.a(a).h()));
        obj1 = new ArrayList(ActivityBusinessLogic.a().a(((com.fitbit.data.bl.Logic.Request) (obj1))));
...
_L1:
        Collections.sort(((List) (obj)), new Comparator() {
            ...
            final RecentSummary._cls1 a;

            public int a(ActivityLogEntry activitylogentry1, ActivityLogEntry activitylogentry2)
            {
                return activitylogentry1.e().compareTo(activitylogentry2.e());
            }

            public int compare(Object obj3, Object obj4)
            {
                return a((ActivityLogEntry)obj3, (ActivityLogEntry)obj4);
            }

            
            {
                a = RecentSummary._cls1.this;
                super();
            }
        });
        if (((List) (obj)).size() > 5)
        ...
        do
        {
            ...
            if (((ActivityLogEntry) (obj2)).p() != null)
            {
                ...
                switch (com.fitbit.runtrack.ui.b[type.ordinal()])
                {
                case 1: // '\001'
...
_L3:
    ...
    _cls1.a(RecentSummary recentsummary, Context context)
    {
        a = recentsummary;
        super(context);
    }
