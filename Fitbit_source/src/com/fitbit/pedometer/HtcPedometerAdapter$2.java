    ...
    implements ServiceConnectionListener
{
    ...
    public void onConnected()
    {
        com.fitbit.pedometer.e.a(new Runnable() {
            ...
            final HtcPedometerAdapter._cls2 a;
            ...
            public void run()
            {
                ...
                Iterator iterator;
                HtcPedometerAdapter.RemoteServiceCommand remoteservicecommand;
                int i;
                try
                {
                ...
                Exception exception;
                if (!HtcPedometerAdapter.e(a.a).contains(HtcPedometerAdapter.RemoteServiceCommand.b) && !HtcPedometerAdapter.e(a.a).contains(com.fitbit.pedometer.HtcPedometerAdapter.RemoteServiceCommand.a))
                {
                    flag = false;
                } else
                {
...
_L1:
                remoteservicecommand = (HtcPedometerAdapter.RemoteServiceCommand)iterator.next();
                i = com.fitbit.pedometer.HtcPedometerAdapter._cls7.a[remoteservicecommand.ordinal()];
                i;
...
_L10:
            ...
            {
                a = HtcPedometerAdapter._cls2.this;
                super();
            }
        });
    }
