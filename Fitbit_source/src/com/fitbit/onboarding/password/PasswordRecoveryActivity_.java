...
public final class PasswordRecoveryActivity_ extends PasswordRecoveryActivity
    implements org.androidannotations.a.c.a, b
{
    public static class a
    {
        ...
        {
            a = context;
            b = new Intent(context, com/fitbit/onboarding/password/PasswordRecoveryActivity_);
        }
        ...
        public a(Fragment fragment)
        {
            ...
            b = new Intent(a, com/fitbit/onboarding/password/PasswordRecoveryActivity_);
        }
    }
    ...
    public PasswordRecoveryActivity_()
    {
    }
    ...
    {
        a = (EditText)a1.findViewById(0x7f110194);
        b = (TextView)a1.findViewById(0x7f110195);
        a1 = a1.findViewById(0x7f110195);
        if (a1 != null)
        {
            a1.setOnClickListener(new android.view.View.OnClickListener() {

                final PasswordRecoveryActivity_ a;
            ...
            {
                a = PasswordRecoveryActivity_.this;
                super();
            }
            });
        }
