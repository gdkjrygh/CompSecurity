...
public final class android.support.multidex.b
{
    private static final class a
    {
        ...
        {
            return (Object[])(Object[])android.support.multidex.b.a(obj, "makeDexElements", new Class[] {
        ...
        private static void b(ClassLoader classloader, List list, File file)
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException
        {
            classloader = ((ClassLoader) (android.support.multidex.b.a(classloader, "pathList").get(classloader)));
            android.support.multidex.b.a(classloader, "dexElements", a(classloader, new ArrayList(list), file));
        }
    ...
    private static final class b
    {
        ...
        private static void b(ClassLoader classloader, List list, File file)
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException
        {
            Object obj = android.support.multidex.b.a(classloader, "pathList").get(classloader);
            ArrayList arraylist = new ArrayList();
            android.support.multidex.b.a(obj, "dexElements", a(obj, new ArrayList(list), file, arraylist));
            if (arraylist.size() > 0)
            {
                for (list = arraylist.iterator(); list.hasNext(); Log.w("MultiDex", "Exception in makeDexElement", (IOException)list.next())) { }
                file = android.support.multidex.b.a(classloader, "dexElementsSuppressedExceptions");
    ...
    private static final class c
    {
        ...
        {
            int j = list.size();
            Field field = android.support.multidex.b.a(classloader, "path");
            StringBuilder stringbuilder = new StringBuilder((String)field.get(classloader));
            String as[] = new String[j];
            File afile[] = new File[j];
            ZipFile azipfile[] = new ZipFile[j];
            DexFile adexfile[] = new DexFile[j];
            for (list = list.listIterator(); list.hasNext();)
            {
                File file = (File)list.next();
                String s = file.getAbsolutePath();
                stringbuilder.append(':').append(s);
                int k = list.previousIndex();
                as[k] = s;
                afile[k] = file;
                azipfile[k] = new ZipFile(file);
                adexfile[k] = DexFile.loadDex(s, (new StringBuilder()).append(s).append(".dex").toString(), 0);
            }

            field.set(classloader, stringbuilder.toString());
            android.support.multidex.b.a(classloader, "mPaths", as);
            android.support.multidex.b.a(classloader, "mFiles", afile);
            android.support.multidex.b.a(classloader, "mZips", azipfile);
            android.support.multidex.b.a(classloader, "mDexs", adexfile);
        }
    ...
    private android.support.multidex.b()
    {
    }
...
_L7:
        Object obj1;
        List list;
        obj1 = new File(applicationinfo.dataDir, c);
        list = android.support.multidex.c.a(context, applicationinfo, ((File) (obj1)), false);
...
label0:
        {
            ...
            context = android.support.multidex.c.a(context, applicationinfo, ((File) (obj1)), true);
            if (!a(((List) (context))))
            {
                break label0;
            }
...
_L1:
    ...
    private static boolean a(List list)
    {
        ...
        {
            if (!android.support.multidex.c.a((File)list.next()))
            {
                return false;
            }
        }
...
label0:
    ...
    static 
    {
        c = (new StringBuilder()).append("code_cache").append(File.separator).append("secondary-dexes").toString();
    }
}
