...
label0:
    ...
    public void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if (((SavedState) (parcelable)).openSubMenuId > 0)
        {
            ...
            if (parcelable != null)
            {
                onSubMenuSelected((a)parcelable.getSubMenu());
            }
        }
    }
    ...
    public boolean onSubMenuSelected(a a1)
    {
        ...
        Object obj;
        for (obj = a1; ((a) (obj)).t() != mMenu; obj = (a)((a) (obj)).t()) { }
        View view = findViewForItem(((a) (obj)).getItem());
        obj = view;
        if (view == null)
        {
            if (mOverflowButton == null)
        ...
        mActionButtonPopup = new ActionButtonSubmenu(mContext, a1);
        mActionButtonPopup.setAnchorView(((View) (obj)));
        mActionButtonPopup.show();
        onSubMenuSelected(a1);
        return true;
    }
