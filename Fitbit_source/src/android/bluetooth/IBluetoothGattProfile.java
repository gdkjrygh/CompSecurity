    ...
    extends IInterface
{
        ...
        implements IBluetoothGattProfile
    {
        ...
        public static IBluetoothGattProfile asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("android.bluetooth.IBluetoothGattProfile");
    ...
    public abstract void onDiscoverCharacteristicsResult(String s, boolean flag)
        throws RemoteException;

    public abstract void onSetCharacteristicCliConfResult(String s, boolean flag)
        throws RemoteException;

    public abstract void onSetCharacteristicValueResult(String s, boolean flag)
        throws RemoteException;

    public abstract void onUpdateCharacteristicValueResult(String s, boolean flag)
        throws RemoteException;

    public abstract void onValueChanged(String s, String s1)
        throws RemoteException;
}
