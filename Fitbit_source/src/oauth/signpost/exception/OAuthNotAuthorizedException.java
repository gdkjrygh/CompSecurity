...
public class OAuthNotAuthorizedException extends OAuthException
{
    ...
    private static final String a = "Authorization failed (server replied with a 401). This can happen if the consumer key was not correct or the signatures did not match.";
