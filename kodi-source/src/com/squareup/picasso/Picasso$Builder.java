...
public static class nContext
{
    ...
    private android.graphics.der.downloader defaultBitmapConfig;
    ...
    public Picasso build()
    {
        ...
        return new Picasso(context1, new Dispatcher(context1, service, Picasso.HANDLER, downloader, cache, stats), cache, listener, transformer, requestHandlers, stats, defaultBitmapConfig, indicatorsEnabled, loggingEnabled);
    }
