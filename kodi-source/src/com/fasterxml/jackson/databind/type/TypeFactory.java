    ...
    protected JavaType _fromClass(Class class1, TypeBindings typebindings)
    {
        ...
        } else
        {
            ...
            if (javatype == null)
            {
                ...
                if (java/util/Map$Entry.isAssignableFrom(class1))
                {
                    Object obj = findTypeParameters(class1, java/util/Map$Entry);
                    ...
                    class1 = constructSimpleType(class1, java/util/Map$Entry, new JavaType[] {
                        typebindings, obj
                    });
                } else
                {
...
_L4:
        if (java/util/Map.isAssignableFrom(class1))
        {
            parameterizedtype = findTypeParameters(constructSimpleType(class1, class1, parameterizedtype), java/util/Map);
            JavaType ajavatype[];
            int j;
...
_L3:
        if (java/util/Collection.isAssignableFrom(class1))
        {
            parameterizedtype = findTypeParameters(constructSimpleType(class1, class1, parameterizedtype), java/util/Collection);
    ...
    protected JavaType _fromParameterizedClass(Class class1, List list)
    {
        ...
        {
            return constructSimpleType(class1, class1, (JavaType[])list.toArray(new JavaType[list.size()]));
        }
    }
    ...
    protected JavaType _fromVariable(TypeVariable typevariable, TypeBindings typebindings)
    {
        ...
        {
            JavaType javatype = typebindings.findType(s, false);
            if (javatype != null)
            {
                return javatype;
            }
    ...
    {
        TypeVariable atypevariable[] = class2.getTypeParameters();
        if (atypevariable.length != ajavatype.length)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Parameter type mismatch for ").append(class1.getName()).append(" (and target ").append(class2.getName()).append("): expected ").append(atypevariable.length).append(" parameters, was given ").append(ajavatype.length).toString());
        }
        ...
        return new SimpleType(class1, as, ajavatype, null, null, false, class2);
    }

    public JavaType constructSimpleType(Class class1, JavaType ajavatype[])
    {
        return constructSimpleType(class1, class1, ajavatype);
    }
    ...
    {
        int j;
        if (class1 != javatype.getParameterSource())
        {
...
_L2:
        ...
        do
        {
            ...
            ajavatype[i] = javatype.containedType(i);
            i++;
        } while (true);
        if (true) goto _L4; else goto _L3
_L3:
        return findTypeParameters(javatype.getRawClass(), class1, new TypeBindings(this, javatype));
    }
