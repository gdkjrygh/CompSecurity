...
label1:
        ...
        throws IOException, JsonProcessingException
    {
        ...
        obj2 = jsonparser.getCurrentName();
        obj3 = keydeserializer.deserializeKey(((String) (obj2)), deserializationcontext);
        obj = jsonparser.nextToken();
...
_L5:
        ...
        try
        {
            ((MapReferringAccumulator) (obj1)).put(obj3, obj);
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
            handleUnresolvedReference(jsonparser, ((MapReferringAccumulator) (obj1)), obj3, ((UnresolvedForwardReference) (obj)));
        }
        catch (Exception exception)
        {
            wrapAndThrow(exception, map, ((String) (obj2)));
        }
        ...
        throws JsonMappingException
    {
        ...
        if (deserializationcontext != null)
        {
            ...
            if (beanproperty != null)
            {
                ...
                if (beanproperty != null)
                {
                    beanproperty = deserializationcontext.findPropertiesToIgnore(beanproperty);
                    obj3 = hashset;
                    if (beanproperty != null)
                    {
                        int i;
