    ...
    implements ConfigFeature
{
    ...
    static 
    {
        ...
        ACCEPT_CASE_INSENSITIVE_PROPERTIES = new MapperFeature("ACCEPT_CASE_INSENSITIVE_PROPERTIES", 14, false);
        USE_WRAPPER_NAME_AS_PROPERTY_NAME = new MapperFeature("USE_WRAPPER_NAME_AS_PROPERTY_NAME", 15, false);
        USE_STD_BEAN_NAMING = new MapperFeature("USE_STD_BEAN_NAMING", 16, false);
        IGNORE_DUPLICATE_MODULE_REGISTRATIONS = new MapperFeature("IGNORE_DUPLICATE_MODULE_REGISTRATIONS", 17, true);
        $VALUES = (new MapperFeature[] {
            ...
            ALLOW_FINAL_FIELDS_AS_MUTATORS, USE_STATIC_TYPING, DEFAULT_VIEW_INCLUSION, SORT_PROPERTIES_ALPHABETICALLY, ACCEPT_CASE_INSENSITIVE_PROPERTIES, USE_WRAPPER_NAME_AS_PROPERTY_NAME, USE_STD_BEAN_NAMING, IGNORE_DUPLICATE_MODULE_REGISTRATIONS
        });
    }
}
