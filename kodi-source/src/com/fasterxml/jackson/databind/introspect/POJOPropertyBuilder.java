...
label0:
    ...
    public com.fasterxml.jackson.annotation.JsonInclude.Include findInclusion()
    {
        ...
        {
            AnnotatedMember annotatedmember = getAccessor();
            return _annotationIntrospector.findSerializationInclusion(annotatedmember, null);
        }
    }
...
_L2:
        ...
        int j = _setterPriority((AnnotatedMethod)linked3.value);
        if (i != j)
        {
            linked2 = linked3;
            if (i < j)
