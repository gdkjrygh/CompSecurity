    ...
    implements ApiCallback
{
    ...
    // Unreferenced inner class org/xbmc/kore/ui/TVShowEpisodeDetailsFragment$3

/* anonymous class */
    class TVShowEpisodeDetailsFragment._cls3
        implements ApiCallback
    {
        ...
        public void onSuccess(ArrayList arraylist)
        {
            if (isAdded())
            {
                ...
                if (i != -1)
                {
                    ...
                    arraylist.episodeid = TVShowEpisodeDetailsFragment.access$000(TVShowEpisodeDetailsFragment.this);
                    (new org.xbmc.kore.jsonrpc.method.Playlist.Add(i, arraylist)).execute(TVShowEpisodeDetailsFragment.access$100(TVShowEpisodeDetailsFragment.this).getConnection(), new TVShowEpisodeDetailsFragment._cls3._cls1(), TVShowEpisodeDetailsFragment.access$200(TVShowEpisodeDetailsFragment.this));
                    return;
                }
                if (isAdded())
                {
