...
// Referenced classes of package org.xbmc.kore.ui.views:
//            PageIndicator
    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f01012f);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f0d0081);
        int k = ((Resources) (obj)).getColor(0x7f0d0080);
        int l = ((Resources) (obj)).getInteger(0x7f0b0009);
        int i1 = ((Resources) (obj)).getColor(0x7f0d0082);
        float f = ((Resources) (obj)).getDimension(0x7f080072);
        float f1 = ((Resources) (obj)).getDimension(0x7f080071);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f0a0007);
        boolean flag1 = ((Resources) (obj)).getBoolean(0x7f0a0008);
        float f2 = ((Resources) (obj)).getDimension(0x7f080070);
        attributeset = context.obtainStyledAttributes(attributeset, org.xbmc.kore.R.styleable.CirclePageIndicator, i, 0);
        ...
        mGapWidth = attributeset.getDimension(9, f2);
