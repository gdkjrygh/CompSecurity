...
class val.auxHostConnection
    implements ApiCallback
{

    final l.auxHandler this$0;
    final org.xbmc.kore.jsonrpc.method.uxHandler val$action;
    ...
    {
        onSuccess((org.xbmc.kore.jsonrpc.type.lue)obj);
    }

    public void onSuccess(org.xbmc.kore.jsonrpc.type.lue lue)
    {
        final boolean initialMuteStatus = lue.muted.booleanValue();
        try
        {
            val$mutePacket.send(val$hostInetAddress, hostInfo.getEventServerPort());
        }
        // Misplaced declaration of an exception variable
        catch (org.xbmc.kore.jsonrpc.type.lue lue)
        {
        ...
        val$action.execute(val$auxHostConnection, new ApiCallback() {

            final EventServerConnection._cls4._cls1 this$1;
            ...
            {
                this$1 = EventServerConnection._cls4._cls1.this;
                initialMuteStatus = flag;
                super();
            }
        }, auxHandler);
    }
    ...
    {
        this$0 = final_es;
        val$mutePacket = packet;
        val$hostInetAddress = inetaddress;
        val$action = uxhandler;
        val$auxHostConnection = HostConnection.this;
        super();
    }
