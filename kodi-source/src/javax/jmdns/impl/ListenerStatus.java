...
_L2:
        ...
        public ServiceListenerStatus(ServiceListener servicelistener, boolean flag)
        {
    ...
    public ListenerStatus(EventListener eventlistener, boolean flag)
    {
    ...
    public String toString()
    {
        return (new StringBuilder()).append("[Status for ").append(getListener().toString()).append("]").toString();
    }
}
