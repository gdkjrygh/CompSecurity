...
_L2:
        View view1;
        view1 = mParentView.getChildAt(mCallback.getOrderedChildIndex(k));
        if (i < view1.getLeft() || i >= view1.getRight() || j < view1.getTop())
        {
            break; /* Loop/switch isn't completed */
        }
        view = view1;
        if (j < view1.getBottom()) goto _L4; else goto _L3
_L3:
        k--;
...
_L11:
        ...
        if (mDragState == 1) goto _L10; else goto _L12
_L12:
        View view = findTopChildUnder((int)f1, (int)f3);
        if (checkTouchSlop(view, f4, f5) && tryCaptureViewForDrag(view, k)) goto _L10; else goto _L13
_L13:
        i++;
          goto _L14
_L7:
...
_L15:
        ...
        i = 0;
_L24:
        if (i < l) goto _L18; else goto _L17
_L17:
        i = j;
_L22:
        if (i == -1)
...
_L18:
        ...
        if (i1 != mActivePointerId) goto _L20; else goto _L19
_L19:
        i++;
        continue; /* Loop/switch isn't completed */
_L20:
        f1 = MotionEventCompat.getX(motionevent, i);
        f3 = MotionEventCompat.getY(motionevent, i);
        if (findTopChildUnder((int)f1, (int)f3) != mCapturedView || !tryCaptureViewForDrag(mCapturedView, i1)) goto _L19; else goto _L21
_L21:
        i = mActivePointerId;
          goto _L22
_L3:
...
_L9:
        ...
        if (mDragState == 1) goto _L8; else goto _L10
_L10:
        view = findTopChildUnder((int)f, (int)f1);
        if (view != null && checkTouchSlop(view, f2, f3) && tryCaptureViewForDrag(view, k)) goto _L8; else goto _L11
_L11:
        i++;
          goto _L12
_L6:
