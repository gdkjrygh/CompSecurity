...
_L1:
        android/support/v4/util/ArrayMap;
        JVM INSTR monitorenter ;
        if (mTwiceBaseCacheSize >= 10) goto _L4; else goto _L3
_L3:
...
_L4:
        ...
        throw ai;
_L2:
        if (ai.length != 4) goto _L8; else goto _L7
_L7:
        android/support/v4/util/ArrayMap;
        JVM INSTR monitorenter ;
        if (mBaseCacheSize >= 10) goto _L10; else goto _L9
_L9:
...
_L2:
        int k;
        k = ContainerHelpers.binarySearch(mHashes, l, i);
        j = k;
        if (k < 0) goto _L4; else goto _L3
_L3:
        j = k;
        if (obj.equals(mArray[k << 1])) goto _L4; else goto _L5
_L5:
        j = k + 1;
_L8:
        if (j < l && mHashes[j] == i) goto _L7; else goto _L6
_L6:
        k--;
_L9:
        if (k < 0 || mHashes[k] != i)
...
_L3:
        i = j;
        if (mArray[j << 1] == null) goto _L4; else goto _L5
_L5:
        i = j + 1;
_L8:
        if (i < k && mHashes[i] == 0) goto _L7; else goto _L6
_L6:
        j--;
_L9:
        if (j < 0 || mHashes[j] != 0)
