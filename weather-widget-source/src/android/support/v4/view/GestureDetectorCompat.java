...
_L4:
            ...
            if (mDoubleTapListener != null)
            {
                ...
                if (mCurrentDownEvent != null && mPreviousUpEvent != null && flag && isConsideredDoubleTap(mCurrentDownEvent, mPreviousUpEvent, motionevent))
                {
                    ...
                    j = false | mDoubleTapListener.onDoubleTap(mCurrentDownEvent) | mDoubleTapListener.onDoubleTapEvent(motionevent);
                } else
                {
...
_L6:
            ...
            {
                flag = mListener.onScroll(mCurrentDownEvent, motionevent, f2, f3);
                mLastFocusX = f1;
                mLastFocusY = f;
                mAlwaysInTapRegion = false;
                mHandler.removeMessages(3);
...
_L22:
            boolean flag2 = mListener.onSingleTapUp(motionevent);
            flag = flag2;
...
_L5:
        ...
        {
            this$1 = GestureDetectorCompatImplBase.this;
            super();
        }
