...
public class NotificationCompat
{
    public static class Action extends NotificationCompatBase.Action
    {
        ...
        Action(int i, CharSequence charsequence, PendingIntent pendingintent, Bundle bundle, RemoteInput aremoteinput[], Action action)
        {
    ...
    public static final class Action.Builder
    {
        ...
        public Action build()
        {
            ...
            return new Action(mIcon, mTitle, mIntent, mExtras, aremoteinput, null);
        }
