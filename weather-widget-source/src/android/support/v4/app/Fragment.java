    ...
    implements ComponentCallbacks, android.view.View.OnCreateContextMenuListener
{
    ...
    public static Fragment instantiate(Context context, String s, Bundle bundle)
    {
        ...
        {
            throw new InstantiationException((new StringBuilder("Unable to instantiate fragment ")).append(s).append(": make sure class name exists, is public, and has an").append(" empty constructor that is public").toString(), context);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
    ...
    public void dump(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        ...
        if (mChildFragmentManager != null)
        {
            ...
            mChildFragmentManager.dump((new StringBuilder(String.valueOf(s))).append("  ").toString(), filedescriptor, printwriter, as);
        }
    }
...
label0:
    ...
    final void setIndex(int i, Fragment fragment)
    {
        ...
        if (fragment != null)
        {
            mWho = (new StringBuilder(String.valueOf(fragment.mWho))).append(":").append(mIndex).toString();
            return;
        } else
        {
