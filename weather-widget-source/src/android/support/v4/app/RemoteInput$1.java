    ...
    implements patBase.RemoteInput.Factory
{
    ...
    public volatile patBase.RemoteInput build(String s, CharSequence charsequence, CharSequence acharsequence[], boolean flag, Bundle bundle)
    {
