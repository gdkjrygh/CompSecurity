...
_L6:
        ...
        private void updateListenerMap()
        {
            ...
            if (!((Set) (obj)).equals(mCachedEnabledPackages)) goto _L2; else goto _L1
_L1:
            return;
_L2:
            HashSet hashset;
            ...
            obj1 = mContext.getPackageManager().queryIntentServices((new Intent()).setAction("android.support.BIND_NOTIFICATION_SIDE_CHANNEL"), 4);
            hashset = new HashSet();
...
_L6:
            ...
            while (((Iterator) (obj)).hasNext()) 
            {
                ...
                if (!hashset.contains(((java.util.Map.Entry) (obj1)).getKey()))
                {
                    if (Log.isLoggable("NotifManCompat", 3))
                    {
                        Log.d("NotifManCompat", (new StringBuilder("Removing listener record for ")).append(((java.util.Map.Entry) (obj1)).getKey()).toString());
                    }
                    ensureServiceUnbound((ListenerRecord)((java.util.Map.Entry) (obj1)).getValue());
                    ((Iterator) (obj)).remove();
                }
            }
              goto _L1
_L4:
    ...
    public static Set getEnabledListenerPackages(Context context)
    {
        ...
        if (context == null || context.equals(sEnabledNotificationListeners)) goto _L2; else goto _L1
_L1:
        HashSet hashset;
        int i;
        int j;
