...
_L9:
    ...
    public void dump(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        ...
        if (mLoaderManager != null)
        {
            ...
            printwriter.println(":");
            mLoaderManager.dump((new StringBuilder(String.valueOf(s))).append("  ").toString(), filedescriptor, printwriter, as);
        }
        mFragments.dump(s, filedescriptor, printwriter, as);
        printwriter.print(s);
        printwriter.println("View Hierarchy:");
        dumpViewHierarchy((new StringBuilder(String.valueOf(s))).append("  ").toString(), printwriter, getWindow().getDecorView());
    }
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        if (-1 == 0 && j == -1 && s2 == null)
        {
            throw new IllegalArgumentException((new StringBuilder(String.valueOf(attributeset.getPositionDescription()))).append(": Must specify unique android:id, android:tag, or have a parent with an id for ").append(s1).toString());
        }
        context = obj;
        if (j != -1)
        {
        ...
        {
            Log.v("FragmentActivity", (new StringBuilder("onCreateView: id=0x")).append(Integer.toHexString(j)).append(" fname=").append(s1).append(" existing=").append(context).toString());
        }
        if (context == null)
        {
        ...
        } else
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder(String.valueOf(attributeset.getPositionDescription()))).append(": Duplicate id 0x").append(Integer.toHexString(j)).append(", tag ").append(s2).append(", or parent id 0x").append(Integer.toHexString(0)).append(" with another fragment for ").append(s1).toString());
            }
            context.mInLayout = true;
...
_L2:
        if (arraylist == null && i == 0 && obj == null)
        {
            return null;
        } else
        {
...
_L1:
        ...
        aloadermanagerimpl = new LoaderManagerImpl[j];
        i = j - 1;
_L5:
        if (i >= 0) goto _L4; else goto _L3
_L3:
