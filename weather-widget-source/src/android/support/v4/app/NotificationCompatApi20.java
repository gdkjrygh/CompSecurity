...
class NotificationCompatApi20
{
    ...
    public static void addAction(android.app.Notification.Builder builder, NotificationCompatBase.Action action)
    {
        ...
        if (action.getRemoteInputs() == null) goto _L2; else goto _L1
_L1:
        android.app.RemoteInput aremoteinput[];
        int i;
        int j;
        aremoteinput = RemoteInputCompatApi20.fromCompat(action.getRemoteInputs());
...
_L4:
    ...
    private static android.app.Notification.Action getActionFromActionCompat(NotificationCompatBase.Action action)
    {
        ...
        builder = (new android.app.Notification.Action.Builder(action.getIcon(), action.getTitle(), action.getActionIntent())).addExtras(action.getExtras());
