...
public static final class mSize extends Enum
{
    ...
    static 
    {
        ...
        RS_ELEMENT = new <init>("RS_ELEMENT", 18, 1000, 4);
        RS_TYPE = new <init>("RS_TYPE", 19, 1001, 4);
        RS_ALLOCATION = new <init>("RS_ALLOCATION", 20, 1002, 4);
        RS_SAMPLER = new <init>("RS_SAMPLER", 21, 1003, 4);
        RS_SCRIPT = new <init>("RS_SCRIPT", 22, 1004, 4);
        $VALUES = (new .VALUES[] {
