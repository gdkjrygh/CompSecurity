...
private static final class m_properties
    implements Runnable
{
...
_L2:
    ...
    (Logger logger, boolean flag, File file, boolean flag1, IMetaData imetadata, ICoverageData icoveragedata, IReportGenerator aireportgenerator[], 
            SourcePathCache sourcepathcache, IProperties iproperties)
    {
        ...
        } else
        {
            ...
            m_generators = (IReportGenerator[])(IReportGenerator[])aireportgenerator.clone();
            m_mdata = imetadata;
