...
public final class SyntheticAttribute_info extends Attribute_info
{
    ...
    public SyntheticAttribute_info(int i)
    {
        super(i, 0L);
    }

    SyntheticAttribute_info(int i, long l)
    {
        super(i, l);
    }
    ...
    {
        return (new StringBuilder()).append("SyntheticValueAttribute_info: [attribute_name_index = ").append(m_name_index).append(", attribute_length = ").append(m_attribute_length).append(']').toString();
    }
