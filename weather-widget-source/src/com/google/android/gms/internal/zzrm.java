...
public final class zzrm extends zzrr
{
...
_L7:
            ...
            flag = flag1;
            if (((zza) (obj)).zzbbt != null) goto _L4; else goto _L8
_L8:
            return zza(((zzrr) (obj)));
_L6:
    ...
    public static final class zza.zza extends zzrr
    {
        ...
        private static volatile zza.zza zzbbu[];
        public int type;
        public zza zzbbv;

        public static zza.zza[] zzCP()
        {
            if (zzbbu == null)
            {
                synchronized (zzrv.zzbck)
...
_L6:
            flag = flag1;
            if (((zza.zza) (obj)).zzbbv != null) goto _L4; else goto _L8
_L8:
            return zza(((zzrr) (obj)));
_L7:
            if (!zzbbv.equals(((zza.zza) (obj)).zzbbv))
            {
                return false;
            }
...
_L6:
    ...
    public static final class zza.zza.zza extends zzrr
    {
...
_L2:
            ...
            obj = (zza.zza.zza)obj;
            flag = flag1;
            if (!Arrays.equals(zzbbw, ((zza.zza.zza) (obj)).zzbbw))
            {
                continue; /* Loop/switch isn't completed */
            }
            if (zzbbx != null)
            ...
            flag = flag1;
            if (((zza.zza.zza) (obj)).zzbbx != null)
            {
                continue; /* Loop/switch isn't completed */
            }
_L5:
            flag = flag1;
            if (Double.doubleToLongBits(zzbby) == Double.doubleToLongBits(((zza.zza.zza) (obj)).zzbby))
            {
                flag = flag1;
                if (Float.floatToIntBits(zzbbz) == Float.floatToIntBits(((zza.zza.zza) (obj)).zzbbz))
                {
                    flag = flag1;
                    if (zzbbA == ((zza.zza.zza) (obj)).zzbbA)
                    {
                        flag = flag1;
                        if (zzbbB == ((zza.zza.zza) (obj)).zzbbB)
                        {
                            flag = flag1;
                            if (zzbbC == ((zza.zza.zza) (obj)).zzbbC)
                            {
                                flag = flag1;
                                if (zzbbD == ((zza.zza.zza) (obj)).zzbbD)
                                {
                                    flag = flag1;
                                    if (zzrv.equals(zzbbE, ((zza.zza.zza) (obj)).zzbbE))
                                    {
                                        flag = flag1;
                                        if (zzrv.equals(zzbbF, ((zza.zza.zza) (obj)).zzbbF))
                                        {
                                            flag = flag1;
                                            if (zzrv.equals(zzbbG, ((zza.zza.zza) (obj)).zzbbG))
                                            {
                                                flag = flag1;
                                                if (zzrv.equals(zzbbH, ((zza.zza.zza) (obj)).zzbbH))
                                                {
                                                    flag = flag1;
                                                    if (zzrv.equals(zzbbI, ((zza.zza.zza) (obj)).zzbbI))
                                                    {
                                                        flag = flag1;
                                                        if (zzbbJ == ((zza.zza.zza) (obj)).zzbbJ)
                                                        {
                                                            return zza(((zzrr) (obj)));
                                                        }
                                                    }
...
_L3:
            if (!zzbbx.equals(((zza.zza.zza) (obj)).zzbbx))
            {
                return false;
            }
              goto _L5
...
_L6:
        ...
        public zza.zza.zza zzy(zzrp zzrp1)
            throws IOException
        {
            do
            {
    ...
    public static zzrm zzw(byte abyte0[])
        throws zzrw
    {
        return (zzrm)zzrx.zza(new zzrm(), abyte0);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        } else
        {
            ...
            if (obj instanceof zzrm)
            {
                obj = (zzrm)obj;
                flag = flag1;
                if (zzrv.equals(zzbbr, ((zzrm) (obj)).zzbbr))
                {
                    return zza(((zzrr) (obj)));
                }
            }
    ...
    public int hashCode()
    {
        return (zzrv.hashCode(zzbbr) + 527) * 31 + zzDk();
    }
    ...
    public void zza(zzrq zzrq1)
        throws IOException
    {
        if (zzbbr != null && zzbbr.length > 0)
        {
            for (int i = 0; i < zzbbr.length; i++)
            {
                zza zza1 = zzbbr[i];
                if (zza1 != null)
                {
        ...
        throws IOException
    {
        do
        {
            ...
            case 10: // '\n'
                ...
                if (j != 0)
                {
                    System.arraycopy(zzbbr, 0, azza, 0, j);
                    k = j;
                }
