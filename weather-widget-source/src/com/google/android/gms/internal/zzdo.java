    ...
    implements zzdg
{
    ...
    private final Map zzxq = new WeakHashMap();
...
_L2:
        ...
        zzxq.put(zzip1, Integer.valueOf(i));
        return;
        Object obj = zzip1.zzgQ();
        if (obj == null)
        {
        ...
        if (flag || flag1)
        {
            ...
            if (flag && ((zzd) (obj)).zzew() == null)
            {
                ...
                if (zzxq.containsKey(zzip1))
                {
                    j = ((Integer)zzxq.get(zzip1)).intValue();
        ...
        } else
        {
            ...
            if (obj == null)
            {
                com.google.android.gms.ads.internal.overlay.zzk.zzd(zzip1);
                return;
            }
            if ("click".equals(obj1))
            {
                zzip1 = zzip1.getContext();
                int k = zza(((Context) (zzip1)), map, "x", 0);
                int i1 = zza(((Context) (zzip1)), map, "y", 0);
                long l2 = SystemClock.uptimeMillis();
                zzip1 = MotionEvent.obtain(l2, l2, 0, k, i1, 0);
                ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).zzd(zzip1);
                zzip1.recycle();
                return;
            }
            if ("currentTime".equals(obj1))
            {
                zzip1 = (String)map.get("time");
                if (zzip1 == null)
                {
                ...
                try
                {
                    ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).seekTo((int)(Float.parseFloat(zzip1) * 1000F));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Map map)
                {
                    zzb.zzaE((new StringBuilder()).append("Could not parse time parameter from currentTime video GMSG: ").append(zzip1).toString());
                }
                return;
            }
            if ("hide".equals(obj1))
            ...
            if ("volume".equals(obj1))
            {
                ...
                try
                {
                    ((com.google.android.gms.ads.internal.overlay.zzk) (obj)).zza(Float.parseFloat(zzip1));
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (Map map)
                {
                    zzb.zzaE((new StringBuilder()).append("Could not parse volume parameter from volume video GMSG: ").append(zzip1).toString());
                }
                return;
            }
