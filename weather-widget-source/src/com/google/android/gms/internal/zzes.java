...
public final class zzes extends zzei.zza
{

    private final MediationAdapter zzzc;
    private final NetworkExtras zzzd;

    public zzes(MediationAdapter mediationadapter, NetworkExtras networkextras)
    {
        zzzc = mediationadapter;
        zzzd = networkextras;
    }
...
_L2:
        s = new HashMap(0);
_L3:
        obj = zzzc.getServerParametersType();
        s1 = null;
        if (obj == null)
        {
        ...
        throws RemoteException
    {
        ...
        {
            com.google.android.gms.ads.internal.util.client.zzb.zzaE((new StringBuilder()).append("MediationAdapter is not a MediationBannerAdapter: ").append(zzzc.getClass().getCanonicalName()).toString());
            throw new RemoteException();
        }
        zzd zzd;
        try
        {
            zzd = zze.zzx(((MediationBannerAdapter)zzzc).getBannerView());
        }
        catch (Throwable throwable)
        {
        ...
        throws RemoteException
    {
        ...
        {
            com.google.android.gms.ads.internal.util.client.zzb.zzaE((new StringBuilder()).append("MediationAdapter is not a MediationInterstitialAdapter: ").append(zzzc.getClass().getCanonicalName()).toString());
            throw new RemoteException();
        }
        ...
        throws RemoteException
    {
        ...
        try
        {
            ((MediationInterstitialAdapter)zzzc).requestInterstitialAd(new zzet(zzej), (Activity)zze.zzp(zzd), zzb(s, adrequestparcel.zzsu, s1), zzeu.zzg(adrequestparcel), zzzd);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (zzd zzd)
        ...
        throws RemoteException
    {
        ...
        try
        {
            ((MediationBannerAdapter)zzzc).requestBannerAd(new zzet(zzej), (Activity)zze.zzp(zzd), zzb(s, adrequestparcel.zzsu, s1), com.google.android.gms.internal.zzeu.zzb(adsizeparcel), zzeu.zzg(adrequestparcel), zzzd);
            return;
        }
        // Misplaced declaration of an exception variable
        catch (zzd zzd)
