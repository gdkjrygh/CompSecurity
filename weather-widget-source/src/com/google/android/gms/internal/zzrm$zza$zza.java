...
public static final class zzCQ extends zzrr
{
...
_L2:
            ...
            obj = (zza)obj;
            flag = flag1;
            if (!Arrays.equals(zzbbw, ((zza) (obj)).zzbbw))
            {
                continue; /* Loop/switch isn't completed */
            }
            if (zzbbx != null)
            ...
            flag = flag1;
            if (((zza) (obj)).zzbbx != null)
            {
                continue; /* Loop/switch isn't completed */
            }
_L5:
            flag = flag1;
            if (Double.doubleToLongBits(zzbby) == Double.doubleToLongBits(((zza) (obj)).zzbby))
            {
                flag = flag1;
                if (Float.floatToIntBits(zzbbz) == Float.floatToIntBits(((zza) (obj)).zzbbz))
                {
                    flag = flag1;
                    if (zzbbA == ((zza) (obj)).zzbbA)
                    {
                        flag = flag1;
                        if (zzbbB == ((zza) (obj)).zzbbB)
                        {
                            flag = flag1;
                            if (zzbbC == ((zza) (obj)).zzbbC)
                            {
                                flag = flag1;
                                if (zzbbD == ((zza) (obj)).zzbbD)
                                {
                                    flag = flag1;
                                    if (zzrv.equals(zzbbE, ((zza) (obj)).zzbbE))
                                    {
                                        flag = flag1;
                                        if (zzrv.equals(zzbbF, ((zza) (obj)).zzbbF))
                                        {
                                            flag = flag1;
                                            if (zzrv.equals(zzbbG, ((zza) (obj)).zzbbG))
                                            {
                                                flag = flag1;
                                                if (zzrv.equals(zzbbH, ((zza) (obj)).zzbbH))
                                                {
                                                    flag = flag1;
                                                    if (zzrv.equals(zzbbI, ((zza) (obj)).zzbbI))
                                                    {
                                                        flag = flag1;
                                                        if (zzbbJ == ((zza) (obj)).zzbbJ)
                                                        {
                                                            return zza(((zzrr) (obj)));
                                                        }
                                                    }
...
_L6:
    ...
    private static volatile zzbbv zzbbu[];
    public int type;
    public zza zzbbv;

    public static zza.zzbbI[] zzCP()
    {
        if (zzbbu == null)
        {
...
_L2:
        flag = flag1;
        if (!(obj instanceof zzbbu)) goto _L4; else goto _L3
_L3:
        obj = (zzbbu)obj;
        flag = flag1;
...
_L6:
        flag = flag1;
        if (((zzbbv) (obj)).zzbbv != null) goto _L4; else goto _L8
_L8:
        return zza(((zzrr) (obj)));
_L7:
        if (!zzbbv.equals(((zza.equals) (obj)).zzbbv))
        {
            return false;
        }
