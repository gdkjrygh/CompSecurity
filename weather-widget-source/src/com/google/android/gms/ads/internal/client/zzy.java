...
public class zzy
{
    ...
    private void zzcR()
    {
        com.google.android.gms.dynamic.zzd zzd = zztm.zzaM();
        if (zzd == null)
        {
            return;
        }
...
_L1:
        ...
        inapppurchaselistener = new zzfr(inapppurchaselistener);
_L3:
...
_L1:
        ...
        oncustomrenderedadloadedlistener = new zzci(oncustomrenderedadloadedlistener);
_L3:
...
_L1:
        ...
        playstorepurchaselistener = new zzfv(playstorepurchaselistener);
_L3:
