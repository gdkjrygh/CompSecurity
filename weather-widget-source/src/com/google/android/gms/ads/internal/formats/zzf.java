...
public class zzf extends com.google.android.gms.internal.zzcr.zza
    implements zzh.zza
{
    ...
    private final zzlh zzvX;
    private final zzlh zzvY;

    public zzf(String s, zzlh zzlh1, zzlh zzlh2, zza zza1)
    {
        zzvW = s;
        zzvX = zzlh1;
        zzvY = zzlh2;
    ...
    public List getAvailableAssetNames()
    {
        ...
        do
        {
            ...
            as[i] = (String)zzvX.keyAt(j);
            i++;
            j++;
        } while (true);
        while (k < zzvY.size()) 
        {
            as[l] = (String)zzvY.keyAt(k);
            k++;
            l++;
        }
