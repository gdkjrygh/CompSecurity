        ...
        implements zzf
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                zza(authaccountrequest, zze.zza.zzdG(parcel.readStrongBinder()));
            ...
            case 8: // '\b'
                ...
                zza(i, account, zze.zza.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 10: // '\n'
                ...
                zza(recordconsentrequest, zze.zza.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 11: // '\013'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                zza(zze.zza.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void zzja(int i)
        throws RemoteException;
}
