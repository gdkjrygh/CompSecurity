        ...
        implements IStreetViewPanoramaDelegate
    {
            ...
            throws RemoteException
        {
            ...
            case 9: // '\t'
                ...
                if (parcel.readInt() != 0)
                {
                    obj = StreetViewPanoramaCamera.CREATOR.zzff(parcel);
                } else
                {
                    obj = null;
                }
            ...
            case 15: // '\017'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                setOnStreetViewPanoramaChangeListener(zzs.zza.zzcE(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 16: // '\020'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                setOnStreetViewPanoramaCameraChangeListener(zzr.zza.zzcD(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 17: // '\021'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                setOnStreetViewPanoramaClickListener(zzt.zza.zzcF(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 18: // '\022'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                parcel = pointToOrientation(com.google.android.gms.dynamic.zzd.zza.zzbk(parcel.readStrongBinder()));
                parcel1.writeNoException();
                if (parcel != null)
                {
                    parcel1.writeInt(1);
            ...
            case 20: // '\024'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                setOnStreetViewPanoramaLongClickListener(zzu.zza.zzcG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
            StreetViewPanoramaCamera streetviewpanoramacamera = StreetViewPanoramaCamera.CREATOR.zzff(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
...
_L3:
            ...
            throws RemoteException
        {
            ...
            if (parcel1.readInt() == 0) goto _L2; else goto _L1
_L1:
            StreetViewPanoramaLocation streetviewpanoramalocation = StreetViewPanoramaLocation.CREATOR.zzfh(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            parcel1.readException();
            streetviewpanoramaorientation = com.google.android.gms.dynamic.zzd.zza.zzbk(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            {
                zzd1 = StreetViewPanoramaOrientation.CREATOR.zzfi(parcel1);
            }
            parcel1.recycle();
            parcel.recycle();
            return zzd1;
