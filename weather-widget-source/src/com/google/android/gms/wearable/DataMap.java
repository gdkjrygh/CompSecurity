...
public class DataMap
{
    ...
    private final HashMap zzaYS = new HashMap();
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        try
        {
            abyte0 = zzrl.zza(new com.google.android.gms.internal.zzrl.zza(zzrm.zzw(abyte0), new ArrayList()));
        }
...
_L8:
    ...
    public int hashCode()
    {
        return zzaYS.hashCode() * 29;
    }

    public boolean isEmpty()
    {
        return zzaYS.isEmpty();
    }
    ...
    {
        String s;
        for (Iterator iterator = datamap.keySet().iterator(); iterator.hasNext(); zzaYS.put(s, datamap.get(s)))
        {
            s = (String)iterator.next();
        }
    ...
    {
        zzaYS.put(s, Boolean.valueOf(flag));
    }

    public void putByte(String s, byte byte0)
    {
        zzaYS.put(s, Byte.valueOf(byte0));
    }
    ...
    {
        zzaYS.put(s, arraylist);
    }

    public void putDouble(String s, double d)
    {
        zzaYS.put(s, Double.valueOf(d));
    }

    public void putFloat(String s, float f)
    {
        zzaYS.put(s, Float.valueOf(f));
    }
    ...
    public Bundle toBundle()
    {
        ...
        String s;
        for (Iterator iterator = zzaYS.keySet().iterator(); iterator.hasNext(); zza(bundle, s, zzaYS.get(s)))
        {
            s = (String)iterator.next();
        }
