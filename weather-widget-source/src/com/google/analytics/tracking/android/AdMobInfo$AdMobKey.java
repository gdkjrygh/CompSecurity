...
static final class bowParameter extends Enum
{
    ...
    public static bowParameter valueOf(String s)
    {
        return (bowParameter)Enum.valueOf(com/google/analytics/tracking/android/AdMobInfo$AdMobKey, s);
    }

    public static bowParameter[] values()
    {
        return (bowParameter[])$VALUES.clone();
    }
