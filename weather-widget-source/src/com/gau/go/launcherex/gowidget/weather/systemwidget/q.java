...
public class q extends t
{
    ...
    public q()
    {
        ...
        d = new String[10];
        e = new HashMap();
        a("systemwidget_style", String.valueOf(42));
    }
    ...
    public String c()
    {
        ...
        {
            return com.gau.go.launcherex.gowidget.weather.globaltheme.c.a(1, com.gau.go.launcherex.gowidget.weather.globaltheme.c.c(g));
        } else
        {
            return "z_appwidget_l_provider_ex";
        }
    }
