...
class w extends AsyncTask
{
    ...
    public w(LanguageSetting languagesetting, int i)
    {
        a = languagesetting;
        super();
        b = new ArrayList();
    ...
    {
        int i;
        if (LanguageSetting.d(a) || LanguageSetting.e(a))
        {
            i = 0;
        } else
        {
            LanguageSetting.a(a, true);
            ArrayList arraylist = new ArrayList();
            avoid = new StringBuilder(com.gau.go.launcherex.gowidget.weather.globaltheme.b.a(a));
            avoid.append("#");
            arraylist.add(new BasicNameValuePair("vps", avoid.toString()));
            arraylist.add(new BasicNameValuePair("channel", com.gau.go.launcherex.gowidget.statistics.w.f(a)));
            arraylist.add(new BasicNameValuePair("lang", com.gau.go.launcherex.gowidget.statistics.w.j(a)));
            ...
            if (com.gau.go.launcherex.gowidget.statistics.w.h(a))
            {
                avoid = "1";
            } else
            {
            ...
            i = LanguageSetting.a(a, arraylist, b);
            LanguageSetting.a(a, false);
        }
    ...
    {
        if (!LanguageSetting.d(a)) goto _L2; else goto _L1
_L1:
        com.gau.go.launcherex.gowidget.weather.view.LanguageSetting.b(a, c);
_L4:
        com.gau.go.launcherex.gowidget.weather.view.LanguageSetting.b(a, c);
        return;
_L2:
        ...
        for (integer = b.iterator(); integer.hasNext();)
        {
            ...
            Iterator iterator = LanguageSetting.a(a).iterator();
        ...
        com.gau.go.launcherex.gowidget.weather.view.LanguageSetting.b(a, true);
