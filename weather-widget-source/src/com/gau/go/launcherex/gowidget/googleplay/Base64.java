...
_L6:
        ...
        if (k1 == 4)
        {
            l = decode4to3(abyte3, 0, abyte2, k, abyte1) + k;
            k = 0;
        } else
        {
            l = k;
...
_L2:
        ...
        if (l != 0)
        {
            ...
            abyte3[l] = 61;
            i = k + decode4to3(abyte3, 0, abyte2, k, abyte1);
        }
        abyte0 = new byte[i];
    ...
    {
        boolean flag;
        if (!com/gau/go/launcherex/gowidget/googleplay/Base64.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
