    ...
    implements m
{
    ...
    d(com.jiubang.commerce.ad.e.a a1, int k, f f1, com.jiubang.commerce.ad.h.a a2, List list, int l, int i1, 
            boolean flag, af af1)
    {
        i = a1;
        a = k;
    ...
    public void a(a a1)
    {
        ...
        if (j.a)
        {
            StringBuilder stringbuilder = (new StringBuilder()).append("[vmId:").append(a).append("]loadSingleAdSourceInfo(FaceBook--onFinish, virtualModuleId:").append(a).append(", adCount:");
            int k;
            if (obj != null)
            {
                k = ((List) (obj)).size();
