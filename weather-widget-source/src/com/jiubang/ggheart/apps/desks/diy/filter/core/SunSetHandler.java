...
public class SunSetHandler extends AbsFilterHandler
{

    public static final String EXSIT_FILE_ARRAY[] = {
        "blackboard.png", "overlay_map.png", "sunset_map.png"
    };
    ...
    public SunSetHandler(Context context)
    {
        ...
        try
        {
            Bitmap bitmap = BitmapFactory.decodeStream(context.getAssets().open("blackboard.png"));
            Bitmap bitmap1 = BitmapFactory.decodeStream(context.getAssets().open("overlay_map.png"));
            context = BitmapFactory.decodeStream(context.getAssets().open("sunset_map.png"));
...
label0:
        ...
        try
        {
            obj = BitmapFactory.decodeStream(((Context) (obj)).getAssets().open("blackboard.png"));
        }
...
label0:
        ...
        try
        {
            obj = BitmapFactory.decodeStream(((Context) (obj)).getAssets().open("sunset_map.png"));
        }
        catch (Exception exception)
        {
            exception.printStackTrace();
