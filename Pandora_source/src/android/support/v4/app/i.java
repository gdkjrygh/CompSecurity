        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).a != null)
        {
            ...
            if (((FragmentManagerState) (parcelable)).c != null)
            {
                ...
                while (i2 < ((FragmentManagerState) (parcelable)).c.length) 
                {
                    ...
                    if (a)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: back stack #").append(i2).append(" (index ").append(((e) (arraylist)).o).append("): ").append(arraylist).toString());
                        arraylist.a("  ", new PrintWriter(new d("FragmentManager")), false);
                    }
                    i.add(arraylist);
                    if (((e) (arraylist)).o >= 0)
                    {
                        a(((e) (arraylist)).o, ((e) (arraylist)));
                    }
                    i2++;
                }
            } else
...
_L4:
        ...
        if (!fragment.mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onAttach()").toString());
        }
        ...
        if (fragment.mFromLayout)
        {
            ...
            if (fragment.mView != null)
            {
                ...
                {
                    android.support.v4.view.t.a(fragment.mView, false);
                } else
                {
...
_L14:
        ...
        if (!fragment.mCalled)
        {
            throw new ai((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onDetach()").toString());
        }
        j2 = i1;
        if (!flag)
        {
...
_L15:
    ...
    public void a(FragmentActivity fragmentactivity, g g1, Fragment fragment)
    {
        if (o != null)
        {
...
_L6:
        ...
        do
        {
            ...
            handler = (e)i.get(j1);
            if (s1 == null || !s1.equals(handler.d()))
            {
                k1 = j1;
                if (i1 < 0)
                {
        ...
        do
        {
            ...
            handler = (e)i.get(l1);
            if (s1 != null && s1.equals(handler.d()) || i1 >= 0 && i1 == ((e) (handler)).o)
            {
                continue; /* Loop/switch isn't completed */
            }
            l1--;
...
label0:
    ...
    public View onCreateView(String s1, Context context, AttributeSet attributeset)
    {
        ...
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("onCreateView: id=0x").append(Integer.toHexString(j1)).append(" fname=").append(s2).append(" existing=").append(obj).toString());
        }
        if (obj == null)
        {
        ...
        if (n < 1 && ((Fragment) (s1)).mFromLayout)
        {
            a(s1, 1, 0, 0, false);
        } else
        {
    ...
    public String toString()
    {
        ...
        if (q != null)
        {
            p.e.c.a(q, stringbuilder);
        } else
        {
            p.e.c.a(o, stringbuilder);
        }
    ...
    android.view.LayoutInflater.Factory w()
    {
        return this;
    }
