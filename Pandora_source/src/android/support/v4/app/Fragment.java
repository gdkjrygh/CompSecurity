    ...
    implements ComponentCallbacks, android.view.View.OnCreateContextMenuListener
{
    ...
    private static final g sClassMap = new g();
...
_L5:
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle)
    {
        ...
        bundle.setFactory(mChildFragmentManager.w());
        return bundle;
    }
    ...
    void instantiateChildFragmentManager()
    {
        ...
        mChildFragmentManager.a(mActivity, new android.support.v4.app.g() {
