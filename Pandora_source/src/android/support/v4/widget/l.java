...
public class l
{
    ...
    private l(Context context, ViewGroup viewgroup, a a1)
    {
        c = -1;
        if (viewgroup == null)
        {
        ...
        } else
        {
            ...
            q = android.support.v4.widget.j.a(context, v);
            return;
        }
    }
    ...
    public static l a(ViewGroup viewgroup, float f1, a a1)
    {
        viewgroup = a(viewgroup, a1);
        viewgroup.b = (int)((float)((l) (viewgroup)).b * (1.0F / f1));
        return viewgroup;
    }

    public static l a(ViewGroup viewgroup, a a1)
    {
        return new l(viewgroup.getContext(), viewgroup, a1);
    }
...
_L6:
    ...
    {
        int j1 = android.support.v4.view.n.c(motionevent);
        for (int i1 = 0; i1 < j1; i1++)
        {
            int k1 = android.support.v4.view.n.b(motionevent, i1);
            float f1 = android.support.v4.view.n.c(motionevent, i1);
            float f2 = android.support.v4.view.n.d(motionevent, i1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void h()
    {
        ...
        a(a(android.support.v4.view.r.a(l, c), n, m), a(android.support.v4.view.r.b(l, c), n, m));
    }
    ...
    public boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)android.support.v4.view.r.a(l, c), (int)android.support.v4.view.r.b(l, c));
        }
    }
...
_L2:
        f1 = motionevent.getX();
        f4 = motionevent.getY();
        i1 = android.support.v4.view.n.b(motionevent, 0);
        a(f1, f4, i1);
        ...
        if ((p & j1) != 0)
        {
          ...
          goto _L7
_L5:
        j1 = android.support.v4.view.n.b(motionevent, i1);
        float f2 = android.support.v4.view.n.c(motionevent, i1);
        float f5 = android.support.v4.view.n.d(motionevent, i1);
        a(f2, f5, j1);
        if (a == 0)
        {
            i1 = h[j1];
        ...
        if (a == 2)
        {
          ...
          goto _L7
_L4:
        k1 = android.support.v4.view.n.c(motionevent);
        i1 = 0;
_L13:
        if (i1 >= k1) goto _L9; else goto _L8
_L8:
        l1 = android.support.v4.view.n.b(motionevent, i1);
        float f3 = android.support.v4.view.n.c(motionevent, i1);
        float f6 = android.support.v4.view.n.d(motionevent, i1);
        f7 = f3 - d[l1];
        f8 = f6 - e[l1];
...
_L10:
        ...
        i3 = r.a(view);
        j3 = r.b(view);
        if (i3 != 0 && (i3 <= 0 || j2 != i2) || j3 != 0 && (j3 <= 0 || l2 != k2)) goto _L11; else goto _L9
_L9:
        c(motionevent);
          goto _L7
_L11:
...
_L12:
        i1++;
          goto _L13
_L6:
        e(android.support.v4.view.n.b(motionevent, i1));
          goto _L7
        e();
          goto _L7
    }
    ...
    public void b(MotionEvent motionevent)
    {
        ...
        i1 = 0;
        j1 = 0;
        l1 = android.support.v4.view.n.a(motionevent);
        k1 = android.support.v4.view.n.b(motionevent);
        if (l1 == 0)
        {
            e();
        }
...
_L6:
        float f2;
        float f4;
        i1 = android.support.v4.view.n.b(motionevent, k1);
        f2 = android.support.v4.view.n.c(motionevent, k1);
        f4 = android.support.v4.view.n.d(motionevent, k1);
        a(f2, f4, i1);
        if (a != 0)
        {
...
_L4:
        if (a == 1)
        {
            i1 = android.support.v4.view.n.a(motionevent, c);
            f2 = android.support.v4.view.n.c(motionevent, i1);
            f4 = android.support.v4.view.n.d(motionevent, i1);
            i1 = (int)(f2 - f[c]);
            j1 = (int)(f4 - g[c]);
...
_L13:
        i1++;
          goto _L14
_L7:
        j1 = android.support.v4.view.n.b(motionevent, k1);
