...
public class ViewPager extends ViewGroup
{
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            c = 0.0F;
            context = context.obtainStyledAttributes(attributeset, android.support.v4.view.ViewPager.f());
    ...
    public static class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = p.d.a.a(new p.d.b() {
    ...
    static interface d
    {
        ...
        public abstract void a(p p1, p p2);
    }
    ...
    public static interface e
    {
        ...
        public abstract void a_(int i1);
    ...
    static p a(ViewPager viewpager)
    {
        return viewpager.h;
    }
...
label0:
        {
            ...
            if (flag1)
            {
                ...
                android.support.v4.view.t.a(this, ah);
            }
            return;
        }
        ah.run();
    ...
    private void b(boolean flag)
    {
        ...
        while (i1 < j1) 
        {
            ...
            android.support.v4.view.t.a(getChildAt(i1), byte0, null);
            i1++;
        }
    }
...
label1:
    ...
    void a()
    {
        ...
        Q = new android.support.v4.widget.f(context);
        R = new android.support.v4.widget.f(context);
        N = (int)(25F * f1);
        O = (int)(2.0F * f1);
        C = (int)(16F * f1);
        android.support.v4.view.t.a(this, new c());
        if (android.support.v4.view.t.c(this) == 0)
        {
...
_L2:
        if (flag && android.support.v4.view.t.a(view, -i1)) goto _L4; else goto _L6
_L6:
        return false;
...
_L3:
    ...
    public void draw(Canvas canvas)
    {
        ...
        int j1 = 0;
        int i1 = 0;
        int k1 = android.support.v4.view.t.a(this);
...
_L4:
        if (!A)
        {
            ...
            float f3 = android.support.v4.view.n.d(motionevent, i1);
        ...
        if (A)
        {
            i1 = false | b(android.support.v4.view.n.c(motionevent, android.support.v4.view.n.a(motionevent, J)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        i1 = j1;
        if (A)
        {
            ...
            i1 = (int)android.support.v4.view.r.a(((VelocityTracker) (obj)), J);
            y = true;
            j1 = getClientWidth();
            int k1 = getScrollX();
            obj = i();
            a(a(((b) (obj)).b, ((float)k1 / (float)j1 - ((b) (obj)).e) / ((b) (obj)).d, i1, (int)(android.support.v4.view.n.c(motionevent, android.support.v4.view.n.a(motionevent, J)) - H)), true, true, i1);
            J = -1;
            j();
            boolean flag = Q.c();
            i1 = R.c() | flag;
