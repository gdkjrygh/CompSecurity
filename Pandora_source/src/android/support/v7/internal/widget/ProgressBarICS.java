...
public class ProgressBarICS extends View
{
        ...
        implements Runnable
    {
        ...
        a(int i1, int j1, boolean flag)
        {
            a = ProgressBarICS.this;
            super();
            b = i1;
            c = j1;
            d = flag;
    ...
    public ProgressBarICS(Context context, AttributeSet attributeset, int i1, int j1)
    {
        ...
        d();
        attributeset = context.obtainStyledAttributes(attributeset, f, i1, j1);
        s = true;
...
label1:
            {
                ...
                if (drawable instanceof LayerDrawable)
                {
                    ...
                    int j1 = layerdrawable1.getNumberOfLayers();
                    drawable = new Drawable[j1];
                    int i1 = 0;
                    while (i1 < j1) 
                    {
                        int k1 = layerdrawable1.getId(i1);
                        Drawable drawable1 = layerdrawable1.getDrawable(i1);
                        if (k1 == 0x102000d || k1 == 0x102000f)
                        {
                            flag = true;
                        } else
                        {
                    ...
                    do
                    {
                        ...
                        layerdrawable.setId(i1, layerdrawable1.getId(i1));
                        i1++;
                    } while (true);
                } else
                {
    ...
    static a a(ProgressBarICS progressbarics, a a1)
    {
        progressbarics.u = a1;
        return a1;
    }
