...
public class ActionBarContextView extends a
{
    ...
    public ActionBarContextView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, android.support.v7.appcompat.R.styleable.ActionMode, i1, 0);
...
label0:
        {
            ...
            if (k == null)
            {
                ...
                l = (TextView)k.findViewById(android.support.v7.appcompat.R.id.action_bar_title);
                m = (TextView)k.findViewById(android.support.v7.appcompat.R.id.action_bar_subtitle);
                if (n != 0)
                {
