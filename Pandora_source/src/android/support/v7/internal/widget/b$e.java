...
private final class <init> extends AsyncTask
{
    ...
    public transient Void a(Object aobj[])
    {
        ...
        list = (List)aobj[0];
        obj1 = (String)aobj[1];
        aobj = b.a(a).openFileOutput(((String) (obj1)), 0);
...
_L2:
        ...
        aobj;
        Log.e(b.d(), (new StringBuilder()).append("Error writing historical recrod file: ").append(((String) (obj1))).toString(), ((Throwable) (aobj)));
_L3:
        return null;
_L1:
        ...
        Object obj;
        obj;
        Log.e(b.d(), (new StringBuilder()).append("Error writing historical recrod file: ").append(b.b(a)).toString(), ((Throwable) (obj)));
        b.a(a, true);
        if (aobj != null)
        {
            try
