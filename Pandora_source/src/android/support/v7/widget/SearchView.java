    ...
    implements p.h.b
{
    ...
    android.view.View.OnKeyListener b = new android.view.View.OnKeyListener() {
        ...
        public boolean onKey(View view, int j1, KeyEvent keyevent)
        {
            if (SearchView.o(a) != null)
            {
                ...
                if (!SearchAutoComplete.a(SearchView.m(a)) && android.support.v4.view.h.a(keyevent) && keyevent.getAction() == 1 && j1 == 66)
                {
    ...
    public SearchView(Context context, AttributeSet attributeset)
    {
        ...
        M = new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                } else
                {
                    ...
                    {
                        android.support.v7.widget.SearchView.h(a);
                        return;
                    }
        ...
        O = new android.widget.AdapterView.OnItemClickListener() {
        ...
        P = new android.widget.AdapterView.OnItemSelectedListener() {
        ...
        k = findViewById(android.support.v7.appcompat.R.id.search_button);
        r = (SearchAutoComplete)findViewById(android.support.v7.appcompat.R.id.search_src_text);
        r.setSearchView(this);
        p = findViewById(android.support.v7.appcompat.R.id.search_edit_frame);
        m = findViewById(android.support.v7.appcompat.R.id.search_plate);
        n = findViewById(android.support.v7.appcompat.R.id.submit_area);
        l = findViewById(android.support.v7.appcompat.R.id.search_go_btn);
        o = (ImageView)findViewById(android.support.v7.appcompat.R.id.search_close_btn);
        q = findViewById(android.support.v7.appcompat.R.id.search_voice_btn);
        t = (ImageView)findViewById(android.support.v7.appcompat.R.id.search_mag_icon);
        ...
        typedarray.recycle();
        context = context.obtainStyledAttributes(attributeset, android.support.v7.appcompat.R.styleable.View, 0, 0);
...
_L8:
    ...
    {
        if (E != null && j != null && keyevent.getAction() == 0 && android.support.v4.view.h.a(keyevent))
        {
...
_L3:
    ...
    private void t()
    {
        if (s.getWidth() > 1)
        {
            ...
            if (h)
            {
                i1 = resources.getDimensionPixelSize(android.support.v7.appcompat.R.dimen.abc_dropdownitem_icon_width);
                i1 = resources.getDimensionPixelSize(android.support.v7.appcompat.R.dimen.abc_dropdownitem_text_padding_left) + i1;
            } else
            {
                i1 = 0;
            }
