...
class this._cls0 extends this._cls0
{
    ...
    void onWebDialogComplete(t t, Bundle bundle, FacebookException facebookexception)
    {
        ...
        {
            e2e = null;
            t = facebookexception.getMessage();
            if (facebookexception instanceof FacebookServiceException)
            {
                t = ((FacebookServiceException)facebookexception).getRequestError();
                bundle = String.format("%d", new Object[] {
                    Integer.valueOf(t.getErrorCode())
                });
                t = t.toString();
            } else
            {
            ...
            t = esult(pendingRequest, null, t, bundle);
        }
