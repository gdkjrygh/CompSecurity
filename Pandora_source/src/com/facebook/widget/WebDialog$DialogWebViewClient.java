...
private class <init> extends WebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        if (!WebDialog.access$500(WebDialog.this))
        {
            WebDialog.access$600(WebDialog.this).dismiss();
        }
        WebDialog.access$700(WebDialog.this).setBackgroundColor(0);
        WebDialog.access$800(WebDialog.this).setVisibility(0);
        WebDialog.access$900(WebDialog.this).setVisibility(0);
    }
    ...
    public void onPageStarted(WebView webview, String s, Bitmap bitmap)
    {
        ...
        if (!WebDialog.access$500(WebDialog.this))
        {
            WebDialog.access$600(WebDialog.this).show();
        }
    }
    ...
    public void onReceivedError(WebView webview, int i, String s, String s1)
    {
        ...
        WebDialog.access$400(WebDialog.this, new FacebookDialogException(s, i, s1));
        dismiss();
    }
    ...
    public void onReceivedSslError(WebView webview, SslErrorHandler sslerrorhandler, SslError sslerror)
    {
        ...
        WebDialog.access$400(WebDialog.this, new FacebookDialogException(null, -11, null));
    ...
    public boolean shouldOverrideUrlLoading(WebView webview, String s)
    {
        ...
        if (s.startsWith(WebDialog.access$200(WebDialog.this)))
        {
            ...
            {
                WebDialog.access$300(WebDialog.this, bundle);
            } else
            ...
            } else
            {
                ...
                WebDialog.access$400(WebDialog.this, new FacebookServiceException(webview, s));
            }
            dismiss();
            return true;
        }
