...
abstract class this._cls0
{
    ...
    {
        loader = (GraphObjectPagingLoader)getLoaderManager().a(0, null, new android.support.v4.app.n.a() {
            ...
            public void onLoadFinished(i i, SimpleGraphObjectCursor simplegraphobjectcursor)
            {
                ...
                {
                    PickerFragment.LoadingStrategy.this.onLoadFinished((GraphObjectPagingLoader)i, simplegraphobjectcursor);
                    return;
                }
            }
            ...
            public void onLoaderReset(i i)
            {
                ...
                {
                    onLoadReset((GraphObjectPagingLoader)i);
                    return;
                }
            }
