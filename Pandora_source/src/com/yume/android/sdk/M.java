...
_L7:
    ...
    public final void a(String s)
    {
        if (s.length() != 0 && (i || h))
        {
            String s1 = (new StringBuilder(String.valueOf(d()))).append(": (D): ").append(s).append("\n").toString();
            if (i)
            {
                Log.d(a, s);
            }
    ...
    public final void b(String s)
    {
        if (s.length() != 0 && (i || h))
        {
            String s1 = (new StringBuilder(String.valueOf(d()))).append(": (I): ").append(s).append("\n").toString();
            if (i)
            {
                Log.i(a, s);
            }
    ...
    public final void c(String s)
    {
        if (s.length() != 0 && (i || h))
        {
            String s1 = (new StringBuilder(String.valueOf(d()))).append(": (E): ").append(s).append("\n").toString();
            if (i)
            {
                Log.e(a, s);
            }
