...
_L3:
    ...
    public final void a(Context context)
    {
        ...
        try
        {
            ...
            {
                h = false;
                b.a("Permission DENIED for writing to External Storage. Hence, not creating YuMe SDK log file.");
                return;
            }
        }
...
_L4:
        h = false;
        b.a("External Storage not accessible. Hence, not creating YuMe SDK log file.");
        return;
_L2:
        File file;
        boolean flag3;
...
_L5:
        ...
        h = false;
        b.a("Error getting External Storage directory. Hence, not creating YuMe SDK log file.");
        return;
