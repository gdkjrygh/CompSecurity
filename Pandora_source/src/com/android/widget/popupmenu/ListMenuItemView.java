    ...
    implements e.a
{
    ...
    private void b()
    {
        b = (ImageView)getInflater().inflate(0x7f040011, this, false);
        addView(b, 0);
    }

    private void c()
    {
        c = (RadioButton)getInflater().inflate(0x7f040013, this, false);
        addView(c);
    }

    private void d()
    {
        e = (CheckBox)getInflater().inflate(0x7f040010, this, false);
        addView(e);
    }
    ...
    public void a(b b1, int i1)
    {
        ...
        setVisibility(i1);
        setTitle(b1.a(this));
        setCheckable(b1.isCheckable());
        a(b1.e(), b1.c());
        setIcon(b1.getIcon());
        setEnabled(b1.isEnabled());
    }
    ...
    protected void onFinishInflate()
    {
        ...
        d = (TextView)findViewById(0x7f100044);
        if (h != -1)
        {
            d.setTextAppearance(i, h);
        }
        f = (TextView)findViewById(0x7f10007b);
    }
