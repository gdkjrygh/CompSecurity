...
_L3:
        ...
        implements android.widget.AbsListView.OnScrollListener
    {
        ...
        {
            if (i1 == 1 && !a.f() && ListPopupWindow.b(a).getContentView() != null)
            {
...
_L3:
    ...
    {
        this(context, attributeset, 0x7f010027);
    }
