    ...
    implements p.c.b
{
    ...
    b(a a1, int i1, int j1, int k1, int l1, CharSequence charsequence, int i2)
    {
        k = 0;
        p = 16;
        q = 0;
...
_L2:
        return true;
        if (o != null && o.onMenuItemClick(this) || l.a(l.j(), this)) goto _L2; else goto _L1
_L1:
        if (n != null)
        {
            n.run();
