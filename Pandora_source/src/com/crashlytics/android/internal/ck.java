...
_L4:
        ...
        if (ba.e(((String) (obj))))
        {
            int i = ba.a(context, "com.crashlytics.ApiKey", "string");
            obj1 = obj;
            if (i != 0)
            {
        ...
        obj;
        cp.a().b().a("Crashlytics", (new StringBuilder("Caught non-fatal exception while retrieving apiKey: ")).append(obj).toString());
_L2:
        obj = null;
        if (true) goto _L4; else goto _L3
_L3:
        cp.a().b().a("Crashlytics", "Crashlytics could not be initialized, API key missing from AndroidManifest.xml. Add the following tag to your Application element \n\t<meta-data android:name=\"com.crashlytics.ApiKey\" android:value=\"YOUR_API_KEY\"/>", null);
        return ((String) (obj1));
    }
