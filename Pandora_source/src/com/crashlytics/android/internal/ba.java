...
public final class ba
{
    ...
    public static final Comparator a = new bb();
...
_L7:
        obj = s;
        cm.a().b().a("Crashlytics", (new StringBuilder("Error parsing ")).append(file).toString(), exception);
...
_L6:
    ...
    private static String a(byte abyte0[], String s)
    {
        ...
        {
            cm.a().b().a("Crashlytics", (new StringBuilder("Could not create hashing algorithm: ")).append(s).append(", returning empty string.").toString(), abyte0);
            return "";
        }
    ...
    public static void a(Closeable closeable, String s)
    {
        ...
        return;
        closeable;
        cm.a().b().a("Crashlytics", s, closeable);
        return;
    }
    ...
    public static void a(Flushable flushable, String s)
    {
        ...
        return;
        flushable;
        cm.a().b().a("Crashlytics", s, flushable);
        return;
    }
...
label0:
        {
            ...
            {
                cm.a().b().a("Crashlytics", "Could not calculate hash for app icon.", inputstream);
                return "";
            }
        }
          goto _L1
        ...
        throws InvalidKeyException
    {
        ...
        {
            cm.a().b().a("Crashlytics", "Could not create Cipher for AES/ECB/PKCS7Padding - should never happen.", s);
    ...
    {
        com/crashlytics/android/internal/ba;
...
label1:
        {
          ...
          goto _L5
        cm.a().b().a("Crashlytics", (new StringBuilder("Unexpected meminfo format while computing RAM: ")).append(s).toString());
        l = 0L;
          goto _L5
        NumberFormatException numberformatexception;
        numberformatexception;
        cm.a().b().a("Crashlytics", (new StringBuilder("Unexpected meminfo format while computing RAM: ")).append(s).toString(), numberformatexception);
        l = 0L;
          goto _L5
        Exception exception;
        exception;
    ...
    public static void d(String s)
    {
        if (e(cm.a().w()))
        {
            cm.a().b().d("Crashlytics", s);
        }
    }

    public static boolean d()
    {
        String s = android.provider.Settings.Secure.getString(cm.a().w().getContentResolver(), "android_id");
...
_L4:
        obj = context;
        cm.a().b().a("Crashlytics", "Could not calculate hash for app icon.", exception);
        a(context, "Failed to close icon input stream.");
        return null;
        context;
        obj = null;
...
_L3:
    ...
    public static String i(Context context)
    {
        ...
        if (j != 0)
        {
            ...
            cm.a().b().a("Crashlytics", (new StringBuilder("Build ID is: ")).append(s).toString());
        }
        return s;
    }
