    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/admarvel/android/ads/AdMarvelActivity$InnerInterstitialJS$8

/* anonymous class */
    class AdMarvelActivity.InnerInterstitialJS._cls8
        implements android.content.DialogInterface.OnClickListener
    {
        ...
        public void onClick(DialogInterface dialoginterface, int i)
        {
            if (callback != null)
            {
                AdMarvelActivity.access$7(adMarvelActivity).post(callback. new AdMarvelActivity.InnerInterstitialJS._cls8._cls1());
            }
