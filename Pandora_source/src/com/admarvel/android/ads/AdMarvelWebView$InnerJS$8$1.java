    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/admarvel/android/ads/AdMarvelWebView$InnerJS$8

/* anonymous class */
    class AdMarvelWebView.InnerJS._cls8
        implements android.content.DialogInterface.OnClickListener
    {
        ...
        public void onClick(DialogInterface dialoginterface, int i)
        {
            if (callback != null)
            {
                AdMarvelWebView.InnerJS.access$0(AdMarvelWebView.InnerJS.this).post(callback. new AdMarvelWebView.InnerJS._cls8._cls1());
            }
