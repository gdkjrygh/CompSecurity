    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/admarvel/android/ads/AdMarvelActivity$InnerInterstitialJS$11

/* anonymous class */
    class AdMarvelActivity.InnerInterstitialJS._cls11
        implements android.content.DialogInterface.OnClickListener
    {

        final AdMarvelActivity.InnerInterstitialJS this$1;
        ...
        public void onClick(DialogInterface dialoginterface, int i)
        {
            if (callback != null)
            {
                AdMarvelActivity.access$7(adMarvelActivity).post(callback. new AdMarvelActivity.InnerInterstitialJS._cls11._cls1());
            }
