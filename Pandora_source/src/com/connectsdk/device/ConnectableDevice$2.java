    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = deviceListeners.iterator(); iterator.hasNext(); tabledevicelistenerpair.listener.onCapabilityUpdated(tabledevicelistenerpair.device, val$added, null))
        {
