    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        for (Iterator iterator = deviceListeners.iterator(); iterator.hasNext(); nnectabledevicelistenerpair.listener.onCapabilityUpdated(nnectabledevicelistenerpair.device, null, val$capabilities))
        {
