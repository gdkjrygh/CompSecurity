...
_L1:
        ...
        scrollTo((int)((float)(getBehindWidth() + i1) * l), j1);
_L4:
        if (byte0 == 4)
        {
...
_L2:
        if (i == 1)
        {
            ...
            scrollTo((int)((float)(getBehindWidth() - getWidth()) + (float)(i1 - getBehindWidth()) * l), j1);
        } else
        {
            byte0 = flag1;
            if (i == 2)
...
_L3:
    ...
    public void a(View view, Canvas canvas, float f1)
    {
        ...
        if (i == 0)
        {
            j1 = view.getLeft() - getBehindWidth();
            i1 = view.getLeft();
        } else
        if (i == 1)
        {
            j1 = view.getRight();
            i1 = view.getRight() + getBehindWidth();
        } else
        if (i == 2)
        {
            i1 = view.getLeft();
...
_L6:
    ...
    {
        int i1;
        while (!q || r == null || s == null || !((String)s.getTag(R.id.selected_view)).equals("CustomViewBehindSelectedView")) 
        {
            return;
        }
        canvas.save();
...
_L1:
        ...
        canvas.drawBitmap(r, i1, getSelectorTop(), null);
_L4:
        canvas.restore();
        return;
_L2:
        if (i == 1)
        {
            ...
            canvas.drawBitmap(r, i1 - r.getWidth(), getSelectorTop(), null);
        }
        if (true) goto _L4; else goto _L3
_L3:
    }

    public boolean b(float f1)
    {
        if (i != 0) goto _L2; else goto _L1
_L1:
        if (f1 >= 0.0F) goto _L4; else goto _L3
...
_L5:
    ...
    public void setCanvasTransformer(SlidingMenu.a a1)
    {
        g = a1;
    }
    ...
    public void setScrollScale(float f1)
    {
        l = f1;
    }
    ...
    public void setSelectedView(View view)
    {
        if (s != null)
        {
            s.setTag(R.id.selected_view, null);
            s = null;
        }
        if (view != null && view.getParent() != null)
        {
            s = view;
            s.setTag(R.id.selected_view, "CustomViewBehindSelectedView");
            invalidate();
        }
    }
    ...
    public void setWidthOffset(int i1)
    {
        f = i1;
        requestLayout();
    }
