    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GetRecentContextCall.Response response, Parcel parcel, int i)
    {
        ...
        zzb.zzc(parcel, 1000, response.zzzH);
        zzb.zza(parcel, 1, response.zzJr, i, false);
        zzb.zzc(parcel, 2, response.zzJs, false);
        zzb.zza(parcel, 3, response.zzJt, false);
        zzb.zzH(parcel, j);
    }
    ...
    public GetRecentContextCall.Response[] zzY(int i)
    {
        return new GetRecentContextCall.Response[i];
    }

    public GetRecentContextCall.Response zzs(Parcel parcel)
    {
        String as[];
        Object obj;
        Object obj1;
