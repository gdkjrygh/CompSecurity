...
//            GooglePlayServicesNotAvailableException, a
...
_L3:
    ...
    public static int isGooglePlayServicesAvailable(Context context)
    {
        ...
        {
            if (zzc1.zza(((PackageInfo) (obj)), a.af.a) == null)
            {
        ...
        try
        {
            obj1 = zzc1.zza(packagemanager.getPackageInfo("com.android.vending", 64), a.af.a);
        }
        // Misplaced declaration of an exception variable
        catch (Object obj1)
        {
        ...
        return 9;
        if (zzc1.zza(((PackageInfo) (obj)), new a.a[] {
    obj1
}) != null)
        {
            break MISSING_BLOCK_LABEL_248;
...
_L2:
        if (flag)
        {
            activity = ((FragmentActivity)activity).f();
...
_L1:
        ...
        if (com.google.android.gms.common.zzc.zzkA().zza(packagemanager, new a.a[] {
            com.google.android.gms.common.a.b[1]
