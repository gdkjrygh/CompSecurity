...
public class zzdf
{
    ...
    private static bz zzaGi = bz.a(0L);
    ...
    public static bz zzA(Object obj)
    {
        ...
        if (zzF(obj))
        {
            return bz.a(Double.valueOf(getDouble(obj)));
        } else
        {
            return zzec(zzz(obj));
        }
...
_L3:
    ...
    {
        return (obj instanceof Double) || (obj instanceof Float) || (obj instanceof bz) && ((bz)obj).a();
    }

    private static boolean zzG(Object obj)
    {
        return (obj instanceof Byte) || (obj instanceof Short) || (obj instanceof Integer) || (obj instanceof Long) || (obj instanceof bz) && ((bz)obj).b();
    }
    ...
    private static bz zzec(String s)
    {
        bz bz1;
        try
        {
    ...
    public static bz zzh(com.google.android.gms.internal.zzd.zza zza)
    {
        return zzA(zzl(zza));
    }
