...
label0:
    ...
    {
        for (Iterator iterator = zzaCT.keySet().iterator(); iterator.hasNext(); ((b)iterator.next()).a(map)) { }
    }
    ...
    private void zzwE()
    {
        zzaCX.a(new zzc.zza() {
            ...
            {
                a a1;
                for (list = list.iterator(); list.hasNext(); DataLayer.zza(a, a.zzi(a1.a, a1.b)))
                {
                    a1 = (a)list.next();
                }

                DataLayer.zza(a).countDown();
            }
...
_L1:
    ...
    void zza(b b1)
    {
        zzaCT.put(b1, Integer.valueOf(0));
    }
