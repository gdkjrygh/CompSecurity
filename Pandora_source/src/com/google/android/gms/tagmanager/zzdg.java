...
//            by, bx, zzbg, DataLayer, 
//            zzdf

public class zzdg extends by
{
    ...
    private final bx zzaGD;

    public zzdg(Context context, DataLayer datalayer)
    {
        this(context, datalayer, new bx(context));
    }

    zzdg(Context context, DataLayer datalayer, bx bx1)
    {
...
_L14:
    ...
    {
        Tracker tracker = zzaGD.a("_GTM_DEFAULT_TRACKER_");
