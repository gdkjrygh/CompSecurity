...
_L1:
        ...
        public void onUpgrade(SQLiteDatabase sqlitedatabase, int j, int l)
        {
        }
    ...
    au(u u1, Context context)
    {
        this(u1, context, "gtm_urls.db", 2000);
    }

    au(u u1, Context context, String s, int j)
    {
        ...
        h = zzhv.zznd();
        b = new b(e, f);
        c = new zzcx(new DefaultHttpClient(), e, new a());
        g = 0L;
        i = j;
    }
    ...
    static void a(au au1, long l, long l1)
    {
        au1.a(l, l1);
    }
        ...
        if (l > g + 0x5265c00L)
        {
            ...
            if (obj != null)
            {
                int j = ((SQLiteDatabase) (obj)).delete("gtm_hits", "HIT_TIME < ?", new String[] {
                    Long.toString(h.currentTimeMillis() - 0x9a7ec800L)
                });
                obj = d;
                if (c() != 0)
                {
...
_L2:
        ...
        if (((Cursor) (obj)).moveToFirst())
        {
            do
            {
                ((List) (obj3)).add(new p(((Cursor) (obj)).getLong(0), ((Cursor) (obj)).getLong(1), ((Cursor) (obj)).getLong(2)));
...
_L5:
        ((p)((List) (obj3)).get(j)).a(((Cursor) (obj2)).getString(1));
_L9:
...
_L6:
        zzbg.zzan(String.format("HitString for hitId %d too large.  Hit will be deleted.", new Object[] {
            Long.valueOf(((p)((List) (obj3)).get(j)).a())
        }));
          goto _L9
        obj1;
        obj = obj2;
...
_L11:
        ...
        obj1 = obj;
        obj4 = (p)((Iterator) (obj3)).next();
        obj1 = obj;
        flag1 = TextUtils.isEmpty(((p) (obj4)).c());
        int k;
        k = j;
        if (!flag1)
        {
