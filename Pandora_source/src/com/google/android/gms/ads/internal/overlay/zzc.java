...
_L11:
    ...
    public void onResume()
    {
        ...
        {
            zzb.zzan("The webview does not exit. Ignoring action.");
            return;
        }
    }
        ...
        throws a
    {
        ...
        zzb.zzaj((new StringBuilder()).append("Delay onShow to next orientation change: ").append(zzwo).toString());
        setRequestedOrientation(zzwf.orientation);
        if (zzh.zzaS().zza(((Window) (obj))))
        {
            zzb.zzaj("Hardware acceleration on the AdActivity window enabled.");
        }
        if (!zzwn)
        {
        ...
        if (flag)
        {
            ...
            zznp.zzft().zza(new com.google.android.gms.internal.zzge.zza() {
                ...
                final com.google.android.gms.ads.internal.overlay.zzc a;
            ...
            {
                a = com.google.android.gms.ads.internal.overlay.zzc.this;
                super();
            }
            });
            if (zzwf.zzwa != null)
