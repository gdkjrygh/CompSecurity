...
public final class zzi
{
    ...
    public zzi(Context context, AttributeSet attributeset)
    {
        ...
        zzqd = context.getString(com.google.android.gms.R.styleable.AdsAttrs_adUnitId);
        if (TextUtils.isEmpty(zzqd))
        {
    ...
    private static AdSize[] zzs(String s)
    {
        String as[];
        AdSize aadsize[];
        int i;
...
_L8:
    ...
    public AdSize[] zzj(boolean flag)
    {
        if (!flag && zzqc.length != 1)
        {
