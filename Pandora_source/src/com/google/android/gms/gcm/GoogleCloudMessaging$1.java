...
class a extends Handler
{
    ...
    public void handleMessage(Message message)
    {
        ...
        {
            GoogleCloudMessaging.zza(a).add(message);
        } else
        if (!GoogleCloudMessaging.zza(a, message))
        {
            message.setPackage(GoogleCloudMessaging.zzb(a).getPackageName());
            GoogleCloudMessaging.zzb(a).sendBroadcast(message);
            return;
        }
    }
