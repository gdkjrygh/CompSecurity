    ...
    implements f.b
{
    static class a extends android.graphics.drawable.Drawable.ConstantState
    {
        ...
        public a(p.n.c c1, byte abyte0[], Context context, g g1, int i1, int j1, p.n.a.a a1, 
                c c2, Bitmap bitmap)
        {
            if (bitmap == null)
            {
    ...
    public b(Context context, p.n.a.a a1, c c1, g g1, int i1, int j1, p.n.c c2, 
    ...
    public void a(g g1, Bitmap bitmap)
    {
        if (bitmap == null)
        {
            throw new NullPointerException("The first frame of the GIF must not be null");
