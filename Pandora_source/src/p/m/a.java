    ...
    implements Closeable
{
    public final class a
    {
        ...
        private a(b b1)
        {
            ...
            {
                a1 = new boolean[p.m.a.e(p.m.a.this)];
            }
            c = p.m.a.this;
        }
    ...
    private final class b
    {
        ...
        private b(String s)
        {
            ...
            super();
            d = s;
            e = new long[p.m.a.e(p.m.a.this)];
            a = new File[p.m.a.e(p.m.a.this)];
            b = new File[p.m.a.e(p.m.a.this)];
            s = (new StringBuilder(s)).append('.');
            int j1 = s.length();
            for (int i1 = 0; i1 < p.m.a.e(p.m.a.this); i1++)
            {
                s.append(i1);
                a[i1] = new File(p.m.a.f(p.m.a.this), s.toString());
                s.append(".tmp");
                b[i1] = new File(p.m.a.f(p.m.a.this), s.toString());
                s.setLength(j1);
            }
...
label0:
    ...
    private p.m.a(File file, int i1, int j1, long l1)
    {
        i = 0L;
        m = 0L;
    ...
    static int a(p.m.a a1, int i1)
    {
        a1.l = i1;
        return i1;
    }

    static Writer a(p.m.a a1)
    {
        return a1.j;
    }
...
_L9:
    ...
    public static p.m.a a(File file, int i1, int j1, long l1)
        throws IOException
    {
        Object obj;
        if (l1 <= 0L)
        ...
        obj = new p.m.a(file, i1, j1, l1);
        if (!((p.m.a) (obj)).c.exists())
        {
...
_L9:
    ...
    static void a(p.m.a a1, a a2, boolean flag)
        throws IOException
    {
        a1.a(a2, flag);
    }
    ...
    private void b()
        throws IOException
    {
        p.m.b b1 = new p.m.b(new FileInputStream(c), p.m.c.a);
        String s = b1.a();
        String s1 = b1.a();
        String s2 = b1.a();
        String s3 = b1.a();
...
_L3:
        p.m.c.a(b1);
        return;
        j = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(c, true), p.m.c.a));
          goto _L3
    }

    static void b(p.m.a a1)
        throws IOException
    {
        a1.g();
    }
        ...
        throws IOException
    {
        ...
        obj = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(d), p.m.c.a));
        Iterator iterator;
...
_L5:
    ...
    static void d(p.m.a a1)
        throws IOException
    {
        a1.d();
    }

    static int e(p.m.a a1)
    {
        return a1.h;
    }
