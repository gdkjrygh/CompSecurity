...
public class d extends e
{
    ...
    public d()
    {
        a = android.provider.MediaStore.Audio.Media.INTERNAL_CONTENT_URI;
    }
...
_L2:
        ...
        p.df.a.c("LocalInternalMusicLibrary", "Artist: %s - Album: %s - Song: %s - IsMusic %s LocalInternalMemoryLibrary", new Object[] {
            s2, s1, s, Boolean.valueOf(flag)
        });
