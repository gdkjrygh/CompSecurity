...
public class e extends p.dz.d
{
    ...
    public b a(b b1)
    {
        ...
        b1.a("Sec-WebSocket-Key1", f());
        b1.a("Sec-WebSocket-Key2", f());
        if (!b1.c("Origin"))
        {
...
label1:
    ...
    public f d(ByteBuffer bytebuffer)
        throws d
    {
        p.ec.c c1 = a(bytebuffer, d);
        if ((c1.c("Sec-WebSocket-Key1") || d == p.dx.b.b.a) && !c1.c("Sec-WebSocket-Version"))
        {
            byte abyte0[];
            byte byte0;
            if (d == p.dx.b.b.b)
            ...
            {
                throw new p.ea.a(bytebuffer.capacity() + 16);
            }
            c1.a(abyte0);
        }
        return c1;
