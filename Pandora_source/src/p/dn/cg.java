...
public class cg extends p.dn.a
{

    public static final d g;
    public static final int h;

    public cg(int i, int j)
    {
        super(h, "PNDR_UPDATE_TRACK_ALBUM_ART", 1, a(i, j));
    }

    public cg(byte abyte0[])
    {
        super(h, "PNDR_UPDATE_TRACK_ALBUM_ART", 1, abyte0);
    }
