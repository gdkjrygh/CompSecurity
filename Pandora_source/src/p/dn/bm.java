...
public class bm extends p.dn.a
{
    ...
    public bm(int i)
    {
        super(h, "PNDR_RETURN_STATIONS_ORDER", 1, a(i));
    }

    public bm(byte abyte0[])
    {
        super(h, "PNDR_RETURN_STATIONS_ORDER", 1, abyte0);
    }
    ...
    public String a(g g1)
    {
        if (g1 == g.c)
        {
            ...
            if (c() == 0)
            {
                g1.append("PNDR_SORT_BY_DATE");
            } else
            {
                g1.append("PNDR_SORT_BY_NAME");
            }
            g1.append("}");
            return g1.toString();
        } else
