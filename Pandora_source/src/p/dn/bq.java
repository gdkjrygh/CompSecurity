...
public class bq extends p.dn.a
{

    public static final d g;
    public static final int h;

    public bq(int i, String s)
    {
        super(h, "PNDR_RETURN_TRACK_ARTIST", 1, a(i, s));
    }

    public bq(byte abyte0[])
    {
        super(h, "PNDR_RETURN_TRACK_ARTIST", 1, abyte0);
        b(abyte0, 253);
    }
