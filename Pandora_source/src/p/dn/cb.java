...
public class cb extends p.dn.a
{

    public static final d g;
    public static final int h;

    public cb(int i, int j)
    {
        super(h, "PNDR_UPDATE_STATION_ADDED", 1, a(i, j));
    }

    public cb(byte abyte0[])
    {
        super(h, "PNDR_UPDATE_STATION_ADDED", 1, abyte0);
    }
