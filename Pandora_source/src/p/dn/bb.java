...
public class bb extends p.dn.a
{
    ...
    {
        super(h, "PNDR_RETURN_GENRE_CATEGORY_STATION_COUNT", 1, a(i, j));
    }

    public bb(byte abyte0[])
    {
        super(h, "PNDR_RETURN_GENRE_CATEGORY_STATION_COUNT", 1, abyte0);
    }
