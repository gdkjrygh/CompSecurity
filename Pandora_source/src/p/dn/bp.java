...
public class bp extends p.dn.a
{

    public static final d g;
    public static final int h;

    public bp(int i, int j, int k, byte abyte0[])
    {
        super(h, "PNDR_RETURN_TRACK_ALBUM_ART_SEGMENT", 1, a(i, j, k, abyte0));
    }

    public bp(byte abyte0[])
    {
        super(h, "PNDR_RETURN_TRACK_ALBUM_ART_SEGMENT", 1, abyte0);
    }
    ...
    public String a(g g1)
    {
        if (g1 == g.c)
        {
            ...
            g1.append(e());
            g1.append(",");
            g1.append((new StringBuilder()).append("dataLength=").append(f().length).toString());
            g1.append("}");
            return g1.toString();
        }
        if (g1 == g.d)
