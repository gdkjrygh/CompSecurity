...
public class cl extends p.dn.a
{

    public static final d g;
    public static final int h;

    public cl(int i, int j)
    {
        super(h, "PNDR_UPDATE_TRACK_EXPLAIN", 1, a(i, j));
    }

    public cl(byte abyte0[])
    {
        super(h, "PNDR_UPDATE_TRACK_EXPLAIN", 1, abyte0);
    }
