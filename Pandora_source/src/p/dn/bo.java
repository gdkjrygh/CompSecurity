...
public class bo extends p.dn.a
{

    public static final d g;
    public static final int h;

    public bo(int i, String s)
    {
        super(h, "PNDR_RETURN_TRACK_ALBUM", 1, a(i, s));
    }

    public bo(byte abyte0[])
    {
        super(h, "PNDR_RETURN_TRACK_ALBUM", 1, abyte0);
        b(abyte0, 253);
    }
