...
public class ch extends p.dn.a
{

    public static final d g;
    public static final int h;

    public ch(int i, boolean flag)
    {
        super(h, "PNDR_UPDATE_TRACK_BOOKMARK_ARTIST", 1, a(i, flag));
    }

    public ch(byte abyte0[])
    {
        super(h, "PNDR_UPDATE_TRACK_BOOKMARK_ARTIST", 1, abyte0);
    }
