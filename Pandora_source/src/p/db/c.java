...
// Referenced classes of package p.db:
//            b, a
...
public class c extends b
{
    ...
    public c(byte abyte0[], int i1, int j1)
    {
        a = new int[18];
        b = new int[256];
        c = new int[256];
    ...
    protected final int a(byte abyte0[], int i1, byte abyte1[], int j1, int k1)
    {
        int l1 = k1 - k1 % 8;
        int ai[] = a;
        int i2 = ai[0];
        ...
        {
            int i7 = abyte0[j1];
            byte byte2 = abyte0[j1 + 1];
            byte byte3 = abyte0[j1 + 2];
            byte byte4 = abyte0[j1 + 3];
            int k6 = abyte0[j1 + 4];
            int l6 = abyte0[j1 + 5];
            byte byte0 = abyte0[j1 + 6];
            byte byte1 = abyte0[j1 + 7];
            j1 += 8;
            i7 = (i7 << 24 | byte2 << 16 & 0xff0000 | byte3 << 8 & 0xff00 | byte4 & 0xff) ^ i2;
            k6 = (k6 << 24 | l6 << 16 & 0xff0000 | byte0 << 8 & 0xff00 | byte1 & 0xff) ^ ((ai[i7 >>> 24] + ai1[i7 >>> 16 & 0xff] ^ ai2[i7 >>> 8 & 0xff]) + ai3[i7 & 0xff] ^ j2);
            l6 = i7 ^ ((ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ k2);
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ l2;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ i3;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ j3;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ k3;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ l3;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ i4;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ j4;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ k4;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ l4;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ i5;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ j5;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ k5;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ l5;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ i6;
            k6 ^= j6;
            abyte1[k1] = (byte)(k6 >>> 24);
            abyte1[k1 + 1] = (byte)(k6 >>> 16);
            abyte1[k1 + 2] = (byte)(k6 >>> 8);
            abyte1[k1 + 3] = (byte)k6;
            abyte1[k1 + 4] = (byte)(l6 >>> 24);
            abyte1[k1 + 5] = (byte)(l6 >>> 16);
            abyte1[k1 + 6] = (byte)(l6 >>> 8);
            abyte1[k1 + 7] = (byte)l6;
            k1 += 8;
        }
    ...
    {
        System.arraycopy(i, 0, a, 0, 18);
        System.arraycopy(j, 0, b, 0, 256);
        System.arraycopy(k, 0, c, 0, 256);
        System.arraycopy(l, 0, d, 0, 256);
        System.arraycopy(m, 0, e, 0, 256);
        if (j1 != 0)
        {
            int ai[] = a;
            int ai1[] = b;
            ...
            for (i1 = 0; i1 < 18; i1 += 2)
            {
                a(abyte1, 0, abyte1, 0, 8);
                ai[i1] = p.db.a.a(abyte1, 0);
                ai[i1 + 1] = p.db.a.a(abyte1, 4);
            }

            for (i1 = 0; i1 < 256; i1 += 2)
            {
                a(abyte1, 0, abyte1, 0, 8);
                ai1[i1] = p.db.a.a(abyte1, 0);
                ai1[i1 + 1] = p.db.a.a(abyte1, 4);
            }

            for (i1 = 0; i1 < 256; i1 += 2)
            {
                a(abyte1, 0, abyte1, 0, 8);
                ai2[i1] = p.db.a.a(abyte1, 0);
                ai2[i1 + 1] = p.db.a.a(abyte1, 4);
            }

            for (i1 = 0; i1 < 256; i1 += 2)
            {
                a(abyte1, 0, abyte1, 0, 8);
                ai3[i1] = p.db.a.a(abyte1, 0);
                ai3[i1 + 1] = p.db.a.a(abyte1, 4);
            }
            ...
            {
                a(abyte1, 0, abyte1, 0, 8);
                ai4[i1] = p.db.a.a(abyte1, 0);
                ai4[i1 + 1] = p.db.a.a(abyte1, 4);
                i1 += 2;
            }
        }
    }

    public int b(byte abyte0[], int i1, byte abyte1[], int j1, int k1)
    {
        return a(abyte0, i1, abyte1, j1, k1);
    }

    public int c(byte abyte0[], int i1, byte abyte1[], int j1, int k1)
    {
        int l1 = k1 - k1 % 8;
        int ai[] = a;
        int i2 = ai[0];
        ...
        for (j1 = i1; j1 < i1 + l1;)
        {
            ...
            byte byte1 = abyte0[j1 + 7];
            j1 += 8;
            i7 = (i7 << 24 | byte2 << 16 & 0xff0000 | byte3 << 8 & 0xff00 | byte4 & 0xff) ^ j6;
            k6 = (k6 << 24 | l6 << 16 & 0xff0000 | byte0 << 8 & 0xff00 | byte1 & 0xff) ^ ((ai[i7 >>> 24] + ai1[i7 >>> 16 & 0xff] ^ ai2[i7 >>> 8 & 0xff]) + ai3[i7 & 0xff] ^ i6);
            l6 = i7 ^ ((ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ l5);
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ k5;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ j5;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ i5;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ l4;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ k4;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ j4;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ i4;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ l3;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ k3;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ j3;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ i3;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ l2;
            k6 ^= (ai[l6 >>> 24] + ai1[l6 >>> 16 & 0xff] ^ ai2[l6 >>> 8 & 0xff]) + ai3[l6 & 0xff] ^ k2;
            l6 ^= (ai[k6 >>> 24] + ai1[k6 >>> 16 & 0xff] ^ ai2[k6 >>> 8 & 0xff]) + ai3[k6 & 0xff] ^ j2;
            k6 ^= i2;
            abyte1[k1] = (byte)(k6 >>> 24);
            abyte1[k1 + 1] = (byte)(k6 >>> 16);
            abyte1[k1 + 2] = (byte)(k6 >>> 8);
