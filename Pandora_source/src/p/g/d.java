...
public class d extends MenuInflater
{
    ...
    private class b
    {
        ...
        static android.support.v4.view.d a(b b1)
        {
            return b1.z;
        }
        ...
        private Object a(String s1, Class aclass[], Object aobj[])
        {
            try
            {
                aclass = ((Class []) (p.g.d.a(a).getClassLoader().loadClass(s1).getConstructor(aclass).newInstance(aobj)));
            }
            // Misplaced declaration of an exception variable
            catch (Class aclass[])
            {
        ...
        private void a(MenuItem menuitem)
        {
            ...
            if (y != null)
            {
                if (p.g.d.a(a).isRestricted())
                {
                    throw new IllegalStateException("The android:onClick attribute cannot be used within a restricted context");
                }
                menuitem.setOnMenuItemClickListener(new a(d.c(a), y));
            }
            ...
            if (w != null)
            {
                android.support.v4.view.k.a(menuitem, (View)a(w, d.b(), d.d(a)));
            } else
            {
                flag = false;
            }
        ...
        {
            attributeset = p.g.d.a(a).obtainStyledAttributes(attributeset, android.support.v7.appcompat.R.styleable.MenuGroup);
        ...
        {
            boolean flag = true;
            attributeset = p.g.d.a(a).obtainStyledAttributes(attributeset, android.support.v7.appcompat.R.styleable.MenuItem);
            ...
            if (i1 != 0 && v == 0 && w == null)
            {
                z = (android.support.v4.view.d)a(x, p.g.d.a(), d.b(a));
            } else
            {
                if (i1 != 0)
                {
...
_L8:
        ...
        if (s1.equals("item"))
        {
            if (!b1.d())
            {
                if (p.g.b.a(b1) != null && p.g.b.a(b1).g())
                {
                    b1.c();
                } else
                {
...
_L6:
    ...
    {
        if (menu instanceof p.c.a) goto _L2; else goto _L1
_L1:
