    ...
    implements Runnable, p.al.a
{
    ...
    public e(Handler handler, int i1, int j1)
    {
        this(handler, i1, j1, true, a);
    }

    e(Handler handler, int i1, int j1, boolean flag, a a1)
    {
        b = handler;
        c = i1;
        d = j1;
