...
public final class ajz
{
    ...
    private ajz(int i1, int j1, int k1, String s, String s1, String s2, String s3, 
            boolean flag, JSONObject jsonobject, JSONObject jsonobject1, Object obj, HttpURLConnection httpurlconnection, ajx ajx1)
    {
        c = i1;
        d = j1;
        e = k1;
    ...
    public ajz(int i1, String s, String s1)
    {
        this(-1, i1, -1, s, s1, null, null, false, null, null, null, null, null);
    }

    ajz(HttpURLConnection httpurlconnection, Exception exception)
    {
        if (exception instanceof ajx)
        {
            exception = (ajx)exception;
        } else
        {
            exception = new ajx(exception);
        }
        this(-1, -1, -1, null, null, null, null, false, null, null, null, httpurlconnection, ((ajx) (exception)));
    }

    static ajz a(JSONObject jsonobject, Object obj, HttpURLConnection httpurlconnection)
    {
...
_L1:
        ...
        obj1 = alt.a(jsonobject, "body", "FACEBOOK_NON_JSON_RESULT");
...
_L6:
        ...
        String s1;
        boolean flag1;
        jsonobject1 = (JSONObject)alt.a(jsonobject2, "error", null);
...
_L10:
        ...
        return new ajz(k1, i1, j1, ((String) (obj1)), s, s1, ((String) (obj2)), flag1, jsonobject2, jsonobject, obj, httpurlconnection, null);
_L7:
...
_L11:
        ...
        obj1 = (JSONObject)alt.a(jsonobject, "body", "FACEBOOK_NON_JSON_RESULT");
_L12:
        jsonobject = new ajz(k1, -1, -1, null, null, null, null, false, ((JSONObject) (obj1)), jsonobject, obj, httpurlconnection, null);
        return jsonobject;
        jsonobject;
_L2:
        return null;
