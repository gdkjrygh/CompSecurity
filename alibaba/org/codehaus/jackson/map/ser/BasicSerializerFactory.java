...
public abstract class BasicSerializerFactory extends SerializerFactory
{
    ...
    public JsonSerializer buildContainerSerializer(SerializationConfig serializationconfig, JavaType javatype, BasicBeanDescription basicbeandescription, BeanProperty beanproperty, boolean flag)
    {
        ...
        if (javatype.isMapLikeType())
        {
            ...
            {
                return buildMapSerializer(serializationconfig, (MapType)javatype, basicbeandescription, beanproperty, flag, jsonserializer1, typeserializer, jsonserializer);
            } else
            {
                return buildMapLikeSerializer(serializationconfig, javatype, basicbeandescription, beanproperty, flag, jsonserializer1, typeserializer, jsonserializer);
            }
        }
        if (javatype.isCollectionLikeType())
        {
            ...
            {
                return buildCollectionSerializer(serializationconfig, (CollectionType)javatype, basicbeandescription, beanproperty, flag, typeserializer, jsonserializer);
            } else
            {
                return buildCollectionLikeSerializer(serializationconfig, javatype, basicbeandescription, beanproperty, flag, typeserializer, jsonserializer);
            }
        }
