...
public class PropertyBuilder
{
    ...
    protected BeanPropertyWriter buildWriter(String s, JavaType javatype, JsonSerializer jsonserializer, TypeSerializer typeserializer, TypeSerializer typeserializer1, AnnotatedMember annotatedmember, boolean flag)
    {
        ...
        if (typeserializer1 != null)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder()).append("Problem trying to create BeanPropertyWriter for property '").append(s).append("' (of type ").append(_beanDesc.getType()).append("); serialization type ").append(javatype2).append(" has no content").toString());
            }
