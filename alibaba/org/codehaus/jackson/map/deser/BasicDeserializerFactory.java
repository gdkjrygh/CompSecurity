...
public abstract class BasicDeserializerFactory extends DeserializerFactory
{
        ...
        throws JsonMappingException
    {
        ...
        if (jsondeserializer == null)
        {
            ...
            JavaType javatype = collectiontype1.getContentType();
            JsonDeserializer jsondeserializer2 = (JsonDeserializer)javatype.getValueHandler();
            collectiontype = (TypeDeserializer)javatype.getTypeHandler();
            if (collectiontype == null)
            {
                collectiontype = findTypeDeserializer(deserializationconfig, javatype, beanproperty);
            }
            JsonDeserializer jsondeserializer3 = _findCustomCollectionDeserializer(collectiontype1, deserializationconfig, deserializerprovider, basicbeandescription, beanproperty, collectiontype, jsondeserializer2);
...
label0:
                {
                    ...
                    deserializerprovider = (CollectionType)collectiontype1.forcedNarrowBy(deserializerprovider);
                ...
                {
                    return new StringCollectionDeserializer(deserializerprovider, jsondeserializer1, deserializationconfig);
                } else
                {
                    return new CollectionDeserializer(deserializerprovider, jsondeserializer1, collectiontype, deserializationconfig);
                }
            }
        }
        ...
        throws JsonMappingException
    {
        ...
        if (jsondeserializer == null)
        {
            ...
            JsonDeserializer jsondeserializer2 = (JsonDeserializer)javatype1.getValueHandler();
            maptype = (KeyDeserializer)javatype.getValueHandler();
            if (maptype == null)
            {
            ...
            JsonDeserializer jsondeserializer3 = _findCustomMapDeserializer(maptype1, deserializationconfig, deserializerprovider, basicbeandescription, beanproperty, maptype, typedeserializer, jsondeserializer2);
            jsondeserializer = jsondeserializer3;
            if (jsondeserializer3 == null)
            {
                ...
                deserializerprovider = maptype1.getRawClass();
                if (java/util/EnumMap.isAssignableFrom(deserializerprovider))
                {
                    ...
                    {
                        return new EnumMapDeserializer(constructEnumResolver(deserializerprovider, deserializationconfig), jsondeserializer1);
                    }
                }
                if (maptype1.isInterface() || maptype1.isAbstract())
                {
                    deserializerprovider = (Class)_mapFallbacks.get(deserializerprovider.getName());
                    if (deserializerprovider == null)
                    {
                    ...
                    beanproperty = (MapType)maptype1.forcedNarrowBy(deserializerprovider);
                ...
                maptype = new MapDeserializer(beanproperty, findValueInstantiator(deserializationconfig, deserializerprovider), maptype, jsondeserializer1, typedeserializer);
