...
//            BasicDeserializerFactory, BeanDeserializerBuilder, SettableAnyProperty, ValueInstantiator, 
//            SettableBeanProperty, BeanDeserializerModifier, ValueInstantiators
...
public class BeanDeserializerFactory extends BasicDeserializerFactory
{
    ...
    protected CreatorProperty constructCreatorProperty(DeserializationConfig deserializationconfig, BasicBeanDescription basicbeandescription, String s, int i, AnnotatedParameter annotatedparameter, Object obj)
        throws JsonMappingException
    {
        Object obj2 = deserializationconfig.getTypeFactory().constructType(annotatedparameter.getParameterType(), basicbeandescription.bindingsForBeanType());
        Object obj1 = new org.codehaus.jackson.map.BeanProperty.Std(s, ((JavaType) (obj2)), basicbeandescription.getClassAnnotations(), annotatedparameter);
        JavaType javatype = resolveType(deserializationconfig, basicbeandescription, ((JavaType) (obj2)), annotatedparameter, ((BeanProperty) (obj1)));
        org.codehaus.jackson.map.BeanProperty.Std std = ((org.codehaus.jackson.map.BeanProperty.Std) (obj1));
        if (javatype != obj2)
        {
            std = ((org.codehaus.jackson.map.BeanProperty.Std) (obj1)).withType(javatype);
        }
        obj2 = findDeserializerFromAnnotation(deserializationconfig, annotatedparameter, std);
        javatype = modifyTypeByAnnotation(deserializationconfig, annotatedparameter, javatype, s);
        obj1 = (TypeDeserializer)javatype.getTypeHandler();
        if (obj1 == null)
        {
            deserializationconfig = findTypeDeserializer(deserializationconfig, javatype, std);
        } else
        {
            deserializationconfig = ((DeserializationConfig) (obj1));
        }
        basicbeandescription = new CreatorProperty(s, javatype, deserializationconfig, basicbeandescription.getClassAnnotations(), annotatedparameter, i, obj);
        deserializationconfig = basicbeandescription;
        if (obj2 != null)
        {
            deserializationconfig = basicbeandescription.withValueDeserializer(((JsonDeserializer) (obj2)));
        }
