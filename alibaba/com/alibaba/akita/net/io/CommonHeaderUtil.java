...
//            DnsDispatcher, MteeUtil, EDMUtil, SitUtil

public class CommonHeaderUtil
{
    public static interface UAListener
    {
    ...
    public static final long CACHE_TIME = 10000L;
    ...
    private static final String SDK_INT_AND_VER_CODE;
    private static final String SPLIT = "|";
    private static String deviceInfo;
    private static final Map networkTypeCache = new HashMap();
    private static String screenInfo;
    private static UAListener uaListener = null;

    public CommonHeaderUtil()
    {
    }
    ...
    public static void addCommonHeader(HttpURLConnection httpurlconnection)
    {
        ...
        httpurlconnection.addRequestProperty("vv", (new StringBuilder()).append(SDK_INT_AND_VER_CODE).append("|").append(getNetworkTypeName()).toString());
        if (screenInfo == null)
        {
            screenInfo = (new StringBuilder()).append(lk.h(AkitaApplication.a())).append("x").append(lk.i(AkitaApplication.a())).toString();
        }
        httpurlconnection.addRequestProperty("cust1", screenInfo);
        if (deviceInfo == null)
        {
            deviceInfo = (new StringBuilder()).append(NetWorkUtil.getNumCores()).append(":").append(NetWorkUtil.getTotalRAM()).toString();
        }
        httpurlconnection.addRequestProperty("cust2", deviceInfo);
        if (AkitaApplication.a > 0L)
        {
            httpurlconnection.addRequestProperty("f", "1");
        }
        List list = DnsDispatcher.getDispatcher().getFailedIpList();
        if (list != null && list.size() > 0)
        {
            ...
            httpurlconnection.addRequestProperty("fip", stringbuilder.toString());
        }
    ...
    static 
    {
        SDK_INT_AND_VER_CODE = (new StringBuilder()).append(String.valueOf(android.os.Build.VERSION.SDK_INT)).append("|").append(lk.a(AkitaApplication.a())).toString();
    }
}
