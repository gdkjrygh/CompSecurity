...
public class SpdySSLSocketFactoryEx
    implements LayeredSocketFactory
{

    private static final SpdySSLSocketFactoryEx DEFAULT_FACTORY = new SpdySSLSocketFactoryEx();
    private SSLSocketFactory socketFactory;
    private SSLContext sslcontext;

    private SpdySSLSocketFactoryEx()
    {
        TrustManager atrustmanager[];
        try
        {
            atrustmanager = new TrustManager[1];
            atrustmanager[0] = new AEX509TrustManager();
        }
        catch (Exception exception)
        {
            exception.printStackTrace();
            exception = new TrustManager[0];
        }
        try
        {
    ...
    public static SpdySSLSocketFactoryEx getSocketFactory()
    {
