...
public static final class  extends Enum
{
    ...
    public static final FINAL FIRSTRETRY;
    public static final FINAL NORMAL;
    public static final FINAL SECONDRETRY;
    ...
    static 
    {
        ...
        FIRSTRETRY = new <init>("FIRSTRETRY", 1);
        SECONDRETRY = new <init>("SECONDRETRY", 2);
        FINAL = new <init>("FINAL", 3);
        $VALUES = (new .VALUES[] {
