...
public class PullToRefreshWebView extends mt
{
    final class a extends WebView
    {
                ...
                int l1, boolean flag)
        {
            ...
            mr.a(a, i, k, j, l, a(), 2, 1.5F, flag);
            return flag1;
        }

        public a(Context context, AttributeSet attributeset)
        {
            a = PullToRefreshWebView.this;
            super(context, attributeset);
        }
    }


    private static final mt.e b = new mt.e() {
    ...
    public PullToRefreshWebView(Context context)
    {
        ...
        ((WebView)a).setWebChromeClient(c);
    }
    ...
    public PullToRefreshWebView(Context context, mt.b b1)
    {
        super(context, b1);
        c = new _cls2();
        setOnRefreshListener(b);
    ...
    public PullToRefreshWebView(Context context, mt.b b1, mt.a a1)
    {
        super(context, b1, a1);
        c = new _cls2();
        setOnRefreshListener(b);
