...
public class RemoteFitXYImageView extends RemoteImageView
{
    ...
    public RemoteFitXYImageView(Context context, int i, int j, boolean flag, boolean flag1)
    {
    ...
    public RemoteFitXYImageView(Context context, boolean flag, boolean flag1)
    {
        super(context, flag, flag1);
    }

    public void a(Bitmap bitmap, boolean flag, String s)
    {
