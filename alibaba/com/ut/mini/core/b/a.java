...
// Referenced classes of package com.ut.mini.core.b:
//            b
...
public class a extends com.ut.mini.core.e.a.a
{
    ...
    private void a(c c1)
    {
        ...
        if (d != null && d.size() > 0)
        {
            for (c1 = d.iterator(); c1.hasNext(); ((b)c1.next()).a()) { }
        }
    ...
    public List a(Map map)
    {
        this;
        JVM INSTR monitorenter ;
        if (!f.a().j() || !f.a().g()) goto _L2; else goto _L1
_L1:
        Object obj;
        obj = new LinkedList();
        ((List) (obj)).add("stm_d");
...
_L4:
        obj = list;
        if (list.size() != 0) goto _L3; else goto _L5
_L5:
        int i;
        boolean flag;
        flag = false;
        ...
        map = (String)map.get(UTLogFieldsScheme.EVENTID.toString());
        i = ((flag) ? 1 : 0);
        if (map == null)
        {
            break MISSING_BLOCK_LABEL_133;
