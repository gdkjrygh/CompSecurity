...
public class UTAnalytics
{
    ...
    private UTAnalytics()
    {
        ...
        {
            a a1 = new a();
            UTPluginMgr.getInstance().registerPlugin(a1, false);
            d.d().a(a1);
            return;
        } else
        {
            a a2 = new a();
            com.ut.mini.core.a.c.a(a2);
            d.d().a(a2);
            return;
        }
    }
    ...
    public UTTracker getDefaultTracker()
    {
        ...
        JVM INSTR monitorenter ;
        UTTracker uttracker;
        if (b == null && com.ut.mini.base.c.a().d() != null)
        {
            b = new UTTracker();
        }
        if (b == null)
    ...
    public UTTracker getTracker(String s)
    {
        this;
        JVM INSTR monitorenter ;
