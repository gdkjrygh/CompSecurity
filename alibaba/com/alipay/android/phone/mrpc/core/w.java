    ...
    implements j
{
    ...
    private w(Context context)
    {
        a = context;
        d = m.a("android");
        c = new ThreadPoolExecutor(10, 11, 3L, TimeUnit.SECONDS, new ArrayBlockingQueue(20), i, new java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy());
        try
        {
    ...
    private static final w b(Context context)
    {
