...
public class PayEntrance
{
    ...
    public static String pay(String s)
    {
        PayResult payresult;
        payresult = TradeModelManager.getInstance().getTradeModelById(StringUtil.getBizIdentity(s)).getPayResult();
        LogEngine.getInstance().startPerf("PAY_WIN_LOAD");
        GlobalConfig.getUiInterControlBridge().startPay(s);
        payresult;
