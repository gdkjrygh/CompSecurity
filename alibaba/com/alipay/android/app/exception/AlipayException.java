...
public final class AlipayException extends RuntimeException
{
    ...
    public AlipayException(ErrorCodeEnum errorcodeenum, boolean flag, String s)
    {
        super(s);
        isNeedExit = false;
        error = errorcodeenum;
    ...
    public AlipayException(ErrorCodeEnum errorcodeenum, boolean flag, Throwable throwable)
    {
        super(errorcodeenum.getCode(), throwable);
        isNeedExit = false;
        error = errorcodeenum;
        isNeedExit = flag;
    }
