...
public class TidInfo
{
    ...
    {
        com/alipay/android/app/model/TidInfo;
    ...
    public static TidInfo getTidInfo()
    {
        String s = null;
        Object obj1 = null;
        com/alipay/android/app/model/TidInfo;
        JVM INSTR monitorenter ;
        if (a == null || !a(a.b)) goto _L2; else goto _L1
_L1:
        Object obj = a;
_L5:
        com/alipay/android/app/model/TidInfo;
        ...
        return ((TidInfo) (obj));
_L2:
        a a1 = new a(GlobalConfig.getContext());
        String s1;
        String s2;
        s1 = DeviceInfo.getInstance().getIMSI();
        s2 = DeviceInfo.getInstance().getIMEI();
        obj = a1.b(s1, s2);
        obj1 = s;
...
_L6:
        ...
        a();
        a.c = s;
        if (TextUtils.isEmpty(s) && TextUtils.isEmpty(a.c))
        {
            a.c = genTidKey();
        }
        a.d = l;
...
_L10:
        ...
        a();
        a.c = ((String) (obj1));
        if (TextUtils.isEmpty(((CharSequence) (obj1))) && TextUtils.isEmpty(a.c))
        {
            a.c = genTidKey();
        }
        a.d = 0L;
