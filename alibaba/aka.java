...
public final class aka
{
    ...
    private static final String a = aka.getCanonicalName();
...
_L4:
        ...
        return;
_L2:
        alu.a(context, "applicationContext");
        alu.b(context, false);
        alu.a(context, false);
...
_L3:
    ...
    public static boolean a(aki aki1)
    {
        HashSet hashset = b;
        hashset;
        JVM INSTR monitorenter ;
        boolean flag;
        if (b() && b.contains(aki1))
        {
            flag = true;
        } else
        {
    ...
    static akf b(Context context, String s)
    {
        if (context == null || s == null)
        {
            ...
            {
                alt.a("Facebook-publish", context);
            }
            return new akf(null, null, new ajz(null, context));
        }
        String s1;
        String s2;
        ...
        context = akv.a(akv.a.a, akw1, akr.c(context), b(context), context);
        s = GraphRequest.a(null, String.format("%s/activities", new Object[] {
            s
        }), context, null);
...
_L6:
        ...
        return (akf)akf.a("true", null, new ake(new GraphRequest[] {
            s
        })).get(0);
        context;
        throw new ajx("An error occurred while publishing install.", context);
        return new akf(null, null, null, context);
_L2:
        context = s.g();
        ...
        if (context.b() != null)
        {
            s.putString(s2, context.b().toString());
        }
        s.apply();
        return context;
_L4:
...
_L5:
    ...
    static 
    {
        b = new HashSet(Arrays.asList(new aki[] {
            aki.f
        }));
    }

    // Unreferenced inner class aka$3
