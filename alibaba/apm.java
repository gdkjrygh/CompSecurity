    ...
    public RegisterSectionInfo a(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < k)
            {
                ...
                case 7: // '\007'
                    afeature = (Feature[])arj.b(parcel, l, Feature.CREATOR);
                    break;
            ...
            if (parcel.dataPosition() != k)
            {
                throw new arj.a((new StringBuilder()).append("Overread allowed size end=").append(k).toString(), parcel);
            } else
            {
