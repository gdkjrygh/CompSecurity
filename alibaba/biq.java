...
public class biq extends Thread
{
    public static interface a
    {

        public abstract void onCommandResult(Context context, bis bis);

        public abstract void onReceiveMessage(Context context, bit bit);
    }
