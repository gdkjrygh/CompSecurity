...
public class asu
{
    ...
    private asu()
    {
        ...
        f = ((List) (obj));
        h = new asx(1024, ((Long)asv.a.f.c()).longValue());
    }
        ...
        if (arp.a)
        {
            if (a(context, s, intent, s1 = a(serviceconnection), i))
            {
                ...
                } else
                {
                    ...
                    serviceconnection = new ConnectionEvent(l1, i, auf.a(context), s, ((ServiceInfo) (intent)).processName, ((ServiceInfo) (intent)).name, serviceconnection, s1, SystemClock.elapsedRealtime(), l);
                }
