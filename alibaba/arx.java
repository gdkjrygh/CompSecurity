    ...
    implements android.os.Handler.Callback
{
    static final class a
    {
        ...
        {
            a = null;
            b = (ComponentName)ase.a(componentname);
        }
        ...
        implements ServiceConnection
    {
        ...
        {
            HashMap hashmap = arx.a(a.a);
            hashmap;
            JVM INSTR monitorenter ;
            b.a(a, ibinder);
            b.a(a, componentname);
            for (Iterator iterator = b.b(a).iterator(); iterator.hasNext(); ((ServiceConnection)iterator.next()).onServiceConnected(componentname, ibinder)) { }
        ...
        public void onServiceDisconnected(ComponentName componentname)
        {
            ...
            b.a(a, null);
            b.a(a, componentname);
            for (Iterator iterator = b.b(a).iterator(); iterator.hasNext(); ((ServiceConnection)iterator.next()).onServiceDisconnected(componentname)) { }
    ...
    {
        ase.a(serviceconnection, "ServiceConnection must not be null");
        HashMap hashmap = a;
        hashmap;
        JVM INSTR monitorenter ;
        b b1 = (b)a.get(a1);
