    ...
    implements gc.a
{
        ...
        implements gi.a
    {
        ...
        public boolean onOpenSubMenu(gc gc1)
        {
            ...
            {
                windowcallback.onMenuOpened(8, gc1);
            }
            return true;
        }
        ...
        implements android.support.v7.view.ActionMode.Callback
    {
        ...
        public void onDestroyActionMode(ActionMode actionmode)
        {
            ...
            if (mActionModeView != null)
            {
                ...
                {
                    ds.w((View)mActionModeView.getParent());
                }
            }
            if (mActionModeView != null)
            {
    ...
    static final class PanelFeatureState
    {
        ...
        gj getListMenuView(gi.a a)
        {
            ...
            {
                listMenuPresenter = new gb(listPresenterContext, android.support.v7.appcompat.R.layout.abc_list_menu_item_layout);
                listMenuPresenter.a(a);
        ...
        void setMenu(gc gc1)
        {
            if (gc1 != menu)
            {
                ...
                menu = gc1;
                if (gc1 != null && listMenuPresenter != null)
                {
                    gc1.a(listMenuPresenter);
                    return;
                }
            }
        }
...
label0:
            {
                ...
                gc1 = actionbaractivitydelegatebase.findMenuPanel(gc1);
                if (gc1 != null)
                {
                    if (!flag1)
                    {
                    ...
                    callOnPanelClosed(((PanelFeatureState) (gc1)).featureId, gc1, gc2);
                    closePanel(gc1, true);
                }
                return;
            }
    ...
    private gb mToolbarListMenuPresenter;
...
_L10:
    ...
    private void checkCloseActionMenu(gc gc1)
    {
        ...
        if (windowcallback != null && !isDestroyed())
        {
            windowcallback.onPanelClosed(8, gc1);
        }
    ...
    private void ensureToolbarListMenuPresenter()
    {
        if (mToolbarListMenuPresenter == null)
        {
            ...
            mToolbarListMenuPresenter = new gb(new ContextThemeWrapper(actionbaractivity, i), android.support.v7.appcompat.R.layout.abc_list_menu_item_layout);
        }
    }
...
_L5:
        obj = new gc(((Context) (obj)));
        ((gc) (obj)).a(this);
        panelfeaturestate.setMenu(((gc) (obj)));
        return true;
_L2:
...
_L4:
    ...
    private void invalidatePanelMenu(int i)
    {
        ...
        {
            ds.a(mWindowDecor, mInvalidatePanelMenuRunnable);
    ...
    {
        if (i == 0 && mDecorContentParent != null && mDecorContentParent.canShowOverflowMenu() && !eb.b(ViewConfiguration.get(mActivity)))
        {
...
_L3:
    ...
    private void reopenMenu(gc gc1, boolean flag)
    {
        if (mDecorContentParent == null || !mDecorContentParent.canShowOverflowMenu() || eb.b(ViewConfiguration.get(mActivity)) && !mDecorContentParent.isOverflowMenuShowPending())
        {
            break MISSING_BLOCK_LABEL_211;
        }
        gc1 = getWindowCallback();
        if (mDecorContentParent.isOverflowMenuShowing() && flag) goto _L2; else goto _L1
_L1:
        if (gc1 != null && !isDestroyed())
        {
            ...
            if (panelfeaturestate.menu != null && !panelfeaturestate.refreshMenuContent && gc1.onPreparePanel(0, null, panelfeaturestate.menu))
            {
                gc1.onMenuOpened(8, panelfeaturestate.menu);
                mDecorContentParent.showOverflowMenu();
            }
        }
_L4:
...
_L3:
        gc1 = getPanelState(0, true);
        mActivity.onPanelClosed(8, ((PanelFeatureState) (gc1)).menu);
        return;
        gc1 = getPanelState(0, true);
        gc1.refreshDecorView = true;
        closePanel(gc1, false);
        openPanel(gc1, null);
        return;
    }
...
_L3:
    ...
    public boolean onMenuItemSelected(gc gc1, MenuItem menuitem)
    {
        ...
        if (windowcallback != null && !isDestroyed())
        {
            gc1 = findMenuPanel(gc1.p());
            if (gc1 != null)
            {
                return windowcallback.onMenuItemSelected(((PanelFeatureState) (gc1)).featureId, menuitem);
            }
        }
        return false;
    }
