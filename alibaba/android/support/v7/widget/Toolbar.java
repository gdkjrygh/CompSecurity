...
public class Toolbar extends ViewGroup
{
        ...
        implements gi
    {
        ...
        ge mCurrentExpandedItem;
        gc mMenu;
        final Toolbar this$0;

        public boolean collapseItemActionView(gc gc1, ge ge1)
        {
        ...
        public boolean expandItemActionView(gc gc1, ge ge1)
        {
            ...
            mExpandedActionView = ge1.getActionView();
            mCurrentExpandedItem = ge1;
            if (mExpandedActionView.getParent() != Toolbar.this)
            {
                gc1 = generateDefaultLayoutParams();
                gc1.gravity = 0x800003 | mButtonGravity & 0x70;
                gc1.mViewType = 2;
                mExpandedActionView.setLayoutParams(gc1);
        ...
        public boolean onSubMenuSelected(gm gm)
        {
            return false;
        }

        public void setCallback(gi.a a)
        {
        }
...
_L8:
    ...
    private gi.a mActionMenuPresenterCallback;
    ...
    private gc.a mMenuBuilderCallback;
    ...
    private void ensureMenu()
    {
        ...
        {
            gc gc1 = (gc)mMenuView.getMenu();
            if (mExpandedMenuPresenter == null)
            {
                mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
            }
            mMenuView.setExpandedActionViewsExclusive(true);
            gc1.a(mExpandedMenuPresenter, mPopupContext);
        }
    }
...
_L3:
    ...
    public void collapseActionView()
    {
        ...
        {
            ge1 = mExpandedMenuPresenter.mCurrentExpandedItem;
        }
        if (ge1 != null)
        {
            ge1.collapseActionView();
        }
    }
...
_L11:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (shouldLayout(mNavButtonView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(0, ds.l(mNavButtonView));
        }
        i2 = k;
        k = i1;
        l = j1;
        if (shouldLayout(mCollapseButtonView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, ds.l(mCollapseButtonView));
        }
        ...
        if (shouldLayout(mMenuView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(k, ds.l(mMenuView));
        }
        ...
        if (shouldLayout(mExpandedActionView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, ds.l(mExpandedActionView));
        }
        i1 = l1;
        j1 = k;
        k1 = l;
        if (shouldLayout(mLogoView))
        {
            ...
            j1 = ViewUtils.combineMeasuredStates(k, ds.l(mLogoView));
        }
        i2 = getChildCount();
        l1 = 0;
        l = k1;
        ...
        while (j1 < i2) 
        {
            ...
            if (((LayoutParams)view.getLayoutParams()).mViewType == 0 && shouldLayout(view))
            {
                ...
                k = ViewUtils.combineMeasuredStates(k, ds.l(view));
            }
            j1++;
        }
        k1 = 0;
        ...
        if (shouldLayout(mTitleTextView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(k, ds.l(mTitleTextView));
        }
        j2 = j1;
        i2 = k1;
        k = i1;
        if (shouldLayout(mSubtitleTextView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, ds.l(mSubtitleTextView));
        }
        l = Math.max(l, j2);
        k1 = getPaddingLeft();
        j2 = getPaddingRight();
        i1 = getPaddingTop();
        j1 = getPaddingBottom();
        k1 = ds.a(Math.max(i2 + l1 + (k1 + j2), getSuggestedMinimumWidth()), i, 0xff000000 & k);
        i = ds.a(Math.max(l + (i1 + j1), getSuggestedMinimumHeight()), j, k << 16);
        if (shouldCollapse())
        {
            i = 0;
        }
...
_L3:
    ...
    public void setMenu(gc gc1, ActionMenuPresenter actionmenupresenter)
    {
        if (gc1 != null || mMenuView != null)
        {
            ensureMenuView();
            gc gc2 = mMenuView.peekMenu();
            if (gc2 != gc1)
            {
                if (gc2 != null)
                {
                    gc2.b(mOuterActionMenuPresenter);
                    gc2.b(mExpandedMenuPresenter);
                }
                if (mExpandedMenuPresenter == null)
                {
                    mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
                ...
                if (gc1 != null)
                {
                    gc1.a(actionmenupresenter, mPopupContext);
                    gc1.a(mExpandedMenuPresenter, mPopupContext);
                } else
                {
    ...
    public void setMenuCallbacks(gi.a a, gc.a a1)
    {
