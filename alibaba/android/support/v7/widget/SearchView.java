    ...
    implements CollapsibleActionView
{
    ...
    private fi mSuggestionsAdapter;
    android.view.View.OnKeyListener mTextKeyListener = new android.view.View.OnKeyListener() {
        ...
        public boolean onKey(View view, int j, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mQueryTextView.isEmpty() && cs.a(keyevent) && keyevent.getAction() == 1 && j == 66)
                {
...
_L6:
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && cs.a(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
...
_L5:
    ...
    public void setSuggestionsAdapter(fi fi1)
    {
        mSuggestionsAdapter = fi1;
        mQueryTextView.setAdapter(mSuggestionsAdapter);
    }
