    ...
    void measureHorizontal(int i, int j)
    {
        ...
        while (k2 < l5) 
        {
            ...
            } else
            {
                ...
                j5 = ViewUtils.combineMeasuredStates(l, ds.l(view1));
                if (flag1)
                {
        ...
        i5 = ds.a(Math.max(mTotalLength, getSuggestedMinimumWidth()), i, 0);
                ...
                if (view1 != null)
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k1 = ViewUtils.combineMeasuredStates(k1, ds.l(view1) & 0xff000000);
                            f -= f1;
                            j1 = j2;
                        }
                        if (flag)
...
_L4:
        ...
        setMeasuredDimension(0xff000000 & k | i5, ds.a(Math.max(i1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j, k << 16));
        if (i2 != 0)
        {
...
_L6:
        ...
        k5 = Math.max(l, i5);
        j5 = ViewUtils.combineMeasuredStates(k, ds.l(view));
        ...
        {
            {
                ...
                k4 = ds.a(Math.max(mTotalLength, getSuggestedMinimumHeight()), j, 0);
                ...
                while (i2 < l5) 
                {
                    ...
                    } else
                    {
                        ...
                        if (f1 > 0.0F)
                        {
                            ...
                            k = ViewUtils.combineMeasuredStates(k, ds.l(view) & 0xffffff00);
                            l1 = k1 - k2;
                            k1 = k;
                            f -= f1;
                            k = l1;
            ...
            setMeasuredDimension(ds.a(Math.max(l + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, k), k4);
            if (j2 != 0)
            {
