...
label0:
    ...
    {
        ds.a(mClose, -mClose.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
        ei ei1 = ds.s(mClose).b(0.0F);
        ei1.a(200L);
        ei1.a(this);
        ei1.a(new DecelerateInterpolator());
        ...
        if (mMenuView != null)
        {
            ...
            if (i > 0)
            {
                ...
                for (int j = 0; k >= 0; j++)
                {
                    ...
                    ds.e(((View) (obj)), 0.0F);
                    obj = ds.s(((View) (obj))).d(1.0F);
                    ((ei) (obj)).a(300L);
                    viewpropertyanimatorcompatset.play(((ei) (obj)));
                    k--;
                }
    ...
    {
        ei ei1 = ds.s(mClose).b(-mClose.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
        ei1.a(200L);
        ei1.a(this);
        ei1.a(new DecelerateInterpolator());
        ViewPropertyAnimatorCompatSet viewpropertyanimatorcompatset = new ViewPropertyAnimatorCompatSet();
