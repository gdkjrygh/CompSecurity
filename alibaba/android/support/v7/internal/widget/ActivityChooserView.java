...
label0:
            {
                ...
                obj = LayoutInflater.from(getContext()).inflate(android.support.v7.appcompat.R.layout.abc_activity_chooser_view_list_item, viewgroup, false);
                ((View) (obj)).setId(1);
                ((TextView)((View) (obj)).findViewById(android.support.v7.appcompat.R.id.title)).setText(getContext().getString(android.support.v7.appcompat.R.string.abc_activity_chooser_view_see_all));
            }
_L8:
            return ((View) (obj));
_L2:
...
_L6:
    ...
    public void setProvider(cp cp1)
    {
        mProvider = cp1;
    }
