    ...
    implements android.view.oolbarWidgetWrapper._cls1
{
    ...
    ()
    {
        ...
        super();
        mNavItem = new fx(ToolbarWidgetWrapper.access$000(ToolbarWidgetWrapper.this).getContext(), 0, 0x102002c, 0, 0, ToolbarWidgetWrapper.access$100(ToolbarWidgetWrapper.this));
    }
}
