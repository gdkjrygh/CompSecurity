    ...
    implements DecorContentParent
{
    ...
    private final em mBottomAnimatorListener;
    private ContentFrameLayout mContent;
    private final Rect mContentInsets;
    private ei mCurrentActionBarBottomAnimator;
    private ei mCurrentActionBarTopAnimator;
    private DecorToolbar mDecorToolbar;
    private ft mFlingEstimator;
    ...
    private final em mTopAnimatorListener;
    ...
    public ActionBarOverlayLayout(Context context)
    {
        ...
        mBottomAnimatorListener = new en() {
        ...
        mRemoveActionBarHideOffset = new Runnable() {
            ...
            public void run()
            {
                ...
                mCurrentActionBarTopAnimator = ds.s(mActionBarTop).c(0.0F).a(mTopAnimatorListener);
                if (mActionBarBottom != null && mActionBarBottom.getVisibility() != 8)
                {
                    mCurrentActionBarBottomAnimator = ds.s(mActionBarBottom).c(0.0F).a(mBottomAnimatorListener);
                }
            }
        ...
        mAddActionBarHideOffset = new Runnable() {
            ...
            {
                haltActionBarHideOffsetAnimations();
                mCurrentActionBarTopAnimator = ds.s(mActionBarTop).c(-mActionBarTop.getHeight()).a(mTopAnimatorListener);
                if (mActionBarBottom != null && mActionBarBottom.getVisibility() != 8)
                {
                    mCurrentActionBarBottomAnimator = ds.s(mActionBarBottom).c(mActionBarBottom.getHeight()).a(mBottomAnimatorListener);
                }
            }
    ...
    private void haltActionBarHideOffsetAnimations()
    {
        ...
        {
            mCurrentActionBarTopAnimator.a();
        }
        if (mCurrentActionBarBottomAnimator != null)
        {
            mCurrentActionBarBottomAnimator.a();
        }
    }
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (mWindowContentOverlay != null && !mIgnoreWindowContentOverlay)
        {
            ...
            {
                i = (int)((float)mActionBarTop.getBottom() + ds.p(mActionBarTop) + 0.5F);
            } else
            {
                i = 0;
            }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        int i1 = ViewUtils.combineMeasuredStates(0, ds.l(mActionBarTop));
        if (mActionBarBottom != null)
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(i1, ds.l(mActionBarBottom));
        }
        boolean flag;
        if ((ds.v(this) & 0x100) != 0)
        {
        ...
        i1 = ViewUtils.combineMeasuredStates(i1, ds.l(mContent));
        j1 = getPaddingLeft();
        k1 = getPaddingRight();
        l = Math.max(l + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(ds.a(Math.max(k + (j1 + k1), getSuggestedMinimumWidth()), i, i1), ds.a(l, j, i1 << 16));
    }
    ...
    public void setMenu(Menu menu, gi.a a)
    {
        pullChildren();
        mDecorToolbar.setMenu(menu, a);
    }
...
/*
    static ei access$002(ActionBarOverlayLayout actionbaroverlaylayout, ei ei1)
    {
        actionbaroverlaylayout.mCurrentActionBarTopAnimator = ei1;
        return ei1;
    }
...
/*
    static ei access$202(ActionBarOverlayLayout actionbaroverlaylayout, ei ei1)
    {
        actionbaroverlaylayout.mCurrentActionBarBottomAnimator = ei1;
        return ei1;
    }
