    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean flag, int i, int j)
    {
        ...
        mToolbar.setNavigationOnClickListener(new android.view.View.OnClickListener() {
            ...
            
            {
                ...
                super();
                mNavItem = new fx(mToolbar.getContext(), 0, 0x102002c, 0, 0, mTitle);
            }
        });
    }
...
label0:
    ...
    public void setMenu(Menu menu, gi.a a)
    {
        ...
        mToolbar.setMenu((gc)menu, mActionMenuPresenter);
    }
