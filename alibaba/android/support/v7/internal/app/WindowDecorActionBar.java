    ...
    implements android.support.v7.internal.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
{
        ...
        implements gc.a
    {
        ...
        public boolean onSubMenuSelected(gm gm1)
        {
            ...
            {
                (new gh(getThemedContext(), gm1)).show();
                return true;
            }
            return flag;
        }
        ...
        public ActionModeImpl(android.support.v7.view.ActionMode.Callback callback)
        {
            ...
            super();
            mCallback = callback;
            mMenu = (new gc(getThemedContext())).a(1);
            mMenu.a(this);
        }
    }
    ...
    public WindowDecorActionBar(Dialog dialog)
    {
        ...
        mHideListener = new en() {
            ...
            public void onAnimationEnd(View view)
            {
                ...
                {
                    ds.b(mContentView, 0.0F);
                    ds.b(mContainerView, 0.0F);
                }
    ...
    public void doHide(boolean flag)
    {
        ...
        if (mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (mShowHideAnimationEnabled || flag))
        {
            ...
            ei ei1 = ds.s(mContainerView).c(f);
            ei1.a(mUpdateListener);
            viewpropertyanimatorcompatset.play(ei1);
            if (mContentAnimations && mContentView != null)
            {
                viewpropertyanimatorcompatset.play(ds.s(mContentView).c(f));
            }
            if (mSplitView != null && mSplitView.getVisibility() == 0)
            {
                ds.c(mSplitView, 1.0F);
                viewpropertyanimatorcompatset.play(ds.s(mSplitView).c(mSplitView.getHeight()));
            }
    ...
    public void doShow(boolean flag)
    {
        ...
        if (mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (mShowHideAnimationEnabled || flag))
        {
            ...
            ds.b(mContainerView, f);
            ViewPropertyAnimatorCompatSet viewpropertyanimatorcompatset = new ViewPropertyAnimatorCompatSet();
            ei ei1 = ds.s(mContainerView).c(0.0F);
            ei1.a(mUpdateListener);
            viewpropertyanimatorcompatset.play(ei1);
            if (mContentAnimations && mContentView != null)
            {
                ds.b(mContentView, f);
                viewpropertyanimatorcompatset.play(ds.s(mContentView).c(0.0F));
            }
            if (mSplitView != null && mContextDisplayMode == 1)
            {
                ds.b(mSplitView, mSplitView.getHeight());
                mSplitView.setVisibility(0);
                viewpropertyanimatorcompatset.play(ds.s(mSplitView).c(0.0F));
            }
...
_L2:
        ...
        {
            q1 = mActivity.getSupportFragmentManager().a().a();
        }
        if (mSelectedTab != tab)
        {
