...
class resetGroup
{
    ...
    private void setItem(MenuItem menuitem)
    {
        ...
        {
            dc.a(menuitem, (View)newInstance(itemActionViewClassName, SupportMenuInflater.access$500(), SupportMenuInflater.access$600(SupportMenuInflater.this)));
        } else
        {
            flag = false;
        }
    ...
    public void readItem(AttributeSet attributeset)
    {
        ...
        {
            itemActionProvider = (cp)newInstance(itemActionProviderClassName, SupportMenuInflater.access$200(), SupportMenuInflater.access$300(SupportMenuInflater.this));
        } else
        {
            if (i != 0)
            {
