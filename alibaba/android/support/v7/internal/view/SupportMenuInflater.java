...
public class SupportMenuInflater extends MenuInflater
{
    ...
    class MenuState
    {
        ...
        private void setItem(MenuItem menuitem)
        {
            ...
            {
                dc.a(menuitem, itemShowAsAction);
            }
            ...
            {
                dc.a(menuitem, (View)newInstance(itemActionViewClassName, SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE, mActionViewConstructorArguments));
            } else
            {
                flag = false;
            }
            if (itemActionViewLayout > 0)
            {
                if (!flag)
                {
                    dc.b(menuitem, itemActionViewLayout);
                } else
                {
            ...
            {
                dc.a(menuitem, itemActionProvider);
            }
        }
        ...
        public void readItem(AttributeSet attributeset)
        {
            ...
            {
                itemActionProvider = (cp)newInstance(itemActionProviderClassName, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, mActionProviderConstructorArguments);
            } else
            {
                if (i != 0)
                {
...
_L6:
    ...
    {
        if (menu instanceof bn) goto _L2; else goto _L1
_L1:
