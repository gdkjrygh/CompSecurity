    ...
    implements Animatable
{
    ...
    private static final Interpolator c = new fe();
    boolean a;
    private final int d[] = {
        0xff000000
    };
    ...
    static float a(MaterialProgressDrawable materialprogressdrawable, a a1)
    {
        return materialprogressdrawable.a(a1);
    }
    ...
    static void a(MaterialProgressDrawable materialprogressdrawable, float f1, a a1)
    {
        materialprogressdrawable.b(f1, a1);
    }
    ...
    static void b(MaterialProgressDrawable materialprogressdrawable, float f1, a a1)
    {
        materialprogressdrawable.a(f1, a1);
    }
