...
public class SwipeRefreshLayout extends ViewGroup
{
    ...
    {
        i1 = df.a(motionevent, i1);
        if (i1 < 0)
        {
            return -1F;
        } else
        {
            return df.d(motionevent, i1);
        }
    }
...
label0:
    ...
    private void b()
    {
        t = new fh(getContext(), 0xfffafafa, 20F);
        w = new MaterialProgressDrawable(getContext(), this);
        w.b(0xfffafafa);
    ...
    static fh e(SwipeRefreshLayout swiperefreshlayout)
    {
...
_L5:
        o = df.b(motionevent, df.b(motionevent));
        continue; /* Loop/switch isn't completed */
_L6:
        a(motionevent);
...
_L3:
        ...
        float f2 = df.d(motionevent, df.a(motionevent, o));
        float f4 = l;
        n = false;
        if ((f2 - f4) * 0.5F > h)
        {
