...
public class hd
{
    static class a extends WeakReference
    {
        ...
        public a(Object obj, Object obj1, ReferenceQueue referencequeue)
        {
...
_L3:
    ...
    public final Object a(Object obj, Object obj1)
    {
        ...
        e();
        a.put(obj, obj1);
        obj = (a)b.put(obj, new a(obj, obj1, c));
...
_L3:
    ...
    public final String toString()
    {
        ...
        i = (d * 100) / j;
        String s = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d, lru=%s, mRef=%s]", new Object[] {
            Integer.valueOf(d()), Integer.valueOf(d), Integer.valueOf(e), Integer.valueOf(i), a.toString(), Integer.valueOf(b.size())
        });
        this;
        JVM INSTR monitorexit ;
        return s;
