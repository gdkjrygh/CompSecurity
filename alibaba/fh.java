...
public class fh extends ImageView
{
    class a extends OvalShape
    {
        ...
        public a(int i, int j)
        {
            ...
            float f = d / 2;
            float f1 = d / 2;
            float f2 = fh.a(fh.this);
            fh1 = android.graphics.Shader.TileMode.CLAMP;
    ...
    public fh(Context context, int i, float f)
    {
        super(context);
