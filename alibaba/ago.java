...
public class ago extends Drawable
{
    ...
    public ago(Context context)
    {
        j = false;
        l = false;
        TypedArray typedarray = context.getTheme().obtainStyledAttributes(null, com.alibaba.aliexpresshd.R.a.DrawerArrowToggle, 0x7f010001, 0x7f100067);
        a.setAntiAlias(true);
        a.setColor(typedarray.getColor(0, 0));
        i = typedarray.getDimensionPixelSize(2, 0);
        e = typedarray.getDimension(6, 0.0F);
        d = typedarray.getDimension(4, 0.0F);
        c = typedarray.getDimension(7, 0.0F);
        g = typedarray.getDimension(3, 0.0F);
    ...
    public void draw(Canvas canvas)
    {
        ...
        float f4 = a(e, d, k);
        float f1 = a(e, f, k);
        float f6 = a(0.0F, c / 2.0F, k);
        float f5 = a(0.0F, b, k);
        float f2 = a(g + c, 0.0F, k);
        h.rewind();
        float f3 = -f1 / 2.0F;
        h.moveTo(f3 + f6, 0.0F);
        h.rLineTo(f1 - f6, 0.0F);
        f6 = Math.round((double)f4 * Math.cos(f5));
