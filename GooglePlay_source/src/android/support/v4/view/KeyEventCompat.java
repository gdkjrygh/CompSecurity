...
public final class KeyEventCompat
{
        ...
        implements KeyEventVersionImpl
    {
        ...
        {
            return metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(i) & 0xf7, 1, 1, 64, 128), 1, 2, 16, 32) == 1;
        }
    ...
    public static boolean hasModifiers$79c6ddc0(KeyEvent keyevent)
    {
        return IMPL.metaStateHasModifiers(keyevent.getMetaState(), 1);
    }
