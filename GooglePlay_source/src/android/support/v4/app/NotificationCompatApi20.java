...
final class NotificationCompatApi20
{
        ...
        implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor
    {
                ...
                boolean flag4, String s1)
        {
            ...
            b = context.setFullScreenIntent(null, flag).setLargeIcon(bitmap).setNumber(0).setUsesChronometer(false).setPriority(l).setProgress(0, 0, false).setLocalOnly(flag3).setGroup(null).setGroupSummary(false).setSortKey(null);
            mExtras = new Bundle();
            if (bundle != null)
            {
