...
final class NotificationCompatJellybean
{
    ...
    {
        notificationbuilderwithbuilderaccessor = (new android.app.Notification.BigPictureStyle(notificationbuilderwithbuilderaccessor.getBuilder())).setBigContentTitle(null).bigPicture(null);
        if (flag)
        {
    ...
    {
        notificationbuilderwithbuilderaccessor = (new android.app.Notification.BigTextStyle(notificationbuilderwithbuilderaccessor.getBuilder())).setBigContentTitle(null).bigText(charsequence2);
        if (flag)
        {
            notificationbuilderwithbuilderaccessor.setSummaryText(charsequence1);
        }
    ...
    {
        notificationbuilderwithbuilderaccessor = (new android.app.Notification.InboxStyle(notificationbuilderwithbuilderaccessor.getBuilder())).setBigContentTitle(null);
        if (flag)
        {
            notificationbuilderwithbuilderaccessor.setSummaryText(charsequence1);
        }
