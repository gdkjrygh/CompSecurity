...
_L2:
        ...
        <init>1 = (this._cls0)list.remove(0);
        ((XmlSerializer) (obj1)).startTag(null, "historical-record");
        ((XmlSerializer) (obj1)).attribute(null, "activity", <init>1.y.flattenToString());
        ((XmlSerializer) (obj1)).attribute(null, "time", String.valueOf(<init>1.y));
        ((XmlSerializer) (obj1)).attribute(null, "weight", String.valueOf(<init>1.y));
...
_L1:
        ...
        ActivityChooserModel.access$502$7906a670(ActivityChooserModel.this);
        Object obj;
        if (aobj != null)
        {
            try
