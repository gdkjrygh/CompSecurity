    ...
    implements MenuItem
{
    ...
    static final class CollapsibleActionViewWrapper extends FrameLayout
    ...
    private final class OnActionExpandListenerWrapper extends BaseWrapper
    ...
    private final class OnMenuItemClickListenerWrapper extends BaseWrapper
    ...
    public View getActionView()
    {
        ...
        {
            return (View)((CollapsibleActionViewWrapper)view).mWrappedView;
        } else
        {
            return view;
        }
