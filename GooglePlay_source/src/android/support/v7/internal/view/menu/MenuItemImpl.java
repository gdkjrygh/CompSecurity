    ...
    implements SupportMenuItem
{
    ...
    private SupportMenuItem setActionView(View view)
    {
        ...
        mMenu.onItemActionRequestChanged$4587d488();
        return this;
    }

    private void setCheckedInt(boolean flag)
    {
        int i = mFlags;
        int j = mFlags;
        byte byte0;
    ...
    public final Drawable getIcon()
    {
        ...
        if (mIconResId != 0)
        {
            Drawable drawable = TintManager.getDrawable(mMenu.mContext, mIconResId);
            mIconResId = 0;
...
_L5:
    ...
    {
        Context context = mMenu.mContext;
    ...
    public final SupportMenuItem setSupportActionProvider(ActionProvider actionprovider)
    {
        ...
        if (mActionProvider != null)
        {
            mActionProvider.setVisibilityListener(new android.support.v4.view.ActionProvider.VisibilityListener() {
                ...
                {
                    mMenu.onItemVisibleChanged$4587d488();
                }
