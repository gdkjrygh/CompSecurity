...
{
    private final class ActionMenuItemForwardingListener extends android.support.v7.widget.ListPopupWindow.ForwardingListener
    {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mAllowTextWithIcon = resources.getBoolean(0x7f0a0004);
...
label0:
        {
            ...
            if (mIcon != null)
            {
                boolean flag1;
                boolean flag2;
                if ((mItemData.mShowAsAction & 4) == 4)
                {
                    flag1 = true;
                } else
                {
    ...
    public final void initialize$6b732f7b(MenuItemImpl menuitemimpl)
    {
        ...
        Drawable drawable = menuitemimpl.getIcon();
        mIcon = drawable;
        if (drawable != null)
        {
            ...
            if (i1 > mMaxIconSize)
            {
                float f = (float)mMaxIconSize / (float)i1;
                i = mMaxIconSize;
                k = (int)((float)l * f);
            }
            i1 = k;
            ...
            drawable.setBounds(0, 0, l, i1);
        }
        setCompoundDrawables(drawable, null, null, null);
        updateTextButtonVisibility();
        mTitle = menuitemimpl.getTitleForItemView(this);
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        mAllowTextWithIcon = getContext().getResources().getBoolean(0x7f0a0004);
        updateTextButtonVisibility();
    }
