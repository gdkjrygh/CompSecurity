...
public final class AppCompatRatingBar extends RatingBar
{
    ...
    {
        this(context, attributeset, 0x7f010153);
    }

    private AppCompatRatingBar(Context context, AttributeSet attributeset, int i)
    {
        super(context, attributeset, 0x7f010153);
        if (TintManager.SHOULD_BE_USED)
        {
            context = TintTypedArray.obtainStyledAttributes$1a6c1917(getContext(), attributeset, TINT_ATTRS, 0x7f010153);
