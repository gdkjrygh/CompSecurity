...
public class DefaultItemAnimator extends RecyclerView.ItemAnimator
{
    private static final class ChangeInfo
    {
        ...
        ChangeInfo(RecyclerView.ViewHolder viewholder, RecyclerView.ViewHolder viewholder1, int i, int j, int k, int l, byte byte0)
        {
    ...
    private static final class MoveInfo
    {
        ...
        MoveInfo(RecyclerView.ViewHolder viewholder, int i, int j, int k, int l, byte byte0)
        {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewholder, RecyclerView.ViewHolder viewholder1, int i, int j, int k, int l)
    {
        ...
        mPendingChanges.add(new ChangeInfo(viewholder, viewholder1, i, j, k, l, (byte)0));
        return true;
    }
    ...
    public final boolean animateMove(RecyclerView.ViewHolder viewholder, int i, int j, int k, int l)
    {
        ...
        mPendingMoves.add(new MoveInfo(viewholder, i, j, k, l, (byte)0));
        return true;
    }
...
label1:
    ...
    public void runPendingAnimations()
    {
        ...
        if (flag || flag1 || flag3 || flag2)
        {
            ...
            for (Iterator iterator = mPendingRemovals.iterator(); iterator.hasNext(); animation.setDuration(super.mRemoveDuration).alpha(0.0F).setListener(new VpaListenerAdapter() {
        ...
        public final void onAnimationStart(View view)
        {
            ...
            {
                holder = (RecyclerView.ViewHolder)iterator.next();
                animation = ViewCompat.animate(holder.itemView);
            ...
            if (flag1)
            {
                ...
                runnable = new Runnable() {
                    ...
                    public final void run()
                    {
                        ...
                        final int deltaY;
                        final int deltaX;
                        for (Iterator iterator1 = moves.iterator(); iterator1.hasNext(); animation.setDuration(((RecyclerView.ItemAnimator) (defaultitemanimator)).mMoveDuration).setListener(defaultitemanimator. new VpaListenerAdapter() {
            ...
            
            {
                ...
                super((byte)0);
                        ...
                        {
                            animation = (MoveInfo)iterator1.next();
                            defaultitemanimator = DefaultItemAnimator.this;
                            holder = ((MoveInfo) (animation)).holder;
                            deltaX = ((MoveInfo) (animation)).fromX;
                            deltaY = ((MoveInfo) (animation)).fromY;
                            int j = ((MoveInfo) (animation)).toX;
                            int i = ((MoveInfo) (animation)).toY;
            ...
            
            {
                ...
                if (flag)
                {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo)moves.get(0)).holder.itemView, runnable, super.mRemoveDuration);
                } else
                {
                    runnable.run();
                }
                ...
                runnable = new Runnable() {
                    ...
                    public final void run()
                    {
                        ...
                        do
                        {
                            ...
                            final ChangeInfo changeInfo = (ChangeInfo)iterator1.next();
                            ...
                            if (oldViewAnim != null)
                            {
                                oldViewAnim = ViewCompat.animate(((View) (oldViewAnim))).setDuration(((RecyclerView.ItemAnimator) (defaultitemanimator)).mChangeDuration);
                                ...
                                ((ViewPropertyAnimatorCompat) (oldViewAnim)).alpha(0.0F).setListener(defaultitemanimator. new VpaListenerAdapter() {
                                    ...
                                    public final void onAnimationEnd(View view)
                                    {
                                        ...
                                        ViewCompat.setTranslationX(view, 0.0F);
                                        ViewCompat.setTranslationY(view, 0.0F);
                                        dispatchChangeFinished$763f3adc(changeInfo.oldHolder);
            ...
            
            {
                ...
                super((byte)0);
                            ...
                            if (newView != null)
                            {
                                ...
                                ((ViewPropertyAnimatorCompat) (oldViewAnim)).translationX(0.0F).translationY(0.0F).setDuration(((RecyclerView.ItemAnimator) (defaultitemanimator)).mChangeDuration).alpha(1.0F).setListener(defaultitemanimator. new VpaListenerAdapter() {
                                    ...
                                    public final void onAnimationEnd(View view)
                                    {
                                        ...
                                        dispatchChangeFinished$763f3adc(changeInfo.newHolder);
            ...
            
            {
                ...
                if (flag)
                {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo)changes.get(0)).oldHolder.itemView, runnable, super.mRemoveDuration);
                } else
                {
                    runnable.run();
                }
            ...
            if (flag3)
            {
                ...
                runnable = new Runnable() {
                    ...
                    public final void run()
                    {
                        ...
                        DefaultItemAnimator defaultitemanimator;
                        final ViewPropertyAnimatorCompat animation;
                        for (Iterator iterator1 = additions.iterator(); iterator1.hasNext(); animation.alpha(1.0F).setDuration(((RecyclerView.ItemAnimator) (defaultitemanimator)).mAddDuration).setListener(defaultitemanimator. new VpaListenerAdapter() {
            ...
            
            {
                ...
                super((byte)0);
                        ...
                        {
                            holder = (RecyclerView.ViewHolder)iterator1.next();
                            defaultitemanimator = DefaultItemAnimator.this;
                            animation = ViewCompat.animate(holder.itemView);
