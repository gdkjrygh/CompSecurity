    ...
    implements android.view.tener
{
    ...
    public final boolean onKey(View view, int i, KeyEvent keyevent)
    {
        if (SearchView.access$1400(SearchView.this) != null)
        {
            ...
            {
                return SearchView.access$1500$2aa05b15(SearchView.this, i, keyevent);
            }
            if (!archAutoComplete.access._mth1600(SearchView.access$1200(SearchView.this)) && KeyEventCompat.hasNoModifiers(keyevent) && keyevent.getAction() == 1 && i == 66)
            {
                ...
                SearchView.access$1700$3e248f03(SearchView.this, SearchView.access$1200(SearchView.this).getText().toString());
                return true;
            }
        }
        return false;
