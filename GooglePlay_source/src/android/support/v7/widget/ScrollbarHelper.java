...
final class ScrollbarHelper
{
    ...
    static int computeScrollExtent(RecyclerView.State state, OrientationHelper orientationhelper, View view, View view1, RecyclerView.LayoutManager layoutmanager, boolean flag)
    {
        ...
        if (!flag)
        {
            return Math.abs(RecyclerView.LayoutManager.getPosition(view) - RecyclerView.LayoutManager.getPosition(view1)) + 1;
        } else
        {
        ...
        if (layoutmanager.getChildCount() != 0)
        {
            ...
            if (state.getItemCount() != 0)
            {
                ...
                if (view != null)
                {
                    ...
                    {
                        int i = Math.min(RecyclerView.LayoutManager.getPosition(view), RecyclerView.LayoutManager.getPosition(view1));
                        j = Math.max(RecyclerView.LayoutManager.getPosition(view), RecyclerView.LayoutManager.getPosition(view1));
                        if (flag1)
                        {
                        ...
                        if (flag)
                        {
                            ...
                            int l = Math.abs(RecyclerView.LayoutManager.getPosition(view) - RecyclerView.LayoutManager.getPosition(view1));
    ...
    static int computeScrollRange(RecyclerView.State state, OrientationHelper orientationhelper, View view, View view1, RecyclerView.LayoutManager layoutmanager, boolean flag)
    {
        ...
        } else
        {
            int i = orientationhelper.getDecoratedEnd(view1);
            int j = orientationhelper.getDecoratedStart(view);
            int k = Math.abs(RecyclerView.LayoutManager.getPosition(view) - RecyclerView.LayoutManager.getPosition(view1));
