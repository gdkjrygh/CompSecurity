    ...
    implements CardViewDelegate
{
    ...
    {
        attributeset = context.obtainStyledAttributes(attributeset, android.support.v7.cardview.R.styleable.CardView, i, 0x7f110092);
        i = attributeset.getColor(0, 0);
        float f3 = attributeset.getDimension(1, 0.0F);
        float f1 = attributeset.getDimension(2, 0.0F);
        float f2 = attributeset.getDimension(3, 0.0F);
        mCompatPadding = attributeset.getBoolean(4, false);
        mPreventCornerOverlap = attributeset.getBoolean(5, true);
        int j = attributeset.getDimensionPixelSize(6, 0);
        mContentPadding.left = attributeset.getDimensionPixelSize(7, j);
        mContentPadding.top = attributeset.getDimensionPixelSize(9, j);
        mContentPadding.right = attributeset.getDimensionPixelSize(8, j);
        mContentPadding.bottom = attributeset.getDimensionPixelSize(10, j);
        float f = f2;
        if (f1 > f2)
        {
            f = f1;
