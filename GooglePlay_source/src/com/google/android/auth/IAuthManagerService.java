...
_L2:
    ...
    public abstract Bundle clearToken(String s, Bundle bundle)
        throws RemoteException;

    public abstract AccountChangeEventsResponse getAccountChangeEvents(AccountChangeEventsRequest accountchangeeventsrequest)
        throws RemoteException;

    public abstract Bundle getAccounts(Bundle bundle)
        throws RemoteException;

    public abstract Bundle getToken(String s, String s1, Bundle bundle)
        throws RemoteException;

    public abstract Bundle getTokenByAccount(Account account, String s, Bundle bundle)
        throws RemoteException;

    public abstract Bundle removeAccount(Account account)
        throws RemoteException;
}
