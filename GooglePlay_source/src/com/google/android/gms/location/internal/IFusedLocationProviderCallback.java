...
public interface IFusedLocationProviderCallback
    extends IInterface
{
...
_L1:
    ...
    public abstract void onFusedLocationProviderResult(FusedLocationProviderResult fusedlocationproviderresult)
        throws RemoteException;
}
