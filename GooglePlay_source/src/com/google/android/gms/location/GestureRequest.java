...
//            GestureRequestCreator

public final class GestureRequest
    implements SafeParcelable
{

    private static final List COUNTER_GESTURE_TYPES = Collections.unmodifiableList(Arrays.asList(new Integer[] {
    ...
    public static final GestureRequestCreator CREATOR = new GestureRequestCreator();
    private static final List DETECTOR_GESTURE_TYPES = Collections.unmodifiableList(Arrays.asList(new Integer[] {
        Integer.valueOf(1)
    }));
    private static final List SEGMENT_DETECTOR_GESTURE_TYPES = Collections.unmodifiableList(Arrays.asList(new Integer[] {
    ...
    private static final List SUPPORTED_GESTURE_TYPES = Collections.unmodifiableList(Arrays.asList(new Integer[] {
    ...
    {
        GestureRequestCreator.writeToParcel$7d941044(this, parcel);
    }
