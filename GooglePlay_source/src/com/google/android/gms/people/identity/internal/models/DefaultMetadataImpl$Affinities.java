...
//            DefaultMetadataImpl, DefaultMetadataImpl_AffinitiesCreator
...
_L6:
    ...
    {
        switch (finities.arcelableFieldId())
        {
        default:
            throw new IllegalStateException((new StringBuilder("Unknown safe parcelable id=")).append(finities.arcelableFieldId()).toString());
    ...
    public final int hashCode()
    {
        ...
        do
        {
            ...
            if (isFieldSet(finities))
            {
                i = finities.arcelableFieldId() + i + getFieldValue(finities).hashCode();
            }
        } while (true);
        return i;
    }
    ...
    {
        return mIndicatorSet.contains(Integer.valueOf(finities.arcelableFieldId()));
    }
    ...
    {
        int i = finities.arcelableFieldId();
        switch (i)
        {
        default:
    ...
    static 
    {
        ...
        sFields = hashmap;
        hashmap.put("type", com.google.android.gms.common.server.response.g("type", 2));
        sFields.put("value", com.google.android.gms.common.server.response.e("value", 3));
    }
