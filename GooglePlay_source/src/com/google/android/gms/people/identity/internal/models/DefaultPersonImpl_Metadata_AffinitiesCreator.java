...
public final class DefaultPersonImpl_Metadata_AffinitiesCreator
    implements android.os.Parcelable.Creator
{

    public DefaultPersonImpl_Metadata_AffinitiesCreator()
    {
    }

    static void writeToParcel$3ae5cb85(DefaultPersonImpl.Metadata.Affinities affinities, Parcel parcel)
    {
    ...
    public final volatile Object createFromParcel(Parcel parcel)
    {
        ...
        do
        {
            ...
            } else
            {
                ...
                return new DefaultPersonImpl.Metadata.Affinities(hashset, i, s, d);
            }
        } while (true);
    }
