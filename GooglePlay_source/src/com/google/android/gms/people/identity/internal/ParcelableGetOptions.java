...
//            ParcelableGetOptionsCreator, ParcelableFirstPartyOptions
    ...
    implements SafeParcelable
{
    ...
    ParcelableGetOptions(int i, boolean flag, boolean flag1, boolean flag2, String s, Bundle bundle, ParcelableFirstPartyOptions parcelablefirstpartyoptions)
    {
        mVersionCode = i;
    ...
    {
        return Objects.toStringHelper(this).add("useOfflineDatabase", Boolean.valueOf(mUseOfflineDatabase)).add("useWebData", Boolean.valueOf(mUseWebData)).add("mUseCp2", Boolean.valueOf(mUseCp2)).add("endpoint", mEndpoint).add("endpointArguments", mEndpointArguments).add("firstPartyOptions", mOptions).toString();
    }
