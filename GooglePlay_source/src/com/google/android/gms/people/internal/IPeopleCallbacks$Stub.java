...
_L2:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel1 = (Bundle)Bundle.CREATOR.ateFromParcel(parcel);
            } else
            {
                parcel1 = null;
            }
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.ateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (ParcelFileDescriptor)ParcelFileDescriptor.CREATOR.ateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        if (parcel.readInt() != 0)
        {
            parcelfiledescriptor = (ParcelFileDescriptor)ParcelFileDescriptor.CREATOR.ateFromParcel(parcel);
        } else
        {
