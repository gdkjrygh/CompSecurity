    ...
    extends IInterface
{
        ...
        implements IDeviceManagerService
    {
        ...
        public static IDeviceManagerService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.mdm.internal.IDeviceManagerService");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                getDeviceName(IDeviceManagerCallbacks.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.mdm.internal.IDeviceManagerService");
                setDeviceName(IDeviceManagerCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;

            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.mdm.internal.IDeviceManagerService");
                clearDeviceName(IDeviceManagerCallbacks.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void clearDeviceName(IDeviceManagerCallbacks idevicemanagercallbacks)
        throws RemoteException;

    public abstract void getDeviceName(IDeviceManagerCallbacks idevicemanagercallbacks)
        throws RemoteException;

    public abstract void setDeviceName(IDeviceManagerCallbacks idevicemanagercallbacks, String s)
        throws RemoteException;
}
