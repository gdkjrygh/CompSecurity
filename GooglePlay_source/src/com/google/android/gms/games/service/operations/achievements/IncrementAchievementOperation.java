...
public final class IncrementAchievementOperation extends AbstractStatusReportingOperation
{
    ...
    public IncrementAchievementOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, String s, int i, com.google.android.gms.games.internal.PopupManager.PopupLocationInfo popuplocationinfo)
    {
    ...
    {
        return databroker.incrementAchievement(mGamesContext, mExternalAchievementId, mNumSteps, mPopupLocationInfo, mWriteImmediate);
    }
