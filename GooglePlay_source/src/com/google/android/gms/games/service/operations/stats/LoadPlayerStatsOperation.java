...
package com.google.android.gms.games.service.operations.stats;
...
public final class LoadPlayerStatsOperation extends AbstractDataHolderOperation
{

    private final WrappedGamesCallbacks mCallbacks;
    private final GamesClientContext mGamesContext;

    public LoadPlayerStatsOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks)
    {
    ...
    {
        return databroker.loadPlayerStats(mGamesContext);
    }
        ...
        throws RemoteException
    {
        ...
        wrappedgamescallbacks.mCallbacks.onPlayerStatsLoaded(dataholder);
    }
}
