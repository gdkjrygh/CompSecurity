...
public final class AcceptRequestOperation extends AbstractDataHolderOperation
{
    ...
    public AcceptRequestOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, String as[])
    {
    ...
    {
        return databroker.acceptRequests(mGamesContext, mExternalRequestIds);
    }
