...
public final class LoadInvitablePlayersOperation extends AbstractDataHolderOperation
{
    ...
    public LoadInvitablePlayersOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, int i, boolean flag)
    {
        ...
        throws GoogleAuthException
    {
        ...
        {
            return databroker.getFirstPartyInvitablePlayers(mGamesContext, mPageSize, mExpandCachedData);
        } else
        {
            return databroker.getInvitablePlayers(mGamesContext, mPageSize, mExpandCachedData);
        }
    }
