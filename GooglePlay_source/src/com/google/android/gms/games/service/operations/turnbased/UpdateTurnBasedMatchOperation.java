...
public final class UpdateTurnBasedMatchOperation extends AbstractDataHolderOperation
{
    ...
    public UpdateTurnBasedMatchOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, String s, String s1, byte abyte0[], ParticipantResult aparticipantresult[])
    {
    ...
    {
        return databroker.updateTurnBasedMatch(mGamesContext, mExternalMatchId, mPendingParticipantId, mMatchData, mResults);
    }
