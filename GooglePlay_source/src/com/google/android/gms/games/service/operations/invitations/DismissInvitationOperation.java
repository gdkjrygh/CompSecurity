...
public final class DismissInvitationOperation extends AbstractStatusReportingOperation
{
    ...
    public DismissInvitationOperation(GamesClientContext gamesclientcontext, String s, int i)
    {
    ...
    {
        return databroker.dismissInvitation(mGamesContext, mExternalInvitationId, mInvitationType);
    }
