...
public final class LoadProfileSettingsOperation extends AbstractDataHolderOperation
{

    private final WrappedGamesCallbacks mCallbacks;
    private final GamesClientContext mGamesContext;

    public LoadProfileSettingsOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks)
    {
    ...
    {
        return databroker.loadProfileSettings(mGamesContext);
    }
        ...
        throws RemoteException
    {
        ...
        wrappedgamescallbacks.mCallbacks.onProfileSettingsLoaded(dataholder);
    }
}
