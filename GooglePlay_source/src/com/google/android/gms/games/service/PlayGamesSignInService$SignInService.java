...
//            PlayGamesSignInService, PlayGamesSignInIntentService

static final class mSignInOptionsBundle extends com.google.android.gms.games.internal.SignInOptionsBundle
{
    ...
    public final Intent getPlusUpgradeIntent(Account account, String s, String as[], PlusCommonExtras pluscommonextras)
    {
        ...
        {
            account = new com.google.android.gms.plus.>(mContext, s);
            account.UpState = 2;
            account = account.();
        } else
        {
    ...
    (Context context, int i, Bundle bundle)
    {
