...
_L2:
    ...
    public static IPlayGamesBridgeService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.games.service.IPlayGamesBridgeService");
        ...
        throws RemoteException
    {
        ...
        case 1002: 
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (BitmapTeleporter)BitmapTeleporter.CREATOR.Parcel(parcel);
            } else
            {
                parcel = null;
            }
