...
public final class CreateTurnBasedMatchOperation extends AbstractDataHolderOperation
{
    ...
    public CreateTurnBasedMatchOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, int i, int j, String as[], Bundle bundle)
    {
    ...
    {
        return databroker.createTurnBasedMatch$d2d5e18(mGamesContext, mVariant, mInvitedPlayerIds, mAutoMatchCriteria);
    }
