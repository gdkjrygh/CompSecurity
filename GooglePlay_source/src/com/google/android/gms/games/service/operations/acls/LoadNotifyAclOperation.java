...
public final class LoadNotifyAclOperation extends AbstractDataHolderOperation
{

    private final WrappedGamesCallbacks mCallbacks;

    public LoadNotifyAclOperation(ClientContext clientcontext, WrappedGamesCallbacks wrappedgamescallbacks)
    {
        super(clientcontext);
    ...
    {
        return databroker.fetchNotifyAcl(context, mClientContext);
    }
        ...
        throws RemoteException
    {
        ...
        wrappedgamescallbacks.mCallbacks.onNotifyAclLoaded(dataholder);
    }
}
