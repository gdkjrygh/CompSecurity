...
public final class ClaimMilestoneOperation extends AbstractDataHolderOperation
{

    private final WrappedGamesCallbacks mCallbacks;
    private final String mExternalMilestoneId;
    private final String mExternalQuestId;
    private final GamesClientContext mGamesContext;

    public ClaimMilestoneOperation(GamesClientContext gamesclientcontext, WrappedGamesCallbacks wrappedgamescallbacks, String s, String s1)
    {
        super(gamesclientcontext.mClientContext);
        mCallbacks = wrappedgamescallbacks;
        mGamesContext = gamesclientcontext;
        mExternalMilestoneId = s1;
        mExternalQuestId = s;
    }
    ...
    {
        return databroker.claimMilestone(mGamesContext, mExternalQuestId, mExternalMilestoneId);
    }
        ...
        throws RemoteException
    {
        ...
        wrappedgamescallbacks.mCallbacks.onMilestoneClaimed(dataholder);
    }
}
