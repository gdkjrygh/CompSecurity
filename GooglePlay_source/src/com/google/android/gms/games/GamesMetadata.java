...
public interface GamesMetadata
{
        ...
        extends Releasable, Result
    {
        ...
        public abstract GameSearchSuggestionBuffer getSuggestions();
    }
    ...
    public abstract PendingResult loadGameSearchSuggestionsFirstParty(GoogleApiClient googleapiclient, String s);
}
