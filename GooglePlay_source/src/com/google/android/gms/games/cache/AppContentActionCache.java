...
public final class AppContentActionCache extends AppContentBaseCache
{

    public AppContentActionCache()
    {
        super(GamesDataUtils.APP_CONTENT_ACTION_SPEC.mColumnNames, "action_id");
    }
}
