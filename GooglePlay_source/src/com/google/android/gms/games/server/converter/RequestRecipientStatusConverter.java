...
public final class RequestRecipientStatusConverter
    implements com.google.android.gms.common.server.response.FastJsonResponse.FieldConverter
{

    public RequestRecipientStatusConverter()
    {
    }
    ...
    public final volatile Object convert(Object obj)
    {
        ...
        {
            GamesLog.e("RequestRecipientStatus", (new StringBuilder("Unknown request recipient type string: ")).append(((String) (obj))).toString());
            i = -1;
        }
    ...
    public final volatile Object convertBack(Object obj)
    {
        ...
        {
        default:
            GamesLog.e("RequestRecipientStatus", (new StringBuilder("Unknown request recipient status: ")).append(i).toString());
