...
public final class RoomAutoMatchingCriteria extends FastMapJsonResponse
{

    private static final TreeMap sFields;

    public RoomAutoMatchingCriteria()
    {
    }

    public RoomAutoMatchingCriteria(Long long1, Integer integer, Integer integer1)
    {
        if (long1 != null)
        {
