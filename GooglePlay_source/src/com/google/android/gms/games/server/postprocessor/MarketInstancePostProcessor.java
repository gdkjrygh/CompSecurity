    ...
    implements PostProcessor
{
    ...
    public final volatile FastJsonResponse postProcess(FastJsonResponse fastjsonresponse)
    {
        ...
        if (s != null)
        {
            ...
            {
                if (as[i].equals("USES_GAMEPAD"))
                {
                    contentvalues.put("gamepad_support", Boolean.valueOf(true));
                }
            }
