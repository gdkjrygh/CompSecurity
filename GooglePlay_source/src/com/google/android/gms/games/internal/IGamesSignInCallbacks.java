...
_L1:
    ...
    public abstract void onGameLoaded(DataHolder dataholder)
        throws RemoteException;

    public abstract void onGameplayAclLoaded(DataHolder dataholder)
        throws RemoteException;

    public abstract void onGameplayAclUpdated(int i)
        throws RemoteException;
