...
private static abstract class  extends DataHolderNotifier
{
    ...
    {
        notifyListener((RoomUpdateListener)obj, GamesClientImpl.access$100(dataholder), dataholder.mStatusCode);
    }
