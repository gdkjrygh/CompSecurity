    ...
    extends IInterface
{
        ...
        implements IRoomService
    {
        ...
        public static IRoomService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.games.internal.IRoomService");
            ...
            throws RemoteException
        {
            ...
            case 1001: 
                ...
                {
                    IInterface iinterface = parcel.queryLocalInterface("com.google.android.gms.games.internal.IRoomServiceCallbacks");
                    if (iinterface != null && (iinterface instanceof IRoomServiceCallbacks))
                    {
                        parcel = (IRoomServiceCallbacks)iinterface;
                    } else
                    {
                        parcel = new IRoomServiceCallbacks.Stub.Proxy(parcel);
                    }
                }
...
_L3:
    ...
    public abstract void connectNetwork(String s, String s1, String s2)
        throws RemoteException;

    public abstract void createNativeLibjingleSocket(String s, int i)
        throws RemoteException;

    public abstract void createSocketConnection(String s, int i)
        throws RemoteException;

    public abstract void disconnectNetwork()
        throws RemoteException;

    public abstract void doneLeavingRoom(boolean flag)
        throws RemoteException;

    public abstract void enterRoom(DataHolder dataholder, boolean flag)
        throws RemoteException;

    public abstract void handleStatusNotification(String s)
        throws RemoteException;
    ...
    public abstract void sendReliableMessage(byte abyte0[], String s, int i)
        throws RemoteException;

    public abstract void sendUnreliableMessage(byte abyte0[], String as[])
        throws RemoteException;

    public abstract void setup(IBinder ibinder, IRoomServiceCallbacks iroomservicecallbacks)
        throws RemoteException;

    public abstract void unloadLibraries()
        throws RemoteException;
}
