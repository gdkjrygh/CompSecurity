    ...
    extends IInterface
{
        ...
        implements IGamesSignInService
    {
        ...
        public static IGamesSignInService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.games.internal.IGamesSignInService");
            ...
            throws RemoteException
        {
            ...
            case 5003: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks5 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account;
                Account account8;
                if (parcel.readInt() != 0)
                {
            ...
            case 5004: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks6 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account1;
                Account account9;
                if (parcel.readInt() != 0)
                {
            ...
            case 5005: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks2 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account2;
                if (parcel.readInt() != 0)
                {
            ...
            case 5006: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks3 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account3;
                if (parcel.readInt() != 0)
                {
            ...
            case 5007: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks4 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account4;
                if (parcel.readInt() != 0)
                {
            ...
            case 5008: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks7 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                Account account5;
                Account account10;
                if (parcel.readInt() != 0)
                {
            ...
            case 14001: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                IGamesSignInCallbacks igamessignincallbacks = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                if (parcel.readInt() != 0)
                {
            ...
            case 17001: 
                parcel.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
                igamessignincallbacks1 = IGamesSignInCallbacks.Stub.asInterface(parcel.readStrongBinder());
                break;
            }
            if (parcel.readInt() != 0)
            {
...
_L4:
    ...
    public abstract void checkOAuthConsent(IGamesSignInCallbacks igamessignincallbacks, Account account, Account account1, String s, String as[])
        throws RemoteException;

    public abstract void forceRefreshToken(IGamesSignInCallbacks igamessignincallbacks, Account account)
        throws RemoteException;

    public abstract String getGmsAccountName(String s)
        throws RemoteException;

    public abstract Intent getPlusUpgradeIntent(Account account, String s, String as[], PlusCommonExtras pluscommonextras)
        throws RemoteException;

    public abstract Account getResolvedGmsAccount(String s, boolean flag)
        throws RemoteException;

    public abstract Account getSignedInAccount(String s)
        throws RemoteException;

    public abstract void loadGame(IGamesSignInCallbacks igamessignincallbacks, Account account, String s, String s1)
        throws RemoteException;

    public abstract void loadGameplayAcl(IGamesSignInCallbacks igamessignincallbacks, Account account, String s)
        throws RemoteException;

    public abstract void loadSelf(IGamesSignInCallbacks igamessignincallbacks, Account account, Account account1, String s, String s1, String as[])
        throws RemoteException;

    public abstract void recordSignIn(IGamesSignInCallbacks igamessignincallbacks, Account account, Account account1, String s, String as[], String s1)
        throws RemoteException;

    public abstract void refreshGameplayAclStatus(Account account, String s)
        throws RemoteException;

    public abstract void updateGameplayAcl(IGamesSignInCallbacks igamessignincallbacks, Account account, String s, String s1)
        throws RemoteException;

    public abstract void validateAccount(IGamesSignInCallbacks igamessignincallbacks, Account account)
        throws RemoteException;
}
