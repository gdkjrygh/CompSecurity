...
final class adGamesImpl extends adGamesImpl
{
    ...
    protected final volatile void doExecute(com.google.android.gms.common.api.aImpl._cls9 _pcls9)
        throws RemoteException
    {
        ((PlayGamesClientImpl)_pcls9).loadCommonGames(this, val$playerId, val$pageSize, true, false);
    }
