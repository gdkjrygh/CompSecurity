...
public interface IPlayGamesCallbacks
    extends IInterface
{
        ...
        implements IPlayGamesCallbacks
    {
        ...
        public static IPlayGamesCallbacks asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.games.client.IPlayGamesCallbacks");
...
_L1:
    ...
    public abstract void onExperimentsLoaded(int i, long al[])
        throws RemoteException;
