...
public final class OnyxMiniCardView extends OnyxBaseCardView
    implements OnyxCardViewDefinition.HasContextMenu, OnyxCardViewDefinition.HasHeroTransition, OnyxCardViewDefinition.HasLabelSetting, OnyxCardViewDefinition.HasPrimaryLabelImage, OnyxCardViewDefinition.HasSnippet, OnyxCardViewDefinition.HasTitleIcon
{
    ...
    protected final void onFinishInflate()
    {
        ...
        mSnippetImageView.setOutlineStrokeWidthResId(0x7f0c0154);
        mSnippetImageView.setShadowStrokeWidthResId(0x7f0c0155);
    }
    ...
    public final void resizeSnippet()
    {
        ...
        {
            mSnippetContainer.setPadding(mSnippetContainer.getPaddingLeft(), resources.getDimensionPixelSize(0x7f0c0150), mSnippetContainer.getPaddingRight(), mSnippetContainer.getPaddingBottom());
            return;
        } else
        {
