...
final class this._cls1 extends BaseTransitionListener
{
    ...
    {
        GameDetailActivity.access$1000(_fld0).setVisibility(4);
        GameDetailActivity.access$1100(_fld0).setVisibility(8);
    }
    ...
    // Unreferenced inner class com/google/android/gms/games/ui/destination/games/GameDetailActivity$1

/* anonymous class */
    final class GameDetailActivity._cls1 extends SharedElementCallback
    {
        ...
        public final void onSharedElementStart(List list, List list1, List list2)
        {
            ...
            findViewById(0x7f0d0156).setBackgroundColor(res.getColor(0x106000d));
            ...
            list = PlayTransitionUtil.aggregate(new Transition[] {
                HeroReloadoHelper.windowTransition(GameDetailActivity.this, null, GameDetailActivity.access$800(GameDetailActivity.this), false), (new Slide(80)).addTarget(containerView)
            }).setDuration(GameDetailActivity.access$900(GameDetailActivity.this));
            getWindow().setReturnTransition(list);
            list.addListener(new GameDetailActivity._cls1._cls1());
        }
