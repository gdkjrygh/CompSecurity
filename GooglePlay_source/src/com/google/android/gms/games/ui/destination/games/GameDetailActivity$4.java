...
final class this._cls0 extends BaseTransitionListener
{
    ...
    public final void onTransitionEnd(Transition transition)
    {
        ...
        GameDetailActivity.access$1700$1241a7bc(GameDetailActivity.this, GameDetailActivity.access$600(GameDetailActivity.this), transition).setAnimationListener(new android.view.animation.Animation.AnimationListener() {
        ...
        transition.addListener(new BaseAnimatorListener() {
            ...
            public final void onAnimationEnd(Animator animator)
            {
                ...
                {
                    GameDetailActivity.access$1800(this$0);
                    return;
                }
            }
