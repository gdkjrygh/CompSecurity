...
//            ActivityEntity, ActivityEntity_ObjectEntity_ActorEntityCreator
...
_L6:
    ...
    {
        switch (ctorentity.FieldId())
        {
        default:
            throw new IllegalStateException((new StringBuilder("Unknown safe parcelable id=")).append(ctorentity.FieldId()).toString());
    ...
    public final int hashCode()
    {
        ...
        do
        {
            ...
            if (isFieldSet(ctorentity))
            {
                i = ctorentity.FieldId() + i + getFieldValue(ctorentity).hashCode();
            }
        } while (true);
        return i;
    }
    ...
    {
        return mIndicatorSet.contains(Integer.valueOf(ctorentity.FieldId()));
    }
    ...
    static 
    {
        ...
        sFields = hashmap;
        hashmap.put("displayName", com.google.android.gms.common.server.response.ctorEntity.sFields("displayName", 2));
    }
