...
//            AccountField, AccountField_LabelEntity_ReferencesEntityCreator
...
_L6:
    ...
    {
        switch (ncesentity.eldId())
        {
        default:
            throw new IllegalStateException((new StringBuilder("Unknown safe parcelable id=")).append(ncesentity.eldId()).toString());
    ...
    public final int hashCode()
    {
        ...
        do
        {
            ...
            if (isFieldSet(ncesentity))
            {
                i = ncesentity.eldId() + i + getFieldValue(ncesentity).hashCode();
            }
        } while (true);
        return i;
    }
    ...
    {
        return mIndicatorSet.contains(Integer.valueOf(ncesentity.eldId()));
    }
