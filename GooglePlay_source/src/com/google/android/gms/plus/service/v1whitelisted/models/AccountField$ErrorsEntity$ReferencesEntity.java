...
//            AccountField, AccountField_ErrorsEntity_ReferencesEntityCreator
...
_L6:
    ...
    {
        switch (ncesentity.ldId())
        {
        default:
            throw new IllegalStateException((new StringBuilder("Unknown safe parcelable id=")).append(ncesentity.ldId()).toString());
    ...
    public final int hashCode()
    {
        ...
        do
        {
            ...
            if (isFieldSet(ncesentity))
            {
                i = ncesentity.ldId() + i + getFieldValue(ncesentity).hashCode();
            }
        } while (true);
        return i;
    }
    ...
    {
        return mIndicatorSet.contains(Integer.valueOf(ncesentity.ldId()));
    }
