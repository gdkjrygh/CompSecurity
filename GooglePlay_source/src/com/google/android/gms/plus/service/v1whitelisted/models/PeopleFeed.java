...
//            PeopleFeedCreator, PersonEntity
...
public final class PeopleFeed extends FastSafeParcelableJsonResponse
{
    ...
    PeopleFeed(Set set, int i, String s, List list, String s1, int j)
    {
        mIndicatorSet = set;
        mVersionCode = i;
        mEtag = s;
...
_L4:
    ...
    {
        PeopleFeedCreator.writeToParcel$761a2ac7(this, parcel);
    }
    ...
    static 
    {
        ...
        sFields.put("items", com.google.android.gms.common.server.response.FastJsonResponse.Field.forConcreteTypeArray("items", 3, com/google/android/gms/plus/service/v1whitelisted/models/PersonEntity));
