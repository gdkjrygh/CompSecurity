...
//            PersonEntity, PersonEntity_CoverEntity_CoverInfoEntityCreator

public static final class mTopImageOffset extends FastSafeParcelableJsonResponse
    implements com.google.android.gms.plus.model.people.foEntity
{
    ...
    {
        if (obj instanceof mTopImageOffset) goto _L2; else goto _L1
_L1:
        return false;
_L2:
        Iterator iterator;
...
_L6:
    ...
    protected final Object getFieldValue(com.google.android.gms.common.server.response.ity ity)
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Unknown safe parcelable id=")).append(ity.ieldId()).toString());
    ...
    public final int hashCode()
    {
        ...
        do
        {
            ...
            if (isFieldSet(ity))
            {
                i = ity.ieldId() + i + getFieldValue(ity).hashCode();
            }
        } while (true);
        return i;
    }
    ...
    {
        return mIndicatorSet.contains(Integer.valueOf(ity.ieldId()));
    }
...
_L4:
    ...
    static 
    {
        ...
        sFields = hashmap;
        hashmap.put("leftImageOffset", com.google.android.gms.common.server.response.ity.sFields("leftImageOffset", 2));
        sFields.put("topImageOffset", com.google.android.gms.common.server.response.ity.sFields("topImageOffset", 3));
    }
