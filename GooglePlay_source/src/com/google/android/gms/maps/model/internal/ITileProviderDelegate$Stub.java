...
_L1:
            Object obj;
            obj = Tile.CREATOR;
            obj = TileCreator.createFromParcel(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
            return ((Tile) (obj));
...
_L3:
    ...
    public static ITileProviderDelegate asInterface(IBinder ibinder)
    {
        ...
        if (iinterface != null && (iinterface instanceof ITileProviderDelegate))
        {
            return (ITileProviderDelegate)iinterface;
        } else
        {
