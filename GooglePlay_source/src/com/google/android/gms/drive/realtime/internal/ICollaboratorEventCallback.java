...
public interface ICollaboratorEventCallback
    extends IInterface
{
        ...
        implements ICollaboratorEventCallback
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (ParcelableCollaborator)ParcelableCollaborator.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
...
_L1:
    ...
    public abstract void onJoined(ParcelableCollaborator parcelablecollaborator)
        throws RemoteException;

    public abstract void onLeft(ParcelableCollaborator parcelablecollaborator)
        throws RemoteException;
}
