...
public final class ValuesRemovedDetailsCreator
    implements android.os.Parcelable.Creator
{

    public ValuesRemovedDetailsCreator()
    {
    }

    static void writeToParcel$14651594(ValuesRemovedDetails valuesremoveddetails, Parcel parcel)
    {
        int i = SafeParcelWriter.beginVariableData(parcel, 20293);
        SafeParcelWriter.writeInt(parcel, 1, valuesremoveddetails.mVersionCode);
        SafeParcelWriter.writeInt(parcel, 2, valuesremoveddetails.mIndex);
        SafeParcelWriter.writeInt(parcel, 3, valuesremoveddetails.mValueIndex);
        SafeParcelWriter.writeInt(parcel, 4, valuesremoveddetails.mValueCount);
        SafeParcelWriter.writeString(parcel, 5, valuesremoveddetails.mMovedToId, false);
        SafeParcelWriter.writeInt(parcel, 6, valuesremoveddetails.mMovedToIndex);
