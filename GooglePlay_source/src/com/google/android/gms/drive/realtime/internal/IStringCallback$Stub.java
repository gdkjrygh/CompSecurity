...
_L1:
        ...
        public final void onStringResult(String s)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
    ...
    public static IStringCallback asInterface(IBinder ibinder)
    {
        ...
        if (iinterface != null && (iinterface instanceof IStringCallback))
        {
            return (IStringCallback)iinterface;
        } else
        {
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            onStringResult(parcel.readString());
        ...
        if (parcel.readInt() != 0)
        {
            parcel = (Status)Status.CREATOR.eateFromParcel(parcel);
        } else
        {
            parcel = null;
        }
