...
public interface ICollaboratorsCallback
    extends IInterface
{
        ...
        implements ICollaboratorsCallback
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                onCollaboratorsResult((ParcelableCollaborator[])parcel.createTypedArray(ParcelableCollaborator.CREATOR));
...
_L1:
    ...
    public abstract void onCollaboratorsResult(ParcelableCollaborator aparcelablecollaborator[])
        throws RemoteException;
