...
public final class ObjectChangedDetailsCreator
    implements android.os.Parcelable.Creator
{

    public ObjectChangedDetailsCreator()
    {
    }

    static void writeToParcel$469d1e3d(ObjectChangedDetails objectchangeddetails, Parcel parcel)
    {
        int i = SafeParcelWriter.beginVariableData(parcel, 20293);
        SafeParcelWriter.writeInt(parcel, 1, objectchangeddetails.mVersionCode);
        SafeParcelWriter.writeInt(parcel, 2, objectchangeddetails.mValueIndex);
        SafeParcelWriter.writeInt(parcel, 3, objectchangeddetails.mValueCount);
