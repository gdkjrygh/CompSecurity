    ...
    extends IInterface
{
    public static abstract class Stub extends Binder
        implements IIntCallback
    {

        public static IIntCallback asInterface(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof IIntCallback))
            {
                return (IIntCallback)iinterface;
            } else
            {
...
_L1:
        ...
        public final void onIntResult(int i)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
    ...
    public abstract void onIntResult(int i)
        throws RemoteException;
}
