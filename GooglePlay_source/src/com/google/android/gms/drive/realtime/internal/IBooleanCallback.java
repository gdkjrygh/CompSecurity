    ...
    extends IInterface
{
        ...
        implements IBooleanCallback
    {
        ...
        public static IBooleanCallback asInterface(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof IBooleanCallback))
            {
                return (IBooleanCallback)iinterface;
            } else
            {
        ...
        implements IBooleanCallback
    {
        ...
        public final void onBooleanResult(boolean flag)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L1:
    ...
    public abstract void onBooleanResult(boolean flag)
        throws RemoteException;
