...
//            BaseDriveServiceCallbacks, DriveResourceImpl, DelegatingMetadata, OnMetadataResponse
...
private static final class mResultHolder extends BaseDriveServiceCallbacks
{
    ...
    public final void onMetadataResponse(OnMetadataResponse onmetadataresponse)
        throws RemoteException
    {
        mResultHolder.Result(new l(Status.RESULT_SUCCESS, new DelegatingMetadata(onmetadataresponse.mMetadata)));
    }
