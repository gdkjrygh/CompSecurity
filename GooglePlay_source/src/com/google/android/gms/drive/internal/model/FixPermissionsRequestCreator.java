...
public final class FixPermissionsRequestCreator
    implements android.os.Parcelable.Creator
{

    public FixPermissionsRequestCreator()
    {
    }

    static void writeToParcel$66c406ab(FixPermissionsRequest fixpermissionsrequest, Parcel parcel)
    {
        int i = SafeParcelWriter.beginVariableData(parcel, 20293);
        if (fixpermissionsrequest.mIndicatorSet.contains(Integer.valueOf(1)))
        {
