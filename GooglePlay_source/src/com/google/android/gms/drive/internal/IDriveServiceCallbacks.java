...
public interface IDriveServiceCallbacks
    extends IInterface
{
        ...
        implements IDriveServiceCallbacks
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnDownloadProgressResponse)OnDownloadProgressResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnListEntriesResponse)OnListEntriesResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 3: // '\003'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnDriveIdResponse)OnDriveIdResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 4: // '\004'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnMetadataResponse)OnMetadataResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 5: // '\005'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnContentsResponse)OnContentsResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 8: // '\b'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnListParentsResponse)OnListParentsResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 9: // '\t'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnSyncMoreResponse)OnSyncMoreResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 11: // '\013'
                ...
                {
                    IInterface iinterface = parcel.queryLocalInterface("com.google.android.gms.drive.realtime.internal.IRealtimeService");
                    if (iinterface != null && (iinterface instanceof IRealtimeService))
                    {
                        parcel = (IRealtimeService)iinterface;
                    } else
                    {
                        parcel = new com.google.android.gms.drive.realtime.internal.IRealtimeService.Stub.Proxy(parcel);
                    }
                }
            ...
            case 12: // '\f'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnResourceIdSetResponse)OnResourceIdSetResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 13: // '\r'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnDrivePreferencesResponse)OnDrivePreferencesResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 14: // '\016'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnDeviceUsagePreferenceResponse)OnDeviceUsagePreferenceResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 16: // '\020'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnFetchThumbnailResponse)OnFetchThumbnailResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 17: // '\021'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (ChangeSequenceNumber)ChangeSequenceNumber.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 18: // '\022'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (OnChangesResponse)OnChangesResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 20: // '\024'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (GetPermissionsResponse)GetPermissionsResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 21: // '\025'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (StringListResponse)StringListResponse.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (OnStartStreamSession)OnStartStreamSession.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel = null;
            }
...
_L1:
    ...
    public abstract void onAutobackupEnabledResponse(boolean flag)
        throws RemoteException;

    public abstract void onChangeSequenceNumberResponse(ChangeSequenceNumber changesequencenumber)
        throws RemoteException;

    public abstract void onChangesResponse(OnChangesResponse onchangesresponse)
        throws RemoteException;

    public abstract void onContentsResponse(OnContentsResponse oncontentsresponse)
        throws RemoteException;

    public abstract void onDeviceUsagePreferenceResponse(OnDeviceUsagePreferenceResponse ondeviceusagepreferenceresponse)
        throws RemoteException;

    public abstract void onDownloadProgress(OnDownloadProgressResponse ondownloadprogressresponse)
        throws RemoteException;

    public abstract void onDriveIdResponse(OnDriveIdResponse ondriveidresponse)
        throws RemoteException;

    public abstract void onDrivePreferencesResponse(OnDrivePreferencesResponse ondrivepreferencesresponse)
        throws RemoteException;

    public abstract void onError(Status status)
        throws RemoteException;

    public abstract void onFetchThumbnailResponse(OnFetchThumbnailResponse onfetchthumbnailresponse)
        throws RemoteException;

    public abstract void onGetPermissionsResponse(GetPermissionsResponse getpermissionsresponse)
        throws RemoteException;

    public abstract void onListEntriesResponse(OnListEntriesResponse onlistentriesresponse)
        throws RemoteException;

    public abstract void onListParentsResponse(OnListParentsResponse onlistparentsresponse)
        throws RemoteException;

    public abstract void onLoadRealtimeResponse(OnLoadRealtimeResponse onloadrealtimeresponse, IRealtimeService irealtimeservice)
        throws RemoteException;

    public abstract void onMetadataResponse(OnMetadataResponse onmetadataresponse)
        throws RemoteException;

    public abstract void onResourceIdSetResponse(OnResourceIdSetResponse onresourceidsetresponse)
        throws RemoteException;

    public abstract void onStartStreamSession(OnStartStreamSession onstartstreamsession)
        throws RemoteException;

    public abstract void onStringListResponse(StringListResponse stringlistresponse)
        throws RemoteException;

    public abstract void onSuccess()
        throws RemoteException;

    public abstract void onSyncMoreResponse(OnSyncMoreResponse onsyncmoreresponse)
        throws RemoteException;
}
