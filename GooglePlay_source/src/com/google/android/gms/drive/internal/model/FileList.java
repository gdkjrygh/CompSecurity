...
//            FileListCreator, File

public final class FileList extends FastSafeParcelableJsonResponse
{

    public static final FileListCreator CREATOR = new FileListCreator();
    ...
    FileList(Set set, int i, List list, String s)
    {
        mIndicatorSet = set;
        mVersionCode = i;
        mItems = list;
    ...
    {
        if (obj instanceof FileList) goto _L2; else goto _L1
_L1:
        return false;
_L2:
        Iterator iterator;
...
_L5:
        ...
        if (!((FileList) (obj)).isFieldSet(field)) goto _L1; else goto _L3
_L3:
        if (getFieldValue(field).equals(((FileList) (obj)).getFieldValue(field))) goto _L5; else goto _L4
_L4:
        return false;
        if (!((FileList) (obj)).isFieldSet(field)) goto _L5; else goto _L6
_L6:
        return false;
        return true;
    }
    ...
    {
        FileListCreator.writeToParcel$4d9f3f57(this, parcel);
    }
    ...
    static 
    {
        ...
        sFields = hashmap;
        hashmap.put("items", com.google.android.gms.common.server.response.FastJsonResponse.Field.forConcreteTypeArray("items", 4, com/google/android/gms/drive/internal/model/File));
