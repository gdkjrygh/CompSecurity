...
//            ParentReferenceCreator

public final class ParentReference extends FastSafeParcelableJsonResponse
{

    public static final ParentReferenceCreator CREATOR = new ParentReferenceCreator();
    ...
    ParentReference(Set set, int i, String s, boolean flag)
    {
        mIndicatorSet = set;
        mVersionCode = i;
        mId = s;
    ...
    {
        if (obj instanceof ParentReference) goto _L2; else goto _L1
_L1:
        return false;
_L2:
        Iterator iterator;
...
_L5:
        ...
        if (!((ParentReference) (obj)).isFieldSet(field)) goto _L1; else goto _L3
_L3:
        if (getFieldValue(field).equals(((ParentReference) (obj)).getFieldValue(field))) goto _L5; else goto _L4
_L4:
        return false;
        if (!((ParentReference) (obj)).isFieldSet(field)) goto _L5; else goto _L6
_L6:
        return false;
        return true;
    }
    ...
    protected final Object getFieldValue(com.google.android.gms.common.server.response.FastJsonResponse.Field field)
    {
        ...
        case 3: // '\003'
            return Boolean.valueOf(mIsRoot);
        }
    }
    ...
    {
        ParentReferenceCreator.writeToParcel$21f7c7ea(this, parcel);
    }
    ...
    static 
    {
        ...
        sFields.put("isRoot", com.google.android.gms.common.server.response.FastJsonResponse.Field.forBoolean("isRoot", 3));
    }
}
