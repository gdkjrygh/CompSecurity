...
//            ISignInService, CheckServerAuthResult, RecordConsentRequest, ISignInCallbacks
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            ...
            if (parcel.readInt() != 0)
            {
                authaccountrequest = (AuthAccountRequest)AuthAccountRequest.CREATOR.reateFromParcel(parcel);
            } else
            {
                authaccountrequest = null;
            }
            authAccount(authaccountrequest, b.asInterface(parcel.readStrongBinder()));
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (CheckServerAuthResult)CheckServerAuthResult.CREATOR.reateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 5: // '\005'
            ...
            if (parcel.readInt() != 0)
            {
                resolveaccountrequest = (ResolveAccountRequest)ResolveAccountRequest.CREATOR.reateFromParcel(parcel);
            } else
            {
                resolveaccountrequest = null;
            }
            ...
            } else
            {
                ...
                {
                    parcel = new com.google.android.gms.common.internal.acks.Stub.Proxy(parcel);
                }
            }
        ...
        case 8: // '\b'
            ...
            if (parcel.readInt() != 0)
            {
                account = (Account)Account.CREATOR.reateFromParcel(parcel);
            } else
            {
                account = null;
            }
            saveAccountToSessionStore(i, account, b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 9: // '\t'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            IAccountAccessor iaccountaccessor = com.google.android.gms.common.internal.b.asInterface(parcel.readStrongBinder());
            i = parcel.readInt();
            boolean flag1;
            if (parcel.readInt() != 0)
            {
        ...
        case 10: // '\n'
            ...
            if (parcel.readInt() != 0)
            {
                recordconsentrequest = (RecordConsentRequest)RecordConsentRequest.CREATOR.reateFromParcel(parcel);
            } else
            {
                recordconsentrequest = null;
            }
            recordConsent(recordconsentrequest, b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 11: // '\013'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            getCurrentAccount(b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
