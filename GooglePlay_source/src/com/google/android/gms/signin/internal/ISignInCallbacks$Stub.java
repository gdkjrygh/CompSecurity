...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                connectionresult = (ConnectionResult)ConnectionResult.CREATOR.ateFromParcel(parcel);
            } else
            {
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (AuthAccountResult)AuthAccountResult.CREATOR.ateFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        if (parcel.readInt() != 0)
        {
            status = (Status)Status.CREATOR.ateFromParcel(parcel);
        } else
        {
            status = null;
        }
        if (parcel.readInt() != 0)
        {
            parcel = (GoogleSignInAccount)GoogleSignInAccount.CREATOR.ateFromParcel(parcel);
        } else
        {
            parcel = null;
        }
