    ...
    extends IInterface
{
        ...
        implements IGoogleHttpService
    {
        ...
        public static IGoogleHttpService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.http.IGoogleHttpService");
...
_L3:
    ...
    public abstract Bundle getHttpRequestInfo(String s)
        throws RemoteException;

    public abstract void reportHttpRequestResult(String s, int i)
        throws RemoteException;
}
