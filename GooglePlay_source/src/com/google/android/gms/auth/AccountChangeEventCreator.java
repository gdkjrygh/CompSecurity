...
public final class AccountChangeEventCreator
    implements android.os.Parcelable.Creator
{
    ...
    static void writeToParcel$119e69c0(AccountChangeEvent accountchangeevent, Parcel parcel)
    {
        int i = SafeParcelWriter.beginVariableData(parcel, 20293);
        SafeParcelWriter.writeInt(parcel, 1, accountchangeevent.mVersion);
        SafeParcelWriter.writeLong(parcel, 2, accountchangeevent.mId);
        SafeParcelWriter.writeString(parcel, 3, accountchangeevent.mAccountName, false);
        SafeParcelWriter.writeInt(parcel, 4, accountchangeevent.mChangeType);
        SafeParcelWriter.writeInt(parcel, 5, accountchangeevent.mEventIndex);
        SafeParcelWriter.writeString(parcel, 6, accountchangeevent.mChangeData, false);
