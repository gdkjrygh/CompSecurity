...
//            IDroidGuardHandle, IDroidGuardCallbacks

public interface IDroidGuardService
    extends IInterface
{
        ...
        implements IDroidGuardService
    {
        ...
        public static IDroidGuardService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.droidguard.internal.IDroidGuardService");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                {
                    IInterface iinterface = parcel1.queryLocalInterface("com.google.android.gms.droidguard.internal.IDroidGuardCallbacks");
                    if (iinterface != null && (iinterface instanceof IDroidGuardCallbacks))
                    {
                        parcel1 = (IDroidGuardCallbacks)iinterface;
                    } else
                    {
                        parcel1 = new IDroidGuardCallbacks.Stub.Proxy(parcel1);
                    }
                }
    ...
    public abstract IDroidGuardHandle createDroidGuardHandle()
        throws RemoteException;

    public abstract int getClientBlockingOperationTimeoutMillis()
        throws RemoteException;

    public abstract void getResults(IDroidGuardCallbacks idroidguardcallbacks, String s, Map map)
        throws RemoteException;
}
