...
public interface IDroidGuardHandle
    extends IInterface
{
        ...
        implements IDroidGuardHandle
    {
        ...
        public static IDroidGuardHandle asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.droidguard.internal.IDroidGuardHandle");
    ...
    public abstract byte[] snapshot(Map map)
        throws RemoteException;
}
