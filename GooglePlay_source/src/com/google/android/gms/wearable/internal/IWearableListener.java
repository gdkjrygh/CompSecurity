...
//            LargeAssetSyncRequestPayload, ILargeAssetSyncRequestResponder, MessageEventParcelable, AncsNotificationParcelable, 
//            NodeParcelable, IFileDescriptorReceiver

public interface IWearableListener
    extends IInterface
{
        ...
        implements IWearableListener
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (MessageEventParcelable)MessageEventParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 3: // '\003'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (NodeParcelable)NodeParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 6: // '\006'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (AncsNotificationParcelable)AncsNotificationParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 7: // '\007'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (ChannelEventParcelable)ChannelEventParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 8: // '\b'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (CapabilityInfoParcelable)CapabilityInfoParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 9: // '\t'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (AmsEntityUpdateParcelable)AmsEntityUpdateParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 10: // '\n'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (LargeAssetQueueStateChangeParcelable)LargeAssetQueueStateChangeParcelable.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 11: // '\013'
                ...
                {
                    IInterface iinterface = parcel1.queryLocalInterface("com.google.android.gms.wearable.internal.IFileDescriptorReceiver");
                    if (iinterface != null && (iinterface instanceof IFileDescriptorReceiver))
                    {
                        parcel1 = (IFileDescriptorReceiver)iinterface;
                    } else
                    {
                        parcel1 = new IFileDescriptorReceiver.Stub.Proxy(parcel1);
                    }
                }
            ...
            if (parcel.readInt() != 0)
            {
                parcel1 = (LargeAssetSyncRequestPayload)LargeAssetSyncRequestPayload.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel1 = null;
            }
            ...
            {
                IInterface iinterface1 = parcel.queryLocalInterface("com.google.android.gms.wearable.internal.ILargeAssetSyncRequestResponder");
                ...
                {
                    parcel = new ILargeAssetSyncRequestResponder.Stub.Proxy(parcel);
                }
            }
...
_L1:
    ...
    public abstract void onChannelEvent(ChannelEventParcelable channeleventparcelable)
        throws RemoteException;

    public abstract void onConnectedCapabilityChanged(CapabilityInfoParcelable capabilityinfoparcelable)
        throws RemoteException;

    public abstract void onConnectedNodes(List list)
        throws RemoteException;

    public abstract void onDataChanged(DataHolder dataholder)
        throws RemoteException;

    public abstract void onEntityUpdate(AmsEntityUpdateParcelable amsentityupdateparcelable)
        throws RemoteException;

    public abstract void onLargeAssetStateChanged(LargeAssetQueueStateChangeParcelable largeassetqueuestatechangeparcelable)
        throws RemoteException;

    public abstract void onLargeAssetSyncRequest(LargeAssetSyncRequestPayload largeassetsyncrequestpayload, ILargeAssetSyncRequestResponder ilargeassetsyncrequestresponder)
        throws RemoteException;

    public abstract void onMessageReceived(MessageEventParcelable messageeventparcelable)
        throws RemoteException;

    public abstract void onNotificationReceived(AncsNotificationParcelable ancsnotificationparcelable)
        throws RemoteException;

    public abstract void onPeerConnected(NodeParcelable nodeparcelable)
        throws RemoteException;

    public abstract void onPeerDisconnected(NodeParcelable nodeparcelable)
        throws RemoteException;

    public abstract void openFileDescriptor(IFileDescriptorReceiver ifiledescriptorreceiver, String s, int i)
        throws RemoteException;
}
