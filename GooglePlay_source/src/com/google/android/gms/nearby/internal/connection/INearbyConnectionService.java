...
public interface INearbyConnectionService
    extends IInterface
{
        ...
        implements INearbyConnectionService
    {
            ...
            throws RemoteException
        {
            ...
            case 1001: 
                ...
                INearbyConnectionCallbacks inearbyconnectioncallbacks = INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder());
            ...
            case 1003: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                startDiscovery(INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.readLong(), parcel.readLong());
                parcel1.writeNoException();
                return true;
            ...
            case 1005: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                startCrossAppDiscoveryRestricted(INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt(), parcel.readLong(), parcel.readLong());
                parcel1.writeNoException();
                return true;
            ...
            case 1007: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                sendConnectionRequest(INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.readString(), parcel.createByteArray(), parcel.readLong());
                parcel1.writeNoException();
                return true;

            case 1008: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                acceptConnectionRequest(INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.createByteArray(), parcel.readLong());
                parcel1.writeNoException();
                return true;

            case 1009: 
                parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionService");
                rejectConnectionRequest(INearbyConnectionCallbacks.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.readLong());
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void acceptConnectionRequest(INearbyConnectionCallbacks inearbyconnectioncallbacks, String s, byte abyte0[], long l)
        throws RemoteException;

    public abstract void clientDisconnecting(long l)
        throws RemoteException;

    public abstract void disconnectFromEndpoint(String s, long l)
        throws RemoteException;

    public abstract String getLocalDeviceId()
        throws RemoteException;

    public abstract String getLocalEndpointId(long l)
        throws RemoteException;

    public abstract void rejectConnectionRequest(INearbyConnectionCallbacks inearbyconnectioncallbacks, String s, long l)
        throws RemoteException;

    public abstract void sendConnectionRequest(INearbyConnectionCallbacks inearbyconnectioncallbacks, String s, String s1, byte abyte0[], long l)
        throws RemoteException;

    public abstract void sendReliableMessage(String as[], byte abyte0[], long l)
        throws RemoteException;

    public abstract void sendUnreliableMessage(String as[], byte abyte0[], long l)
        throws RemoteException;

    public abstract void startAdvertising(INearbyConnectionCallbacks inearbyconnectioncallbacks, String s, AppMetadata appmetadata, long l, long l1)
        throws RemoteException;

    public abstract void startCrossAppDiscoveryRestricted(INearbyConnectionCallbacks inearbyconnectioncallbacks, int i, long l, long l1)
        throws RemoteException;

    public abstract void startDiscovery(INearbyConnectionCallbacks inearbyconnectioncallbacks, String s, long l, long l1)
        throws RemoteException;

    public abstract void stopAdvertising(long l)
        throws RemoteException;

    public abstract void stopAllEndpoints(long l)
        throws RemoteException;

    public abstract void stopCrossAppDiscoveryRestricted(long l)
        throws RemoteException;

    public abstract void stopDiscovery(String s, long l)
        throws RemoteException;
}
