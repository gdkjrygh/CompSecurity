...
//            INearbyMessagesService, PublishRequest, UnpublishRequest, SubscribeRequest, 
//            UnsubscribeRequest, GetPermissionStatusRequest, RegisterStatusCallbackRequest
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (PublishRequest)PublishRequest.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 2: // '\002'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (UnpublishRequest)UnpublishRequest.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (SubscribeRequest)SubscribeRequest.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 4: // '\004'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (UnsubscribeRequest)UnsubscribeRequest.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 7: // '\007'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (GetPermissionStatusRequest)GetPermissionStatusRequest.CREATOR.mParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        if (parcel.readInt() != 0)
        {
            parcel = (RegisterStatusCallbackRequest)RegisterStatusCallbackRequest.CREATOR.mParcel(parcel);
        } else
        {
            parcel = null;
        }
