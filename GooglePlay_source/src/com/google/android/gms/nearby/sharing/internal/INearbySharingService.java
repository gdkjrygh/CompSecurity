...
//            TrustedDevicesRequest, ProvideContentRequest, ReceiveContentRequest, INearbySharingCallback, 
//            StopProvidingContentRequest

public interface INearbySharingService
    extends IInterface
{
        ...
        implements INearbySharingService
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (ProvideContentRequest)ProvideContentRequest.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (StopProvidingContentRequest)StopProvidingContentRequest.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 3: // '\003'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (TrustedDevicesRequest)TrustedDevicesRequest.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 4: // '\004'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (ReceiveContentRequest)ReceiveContentRequest.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 5: // '\005'
                parcel.enforceInterface("com.google.android.gms.nearby.sharing.internal.INearbySharingService");
                resetKeysAndForgetTrustedDevices(INearbySharingCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void addTrustedDevice(TrustedDevicesRequest trusteddevicesrequest)
        throws RemoteException;

    public abstract void provideContent(ProvideContentRequest providecontentrequest)
        throws RemoteException;

    public abstract void registerContentReceiver(ReceiveContentRequest receivecontentrequest)
        throws RemoteException;

    public abstract void resetKeysAndForgetTrustedDevices(INearbySharingCallback inearbysharingcallback)
        throws RemoteException;

    public abstract void stopProvidingContent(StopProvidingContentRequest stopprovidingcontentrequest)
        throws RemoteException;
}
