...
public interface INearbySharingCallback
    extends IInterface
{
        ...
        implements INearbySharingCallback
    {
        ...
        public static INearbySharingCallback asInterface(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof INearbySharingCallback))
            {
                return (INearbySharingCallback)iinterface;
            } else
            {
