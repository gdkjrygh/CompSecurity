...
public interface INearbyBootstrapService
    extends IInterface
{
...
_L1:
    ...
    public abstract void confirm(INearbyBootstrapCallback inearbybootstrapcallback)
        throws RemoteException;

    public abstract void continueWithToken(ContinueConnectRequest continueconnectrequest)
        throws RemoteException;

    public abstract void disableTargetMode(DisableTargetRequest disabletargetrequest)
        throws RemoteException;

    public abstract void disconnect(DisconnectRequest disconnectrequest)
        throws RemoteException;

    public abstract void enableTargetMode(EnableTargetRequest enabletargetrequest)
        throws RemoteException;

    public abstract String getToken()
        throws RemoteException;

    public abstract void securelyConnectToDevice(ConnectRequest connectrequest)
        throws RemoteException;

    public abstract void sendData(SendDataRequest senddatarequest)
        throws RemoteException;

    public abstract void startScanForTargetDevices(StartScanRequest startscanrequest)
        throws RemoteException;

    public abstract void stopScanForTargetDevices(StopScanRequest stopscanrequest)
        throws RemoteException;
}
