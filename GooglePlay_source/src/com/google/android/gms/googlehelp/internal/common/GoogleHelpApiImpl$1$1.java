...
//            SimpleGoogleHelpCallbacks, TogglingData, GoogleHelpApiImpl, IGoogleHelpService

final class cks extends SimpleGoogleHelpCallbacks
{
...
_L9:
    ...
    // Unreferenced inner class com/google/android/gms/googlehelp/internal/common/GoogleHelpApiImpl$1

/* anonymous class */
    final class GoogleHelpApiImpl._cls1 extends GoogleHelpApiImpl.GoogleHelpImpl
    {
            ...
            throws RemoteException
        {
            try
            {
                igooglehelpservice.processGoogleHelpAndPip((GoogleHelp)helpIntent.getParcelableExtra("EXTRA_GOOGLE_HELP"), pip, new GoogleHelpApiImpl._cls1._cls1());
                return;
            }
