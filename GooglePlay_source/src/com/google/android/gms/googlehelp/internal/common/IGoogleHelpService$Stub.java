...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                googlehelp = (GoogleHelp)GoogleHelp.CREATOR.eFromParcel(parcel);
            } else
            {
                googlehelp = null;
            }
            processGoogleHelp(googlehelp, b.asInterface(parcel.readStrongBinder()));
        ...
        case 2: // '\002'
            ...
            if (parcel.readInt() != 0)
            {
                googlehelp1 = (GoogleHelp)GoogleHelp.CREATOR.eFromParcel(parcel);
            } else
            {
                googlehelp1 = null;
            }
            if (parcel.readInt() != 0)
            {
                bitmap1 = (Bitmap)Bitmap.CREATOR.eFromParcel(parcel);
            } else
            {
                bitmap1 = null;
            }
            processGoogleHelpAndPip(googlehelp1, bitmap1, b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                bitmap = (Bitmap)Bitmap.CREATOR.eFromParcel(parcel);
            } else
            {
                bitmap = null;
            }
            processTogglingPip(bitmap, b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            showPipInCallingApp(b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 5: // '\005'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            hidePipInCallingApp(b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            disablePipInCallingApp(b.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
