...
public final class MessageNanoPrinter
{
    ...
    public static String print(MessageNano messagenano)
    {
        ...
        {
            return (new StringBuilder("Error printing proto: ")).append(messagenano.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (MessageNano messagenano)
        {
...
_L3:
        ...
        for (int i = 0; i < l1; i++)
        {
            ...
            if (class2.isArray() && class2.getComponentType() != Byte.TYPE)
            {
                ...
                for (j1 = 0; j1 < l; j1++)
                {
                    print(s1, Array.get(obj1, j1), stringbuffer, stringbuffer1);
                }

            } else
            {
                print(s1, obj1, stringbuffer, stringbuffer1);
            }
        }
...
_L6:
        ...
        print(s2, method.invoke(obj, new Object[0]), stringbuffer, stringbuffer1);
_L7:
        j++;
