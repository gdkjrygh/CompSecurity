...
.method constructor <init>(Ltwitter4j/internal/http/HttpResponse;Ltwitter4j/conf/Configuration;)V
    ...
    invoke-static {v0, v1}, Ltwitter4j/internal/json/z_T4JInternalParseUtil;->getInt(Ljava/lang/String;Ltwitter4j/internal/org/json/JSONObject;)I

    move-result v0

    iput v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizeLimit:I
    ...
    iput v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLength:I
    ...
    iput v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLengthHttps:I
    ...
    iput v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->charactersReservedPerMedia:I
    ...
    iput-object v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizes:Ljava/util/Map;
    ...
    new-instance v4, Ltwitter4j/internal/json/MediaEntityJSONImpl$Size;

    const-string v5, "large"

    invoke-virtual {v2, v5}, Ltwitter4j/internal/org/json/JSONObject;->getJSONObject(Ljava/lang/String;)Ltwitter4j/internal/org/json/JSONObject;

    move-result-object v5

    invoke-direct {v4, v5}, Ltwitter4j/internal/json/MediaEntityJSONImpl$Size;-><init>(Ltwitter4j/internal/org/json/JSONObject;)V
    ...
    invoke-virtual {v2, v0}, Ltwitter4j/internal/org/json/JSONObject;->isNull(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v0}, Ltwitter4j/internal/org/json/JSONObject;->getJSONObject(Ljava/lang/String;)Ltwitter4j/internal/org/json/JSONObject;
    ...
    invoke-direct {v5, v0}, Ltwitter4j/internal/json/MediaEntityJSONImpl$Size;-><init>(Ltwitter4j/internal/org/json/JSONObject;)V
    ...
    invoke-direct {v4, v2}, Ltwitter4j/internal/json/MediaEntityJSONImpl$Size;-><init>(Ltwitter4j/internal/org/json/JSONObject;)V
    ...
    iput-object v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->nonUsernamePaths:[Ljava/lang/String;
    ...
    iput v0, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->maxMediaPerUpload:I
    :try_end_0
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 145
    :cond_1
    instance-of v2, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;
    ...
    .line 147
    :cond_2
    check-cast p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;

    .line 149
    iget v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->charactersReservedPerMedia:I

    iget v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->charactersReservedPerMedia:I
    ...
    iget v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->maxMediaPerUpload:I
    ...
    .line 152
    :cond_4
    iget v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizeLimit:I

    iget v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizeLimit:I
    ...
    .line 153
    :cond_5
    iget v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLength:I

    iget v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLength:I
    ...
    .line 154
    :cond_6
    iget v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLengthHttps:I

    iget v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->shortURLLengthHttps:I
    ...
    iget-object v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->nonUsernamePaths:[Ljava/lang/String;
    ...
    .line 157
    :cond_8
    iget-object v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizes:Ljava/util/Map;

    if-eqz v2, :cond_9

    iget-object v2, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizes:Ljava/util/Map;

    iget-object v3, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizes:Ljava/util/Map;
    ...
    .line 157
    :cond_9
    iget-object v2, p1, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->photoSizes:Ljava/util/Map;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Ltwitter4j/internal/json/TwitterAPIConfigurationJSONImpl;->nonUsernamePaths:[Ljava/lang/String;
