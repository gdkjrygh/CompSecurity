...
.method constructor <init>(Ltwitter4j/conf/Configuration;Ltwitter4j/auth/Authorization;)V
    ...
    const-string v6, "include_entities"

    invoke-direct {v5, v6, v0}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "include_rts"

    invoke-direct {v0, v5, v1}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v6, v7}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;J)V
    ...
    .line 74
    sget-object v1, Ltwitter4j/TwitterImpl;->implicitParamsMap:Ljava/util/Map;
    ...
    .line 76
    :cond_2
    iput-object v0, p0, Ltwitter4j/TwitterImpl;->IMPLICIT_PARAMS:[Ltwitter4j/internal/http/HttpParameter;
...
.method private get(Ljava/lang/String;)Ltwitter4j/internal/http/HttpResponse;
    ...
    invoke-interface {v1}, Ltwitter4j/conf/Configuration;->isMBeanEnabled()Z
    ...
    .line 1911
    iget-object v1, p0, Ltwitter4j/TwitterImpl;->http:Ltwitter4j/internal/http/HttpClientWrapper;

    iget-object v2, p0, Ltwitter4j/TwitterImpl;->auth:Ltwitter4j/auth/Authorization;

    invoke-virtual {v1, v0, v2}, Ltwitter4j/internal/http/HttpClientWrapper;->get(Ljava/lang/String;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    ...
    invoke-virtual {v1, v0, v4}, Ltwitter4j/internal/http/HttpClientWrapper;->get(Ljava/lang/String;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    :try_end_0
    ...
    invoke-direct {p0, v1}, Ltwitter4j/TwitterImpl;->isOk(Ltwitter4j/internal/http/HttpResponse;)Z

    move-result v5

    invoke-virtual {v4, v0, v2, v3, v5}, Ltwitter4j/TwitterAPIMonitor;->methodCalled(Ljava/lang/String;JZ)V
    ...
    invoke-direct {p0, v5}, Ltwitter4j/TwitterImpl;->isOk(Ltwitter4j/internal/http/HttpResponse;)Z
...
.method private get(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;)Ltwitter4j/internal/http/HttpResponse;
    ...
    .line 1929
    iget-object v0, p0, Ltwitter4j/TwitterImpl;->http:Ltwitter4j/internal/http/HttpClientWrapper;
    ...
    invoke-virtual {v0, p1, v1, v2}, Ltwitter4j/internal/http/HttpClientWrapper;->get(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    ...
    invoke-virtual {v0, p1, v1, v4}, Ltwitter4j/internal/http/HttpClientWrapper;->get(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v0}, Ltwitter4j/TwitterImpl;->isOk(Ltwitter4j/internal/http/HttpResponse;)Z

    move-result v4

    invoke-virtual {v1, p1, v2, v3, v4}, Ltwitter4j/TwitterAPIMonitor;->methodCalled(Ljava/lang/String;JZ)V
    ...
    invoke-direct {p0, v4}, Ltwitter4j/TwitterImpl;->isOk(Ltwitter4j/internal/http/HttpResponse;)Z
...
.method private mergeParameters([Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/internal/http/HttpParameter;)[Ltwitter4j/internal/http/HttpParameter;
    ...
    .line 2005
    new-array p1, v2, [Ltwitter4j/internal/http/HttpParameter;
    ...
    new-array p1, v0, [Ltwitter4j/internal/http/HttpParameter;
...
.method private mergeParameters([Ltwitter4j/internal/http/HttpParameter;[Ltwitter4j/internal/http/HttpParameter;)[Ltwitter4j/internal/http/HttpParameter;
    ...
    .line 1988
    new-array p1, v3, [Ltwitter4j/internal/http/HttpParameter;
...
.method private post(Ljava/lang/String;)Ltwitter4j/internal/http/HttpResponse;
    ...
    iget-object v1, p0, Ltwitter4j/TwitterImpl;->IMPLICIT_PARAMS:[Ltwitter4j/internal/http/HttpParameter;

    iget-object v2, p0, Ltwitter4j/TwitterImpl;->auth:Ltwitter4j/auth/Authorization;

    invoke-virtual {v0, p1, v1, v2}, Ltwitter4j/internal/http/HttpClientWrapper;->post(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    ...
    invoke-virtual {v0, p1, v1, v4}, Ltwitter4j/internal/http/HttpClientWrapper;->post(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private varargs updateUserList(Ljava/lang/String;ZLjava/lang/String;[Ltwitter4j/internal/http/HttpParameter;)Ltwitter4j/UserList;
    ...
    invoke-direct {v0, v2, p1}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {v2, v3, v0}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, p3}, Ltwitter4j/internal/http/HttpParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3, v0}, Ltwitter4j/TwitterImpl;->post(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;)Ltwitter4j/internal/http/HttpResponse;

    move-result-object v0

    invoke-interface {v2, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createAUserList(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/UserList;
...
.method public createPlace(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ltwitter4j/GeoLocation;Ljava/lang/String;)Ltwitter4j/Place;
    ...
    invoke-direct {p0, v2, v0}, Ltwitter4j/TwitterImpl;->post(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;)Ltwitter4j/internal/http/HttpResponse;

    move-result-object v0

    invoke-interface {v1, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createPlace(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/Place;
...
.method public getPrivacyPolicy()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Ltwitter4j/internal/http/HttpResponse;->asJSONObject()Ltwitter4j/internal/org/json/JSONObject;
...
.method public getSimilarPlaces(Ltwitter4j/GeoLocation;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ltwitter4j/SimilarPlaces;
    ...
    invoke-direct {p0, v2, v0}, Ltwitter4j/TwitterImpl;->get(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;)Ltwitter4j/internal/http/HttpResponse;

    move-result-object v0

    invoke-interface {v1, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createSimilarPlaces(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/SimilarPlaces;
...
.method public reverseGeoCode(Ltwitter4j/GeoQuery;)Ltwitter4j/ResponseList;
    ...
    invoke-interface {v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createEmptyResponseList()Ltwitter4j/ResponseList;
...
.method public updateAccountSettings(Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ltwitter4j/AccountSettings;
    ...
    invoke-interface {v1, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createAccountSettings(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/AccountSettings;
...
.method public updateProfile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ltwitter4j/User;
    ...
    invoke-interface {v1, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createUser(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/User;
...
.method public updateStatus(Ltwitter4j/StatusUpdate;)Ltwitter4j/Status;
    ...
    invoke-interface {v1, v0}, Ltwitter4j/internal/json/z_T4JInternalFactory;->createStatus(Ltwitter4j/internal/http/HttpResponse;)Ltwitter4j/Status;
