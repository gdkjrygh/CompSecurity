    ...
    implements android.view.View.OnClickListener
{
    ...
    ak(TrackSelector trackselector, LocalTrack localtrack)
    {
        b = trackselector;
        a = localtrack;
        super();
    ...
    {
        if (a.getTrack().track_url != null)
        {
            b.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(a.getTrack().track_url)));
        }
    }
}
