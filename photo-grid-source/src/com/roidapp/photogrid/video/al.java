    ...
    implements android.view.View.OnClickListener
{
    ...
    al(TrackSelector trackselector, LocalTrack localtrack)
    {
        b = trackselector;
        a = localtrack;
        super();
    ...
    {
        if (a.getTrack().license_url != null)
        {
            b.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(a.getTrack().license_url)));
        }
    }
}
