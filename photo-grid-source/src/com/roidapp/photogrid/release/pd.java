...
//            oi, mm, ih, ml, 
//            ie, pe, PhotoGridActivity, pf, 
//            ig, PhotoView, az

public final class pd extends oi
{

    private mm r;

    public pd(Activity activity, ig aig[], ml ml1, PhotoView photoview, mm mm1, az az)
    {
        b = activity;
        c = aig;
        d = ml1;
    ...
    public final void a()
    {
        ...
        f3 = ih.C().S();
        ((ie) (obj)).a((f3 / 100F) * f2, f2 * (f3 / 100F), f);
        d.a(21, 1);
        (new Thread(new pe(this, ((ie) (obj))))).start();
    }
...
_L8:
        ...
        ((ie) (obj)).a(f2, f1, f);
        b(21);
        (new Thread(new pf(this, ((ie) (obj)), i))).start();
        return;
_L2:
        ih.C().b(1.0F);
          goto _L8
