...
//            oi, mm, ih, ml, 
//            ie, PhotoGridActivity, os, ot, 
//            ig, PhotoView, az

public final class or extends oi
{

    private mm r;

    public or(Activity activity, ig aig[], ml ml1, PhotoView photoview, mm mm1, az az)
    {
        b = activity;
        c = aig;
        d = ml1;
    ...
    public final void a()
    {
        ...
        d.a(21, 1);
        (new Thread(new os(this, ((ie) (obj))))).start();
    }
...
_L8:
        ...
        ((ie) (obj)).a(f1, f, f2);
        b(21);
        (new Thread(new ot(this, ((ie) (obj)), i))).start();
        return;
_L2:
        ih.C().b(1.0F);
          goto _L8
