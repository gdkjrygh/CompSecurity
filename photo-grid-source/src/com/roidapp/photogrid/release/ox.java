...
//            oi, mm, ih, ml, 
//            ie, oy, PhotoGridActivity, oz, 
//            ig, PhotoView, az

public final class ox extends oi
{

    private mm r;

    public ox(Activity activity, ig aig[], ml ml1, PhotoView photoview, mm mm1, az az)
    {
        b = activity;
        c = aig;
        d = ml1;
    ...
    public final void a()
    {
        ...
        {
            f3 = (f4 / 100F + 0.009583333F) * f2;
            f2 *= f4 / 100F + 0.009583333F;
        } else
        {
            f3 = (f4 / 100F) * f2;
            f2 *= f4 / 100F;
        ...
        d.a(21, 1);
        (new Thread(new oy(this, ((ie) (obj))))).start();
    }
...
_L8:
        ...
        ((ie) (obj)).a(f1, f, f2);
        b(21);
        (new Thread(new oz(this, ((ie) (obj)), i))).start();
        return;
_L2:
        ih.C().b(1.0F);
          goto _L8
