...
_L11:
        if (flag)
        {
            ...
            obj = new Intent(this, com/roidapp/photogrid/cloud/PGShareActivity);
            ((Intent) (obj)).putExtra("image_path", ((ig) (bundle[0])).n);
            ((Intent) (obj)).putExtra("mode_str", "FromShare");
            ((Intent) (obj)).putExtra("is_video", false);
            ((Intent) (obj)).setFlags(0x4000000);
            ((Intent) (obj)).putExtra("moreThan9", b);
            ((Intent) (obj)).putExtra("shareToSelf", flag1);
            finish();
