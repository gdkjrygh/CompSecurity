...
public final class na extends mm
{

    public na(boolean flag, Activity activity, ig aig[], ml ml1, PhotoView photoview, com.roidapp.photogrid.release.az az1)
    {
        F = flag;
        h = activity;
        this.i = aig;
...
_L19:
        ...
        l.a(20, 0);
        (new Thread(new nb(this, this.j.getLayoutParams().width, this.j.getLayoutParams().height))).start();
        return;
_L4:
        obj = this.i[0].e();
          goto _L22
