...
_L3:
        return true;
        context;
        kc.a(6, a, (new StringBuilder("Error occured when checking if app has permission.  Error: ")).append(context.getMessage()).toString());
        return false;
    }

    public static boolean a(Intent intent)
    {
        return jo.a().e().queryIntentActivities(intent, 0x10000).size() > 0;
    }
    ...
    public static String b(byte abyte0[])
    {
        ...
        {
            kc.a(5, a, (new StringBuilder("Unsupported ISO-8859-1:")).append(abyte0.getMessage()).toString());
            return null;
        }
        return abyte0;
    }
    ...
    public static String c(String s)
    {
        ...
        {
            kc.a(5, a, (new StringBuilder("Cannot encode '")).append(s).append("'").toString());
            return "";
        }
        return s1;
    }
    ...
    public static String d(String s)
    {
        ...
        {
            kc.a(5, a, (new StringBuilder("Cannot decode '")).append(s).append("'").toString());
            return "";
        }
        return s1;
    }
    ...
    public static byte[] e(String s)
    {
        ...
        {
            kc.a(5, a, (new StringBuilder("Unsupported UTF-8: ")).append(s.getMessage()).toString());
            return null;
        }
        return s;
    }
    ...
    public static byte[] f(String s)
    {
        ...
        {
            kc.a(6, a, (new StringBuilder("Unsupported SHA1: ")).append(s.getMessage()).toString());
            return null;
        }
        return s;
    }
