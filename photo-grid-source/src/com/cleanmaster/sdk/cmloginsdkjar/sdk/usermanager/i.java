...
final class i
    implements com.cleanmaster.sdk.cmloginsdkjar.Request.CmProxyRefreshCallback
{

    final CmRawObject a[];
    final UserManagerImpl b;

    i(UserManagerImpl usermanagerimpl, CmRawObject acmrawobject[])
    {
        b = usermanagerimpl;
        a = acmrawobject;
        super();
    ...
    public final void onCompleted(CmRawObject cmrawobject, Response response)
    {
        ...
        if (response.getConnection() != null)
        {
            try
            {
                j = response.getConnection().getResponseCode();
            }
