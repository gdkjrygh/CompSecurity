...
class WebViewLoginMethodHandler extends LoginMethodHandler
{
    ...
    boolean tryAuthorize(final LoginClient.Request request)
    {
        ...
        loginDialog = (new AuthDialogBuilder(((Context) (obj)), request.getApplicationId(), bundle)).setE2E(e2e).setIsRerequest(request.isRerequest()).setOnCompleteListener(_lcls1).build();
