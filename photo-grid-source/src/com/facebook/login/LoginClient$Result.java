    ...
    implements Parcelable
{
    ...
    public static final android.os..Result._cls1 CREATOR = new _cls1();
    final Code code;
    ...
    private Code.loggingValue(Parcel parcel)
    {
        ...
        implements android.os.Parcelable.Creator
    {
        ...
        public final LoginClient.Result createFromParcel(Parcel parcel)
        {
