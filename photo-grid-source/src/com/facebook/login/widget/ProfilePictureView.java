...
_L8:
    ...
    private void parseAttributes(AttributeSet attributeset)
    {
        ...
        setPresetSize(attributeset.getInt(com.facebook.R.styleable.com_facebook_profile_picture_view_preset_size, -1));
        isCropped = attributeset.getBoolean(com.facebook.R.styleable.com_facebook_profile_picture_view_is_cropped, true);
