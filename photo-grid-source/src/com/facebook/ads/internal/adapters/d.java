...
public class d extends BroadcastReceiver
{
    ...
    public void a()
    {
        ...
        intentfilter.addAction((new StringBuilder("com.facebook.ads.interstitial.impression.logged:")).append(a).toString());
        intentfilter.addAction((new StringBuilder("com.facebook.ads.interstitial.displayed:")).append(a).toString());
        intentfilter.addAction((new StringBuilder("com.facebook.ads.interstitial.dismissed:")).append(a).toString());
        intentfilter.addAction((new StringBuilder("com.facebook.ads.interstitial.clicked:")).append(a).toString());
        intentfilter.addAction((new StringBuilder("com.facebook.ads.interstitial.error:")).append(a).toString());
