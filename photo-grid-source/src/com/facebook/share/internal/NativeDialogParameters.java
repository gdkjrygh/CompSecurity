    ...
    public static Bundle create(UUID uuid, ShareContent sharecontent, boolean flag)
    {
        ...
        } else
        {
            ...
            if (sharecontent instanceof ShareOpenGraphContent)
            {
                ...
                try
                {
                    uuid = create(((ShareOpenGraphContent) (sharecontent)), ShareInternalUtility.removeNamespacesFromOGJsonObject(ShareInternalUtility.toJSONObjectForCall(uuid, shareopengraphaction), false), flag);
                }
