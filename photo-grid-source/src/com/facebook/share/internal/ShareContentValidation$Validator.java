...
class <init>
{
    ...
    {
        ShareContentValidation.access$300(sharelinkcontent, this);
    }

    public void validate(ShareOpenGraphAction shareopengraphaction)
    {
        ShareContentValidation.access$700(shareopengraphaction, this);
    }

    public void validate(ShareOpenGraphContent shareopengraphcontent)
    {
        isOpenGraphContent = true;
        ShareContentValidation.access$600(shareopengraphcontent, this);
    }

    public void validate(ShareOpenGraphObject shareopengraphobject)
    {
        ShareContentValidation.access$800(shareopengraphobject, this);
    }

    public void validate(ShareOpenGraphValueContainer shareopengraphvaluecontainer, boolean flag)
    {
        ShareContentValidation.access$900(shareopengraphvaluecontainer, this, flag);
    }

    public void validate(SharePhoto sharephoto)
    {
        ShareContentValidation.access$1000(sharephoto, this);
    }

    public void validate(SharePhotoContent sharephotocontent)
    {
        ShareContentValidation.access$400(sharephotocontent, this);
    }

    public void validate(ShareVideo sharevideo)
    {
        ShareContentValidation.access$1100(sharevideo, this);
    }

    public void validate(ShareVideoContent sharevideocontent)
    {
        ShareContentValidation.access$500(sharevideocontent, this);
    }
