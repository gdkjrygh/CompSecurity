    ...
    implements Sharer
{
    ...
    protected final void registerCallbackImpl(CallbackManagerImpl callbackmanagerimpl, FacebookCallback facebookcallback)
    {
        ShareInternalUtility.registerSharerCallback(getRequestCode(), callbackmanagerimpl, facebookcallback);
    }

    public final void setShouldFailOnDataError(boolean flag)
    {
    ...
    private class NativeHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
    {
        ...
        public AppCall createAppCall(final ShareContent content)
        {
            ...
            DialogPresenter.setupAppCallForNativeDialog(appCall, new _cls1(), MessageDialog.getFeature(content.getClass()));
            return appCall;
        }
