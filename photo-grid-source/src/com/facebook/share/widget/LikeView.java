...
public class LikeView extends FrameLayout
{
    ...
    private void parseAttributes(AttributeSet attributeset)
    {
        if (attributeset != null && getContext() != null)
        {
            ...
            {
                objectId = Utility.coerceValueIfNullOrEmpty(attributeset.getString(com.facebook.R.styleable.com_facebook_like_view_object_id), null);
                objectType = ObjectType.fromInt(attributeset.getInt(com.facebook.R.styleable.com_facebook_like_view_object_type, ObjectType.DEFAULT.getValue()));
                likeViewStyle = Style.fromInt(attributeset.getInt(com.facebook.R.styleable.com_facebook_like_view_style, Style.DEFAULT.getValue()));
                if (likeViewStyle == null)
                {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
                }
                auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(attributeset.getInt(com.facebook.R.styleable.com_facebook_like_view_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                if (auxiliaryViewPosition == null)
                {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
                }
                horizontalAlignment = HorizontalAlignment.fromInt(attributeset.getInt(com.facebook.R.styleable.com_facebook_like_view_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                if (horizontalAlignment == null)
                {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
                } else
                {
                    foregroundColor = attributeset.getColor(com.facebook.R.styleable.com_facebook_like_view_foreground_color, -1);
    ...
    {
        if (likeActionController == null) goto _L2; else goto _L1
_L1:
        if (parentFragment != null) goto _L4; else goto _L3
_L3:
