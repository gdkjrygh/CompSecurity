...
public class AccessibilityServiceInfoCompat
{
    ...
    private class AccessibilityServiceInfoVersionImpl
    {
    ...
    private class AccessibilityServiceInfoJellyBeanMr2 extends AccessibilityServiceInfoIcsImpl
    {
        private class AccessibilityServiceInfoIcsImpl extends AccessibilityServiceInfoStubImpl
        {
            private class AccessibilityServiceInfoStubImpl
