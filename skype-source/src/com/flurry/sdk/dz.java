    ...
    implements dq.a, fb.a
{
    ...
    private dz()
    {
        ...
        eo.a(4, c, (new StringBuilder("initSettings, LocationCriteria = ")).append(j).toString());
        b = ((Boolean)dq1.a("ReportLocation")).booleanValue();
        dq1.a("ReportLocation", this);
        eo.a(4, c, (new StringBuilder("initSettings, ReportLocation = ")).append(b).toString());
    }
    ...
    private String k()
    {
        ...
        eo.a(4, c, (new StringBuilder("provider = ")).append(((String) (obj))).toString());
        return ((String) (obj));
    }
    ...
    public void a(String s, Object obj)
    {
        ...
        {
            j = (Criteria)obj;
            eo.a(4, c, (new StringBuilder("onSettingUpdate, LocationCriteria = ")).append(j).toString());
            if (a)
            {
                j();
            }
        ...
        if (s.equals("ReportLocation"))
        {
            ...
            eo.a(4, c, (new StringBuilder("onSettingUpdate, ReportLocation = ")).append(b).toString());
            if (b)
            {
                if (!a && n > 0)
                {
...
_L3:
    ...
    public Location f()
    {
        ...
        eo.a(4, c, (new StringBuilder("getLocation() = ")).append(location).toString());
        return location;
    }
