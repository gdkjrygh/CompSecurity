...
_L3:
        eo.a(4, d, (new StringBuilder("Trying to delete persistence file : ")).append(file.getAbsolutePath()).toString());
        flag = file.delete();
...
_L4:
        ...
        int j = abyte0.length;
        s = dataoutputstream;
        eo.a(4, d, (new StringBuilder("write iter ")).append(i).append(" dataLength = ").append(j).toString());
        s = dataoutputstream;
...
_L6:
        ...
        datainputstream = datainputstream1;
        eo.a(4, d, (new StringBuilder("read iter ")).append(i).append(" dataLength = ").append(k).toString());
        datainputstream = datainputstream1;
        abyte0 = new byte[k];
        datainputstream = datainputstream1;
...
_L9:
        datainputstream = datainputstream1;
        eo.a(6, d, "Error when loading persistent file", throwable);
        fe.a(datainputstream1);
          goto _L7
        s;
        throw s;
...
_L1:
        eo.a(4, d, (new StringBuilder("discardOutdatedBlocksForDataKey: notSentBlocks = ")).append(list.size()).toString());
        int i = 0;
_L3:
        if (i >= list.size())
        {
        ...
        b(s1);
        eo.a(4, d, (new StringBuilder("discardOutdatedBlocksForDataKey: removed block = ")).append(s1).toString());
        i++;
