...
public class df
{
    ...
    public boolean a(byte abyte0[])
    {
        ...
        eo.a(4, d, (new StringBuilder("Writing FlurryDataSenderBlockInfo: ")).append(e.getAbsolutePath()).toString());
        boolean flag2 = fd.a(e);
        if (!flag2)
        {
            fe.a(null);
            return false;
...
_L1:
        eo.a(4, d, (new StringBuilder("Reading FlurryDataSenderBlockInfo: ")).append(e.getAbsolutePath()).toString());
