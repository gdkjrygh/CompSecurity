    ...
    implements dq.a, Thread.UncaughtExceptionHandler
{
    ...
    private void d()
    {
        ...
        eo.a(4, a, (new StringBuilder("initSettings, CrashReportingEnabled = ")).append(d).toString());
        String s = (String)dq1.a("VersionName");
        dq1.a("VersionName", this);
        eb.a(s);
        eo.a(4, a, (new StringBuilder("initSettings, VersionName = ")).append(s).toString());
    }
    ...
    public void a(String s, Object obj)
    {
        if (s.equals("CaptureUncaughtExceptions"))
        {
            ...
            eo.a(4, a, (new StringBuilder("onSettingUpdate, CrashReportingEnabled = ")).append(d).toString());
            return;
        }
        if (s.equals("VersionName"))
        {
            s = (String)obj;
            eb.a(s);
            eo.a(4, a, (new StringBuilder("onSettingUpdate, VersionName = ")).append(s).toString());
            return;
        } else
        {
    ...
    public void a(String s, String s1, Map map)
    {
        ...
        if (((Map) (obj)).size() >= 10)
        {
            eo.d(a, (new StringBuilder("MaxOriginParams exceeded: ")).append(((Map) (obj)).size()).toString());
            return;
        }
        ...
        synchronized (c)
        {
            ...
            eo.d(a, (new StringBuilder("MaxOrigins exceeded: ")).append(c.size()).toString());
        }
        return;
        s;
        s1;
