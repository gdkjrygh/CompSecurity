...
public final class dx
{
    ...
    public static PackageInfo a(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                eo.a(a, (new StringBuilder("Cannot find package info for package: ")).append(context.getPackageName()).toString());
                return null;
            }
        }
        return packageinfo;
    ...
    public static ApplicationInfo b(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                eo.a(a, (new StringBuilder("Cannot find application info for package: ")).append(context.getPackageName()).toString());
                return null;
            }
        }
