    ...
    implements eu
{
    ...
    protected void a(String s, String s1, int i)
    {
        a(((ff) (new ff(s, s1) {
            ...
            public void a()
            {
                if (!c.f.a(a, b))
                {
                    eo.a(6, c.d, (new StringBuilder("Internal error. Block wasn't deleted with id = ")).append(a).toString());
                }
                if (!c.e.remove(a))
                {
                    eo.a(6, c.d, (new StringBuilder("Internal error. Block with id = ")).append(a).append(" was not in progress state").toString());
                }
            }
    ...
    {
        eo.a(4, d, (new StringBuilder("onNetworkStateChanged : isNetworkEnable = ")).append(flag).toString());
        if (flag)
        {
            d();
        }
    ...
    protected void a(byte abyte0[], String s, String s1, a a1)
    {
        ...
        {
            eo.a(6, d, "Report that has to be sent is EMPTY or NULL");
            return;
        } else
        {
            c(abyte0, s, s1);
    ...
    protected void c(String s, String s1)
    {
        if (!f.a(s, s1))
        {
            eo.a(6, d, (new StringBuilder("Internal error. Block wasn't deleted with id = ")).append(s).toString());
        }
        if (!e.remove(s))
        {
            eo.a(6, d, (new StringBuilder("Internal error. Block with id = ")).append(s).append(" was not in progress state").toString());
        }
    }

    protected void c(byte abyte0[], String s, String s1)
    {
        a(new ff(abyte0, s, s1) {
    ...
    protected void f()
    {
        if (ev.a().c()) goto _L2; else goto _L1
_L1:
        eo.a(5, d, "Reports were not sent! No Internet connection!");
_L4:
        return;
_L2:
        Object obj;
        ...
        {
            eo.a(4, d, "No more reports to send.");
            return;
        }
...
_L5:
        ...
        int i;
        list = f.c(s);
        eo.a(4, d, (new StringBuilder("Number of not sent blocks = ")).append(list.size()).toString());
        i = 0;
_L9:
...
_L8:
        ...
        if (abyte0 == null || abyte0.length == 0)
        {
            eo.a(6, d, "Internal ERROR! Report is empty!");
            f.a(s1, s);
        } else
        {
            e.add(s1);
