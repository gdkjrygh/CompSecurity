...
_L1:
        ...
        public final SQLiteDatabase getWritableDatabase()
        {
            ...
            {
                w.a(a).a();
                a.g("Opening the database failed, dropping the table and recreating it");
                Object obj = w.b(a);
    ...
    private final a c;
    private final k d = new k(l());
    private final k e = new k(l());
...
_L3:
    ...
    static String b(w w1)
    {
        return w1.F();
    }

    private Map b(String s1)
    {
...
_L4:
    ...
    public final long a(long l, String s1, String s2)
    {
        y.a(s1);
        y.a(s2);
        B();
...
_L1:
        ...
        obj = obj1;
        ((List) (obj2)).add(new c(this, b(s1), l1, m.e(s2), l, j));
        obj = obj1;
...
_L5:
    ...
    public final void a(long l, String s1)
    {
        y.a(s1);
        B();
        s.r();
        int j = E().delete("properties", "app_uid=? AND cid<>?", new String[] {
            String.valueOf(l), s1
        });
        if (j > 0)
        {
    ...
    public final void a(c c1)
    {
        ...
        Object obj1 = c1.b().entrySet().iterator();
        do
        {
        ...
        {
            n().a(c1, "Hit length exceeds the maximum allowed size");
            return;
        }
        int j = ((Integer)al.f.a()).intValue();
        l = D();
        if (l > (long)(j - 1))
        {
            obj1 = c((l - (long)j) + 1L);
    ...
    public final void a(u u1)
    {
        ...
        ((ContentValues) (obj1)).put("app_uid", Long.valueOf(u1.a()));
        ((ContentValues) (obj1)).put("cid", u1.b());
        ((ContentValues) (obj1)).put("tid", u1.c());
        int j;
        if (u1.d())
        {
            j = 1;
        ...
        ((ContentValues) (obj1)).put("hits_count", Long.valueOf(u1.e()));
    ...
    public final int f()
    {
        ...
        } else
        {
            ...
            int j = E().delete("hits2", "hit_time < ?", new String[] {
...
_L2:
        if (((List) (obj1)).size() >= j)
        {
            f("Sending hits to too many properties. Campaign report might be incorrect");
        }
        if (obj != null)
        {
            ((Cursor) (obj)).close();
        ...
        return ((List) (obj1));
_L4:
        ((List) (obj1)).add(new u(s1, s2, flag, l, map));
        if (true) goto _L6; else goto _L5
_L5:
