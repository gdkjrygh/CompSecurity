    ...
    implements fh.a
{
        ...
        throws JSONException, InterruptedException, ExecutionException
    {
        ...
        ha ha1 = fh1.a(jsonobject, "app_icon", true, a);
        fh1 = fh1.a(jsonobject);
        ArrayList arraylist = new ArrayList();
        for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext(); arraylist.add(((ha)((Iterator) (obj)).next()).get())) { }
        return new d(jsonobject.getString("headline"), arraylist, jsonobject.getString("body"), (bk)ha1.get(), jsonobject.getString("call_to_action"), jsonobject.optDouble("rating", -1D), jsonobject.optString("store"), jsonobject.optString("price"), (a)fh1.get(), new Bundle());
    }
}
