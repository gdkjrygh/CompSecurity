...
public final class fq
{
    ...
    private static long b(Map map, String s1)
    {
        ...
        com.google.android.gms.ads.internal.util.client.b.c((new StringBuilder("Could not parse float from ")).append(s1).append(" header: ").append(map).toString());
        return -1L;
    }
    ...
    public final void a(Map map)
    {
        ...
        if (obj != null && !((List) (obj)).isEmpty())
        {
            ...
            {
                m = com.google.android.gms.ads.internal.p.g().b();
            } else
            if ("landscape".equalsIgnoreCase(((String) (obj))))
            {
                m = com.google.android.gms.ads.internal.p.g().a();
            }
        }
