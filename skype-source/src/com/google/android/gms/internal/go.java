...
_L11:
        ...
        {
            com.google.android.gms.ads.internal.util.client.b.b("Can not create dialog without Activity Context");
            return;
        }
        obj = b;
...
_L14:
        ...
        builder.setPositiveButton("Share", new android.content.DialogInterface.OnClickListener(((String) (obj))) {
            ...
            {
                go.a(b).startActivity(Intent.createChooser((new Intent("android.intent.action.SEND")).setType("text/plain").putExtra("android.intent.extra.TEXT", a), "Share via"));
            }
