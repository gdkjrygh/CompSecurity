...
public final class ge
{
    ...
    private static boolean a(Context context)
    {
        ...
        if (i == 0)
        {
            com.google.android.gms.ads.internal.util.client.b.b("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
            return false;
        }
        ...
        {
            com.google.android.gms.ads.internal.util.client.b.c("Fail to fetch AdActivity theme");
            com.google.android.gms.ads.internal.util.client.b.b("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
            return false;
        }
        return false;
