...
public final class lc
{
    ...
    public static String a(lb lb1)
    {
        ...
        try
        {
            a(null, lb1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (lb lb1)
        {
            return (new StringBuilder("Error printing proto: ")).append(lb1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (lb lb1)
        {
...
_L1:
        if (!(obj instanceof lb)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
