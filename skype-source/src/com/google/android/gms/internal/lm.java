...
_L12:
        ia1 = new ProtocolVersion("HTTP", 1, 1);
...
_L11:
        ia1 = new BasicHttpResponse(new BasicStatusLine(ia1, map.getResponseCode(), map.getResponseMessage()));
        ia1.setEntity(a(((HttpURLConnection) (map))));
        ...
        do
        {
            ...
            {
                ia1.addHeader(new BasicHeader((String)entry.getKey(), (String)((List)entry.getValue()).get(0)));
            }
        } while (true);
        return ia1;
    }
