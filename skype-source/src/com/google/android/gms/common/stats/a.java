    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(ConnectionEvent connectionevent, Parcel parcel)
    {
        ...
        b.a(parcel, 4, connectionevent.c());
        b.a(parcel, 5, connectionevent.d());
        b.a(parcel, 6, connectionevent.e());
        b.a(parcel, 7, connectionevent.f());
        b.a(parcel, 8, connectionevent.g());
        b.a(parcel, 10, connectionevent.j());
        b.a(parcel, 11, connectionevent.i());
        b.a(parcel, 12, connectionevent.b());
        b.a(parcel, 13, connectionevent.h());
        b.a(parcel, i);
    }
    ...
    public final Object createFromParcel(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < k)
            {
                ...
                case 2: // '\002'
                    l3 = com.google.android.gms.common.internal.safeparcel.a.g(parcel, l);
                    break;
