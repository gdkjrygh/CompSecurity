...
public class InstanceIDListenerService extends Service
{
    ...
    public InstanceIDListenerService()
    {
        b = new MessengerCompat(new Handler(Looper.getMainLooper()) {
            ...
            {
                com.google.android.gms.iid.InstanceIDListenerService.a(a, message, com.google.android.gms.iid.MessengerCompat.a(message));
            }
    ...
    static void a(Context context, e e1)
    {
        e1.b();
    ...
    {
        com.google.android.gms.iid.d.a(instanceidlistenerservice);
        instanceidlistenerservice.getPackageManager();
        if (i != d.c && i != d.b)
        {
            Log.w("InstanceID", (new StringBuilder("Message from unexpected caller ")).append(i).append(" mine=").append(d.b).append(" appid=").append(d.c).toString());
            return;
        } else
        {
...
_L3:
        ...
        if ("PING".equals(obj1))
        {
            try
            {
                com.google.android.gms.gcm.a.a(this).a(f, com.google.android.gms.iid.d.a(), intent.getExtras());
                return;
            }
