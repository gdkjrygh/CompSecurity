...
public static final class value extends Enum
{
    ...
    public static final value CAPABILITY_MIXED;
    ...
    {
        return (WRAPPER_UNKNOWN_VALUE)Enum.valueOf(com/skype/Contact$CAPABILITYSTATUS, s);
    }
    ...
    static 
    {
        ...
        CAPABILITY_MIXED = new <init>("CAPABILITY_MIXED", 1, 1);
        CAPABILITY_EXISTS = new <init>("CAPABILITY_EXISTS", 2, 2);
