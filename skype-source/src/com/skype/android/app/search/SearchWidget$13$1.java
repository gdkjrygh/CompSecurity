...
final class al extends PendingKeyboardDismissal
{
    ...
    protected final void proceed()
    {
        ...
        SearchWidget.access$000(_fld0).getConversation(val$objectId, conversationimpl);
    ...
    // Unreferenced inner class com/skype/android/app/search/SearchWidget$13

/* anonymous class */
    final class SearchWidget._cls13
        implements OnUserEventListener
    {
        ...
        public final void onItemClick(com.skype.android.app.data.DataAdapter.ItemViewHolder itemviewholder, int i, Object obj)
        {
            ...
            (SearchWidget.access$800(SearchWidget.this). new SearchWidget._cls13._cls1(SearchWidget.access$900(SearchWidget.this), i)).hideKeyboardAndProceed();
        }
