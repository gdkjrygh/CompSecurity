...
final class this._cls0 extends ProxyEventListener
{
    ...
    final tactsSearchCompleted this$0;

    public final void onEvent(OnPromotedSCDContactsSearchCompleted onpromotedscdcontactssearchcompleted)
    {
        ((SearchWidget)tTarget()).onEvent(onpromotedscdcontactssearchcompleted);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((OnPromotedSCDContactsSearchCompleted)obj);
    }

    tactsSearchCompleted(Proxy proxy, Class class1, LifecycleState lifecyclestate, EventThread eventthread)
    {
