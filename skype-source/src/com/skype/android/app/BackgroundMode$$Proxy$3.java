...
final class nit> extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.rtyChange rtychange)
    {
        ((BackgroundMode)tTarget()).onEvent(rtychange);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.rtyChange)obj);
    }
