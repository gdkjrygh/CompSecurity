...
//            MediaPhotoViewerActivity, OnMediaDocumentLinkStatusChange
...
final class this._cls0 extends ProxyEventListener
{
    ...
    {
        ((MediaPhotoViewerActivity)tTarget()).onEvent(onmediadocumentlinkstatuschange);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((OnMediaDocumentLinkStatusChange)obj);
    }
