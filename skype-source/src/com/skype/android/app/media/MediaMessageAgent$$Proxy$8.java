...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.oxy._cls8 _pcls8)
    {
        ((MediaMessageAgent)tTarget()).onEvent(_pcls8);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.oxy._cls8.onEvent)obj);
    }
