...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.iesChanged ieschanged)
    {
        ((ContactProfileActivity)tTarget()).onEvent(ieschanged);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.iesChanged)obj);
    }
