...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen..Proxy._cls1 _pcls1)
    {
        ((ContactDirectorySearchActivity)tTarget()).onEvent(_pcls1);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen..Proxy._cls1.onEvent)obj);
    }
