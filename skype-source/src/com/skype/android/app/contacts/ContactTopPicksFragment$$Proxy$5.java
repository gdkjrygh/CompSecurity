...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen..Proxy._cls5 _pcls5)
    {
        ((ContactTopPicksFragment)tTarget()).onEvent(_pcls5);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen..Proxy._cls5.onEvent)obj);
    }
