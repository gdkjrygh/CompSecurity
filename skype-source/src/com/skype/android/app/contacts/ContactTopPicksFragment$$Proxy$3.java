...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.earance earance)
    {
        ((ContactTopPicksFragment)tTarget()).onEvent(earance);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.earance)obj);
    }
