...
final class this._cls0
    implements android.view.ialActivity._cls3
{
...
_L2:
        ...
        if (android.os.Interpolator >= 16)
        {
            skypeLogo.animate().withEndAction(new Runnable() {

                final HubMaterialActivity._cls3 this$1;
                ...
                public final void run()
                {
                    ...
                    if (HubMaterialActivity.access$000(this$0) != null)
                    {
                        HubMaterialActivity.access$000(this$0).cancel();
                    }
                    HubMaterialActivity.access$002(this$0, ObjectAnimator.ofPropertyValuesHolder(skypeLogo, new PropertyValuesHolder[] {
                        propertyvaluesholder, propertyvaluesholder1
                    }));
                    HubMaterialActivity.access$000(this$0).setInterpolator(new AccelerateDecelerateInterpolator());
                    HubMaterialActivity.access$000(this$0).setRepeatMode(2);
                    HubMaterialActivity.access$000(this$0).setRepeatCount(-1);
                    HubMaterialActivity.access$000(this$0).setDuration(500L);
                    HubMaterialActivity.access$000(this$0).start();
                }

            
            {
                this$1 = HubMaterialActivity._cls3.this;
                super();
            }
            });
            return true;
