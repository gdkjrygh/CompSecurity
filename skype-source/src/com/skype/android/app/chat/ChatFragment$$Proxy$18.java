...
final class  extends ProxyEventListener
{
    ...
    final rorEvent this$0;

    public final void onEvent(OnMediaSaveToGalleryErrorEvent onmediasavetogalleryerrorevent)
    {
        ((ChatFragment)Target()).onEvent(onmediasavetogalleryerrorevent);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((OnMediaSaveToGalleryErrorEvent)obj);
    }

    rorEvent(Proxy proxy, Class class1, LifecycleState lifecyclestate, EventThread eventthread)
    {
