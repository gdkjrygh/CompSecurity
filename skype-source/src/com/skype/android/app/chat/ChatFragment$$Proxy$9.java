...
final class > extends ProxyEventListener
{
    ...
    {
        ((ChatFragment)tTarget()).onEvent(onmediadefaultlinkupdate);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((OnMediaDefaultLinkUpdate)obj);
    }

    ate(Proxy proxy, Class class1, LifecycleState lifecyclestate, EventThread eventthread)
    {
