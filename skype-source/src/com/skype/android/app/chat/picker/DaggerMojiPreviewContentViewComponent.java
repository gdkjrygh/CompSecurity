...
//            MojiPreviewContentViewComponent, MojiPreviewContentView

public final class DaggerMojiPreviewContentViewComponent
    implements MojiPreviewContentViewComponent
{
    public static final class Builder
    {
        ...
        public final MojiPreviewContentViewComponent build()
        {
            ...
            {
                return new DaggerMojiPreviewContentViewComponent(this);
            }
        }
    ...
    private DaggerMojiPreviewContentViewComponent(Builder builder1)
    {
    ...
    public final void inject(MojiPreviewContentView mojipreviewcontentview)
    {
        MembersInjectors.a().injectMembers(mojipreviewcontentview);
    }

    static 
    {
        boolean flag;
        if (!com/skype/android/app/chat/picker/DaggerMojiPreviewContentViewComponent.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
