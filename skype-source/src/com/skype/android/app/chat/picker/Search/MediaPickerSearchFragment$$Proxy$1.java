...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.atusChange atuschange)
    {
        ((MediaPickerSearchFragment)tTarget()).onEvent(atuschange);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.atusChange)obj);
    }

    Q(Proxy proxy, Class class1, LifecycleState lifecyclestate, EventThread eventthread)
    {
