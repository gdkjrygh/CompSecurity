...
final class  extends ProxyEventListener
{
    ...
    {
        ((ChatFragment)Target()).onEvent(onmediadownloadcriticalerror);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((OnMediaDownloadCriticalError)obj);
    }

    lError(Proxy proxy, Class class1, LifecycleState lifecyclestate, EventThread eventthread)
    {
