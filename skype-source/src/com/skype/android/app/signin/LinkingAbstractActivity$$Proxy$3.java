...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.nkResult nkresult)
    {
        ((LinkingAbstractActivity)tTarget()).onEvent(nkresult);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.nkResult)obj);
    }
