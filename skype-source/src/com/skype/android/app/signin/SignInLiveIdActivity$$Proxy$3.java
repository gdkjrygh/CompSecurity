...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.foResult foresult)
    {
        ((SignInLiveIdActivity)tTarget()).onEvent(foresult);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.foResult)obj);
    }
