...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.ger..Proxy._cls3 _pcls3)
    {
        ((PromotedSCDContactsManager)tTarget()).onEvent(_pcls3);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.ger..Proxy._cls3.onEvent)obj);
    }
