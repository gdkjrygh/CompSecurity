...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.util.cache.this._cls0 _pcls0)
    {
        ((CallHistoryMaterialFragment)tTarget()).onEvent(_pcls0);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.util.cache.onEvent)obj);
    }
