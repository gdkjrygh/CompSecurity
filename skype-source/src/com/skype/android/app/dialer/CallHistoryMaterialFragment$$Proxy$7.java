...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.roxy._cls7 _pcls7)
    {
        ((CallHistoryMaterialFragment)tTarget()).onEvent(_pcls7);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.roxy._cls7.onEvent)obj);
    }
