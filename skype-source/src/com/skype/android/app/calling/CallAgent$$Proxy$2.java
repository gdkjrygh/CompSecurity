...
final class > extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.r.OnPropertyChange onpropertychange)
    {
        ((CallAgent)tTarget()).onEvent(onpropertychange);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.r.OnPropertyChange)obj);
    }
