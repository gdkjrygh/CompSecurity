...
final class this._cls0 extends ProxyEventListener
{
    ...
    public final void onEvent(com.skype.android.gen.estResult estresult)
    {
        ((PreCallActivity)tTarget()).onEvent(estresult);
    }

    public final volatile void onEvent(Object obj)
    {
        onEvent((com.skype.android.gen.estResult)obj);
    }
