...
//            UiAnimationControlsStateAdapter, VideoCallNoControls, VideoCallAnimatingControls, RosterFragmentDisplayed, 
//            AudioCallAnimatingControls, ChatFragmentDisplayed, CallControlsStateContext, CallControlsState

public class VideoCallHidingControls extends UiAnimationControlsStateAdapter
{

    public VideoCallHidingControls(CallControlsStateContext callcontrolsstatecontext)
    {
        super(callcontrolsstatecontext, new VideoCallNoControls(callcontrolsstatecontext));
    }
    ...
    public CallControlsState onConfirmedCallViewTap(CallActivity callactivity, InCallFragment incallfragment)
    {
        VideoCallAnimatingControls videocallanimatingcontrols = new VideoCallAnimatingControls(getContext());
        callactivity.cancelCallControlsTimeout(true);
        incallfragment.showControls(true, videocallanimatingcontrols);
        incallfragment.hideUnmuteButton();
        callactivity.getSupportActionBar().g();
        return videocallanimatingcontrols;
    }
