...
public class SendUnreadConversationCountCommand extends NodeCompletionWearCommand
{

    private final int unreadCount;

    public SendUnreadConversationCountCommand(int i)
    {
        unreadCount = i;
    }
    ...
    {
        WearMessageApiUtils.sendToAllNodes(c, RemoteDeviceCapabilities.WEAR_REMOTE_CONTROL_CAPABILITY, com.skype.android.app.wear.RemoteDeviceCapabilities.RemoteCommands.UPDATE_RECENT_COUNT_COMMAND.getCommandPath(new Object[] {
