...
public final class ActivityModule_SupportFragmentManagerFactory
    implements Factory
{
    ...
    public final l get()
    {
        l l = module.supportFragmentManager();
        if (l == null)
        {
    ...
    {
        boolean flag;
        if (!com/skype/android/inject/ActivityModule_SupportFragmentManagerFactory.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
