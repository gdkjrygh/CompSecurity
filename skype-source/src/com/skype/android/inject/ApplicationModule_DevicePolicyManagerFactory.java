...
public final class ApplicationModule_DevicePolicyManagerFactory
    implements Factory
{
    ...
    {
        DevicePolicyManager devicepolicymanager = module.devicePolicyManager();
    ...
    {
        boolean flag;
        if (!com/skype/android/inject/ApplicationModule_DevicePolicyManagerFactory.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
