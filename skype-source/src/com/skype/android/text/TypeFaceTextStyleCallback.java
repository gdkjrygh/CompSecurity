...
//            TextStyleCallback, TypeFacedSpan, TypeFaceFactory

public class TypeFaceTextStyleCallback
    implements TextStyleCallback
{
    private static abstract class a extends Enum
    {
        ...
        {
            return (a)Enum.valueOf(com/skype/android/text/TypeFaceTextStyleCallback$a, s);
        }
        ...
        public abstract View a(TypeFaceFactory typefacefactory, String s, Context context, AttributeSet attributeset);
...
_L2:
    ...
    public final View a(String s, Context context, AttributeSet attributeset)
    {
        a aa[] = a.values();
        int j = aa.length;
        for (int i = 0; i < j; i++)
        {
            ...
            if (a1.a(s))
            {
                return a1.a(a, s, context, attributeset);
            }
        }
    ...
    public final void a(Menu menu)
    {
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            if (charsequence != null && !(charsequence instanceof SpannableStringBuilder))
            {
                ...
                spannablestringbuilder.setSpan(new TypeFacedSpan(a), 0, spannablestringbuilder.length(), 33);
