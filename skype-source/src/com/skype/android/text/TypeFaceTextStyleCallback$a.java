...
private static abstract class <init> extends Enum
{
    ...
    {
        return (<init>)Enum.valueOf(com/skype/android/text/TypeFaceTextStyleCallback$a, s);
    }
    ...
    static 
    {
        a = new TypeFaceTextStyleCallback.a("TEXTVIEW") {
...
_L2:
    ...
    private _cls1.b(String s)
    {
        super(s, 0);
    }

    _cls1.b(String s, byte byte0)
    {
        this(s);
    }
}
