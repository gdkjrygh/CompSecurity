    ...
    implements Interpolator
{
    ...
    public BezierEasingInterpolator(float f1, float f2, float f3, float f4, long l)
    {
        h = (new StringBuilder()).append(com/skype/android/animation/BezierEasingInterpolator.getSimpleName()).append(' ').append('[').append(f1).append(',').append(f2).append(',').append(f3).append(',').append(f4).append(']').toString();
        a = 1.0F / (0.2F * (float)l);
        b = 3F * f1;
        c = (f3 - f1) * 3F - b;
        d = 1.0F - b - c;
