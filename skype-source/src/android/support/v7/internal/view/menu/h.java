    ...
    implements b
{
    ...
    private int k;
    private f l;
    private android.support.v7.internal.view.menu.o m;
    private Runnable n;
    ...
    public final b a(android.support.v4.view.k.e e1)
    {
        t = e1;
        return this;
    }
    ...
    public final void a(android.support.v7.internal.view.menu.o o1)
    {
        m = o1;
        o1.setHeaderTitle(getTitle());
    }
...
_L5:
    ...
    {
        while (!n() || t != null && !t.onMenuItemActionExpand(this)) 
        {
            return false;
        }
        return l.a(this);
    ...
    public final Drawable getIcon()
    {
        ...
        if (k != 0)
        {
            Drawable drawable = android.support.v7.internal.widget.o.a(l.e(), k);
            k = 0;
            j = drawable;
            return drawable;
        } else
