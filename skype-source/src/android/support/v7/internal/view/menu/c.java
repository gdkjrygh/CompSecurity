...
abstract class c extends d
{
    ...
    final MenuItem a(MenuItem menuitem)
    {
        if (menuitem instanceof b)
        {
            ...
            if (menuitem1 == null)
            {
                menuitem = MenuWrapperFactory.wrapSupportMenuItem(a, b1);
                c.put(b1, menuitem);
            }
            return menuitem;
        } else
    ...
    final SubMenu a(SubMenu submenu)
    {
        ...
        {
            android.support.v4.internal.view.c c1 = (android.support.v4.internal.view.c)submenu;
            if (d == null)
            {
                d = new a();
            }
            ...
            if (submenu1 == null)
            {
                submenu = MenuWrapperFactory.wrapSupportSubMenu(a, c1);
                d.put(c1, submenu);
            }
            return submenu;
        } else
