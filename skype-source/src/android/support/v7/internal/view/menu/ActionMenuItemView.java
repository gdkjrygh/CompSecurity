...
{
    private final class a extends android.support.v7.widget.j.b
    {
    ...
    private Drawable c;
    private f.b d;
    private android.support.v7.widget.j.b e;
    private b f;
    private boolean g;
    private boolean h;
    private int i;
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int l)
    {
        ...
        g = resources.getBoolean(android.support.v7.appcompat.a.b.abc_config_allowActionMenuItemTextWithIcon);
        context = context.obtainStyledAttributes(attributeset, android.support.v7.appcompat.a.k.ActionMenuItemView, l, 0);
        i = context.getDimensionPixelSize(android.support.v7.appcompat.a.k.ActionMenuItemView_android_minWidth, 0);
        context.recycle();
        k = (int)(32F * resources.getDisplayMetrics().density + 0.5F);
...
label0:
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        g = getContext().getResources().getBoolean(android.support.v7.appcompat.a.b.abc_config_allowActionMenuItemTextWithIcon);
        f();
    }
