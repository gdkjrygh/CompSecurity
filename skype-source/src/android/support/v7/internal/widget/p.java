...
public final class p
{
    ...
    private p(Context context, TypedArray typedarray)
    {
        a = context;
        b = typedarray;
    }

    public static p a(Context context, AttributeSet attributeset, int ai[])
    {
        return new p(context, context.obtainStyledAttributes(attributeset, ai));
    }

    public static p a(Context context, AttributeSet attributeset, int ai[], int i)
    {
        return new p(context, context.obtainStyledAttributes(attributeset, ai, i, 0));
    }
