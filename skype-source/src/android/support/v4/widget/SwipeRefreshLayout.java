    ...
    implements n, p
{
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeset)
    {
        ...
        G = 64F * ((DisplayMetrics) (context)).density;
        h = G;
        j = new q(this);
        k = new o(this);
    ...
    private static float a(MotionEvent motionevent, int i1)
    {
        ...
        {
            return android.support.v4.view.m.d(motionevent, i1);
        }
    }
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (android.support.v4.view.m.b(motionevent, i1) == s)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            s = android.support.v4.view.m.b(motionevent, i1);
        }
    }
...
_L4:
        A.c((-0.25F + 0.4F * f4 + 2.0F * f5) * 0.5F);
        a((i1 + j1) - n, true);
        return;
_L2:
...
_L3:
    ...
    private boolean c()
    {
        ...
        if (!(d instanceof AbsListView)) goto _L2; else goto _L1
_L1:
...
_L4:
        return false;
_L2:
        if (android.support.v4.view.x.b(d, -1) || d.getScrollY() > 0) goto _L3; else goto _L5
_L5:
        return false;
...
_L4:
        float f1;
        a(b - x.getTop(), true);
        s = android.support.v4.view.m.b(motionevent, 0);
        r = false;
        f1 = a(motionevent, s);
    ...
    protected void onLayout(boolean flag, int i1, int j1, int k1, int l1)
    {
        ...
        if (getChildCount() != 0)
        {
            ...
            if (d != null)
            {
                ...
                k1 = getPaddingLeft();
                l1 = getPaddingTop();
                view.layout(k1, l1, k1 + (i1 - getPaddingLeft() - getPaddingRight()), l1 + (j1 - getPaddingTop() - getPaddingBottom()));
...
_L6:
        i1 = android.support.v4.view.m.a(motionevent, s);
        if (i1 < 0)
        {
            Log.e(c, "Got ACTION_MOVE event but have an invalid active pointer id.");
            return false;
        }
        float f1 = (android.support.v4.view.m.d(motionevent, i1) - p) * 0.5F;
        if (r)
        {
            if (f1 <= 0.0F)
            {
        ...
        continue; /* Loop/switch isn't completed */
_L7:
        s = android.support.v4.view.m.b(motionevent, android.support.v4.view.m.b(motionevent));
        continue; /* Loop/switch isn't completed */
_L8:
        a(motionevent);
...
_L5:
        ...
        {
            float f2 = android.support.v4.view.m.d(motionevent, android.support.v4.view.m.a(motionevent, s));
            float f3 = p;
            r = false;
            c((f2 - f3) * 0.5F);
            s = -1;
...
_L9:
    ...
    public void setSize(int i1)
    {
        ...
        if (i1 == 0)
        {
            int j1 = (int)(56F * displaymetrics.density);
            I = j1;
            J = j1;
        } else
        {
            int k1 = (int)(40F * displaymetrics.density);
            I = k1;
            J = k1;
        }
