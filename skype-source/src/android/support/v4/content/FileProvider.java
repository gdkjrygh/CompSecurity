...
public class FileProvider extends ContentProvider
{
        ...
        implements a
    {
        ...
        public final Uri a(File file)
        {
            ...
            if (file == null)
            {
                throw new IllegalArgumentException((new StringBuilder("Failed to find configured root that contains ")).append(s1).toString());
            }
    ...
    private static a getPathStrategy(Context context, String s)
    {
        ...
        a1 = parsePathStrategy(context, s);
        sCache.put(s, a1);
        hashmap;
    ...
    {
        return getPathStrategy(context, s).a(file);
    }
    ...
    private static a parsePathStrategy(Context context, String s)
...
_L6:
    ...
    {
        return !mStrategy.a(uri).delete() ? 0 : 1;
    }
    ...
    {
        return ParcelFileDescriptor.open(mStrategy.a(uri), modeToMode(s));
    }
