    ...
    implements android.content.DialogInterface.OnCancelListener, android.content.DialogInterface.OnDismissListener
{
    ...
    void dismissInternal(boolean flag)
    {
        ...
        if (mBackStackId >= 0)
        {
            getFragmentManager().b(mBackStackId);
            mBackStackId = -1;
            return;
        }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle)
    {
        ...
        {
            return (LayoutInflater)mHost.b.getSystemService("layout_inflater");
        }
    }
    ...
    public void show(l l1, String s)
    {
        mDismissed = false;
        mShownByMe = true;
        l1 = l1.a();
