...
final class af
{
    ...
    static RemoteInput[] a(RemoteInputCompatBase.RemoteInput aremoteinput[])
    {
...
_L2:
        ...
        do
        {
            ...
            aremoteinput2[i] = (new android.app.RemoteInput.Builder(remoteinput.a())).setLabel(remoteinput.b()).setChoices(remoteinput.c()).setAllowFreeFormInput(remoteinput.d()).addExtras(remoteinput.e()).build();
            i++;
        } while (true);
