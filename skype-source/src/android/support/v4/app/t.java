...
public final class t
{
        ...
        implements a
    {
        ...
        {
            String s = android.support.v4.app.t.b(activity);
            if (s == null)
            {
                return null;
            }
            ...
            try
            {
                if (android.support.v4.app.t.b(activity, componentname) == null)
                {
                    return android.support.v4.content.b.a(componentname);
                }
