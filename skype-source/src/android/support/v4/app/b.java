...
final class android.support.v4.app.b
{
    ...
    private static SharedElementCallback a(a a1)
    {
        b b1 = null;
        if (a1 != null)
        {
    ...
    {
        activity.setEnterSharedElementCallback(a(a1));
    }

    public static void b(Activity activity, a a1)
    {
        activity.setExitSharedElementCallback(a(a1));
    }
}
