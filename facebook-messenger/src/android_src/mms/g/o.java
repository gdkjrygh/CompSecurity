...
public final class o
{
    ...
    public static int a(Context context, ContentResolver contentresolver, Uri uri, String s, String as[])
    {
        int i;
        try
        {
        ...
        {
            b.d("SqliteWrapper", "Catch a SQLiteException when delete: ", contentresolver);
            a(context, ((SQLiteException) (contentresolver)));
            return -1;
        }
        return i;
