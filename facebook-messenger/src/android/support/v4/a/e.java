...
_L2:
        if (i < ag.length)
        {
            ...
            {
                ((h)((g) (obj)).b.get(j)).b.onReceive(a, ((g) (obj)).a);
            }
...
_L5:
        ...
        Log.v("LocalBroadcastManager", (new StringBuilder()).append("Matching against filter ").append(((h) (obj)).a).toString());
...
_L9:
        Log.v("LocalBroadcastManager", "  Filter's target already added");
          goto _L10
_L8:
        k = ((h) (obj)).a.match(s, s1, s2, uri, set, "LocalBroadcastManager");
