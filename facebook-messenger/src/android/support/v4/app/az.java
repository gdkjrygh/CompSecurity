...
class az
{
    ...
    public az(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
    ...
    public void a(CharSequence charsequence, boolean flag, CharSequence charsequence1, Bitmap bitmap)
    {
