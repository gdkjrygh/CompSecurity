...
public class b
{
    ...
    static void a(b b1, OperationResult operationresult, String s)
    {
        b1.a(operationresult, s);
    }

    static void a(b b1, ServiceException serviceexception, String s)
    {
        b1.a(serviceexception, s);
    }

    public void a(ThreadSummary threadsummary)
    {
        String s = threadsummary.a();
        MarkThreadParams markthreadparams = new MarkThreadParams(s, ai.ARCHIVED, true, threadsummary.c());
        Bundle bundle = new Bundle();
        bundle.putParcelable("markThreadParams", markthreadparams);
        i.a(b.a(aq.p, bundle).a(), new c(this, s));
