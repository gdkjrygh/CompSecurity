...
_L2:
        ...
        obj1 = obj;
        if (!propertyvaluebuffer.assignParameter(settablebeanproperty.getPropertyIndex(), obj3))
        {
...
_L1:
        ...
        if (!propertyvaluebuffer.assignParameter(((SettableBeanProperty) (obj)).getPropertyIndex(), obj1)) goto _L4; else goto _L3
_L3:
        obj = jsonparser.nextToken();
        obj1 = propertybasedcreator.build(deserializationcontext, propertyvaluebuffer);
