...
_L5:
    ...
    {
        return (ObjectIdInfo)fromMemberAnnotation(new _cls5());
    }

    public com.fasterxml.jackson.databind.AnnotationIntrospector.ReferenceProperty findReferenceType()
    {
        return (com.fasterxml.jackson.databind.AnnotationIntrospector.ReferenceProperty)fromMemberAnnotation(new _cls2());
    }

    public Class[] findViews()
    {
        return (Class[])fromMemberAnnotation(new _cls1());
    }

    protected Object fromMemberAnnotation(WithMember withmember)
    {
        Object obj;
        Object obj1;
        Object obj3;
...
_L6:
    ...
    {
        Boolean boolean1 = (Boolean)fromMemberAnnotation(new _cls4());
        return boolean1 != null && boolean1.booleanValue();
    }

    public boolean isTypeId()
    {
        Boolean boolean1 = (Boolean)fromMemberAnnotation(new _cls3());
        return boolean1 != null && boolean1.booleanValue();
    }
