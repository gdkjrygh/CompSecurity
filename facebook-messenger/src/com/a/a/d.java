...
label0:
    ...
    {
        for (Iterator iterator = e.iterator(); iterator.hasNext(); ((j)iterator.next()).a.a(obj)) { }
    }
    ...
    public void b()
    {
        ...
        if (a != null)
        {
            ...
            for (Iterator iterator = ((ArrayList) (obj)).iterator(); iterator.hasNext(); ((b)iterator.next()).c(this)) { }
        } else
        {
            obj = null;
        }
...
_L4:
        if (obj != null)
        {
            for (obj = ((ArrayList) (obj)).iterator(); ((Iterator) (obj)).hasNext(); ((b)((Iterator) (obj)).next()).b(this)) { }
        }
...
_L3:
    ...
    public void c()
    {
        ...
        if (e())
        {
            ...
            if (a != null)
            {
                for (Iterator iterator2 = ((ArrayList)a.clone()).iterator(); iterator2.hasNext(); ((b)iterator2.next()).b(this)) { }
            }
            i = false;
        }
    }
    ...
    {
        ArrayList arraylist = new ArrayList();
        for (Iterator iterator = e.iterator(); iterator.hasNext(); arraylist.add(((j)iterator.next()).a)) { }
        return arraylist;
    }
