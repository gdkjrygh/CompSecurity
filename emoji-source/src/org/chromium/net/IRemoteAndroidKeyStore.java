    ...
    extends IInterface
{
        ...
        implements IRemoteAndroidKeyStore
    {
        ...
        public static IRemoteAndroidKeyStore asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("org.chromium.net.IRemoteAndroidKeyStore");
...
_L1:
    ...
    public abstract String getClientCertificateAlias()
        throws RemoteException;

    public abstract byte[] getDSAKeyParamQ(int i)
        throws RemoteException;

    public abstract byte[] getECKeyOrder(int i)
        throws RemoteException;

    public abstract byte[] getEncodedCertificateChain(String s)
        throws RemoteException;

    public abstract byte[] getPrivateKeyEncodedBytes(int i)
        throws RemoteException;

    public abstract int getPrivateKeyHandle(String s)
        throws RemoteException;

    public abstract int getPrivateKeyType(int i)
        throws RemoteException;

    public abstract byte[] getRSAKeyModulus(int i)
        throws RemoteException;

    public abstract byte[] rawSignDigestWithPrivateKey(int i, byte abyte0[])
        throws RemoteException;

    public abstract void releaseKey(int i)
        throws RemoteException;

    public abstract void setClientCallbacks(IRemoteAndroidKeyStoreCallbacks iremoteandroidkeystorecallbacks)
        throws RemoteException;
}
