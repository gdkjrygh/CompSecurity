    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            ontainerViewAtCreation.removeView(val$zoomer);
            ontainerViewAtCreation.invalidate();
        } else
...
/* anonymous class */
        ...
        implements PopupZoomer.OnVisibilityChangedListener
    {
        ...
        {
            mContainerViewAtCreation.post(popupzoomer. new ContentViewCore._cls5._cls2());
        }

        public void onPopupZoomerShown(final PopupZoomer zoomer)
        {
            mContainerViewAtCreation.post(new ContentViewCore._cls5._cls1());
        }
        ...
        // Unreferenced inner class org/chromium/content/browser/ContentViewCore$5$1

/* anonymous class */
        class ContentViewCore._cls5._cls1
            implements Runnable
        {
