    ...
    implements android.content.
{
    ...
    public boolean onKey(DialogInterface dialoginterface, int i, KeyEvent keyevent)
    {
        if (i == 4)
        {
            XWalkLaunchScreenManager.access$300(_fld0);
            XWalkLaunchScreenManager.access$000(_fld0).onBackPressed();
        }
        return true;
    }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        // Unreferenced inner class org/xwalk/core/internal/XWalkLaunchScreenManager$1$2

/* anonymous class */
        class XWalkLaunchScreenManager._cls1._cls2 extends OrientationEventListener
        {
