        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (buttonLabels.length() > 0)
            {
                try
                {
                    builder.setNegativeButton(buttonLabels.getString(0), promptInput. new Notification._cls4._cls1());
                }
            ...
            if (buttonLabels.length() > 2)
            {
                try
                {
                    builder.setPositiveButton(buttonLabels.getString(2), new Notification._cls4._cls3());
                }
...
_L2:
        ...
        // Unreferenced inner class org/apache/cordova/dialogs/Notification$4$3

/* anonymous class */
        class Notification._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
