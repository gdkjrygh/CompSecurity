    ...
    implements Runnable
{
    ...
    public void run()
    {
        ((com.facebook.widget.tsDialogBuilder)(new com.facebook.widget.tsDialogBuilder(val$me.cordova.getActivity(), Session.getActiveSession(), ConnectPlugin.access$500(ConnectPlugin.this))).setOnCompleteListener(val$dialogCallback)).build().show();
    }
