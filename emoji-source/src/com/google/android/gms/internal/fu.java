        ...
        implements fu
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                a(com.google.android.gms.internal.fv.a.B(parcel.readStrongBinder()), parcel.readString(), (fr[])parcel.createTypedArray(fr.CREATOR));
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                a(com.google.android.gms.internal.fv.a.B(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                b(com.google.android.gms.internal.fv.a.B(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 4: // '\004'
                parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                fv = com.google.android.gms.internal.fv.a.B(parcel.readStrongBinder());
                break;
            }
            boolean flag;
            if (parcel.readInt() != 0)
...
_L1:
    ...
    public abstract void a(fv fv)
        throws RemoteException;

    public abstract void a(fv fv, String s, fr afr[])
        throws RemoteException;

    public abstract void a(fv fv, boolean flag)
        throws RemoteException;

    public abstract void b(fv fv)
        throws RemoteException;
}
