        ...
        implements IBrailleServiceCallback
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = (BrailleDisplayProperties)BrailleDisplayProperties.CREATOR.createFromParcel(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (BrailleInputEvent)BrailleInputEvent.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel = null;
            }
