...
_L1:
    ...
    public static IBrailleService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.googlecode.eyesfree.braille.display.IBrailleService");
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            boolean flag = registerCallback(ck.Stub.asInterface(parcel.readStrongBinder()));
