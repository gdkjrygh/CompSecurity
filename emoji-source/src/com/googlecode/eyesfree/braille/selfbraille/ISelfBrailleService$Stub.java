...
_L1:
    ...
    public static ISelfBrailleService asInterface(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.googlecode.eyesfree.braille.selfbraille.ISelfBrailleService");
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (WriteData)WriteData.CREATOR.FromParcel(parcel);
            } else
            {
                parcel = null;
            }
