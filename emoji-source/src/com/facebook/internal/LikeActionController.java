...
public class LikeActionController
{
    ...
    private static LikeActionController deserializeFromDiskSynchronously(Context context1, String s)
    {
        ...
        inputstream = inputstream2;
        inputstream1 = s1;
        inputstream2 = controllerDiskCache.get(s);
        s = obj;
        ...
        s1 = Utility.readStreamToString(inputstream2);
        s = obj;
        inputstream = inputstream2;
        inputstream1 = inputstream2;
        ...
        inputstream = inputstream2;
        inputstream1 = inputstream2;
        s = deserializeFromJson(context1, s1);
        context1 = s;
        if (inputstream2 != null)
        {
...
_L1:
    ...
    public static boolean handleOnActivityResult(Context context1, int i, int j, Intent intent)
    {
        ...
        if (uuid != null)
        {
            ...
            if (!Utility.isNullOrEmpty(objectIdForPendingController))
            {
                getControllerForObjectId(context1, objectIdForPendingController, new CreationCallback(i, j, intent, uuid) {
...
_L3:
    ...
    private static void registerSessionBroadcastReceivers(Context context1)
    {
        ...
        context1.registerReceiver(new BroadcastReceiver() {
