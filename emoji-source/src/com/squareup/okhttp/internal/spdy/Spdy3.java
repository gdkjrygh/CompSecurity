    ...
    implements Variant
{
        ...
        implements FrameReader
    {
        ...
        private void readHeaders(FrameReader.Handler handler, int i, int j)
            throws IOException
        {
            handler.headers(false, false, in.readInt() & 0x7fffffff, -1, -1, nameValueBlockReader.readNameValueBlock(j - 4), HeadersMode.SPDY_HEADERS);
        }
        ...
        {
            int k = in.readInt();
            List list = nameValueBlockReader.readNameValueBlock(j - 4);
            boolean flag;
            if ((i & 1) != 0)
            {
                flag = true;
            ...
            throws IOException
        {
            ...
            List list = nameValueBlockReader.readNameValueBlock(j - 10);
            boolean flag;
            boolean flag1;
            if ((i & 1) != 0)
            {
