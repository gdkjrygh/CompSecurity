    ...
    implements Runnable
{
    ...
    public void run()
    {
        SocialSharing.access$600(_fld0, msg, SocialSharing.access$500(_fld0));
    }
...
_L13:
    ...
    // Unreferenced inner class nl/xservices/plugins/SocialSharing$2$1

/* anonymous class */
    class SocialSharing._cls2._cls1 extends TimerTask
    {
        ...
        public void run()
        {
            cordova.getActivity().runOnUiThread(new SocialSharing._cls2._cls1._cls1());
        }
