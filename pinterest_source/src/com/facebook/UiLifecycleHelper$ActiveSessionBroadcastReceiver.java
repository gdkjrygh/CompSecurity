...
class <init> extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        if ("com.facebook.sdk.ACTIVE_SESSION_SET".equals(intent.getAction()))
        {
            ...
            if (context != null && UiLifecycleHelper.access$100(UiLifecycleHelper.this) != null)
            {
                context.addCallback(UiLifecycleHelper.access$100(UiLifecycleHelper.this));
            }
        } else
        if ("com.facebook.sdk.ACTIVE_SESSION_UNSET".equals(intent.getAction()))
        {
            ...
            if (context != null && UiLifecycleHelper.access$100(UiLifecycleHelper.this) != null)
            {
                context.removeCallback(UiLifecycleHelper.access$100(UiLifecycleHelper.this));
                return;
            }
        }
    }
