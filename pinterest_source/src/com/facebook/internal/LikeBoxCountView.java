...
public class LikeBoxCountView extends FrameLayout
{
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        _cls1..SwitchMap.com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition[caretPosition.ordinal()];
...
_L6:
    ...
    public void setCaretPosition(LikeBoxCountViewCaretPosition likeboxcountviewcaretposition)
    {
        ...
        switch (_cls1..SwitchMap.com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition[likeboxcountviewcaretposition.ordinal()])
        {
        default:
            return;
    ...
    private class _cls1
    {
        ...
        static final int $SwitchMap$com$facebook$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition[];

        static 
        {
            $SwitchMap$com$facebook$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition = new int[LikeBoxCountViewCaretPosition.values().length];
            try
            {
