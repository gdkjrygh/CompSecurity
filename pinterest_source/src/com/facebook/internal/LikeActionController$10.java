    ...
    implements com.facebook.oller._cls10
{
    ...
    {
        LikeActionController.access$1902(LikeActionController.this, val$objectIdRequest.verifiedObjectId);
        if (Utility.isNullOrEmpty(LikeActionController.access$1900(LikeActionController.this)))
        {
            LikeActionController.access$1902(LikeActionController.this, val$pageIdRequest.verifiedObjectId);
            LikeActionController.access$2502(LikeActionController.this, val$pageIdRequest.objectIsPage);
        }
        if (Utility.isNullOrEmpty(LikeActionController.access$1900(LikeActionController.this)))
        {
            Logger.log(LoggingBehavior.DEVELOPER_ERRORS, LikeActionController.access$1500(), "Unable to verify the FB id for '%s'. Verify that it is a valid FB object or page", new Object[] {
