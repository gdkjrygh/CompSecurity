...
public final class cw extends ct
{
    ...
    public cw(String s, bv bv, c c1, String s1)
    {
        super(bA.c, bv, c1, c(s, s1));
    }
    ...
    public final String b()
    {
        ...
        hashmap.put("device_info", com.paypal.android.sdk.d.a(bY.a().toString()));
        hashmap.put("app_info", com.paypal.android.sdk.d.a(bV.a().toString()));
