...
public final class cs extends ct
{
    ...
    public cs(bv bv, c c1, String s, String s1, ca ca1, String s2, String s3, 
            boolean flag, String s4, boolean flag1, String s5)
    {
        this(bv, c1, s, s1, ca1, flag, s4, flag1, s5);
        m = s2;
        n = s3;
    }

    public cs(bv bv, c c1, String s, String s1, ca ca1, boolean flag, String s2, 
            boolean flag1, String s3)
    {
        super(bA.d, bv, c1, c(s, s1));
        a = ca1;
        b = flag;
        j = s2;
        k = flag1;
    ...
    public final String b()
    {
        ...
        if (j != null && j.equals("token"))
        {
            ...
            if (!com.paypal.android.sdk.d.b(l))
            {
                hashmap.put("scope", l);
            }
        }
        hashmap.put("risk_data", com.paypal.android.sdk.d.a(ac.a().b().toString()));
        if (m != null)
        {
        ...
        if (a.a())
        {
            ...
            hashmap.put("email", com.paypal.android.sdk.d.a(a.b()));
            hashmap.put("password", com.paypal.android.sdk.d.a(a.c()));
        } else
        {
            hashmap.put("grant_type", "password");
            a.d().c();
            hashmap.put("phone", com.paypal.android.sdk.d.a((new StringBuilder("+")).append(a.d().c()).append(" ").append(a.d().a()).toString()));
            hashmap.put("pin", a.e());
        }
        hashmap.put("remember_me", "true");
        hashmap.put("device_name", com.paypal.android.sdk.d.a(Build.DEVICE));
        hashmap.put("redirect_uri", com.paypal.android.sdk.d.a("urn:ietf:wg:oauth:2.0:oob"));
