...
//            az, PayPalTouchActivity, PayPalOAuthScopes, PayPalConfiguration

final class aN extends az
{

    aN(Intent intent, PayPalConfiguration paypalconfiguration)
    {
...
_L3:
        if (!U.a((String)((Iterator) (obj)).next())) goto _L6; else goto _L5
_L5:
        boolean flag = false;
_L7:
        if (flag)
