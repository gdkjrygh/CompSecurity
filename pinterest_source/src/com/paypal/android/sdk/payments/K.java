...
final class K
{
    ...
    K(Context context, J j)
    {
        d = new ScrollView(context);
        d.setBackgroundColor(bw.d);
...
_L1:
        j = null;
_L7:
        webview.loadData(stringbuilder.append(j).append("</body><html>").toString(), "text/html; charset=UTF-8", null);
        webview.setClickable(true);
        linearlayout.addView(webview);
        bx.a(webview, -1, -2);
        bx.b(webview, null, null, null, "10dip");
        c = new Button(context);
        linearlayout.addView(c);
        bx.a(c, context);
        bx.b(c, null, "20dip", null, "4dip");
        a = d;
        return;
_L2:
        String s2 = cF.a(cH.am);
        String s1 = Locale.getDefault().getCountry().toLowerCase(Locale.US);
        j = s1;
        if (com.paypal.android.sdk.d.b(s1))
        {
            j = "us";
        }
    ...
    "nl", "de", "it", "fr", "gb", "us"
        ...
        {
            j = String.format("https://www.paypal.com/%s/webapps/mpp/ua/useragreement-full", new Object[] {
                j
            });
        } else
        {
...
_L3:
        ...
        continue; /* Loop/switch isn't completed */
_L4:
        j = String.format(cF.a(cH.aH), new Object[] {
            cF.a(cH.aG)
        });
        continue; /* Loop/switch isn't completed */
_L5:
