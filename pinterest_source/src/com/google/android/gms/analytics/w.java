    ...
    implements ak, c.b, c.c
{
    ...
    w(Context context, f f1, d d1, GoogleAnalytics googleanalytics)
    {
...
_L2:
        ...
        _cls2.zw[zi.ordinal()];
        JVM INSTR tableswitch 1 7: default 358
    //                   1 108
    //                   2 216
    //                   3 358
    //                   4 358
...
_L4:
        ...
        {
            d1 = (d)zm.poll();
            ae.V((new StringBuilder("Sending hit to store  ")).append(d1).toString());
        }
...
_L10:
        d d2;
        d2 = (d)zm.peek();
        ae.V((new StringBuilder("Sending hit to service   ")).append(d2).toString());
...
_L1:
        ae.W((new StringBuilder("Service unavailable (code=")).append(k).append("), will retry.").toString());
        eG();
_L4:
        this;
        JVM INSTR monitorexit ;
        return;
_L2:
        ae.W((new StringBuilder("Service unavailable (code=")).append(k).append("), using local store.").toString());
        eE();
