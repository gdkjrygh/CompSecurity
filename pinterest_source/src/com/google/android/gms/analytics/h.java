...
_L1:
        ae.W((new StringBuilder("Request too long (> ")).append(Math.min(yi, yj)).append(" bytes)--not sent").toString());
_L4:
        return true;
_L2:
...
_L8:
        ...
        {
            ae.W((new StringBuilder("Exception sending hit: ")).append(s.getClass().getSimpleName()).toString());
            ae.W(s.getMessage());
            return false;
        }
        if (httphost == null)
...
_L9:
        ...
        {
            ae.T((new StringBuilder("Unexpected IOException: ")).append(s.getMessage()).toString());
            ae.T("Request will be discarded");
            return true;
        }
          goto _L9
        ae.W((new StringBuilder("Bad response: ")).append(s.getStatusLine().getStatusCode()).toString());
        return true;
    }
...
_L19:
        ...
        if (l2 <= (long)yj) goto _L8; else goto _L7
_L7:
        _cls1.yv[j.ordinal()];
...
_L9:
        ...
        i1 = 1;
_L17:
        if (i1 >= ((List) (obj2)).size()) goto _L8; else goto _L15
_L15:
