...
public class GoogleAnalytics extends TrackerHandler
{
    ...
    private void eZ()
    {
        if (!Bm)
        {
            ...
            {
                ae.V((new StringBuilder("PackageManager doesn't know about package: ")).append(obj).toString());
                obj = null;
            }
            if (obj == null)
            {
    ...
    void a(aa aa1)
    {
        ...
        {
            ya = aa1.eP();
            ae.V((new StringBuilder("app name loaded: ")).append(ya).toString());
        }
        if (aa1.eQ())
        {
            yb = aa1.eR();
            ae.V((new StringBuilder("app version loaded: ")).append(yb).toString());
        }
        if (aa1.eS())
        {
            int i = ai(aa1.eT());
            if (i >= 0)
            {
                ae.V((new StringBuilder("log level loaded: ")).append(i).toString());
