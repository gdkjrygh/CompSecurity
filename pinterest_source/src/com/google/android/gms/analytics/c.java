    ...
    implements b
{
    ...
    public void a(Map map, long l, String s, List list)
    {
        ...
        {
            ae.T((new StringBuilder("sendHit failed: ")).append(map).toString());
        }
    }
    ...
    public void connect()
    {
        ...
        } else
        {
            ...
            ae.V((new StringBuilder("connect: bindService returned ")).append(flag).append(" for ").append(intent).toString());
            if (!flag)
            {
                xV = null;
                xX.a(1, null);
    ...
    public void dQ()
    {
        ...
        {
            ae.T((new StringBuilder("clear hits failed: ")).append(remoteexception).toString());
        }
    }
        ...
        implements ServiceConnection
    {
        ...
        {
            ae.V((new StringBuilder("service connected, binder: ")).append(ibinder).toString());
            try
            {
        ...
        {
            ae.V((new StringBuilder("service disconnected: ")).append(componentname).toString());
            com.google.android.gms.analytics.c.a(xZ, null);
