    ...
    implements d
{
    ...
    private void a(Map map, long l1, String s)
    {
        ...
        sqlitedatabase = al("Error opening database for putHit");
...
label0:
    ...
    private void fh()
    {
        ...
        {
            List list = G(i);
            ae.V((new StringBuilder("Store full, deleting ")).append(list.size()).append(" hits to make room.").toString());
...
_L6:
        obj = obj1;
        ae.W((new StringBuilder("Error in peekHits fetching hitIds: ")).append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
...
_L4:
        ...
        obj1 = obj3;
_L17:
        ae.W((new StringBuilder("Error in peekHits fetching hitIds: ")).append(((SQLiteException) (obj2)).getMessage()).toString());
        obj2 = obj;
...
_L15:
        obj1 = obj;
        ae.W((new StringBuilder("Error in peekHits fetching hitString: ")).append(((SQLiteException) (obj2)).getMessage()).toString());
        obj1 = obj;
        obj2 = new ArrayList();
        obj1 = obj;
...
_L11:
        ...
        j = i;
        obj1 = obj;
        if (TextUtils.isEmpty(((ab) (obj4)).fa()))
        {
            if (i != 0)
            {
                break; /* Loop/switch isn't completed */
...
_L3:
        ...
        return;
        sqliteexception;
        ae.W((new StringBuilder("Error deleting hits ")).append(TextUtils.join(",", as)).toString());
        return;
    }
    ...
    public void dispatch()
    {
        ...
        i = BU.a(list, BW, flag);
        ae.V((new StringBuilder("sent ")).append(i).append(" of ").append(list.size()).append(" hits").toString());
