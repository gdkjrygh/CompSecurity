            ...
            if (obj instanceof qt)
            {
                ...
                if (aze != null && ((qt) (obj)).aze != null)
                {
                    ...
                    if (azd == ((qt) (obj)).azd)
                    {
                        ...
                        {
                            return Arrays.equals((byte[])aze, (byte[])((qt) (obj)).aze);
                        }
                        if (aze instanceof int[])
                        {
                            return Arrays.equals((int[])aze, (int[])((qt) (obj)).aze);
                        }
                        if (aze instanceof long[])
                        {
                            return Arrays.equals((long[])aze, (long[])((qt) (obj)).aze);
                        }
                        if (aze instanceof float[])
                        {
                            return Arrays.equals((float[])aze, (float[])((qt) (obj)).aze);
                        }
                        if (aze instanceof double[])
                        {
                            return Arrays.equals((double[])aze, (double[])((qt) (obj)).aze);
                        }
                        if (aze instanceof boolean[])
                        {
                            return Arrays.equals((boolean[])aze, (boolean[])((qt) (obj)).aze);
                        } else
                        {
                            return Arrays.deepEquals((Object[])aze, (Object[])((qt) (obj)).aze);
                        }
                    }
                } else
                {
