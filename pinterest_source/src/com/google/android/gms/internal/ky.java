    ...
    implements SafeParcelable
{
        ...
        if (!kv1.b(((Class) (obj))))
        {
            ...
            do
            {
                ...
                if (class1 != null)
                {
                    ...
                    {
                        throw new IllegalStateException((new StringBuilder("Could not instantiate an object of type ")).append(kr1.hS().getCanonicalName()).toString(), kv1);
                    }
                    // Misplaced declaration of an exception variable
                    catch (kv kv1)
                    {
                        throw new IllegalStateException((new StringBuilder("Could not access object of type ")).append(kr1.hS().getCanonicalName()).toString(), kv1);
                    }
                }
            } while (true);
        }
    ...
    private void a(StringBuilder stringbuilder, kr.a a1, Parcel parcel, int i)
    {
        ...
        {
        default:
            throw new IllegalArgumentException((new StringBuilder("Unknown field out type = ")).append(a1.hJ()).toString());
...
_L4:
    ...
    kv id()
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Invalid creation type: ")).append(Ob).toString());
