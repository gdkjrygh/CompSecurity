...
_L1:
    ...
    private class b extends nh.a
    {
        ...
        private class c extends jl.b
        {
            ...
            protected final void a(com.google.android.gms.location.c.b b1)
            {
label0:
                {
label1:
                    {
                        if (b1 != null)
                        {
                            ...
                            {
                            default:
                                Log.wtf("LocationClientImpl", (new StringBuilder("Unsupported action: ")).append(ahf).toString());
                                break;
        ...
        private class a extends jl.b
        {
            ...
            protected final void a(com.google.android.gms.location.c.a a1)
            {
                if (a1 != null)
                {
                    a1.a(Iv, aha);
