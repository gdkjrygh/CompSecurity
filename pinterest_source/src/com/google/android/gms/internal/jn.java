    ...
    implements android.os.Handler.Callback
{
    ...
    public final boolean a(String s, jl.f f)
    {
        HashMap hashmap = Nf;
        hashmap;
...
_L6:
    ...
    public final void b(String s, jl.f f)
    {
        HashMap hashmap = Nf;
        hashmap;
        JVM INSTR monitorenter ;
    ...
    private class a
    {
        ...
        public final void a(jl.f f)
        {
            Ni.add(f);
        }

        public final void b(jl.f f)
        {
            Ni.remove(f);
        }

        public final boolean c(jl.f f)
        {
