    ...
    implements GoogleApiClient
{
    ...
    public com.google.android.gms.common.api.c(Context context, Looper looper, jg jg1, Map map, Set set, Set set1, int i1)
    {
        ...
        Api.b b1;
        Object obj;
        for (set = map.keySet().iterator(); set.hasNext(); Kg.put(set1.gz(), a(b1, obj, context, looper, jg1, Kl, new _cls4(b1))))
        {
            set1 = (Api)set.next();
            b1 = set1.gx();
            obj = map.get(set1);
    ...
    {
        kc.Nu.c(googleapiclient).setResultCallback(new _cls7(f1, flag, googleapiclient));
    }
...
_L1:
    ...
    public final ConnectionResult blockingConnect(long l1, TimeUnit timeunit)
    {
        long l2;
        boolean flag;
        if (Looper.myLooper() != Looper.getMainLooper())
...
_L1:
    ...
    public final PendingResult clearDefaultAccountAndReconnect()
    {
        ...
        } else
        {
            ...
            Object obj = new _cls5(atomicreference, f1);
            _cls6 _lcls6 = new _cls6(f1);
            obj = (new GoogleApiClient.Builder(mContext)).addApi(kc.API).addConnectionCallbacks(((GoogleApiClient.ConnectionCallbacks) (obj))).addOnConnectionFailedListener(_lcls6).setHandler(Kd).build();
...
_L2:
        ...
        implements ResultCallback
    {
        ...
        _cls7(f f1, boolean flag, GoogleApiClient googleapiclient)
        {
            Kn = com.google.android.gms.common.api.c.this;
            Kq = f1;
            Kr = flag;
        ...
        implements GoogleApiClient.ConnectionCallbacks
    {
        ...
        _cls5(AtomicReference atomicreference, f f1)
        {
            Kn = com.google.android.gms.common.api.c.this;
            Kp = atomicreference;
            Kq = f1;
