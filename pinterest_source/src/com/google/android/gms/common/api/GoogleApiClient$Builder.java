...
public final class JQ
{
    ...
    public final JO addApi(Api api)
    {
        JL.put(api, null);
        api = api.gy();
        int j = api.size();
    ...
    public final JQ addScope(Scope scope)
    {
        JH.add(scope.gO());
        return this;
    }
    ...
    public final tionFailedListener enableAutoManage(FragmentActivity fragmentactivity, int i, tionFailedListener tionfailedlistener)
    {
        boolean flag;
        if (i >= 0)
        {
    ...
    public final JK setAccountName(String s)
    {
        DZ = s;
        return this;
    }

    public final DZ setGravityForPopups(int i)
    {
        JI = i;
        return this;
    }

    public final JI setHandler(Handler handler)
    {
    ...
    public final JF setViewForPopups(View view)
    {
        JJ = view;
        return this;
    }

    public final JJ useDefaultAccount()
    {
