...
class ct
{
    ...
    public ct(Context context, cr.c c1, DataLayer datalayer, s.a a1, s.a a2, ag ag1)
    {
        ...
        for (context = atc.qq().entrySet().iterator(); context.hasNext();)
        {
            ...
            while (datalayer.hasNext()) 
            {
                ...
                if (!di.n((com.google.android.gms.internal.d.a)a1.ql().get(b.dG.toString())).booleanValue())
                {
    ...
    private bz a(com.google.android.gms.internal.d.a a1, Set set, dl dl1)
    {
        ...
        case 6: // '\006'
        default:
            bh.T((new StringBuilder("Unknown type: ")).append(a1.type).toString());
            return atb;
        ...
        case 3: // '\003'
            ...
            {
                bh.T((new StringBuilder("Invalid serving value: ")).append(a1.toString()).toString());
                return atb;
            }
        ...
        case 4: // '\004'
            ...
            {
                bh.T((new StringBuilder("Macro cycle detected.  Current macro reference: ")).append(a1.gz).append(".  Previous macro references: ").append(set.toString()).append(".").toString());
                return atb;
            } else
            {
                set.add(a1.gz);
    ...
    private bz a(Map map, cr.a a1, Set set, ck ck1)
    {
        ...
        } else
        {
            ...
            if (map == null || atd.pH())
            {
                ...
                if (!aj1.a(map.keySet()))
                {
                    bh.T((new StringBuilder("Incorrect keys for function ")).append(((String) (obj))).append(" required ").append(aj1.pJ()).append(" had ").append(map.keySet()).toString());
                    return atb;
                }
                if (!flag || !aj1.pe())
                {
...
_L3:
    ...
    private static void a(List list, List list1, String s1)
    {
        ...
        {
            bh.U((new StringBuilder("Invalid resource: imbalance of rule names of functions for ")).append(s1).append(" operation. Using default rule name instead").toString());
        }
    }
    ...
    private static void a(Map map, aj aj1)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("Duplicate function type name: ")).append(aj1.pI()).toString());
        } else
        {
            map.put(aj1.pI(), aj1);
            return;
...
_L2:
        ...
        do
        {
            ...
            bh.V((new StringBuilder("Ignored supplemental: ")).append(j).toString());
        } while (true);
        list;
        throw list;
        ai.a(aqn, j);
