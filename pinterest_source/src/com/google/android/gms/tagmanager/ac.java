...
class ac extends aj
{
    ...
    public com.google.android.gms.internal.d.a B(Map map)
    {
        ...
        String s1;
        byte byte0;
        obj = (com.google.android.gms.internal.d.a)map.get(arp);
        if (obj == null || obj == di.rb())
        {
            return di.rb();
        }
        s1 = di.j(((com.google.android.gms.internal.d.a) (obj)));
...
_L2:
        ...
        } else
        {
            try
            {
                bh.T((new StringBuilder("Encode: unknown input format: ")).append(s).toString());
                map = di.rb();
            }
...
_L5:
        bh.T((new StringBuilder("Encode: unknown output format: ")).append(((String) (obj))).toString());
        return di.rb();
