...
_L2:
        ...
        if (map != null)
        {
            ...
            {
                bh.T((new StringBuilder("ArbitraryPixel: additional params not a list: not sending partial hit: ")).append(builder.build().toString()).toString());
                return;
            }
            for (map = ((List)map).iterator(); map.hasNext();)
            {
                ...
                {
                    bh.T((new StringBuilder("ArbitraryPixel: additional params contains non-map: not sending partial hit: ")).append(builder.build().toString()).toString());
                    return;
                }
        ...
        aqj.pf().cB(map);
        bh.V((new StringBuilder("ArbitraryPixel: url = ")).append(map).toString());
...
_L3:
    ...
    static 
    {
        ...
        aqf = b.bl.toString();
        aqg = b.eW.toString();
        aqh = (new StringBuilder("gtm_")).append(ID).append("_unrepeatable").toString();
    }
