    ...
    implements at
{
    ...
    private void c(long l, long l1)
    {
        ...
        {
            bh.W((new StringBuilder("Error setting HIT_FIRST_DISPATCH_TIME for hitId: ")).append(l).toString());
        }
        y(l);
    }
    ...
    private void fh()
    {
        ...
        {
            List list = G(i);
            bh.V((new StringBuilder("Store full, deleting ")).append(list.size()).append(" hits to make room.").toString());
...
_L6:
        obj = obj1;
        bh.W((new StringBuilder("Error in peekHits fetching hitIds: ")).append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
...
_L4:
        ...
        obj1 = obj3;
_L17:
        bh.W((new StringBuilder("Error in peekHits fetching hitIds: ")).append(((SQLiteException) (obj2)).getMessage()).toString());
        obj2 = obj;
...
_L15:
        obj1 = obj;
        bh.W((new StringBuilder("Error in peekHits fetching hit url: ")).append(((SQLiteException) (obj2)).getMessage()).toString());
        obj1 = obj;
        obj2 = new ArrayList();
        obj1 = obj;
...
_L11:
        ...
        j = i;
        obj1 = obj;
        if (TextUtils.isEmpty(((ap) (obj4)).pL()))
        {
            if (i != 0)
            {
                break; /* Loop/switch isn't completed */
...
_L1:
        ...
        implements db.a
    {
        ...
        {
            cb.a(asi, ap1.fb());
            bh.V((new StringBuilder("Permanent failure dispatching hitId: ")).append(ap1.fb()).toString());
        }
        ...
        public void c(ap ap1)
        {
            ...
            {
                cb.a(asi, ap1.fb());
                bh.V((new StringBuilder("Giving up on failed hitId: ")).append(ap1.fb()).toString());
                return;
            }
        }
