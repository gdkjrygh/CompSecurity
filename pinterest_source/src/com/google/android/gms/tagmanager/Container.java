...
public class Container
{
    ...
    private void a(com.google.android.gms.internal.c.f f)
    {
        ...
        {
            bh.T((new StringBuilder("Not loading resource: ")).append(f).append(" because it is invalid: ").append(g.toString()).toString());
            return;
        }
        a(c);
    }
    ...
    private void a(cr.c c)
    {
        aqs = c.getVersion();
        ag ag = cs(aqs);
        a(new ct(mContext, c, aqn, new a(null), new b(null), ag));
    }
    ...
    public boolean getBoolean(String s)
    {
        ...
        {
            bh.T((new StringBuilder("Calling getBoolean() threw an exception: ")).append(s.getMessage()).append(" Returning default value.").toString());
            return di.qY().booleanValue();
        }
        return flag;
    }
    ...
    public double getDouble(String s)
    {
        ...
        {
            bh.T((new StringBuilder("Calling getDouble() threw an exception: ")).append(s.getMessage()).append(" Returning default value.").toString());
            return di.qX().doubleValue();
        }
        return d;
    }
    ...
    public long getLong(String s)
    {
        ...
        {
            bh.T((new StringBuilder("Calling getLong() threw an exception: ")).append(s.getMessage()).append(" Returning default value.").toString());
            return di.qW().longValue();
        }
        return l;
    }
    ...
    public String getString(String s)
    {
        ...
        {
            bh.T((new StringBuilder("Calling getString() threw an exception: ")).append(s.getMessage()).append(" Returning default value.").toString());
            return di.ra();
        }
        return s;
    }
