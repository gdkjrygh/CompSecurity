    ...
    implements Runnable
{
    ...
    co(Context context, String s, bn bn1, r r1)
    {
        ...
        aqm = s;
        asD = r1;
        asB = (new StringBuilder("/r?id=")).append(s).toString();
        aqI = asB;
        asE = null;
    }
    ...
    private void qe()
    {
        ...
        bh.V((new StringBuilder("Successfully loaded supplemented resource: ")).append(obj).toString());
        if (((com.google.android.gms.internal.c.j) (obj)).gs == null && ((com.google.android.gms.internal.c.j) (obj)).gr.length == 0)
        {
            bh.V((new StringBuilder("No change for container: ")).append(aqm).toString());
        }
        asC.l(obj);
        bm1.close();
        ...
        Object obj1;
        obj1;
        bh.W((new StringBuilder("No data is retrieved from the given url: ")).append(s).append(". Make sure container_id: ").append(aqm).append(" is correct.").toString());
        asC.a(bg.a.arX);
        bm1.close();
        return;
        obj1;
        bh.d((new StringBuilder("Error when loading resources from url: ")).append(s).append(" ").append(((IOException) (obj1)).getMessage()).toString(), ((Throwable) (obj1)));
        asC.a(bg.a.arW);
        bm1.close();
        return;
        obj1;
        bh.d((new StringBuilder("Error when parsing downloaded resources from url: ")).append(s).append(" ").append(((IOException) (obj1)).getMessage()).toString(), ((Throwable) (obj1)));
        asC.a(bg.a.arX);
        bm1.close();
        return;
        Exception exception;
    ...
    void cL(String s)
    {
        bh.S((new StringBuilder("Setting previous container version: ")).append(s).toString());
        asE = s;
    }
    ...
    void cw(String s)
    {
        ...
        {
            bh.S((new StringBuilder("Setting CTFE URL path: ")).append(s).toString());
            aqI = s;
            return;
        }
    }
