...
_L2:
        ...
        if (matcher.matches())
        {
            ...
            {
                bh.W((new StringBuilder("illegal number in custom dimension value: ")).append(s).toString());
        ...
        bh.W((new StringBuilder("illegal number in custom metric value: ")).append(s).toString());
...
_L1:
        ...
        if (obj instanceof List)
        {
            for (obj = ((List)obj).iterator(); ((Iterator) (obj)).hasNext();)
            {
                ...
                {
                    bh.T((new StringBuilder("Failed to extract a product from DataLayer. ")).append(runtimeexception.getMessage()).toString());
                }
            }
...
_L3:
        for (obj = ((List) (obj)).iterator(); ((Iterator) (obj)).hasNext();)
        {
            ...
            {
                bh.T((new StringBuilder("Failed to extract a promotion from DataLayer. ")).append(runtimeexception.getMessage()).toString());
            }
        }
...
_L9:
        ...
        if (runtimeexception != null)
        {
            for (runtimeexception = runtimeexception.iterator(); runtimeexception.hasNext();)
            {
                ...
                {
                    bh.T((new StringBuilder("Failed to extract a product from DataLayer. ")).append(runtimeexception1.getMessage()).toString());
                }
            }
...
_L14:
        map = new ProductAction(((String) (obj)));
          goto _L15
        map;
        bh.T((new StringBuilder("Failed to extract a product action from DataLayer. ")).append(map.getMessage()).toString());
          goto _L2
    }
