...
label0:
    ...
    static Long cy(String s)
    {
        ...
        {
            bh.U((new StringBuilder("unknown _lifetime: ")).append(s).toString());
            return null;
        }
        long l;
        try
        ...
        {
            bh.W((new StringBuilder("illegal number in _lifetime value: ")).append(s).toString());
            l = 0L;
        }
        if (l <= 0L)
        {
            bh.U((new StringBuilder("non-positive _lifetime: ")).append(s).toString());
            return null;
        }
        ...
        {
        default:
            bh.W((new StringBuilder("unknown units in _lifetime: ")).append(s).toString());
            return null;
