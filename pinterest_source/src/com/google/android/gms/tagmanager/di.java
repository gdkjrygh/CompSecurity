...
class di
{
    ...
    private static dh da(String s1)
    {
        ...
        {
            bh.T((new StringBuilder("Failed to convert '")).append(s1).append("' to a number.").toString());
            return auf;
        }
        return dh1;
    }
    ...
    public static Object o(com.google.android.gms.internal.d.a a)
    {
        ...
        {
        default:
            bh.T((new StringBuilder("Failed to convert a value of type: ")).append(a.type).toString());
            return auc;
        ...
        case 3: // '\003'
            ...
            {
                bh.T((new StringBuilder("Converting an invalid value to object: ")).append(a.toString()).toString());
                return auc;
            }
