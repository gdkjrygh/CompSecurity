    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder("ActivityRecognitionResult [probableActivities=")).append(afX).append(", timeMillis=").append(afY).append(", elapsedRealtimeMillis=").append(afZ).append("]").toString();
    }
