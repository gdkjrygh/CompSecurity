    ...
    implements SafeParcelable
{
    ...
    public static final Comparator aga = new _cls1();
    ...
    {
        return (new StringBuilder("DetectedActivity [type=")).append(getType()).append(", confidence=").append(agc).append("]").toString();
    }
