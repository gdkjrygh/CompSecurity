...
public class AtMentionSpan extends NoUnderlineClickSpan
{

    public static final char PREFIX = 64;

    public AtMentionSpan()
    {
    }

    public static boolean isAtMention(String s)
    {
