...
class this._cls0
    implements android.view.aryHeaderMetaDataBar._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        {
            Events.post(new Navigation(Location.USER_LIBRARY_FOLLOWERS, LibraryHeaderMetaDataBar.access$000(LibraryHeaderMetaDataBar.this).getUid()));
        }
    }
