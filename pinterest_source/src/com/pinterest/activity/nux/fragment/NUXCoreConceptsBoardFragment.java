...
public class NUXCoreConceptsBoardFragment extends NUXCoreConceptsBaseFragment
{

    private static final long ANIMATION_START_DURATION = 300L;
    private static final long BOARD_APPEAR_ANIMATION_DURATION = 700L;
    private static final long BOARD_FADE_ANIMATION_DURATION = 400L;
    private static final long BOARD_FADE_BEGIN_AFTER = 800L;
    private static final float BOARD_FINAL_ALPHA = 0.5F;
    private static final float BOARD_FINAL_SCALE = 0.9F;
    private static final long BOARD_NAME_ALPHA_DURATION = 200L;
    private static final long BOARD_NAME_BEGIN_AFTER = 1200L;
    private static final float BOARD_NAME_PRE_SCALE = 0.85F;
    private static final long BOARD_NAME_SCALE_DURATION = 1300L;
    private static final float BOARD_PRE_TRANSLATEY = 100F;
    private static final long BOARD_TIP_ANIMATION_DURATION = 600L;
    private static final long BOARD_TIP_BEGIN_AFTER = 800L;
    private static final float BOARD_TIP_INTERPOLATOR_FRICTION = 0.9F;
    private static final float BOARD_TIP_INTERPOLATOR_TENSION = 0.2F;
    private static final float BOARD_TIP_PRE_SCALE = 0.7F;
    private static final float BOARD_TRANSLATE_INTERPOLATOR = 0.95F;
    private static final float GENERAL_INTERPOLATOR = 0.9F;
    WebImageView _board;
    PTextView _boardName;
    WebImageView _boardTip;
    PTextView _title;
    public AutofitHelper _titleAutofitHelper;
    AutofitLayout _titleWrapper;

    public NUXCoreConceptsBoardFragment()
    {
        _layoutId = 0x7f0300e1;
    }

    private AnimatorSet getBoardAnimation(WebImageView webimageview)
    {
        ...
        objectanimator = ObjectAnimator.ofFloat(webimageview, "scaleY", new float[] {
            1.0F, 0.9F
        });
        ...
        webimageview.playTogether(new Animator[] {
            obj, objectanimator1, objectanimator
        });
    ...
    private AnimatorSet getBoardTipAnimation(WebImageView webimageview)
    {
        ObjectAnimator objectanimator = ObjectAnimator.ofFloat(webimageview, "alpha", new float[] {
            0.0F, 1.0F
        });
    ...
    private AnimatorSet getBoardTitleAnimation(PTextView ptextview)
    {
        ObjectAnimator objectanimator = ObjectAnimator.ofFloat(ptextview, "alpha", new float[] {
            0.0F, 1.0F
        });
        objectanimator.setDuration(200L);
        objectanimator.setInterpolator(new LinearInterpolator());
        ObjectAnimator objectanimator1 = ObjectAnimator.ofFloat(ptextview, "scaleX", new float[] {
            0.85F, 1.0F
        });
        objectanimator1.setDuration(1300L);
        objectanimator1.setInterpolator(new BounceInterpolator());
        ptextview = ObjectAnimator.ofFloat(ptextview, "scaleY", new float[] {
            0.85F, 1.0F
        });
        ptextview.setDuration(1300L);
        ptextview.setInterpolator(new BounceInterpolator());
        AnimatorSet animatorset = new AnimatorSet();
        animatorset.playTogether(new Animator[] {
            objectanimator, objectanimator1, ptextview
        });
        return animatorset;
    }
    ...
    public void applyAnimation()
    {
        ...
        animatorset.play(getBoardAnimation(_board));
        animatorset.play(getBoardTipAnimation(_boardTip)).after(800L);
        animatorset.play(getBoardTitleAnimation(_boardName)).after(1200L);
        animatorset.start();
    }
...
_L3:
        ...
        boolean flag;
        if (((NuxStep) (obj)).a == AndroidView.NUX_CORE_CONCEPTS_BOARD.getValue())
        {
            flag = true;
        } else
        {
...
_L5:
        ...
        _boardName.setText(((NuxStep) (obj)).s);
        _boardName.setTypefaceId(com.pinterest.kit.utils.FontUtils.TypefaceId.MEDIUM);
        obj = ((NuxStep) (obj)).r;
        _board.loadUri(Uri.parse(((PinterestJsonObject) (obj)).a("board", "")));
        _boardTip.loadUri(Uri.parse(((PinterestJsonObject) (obj)).a("boardTip", "")));
