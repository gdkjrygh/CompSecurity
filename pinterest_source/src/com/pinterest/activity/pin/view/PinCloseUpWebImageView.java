...
public class PinCloseUpWebImageView extends WebView
{
    ...
    public PinCloseUpWebImageView(Context context)
    {
        this(context, null, 0);
    }
    ...
    public PinCloseUpWebImageView(Context context, AttributeSet attributeset, int i)
    {
    ...
    public void setGalleryItem(final com.pinterest.api.model.Pin.GalleryItem url)
    {
        if ((_galleryItem != null || url != null) && (url == null || !url.equals(_galleryItem)))
        {
            _galleryItem = url;
            if (_galleryItem != null)
            {
                init();
                if (_galleryItem.isGif())
                {
                    url = _galleryItem.getEmbedUrl();
                } else
                {
                    url = _galleryItem.getLargeUrl();
                }
...
_L7:
            finalHtml = _galleryItem.getMediumUrl();
            class _cls1
                implements Runnable
            {
...
_L6:
        ...
        _cls1()
        {
            this$0 = PinCloseUpWebImageView.this;
            url = s;
            super();
        }
    }
