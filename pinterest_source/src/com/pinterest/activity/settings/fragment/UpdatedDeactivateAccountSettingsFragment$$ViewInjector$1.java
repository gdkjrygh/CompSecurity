...
final class val.target extends DebouncingOnClickListener
{
    ...
    final UpdatedDeactivateAccountSettingsFragment val$target;

    public final void doClick(View view)
    {
        val$target.onOptionDeactivateAccountClicked(view);
    }

    ()
    {
        val$target = updateddeactivateaccountsettingsfragment;
        super();
    }
}
