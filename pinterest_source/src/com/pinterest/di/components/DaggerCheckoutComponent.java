...
import com.pinterest.activity.commerce.CheckoutFragment_MembersInjector;
...
import com.pinterest.activity.commerce.logic.CheckoutController_Factory;
...
import com.pinterest.di.modules.CheckoutModule_ProvidesCheckoutFragmentFactory;
    ...
    implements CheckoutComponent
{
    ...
    private DaggerCheckoutComponent(Builder builder)
    {
        ...
        } else
        {
            ...
            w = ScopedProvider.a(CheckoutModule_ProvidesCheckoutFragmentFactory.a(Builder.b(builder)));
            x = CheckoutController_Factory.create(b, i, n, w);
            y = CheckoutFragment_MembersInjector.create(k, x);
            return;
        }
    }

    DaggerCheckoutComponent(Builder builder, byte byte0)
    {
        this(builder);
    }
    ...
    {
        y.injectMembers(checkoutfragment);
    }
    ...
    {
        boolean flag;
        if (!com/pinterest/di/components/DaggerCheckoutComponent.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
        ...
        implements Factory
    {
        private class Builder
        {
            ...
            static CheckoutModule b(Builder builder)
            {
                return builder.a;
            }
            ...
            public final Builder a(CheckoutModule checkoutmodule)
            {
                a = checkoutmodule;
                return this;
            }
        ...
        {
            b = DaggerCheckoutComponent.this;
            a = builder;
            super();
            c = Builder.a(a);
        }
