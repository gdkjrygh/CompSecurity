        ...
        if (i < 2)
        {
            ...
            if (fragment.mView != null && fragment.mContainer != null)
            {
                ...
                if (obj != null)
                {
                    ...
                    fragment.mStateAfterAnimating = i;
                    ((Animation) (obj)).setAnimationListener(new _cls5(((Animation) (obj)), fragment));
...
_L15:
    ...
    public final View onCreateView(View view, String s, Context context, AttributeSet attributeset)
    {
        ...
        if (DEBUG)
        {
            Log.v("FragmentManager", (new StringBuilder("onCreateView: id=0x")).append(Integer.toHexString(k)).append(" fname=").append(s1).append(" existing=").append(s).toString());
        }
        if (s == null)
        {
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).mActive != null)
        {
            ...
            if (((FragmentManagerState) (parcelable)).mAdded != null)
            {
                ...
                for (int l = 0; l < ((FragmentManagerState) (parcelable)).mAdded.length; l++)
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: added #")).append(l).append(": ").append(list).toString());
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mBackStack != null)
            {
                ...
                while (i1 < ((FragmentManagerState) (parcelable)).mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: back stack #")).append(i1).append(" (index ").append(((BackStackRecord) (list)).mIndex).append("): ").append(list).toString());
...
_L3:
    ...
    final void setRetainLoader(boolean flag)
    {
        if (mActive != null)
        {
    ...
    private class _cls5 extends AnimateOnHWLayerIfNeededListener
    {
        ...
        _cls5(Animation animation, Fragment fragment1)
        {
            this$0 = FragmentManagerImpl.this;
            fragment = fragment1;
