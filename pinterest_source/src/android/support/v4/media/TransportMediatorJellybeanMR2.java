...
class TransportMediatorJellybeanMR2
{
    ...
    boolean mFocused;
    final android.media.RemoteControlClient.OnGetPlaybackPositionListener mGetPlaybackPositionListener = new _cls5();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new _cls3();
    PendingIntent mPendingIntent;
    int mPlayState;
    final android.media.RemoteControlClient.OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new _cls6();
