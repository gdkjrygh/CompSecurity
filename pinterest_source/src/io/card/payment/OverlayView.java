...
class OverlayView extends View
{
    ...
    public void markupCard()
    {
        ...
        if (mBitmap != null)
        {
            ...
            while (i < j) 
            {
                ...
                canvas.drawText((new StringBuilder()).append(mDetectedCard.cardNumber.charAt(i)).toString(), l, k, paint);
                i++;
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionevent)
    {
        ...
        Log.d(TAG, (new StringBuilder("onTouchEvent: ")).append(motionevent).toString());
    ...
    {
        Log.d(TAG, (new StringBuilder("setGuideAndRotation: ")).append(rect).append(", ").append(i).toString());
        mRotation = i;
        mGuide = rect;
        invalidate();
        if (mRotation % 180 != 0)
        ...
        {
            Log.d(TAG, (new StringBuilder()).append(mCameraPreviewRect).append(", ").append(rect).append(", ").append(mCameraPreviewRect).append(", ").append(rect).toString());
