...
public final class Intents
{
    public static final class PhotoViewIntentBuilder
    {
        ...
        public final PhotoViewIntentBuilder setActionBarHiddenInitially(boolean flag)
        {
            mActionBarHiddenInitially = flag;
            return this;
        }

        public final PhotoViewIntentBuilder setDisplayThumbsFullScreen(boolean flag)
        {
            mDisplayFullScreenThumbs = flag;
            return this;
        }

        public final PhotoViewIntentBuilder setInitialPhotoUri(String s)
        {
            mInitialPhotoUri = s;
            return this;
        }

        public final PhotoViewIntentBuilder setMaxInitialScale(float f)
        {
            mMaxInitialScale = Float.valueOf(f);
            return this;
        }

        public final PhotoViewIntentBuilder setProjection(String as[])
        {
            mProjection = as;
            return this;
        }

        public final PhotoViewIntentBuilder setResolvedPhotoUri(String s)
        {
            mResolvedPhotoUri = s;
            return this;
        }

        public final PhotoViewIntentBuilder setThumbnailUri(String s)
        {
            mThumbnailUri = s;
            return this;
        }

        private PhotoViewIntentBuilder(Context context, Class class1)
        {
    ...
    public static PhotoViewIntentBuilder newPhotoViewFragmentIntentBuilder(Context context, Class class1)
    {
        return new PhotoViewIntentBuilder(context, class1);
    }

    public static PhotoViewIntentBuilder newPhotoViewIntentBuilder(Context context, Class class1)
    {
        return new PhotoViewIntentBuilder(context, class1);
    }
}
