...
public final class Detector
{
        ...
        throws NotFoundException
    {
        ...
        {
            Point point4 = getFirstDifferent(((Point) (obj2)), flag, 1, -1);
            Point point3 = getFirstDifferent(((Point) (obj1)), flag, 1, 1);
            Point point2 = getFirstDifferent(((Point) (obj)), flag, -1, 1);
            Point point1 = getFirstDifferent(point, flag, -1, -1);
            if (nbCenterLayers > 2)
            {
