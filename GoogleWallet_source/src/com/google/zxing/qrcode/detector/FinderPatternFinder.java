...
public final class FinderPatternFinder
{
        ...
        implements Serializable, Comparator
    {
        ...
        private int compare(FinderPattern finderpattern, FinderPattern finderpattern1)
        {
    ...
    private static boolean foundPatternCross(int ai[])
    {
        int i;
        int j;
        j = 0;
...
_L7:
    ...
    private boolean handlePossibleCenter(int ai[], int i, int j)
    {
