...
final class BitMatrixParser
{
    ...
    private int readCorner1(int i, int j)
    {
        int k = 0;
    ...
    private int readCorner2(int i, int j)
    {
        int k = 0;
    ...
    private int readCorner3(int i, int j)
    {
        int k = 0;
        if (readModule(i - 1, 0, i, j))
        {
    ...
    private int readCorner4(int i, int j)
    {
        int k = 0;
        if (readModule(i - 3, 0, i, j))
        {
    ...
    private boolean readModule(int i, int j, int k, int l)
    {
        int i1 = i;
        int j1 = j;
        if (i < 0)
    ...
    private int readUtah(int i, int j, int k, int l)
    {
        int i1 = 0;
