...
//            ASCIIEncoder, C40Encoder, TextEncoder, X12Encoder, 
//            EdifactEncoder, Base256Encoder, EncoderContext, Encoder, 
...
_L1:
        ...
        encodercontext.pos = encodercontext.pos + 7;
_L4:
        int i;
        i = 0;
        do
...
_L3:
    ...
    static void illegalCharacter(char c)
    {
        ...
        throw new IllegalArgumentException((new StringBuilder("Illegal character: ")).append(c).append(" (0x").append(s).append(')').toString());
    }
