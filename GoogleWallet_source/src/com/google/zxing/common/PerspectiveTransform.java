...
public final class PerspectiveTransform
{
    ...
    private static PerspectiveTransform squareToQuadrilateral(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
    {
        float f8 = ((f - f2) + f4) - f6;
        ...
        } else
        {
            ...
            float f12 = f7 - f5;
            f5 = f10 * f12 - f11 * f4;
            f11 = (f8 * f12 - f11 * f9) / f5;
            f4 = (f10 * f9 - f8 * f4) / f5;
            return new PerspectiveTransform((f2 - f) + f11 * f2, (f6 - f) + f4 * f6, f, f11 * f3 + (f3 - f1), f4 * f7 + (f7 - f1), f1, f11, f4, 1.0F);
        }
    }

    private PerspectiveTransform times(PerspectiveTransform perspectivetransform)
    {
