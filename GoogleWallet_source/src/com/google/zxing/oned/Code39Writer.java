...
public final class Code39Writer extends OneDimensionalCodeWriter
{
    ...
    public final boolean[] encode(String s)
    {
        ...
        if (l1 > 80)
        {
            throw new IllegalArgumentException((new StringBuilder("Requested contents should be less than 80 digits long, but got ")).append(l1).toString());
        }
        int ai[] = new int[9];
        int l = l1 + 25;
        for (int i = 0; i < l1; i++)
        {
            ...
            if (i1 < 0)
            {
                throw new IllegalArgumentException((new StringBuilder("Bad contents: ")).append(s).toString());
            }
