    ...
    extends IInterface
{
        ...
        implements IUploadService
    {
        ...
        public static IUploadService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.google.android.libraries.uploader.service.lib.service.IUploadService");
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                flag = startUpload(s, s1, uri, parcel.readLong(), parcel.readString(), IUploadServiceCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
            ...
            case 3: // '\003'
                parcel.enforceInterface("com.google.android.libraries.uploader.service.lib.service.IUploadService");
                boolean flag1 = associateCallback(parcel.readString(), IUploadServiceCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                if (flag1)
                {
                    i = 1;
...
_L2:
    ...
    public abstract boolean associateCallback(String s, IUploadServiceCallback iuploadservicecallback)
        throws RemoteException;

    public abstract void cancelUpload(String s)
        throws RemoteException;

    public abstract double getUpdate(String s)
        throws RemoteException;

    public abstract boolean hasUploadFailed(String s)
        throws RemoteException;
    ...
    public abstract boolean sessionExists(String s)
        throws RemoteException;

    public abstract boolean startUpload(String s, String s1, Uri uri, long l, String s2, IUploadServiceCallback iuploadservicecallback, 
            String s3)
        throws RemoteException;
}
