...
final class val.this._cls0
    implements android.animation.icator.PendingRetreatAnimator._cls2
{
    ...
    {
        PagingIndicator.access$1302(_fld0, ((Float)valueanimator.getAnimatedValue()).floatValue());
        postInvalidateOnAnimation();
        valueanimator = PagingIndicator.access$1100(_fld0);
        int j = valueanimator.length;
        for (int i = 0; i < j; i++)
        {
            valueanimator[i].rtIfNecessary(PagingIndicator.access$1300(_fld0));
        }
