    ...
    implements com.google.android.libraries.commerce.ocr.capture._cls1
{
    ...
    {
        if (CameraPreviewPresenterImpl.access$300(_fld0))
        {
            if (CameraPreviewPresenterImpl.access$400(_fld0) == null || !CameraPreviewPresenterImpl.access$400(_fld0).isSameType(ocrimage))
            {
                CameraPreviewPresenterImpl.access$402(_fld0, new OcrImage(ocrimage));
            } else
            {
                CameraPreviewPresenterImpl.access$400(_fld0).copyFrom(ocrimage);
            }
        }
        CameraPreviewPresenterImpl.access$500(_fld0).process(ocrimage);
    }
...
/* anonymous class */
        ...
        implements com.google.android.libraries.commerce.ocr.capture.CameraManager.OnFinishCallback
    {
        ...
        // Unreferenced inner class com/google/android/libraries/commerce/ocr/ui/CameraPreviewPresenterImpl$1$2

/* anonymous class */
        final class CameraPreviewPresenterImpl._cls1._cls2
            implements Runnable
        {
            ...
            {
                CameraPreviewPresenterImpl.access$000(this$0).startPreview(null);
            }
