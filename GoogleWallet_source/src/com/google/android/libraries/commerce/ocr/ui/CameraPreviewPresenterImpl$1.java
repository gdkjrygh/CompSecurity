...
final class val.holder
    implements com.google.android.libraries.commerce.ocr.capture.k
{
    ...
    public final void onFinish()
    {
        ...
        CameraPreviewPresenterImpl.access$000(CameraPreviewPresenterImpl.this).addContinuousPreviewImageCallback(new com.google.android.libraries.commerce.ocr.capture.CameraManager.ImageCallback() {
        ...
        {
            CameraPreviewPresenterImpl.access$700(CameraPreviewPresenterImpl.this).execute(new Runnable() {
        ...
        obj = val$holder.getSurfaceFrame();
        Canvas canvas = val$holder.lockCanvas();
        new ImageUtil();
        ...
        val$holder.unlockCanvasAndPost(canvas);
    }
