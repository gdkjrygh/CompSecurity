...
public static final class  extends KycOcrResponseHandler
{
    ...
    private void onRecognized(com.google.commerce.ocr.definitions.er.BarcodeHandler barcodehandler, Bundle bundle)
    {
        getListener().deCaptured(barcodehandler, getAnalytics());
    }

    public final volatile void onRecognized(Object obj, Bundle bundle)
    {
        onRecognized((com.google.commerce.ocr.definitions.er.BarcodeHandler.onRecognized)obj, bundle);
    }

    public final volatile void onRecognized(Object obj, Object obj1)
    {
        onRecognized((com.google.commerce.ocr.definitions.er.BarcodeHandler.onRecognized)obj, (Bundle)obj1);
    }
