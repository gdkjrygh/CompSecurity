...
public class ScreenWidthSensitiveRelativeLayout extends RelativeLayout
{

    public ScreenWidthSensitiveRelativeLayout(Context context, AttributeSet attributeset)
    {
