    ...
    implements android.view.er
{
    ...
    public final void onClick(View view)
    {
        ...
        {
            BankAccountTile.access$100(BankAccountTile.this).startActivity(BankAccountApi.createChallengeDepositActivityIntent(BankAccountTile.access$000(BankAccountTile.this), val$bankAccount));
            return;
        }
    }
