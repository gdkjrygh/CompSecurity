    ...
    implements Runnable
{
    ...
    {
        SystemClock.sleep(CombinedBackgroundInitializerTask.access$400(_fld0).longValue());
        int i = ((PreferenceClient)CombinedBackgroundInitializerTask.access$800(_fld0).get()).updateDeviceInfo();
        if (i != 0)
        {
            try
            {
        ...
        ((LocalePreferenceUpdater)CombinedBackgroundInitializerTask.access$1000(_fld0).get()).register();
        return;
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/google/android/apps/wallet/init/CombinedBackgroundInitializerTask$1$3

/* anonymous class */
        final class CombinedBackgroundInitializerTask._cls1._cls3
            implements Runnable
        {
