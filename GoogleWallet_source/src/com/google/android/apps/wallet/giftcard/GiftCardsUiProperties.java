...
final class GiftCardsUiProperties
    implements ProgramCardsUiProperties
{
    ...
    public final int getEditCardInfoFragmentTitle(int i)
    {
        ...
        {
        default:
            return com.google.android.apps.walletnfcrel.R.string.gift_cards_title_add;

        case 2: // '\002'
            return com.google.android.apps.walletnfcrel.R.string.gift_cards_edit_title;
        }
    }

    public final int getErrorDialogMessage()
    {
        return com.google.android.apps.walletnfcrel.R.string.gift_cards_add_card_error_message;
    }

    public final int getErrorDialogTitle()
    {
        return com.google.android.apps.walletnfcrel.R.string.gift_cards_add_card_error_title;
    }
    ...
    {
        return com.google.android.apps.walletnfcrel.R.string.gift_cards_title_find;
    }

    public final int getSuccessToastMessage()
    {
        return com.google.android.apps.walletnfcrel.R.string.gift_cards_add_card_success_message;
    }
