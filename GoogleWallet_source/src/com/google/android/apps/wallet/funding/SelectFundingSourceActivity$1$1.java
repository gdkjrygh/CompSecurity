    ...
    implements Callable
{
    ...
    private Void call()
        throws Exception
    {
        tapAndPayModelPublisher.enableStoredValue(((StoredValueEvent)SelectFundingSourceActivity.access$100(_fld0).get()).getModel().getStoredValue(), ((PaymentCardModelEvent)SelectFundingSourceActivity.access$200(_fld0).get()).getModel().getAllCredentials(), SelectFundingSourceActivity.access$000(_fld0).isChecked());
        return null;
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/google/android/apps/wallet/funding/SelectFundingSourceActivity$1$2

/* anonymous class */
        final class SelectFundingSourceActivity._cls1._cls2
            implements AsyncCallback
        {
            ...
            {
                SelectFundingSourceActivity.access$000(this$0).setEnabled(true);
            }

            public final void onFailure(Exception exception)
            {
                SelectFundingSourceActivity.access$000(this$0).toggle();
                SelectFundingSourceActivity.access$000(this$0).setEnabled(true);
