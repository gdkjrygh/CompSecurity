...
public class NotificationProtoManager extends AbstractProtoEntityManager
{
    ...
    NotificationProtoManager(WalletDatabaseHelper walletdatabasehelper)
    {
    ...
    {
        deleteSelectedEntities(String.format("%s=?", new Object[] {
            Column.NOTIFICATION_TYPE.getColumnName()
        }), new String[] {
            String.valueOf(i)
        });
    }
