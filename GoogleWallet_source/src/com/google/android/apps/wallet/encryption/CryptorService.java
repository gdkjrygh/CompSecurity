...
{
    public static class CryptorSession
        implements EncryptionService.EncryptionSession
    {
        ...
        private CryptorSession(SessionCrypter sessioncrypter)
        {
            mSessionCrypter = sessioncrypter;
        }

        CryptorSession(SessionCrypter sessioncrypter, KeyczarTorinoKeysEncryptionService._cls1 _pcls1)
        {
            this(sessioncrypter);
        }
    }
    ...
    public abstract CryptorSession newSession();
}
