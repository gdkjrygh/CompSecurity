...
final class this._cls1
    implements android.content.SetupProfileActivity._cls8._cls1
{
    ...
    // Unreferenced inner class com/google/android/apps/wallet/usersetup/SimplifiedSetupProfileActivity$8

/* anonymous class */
    final class SimplifiedSetupProfileActivity._cls8
        implements com.google.android.gms.common.GooglePlayServicesClient.OnConnectionFailedListener
    {
        ...
        public final void onConnectionFailed(ConnectionResult connectionresult)
        {
            ...
            obj = GooglePlayServicesUtil.getErrorDialog(connectionresult.getErrorCode(), SimplifiedSetupProfileActivity.this, 9001, new SimplifiedSetupProfileActivity._cls8._cls1());
            if (obj != null)
            {
                ((Dialog) (obj)).show();
            } else
