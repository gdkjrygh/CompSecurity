    ...
    implements Provider
{
    ...
    public final InitializedEventPublisher get()
    {
        ...
        return WobsCachingModule.getInitializedEventPublishers((WobsManager)wobsManager.get());
    }
    ...
    {
        super("com.google.android.apps.wallet.eventbus.InitializedEventPublisher", false, "com.google.android.apps.wallet.wobs.caching.WobsCachingModule", "getInitializedEventPublishers");
