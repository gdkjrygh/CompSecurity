    ...
    implements OnActionHandler
{
    ...
    private void onAction(final URI uri, final View view)
    {
        ...
        final String actionName = WoblHolderImpl.MUTATE_WOBL_ACTION_NAME_PATTERN.matcher(uri.toString());
        if (actionName.find())
        {
        ...
        WoblHolderImpl.access$700(WoblHolderImpl.this).executeAction(new Callable() {
