...
final class this._cls0
    implements com.google.android.libraries.uploader.service.lib.service.r
{
    ...
    public final void onResponseReceived(final String identifier, byte abyte0[], int i)
    {
        if (i == 200)
        {
            log.logfmt(com.google.android.apps.wallet.logging., "Upload response received: identifier=%s, responseText=\"%s\"", new Object[] {
                identifier, new String(abyte0, Charset.forName("UTF-8"))
            });
            ImageUploadManager.access$000(ImageUploadManager.this, identifier);
            ImageUploadManager.access$200(ImageUploadManager.this).execute(new Runnable() {
        ...
        log.logfmt(com.google.android.apps.wallet.logging.R, "Upload response received: identifier=%s, responseText=\"%s\", responseCode=%s", new Object[] {
        ...
        if (i == 401)
        {
            log.logfmt(com.google.android.apps.wallet.logging.R, "Got 401, retrying upload: identifier=%s", new Object[] {
                identifier
            });
            ImageUploadManager.access$200(ImageUploadManager.this).execute(new Runnable() {
    ...
    {
        log.logfmt(com.google.android.apps.wallet.logging.R, "Upload failed: identifier=%s", new Object[] {
            s
        });
