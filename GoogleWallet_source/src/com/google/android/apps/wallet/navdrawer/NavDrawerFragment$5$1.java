    ...
    implements android.view.tsListener
{
    ...
    final .setIntrinsicHeight this$1;

    public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowinsets)
    {
        int i = windowinsets.getSystemWindowInsetTop();
        NavDrawerFragment.access$900(_fld0).setIntrinsicHeight(i);
        return windowinsets;
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnAttachStateChangeListener
    {
        ...
        // Unreferenced inner class com/google/android/apps/wallet/navdrawer/NavDrawerFragment$5$2

/* anonymous class */
        final class NavDrawerFragment._cls5._cls2
