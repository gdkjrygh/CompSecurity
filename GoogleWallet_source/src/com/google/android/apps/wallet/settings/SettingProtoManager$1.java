    ...
    implements EntityUtil
{
    ...
    private static EntityId getId(com.google.wallet.proto.ting ting)
    {
        return new EntityId(ting.id);
    }

    private static com.google.wallet.proto.ting parseFrom(byte abyte0[])
        throws InvalidProtocolBufferNanoException
    {
        return (com.google.wallet.proto.ting)MessageNano.mergeFrom(new com.google.wallet.proto.ting(), abyte0);
    }

    public final volatile EntityId getId(MessageNano messagenano)
    {
        return getId((com.google.wallet.proto.ting)messagenano);
    }
