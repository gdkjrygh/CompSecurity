    ...
    implements Provider
{
    ...
    public final Set get()
    {
        ...
        return ImageIoModule.getAuthoritiesRequiringAuth((CloudConfigurationManager)cloudConfigManager.get());
    }
    ...
    {
        super("@com.google.android.apps.wallet.imageio.BindingAnnotations$AuthoritiesRequiringAuth()/java.util.Set<java.lang.String>", false, "com.google.android.apps.wallet.imageio.ImageIoModule", "getAuthoritiesRequiringAuth");
