...
_L4:
            return;
_L2:
            int i = GooglePlayServicesUtil.isGooglePlayServicesAvailable(mR);
            if (GooglePlayServicesUtil.isUserRecoverableError(i))
            {
                GooglePlayServicesUtil.b(i, mR);
                return;
            }
...
_L3:
        ...
        throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException
    {
        ...
        if (i != 0)
        {
            context = getGooglePlayServicesAvailabilityRecoveryIntent(i);
    ...
    private static void E(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 6587000 but found ")).append(i).append(".  You must have the following declaration within the <application> element: ").append("    <meta-data android:name=\"com.google.android.gms.version").append("\" android:value=\"@integer/google_play_services_version\" />").toString());
            }
        } else
        {
    ...
    private static Dialog a(int i, Activity activity, Fragment fragment, int j, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        int k;
        k = i;
        if (com.google.android.gms.common.util.c.M(activity))
        {
            k = i;
            if (i == 2)
            {
        ...
        if (!m.jn()) goto _L2; else goto _L1
_L1:
        Object obj;
        obj = new TypedValue();
...
_L5:
        ...
        builder.setMessage(c(activity, k));
        if (oncancellistener != null)
        {
            builder.setOnCancelListener(oncancellistener);
        }
        oncancellistener = getGooglePlayServicesAvailabilityRecoveryIntent(k);
        if (fragment == null)
        {
            fragment = new jx(activity, oncancellistener, j);
        } else
        {
            fragment = new jx(fragment, oncancellistener, j);
        }
        activity = d(activity, k);
        if (activity != null)
        {
        ...
        {
        default:
            Log.e("GooglePlayServicesUtil", (new StringBuilder("Unexpected error code ")).append(k).toString());
...
_L4:
    ...
    private static void a(int i, Context context)
    {
        ...
        ((NotificationManager)context.getSystemService("notification")).notify(cM(i), ((Notification) (obj)));
    }
    ...
    private static byte[] a(PackageInfo packageinfo, boolean flag)
    {
        ...
        if (flag)
        {
            packageinfo = com.google.android.gms.common.b.hQ();
        } else
        {
            packageinfo = com.google.android.gms.common.b.hR();
        }
...
_L4:
    ...
    private static PendingIntent getErrorPendingIntent(int i, Context context, int j)
    {
        Intent intent = getGooglePlayServicesAvailabilityRecoveryIntent(i);
        if (intent == null)
        {
            return null;
        } else
    ...
    private static boolean honorsDebugCertificates(PackageManager packagemanager)
    {
...
label0:
        {
            ...
            if (com.google.android.gms.common.util.c.dB(((PackageInfo) (obj1)).versionCode))
            {
                int i;
                if (hS())
                {
    ...
    b.Rm[i], b.Rs[i], b.Rr[i]
                ...
                try
                {
                    ...
                    if (isGoogleSignedPackage(((PackageManager) (obj)), packageinfo))
                    {
                        break label0;
                    }
            ...
            if (com.google.android.gms.common.util.c.M(context))
            {
                if (a(((PackageInfo) (obj1)), b.Rm) == null)
                {
    ...
    context
        ...
        int j = com.google.android.gms.common.util.c.dz(0x648278);
        if (com.google.android.gms.common.util.c.dz(((PackageInfo) (obj1)).versionCode) < j)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder("Google Play services out of date.  Requires 6587000 but found ")).append(((PackageInfo) (obj1)).versionCode).toString());
            return 2;
        }
        try
        {
    ...
    private static boolean isGoogleSignedPackage(PackageManager packagemanager, PackageInfo packageinfo)
    {
        boolean flag;
        boolean flag1;
        flag = false;
...
_L4:
    ...
    private static boolean isPackageGoogleSigned(PackageManager packagemanager, String s)
    {
        ...
        return isGoogleSignedPackage(packagemanager, packageinfo);
    }
    ...
    private static boolean showErrorDialogFragment(int i, Activity activity, int j, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
    ...
    public static void showErrorNotification(int i, Context context)
    {
        ...
        if (isPlayServicesPossiblyUpdating(context, j))
        {
            F(context);
            return;
        } else
    ...
    {
        if (!isPackageGoogleSigned(packagemanager, s))
        {
