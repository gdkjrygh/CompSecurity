    ...
    extends IInterface
{
        ...
        implements e
    {
        ...
        public static e cB(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                parcel = a(com.google.android.gms.maps.model.internal.l.a.dg(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
        ...
        implements e
    {
        ...
        public final Bitmap a(l l1, int i, int j)
            throws RemoteException
        {
            Object obj;
            Parcel parcel;
...
_L1:
    ...
    public abstract Bitmap a(l l, int i, int j)
        throws RemoteException;
}
