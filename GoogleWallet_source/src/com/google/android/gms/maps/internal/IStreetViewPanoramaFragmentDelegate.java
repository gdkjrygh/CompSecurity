    ...
    extends IInterface
{
        ...
        implements IStreetViewPanoramaFragmentDelegate
    {
        ...
        public static IStreetViewPanoramaFragmentDelegate cY(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                onInflate(d1, ((StreetViewPanoramaOptions) (obj)), parcel);
                parcel1.writeNoException();
                return true;
...
_L4:
        ...
        public final void onInflate(d d1, StreetViewPanoramaOptions streetviewpanoramaoptions, Bundle bundle)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
