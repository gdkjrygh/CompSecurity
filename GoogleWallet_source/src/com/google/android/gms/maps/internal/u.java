    ...
    extends IInterface
{
        ...
        implements u
    {
        ...
        public static u cU(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                a(IStreetViewPanoramaDelegate.a.cX(parcel.readStrongBinder()));
...
_L1:
    ...
    public abstract void a(IStreetViewPanoramaDelegate istreetviewpanoramadelegate)
        throws RemoteException;
}
