    ...
    extends IInterface
{
        ...
        implements t
    {
        ...
        public static t cT(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            if (parcel.readInt() != 0)
            {
                com.google.android.gms.maps.model.t t1 = StreetViewPanoramaOrientation.CREATOR;
                parcel = com.google.android.gms.maps.model.t.gx(parcel);
            } else
            {
                parcel = null;
            }
