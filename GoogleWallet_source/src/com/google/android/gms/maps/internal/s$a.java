...
_L1:
    ...
    public static com.google.android.gms.maps.internal.s cS(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof com.google.android.gms.maps.internal.s))
        {
            return (com.google.android.gms.maps.internal.s)iinterface;
        } else
        {
        ...
        throws RemoteException
    {
        ...
        if (parcel.readInt() != 0)
        {
            s s1 = StreetViewPanoramaLocation.CREATOR;
            parcel = s.gw(parcel);
        } else
        {
            parcel = null;
