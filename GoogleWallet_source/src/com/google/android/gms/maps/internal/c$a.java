...
_L1:
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            g1 = com.google.android.gms.maps.model.internal.g.a.db(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return g1;
            Exception exception;
    ...
    public static com.google.android.gms.maps.internal.c cy(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            l(com.google.android.gms.dynamic.bH(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = m(com.google.android.gms.dynamic.bH(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj2;
            if (obj != null)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj1 = com.google.android.gms.dynamic.bH(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            a(com.google.android.gms.dynamic.bH(parcel.readStrongBinder()), parcel.readInt());
            parcel1.writeNoException();
            return true;

        case 7: // '\007'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = com.google.android.gms.dynamic.bH(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                c c1 = StreetViewPanoramaOptions.CREATOR;
                parcel = c.gk(parcel);
            } else
            {
                parcel = null;
        ...
        case 8: // '\b'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = n(com.google.android.gms.dynamic.bH(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj5;
            break;
        }
