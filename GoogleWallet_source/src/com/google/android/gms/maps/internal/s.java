    ...
    extends IInterface
{
        ...
        implements s
    {
        ...
        public static s cS(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            if (parcel.readInt() != 0)
            {
                com.google.android.gms.maps.model.s s1 = StreetViewPanoramaLocation.CREATOR;
                parcel = com.google.android.gms.maps.model.s.gw(parcel);
            } else
            {
                parcel = null;
            }
