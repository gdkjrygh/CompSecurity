...
public class SupportStreetViewPanoramaFragment extends Fragment
{
    ...
    static final class b extends com.google.android.gms.dynamic.a
    {
        ...
        private void qc()
        {
            ...
            try
            {
                ...
                azc.a(new a(VB, istreetviewpanoramafragmentdelegate));
    ...
    private final b azL = new b(this);
    ...
    public final View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        return azL.onCreateView(layoutinflater, viewgroup, bundle);
    }
    ...
    public final void onInflate(Activity activity, AttributeSet attributeset, Bundle bundle)
    {
        ...
        azL.onInflate(activity, attributeset, bundle);
    }
    ...
    public final void onSaveInstanceState(Bundle bundle)
    {
        ...
        azL.onSaveInstanceState(bundle);
    }
