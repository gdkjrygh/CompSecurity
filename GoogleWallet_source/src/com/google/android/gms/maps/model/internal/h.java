    ...
    extends IInterface
{
        ...
        implements h
    {
        ...
        public static h dc(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 17: // '\021'
                parcel.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                boolean flag4 = a(dc(parcel.readStrongBinder()));
                parcel1.writeNoException();
                j = ((flag1) ? 1 : 0);
                if (flag4)
                {
...
_L1:
        ...
        public final void setFillColor(int j)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
        ...
        public final void setStrokeColor(int j)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
