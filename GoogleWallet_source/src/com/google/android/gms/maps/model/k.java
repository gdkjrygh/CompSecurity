    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static MarkerOptions gr(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < j)
            {
                ...
                case 5: // '\005'
                    ibinder = com.google.android.gms.common.internal.safeparcel.a.q(parcel, l);
                    break;
    ...
    private static MarkerOptions[] iQ(int i)
    {
