    ...
    extends IInterface
{
        ...
        implements c
    {
        ...
        public static c bG(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 20: // '\024'
                parcel.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                g(d.a.bH(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 27: // '\033'
                parcel.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                h(d.a.bH(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L3:
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            d1 = d.a.bH(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return d1;
            Exception exception;
...
_L1:
            ...
            throws RemoteException
        {
            ...
            parcel1.readException();
            c1 = a.bG(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return c1;
            Exception exception;
...
_L1:
    ...
    public abstract c lh()
        throws RemoteException;

    public abstract d li()
        throws RemoteException;
