...
public final class GoogleAuthUtil
{
    ...
    public static final String SIDEWINDER_ACCOUNT_TYPE = "com.sidewinder";
    ...
    private static boolean aA(String s)
    {
    ...
    {
        return "BadAuthentication".equals(s) || "CaptchaRequired".equals(s) || "DeviceManagementRequiredOrSyncDisabled".equals(s) || "NeedPermission".equals(s) || "NeedsBrowser".equals(s) || "UserCancel".equals(s) || "AppDownloadRequired".equals(s) || Status.DM_SYNC_DISABLED.getWire().equals(s) || Status.DM_ADMIN_BLOCKED.getWire().equals(s) || Status.DM_ADMIN_PENDING_APPROVAL.getWire().equals(s) || Status.DM_STALE_SYNC_REQUIRED.getWire().equals(s) || Status.DM_DEACTIVATED.getWire().equals(s) || Status.DM_REQUIRED.getWire().equals(s);
    }
        ...
        throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException
    {
        ...
        context = new a();
        if (!context1.bindService(Gm, context, 1))
        {
            break MISSING_BLOCK_LABEL_165;
        }
        s = com.google.android.gms.internal.r.a.a(context.hO()).a(s, ((Bundle) (obj)));
        obj = s.getString(Status.EXTRA_KEY_STATUS);
    ...
    {
        a a1;
        kn.b(s, "accountName must be provided");
        kn.be("Calling this from your main thread can lead to deadlock");
        context = context.getApplicationContext();
        B(context);
        a1 = new a();
        if (!context.bindService(Gm, a1, 1))
        {
            break MISSING_BLOCK_LABEL_122;
        }
        s = com.google.android.gms.internal.r.a.a(a1.hO()).getAccountChangeEvents((new AccountChangeEventsRequest()).setAccountName(s).setEventIndex(i)).getEvents();
    ...
    private static String getToken(Context context, String s, String s1, Bundle bundle)
        throws IOException, UserRecoverableAuthException, GoogleAuthException
    {
        Context context1;
        context1 = context.getApplicationContext();
        ...
        s = com.google.android.gms.internal.r.a.a(context.hO()).a(s, s1, bundle);
        if (s != null)
        {
