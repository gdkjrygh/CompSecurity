    ...
    extends IInterface
{
        ...
        implements xj
    {
        ...
        public static xj eo(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof xj))
            {
                return (xj)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            {
                obj = Status.CREATOR;
                obj = StatusCreator.createFromParcel(parcel);
            } else
            {
                obj = null;
            }
            ...
            a(((Status) (obj)), getinstrumentsresponse, parcel);
            parcel1.writeNoException();
            return true;
        }
