...
_L1:
        if (!(obj instanceof ye)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(ey(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String bp(String s)
    {
        int j = s.length();
    ...
    private static String ey(String s)
    {
    ...
    private static String ez(String s)
    {
        String s1 = s;
    ...
    public static String f(ye ye1)
    {
        ...
        try
        {
            a(null, ye1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (ye ye1)
        {
            return (new StringBuilder("Error printing proto: ")).append(ye1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (ye ye1)
        {
