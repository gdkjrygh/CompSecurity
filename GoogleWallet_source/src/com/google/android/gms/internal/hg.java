    ...
    extends IInterface
{
        ...
        implements hg
    {
        ...
        public static hg H(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                a(parcel.readHashMap(getClass().getClassLoader()), parcel.readLong(), parcel.readString(), parcel.createTypedArrayList(hf.CREATOR));
