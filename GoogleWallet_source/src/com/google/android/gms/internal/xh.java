    ...
    extends IInterface
{
        ...
        implements xh
    {
        ...
        public static xh em(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof xh))
            {
                return (xh)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                d = com.google.android.gms.dynamic.d.a.bH(parcel.readStrongBinder());
                c = com.google.android.gms.dynamic.c.a.bG(parcel.readStrongBinder());
                break;
            }
            Object obj;
            if (parcel.readInt() != 0)
            ...
            obj = a(d, c, ((WalletFragmentOptions) (obj)), xf.a.ek(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj1;
            if (obj != null)
            {
                parcel = ((xe) (obj)).asBinder();
            }
        ...
        implements xh
    {
        ...
        public final xe a(d d1, c c1, WalletFragmentOptions walletfragmentoptions, xf xf1)
            throws RemoteException
        {
            Object obj;
            Parcel parcel;
...
_L9:
            ...
            d1 = xe.a.ej(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return d1;
_L2:
...
_L6:
    ...
    public abstract xe a(d d, c c, WalletFragmentOptions walletfragmentoptions, xf xf)
        throws RemoteException;
}
