    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(ph ph1, Parcel parcel, int i)
    {
        i = b.bU(parcel);
        b.a(parcel, 1, ph1.getRequestId(), false);
        b.c(parcel, 1000, ph1.getVersionCode());
        b.a(parcel, 2, ph1.getExpirationTime());
        b.a(parcel, 3, ph1.py());
        b.a(parcel, 4, ph1.getLatitude());
        b.a(parcel, 5, ph1.getLongitude());
        b.a(parcel, 6, ph1.pz());
        b.c(parcel, 7, ph1.getTransitionTypes());
        b.c(parcel, 8, ph1.getNotificationResponsiveness());
        b.c(parcel, 9, ph1.pA());
        b.J(parcel, i);
    }

    public static ph fJ(Parcel parcel)
    {
        ...
        do
        {
            ...
            {
                return new ph(l, s, k, word0, d1, d, f, l1, j, i);
            }
        } while (true);
    }

    private static ph[] ic(int i)
    {
        return new ph[i];
    }
