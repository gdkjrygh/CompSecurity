...
_L6:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            d = com.google.android.gms.dynamic.H(parcel.readStrongBinder());
            c = com.google.android.gms.dynamic.G(parcel.readStrongBinder());
            break;
        }
        Object obj;
        if (parcel.readInt() != 0)
        ...
        obj = a(d, c, ((WalletFragmentOptions) (obj)), ek(parcel.readStrongBinder()));
