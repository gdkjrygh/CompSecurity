    ...
    implements xe
{
        ...
        implements xe
    {
        ...
        public final void a(d d1, WalletFragmentOptions walletfragmentoptions, Bundle bundle)
...
_L1:
    ...
    public static xe ej(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof xe))
        {
            return (xe)iinterface;
        } else
        {
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            d d1 = com.google.android.gms.dynamic.H(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.wallet.fragment.internal.IWalletFragmentDelegate");
            d d2 = com.google.android.gms.dynamic.H(parcel.readStrongBinder());
            d d3 = com.google.android.gms.dynamic.H(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.createFromParcel(parcel);
            } else
