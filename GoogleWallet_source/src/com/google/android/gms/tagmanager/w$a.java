...
final class sorFactory extends SQLiteOpenHelper
{
...
_L1:
    ...
    private static boolean a(String s, SQLiteDatabase sqlitedatabase)
    {
        ...
        sqlitedatabase = null;
_L4:
        bg.w((new StringBuilder("Error querying for table ")).append(s).toString());
        if (sqlitedatabase != null)
        {
            sqlitedatabase.close();
        }
...
_L1:
    ...
    sorFactory(w w1, Context context, String s)
    {
        aNv = w1;
