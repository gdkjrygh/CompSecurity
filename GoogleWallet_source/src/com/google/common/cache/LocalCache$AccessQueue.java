...
static final class rator extends AbstractQueue
{
    ...
    final ry head = new LocalCache.AbstractReferenceEntry() {
        ...
        public final LocalCache.ReferenceEntry getNextInAccessQueue()
        {
            return nextAccess;
        }

        public final LocalCache.ReferenceEntry getPreviousInAccessQueue()
        {
        ...
        public final void setNextInAccessQueue(LocalCache.ReferenceEntry referenceentry)
        {
            nextAccess = referenceentry;
        }

        public final void setPreviousInAccessQueue(LocalCache.ReferenceEntry referenceentry)
        {
