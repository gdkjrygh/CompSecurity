...
public final class GiftCardProto
{
    public static final class GiftCardData extends GeneratedMessageLite
    {
        ...
        private static final GiftCardData defaultInstance;
        ...
        {
            return defaultInstance.toBuilder().mergeFrom(giftcarddata);
        }
        ...
        static 
        {
            PARSER = new AbstractParser() {
                ...
                private static GiftCardData parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
                    throws InvalidProtocolBufferException
                {
                    try
                    {
                        codedinputstream = new GiftCardData(codedinputstream, extensionregistrylite);
                    }
            ...
            defaultInstance = new GiftCardData(Internal.EMPTY_CODED_INPUT_STREAM, ExtensionRegistryLite.getEmptyRegistry());
            GeneratedMessageLite.onLoad(com/google/commerce/ocr/definitions/GiftCardProto$GiftCardData, new com.google.protobuf.GeneratedMessageLite.PrototypeHolder(defaultInstance, PARSER));
        }



/*
        static UnknownFieldSetLite access$2402(GiftCardData giftcarddata, UnknownFieldSetLite unknownfieldsetlite)
        {
            giftcarddata.unknownFields = unknownfieldsetlite;
...
/*
        static ClassData access$2502(GiftCardData giftcarddata, ClassData classdata)
        {
            giftcarddata.classData_ = classdata;
            return classdata;
        }
...
/*
        static InstanceData access$2602(GiftCardData giftcarddata, InstanceData instancedata)
        {
            giftcarddata.instanceData_ = instancedata;
            return instancedata;
        }
...
/*
        static int access$2702(GiftCardData giftcarddata, int i)
        {
            giftcarddata.bitField0_ = i;
            return i;
        }
...
_L11:
    ...
    public static final class GiftCardData.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
    {

        private int bitField0_;
        private GiftCardData.ClassData classData_;
        private GiftCardData.InstanceData instanceData_;

        private GiftCardData.Builder mergeClassData(GiftCardData.ClassData classdata)
        {
            if ((bitField0_ & 1) == 1 && classData_ != null && classData_ != GiftCardData.ClassData.getDefaultInstance())
            {
                classData_ = GiftCardData.ClassData.newBuilder(classData_).mergeFrom(classdata).buildPartial();
            } else
            {
        ...
        private GiftCardData.Builder mergeInstanceData(GiftCardData.InstanceData instancedata)
        {
            if ((bitField0_ & 2) == 2 && instanceData_ != null && instanceData_ != GiftCardData.InstanceData.getDefaultInstance())
            {
                instanceData_ = GiftCardData.InstanceData.newBuilder(instanceData_).mergeFrom(instancedata).buildPartial();
            } else
            {
        ...
        {
            GiftCardData giftcarddata = new GiftCardData(Internal.EMPTY_CODED_INPUT_STREAM, ExtensionRegistryLite.getEmptyRegistry());
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        public final GiftCardData.Builder mergeFrom(GiftCardData giftcarddata)
        {
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        {
            return mergeFrom((GiftCardData)generatedmessagelite);
        }

        public final GiftCardData.Builder setClassData(GiftCardData.ClassData.Builder builder)
        {
            classData_ = (GiftCardData.ClassData)builder.build();
            bitField0_ = bitField0_ | 1;
            return this;
        }

        public final GiftCardData.Builder setInstanceData(GiftCardData.InstanceData.Builder builder)
        {
            instanceData_ = (GiftCardData.InstanceData)builder.build();
            bitField0_ = bitField0_ | 2;
            return this;
        }

        private GiftCardData.Builder()
        {
            super(GiftCardData.defaultInstance);
            classData_ = null;
            instanceData_ = null;
        }
    ...
    public static final class GiftCardData.ClassData extends GeneratedMessageLite
    {

        public static final Parser PARSER;
        private static final GiftCardData.ClassData defaultInstance;
        private static volatile MutableMessageLite mutableDefault = null;
        ...
        public static GiftCardData.ClassData getDefaultInstance()
        {
            return defaultInstance;
        }
        ...
        public static Builder newBuilder(GiftCardData.ClassData classdata)
        {
        ...
        static 
        {
            PARSER = new AbstractParser() {
                ...
                private static GiftCardData.ClassData parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
                    throws InvalidProtocolBufferException
                {
                    try
                    {
                        codedinputstream = new ClassData(codedinputstream, extensionregistrylite);
                    }
                    // Misplaced declaration of an exception variable
                    catch (CodedInputStream codedinputstream)
                    {
...
/*
        static int access$1002(GiftCardData.ClassData classdata, int i)
        {
...
/*
        static UnknownFieldSetLite access$402(GiftCardData.ClassData classdata, UnknownFieldSetLite unknownfieldsetlite)
        {
...
/*
        static Object access$502(GiftCardData.ClassData classdata, Object obj)
        {
...
/*
        static Object access$602(GiftCardData.ClassData classdata, Object obj)
        {
...
/*
        static float access$702(GiftCardData.ClassData classdata, float f)
        {
            classdata.score_ = f;
            return f;
        }
...
/*
        static List access$802(GiftCardData.ClassData classdata, List list)
        {
...
/*
        static Object access$902(GiftCardData.ClassData classdata, Object obj)
        {
...
*/
        ...
        private GiftCardData.ClassData(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
        {
            com.google.protobuf.UnknownFieldSetLite.Builder builder;
            int i;
            boolean flag;
...
_L12:
    ...
    public static final class GiftCardData.ClassData.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
    {
        ...
        private GiftCardData.ClassData.Builder setScore(float f)
        {
            bitField0_ = bitField0_ | 4;
            score_ = f;
            return this;
        ...
        public final GiftCardData.ClassData.Builder addAllAttribution(Iterable iterable)
        {
        ...
        public final GiftCardData.ClassData buildPartial()
        {
            GiftCardData.ClassData classdata = new ClassData(Internal.EMPTY_CODED_INPUT_STREAM, ExtensionRegistryLite.getEmptyRegistry());
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        public final GiftCardData.ClassData.Builder mergeFrom(GiftCardData.ClassData classdata)
        {
            if (classdata == GiftCardData.ClassData.getDefaultInstance())
            {
                return this;
            }
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        public final volatile com.google.protobuf.GeneratedMessageLite.Builder mergeFrom(GeneratedMessageLite generatedmessagelite)
        {
            return mergeFrom((GiftCardData.ClassData)generatedmessagelite);
        }

        public final GiftCardData.ClassData.Builder setDiscoverableId(String s)
        {
            if (s == null)
            {
        ...
        public final GiftCardData.ClassData.Builder setMerchantName(String s)
        {
            if (s == null)
            {
                throw new NullPointerException();
        ...
        private GiftCardData.ClassData.Builder()
        {
            super(GiftCardData.ClassData.defaultInstance);
            merchantName_ = "";
            ocrSystemId_ = "";
            attribution_ = Collections.emptyList();
            discoverableId_ = "";
    ...
    public static final class GiftCardData.InstanceData extends GeneratedMessageLite
    {

        public static final Parser PARSER;
        private static final GiftCardData.InstanceData defaultInstance;
        private static volatile MutableMessageLite mutableDefault = null;
        ...
        public static GiftCardData.InstanceData getDefaultInstance()
        {
            return defaultInstance;
        }
        ...
        public static Builder newBuilder(GiftCardData.InstanceData instancedata)
        {
        ...
        static 
        {
            PARSER = new AbstractParser() {
                ...
                private static GiftCardData.InstanceData parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
                    throws InvalidProtocolBufferException
                {
                    try
                    {
                        codedinputstream = new InstanceData(codedinputstream, extensionregistrylite);
                    }
                    // Misplaced declaration of an exception variable
                    catch (CodedInputStream codedinputstream)
                    {
...
/*
        static UnknownFieldSetLite access$1502(GiftCardData.InstanceData instancedata, UnknownFieldSetLite unknownfieldsetlite)
        {
...
/*
        static PrimitivesProto.RecognizedText access$1602(GiftCardData.InstanceData instancedata, PrimitivesProto.RecognizedText recognizedtext)
        {
...
/*
        static PrimitivesProto.RecognizedText access$1702(GiftCardData.InstanceData instancedata, PrimitivesProto.RecognizedText recognizedtext)
        {
...
/*
        static List access$1802(GiftCardData.InstanceData instancedata, List list)
        {
...
/*
        static List access$1902(GiftCardData.InstanceData instancedata, List list)
        {
...
/*
        static int access$2002(GiftCardData.InstanceData instancedata, int i)
        {
...
*/
        ...
        private GiftCardData.InstanceData(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
        {
...
_L21:
    ...
    public static final class GiftCardData.InstanceData.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
    {
        ...
        private GiftCardData.InstanceData.Builder mergeCardNumber(PrimitivesProto.RecognizedText recognizedtext)
        {
        ...
        private GiftCardData.InstanceData.Builder mergePin(PrimitivesProto.RecognizedText recognizedtext)
        {
        ...
        public final GiftCardData.InstanceData.Builder addAllBarcode(Iterable iterable)
        {
        ...
        public final GiftCardData.InstanceData buildPartial()
        {
            GiftCardData.InstanceData instancedata = new InstanceData(Internal.EMPTY_CODED_INPUT_STREAM, ExtensionRegistryLite.getEmptyRegistry());
        ...
        public final GiftCardData.InstanceData.Builder mergeFrom(GiftCardData.InstanceData instancedata)
        {
            if (instancedata == GiftCardData.InstanceData.getDefaultInstance())
            {
                return this;
            }
        ...
        public final volatile com.google.protobuf.GeneratedMessageLite.Builder mergeFrom(GeneratedMessageLite generatedmessagelite)
        {
            return mergeFrom((GiftCardData.InstanceData)generatedmessagelite);
        }

        public final GiftCardData.InstanceData.Builder setCardNumber(PrimitivesProto.RecognizedText recognizedtext)
        {
        ...
        public final GiftCardData.InstanceData.Builder setPin(PrimitivesProto.RecognizedText recognizedtext)
        {
            if (recognizedtext == null)
            {
                throw new NullPointerException();
        ...
        private GiftCardData.InstanceData.Builder()
        {
            super(GiftCardData.InstanceData.defaultInstance);
            cardNumber_ = null;
            pin_ = null;
            barcode_ = Collections.emptyList();
            textField_ = Collections.emptyList();
