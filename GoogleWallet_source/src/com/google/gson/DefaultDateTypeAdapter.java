...
//            JsonDeserializer, JsonSerializer, JsonParseException, JsonPrimitive, 
//            JsonElement, JsonSyntaxException, JsonDeserializationContext, JsonSerializationContext
    ...
    implements JsonDeserializer, JsonSerializer
{
    ...
    private DefaultDateTypeAdapter(DateFormat dateformat, DateFormat dateformat1)
    {
    ...
    private Date deserialize(JsonElement jsonelement, Type type, JsonDeserializationContext jsondeserializationcontext)
    ...
    private JsonElement serialize(Date date, Type type, JsonSerializationContext jsonserializationcontext)
    {
        synchronized (localFormat)
        {
