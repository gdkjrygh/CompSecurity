...
_L7:
        ...
        {
            Node node1 = this;
            for (Node node = right; node != null; node = node.right)
            {
                node1 = node;
            }
    ...
    private LinkedTreeMap(Comparator comparator1)
    {
        size = 0;
        modCount = 0;
        header = new Node();
    ...
    private Node find(Object obj, boolean flag)
    {
        Node node;
        Node node1;
        Object obj1;
...
_L7:
    ...
    private Node findByObject(Object obj)
    {
        Node node = null;
        if (obj != null)
        {
