...
static final class constructor extends TypeAdapter
{

    private final ObjectConstructor constructor;
    private final TypeAdapter elementTypeAdapter;

    private Collection read(JsonReader jsonreader)
        throws IOException
    {
    ...
    private void write(JsonWriter jsonwriter, Collection collection)
        throws IOException
    {
        if (collection == null)
        {
