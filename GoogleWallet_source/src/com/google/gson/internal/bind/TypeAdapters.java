...
public final class TypeAdapters
{
    static final class EnumTypeAdapter extends TypeAdapter
    {
        ...
        private Enum read(JsonReader jsonreader)
            throws IOException
        {
        ...
        private void write(JsonWriter jsonwriter, Enum enum)
            throws IOException
        {
            if (enum == null)
            {
...
_L1:
    ...
    public static final TypeAdapter BIG_DECIMAL = new TypeAdapter() {
        ...
        private static BigDecimal read(JsonReader jsonreader)
            throws IOException
        {
            if (jsonreader.peek() == JsonToken.NULL)
            {
        ...
        private static void write(JsonWriter jsonwriter, BigDecimal bigdecimal)
            throws IOException
        {
    ...
    public static final TypeAdapter BIG_INTEGER = new TypeAdapter() {
        ...
        private static BigInteger read(JsonReader jsonreader)
            throws IOException
        {
            if (jsonreader.peek() == JsonToken.NULL)
            {
        ...
        private static void write(JsonWriter jsonwriter, BigInteger biginteger)
            throws IOException
        {
    ...
    public static final TypeAdapter BOOLEAN_AS_STRING = new TypeAdapter() {
        ...
        private static Boolean read(JsonReader jsonreader)
            throws IOException
        {
            if (jsonreader.peek() == JsonToken.NULL)
            {
        ...
        private static void write(JsonWriter jsonwriter, Boolean boolean1)
            throws IOException
        {
            if (boolean1 == null)
            {
    ...
    private static TypeAdapterFactory newFactoryForMultipleTypes(Class class1, Class class2, TypeAdapter typeadapter)
    {
        return new TypeAdapterFactory(class1, class2, typeadapter) {
    ...
    private static TypeAdapterFactory newTypeHierarchyFactory(Class class1, TypeAdapter typeadapter)
    {
        return new TypeAdapterFactory(class1, typeadapter) {
    ...
    static 
    {
        CLASS = new TypeAdapter() {
            ...
            private static Class read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, Class class1)
                throws IOException
            {
                if (class1 == null)
                {
        ...
        BIT_SET = new TypeAdapter() {
            ...
            private static BitSet read(JsonReader jsonreader)
                throws IOException
            {
                JsonToken jsontoken;
                BitSet bitset;
...
_L1:
            ...
            private static void write(JsonWriter jsonwriter, BitSet bitset)
                throws IOException
            {
                if (bitset == null)
                {
        ...
        CHARACTER = new TypeAdapter() {
            ...
            private static Character read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, Character character)
                throws IOException
            {
                if (character == null)
                {
        ...
        STRING = new TypeAdapter() {
            ...
            private static String read(JsonReader jsonreader)
                throws IOException
            {
                JsonToken jsontoken = jsonreader.peek();
            ...
            private static void write(JsonWriter jsonwriter, String s)
                throws IOException
            {
                jsonwriter.value(s);
            }
        ...
        STRING_BUILDER = new TypeAdapter() {
            ...
            private static StringBuilder read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, StringBuilder stringbuilder)
                throws IOException
            {
        ...
        STRING_BUFFER = new TypeAdapter() {
            ...
            private static StringBuffer read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, StringBuffer stringbuffer)
                throws IOException
            {
        ...
        URL = new TypeAdapter() {
            ...
            private static URL read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, URL url)
                throws IOException
            {
                if (url == null)
                {
        ...
        URI = new TypeAdapter() {
            ...
            private static URI read(JsonReader jsonreader)
                throws IOException
            {
...
_L3:
            ...
            private static void write(JsonWriter jsonwriter, URI uri)
                throws IOException
            {
                if (uri == null)
                {
        ...
        INET_ADDRESS = new TypeAdapter() {
            ...
            private static InetAddress read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, InetAddress inetaddress)
                throws IOException
            {
                if (inetaddress == null)
                {
        ...
        UUID = new TypeAdapter() {
            ...
            private static UUID read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, UUID uuid)
                throws IOException
            {
                if (uuid == null)
                {
        ...
        LOCALE = new TypeAdapter() {
            ...
            private static Locale read(JsonReader jsonreader)
                throws IOException
            {
                if (jsonreader.peek() == JsonToken.NULL)
                {
            ...
            private static void write(JsonWriter jsonwriter, Locale locale)
                throws IOException
            {
                if (locale == null)
                {
        ...
        JSON_ELEMENT = new TypeAdapter() {
            ...
            private JsonElement read(JsonReader jsonreader)
                throws IOException
            {
            ...
            private void write(JsonWriter jsonwriter, JsonElement jsonelement)
                throws IOException
            {
