...
//            TypeAdapter, Gson, JsonParseException, JsonElement, 
...
final class TreeTypeAdapter extends TypeAdapter
{
        ...
        throws IOException
    {
        ...
        try
        {
            jsonreader = ((JsonReader) (deserializer.deserialize(jsonreader, typeToken.getType(), gson.deserializationContext)));
        }
