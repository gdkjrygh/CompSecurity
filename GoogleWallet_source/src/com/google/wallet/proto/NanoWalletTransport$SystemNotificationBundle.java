...
{
    public static final class SystemNotification extends ExtendableMessageNano
    {
        ...
        private SystemNotification mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
_L6:
...
_L7:
    ...
    public static final class SystemNotification.AndroidSyncParams extends ExtendableMessageNano
    {

        public String entityName;
        public Long timestampMillis;

        private SystemNotification.AndroidSyncParams clear()
        {
            entityName = null;
        ...
        private SystemNotification.AndroidSyncParams mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
            do
            {
        ...
        public SystemNotification.AndroidSyncParams()
        {
            clear();
        }
    }

    public static final class SystemNotification.FetchWobsDiffParams extends ExtendableMessageNano
    {

        public Long updateTimeMillis;

        private SystemNotification.FetchWobsDiffParams clear()
        {
        ...
        private SystemNotification.FetchWobsDiffParams mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
            do
            {
