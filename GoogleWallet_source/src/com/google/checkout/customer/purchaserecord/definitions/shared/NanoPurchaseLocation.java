...
{
    public static final class PurchaseLocation extends ExtendableMessageNano
    {
        ...
        private PurchaseLocation clear()
        {
            address = null;
            latitudeE7 = null;
            longitudeE7 = null;
        ...
        private PurchaseLocation mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
            do
            {
                ...
                case 10: // '\n'
                    if (address == null)
                    {
                        address = new NanoAddress.Address();
                    }
