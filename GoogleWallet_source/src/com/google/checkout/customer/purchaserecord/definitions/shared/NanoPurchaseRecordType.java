...
public interface NanoPurchaseRecordType
{
    public static final class PurchaseRecordType extends ExtendableMessageNano
    {

        public Integer type;

        private PurchaseRecordType clear()
        {
            type = null;
        ...
        private PurchaseRecordType mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
_L4:
