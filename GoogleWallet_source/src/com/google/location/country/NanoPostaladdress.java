...
{
    public static final class PostalAddress extends ExtendableMessageNano
    {
        ...
        private PostalAddress mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
            do
            {
