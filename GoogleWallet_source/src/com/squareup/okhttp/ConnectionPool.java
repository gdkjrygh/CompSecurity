...
_L2:
        ...
        Platform.get();
        Platform.logW((new StringBuilder("Unable to tagSocket(): ")).append(socketexception).toString());
...
_L1:
    ...
    final void recycle(Connection connection)
    {
        ...
        {
            Platform.get();
            Platform.logW((new StringBuilder("Unable to untagSocket(): ")).append(socketexception).toString());
            Util.closeQuietly(connection.getSocket());
            return;
        }
        this;
