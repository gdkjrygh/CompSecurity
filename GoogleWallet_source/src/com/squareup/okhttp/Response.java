...
//            Headers, CacheControl, Request, ResponseBody, 
//            Handshake, Protocol
...
public final class Response
{
    public static final class Builder
    {
        ...
        public final Builder handshake(Handshake handshake1)
        {
        ...
        public final Builder message(String s)
        {
            message = s;
            return this;
        }
        ...
        public final Builder protocol(Protocol protocol1)
        {
            protocol = protocol1;
            return this;
        }

        public final Builder request(Request request1)
        {
            request = request1;
            return this;
        }
    ...
    private String header(String s, String s1)
    {
        s = headers.get(s);
        if (s != null)
        {
