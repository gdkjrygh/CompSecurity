...
//            Protocol, Route, Address, Request, 
//            Response, ConnectionSpec, Handshake, CertificatePinner, 
...
public final class Connection
{
    ...
    private void connect(int i, int j, int k, Request request)
        throws IOException
    {
        if (connected)
        {
    ...
    private void setTimeouts(int i, int j)
        throws IOException
    {
        if (!connected)
        {
