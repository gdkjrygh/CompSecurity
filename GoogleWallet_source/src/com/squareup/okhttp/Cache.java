...
public final class Cache
{
    ...
    static final class Entry
    {
        ...
        private static List readCertificateList(BufferedSource bufferedsource)
            throws IOException
        {
...
_L3:
        ...
        private static void writeCertArray(BufferedSink bufferedsink, List list)
            throws IOException
        {
            int i;
            int j;
...
_L1:
            ...
            throws IOException
        {
            ...
            editor.writeByte(10);
            editor.writeUtf8(Integer.toString(varyHeaders.size()));
            editor.writeByte(10);
            int i = 0;
            ...
            editor.writeByte(10);
            editor.writeUtf8(Integer.toString(responseHeaders.size()));
            editor.writeByte(10);
            i = 0;
...
_L2:
            ...
            ((Headers.Builder) (obj1)).addLine(((BufferedSource) (obj)).readUtf8LineStrict());
            i++;
            if (true) goto _L2; else goto _L1
_L1:
...
_L5:
    ...
    final InternalCache internalCache = new InternalCache() {
        ...
        public final void update(Response response, Response response1)
            throws IOException
        {
    ...
    private static void abortQuietly(com.squareup.okhttp.internal.DiskLruCache.Editor editor)
    {
        if (editor == null)
        {
...
/* anonymous class */
    final class CacheResponseBody._cls1 extends ForwardingSource
    {
