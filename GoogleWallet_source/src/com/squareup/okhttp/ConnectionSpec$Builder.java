...
public static final class <init>
{
    ...
    public final transient <init> cipherSuites(CipherSuite aciphersuite[])
    {
        if (!tls)
        {
    ...
    final cipherSuites cipherSuites(String as[])
    {
        cipherSuites = as;
        return this;
    }
    ...
    final transient tlsVersions tlsVersions(String as[])
    {
        tlsVersions = as;
        return this;
    }
