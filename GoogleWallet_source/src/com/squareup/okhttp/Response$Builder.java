...
public static final class <init>
{
    ...
    private static void checkPriorResponse(Response response)
    {
    ...
    private static void checkSupportResponse(String s, Response response)
    {
        if (Response.access$1700(response) != null)
        {
    ...
    public final nit> addHeader(String s, String s1)
    {
        headers.dd(s, s1);
        return this;
    }

    public final dd body(ResponseBody responsebody)
    {
        body = responsebody;
        return this;
    }
    ...
    public final code cacheResponse(Response response)
    {
        if (response != null)
        {
    ...
    public final cacheResponse code(int i)
    {
        code = i;
        return this;
    }

    public final code handshake(Handshake handshake1)
    {
        handshake = handshake1;
        return this;
    }

    public final handshake header(String s, String s1)
    {
        headers.et(s, s1);
        return this;
    }

    public final et headers(Headers headers1)
    {
        headers = headers1.newBuilder();
        return this;
    }

    public final r message(String s)
    {
        message = s;
        return this;
    }

    public final message networkResponse(Response response)
    {
        if (response != null)
        {
    ...
    public final networkResponse priorResponse(Response response)
    {
        if (response != null)
        {
    ...
    public final priorResponse protocol(Protocol protocol1)
    {
        protocol = protocol1;
        return this;
    }

    public final protocol request(Request request1)
    {
        request = request1;
        return this;
    }
