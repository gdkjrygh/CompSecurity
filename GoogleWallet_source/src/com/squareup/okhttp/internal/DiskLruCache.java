...
*/
    ...
    final class Editor.FaultHidingSink extends ForwardingSink
    {
    ...
    final class Entry
    {
        ...
        private static IOException invalidLengths(String as[])
            throws IOException
        {
...
label0:
    ...
    private DiskLruCache(File file, int i, int j, long l, Executor executor1)
    {
        size = 0L;
...
_L10:
        ...
        throws IOException
    {
        ...
        if (journalFile.exists())
        {
            ...
            {
                Platform.get();
                Platform.logW((new StringBuilder("DiskLruCache ")).append(directory).append(" is corrupt: ").append(ioexception.getMessage()).append(", removing").toString());
                delete();
            }
        }
        directory.mkdirs();
