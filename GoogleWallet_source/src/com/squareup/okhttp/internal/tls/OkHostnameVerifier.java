...
_L6:
    ...
    private boolean verify(String s, X509Certificate x509certificate)
    {
    ...
    private static boolean verifyAsIpAddress(String s)
    {
    ...
    private static boolean verifyIpAddress(String s, X509Certificate x509certificate)
    {
