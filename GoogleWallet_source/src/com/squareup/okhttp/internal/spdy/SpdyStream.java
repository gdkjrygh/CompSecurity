...
_L3:
            ...
            JVM INSTR monitorexit ;
            l1 -= l;
            connection.writeData(id, false, buffer, l);
_L1:
            if (l1 <= 0L)
            {
...
label0:
        ...
        final void receive(BufferedSource bufferedsource, long l)
            throws IOException
        {
            long l1;
            l1 = l;
...
*/
    ...
    final class SpdyTimeout extends AsyncTimeout
    {
...
_L3:
    ...
    final void receiveData(BufferedSource bufferedsource, int i)
        throws IOException
    {
        if (!$assertionsDisabled && Thread.holdsLock(this))
        {
