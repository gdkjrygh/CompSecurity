...
public final class RouteSelector
{
        ...
        throws IOException
    {
        ...
        {
            throw new SocketException((new StringBuilder("No route to ")).append(address.getUriHost()).append("; exhausted connection specs: ").append(connectionSpecs).toString());
        } else
        {
    ...
    private Connection nextUnconnected()
        throws IOException
    {
        do
        {
        ...
        throws UnknownHostException
    {
        ...
        System.out.println((new StringBuilder("Found ")).append(inetSocketAddresses.size()).append(" addresses to connect to, out of which ").append(k).append(" are on Ipv6").toString());
...
_L3:
    ...
    public final Connection next(HttpEngine httpengine)
        throws IOException
    {
