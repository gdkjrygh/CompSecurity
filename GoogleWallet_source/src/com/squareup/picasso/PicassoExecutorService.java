...
{
    static final class PicassoFutureTask extends FutureTask
        implements Comparable
    {

        private final BitmapHunter hunter;

        private int compareTo(PicassoFutureTask picassofuturetask)
        {
    ...
    final void adjustThreadCount(NetworkInfo networkinfo)
    {
