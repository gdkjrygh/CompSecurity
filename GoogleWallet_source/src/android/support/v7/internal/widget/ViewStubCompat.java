    ...
    public final View inflate()
    {
        ...
        if (obj != null && (obj instanceof ViewGroup))
        {
            if (mLayoutResource != 0)
            {
                ...
                obj = ((LayoutInflater) (obj)).inflate(mLayoutResource, ((ViewGroup) (obj1)), false);
                if (mInflatedId != -1)
                {
                    ((View) (obj)).setId(mInflatedId);
                }
                i = ((ViewGroup) (obj1)).indexOfChild(this);
                ((ViewGroup) (obj1)).removeViewInLayout(this);
