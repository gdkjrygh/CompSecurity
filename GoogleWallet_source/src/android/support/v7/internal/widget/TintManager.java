...
{
    static final class ColorFilterLruCache extends LruCache
    {
        ...
        final PorterDuffColorFilter get(int i, android.graphics.PorterDuff.Mode mode)
        {
            return (PorterDuffColorFilter)get(Integer.valueOf(generateCacheKey(i, mode)));
        }

        final PorterDuffColorFilter put(int i, android.graphics.PorterDuff.Mode mode, PorterDuffColorFilter porterduffcolorfilter)
        {
    ...
    private int getDisabledThemeAttrColor(int i)
    {
    ...
    private int getThemeAttrColor(int i, float f)
    {
...
label0:
    ...
    final void tintDrawable(int i, Drawable drawable)
    {
