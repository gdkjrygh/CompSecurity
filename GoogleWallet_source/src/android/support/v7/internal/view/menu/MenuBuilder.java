...
_L3:
    ...
    private int findGroupIndex(int i, int j)
    {
        int l = size();
        int k = j;
        if (j < 0)
...
label0:
    ...
    public final ArrayList getActionItems()
    {
        flagActionItems();
        return mActionItems;
    }
    ...
    final void onItemActionRequestChanged(MenuItemImpl menuitemimpl)
    {
        mIsActionItemsStale = true;
        onItemsChanged(true);
    }

    final void onItemVisibleChanged(MenuItemImpl menuitemimpl)
    {
        mIsVisibleItemsStale = true;
        onItemsChanged(true);
    }
...
_L6:
    ...
    public final MenuBuilder setDefaultShowAsAction(int i)
    {
