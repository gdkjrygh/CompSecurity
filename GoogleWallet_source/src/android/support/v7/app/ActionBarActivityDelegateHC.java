...
final class ActionBarActivityDelegateHC extends ActionBarActivityDelegateBase
    implements android.support.v7.internal.widget.NativeActionModeAwareLayout.OnActionModeForChildListener
{
    ...
    final boolean onKeyDown(int i, KeyEvent keyevent)
    {
        return false;
    }

    final void onSubDecorInstalled()
    {
    ...
    public final ActionMode startActionModeForChild(View view, android.view.ActionMode.Callback callback)
    {
