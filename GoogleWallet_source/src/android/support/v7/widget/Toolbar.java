...
_L8:
    ...
    public static class LayoutParams extends android.support.v7.app.ActionBar.LayoutParams
    {
        ...
        private void copyMarginsFromCompat(android.view.ViewGroup.MarginLayoutParams marginlayoutparams)
        {
...
_L6:
    ...
    private int getContentInsetLeft()
    {
        return mContentInsets.getLeft();
    }

    private int getContentInsetRight()
    {
    ...
    private static int getViewListMeasuredWidth(List list, int ai[])
    {
        int l = ai[0];
        int k = ai[1];
        int j = 0;
...
_L3:
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        if (shouldLayout(mNavButtonView))
        {
            ...
            {
                i = layoutChildLeft(mNavButtonView, l2, ai, i3);
                j = l;
            }
        }
        k = i;
...
_L13:
        if (j1 != 0)
        {
            ...
            if (flag2)
            {
                ...
                mSubtitleTextView.layout(j - l1, i, j, i + j2);
        ...
        while (l < j2) 
        {
            ...
            if (((LayoutParams)view.getLayoutParams()).mViewType == 0)
            {
                ...
                if (shouldLayout(view))
                {
                    ...
                    i1 = Math.max(l1, view.getMeasuredHeight() + getVerticalMargins(view));
