...
{
    static final class DropDownListView extends ListViewCompat
    {
...
_L3:
    ...
    final class ForwardingListener.DisallowIntercept
        implements Runnable
    {
    ...
    final class ForwardingListener.TriggerLongPress
        implements Runnable
    {
    ...
    final class PopupScrollListener
    ...
    final class PopupTouchInterceptor
        implements android.view.View.OnTouchListener
    {
...
_L3:
    ...
    final class ResizePopupRunnable
        implements Runnable
    {
...
_L8:
        mDropDownWidth;
        JVM INSTR tableswitch -2 -1: default 532
    //                   -2 585
    //                   -1 625;
           goto _L10 _L11 _L12
_L10:
...
_L3:
    ...
    public final void setOnItemClickListener(android.widget.AdapterView.OnItemClickListener onitemclicklistener)
    {
...
/* anonymous class */
    final class _cls1 extends ForwardingListener
    {
