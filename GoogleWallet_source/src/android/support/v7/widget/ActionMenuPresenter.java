    ...
    implements android.support.v4.view.ActionProvider.SubUiVisibilityListener
{
    ...
    final class ActionMenuPopupCallback extends android.support.v7.internal.view.menu.ActionMenuItemView.PopupCallback
    {
    ...
    final class OverflowMenuButton extends TintImageView
    ...
    final class PopupPresenterCallback
...
_L3:
    ...
    public final void onSubUiVisibilityChanged(boolean flag)
    {
        if (flag)
        {
    ...
    public final void setExpandedActionViewsExclusive(boolean flag)
    {
    ...
    public final void setReserveOverflow(boolean flag)
    {
        mReserveOverflow = flag;
        mReserveOverflowSet = true;
    }

    public final void setWidthLimit(int i, boolean flag)
    {
        mWidthLimit = i;
