...
{
    static final class AutoCompleteTextViewReflector
    {
        ...
        final void doAfterTextChanged(AutoCompleteTextView autocompletetextview)
        {
        ...
        final void doBeforeTextChanged(AutoCompleteTextView autocompletetextview)
        {
        ...
        final void ensureImeVisible(AutoCompleteTextView autocompletetextview, boolean flag)
        {
        ...
        final void showSoftInputUnchecked(InputMethodManager inputmethodmanager, View view, int i)
        {
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView
    {
        ...
        final void setSearchView(SearchView searchview)
        {
    ...
    android.view.View.OnKeyListener mTextKeyListener = new android.view.View.OnKeyListener() {
        ...
        public final boolean onKey(View view, int j, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mQueryTextView.isEmpty() && KeyEventCompat.hasNoModifiers(keyevent) && keyevent.getAction() == 1 && j == 66)
                {
...
_L5:
    ...
    private void adjustDropDownSizeAndPosition()
    {
        if (mDropDownAnchor.getWidth() > 1)
        {
            ...
            l = rect.left;
            i1 = rect.right;
            mQueryTextView.setDropDownWidth((j + l + i1 + i) - k);
        }
    }
...
_L8:
    ...
    private static Intent createVoiceWebSearchIntent(Intent intent, SearchableInfo searchableinfo)
    {
...
_L5:
    ...
    final void onQueryRefine(CharSequence charsequence)
    {
