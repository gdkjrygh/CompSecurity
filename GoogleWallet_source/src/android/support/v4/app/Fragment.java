...
//            FragmentManagerImpl, LoaderManagerImpl, FragmentActivity, SuperNotCalledException, 
    ...
    implements ComponentCallbacks, android.view.View.OnCreateContextMenuListener
{
    ...
    private static boolean onContextItemSelected(MenuItem menuitem)
    {
        return false;
    }

    public static Animation onCreateAnimation(int i, boolean flag, int j)
    {
        return null;
    }
    ...
    public static void onHiddenChanged(boolean flag)
    {
    }
...
_L5:
    ...
    final void performActivityCreated(Bundle bundle)
    {
        if (mChildFragmentManager != null)
        {
    ...
    final boolean performContextItemSelected(MenuItem menuitem)
    {
    ...
    final boolean performCreateOptionsMenu(Menu menu, MenuInflater menuinflater)
    {
        boolean flag1 = false;
        boolean flag2 = false;
        if (!mHidden)
    ...
    final boolean performOptionsItemSelected(MenuItem menuitem)
    {
