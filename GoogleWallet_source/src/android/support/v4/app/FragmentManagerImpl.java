    ...
    implements android.view.LayoutInflater.Factory
{
    ...
    private static Animation makeFadeAnimation(Context context, float f, float f1)
    {
    ...
    private static Animation makeOpenCloseAnimation(Context context, float f, float f1, float f2, float f3)
    {
    ...
    private void moveToState(int i, boolean flag)
    {
...
_L3:
    ...
    private static int transitToStyleIndex(int i, boolean flag)
    {
        switch (i)
        {
        default:
                ...
                if (mBackStack != null)
                {
                    ...
                    if (i1 > 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (DEBUG)
                            {
                                Log.v("FragmentManager", (new StringBuilder("saveAllState: adding back stack #")).append(k).append(": ").append(mBackStack.get(k)).toString());
                            }
                            k++;
                        } while (true);
                    }
