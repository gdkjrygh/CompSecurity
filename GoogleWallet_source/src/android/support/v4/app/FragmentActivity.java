...
//            FragmentManagerImpl, LoaderManagerImpl, ActivityCompat, Fragment, 
...
_L9:
    ...
    final LoaderManagerImpl getLoaderManager(String s, boolean flag, boolean flag1)
    {
    ...
    final void invalidateSupportFragment(String s)
    {
        if (mAllLoaderManagers != null)
        {
            LoaderManagerImpl loadermanagerimpl = (LoaderManagerImpl)mAllLoaderManagers.get(s);
