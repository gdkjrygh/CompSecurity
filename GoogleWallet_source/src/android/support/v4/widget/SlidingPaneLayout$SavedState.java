...
static final class <init> extends android.view.t.SavedState
{

    public static final android.os.out.SavedState.isOpen CREATOR = new android.os.Parcelable.Creator() {

        private static SlidingPaneLayout.SavedState createFromParcel(Parcel parcel)
        {
            return new SlidingPaneLayout.SavedState(parcel, null);
        }

        private static SlidingPaneLayout.SavedState[] newArray(int i)
        {
