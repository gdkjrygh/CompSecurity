    ...
    implements android.view.View.OnTouchListener
{
    static final class ClampedScroller
    {
        ...
        public final void setTargetVelocity(float f, float f1)
        {
            mTargetVelocityX = f;
            mTargetVelocityY = f1;
        }
...
_L5:
    ...
    private AutoScrollHelper setActivationDelay(int i)
    {
        mActivationDelay = i;
        return this;
    }

    private AutoScrollHelper setEdgeType(int i)
    {
        mEdgeType = i;
        return this;
    }

    private AutoScrollHelper setMaximumEdges(float f, float f1)
    {
        mMaximumEdges[0] = f;
        mMaximumEdges[1] = f1;
        return this;
    ...
    private AutoScrollHelper setMaximumVelocity(float f, float f1)
    {
    ...
    private AutoScrollHelper setMinimumVelocity(float f, float f1)
    {
    ...
    private AutoScrollHelper setRampDownDuration(int i)
    {
        mScroller.setRampDownDuration(i);
        return this;
    }

    private AutoScrollHelper setRampUpDuration(int i)
    {
        mScroller.setRampUpDuration(i);
        return this;
    }

    private AutoScrollHelper setRelativeEdges(float f, float f1)
    {
        mRelativeEdges[0] = f;
        mRelativeEdges[1] = f1;
        return this;
    ...
    private AutoScrollHelper setRelativeVelocity(float f, float f1)
    {
