...
{
    static final class AsyncTaskResult
    {
    ...
    static final class InternalHandler extends Handler
    {
        ...
        public final void handleMessage(Message message)
        {
            ...
            case 2: // '\002'
                message = asynctaskresult.mTask;
                break;
            }
            ModernAsyncTask.onProgressUpdate(asynctaskresult.mData);
        }
    ...
    protected static transient void onProgressUpdate(Object aobj[])
    {
    }
