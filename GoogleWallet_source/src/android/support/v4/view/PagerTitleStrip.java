...
{
    final class PageListener extends DataSetObserver
        implements ViewPager.OnAdapterChangeListener, ViewPager.OnPageChangeListener
    {
        ...
        public final void onAdapterChanged(PagerAdapter pageradapter, PagerAdapter pageradapter1)
        {
        ...
        implements PagerTitleStripImpl
    {
        ...
        public final void setSingleLineAllCaps(TextView textview)
        {
    ...
    final void updateAdapter(PagerAdapter pageradapter, PagerAdapter pageradapter1)
    {
