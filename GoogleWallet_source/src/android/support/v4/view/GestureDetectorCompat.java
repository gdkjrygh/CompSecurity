...
public final class GestureDetectorCompat
{
        ...
        implements GestureDetectorCompatImpl
    {
        ...
        private void setOnDoubleTapListener(android.view.GestureDetector.OnDoubleTapListener ondoubletaplistener)
        {
...
_L2:
            ...
            if (mDoubleTapListener != null)
            {
                ...
                if (mCurrentDownEvent != null && mPreviousUpEvent != null && flag1 && isConsideredDoubleTap(mCurrentDownEvent, mPreviousUpEvent, motionevent))
                {
                    ...
                    k = mDoubleTapListener.onDoubleTap(mCurrentDownEvent) | false | mDoubleTapListener.onDoubleTapEvent(motionevent);
                } else
                {
...
_L4:
            ...
            {
                flag1 = mListener.onScroll(mCurrentDownEvent, motionevent, f4, f6);
                mLastFocusX = f2;
                mLastFocusY = f;
                mAlwaysInTapRegion = false;
                mHandler.removeMessages(3);
...
_L19:
            flag1 = mListener.onFling(mCurrentDownEvent, motionevent, f2, f);
              goto _L15
_L5:
            cancel();
            return false;
...
*/
    ...
    final class GestureDetectorCompatImplBase.GestureHandler extends Handler
    {
