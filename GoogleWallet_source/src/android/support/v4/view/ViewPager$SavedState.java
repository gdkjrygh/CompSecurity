...
public static final class loader extends android.view.SavedState
{
    ...
    public static final android.os.CompatCreatorCallbacks CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks() {
        ...
        private static ViewPager.SavedState createFromParcel(Parcel parcel, ClassLoader classloader)
        {
            return new ViewPager.SavedState(parcel, classloader);
        }

        private static ViewPager.SavedState[] newArray(int i)
        {
