    ...
    implements PageIndicator
{
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        } else
        {
            ...
            mPaintPageFill.setColor(attributeset.getColor(4, j));
            mPaintStroke.setStyle(android.graphics.Paint.Style.STROKE);
            mPaintStroke.setColor(attributeset.getColor(7, i1));
            mPaintStroke.setStrokeWidth(attributeset.getDimension(2, f));
            mPaintFill.setStyle(android.graphics.Paint.Style.FILL);
            mPaintFill.setColor(attributeset.getColor(3, k));
            mRadius = attributeset.getDimension(5, f1);
            mSnap = attributeset.getBoolean(6, flag1);
