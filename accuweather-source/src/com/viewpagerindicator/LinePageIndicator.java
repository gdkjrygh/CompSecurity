    ...
    implements PageIndicator
{
    ...
    public LinePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        } else
        {
            ...
            mCentered = attributeset.getBoolean(0, flag);
            mLineWidth = attributeset.getDimension(4, f);
            mGapWidth = attributeset.getDimension(5, f1);
            setStrokeWidth(attributeset.getDimension(2, f2));
            mPaintUnselected.setColor(attributeset.getColor(3, k));
            mPaintSelected.setColor(attributeset.getColor(1, j));
