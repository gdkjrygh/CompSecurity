    ...
    implements com.actionbarsherlock.internal.view.menu.MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, com.actionbarsherlock.internal.view.menu.MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener
{
    ...
    private ViewGroup generateLayout()
    {
        ...
        mIsFloating = ((TypedArray) (obj)).getBoolean(0, false);
        if (!((TypedArray) (obj)).hasValue(60))
        {
        ...
        do
        {
            ...
            if (((TypedArray) (obj)).getBoolean(62, false))
            {
                requestFeature(10);
            }
...
_L3:
        if (!hasFeature(1)) goto _L6; else goto _L5
_L5:
...
_L4:
        ...
        if (wActionBar == null) goto _L2; else goto _L7
_L7:
        boolean flag1;
        ...
        if (actionbarcontainer == null) goto _L9; else goto _L8
_L8:
