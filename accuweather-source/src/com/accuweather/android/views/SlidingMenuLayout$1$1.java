    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/accuweather/android/views/SlidingMenuLayout$1

/* anonymous class */
    class SlidingMenuLayout._cls1 extends TimerTask
    {
        ...
        public void run()
        {
            ...
            ((Activity)getContext()).runOnUiThread(new SlidingMenuLayout._cls1._cls1());
        }
