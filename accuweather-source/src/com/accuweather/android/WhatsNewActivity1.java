...
//            SetupActivity, WhatsNewActivity2

public class WhatsNewActivity1 extends SetupActivity
{

    public WhatsNewActivity1()
    {
    }
    ...
    {
        Intent intent = (new Intent(this, com/accuweather/android/WhatsNewActivity2)).addFlags(0x4000000);
        if (getIntent() != null)
        {
    ...
    {
        return PreferenceUtils.get(this, "whats_new_page1_viewed", false);
    }

    private void init()
    {
        setContentView(R.layout.whats_new_page_1);
        ...
        findViewById(R.id.nextButton).setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final WhatsNewActivity1 this$0;
    ...
    {
        PreferenceUtils.save(this, "whats_new_page1_viewed", true);
    }
    ...
    public void setTypeFaces()
    {
        ...
        Utilities.setTypeFace(findViewById(R.id.newMinuteCastTextView), Data.getRobotoCondensed());
        Utilities.setTypeFace(findViewById(R.id.minuteCastDescriptionTextView), Data.getRobotoCondensed());
    }
