...
public class HoloDark_WidgetConfigurationActivity extends WidgetConfigurationActivity
{

    public static final String DEBUG_TAG = "WidgetConfigurationActivity";

    public HoloDark_WidgetConfigurationActivity()
    {
    }
    ...
    public Bundle buildExtras()
    {
        ...
        bundle.putBoolean("is_from_holo_dark", true);
