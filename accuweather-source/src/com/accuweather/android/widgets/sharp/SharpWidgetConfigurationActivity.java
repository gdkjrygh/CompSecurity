...
public class SharpWidgetConfigurationActivity extends WidgetConfigurationActivity
{
    ...
    public SharpWidgetConfigurationActivity()
    {
    }
    ...
    {
        return getData().getSharpWidgetIdMap();
    }
