...
_L4:
        ...
        {
            AB.putString(((String) (obj1)), (String)obj);
        }
        continue; /* Loop/switch isn't completed */
_L7:
        try
...
_L5:
        ...
        {
            AB.putInt(((String) (obj1)), ((Integer)obj).intValue());
        }
        continue; /* Loop/switch isn't completed */
_L6:
        if (obj instanceof Double)
        {
            AB.putDouble(((String) (obj1)), ((Double)obj).doubleValue());
        }
        continue; /* Loop/switch isn't completed */
_L2:
        ...
        {
            AB.putString(((String) (obj)), (String)obj1);
            continue; /* Loop/switch isn't completed */
        }
        if (obj1 instanceof Integer)
        {
            AB.putInt(((String) (obj)), ((Integer)obj1).intValue());
            continue; /* Loop/switch isn't completed */
        }
        try
        {
            ...
            {
                AB.putDouble(((String) (obj)), ((Double)obj1).doubleValue());
            }
            continue; /* Loop/switch isn't completed */
        }
        // Misplaced declaration of an exception variable
...
_L8:
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!a(AB, ((MediaMetadata) (obj)).AB) || !zN.equals(((MediaMetadata) (obj)).zN))
            {
                return false;
            }
        }
    ...
    public int hashCode()
    {
        ...
        String s;
        int i;
        for (i = 17; iterator.hasNext(); i = AB.get(s).hashCode() + i * 31)
        {
            s = (String)iterator.next();
        }
