    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(as as1, Parcel parcel, int i)
    {
        ...
        b.a(parcel, 3, as1.alY);
        b.b(parcel, 4, as1.ama, false);
        b.G(parcel, i);
    }
    ...
    public as cK(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < k)
            {
                ...
                case 4: // '\004'
                    arraylist = com.google.android.gms.common.internal.safeparcel.a.c(parcel, l, ak.CREATOR);
                    break;
                }
            } else
            if (parcel.dataPosition() != k)
            ...
            {
                return new as(j, i, l1, arraylist);
            }
        } while (true);
    }
