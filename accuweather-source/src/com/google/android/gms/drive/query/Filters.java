...
public class Filters
{
    ...
    {
        return new LogicalFilter(Operator.Lc, filter, afilter);
    }
    ...
    {
        return new ComparisonFilter(Operator.Lf, searchablemetadatafield, s);
    }
    ...
    {
        return new LogicalFilter(Operator.Ld, filter, afilter);
    }
