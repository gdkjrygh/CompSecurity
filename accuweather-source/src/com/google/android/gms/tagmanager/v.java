...
_L4:
    ...
    private List e(List list)
    {
        ...
        b b1;
        for (list = list.iterator(); list.hasNext(); arraylist.add(new DataLayer.a(b1.JI, j(b1.afp))))
        {
            b1 = (b)list.next();
        }
    ...
    private List f(List list)
    {
        ArrayList arraylist = new ArrayList();
        DataLayer.a a1;
        for (list = list.iterator(); list.hasNext(); arraylist.add(new b(a1.JI, j(a1.afe))))
        {
...
_L4:
    ...
    {
        list = f(list);
        afh.execute(new Runnable(list, l) {
