...
_L3:
        ...
        public SQLiteDatabase getWritableDatabase()
        {
            ...
            if (wU && wV + 0x36ee80L > ca.a(agq).currentTimeMillis())
            {
...
_L1:
    ...
    private static final String wM = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[] {
    ...
    ca(au au1, Context context, String s, int i)
    {
        ...
        agp = au1;
        aec = im.fW();
        agn = new b(mContext, wP);
        ago = new da(new DefaultHttpClient(), mContext, new a());
        wR = 0L;
        wS = i;
    }
    ...
    private SQLiteDatabase S(String s)
    {
        ...
        try
        {
            sqlitedatabase = agn.getWritableDatabase();
        }
...
_L6:
        bh.D(String.format("HitString for hitId %d too large.  Hit will be deleted.", new Object[] {
            Long.valueOf(((ap)((List) (obj3)).get(i)).dg())
        }));
          goto _L9
        obj1;
        obj = obj2;
...
_L11:
        ...
        obj1 = obj;
        flag1 = TextUtils.isEmpty(((ap) (obj4)).lJ());
        int j;
        j = i;
        if (!flag1)
        {
        ...
        if (l > wR + 0x5265c00L)
        {
            ...
            if (obj != null)
            {
                int i = ((SQLiteDatabase) (obj)).delete("gtm_hits", "HIT_TIME < ?", new String[] {
                    Long.toString(aec.currentTimeMillis() - 0x9a7ec800L)
                });
                obj = agp;
                if (_mthdo() != 0)
                {
