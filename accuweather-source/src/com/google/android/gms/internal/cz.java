...
public final class cz
{
    ...
    public static int a(Bundle bundle)
    {
        ...
        {
            ev.D((new StringBuilder()).append("Unexpected type for intent response code. ").append(bundle.getClass().getName()).toString());
            return 5;
        }
    }
    ...
    public static int c(Intent intent)
    {
        ...
        {
            ev.D((new StringBuilder()).append("Unexpected type for intent response code. ").append(intent.getClass().getName()).toString());
            return 5;
        }
    }
