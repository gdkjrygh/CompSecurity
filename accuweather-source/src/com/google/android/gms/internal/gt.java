...
public class gt
{
    ...
    private static final String CM = (new StringBuilder()).append("yyyyMMdd'T'HHmmss").append(CL[0]).toString();
    ...
    public static String a(Calendar calendar)
    {
        ...
        } else
        {
            ...
            {
                return ((String) (obj)).replace("+0000", CL[0]);
            }
        }
        return calendar;
    }
...
_L1:
    ...
    public static void a(JSONObject jsonobject, List list)
    {
        ...
        for (list = list.iterator(); list.hasNext(); jsonarray.put(((WebImage)list.next()).dU())) { }
    ...
    public static Calendar aq(String s)
    {
        ...
        {
            BD.b("Error parsing string: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
    ...
    private static String ar(String s)
    {
        ...
        {
            BD.c("Error extracting the date: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L2:
        ...
        {
            BD.b("Error extracting the time substring: %s", new Object[] {
                s.getMessage()
            });
            return null;
        }
...
_L6:
        ...
        if (s.length() != "HHmmss".length() + CL[0].length()) goto _L7; else goto _L8
_L8:
