...
public final class eu
{
    ...
    public static void a(ViewGroup viewgroup, am am1, String s)
    {
        a(viewgroup, am1, s, 0xff000000, -1);
    }

    private static void a(ViewGroup viewgroup, am am1, String s, int i, int j)
    {
        ...
        } else
        {
            ...
            i = a(context, 3);
            s.addView(textview, new android.widget.FrameLayout.LayoutParams(am1.widthPixels - i, am1.heightPixels - i, 17));
            viewgroup.addView(s, am1.widthPixels, am1.heightPixels);
            return;
        }
    }

    public static void a(ViewGroup viewgroup, am am1, String s, String s1)
    {
        ev.D(s1);
        a(viewgroup, am1, s, 0xffff0000, 0xff000000);
    }
