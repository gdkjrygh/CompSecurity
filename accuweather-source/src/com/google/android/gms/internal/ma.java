...
public final class ma
{
    ...
    private ma(byte abyte0[], int i, int j)
    {
        buffer = abyte0;
        position = i;
        amT = i + j;
    ...
    public static int b(int i, mf mf1)
    {
        return eH(i) + c(mf1);
    }
    ...
    public static ma b(byte abyte0[], int i, int j)
    {
        return new ma(abyte0, i, j);
    }
    ...
    public static ma q(byte abyte0[])
    {
