...
_L8:
        flag = flag1;
        if (!md.equals(fO, ((fO) (obj)).fO)) goto _L4; else goto _L9
_L9:
        flag = flag1;
        if (!md.equals(fP, ((fP) (obj)).fP)) goto _L4; else goto _L10
_L10:
        flag = flag1;
        if (!md.equals(fQ, ((fQ) (obj)).fQ)) goto _L4; else goto _L11
_L11:
...
_L19:
        flag = flag1;
        if (!md.equals(fV, ((fV) (obj)).fV)) goto _L4; else goto _L20
_L20:
        flag = flag1;
        if (!md.equals(fW, ((fW) (obj)).fW)) goto _L4; else goto _L21
_L21:
        flag = flag1;
...
_L22:
        ...
        flag = flag1;
        if (!((amU) (obj)).amU.isEmpty()) goto _L4; else goto _L23
_L23:
        return true;
_L7:
...
_L5:
        ...
        if (i != 0)
        {
            System.arraycopy(fO, 0, aamu, 0, i);
            k = i;
        }
        for (; k < aamu.length - 1; k++)
        {
            aamu[k] = new <init>();
            lz1.a(aamu[k]);
            lz1.nw();
...
_L6:
        ...
        if (i != 0)
        {
            System.arraycopy(fP, 0, aamu1, 0, i);
            i1 = i;
        }
        for (; i1 < aamu1.length - 1; i1++)
        {
            aamu1[i1] = new <init>();
            lz1.a(aamu1[i1]);
            lz1.nw();
...
_L7:
        ...
        if (i != 0)
        {
            System.arraycopy(fQ, 0, aamu2, 0, i);
            j1 = i;
        }
        for (; j1 < aamu2.length - 1; j1++)
        {
            aamu2[j1] = new <init>();
            lz1.a(aamu2[j1]);
            lz1.nw();
...
_L14:
        ...
        if (j != 0)
        {
            System.arraycopy(fV, 0, aamu3, 0, j);
            l1 = j;
        }
        for (; l1 < aamu3.length - 1; l1++)
        {
            aamu3[l1] = new <init>();
            lz1.a(aamu3[l1]);
            lz1.nw();
