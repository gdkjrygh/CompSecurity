    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(gz.a a1, Parcel parcel, int i)
    {
        i = b.C(parcel);
        b.a(parcel, 1, a1.getAccountName(), false);
        b.c(parcel, 1000, a1.getVersionCode());
        b.a(parcel, 2, a1.fg(), false);
        b.c(parcel, 3, a1.ff());
        b.a(parcel, 4, a1.fi(), false);
        b.G(parcel, i);
    }

    public gz.a[] aq(int i)
    {
        return new gz.a[i];
    }
    ...
    public gz.a z(Parcel parcel)
    {
        ...
        do
        {
            ...
            {
                return new gz.a(j, s1, arraylist, i, s);
            }
        } while (true);
    }
}
