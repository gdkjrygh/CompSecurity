...
public class cs
{
    ...
    public int a(String s, String s1)
    {
        ...
        try
        {
            ...
            }).invoke(class1.cast(oT), new Object[] {
        ...
        {
            ev.c("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", s);
            return 5;
        }
        return i;
    }
    ...
    public void o(IBinder ibinder)
    {
        try
        {
            oT = mContext.getClassLoader().loadClass("com.android.vending.billing.IInAppBillingService$Stub").getDeclaredMethod("asInterface", new Class[] {
                android/os/IBinder
