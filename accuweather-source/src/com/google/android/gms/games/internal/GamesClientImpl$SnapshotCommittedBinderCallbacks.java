...
private final class OG extends AbstractGamesCallbacks
{
    ...
    private final com.google.android.gms.common.api.t> OG;

    public void J(DataHolder dataholder)
    {
        OG.OG(new OG(dataholder));
    }
    ...
    public (GamesClientImpl gamesclientimpl, com.google.android.gms.common.api.cks cks)
    {
        NB = gamesclientimpl;
        super();
        OG = (com.google.android.gms.common.api.cks.OG)hn.b(cks, "Holder must not be null");
    }
}
