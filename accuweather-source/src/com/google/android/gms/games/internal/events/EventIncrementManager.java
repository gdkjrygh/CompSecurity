...
public abstract class EventIncrementManager
{
    ...
    {
        EventIncrementCache eventincrementcache1 = (EventIncrementCache)Rp.get();
        EventIncrementCache eventincrementcache = eventincrementcache1;
        if (eventincrementcache1 == null)
        {
            EventIncrementCache eventincrementcache2 = hs();
            eventincrementcache = eventincrementcache2;
            if (!Rp.compareAndSet(null, eventincrementcache2))
            {
