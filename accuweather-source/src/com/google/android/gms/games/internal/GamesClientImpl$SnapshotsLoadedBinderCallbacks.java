...
private final class OI extends AbstractGamesCallbacks
{
    ...
    private final com.google.android.gms.common.api.it> OI;

    public void I(DataHolder dataholder)
    {
        OI.OI(new OI(dataholder));
    }
    ...
    public (GamesClientImpl gamesclientimpl, com.google.android.gms.common.api.cks cks)
    {
        NB = gamesclientimpl;
        super();
        OI = (com.google.android.gms.common.api.cks.OI)hn.b(cks, "Holder must not be null");
    }
}
