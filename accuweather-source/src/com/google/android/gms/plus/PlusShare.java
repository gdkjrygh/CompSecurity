...
public final class PlusShare
{
    public static class Builder
    {
        ...
        public Builder addCallToAction(String s, Uri uri, String s1)
        {
            ...
            hn.b(flag, "Must provide a call to action URL");
            bundle = new Bundle();
            ...
            {
                hn.a(PlusShare.bv(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            hn.a(flag1, "Call-to-action buttons are only available for URLs.");
            ...
            hn.a(flag1, "The content URL is required for interactive posts.");
            flag1 = flag2;
            if (flag4)
            {
                flag1 = flag2;
            ...
            hn.a(flag1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
        ...
        public Builder setContentDeepLinkId(String s, String s1, String s2, Uri uri)
        {
            ...
            hn.b(flag, "The deepLinkId parameter is required.");
        ...
        public Builder(Activity activity, PlusClient plusclient)
        {
            ...
            hn.a(flag, "PlusClient must not be null.");
            hn.a(plusclient.isConnected(), "PlusClient must be connected to create an interactive post.");
            hn.a(plusclient.jN().by("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
    ...
    public static Person createPerson(String s, String s1)
    {
        ...
        {
            return new kt(s1, s, null, 0, null);
        }
    }
