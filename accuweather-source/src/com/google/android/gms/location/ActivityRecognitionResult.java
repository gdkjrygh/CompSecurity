    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder()).append("ActivityRecognitionResult [probableActivities=").append(US).append(", timeMillis=").append(UT).append(", elapsedRealtimeMillis=").append(UU).append("]").toString();
    }
