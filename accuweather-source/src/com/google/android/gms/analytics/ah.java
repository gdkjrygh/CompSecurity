    ...
    implements n
{
    ...
    ah(HttpClient httpclient, GoogleAnalytics googleanalytics, Context context)
    {
        ...
        wX = a("GoogleAnalytics", "3.0", android.os.Build.VERSION.RELEASE, ak.a(Locale.getDefault()), Build.MODEL, Build.ID);
        wY = httpclient;
        ui = googleanalytics;
    }
    ...
    {
        if (!TextUtils.isEmpty(ab1.dl()) && ds()) goto _L2; else goto _L1
_L1:
        return;
_L2:
        if (url != null)
...
_L2:
        ...
        if (aa.dk())
        {
            aa.D((new StringBuilder()).append("No destination: discarding hit: ").append(x1.df()).toString());
        } else
        {
...
_L5:
        ...
        flag3 = flag2;
        flag1 = flag2;
        obj1 = wY.execute(((HttpHost) (obj1)), ((org.apache.http.HttpRequest) (obj2)));
        flag3 = flag2;
        flag1 = flag2;
