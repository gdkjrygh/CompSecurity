...
class RichPushUserPreferences
{
    ...
    RichPushUserPreferences(PreferenceDataStore preferencedatastore)
    {
        ...
        String s = preferencedatastore.getString("com.urbanairship.user.PASSWORD", null);
        if (!UAStringUtil.isEmpty(s) && preferencedatastore.putSync("com.urbanairship.user.USER_TOKEN", encode(s, preferencedatastore.getString("com.urbanairship.user.ID", null))))
        {
...
_L4:
    ...
    {
        return preferenceDataStore.getLong("com.urbanairship.user.LAST_MESSAGE_REFRESH_TIME", 0L);
    }

    public long getLastUpdateTime()
    {
        return preferenceDataStore.getLong("com.urbanairship.user.LAST_UPDATE_TIME", 0L);
    }
    ...
    public void setLastMessageRefreshTime(long l)
    {
        preferenceDataStore.put("com.urbanairship.user.LAST_MESSAGE_REFRESH_TIME", Long.valueOf(l));
    }

    public void setLastUpdateTime(long l)
    {
        preferenceDataStore.put("com.urbanairship.user.LAST_UPDATE_TIME", Long.valueOf(l));
    }

    public void setUserCredentials(String s, String s1)
    {
        preferenceDataStore.put("com.urbanairship.user.ID", s);
        preferenceDataStore.put("com.urbanairship.user.USER_TOKEN", encode(s1, s));
    }
}
