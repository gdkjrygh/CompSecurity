...
public abstract class DataManager
{
    ...
    public DataManager(final Context final_context, String s, int i)
    {
        openHelper = new SQLiteOpenHelper(s, null, i, s) {
            ...
            {
                Logger.info((new StringBuilder()).append("Downgrading database ").append(name).append(" from version ").append(j).append(" to ").append(k).toString());
                DataManager.this.onDowngrade(sqlitedatabase, j, k);
            }

            public void onUpgrade(SQLiteDatabase sqlitedatabase, int j, int k)
            {
                Logger.info((new StringBuilder()).append("Upgrading database ").append(name).append(" from version ").append(j).append(" to ").append(k).toString());
                DataManager.this.onUpgrade(sqlitedatabase, j, k);
            }
