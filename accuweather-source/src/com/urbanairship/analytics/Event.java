...
public abstract class Event
{
    ...
    public Event()
    {
        this(((Environment) (new DefaultEnvironment())), System.currentTimeMillis());
    }

    public Event(Environment environment1)
    {
        this(environment1, System.currentTimeMillis());
    }

    public Event(Environment environment1, long l)
    {
