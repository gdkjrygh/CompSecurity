...
//            CancelableOperation, BaseManager, UrbanAirshipProvider, Cancelable
...
public class UAirship
{
    ...
    private static void executeTakeOff(Application application1, AirshipConfigOptions airshipconfigoptions, OnReadyCallback onreadycallback)
    {
        ...
        for (airshipconfigoptions = (new ArrayList(pendingAirshipRequests)).iterator(); airshipconfigoptions.hasNext(); ((CancelableOperation)airshipconfigoptions.next()).run()) { }
...
label0:
    ...
    {
        looper = new CancelableOperation(looper, onreadycallback) {
            ...
            public void onRun()
            {
                ...
                if (callback != null && uairship != null)
                {
                    callback.onAirshipReady(uairship);
                }
            }
...
label0:
        ...
        (new Thread(new Runnable(application1, airshipconfigoptions, onreadycallback) {
