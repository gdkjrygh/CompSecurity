...
class CommandGetRenderbufferParameteriv extends CommandBase
{
    ...
    CommandGetRenderbufferParameteriv()
    {
    }

    void execute()
    {
        GLES20.glGetRenderbufferParameteriv(target_, pname_, params_);
    }
