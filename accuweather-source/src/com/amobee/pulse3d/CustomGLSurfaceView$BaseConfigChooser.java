    ...
    implements filterConfigSpec
{
    ...
    {
        if (CustomGLSurfaceView.access$200(CustomGLSurfaceView.this) != 2 && CustomGLSurfaceView.access$200(CustomGLSurfaceView.this) != 3)
        {
            return ai;
        }
        int i = ai.length;
        ...
        ai1[i - 1] = 12352;
        if (CustomGLSurfaceView.access$200(CustomGLSurfaceView.this) == 2)
        {
            ai1[i] = 4;
        } else
        {
