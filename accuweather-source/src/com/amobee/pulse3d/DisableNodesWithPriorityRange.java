...
class DisableNodesWithPriorityRange extends NativeCommandProcessor
{
    ...
    DisableNodesWithPriorityRange(Pulse3DView pulse3dview)
    {
...
_L2:
        ...
        if (k >= min_ && k <= max_)
        {
            ((CommandList)viewController_.mGLView.renderer.commandLists.get(k)).disable();
        }
