...
_L31:
    ...
    // Unreferenced inner class com/amobee/richmedia/view/AmobeeView$2$1

/* anonymous class */
    class AmobeeView._cls2._cls1
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            framelayout.setOnTouchListener(new AmobeeView._cls2._cls1._cls1());
