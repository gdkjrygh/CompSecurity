...
class this._cls0 extends WebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        if (mViewState == ewState.INTERSTITIAL && amobeeInterstitial != null && s.toLowerCase().startsWith("file://"))
        {
        ...
        if (parentView != null && getParent() == null)
        {
            parentView.post(new Runnable() {
                ...
                final AmobeeView._cls2 this$1;

                public void run()
                {
                    ViewGroup viewgroup = AmobeeView.access$6(this$0);
                    if (viewgroup == null)
                    {
                        closeExpanded();
                        return;
            ...
            
            {
                ...
                super();
                    ...
                    mViewState = AmobeeView.ViewState.EXPANDED;
    ...
    public void onPageStarted(WebView webview, String s, Bitmap bitmap)
    {
        ...
        if (mViewState != ewState.INTERSTITIAL || amobeeInterstitial == null) goto _L2; else goto _L1
_L1:
...
_L5:
    ...
    public boolean shouldOverrideUrlLoading(WebView webview, String s)
    {
        Object obj1;
        obj1 = s.toLowerCase();
        android.util.Log.d("njdskJDV", (new StringBuilder()).append(mViewState).append(" == ").append(ewState.INTERSTITIAL).toString());
        ...
        if (mViewState != ewState.INTERSTITIAL || amobeeInterstitial == null || !((String) (obj1)).contains("redirect") || !((String) (obj1)).contains((new StringBuilder("n=")).append(amobeeInterstitial.getRandom()).toString())) goto _L2; else goto _L1
_L1:
        closeInterstitial();
_L14:
        return true;
_L2:
        Object obj;
        Uri uri;
        if (mViewState == ewState.INTERSTITIAL && ((String) (obj1)).contains("actionpage"))
        {
            return false;
        }
...
_L4:
        obj = obj1;
        if (mViewState != ewState.INTERSTITIAL)
        {
...
_L27:
        obj = webview;
        if (mViewState != ewState.INTERSTITIAL) goto _L14; else goto _L23
_L23:
        obj = webview;
