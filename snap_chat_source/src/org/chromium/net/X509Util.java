...
public class X509Util
{
    ...
    private static String a(X500Principal x500principal)
    {
        ...
        {
            ac[i1 * 2] = k[x500principal[3 - i1] >> 4 & 0xf];
            ac[i1 * 2 + 1] = k[x500principal[3 - i1] & 0xf];
        }
...
_L1:
        ...
        {
            return new d((X509TrustManager)s);
        }
        b1 = new b((X509TrustManager)s);
        return b1;
        IllegalArgumentException illegalargumentexception;
        illegalargumentexception;
        s = s.getClass().getName();
        (new StringBuilder("Error creating trust manager (")).append(s).append("): ").append(illegalargumentexception);
        i1++;
          goto _L3
_L2:
        return null;
        ...
        do
        {
            ...
            if (obj != null)
            {
                if (!(obj instanceof X509Certificate))
                {
                    ...
                    (new StringBuilder("Anchor ")).append(s1).append(" not an X509Certificate: ").append(((String) (obj)));
                } else
                {
...
_L3:
    ...
    {
        boolean flag;
        if (!org/chromium/net/X509Util.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
