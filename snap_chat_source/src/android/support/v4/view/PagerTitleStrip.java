    ...
    implements ViewPager.a
{
        ...
        implements ViewPager.d, ViewPager.e
    {
        ...
        public final void a(int i1)
        {
            ...
            if (a == 0)
            {
                ...
                {
                    f1 = PagerTitleStrip.a(b);
                }
                b.a(b.a.mCurItem, f1, true);
            }
        }
        ...
        implements b
    {
        ...
        public final void a(TextView textview)
        {
            textview.setTransformationMethod(new aV.a(textview.getContext()));
        }
...
_L4:
    ...
    protected void onAttachedToWindow()
    {
        ...
        obj = (ViewPager)obj;
        aU au = ((ViewPager) (obj)).mAdapter;
        ((ViewPager) (obj)).a(l);
        obj.mAdapterChangeListener = l;
        a = ((ViewPager) (obj));
        if (m != null)
        {
            obj = (aU)m.get();
