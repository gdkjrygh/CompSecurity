...
public class PreviewActivity extends Activity
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        if (bundle != null)
        {
            try
            {
                zzbf.zzaa((new StringBuilder("Invoke the launch activity for package name: ")).append(getPackageName()).toString());
            ...
            {
                zzbf.zzZ((new StringBuilder("Calling preview threw an exception: ")).append(bundle.getMessage()).toString());
            }
            break MISSING_BLOCK_LABEL_154;
        }
        zzbf.zzaa((new StringBuilder("No launch activity found for package name: ")).append(getPackageName()).toString());
        return;
    }
}
