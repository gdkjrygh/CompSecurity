...
public class zzaq
{
    ...
    {
        return Character.isLetter(i) && zza(Character.UnicodeBlock.of(i));
    }

    public static int zzo(String s)
    {
        byte abyte0[] = s.getBytes("UTF-8");
        s = abyte0;
_L2:
        return zzmc.zza(s, 0, s.length, 0);
...
_L1:
    ...
    public static String[] zzp(String s)
    {
        if (s == null)
        {
            return null;
