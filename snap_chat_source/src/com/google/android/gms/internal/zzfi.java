...
_L2:
        ...
        sqliteexception;
        obj1 = obj;
        zzhx.zzac((new StringBuilder("Error getting record count")).append(sqliteexception.getMessage()).toString());
...
_L4:
        obj = cursor;
        zzhx.zzac((new StringBuilder("Error remove oldest record")).append(sqliteexception.getMessage()).toString());
...
_L7:
        obj = cursor;
        zzhx.zzac((new StringBuilder("Error extracing purchase info: ")).append(sqliteexception.getMessage()).toString());
