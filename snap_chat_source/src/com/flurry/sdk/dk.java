...
public class dk
{
    ...
    private boolean a(String s, DataInputStream datainputstream)
    {
        ...
        el.a(3, a, (new StringBuilder("File version: ")).append(i).toString());
        if (i > 2)
        {
            el.a(6, a, (new StringBuilder("Unknown agent file version: ")).append(i).toString());
            throw new IOException((new StringBuilder("Unknown agent file version: ")).append(i).toString());
        }
        if (i >= 2)
        {
            Object obj = datainputstream.readUTF();
            el.a(3, a, (new StringBuilder("Loading API key: ")).append(a(s)).toString());
            ...
            {
                el.a(3, a, (new StringBuilder("Api keys do not match, old: ")).append(a(s)).append(", new: ").append(a(((String) (obj)))).toString());
                return false;
            }
        } else
        {
            el.a(5, a, (new StringBuilder("Deleting old file version: ")).append(i).toString());
            return false;
        }
    }
...
_L2:
        ...
        el.a(6, a, (new StringBuilder("discarded sessions: ")).append(i).toString());
...
_L1:
    ...
    public boolean a(DataInputStream datainputstream, String s)
    {
        ...
        el.a(4, a, (new StringBuilder("Magic: ")).append(i).toString());
