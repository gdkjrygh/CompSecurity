...
_L4:
        ...
        {
            s1 = (java.util.Map.Entry)s.next();
            el.a(3, a, (new StringBuilder("Referrer Entry:  ")).append((String)s1.getKey()).append("=").append(s1.getValue()).toString());
            dataoutputstream.writeUTF((String)s1.getKey());
            el.a(3, a, (new StringBuilder("referrer key is :")).append((String)s1.getKey()).toString());
            ...
            while (s1.hasNext()) 
            {
                ...
                el.a(3, a, (new StringBuilder("referrer value is :")).append(map).toString());
            }
        }
...
_L7:
        i = map2.keySet().size();
_L24:
        el.a(3, a, (new StringBuilder("optionsMapSize is:  ")).append(i).toString());
        dataoutputstream.writeShort(i);
        if (map2 == null)
        {
        ...
        {
            s1 = (java.util.Map.Entry)s.next();
            el.a(3, a, (new StringBuilder("Launch Options Key:  ")).append((String)s1.getKey()).toString());
            dataoutputstream.writeUTF((String)s1.getKey());
            dataoutputstream.writeShort(((List)s1.getValue()).size());
            s1 = ((List)s1.getValue()).iterator();
            while (s1.hasNext()) 
            {
                map = (String)s1.next();
                dataoutputstream.writeUTF(map);
                el.a(3, a, (new StringBuilder("Launch Options value is :")).append(map).toString());
            }
        }
...
_L25:
        el.a(3, a, (new StringBuilder("numOriginAttributions is:  ")).append(i).toString());
...
_L13:
        ...
        el.a(3, a, (new StringBuilder("Origin Atttribute Key:  ")).append((String)map.getKey()).toString());
        dataoutputstream.writeUTF((String)map.getKey());
        dataoutputstream.writeShort(((Map)map.getValue()).size());
        el.a(3, a, (new StringBuilder("Origin Attribute Map Size for ")).append((String)map.getKey()).append(":  ").append(((Map)map.getValue()).size()).toString());
        map1 = ((Map)map.getValue()).entrySet().iterator();
_L18:
        if (!map1.hasNext()) goto _L15; else goto _L14
_L14:
        map2 = (java.util.Map.Entry)map1.next();
        el.a(3, a, (new StringBuilder("Origin Atttribute for ")).append((String)map.getKey()).append(":  ").append((String)map2.getKey()).append(":").append((String)map2.getValue()).toString());
