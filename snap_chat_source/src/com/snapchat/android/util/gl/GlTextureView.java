...
_L5:
    ...
    private boolean mRenderModeContagiously;
    private a mRenderThread;
    private boolean mTryEgl3;

    static boolean a(GlTextureView gltextureview)
    {
        return gltextureview.mRenderModeContagiously;
    }

    static boolean b(GlTextureView gltextureview)
    {
        return gltextureview.mTryEgl3;
    }

    public void setRenderModeContagiously(boolean flag)
    {
        mRenderModeContagiously = flag;
    }

    public void setTryEgl3(boolean flag)
    {
        mTryEgl3 = flag;
    }
}
