...
final class a
    implements android.view.ewFragment._cls27._cls1
{
...
/* anonymous class */
        ...
        implements PI.a
    {
        ...
        {
            ((ImageButton)SnapPreviewFragment.l(a).a()).setOnClickListener(new SnapPreviewFragment._cls27._cls1(this));
            ((ImageButton)SnapPreviewFragment.n(a).a()).setOnClickListener(new SnapPreviewFragment._cls27._cls2());
        }
        ...
        // Unreferenced inner class com/snapchat/android/preview/SnapPreviewFragment$27$2

/* anonymous class */
        final class SnapPreviewFragment._cls27._cls2
