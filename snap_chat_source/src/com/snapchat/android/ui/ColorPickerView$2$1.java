    ...
    implements android.view.animation.istener
{
    ...
    public final void onAnimationEnd(Animation animation)
    {
        ...
        animation = new nit>(ColorPickerView.h(a.a).getWidth(), (int)Jo.a(12F, a.a.getContext()), ColorPickerView.h(a.a));
        animation.tDuration(140L);
...
/* anonymous class */
    final class ColorPickerView._cls2
        implements android.view.View.OnTouchListener
    {
        ...
        public final boolean onTouch(View view, MotionEvent motionevent)
        {
            ...
            case 1: // '\001'
                ...
                view.setAnimationListener(new ColorPickerView._cls2._cls1(this));
