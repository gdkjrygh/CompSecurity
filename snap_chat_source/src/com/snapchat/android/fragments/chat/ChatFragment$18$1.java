    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/snapchat/android/fragments/chat/ChatFragment$18

/* anonymous class */
    final class ChatFragment._cls18
        implements Runnable
    {
...
label2:
                        {
                            ...
                            valueanimator.addUpdateListener(new com.snapchat.android.ui.CashReceiverView._cls3(imageview, f2, f7, f3, f4 * (0.4F + 0.2F * f5) - f6, f8 - f9, f1, f));
                            ...
                            imageview.setLayoutParams(new android.view.ViewGroup.LayoutParams(k, l));
            ...
            ChatFragment.K(a).postDelayed(new ChatFragment._cls18._cls1(this), 3000L);
        }
