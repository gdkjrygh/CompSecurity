    ...
    implements tt
{
    ...
    private static final NUM_CHUNKS $VALUES[];
    public static final NUM_CHUNKS CURRENT_EDITION_ID;
    public static final NUM_CHUNKS ENABLED;
    public static final NUM_CHUNKS FILLED_ICON;
    public static final NUM_CHUNKS INTRO_AD_TARGETING;
    public static final NUM_CHUNKS INTRO_AD_UNIT_ID;
    public static final NUM_CHUNKS INTRO_MOVIE;
    public static final NUM_CHUNKS INVERTED_ICON;
    public static final NUM_CHUNKS LOADING_ICON;
    public static final NUM_CHUNKS NUM_CHUNKS;
    public static final NUM_CHUNKS POSITION;
    public static final NUM_CHUNKS PRIMARY_COLOR;
    public static final NUM_CHUNKS PROMOTED_STORIES_PAGE_POSITION;
    public static final NUM_CHUNKS PUBLISHER_FORMAL_NAME;
    public static final NUM_CHUNKS PUBLISHER_INTERNATIONAL_NAME;
    public static final NUM_CHUNKS PUBLISHER_NAME;
    public static final NUM_CHUNKS SECONDARY_COLOR;
    public static final NUM_CHUNKS SPONSORED;
    public static final NUM_CHUNKS SPONSORED_SLUG_ALIGNMENT;
    public static final NUM_CHUNKS SPONSORED_SLUG_HMARGIN;
    public static final NUM_CHUNKS SPONSORED_SLUG_POSITION;
    public static final NUM_CHUNKS SPONSORED_SLUG_STR_RECT_HEIGHT;
    public static final NUM_CHUNKS SPONSORED_SLUG_STR_RECT_WIDTH;
    public static final NUM_CHUNKS SPONSORED_SLUG_STR_RECT_X;
    public static final NUM_CHUNKS SPONSORED_SLUG_STR_RECT_Y;
    public static final NUM_CHUNKS SPONSORED_SLUG_TEXT;
    public static final NUM_CHUNKS SPONSORED_SLUG_TIME_BEFORE_FADEOUT;
    public static final NUM_CHUNKS SPONSORED_SLUG_VMARGIN;
    public static final NUM_CHUNKS STORIES_PAGE_POSITION;
    private String a;
    private DataType b;
    private String c;
    ...
    {
        return (c)Enum.valueOf(com/snapchat/android/discover/model/database/vtable/PublisherAndEditionVirtualTable$ChannelSchema, s);
    }
    ...
    static 
    {
        PUBLISHER_NAME = new <init>("PUBLISHER_NAME", "_id", DataType.TEXT, "PRIMARY KEY");
        ...
        CURRENT_EDITION_ID = new <init>("CURRENT_EDITION_ID", 26, "current_edition_id", DataType.TEXT);
        NUM_CHUNKS = new <init>("NUM_CHUNKS", 27, "num_chunks", DataType.INTEGER);
        $VALUES = (new .VALUES[] {
