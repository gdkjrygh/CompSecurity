    ...
    implements t
{
    ...
    public final void a(int i)
    {
        ...
        if (CashFeedItem.a(CashFeedItem.this).mRecipientSaveVersion == val$modifiedVersion)
        {
            ...
            CashFeedItem.a(CashFeedItem.this).mRecipientSaveVersion = val$originalVersion;
            CashFeedItemTable.a(SnapchatApplication.get(), Arrays.asList(new CashFeedItem[] {
                CashFeedItem.this
            }));
            Mf.a().a(new Mp(ac(), d()));
