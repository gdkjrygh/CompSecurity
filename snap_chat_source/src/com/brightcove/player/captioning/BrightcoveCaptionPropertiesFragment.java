    ...
    implements android.preference.Preference.OnPreferenceChangeListener, com.brightcove.player.captioning.preferences.ListDialogPreference.OnValueChangedListener
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        bundle = getResources().getIntArray(com.brightcove.player.R.array.captioning_preset_selector_values);
        ...
        p = true;
        bundle = getResources().getIntArray(com.brightcove.player.R.array.captioning_color_selector_values);
        ...
        f.setTitles(as);
        f.setValues(bundle);
        int ai[] = getResources().getIntArray(com.brightcove.player.R.array.captioning_opacity_selector_values);
        ...
        i.setTitles(as);
        i.setValues(bundle);
        int ai1[] = new int[bundle.length + 1];
        String as2[] = new String[as.length + 1];
        System.arraycopy(bundle, 0, ai1, 1, bundle.length);
