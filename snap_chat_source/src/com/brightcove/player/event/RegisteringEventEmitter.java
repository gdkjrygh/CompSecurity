    ...
    implements EventEmitter
{
    ...
    public RegisteringEventEmitter(EventEmitter eventemitter, Class class1)
    {
        ...
        } else
        {
            ...
            {
                a = RegisteringEventEmitter.this;
                super();
            }
            });
            return;
    ...
    private List a(Class class1, Class class2)
    {
        ArrayList arraylist;
        arraylist = new ArrayList();
        class1 = b(class1, class2);
        if (class1.size() <= 0) goto _L2; else goto _L1
_L1:
        Iterator iterator;
...
_L4:
        ...
        String as[] = (String[])annotation.getClass().getMethod(a, new Class[0]).invoke(annotation, new Object[0]);
        class1 = as;
_L5:
        ...
        Exception exception;
        exception;
        (new StringBuilder("Error attempting to invoke ")).append(a).append(" on annotation ").append(class2.getName()).append(": ").append(exception.getMessage());
          goto _L5
_L2:
