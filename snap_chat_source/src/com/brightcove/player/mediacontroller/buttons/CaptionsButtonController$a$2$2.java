...
/* anonymous class */
        ...
        implements EventListener
    {
        ...
        public final void processEvent(Event event)
        {
            CaptionsButtonController.c(a.a, CaptionsButtonController.f(a.a).once("activityResumed", new CaptionsButtonController.a._cls2._cls1()));
            CaptionsButtonController.d(a.a, CaptionsButtonController.i(a.a).once("fragmentResumed", new CaptionsButtonController.a._cls2._cls2(this)));
        ...
        // Unreferenced inner class com/brightcove/player/mediacontroller/buttons/CaptionsButtonController$a$2$1

/* anonymous class */
        final class CaptionsButtonController.a._cls2._cls1
            implements EventListener
        {
