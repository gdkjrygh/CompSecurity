    ...
    implements Serializable
{
    ...
    public Length(String s)
    {
        ...
        if (((Matcher) (obj)).find() && ((Matcher) (obj)).groupCount() >= 2)
        {
            ...
            if (StringUtil.isEmpty(s))
            {
                throw new IllegalArgumentException((new StringBuilder("invalid number format: ")).append(s).toString());
            }
            if (StringUtil.isEmpty(((String) (obj))))
            {
                throw new IllegalArgumentException((new StringBuilder("invalid unit format: ")).append(((String) (obj))).toString());
            }
