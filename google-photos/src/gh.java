...
public abstract class gh extends Binder
    implements gg
{
    ...
    public static gg a(IBinder ibinder)
    {
        ...
        if (iinterface != null && (iinterface instanceof gg))
        {
            return (gg)iinterface;
        } else
        {
            return new gi(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (ho)ho.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 3: // '\003'
            parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
            a(ge.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
            b(ge.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 25: // '\031'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (fz)fz.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel = null;
            }
