...
public abstract class kbf
{
    ...
    public static final kbf a = b("\t\n\013\f\r \205\u1680\u2028\u2029\u205F\u3000\240\u180E\u202F").a(a('\u2000', '\u200A'));
    private static kbf b = new kbg();

    public kbf()
    {
    }

    private static kbf a(char c, char c1)
    {
        boolean flag;
        if (c1 >= c)
        {
    ...
    private static kbf b(char c)
    {
        return new kbh(c);
    }

    private static kbf b(CharSequence charsequence)
    {
        ...
        case 2: // '\002'
            return new kbi(charsequence.charAt(0), charsequence.charAt(1));
        }
    }

    public kbf a(kbf kbf1)
    {
        return new kbl(Arrays.asList(new kbf[] {
            this, (kbf)b.d(kbf1)
        }));
    }
