...
public abstract class loq extends Binder
    implements lop
{
    ...
    public static lop a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof lop))
        {
            return (lop)iinterface;
        } else
        {
            return new lor(ibinder);
        }
    }
