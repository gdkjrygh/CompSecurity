...
public abstract class kst extends Binder
    implements kss
{

    public static kss a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kss))
        {
            return (kss)iinterface;
        } else
        {
            return new ksu(ibinder);
        }
    }
