...
public abstract class kto extends Binder
    implements ktn
{

    public static ktn a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ktn))
        {
            return (ktn)iinterface;
        } else
        {
            return new ktp(ibinder);
        }
    }
