...
public final class jsn
{
    ...
    public jsn(jrj jrj1, Map map, long l, boolean flag)
    {
        this(jrj1, map, l, flag, 0L, 0, null);
    }

    public jsn(jrj jrj1, Map map, long l, boolean flag, long l1, 
            int i)
    {
        this(jrj1, map, l, flag, l1, i, null);
    }
            ...
            int i, List list)
    {
        ...
        do
        {
            ...
            if (a(entry1.getKey()))
            {
                String s1 = a(jrj1, entry1.getKey());
                if (s1 != null)
                {
                    list.put(s1, b(jrj1, entry1.getValue()));
                }
            }
        } while (true);
        ...
        do
        {
            ...
            if (!a(entry.getKey()))
            {
                String s = a(jrj1, entry.getKey());
                if (s != null)
                {
                    list.put(s, b(jrj1, entry.getValue()));
                }
            }
        } while (true);
...
_L6:
    ...
    private static String a(jrj jrj1, Object obj)
    {
        if (obj == null)
        {
            jrj1 = null;
        } else
        {
            ...
            if (i > 256)
            {
                ...
                jrj1.c("Hit param name is too long and will be trimmed", Integer.valueOf(i), obj1);
            }
            jrj1 = ((jrj) (obj1));
    ...
    private static String b(jrj jrj1, Object obj)
    {
        Object obj1;
        int i;
        if (obj == null)
        ...
        if (i > 8192)
        {
            ...
            jrj1.c("Hit param value is too long and will be trimmed", Integer.valueOf(i), obj1);
        }
        return ((String) (obj1));
    }
    ...
    String a(String s, String s1)
    {
        ...
        b.b(flag, "Short param name required");
        s = (String)a.get(s);
        if (s != null)
        {
            return s;
