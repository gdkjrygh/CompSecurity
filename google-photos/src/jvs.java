...
public final class jvs
{
    ...
    public final boolean a(JSONObject jsonobject)
    {
        ...
        {
            a = new jvp(jsonobject.getJSONObject("media"));
            flag1 = true;
        } else
        {
            flag1 = false;
...
_L2:
        ...
        if (h == null || ((jvs) (obj)).h == null)
        {
            break; /* Loop/switch isn't completed */
        }
        flag2 = flag3;
        if (!kdk.a(h, ((jvs) (obj)).h)) goto _L4; else goto _L3
_L3:
        flag2 = flag3;
        if (jwo.a(a, ((jvs) (obj)).a))
        {
            flag2 = flag3;
            if (b == ((jvs) (obj)).b)
            {
