...
public class SwitchCompat extends CompoundButton
{
    ...
    public SwitchCompat(Context context, AttributeSet attributeset, int i1)
    {
        ...
        obj = yj.a(context, attributeset, uh.bb, i1, 0);
        a = ((yj) (obj)).a(uh.be);
        if (a != null)
        {
            a.setCallback(this);
        ...
        g = ((yj) (obj)).c(uh.bd);
        h = ((yj) (obj)).c(uh.bc);
        i = ((yj) (obj)).a(uh.bf, true);
        c = ((yj) (obj)).d(uh.bk, 0);
        d = ((yj) (obj)).d(uh.bh, 0);
        e = ((yj) (obj)).d(uh.bi, 0);
        f = ((yj) (obj)).a(uh.bg, false);
        i1 = ((yj) (obj)).f(uh.bj, 0);
        if (i1 == 0) goto _L2; else goto _L1
_L1:
        int j1;
        TypedArray typedarray = context.obtainStyledAttributes(i1, uh.bm);
        attributeset = typedarray.getColorStateList(uh.bn);
        ...
        i1 = typedarray.getDimensionPixelSize(uh.bo, 0);
        if (i1 != 0 && (float)i1 != x.getTextSize())
        {
            x.setTextSize(i1);
            requestLayout();
        }
        i1 = typedarray.getInt(uh.bq, -1);
        j1 = typedarray.getInt(uh.bp, -1);
        i1;
...
_L7:
        ...
        if (typedarray.getBoolean(uh.br, false))
        {
            B = new va(getContext());
        } else
        {
...
_L4:
    ...
    public void onMeasure(int i1, int j1)
    {
        ...
        {
            rect = xq.a(a);
            i2 = Math.max(l2, rect.left);
            j2 = Math.max(k2, rect.right);
        }
        i2 = Math.max(d, j2 + (i2 + s * 2));
        k1 = Math.max(l1, k1);
        q = i2;
        r = k1;
        ...
        {
            setMeasuredDimension(mk.j(this), k1);
        }
    }
...
_L8:
    ...
    public void setChecked(boolean flag)
    {
        ...
        flag = isChecked();
        if (getWindowToken() != null && mk.z(this))
        {
            float f2 = p;
            if (!flag)
            {
