...
public final class kxj
{
    ...
    public kxj(Context context, String s)
    {
        this(context);
        b = s;
    }
...
_L12:
        ...
        jqc.c();
        obj1 = kwz.a(((android.net.Uri) (obj1)));
        String s;
...
_L14:
        ...
        builder.setPositiveButton("Share", new kxk(this, ((String) (obj))));
        builder.setNegativeButton("Close", new kxl(this));
        builder.create().show();
        return;
_L13:
