    ...
    implements Parcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new fu();
    ...
    ft(String s, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, Bitmap bitmap, Uri uri, Bundle bundle, 
            Uri uri1)
    {
        e = s;
        a = charsequence;
