...
public abstract class joq extends Binder
    implements jop
{

    public static jop a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof jop))
        {
            return (jop)iinterface;
        } else
        {
            return new jor(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            parcel = a(kol.a(parcel.readStrongBinder()), parcel.readInt());
