...
public abstract class jws extends Binder
    implements jwr
{

    public static jwr a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof jwr))
        {
            return (jwr)iinterface;
        } else
        {
            return new jwt(ibinder);
        }
    }
