...
final class luv extends SQLiteOpenHelper
{

    private lur a;

    luv(lur lur1, Context context, String s)
    {
        a = lur1;
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        lur.b(a).getDatabasePath("google_tagmanager.db").delete();
        if (true) goto _L2; else goto _L1
_L1:
    }
