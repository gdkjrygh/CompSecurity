...
public abstract class ksy extends Binder
    implements ksx
{

    public static ksx a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ksx))
        {
            return (ksx)iinterface;
        } else
        {
            return new ksz(ibinder);
        }
    }
