...
public abstract class krl extends Binder
    implements krk
{

    public static krk a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof krk))
        {
            return (krk)iinterface;
        } else
        {
            return new krm(ibinder);
        }
    }
