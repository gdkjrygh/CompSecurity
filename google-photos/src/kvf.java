...
public abstract class kvf extends Binder
    implements kve
{

    public static kve a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kve))
        {
            return (kve)iinterface;
        } else
        {
            return new kvg(ibinder);
        }
    }
