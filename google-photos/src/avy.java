...
public final class avy extends FilterInputStream
{
    ...
    public avy(InputStream inputstream, aqp aqp1)
    {
        this(inputstream, aqp1, 0x10000);
    }

    private avy(InputStream inputstream, aqp aqp1, int i)
    {
        super(inputstream);
        d = -1;
        f = aqp1;
...
_L7:
    ...
    public final void reset()
    {
        ...
        if (-1 == d)
        {
            int i = e;
            int j = c;
            throw new avz((new StringBuilder(66)).append("Mark has been invalidated, pos: ").append(i).append(" markLimit: ").append(j).toString());
        }
        e = d;
        this;
        JVM INSTR monitorexit ;
