...
public abstract class kaz extends Binder
    implements kay
{

    public static kay a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kay))
        {
            return (kay)iinterface;
        } else
        {
            return new kba(ibinder);
        }
    }
