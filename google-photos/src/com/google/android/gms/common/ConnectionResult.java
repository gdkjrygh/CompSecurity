    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new kdo();
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (c != ((ConnectionResult) (obj)).c || !c.b(d, ((ConnectionResult) (obj)).d))
            {
                return false;
            }
        }
...
_L21:
        return kct1.a("statusCode", s).a("resolution", d).toString();
_L2:
        s = "SUCCESS";
