    ...
    implements SafeParcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new kcv();
    public final int a;
    public IBinder b;
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!c.equals(((ResolveAccountResponse) (obj)).c) || !kaz.a(b).equals(kaz.a(((ResolveAccountResponse) (obj)).b)))
            {
                return false;
            }
        }
