...
public abstract class kut extends Binder
    implements kus
{

    public static kus a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kus))
        {
            return (kus)iinterface;
        } else
        {
            return new kuu(ibinder);
        }
    }
