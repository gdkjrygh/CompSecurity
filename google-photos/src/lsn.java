...
final class lsn extends SQLiteOpenHelper
{
    ...
    lsn(lsl lsl1, Context context, String s)
    {
        c = lsl1;
    ...
    private static boolean a(String s, SQLiteDatabase sqlitedatabase)
    {
        ...
        sqlitedatabase = null;
_L4:
        lqh.b((new StringBuilder("Error querying for table ")).append(s).toString());
        if (sqlitedatabase != null)
        {
            sqlitedatabase.close();
        }
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        lsl.c(c).getDatabasePath(lsl.b(c)).delete();
        if (true) goto _L2; else goto _L1
_L1:
    }
