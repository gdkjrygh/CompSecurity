...
public abstract class lin extends Binder
    implements lim
{

    public static lim a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof lim))
        {
            return (lim)iinterface;
        } else
        {
            return new lio(ibinder);
        }
    }
