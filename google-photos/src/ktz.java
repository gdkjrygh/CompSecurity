    ...
    implements kuf
{
    ...
    {
        PackageManager packagemanager = kxu1.getContext().getPackageManager();
        ...
        {
            kxu1.a("openableIntents", new JSONObject());
            return;
        }
        try
        {
...
label1:
            {
                ...
                {
                    b.a("Error parsing the intent data.", jsonexception);
                    break label1;
                }
                ...
                {
                    b.a("Error constructing openable urls response.", jsonexception1);
                }
            }
            i++;
        } while (true);
        kxu1.a("openableIntents", jsonobject);
    }
}
