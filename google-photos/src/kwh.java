...
public abstract class kwh extends Binder
    implements kwg
{

    public static kwg a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kwg))
        {
            return (kwg)iinterface;
        } else
        {
            return new kwi(ibinder);
        }
    }
