...
public final class krn
{
    ...
    private krn(Context context, String s)
    {
        b = context;
        ...
        {
            context = ed.a(new File(context.getApplicationInfo().dataDir, "no_backup"));
        }
...
_L1:
    ...
    final KeyPair a(String s, long l)
    {
        ...
        a(editor, s, "|P|", krf.a(keypair.getPublic().getEncoded()));
        a(editor, s, "|K|", krf.a(keypair.getPrivate().getEncoded()));
