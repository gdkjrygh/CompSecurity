...
public class SharpenFilter extends ahn
{
    ...
    public SharpenFilter(ajr ajr, String s)
    {
        super(ajr, s);
        mScale = 0.0F;
    }
    ...
    protected final void e()
    {
        ...
        int i = ahv1.m();
        int j = ahv1.n();
        mShader.a("stepsizeX", 1.0F / (float)i);
        mShader.a("stepsizeY", 1.0F / (float)j);
        mShader.a("scale", mScale);
        mShader.a(ahv1, ahv2);
        aju1.a(ahv2);
        this;
