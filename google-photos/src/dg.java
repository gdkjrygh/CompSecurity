    ...
    implements ch, ci, jnm
{
    ...
    public dg(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
    ...
    {
        android.util.SparseArray sparsearray = de.a(c);
        if (sparsearray != null)
        {
