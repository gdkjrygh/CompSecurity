...
public abstract class kwe extends Binder
    implements kwd
{
    ...
    public static kwd a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof kwd))
        {
            return (kwd)iinterface;
        } else
        {
            return new kwf(ibinder);
        }
    }
