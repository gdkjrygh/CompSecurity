...
public final class abw extends RatingBar
{
    ...
    private Drawable a(Drawable drawable, boolean flag)
    {
        ...
        {
            Drawable drawable1 = ((fi)drawable).a();
            if (drawable1 != null)
            {
                drawable1 = a(drawable1, flag);
                ((fi)drawable).a(drawable1);
            }
        } else
        {
    ...
    protected final void onMeasure(int i, int j)
    {
        ...
        if (b != null)
        {
            setMeasuredDimension(mk.a(b.getWidth() * getNumStars(), i, 0), getMeasuredHeight());
        }
        this;
