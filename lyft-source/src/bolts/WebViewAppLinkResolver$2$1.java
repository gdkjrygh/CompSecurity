...
/* anonymous class */
        ...
        implements Continuation
    {
        ...
        public Task a(Task task)
        {
            ...
            webview.addJavascriptInterface(new WebViewAppLinkResolver._cls2._cls2(taskcompletionsource), "boltsWebViewAppLinkResolverResult");
            if (a.a() != null)
            {
...
/* anonymous class */
        class WebViewAppLinkResolver._cls2._cls2
        {
            ...
            final WebViewAppLinkResolver._cls2 b;

                    
                    {
                        b = WebViewAppLinkResolver._cls2.this;
