    ...
    implements ValueLoader
{
    ...
    public String a(Context context)
    {
        ...
        context2 = context;
        obj = context;
        String s1 = a(((ZipInputStream) (context)));
        obj1 = s1;
        obj = obj1;
        if (context != null)
        {
            ...
            {
                Fabric.g().d("Beta", "Failed to close the APK file", context);
                obj = obj1;
...
_L2:
        ...
        Fabric.g().a("Beta", (new StringBuilder()).append("Beta device token load took ").append(d).append("ms").toString());
        return ((String) (obj));
        context;
        obj = obj1;
        Fabric.g().d("Beta", "Failed to find this app in the PackageManager", context);
        obj = s;
        if (obj1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context1;
        Fabric.g().d("Beta", "Failed to find the APK file", context);
        obj = s;
        if (context1 == null)
        {
            continue; /* Loop/switch isn't completed */
        ...
        context;
        obj = context2;
        Fabric.g().d("Beta", "Failed to read the APK file", context);
        obj = s;
        if (context2 == null)
        {
            continue; /* Loop/switch isn't completed */
...
_L1:
        ...
        if (obj != null)
        {
            ...
            {
                Fabric.g().d("Beta", "Failed to close the APK file", ioexception);
            }
        }
        throw context;
    }
