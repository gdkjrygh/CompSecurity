    ...
    class TuneBanner._cls1 extends WebViewClient
    {
        ...
        public void onPageFinished(WebView webview, String s)
        {
            ...
            if (TuneBanner.b(a) != null)
            {
                ...
                {
                    TuneBanner.d(a).postDelayed(new TuneBanner._cls1._cls1(this), 50L);
                } else
                {
                    TuneBanner.d(a).postDelayed(new TuneBanner._cls1._cls2(), 50L);
                }
        ...
        // Unreferenced inner class com/tune/crosspromo/TuneBanner$1$2

/* anonymous class */
        class TuneBanner._cls1._cls2
            implements Runnable
        {
