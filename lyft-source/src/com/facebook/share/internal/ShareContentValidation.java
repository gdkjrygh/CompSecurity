...
public class ShareContentValidation
{
    ...
    private static void validateOpenGraphContent(ShareOpenGraphContent shareopengraphcontent, Validator validator)
    {
        ...
        {
            throw new FacebookException((new StringBuilder()).append("Property \"").append(validator).append("\" was not found on the action. ").append("The name of the preview property must match the name of an ").append("action property.").toString());
        } else
        {
            return;
        }
