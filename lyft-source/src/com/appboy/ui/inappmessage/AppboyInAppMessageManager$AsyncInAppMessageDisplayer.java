...
_L2:
        try
        {
            AppboyLogger.w(AppboyInAppMessageManager.access$000(), (new StringBuilder()).append("Fresco disk prefetch failed with cause: ").append(datasource.getFailureCause().getMessage()).append(" with image url: ").append(s).toString());
        }
    ...
    void prepareInAppMessageWithHtml(IInAppMessage iinappmessage)
    {
        ...
        if (!StringUtils.isNullOrBlank(s))
        {
            AppboyLogger.d(AppboyInAppMessageManager.access$000(), (new StringBuilder()).append("Local url for html in-app message is ").append(s).toString());
