    ...
    public void trigger(final FeedUpdatedEvent event)
    {
        ...
        } else
        {
            activity.runOnUiThread(new Runnable() {
                ...
                public void run()
                {
                    AppboyLogger.d(AppboyXamarinFormsFeedFragment.access$700(), (new StringBuilder()).append("Updating feed views in response to FeedUpdatedEvent: ").append(event).toString());
