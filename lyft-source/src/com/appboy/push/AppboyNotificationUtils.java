        ...
        if (bundle != null)
        {
            if (bundle.containsKey("n"))
            {
                ...
                try
                {
                    ...
                    AppboyLogger.d(TAG, String.format((new StringBuilder()).append("Using notification id provided in the message's extras bundle: ").append(i).toString(), new Object[0]));
                }
                // Misplaced declaration of an exception variable
                catch (Bundle bundle)
                {
            ...
            } else
            {
                ...
                AppboyLogger.d(TAG, String.format((new StringBuilder()).append("Message without notification id provided in the extras bundle received.  Using a hash of the message: ").append(j).toString(), new Object[0]));
                return j;
            }
        } else
        {
...
_L5:
    ...
    private static void logNotificationOpened(Context context, Intent intent)
    {
        ...
        if (intent != null)
        {
            AppboyLogger.i(TAG, String.format((new StringBuilder()).append("Logging push click to Appboy. Campaign Id: ").append(intent).toString(), new Object[0]));
    ...
    public static void setAccentColorIfPresentAndSupported(XmlAppConfigurationProvider xmlappconfigurationprovider, android.support.v4.app.NotificationCompat.Builder builder, Bundle bundle)
    {
label0:
        {
    ...
    public static void setContentIntentIfPresent(Context context, android.support.v4.app.NotificationCompat.Builder builder, Bundle bundle)
    {
        ...
        intent.putExtras(bundle);
        builder.setContentIntent(PendingIntent.getBroadcast(context, IntentUtils.getRequestCode(), intent, 0x40000000));
        return;
    }

    public static void setLargeIconIfPresentAndSupported(Context context, XmlAppConfigurationProvider xmlappconfigurationprovider, android.support.v4.app.NotificationCompat.Builder builder)
    {
        int i;
    ...
    public static void setPublicVersionIfPresentAndSupported(Context context, XmlAppConfigurationProvider xmlappconfigurationprovider, android.support.v4.app.NotificationCompat.Builder builder, Bundle bundle)
    {
    ...
    public static int setSmallIcon(XmlAppConfigurationProvider xmlappconfigurationprovider, android.support.v4.app.NotificationCompat.Builder builder)
    {
...
label0:
    ...
    public static void setVisibilityIfPresentAndSupported(android.support.v4.app.NotificationCompat.Builder builder, Bundle bundle)
    {
        ...
        {
            AppboyLogger.e(TAG, "Failed to parse visibility from notificationExtras", builder);
        }
    }

    public static boolean wakeScreenIfHasPermission(Context context, Bundle bundle)
    {
        while (context.checkCallingOrSelfPermission("android.permission.WAKE_LOCK") == -1 || android.os.Build.VERSION.SDK_INT >= 16 && getNotificationPriority(bundle) == -2) 
        {
            return false;
        }
