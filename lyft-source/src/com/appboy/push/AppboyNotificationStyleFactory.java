...
public class AppboyNotificationStyleFactory
{
    ...
    public static android.support.v4.app.NotificationCompat.Style getBigNotificationStyle(Context context, Bundle bundle, Bundle bundle1)
    {
        Object obj = null;
        android.support.v4.app.NotificationCompat.BigPictureStyle bigpicturestyle = obj;
        if (bundle1 != null)
        {
            bigpicturestyle = obj;
            if (bundle1.containsKey("appboy_image_url"))
            {
                bigpicturestyle = getBigPictureNotificationStyle(context, bundle, bundle1);
            }
        }
        context = bigpicturestyle;
...
_L1:
        context = new android.support.v4.app.NotificationCompat.BigPictureStyle();
        context.bigPicture(bundle1);
    ...
    public static android.support.v4.app.NotificationCompat.BigTextStyle getBigTextNotificationStyle(Bundle bundle)
    {
        ...
        if (bundle != null)
        {
            ...
            if (obj != null)
            {
                bigtextstyle.setSummaryText(((CharSequence) (obj)));
            }
            if (s != null)
            {
        ...
        return ((android.support.v4.app.NotificationCompat.BigTextStyle) (obj));
    }
    ...
    static void setBigPictureSummaryAndTitle(android.support.v4.app.NotificationCompat.BigPictureStyle bigpicturestyle, Bundle bundle)
    {
        ...
        if (s1 != null)
        {
            bigpicturestyle.setBigContentTitle(s1);
        }
