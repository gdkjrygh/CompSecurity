    ...
    implements IInAppMessage, IPutIntoJson
{
    ...
    public InAppMessageBase(JSONObject jsonobject, cd cd1)
    {
        this(jsonobject.optString("message"), eu.a(jsonobject.optJSONObject("extras"), new HashMap()), (ClickAction)eu.a(jsonobject, "click_action", com/appboy/enums/inappmessage/ClickAction, ClickAction.NONE), jsonobject.optString("uri"), jsonobject.optInt("bg_color"), jsonobject.optInt("icon_color"), jsonobject.optInt("icon_bg_color"), jsonobject.optInt("text_color"), jsonobject.optString("icon"), jsonobject.optString("image_url"), (DismissType)eu.a(jsonobject, "message_close", com/appboy/enums/inappmessage/DismissType, DismissType.AUTO_DISMISS), jsonobject.optInt("duration"), jsonobject.optString("campaign_id"), jsonobject.optString("card_id"), jsonobject, cd1);
    }
