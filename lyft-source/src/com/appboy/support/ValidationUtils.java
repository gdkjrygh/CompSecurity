...
public final class ValidationUtils
{
    ...
    public static final gw CUSTOM_ATTRIBUTE_RESERVED_KEYS = (new gx()).c("first_name").c("last_name").c("email").c("bio").c("gender").c("dob").c("country").c("home_city").c("email_subscribe").c("push_subscribe").c("phone").c("facebook").c("twitter").c("image_url").a();
    public static final gw CUSTOM_ATTRIBUTE_RESERVED_KEY_PREFIXES = (new gx()).c("appboy").a();
    ...
    {
        s = s.trim();
        for (Iterator iterator = CUSTOM_ATTRIBUTE_RESERVED_KEY_PREFIXES.iterator(); iterator.hasNext();)
        {
