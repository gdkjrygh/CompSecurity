...
public final class cw extends ArrayAdapter
{
    ...
    public cw(Context context, List list, int i)
    {
    ...
    public final View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        bj.b(((TextView) (obj)), 83);
        viewgroup = bj.a(viewgroup.getContext(), "20dip", "20dip", 9);
        viewgroup.addRule(0, 2303);
        relativelayout.addView(((View) (obj)), viewgroup);
        bj.b(((View) (obj)), "6dip", "6dip", "6dip", "6dip");
