...
public final class ce extends cf
{
    ...
    public ce(bh bh, c c1, String s, String s1, bM bm1, String s2, String s3, 
            boolean flag, String s4, boolean flag1, String s5)
    {
        this(bh, c1, s, s1, bm1, flag, s4, flag1, s5);
        m = s2;
        n = s3;
    }

    public ce(bh bh, c c1, String s, String s1, bM bm1, boolean flag, String s2, 
            boolean flag1, String s3)
    {
        super(bm.d, bh, c1, b(s, s1));
        a = bm1;
        b = flag;
        j = s2;
        k = flag1;
    ...
    public final String b()
    {
        ...
        if (a.a())
        {
            ...
            hashmap.put("email", R.a(a.b()));
            hashmap.put("password", R.a(a.c()));
        } else
        {
            hashmap.put("grant_type", "password");
            a.d().c();
            hashmap.put("phone", R.a((new StringBuilder("+")).append(a.d().c()).append(" ").append(a.d().a()).toString()));
            hashmap.put("pin", a.e());
        }
        hashmap.put("remember_me", "true");
        hashmap.put("device_name", R.a(Build.DEVICE));
        hashmap.put("redirect_uri", R.a("urn:ietf:wg:oauth:2.0:oob"));
        return R.a(hashmap);
    }
