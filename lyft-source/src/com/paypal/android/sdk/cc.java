...
public class cc extends bf
{
    ...
    private static final String a = com/paypal/android/sdk/cc.getSimpleName();
    private Map b;
    private String c;
    private String d;
    private String e;

    public cc(bh bh, c c1, String s, String s1, String s2)
    {
        bl bl1 = new bl(bm.i);
        ...
        super(bl1, bh, c1, stringbuilder.append(s3).toString(), (new StringBuilder("/")).append(s2).toString());
        b = new HashMap();
