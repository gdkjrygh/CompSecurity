...
_L1:
            ...
            Feature.l(a).schedule(new Feature._cls3._cls1(this), 0L, Feature.j());
            Feature.b(a, new Timer());
            if (!flag)
            {
                Feature.m(a).schedule(new Feature._cls3._cls2(), 0x927c0L);
                return;
            } else
            {
        ...
        // Unreferenced inner class com/kochava/android/tracker/Feature$3$2

/* anonymous class */
        class Feature._cls3._cls2 extends TimerTask
        {
