...
_L1:
        ...
        Feature.f(a, android.provider.ecure.getString(Feature.d(a).getContentResolver(), "android_id"));
        ...
        Feature.l(a).schedule(new TimerTask() {
        ...
        if (!flag)
        {
            Feature.m(a).schedule(new TimerTask() {
        ...
        } else
        {
            ...
            Feature.n(a).schedule(new TimerTask() {
