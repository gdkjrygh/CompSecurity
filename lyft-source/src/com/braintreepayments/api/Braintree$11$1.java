    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/braintreepayments/api/Braintree$11

/* anonymous class */
    class Braintree._cls11
        implements Braintree.ListenerCallback
    {
        ...
        public void execute()
        {
            ...
            for (Iterator iterator = Braintree.access$1100(Braintree.this).iterator(); iterator.hasNext(); Braintree.access$800(Braintree.this).post(errorlistener. new Braintree._cls11._cls1()))
            {
