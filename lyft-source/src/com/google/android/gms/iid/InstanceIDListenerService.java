...
public class InstanceIDListenerService extends Service
{
    ...
    private void zza(Message message, int i)
    {
        ...
        if (i != zzc.c && i != zzc.b)
        {
            Log.w("InstanceID", (new StringBuilder()).append("Message from unexpected caller ").append(i).append(" mine=").append(zzc.b).append(" appid=").append(zzc.c).toString());
            return;
        } else
        {
    ...
    public void zzn(Intent intent)
    {
        ...
        if (s1 == null)
        {
            obj = InstanceID.b(this);
        } else
        {
            obj = new Bundle();
            ((Bundle) (obj)).putString("subtype", s1);
            obj = InstanceID.a(this, ((Bundle) (obj)));
        }
...
_L3:
        ...
        if ("PING".equals(s))
        {
            try
            {
                GoogleCloudMessaging.a(this).a(zzavK, zzc.b(), 0L, intent.getExtras());
                return;
            }
