...
_L3:
    ...
    KeyPair a(String s, long l)
    {
        ...
        KeyPair keypair;
        keypair = zza.a();
        a.edit().putString((new StringBuilder()).append(s).append("|P|").toString(), InstanceID.a(keypair.getPublic().getEncoded())).putString((new StringBuilder()).append(s).append("|K|").toString(), InstanceID.a(keypair.getPrivate().getEncoded())).putString((new StringBuilder()).append(s).append("|S|").append("cre").toString(), Long.toString(l)).commit();
        this;
        JVM INSTR monitorexit ;
        return keypair;
        s;
