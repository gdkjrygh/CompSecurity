...
public final class AnalyticsReceiver extends BroadcastReceiver
{
    ...
    public static boolean a(Context context)
    {
        ...
        {
            boolean flag = zzam.a(context, com/google/android/gms/analytics/AnalyticsReceiver, false);
    ...
    {
        zzaf zzaf1;
        Object obj = zzf.a(context);
        zzaf1 = ((zzf) (obj)).f();
        intent = intent.getAction();
        boolean flag;
        if (((zzf) (obj)).e().a())
        {
            zzaf1.a("Device AnalyticsReceiver got", intent);
        } else
        {
            zzaf1.a("Local AnalyticsReceiver got", intent);
        }
...
_L3:
        ...
        throw context;
        context;
        zzaf1.e("Analytics service at risk of not starting. For more reliable analytics, add the WAKE_LOCK permission to your manifest. See http://goo.gl/8Rd3yj for instructions.");
          goto _L3
    }
