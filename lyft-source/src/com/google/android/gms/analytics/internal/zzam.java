...
public class zzam
{
    ...
    public static zzny a(zzaf zzaf1, String s)
    {
        zzu.a(zzaf1);
        ...
        {
            zzaf1.d("No valid campaign data found", s);
            return null;
        }
        ...
        s = new zzny();
        s.e((String)zzaf1.get("utm_content"));
        s.c((String)zzaf1.get("utm_medium"));
        s.a((String)zzaf1.get("utm_campaign"));
        s.b((String)zzaf1.get("utm_source"));
        s.d((String)zzaf1.get("utm_term"));
        s.f((String)zzaf1.get("utm_id"));
        s.g((String)zzaf1.get("anid"));
        s.h((String)zzaf1.get("gclid"));
        s.i((String)zzaf1.get("dclid"));
        s.j((String)zzaf1.get("aclid"));
        return s;
    }
