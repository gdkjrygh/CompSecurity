...
public final class zzrc extends zzrh
{
    ...
    public static zzrc a(byte abyte0[])
    {
        return (zzrc)zzrn.a(new zzrc(), abyte0);
    }
    ...
    public int hashCode()
    {
        return (zzrl.a(a) + 527) * 31 + d();
    }

    private class zza extends zzrh
    {
...
_L5:
            flag = flag1;
            if (((zza) (obj)).a != null) goto _L4; else goto _L7
_L7:
            if (b != null)
            {
