...
_L1:
        if (a(zzrf1, i)) goto _L5; else goto _L2
_L2:
        return this;
_L3:
        int j = zzrf1.f();
        ...
        class zza extends zzrh
        {
            ...
            public zza a(zzrf zzrf2)
            {
                do
                {
                    ...
                    case 98: // 'b'
                        int l4 = zzrf2.d(zzrf2.k());
                        int j2 = zzrf2.q();
                        int i4;
                        for (i4 = 0; zzrf2.o() > 0; i4++)
                        {
                            zzrf2.e();
                        }
