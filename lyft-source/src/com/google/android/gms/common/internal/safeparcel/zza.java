...
public class zza
{
    ...
    public static ArrayList A(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
    ...
    private static void a(Parcel parcel, int i1, int j1)
    {
        ...
        if (i1 != j1)
        {
            throw new zza((new StringBuilder()).append("Expected size ").append(j1).append(" got ").append(i1).append(" (0x").append(Integer.toHexString(i1)).append(")").toString(), parcel);
        } else
        {
            return;
        }
    ...
    private static void a(Parcel parcel, int i1, int j1, int k1)
    {
        if (j1 != k1)
        {
            throw new zza((new StringBuilder()).append("Expected size ").append(k1).append(" got ").append(j1).append(" (0x").append(Integer.toHexString(j1)).append(")").toString(), parcel);
        } else
        {
            return;
        }
    ...
    public static int b(Parcel parcel)
    {
        ...
        if (a(j1) != 20293)
        {
            throw new zza((new StringBuilder()).append("Expected object header. Got 0x").append(Integer.toHexString(j1)).toString(), parcel);
        }
        j1 = i1 + k1;
        if (j1 < i1 || j1 > parcel.dataSize())
        {
            throw new zza((new StringBuilder()).append("Size read is invalid start=").append(i1).append(" end=").append(j1).toString(), parcel);
        } else
        {
            return j1;
        }
    ...
    public static byte[][] q(Parcel parcel, int i1)
    {
        int j1 = a(parcel, i1);
        int k1 = parcel.dataPosition();
        if (j1 == 0)
    ...
    public static boolean[] r(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
        int j1 = parcel.dataPosition();
        if (i1 == 0)
    ...
    public static long[] t(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
        int j1 = parcel.dataPosition();
        if (i1 == 0)
    ...
    public static BigInteger[] u(Parcel parcel, int i1)
    {
        int j1 = a(parcel, i1);
        int k1 = parcel.dataPosition();
        if (j1 == 0)
    ...
    public static float[] v(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
        int j1 = parcel.dataPosition();
        if (i1 == 0)
    ...
    public static double[] w(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
        int j1 = parcel.dataPosition();
        if (i1 == 0)
    ...
    public static BigDecimal[] x(Parcel parcel, int i1)
    {
        int j1 = a(parcel, i1);
        int k1 = parcel.dataPosition();
        if (j1 == 0)
    ...
    public static String[] y(Parcel parcel, int i1)
    {
        i1 = a(parcel, i1);
        int j1 = parcel.dataPosition();
        if (i1 == 0)
