    ...
    implements Runnable
{
    ...
    private void a(eReceiver ereceiver, boolean flag)
    {
        ...
        while (i < j) 
        {
            ...
            if (flag)
            {
                zza1.a(ImageManager.b(a), c, false);
            } else
            {
                ImageManager.d(a).put(b, Long.valueOf(SystemClock.elapsedRealtime()));
                zza1.a(ImageManager.b(a), ImageManager.c(a), false);
            }
            if (!(zza1 instanceof a))
            {
                ImageManager.a(a).remove(zza1);
            }
            i++;
        }
    }
    ...
    public void run()
    {
        ...
        eReceiver ereceiver = (eReceiver)ImageManager.e(a).remove(b);
        if (ereceiver != null)
        {
            a(ereceiver, flag);
        }
