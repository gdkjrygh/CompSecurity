    ...
    implements android.os.Parcelable.Creator
{
    ...
    {
        int j = zzb.a(parcel);
        zzb.a(parcel, 1, groundoverlayoptionsparcelable.a());
        zzb.a(parcel, 2, groundoverlayoptionsparcelable.b(), i, false);
        zzb.a(parcel, j);
    }

    public GroundOverlayOptionsParcelable a(Parcel parcel)
    {
        int j = zza.b(parcel);
        int i = 0;
    ...
    public GroundOverlayOptionsParcelable[] a(int i)
    {
