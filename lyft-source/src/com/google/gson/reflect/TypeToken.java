...
public class TypeToken
{
    ...
    protected TypeToken()
    {
        ...
        rawType = com.google.gson.internal..Gson.Types.e(type);
        hashCode = type.hashCode();
    }

    TypeToken(Type type1)
    {
        type = com.google.gson.internal..Gson.Types.d((Type)com.google.gson.internal..Gson.Preconditions.a(type1));
        rawType = com.google.gson.internal..Gson.Types.e(type);
        hashCode = type.hashCode();
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return com.google.gson.internal..Gson.Types.d(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L3:
    ...
    private static boolean isAssignableFrom(Type type1, ParameterizedType parameterizedtype, Map map)
    {
        ...
        Class class1 = com.google.gson.internal..Gson.Types.e(type1);
        int k;
...
_L4:
    ...
    {
        return (obj instanceof TypeToken) && com.google.gson.internal..Gson.Types.a(type, ((TypeToken)obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(com.google.gson.internal..Gson.Types.e(type1));
        }
        ...
        {
            boolean flag;
            if (rawType.isAssignableFrom(com.google.gson.internal..Gson.Types.e(type1)) && isAssignableFrom(type1, (GenericArrayType)type))
            {
                flag = true;
            } else
            {
    ...
    {
        return com.google.gson.internal..Gson.Types.f(type);
    }
}
