...
_L1:
    ...
    {
        throw new MalformedJsonException((new StringBuilder()).append(s1).append(" at line ").append(v()).append(" column ").append(w()).append(" path ").append(q()).toString());
    }
...
_L1:
    ...
    public double k()
    {
        ...
        do
        {
            ...
            {
                throw new MalformedJsonException((new StringBuilder()).append("JSON forbids NaN and infinities: ").append(d1).append(" at line ").append(v()).append(" column ").append(w()).append(" path ").append(q()).toString());
            } else
            {
                l = null;
                i = 0;
    ...
    static 
    {
        JsonReaderInternalAccess.a = new JsonReaderInternalAccess() {
            ...
            public void a(JsonReader jsonreader)
            {
                ...
                {
                    throw new IllegalStateException((new StringBuilder()).append("Expected a name but was ").append(jsonreader.f()).append(" ").append(" at line ").append(JsonReader.c(jsonreader)).append(" column ").append(JsonReader.d(jsonreader)).append(" path ").append(jsonreader.q()).toString());
                }
            }
