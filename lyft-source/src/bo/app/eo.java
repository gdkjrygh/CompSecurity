...
public class eo extends dx
{
    ...
    static final gw a = (new gx()).c("twitter").c("facebook").c("ab_install_attribution").a();
    private static final String b;
    private final SharedPreferences c;
    private final em d;

    public eo(Context context, em em1)
    {
        this(context, null, null, em1);
    }

    public eo(Context context, String s, String s1, em em1)
    {
        c = context.getSharedPreferences((new StringBuilder("com.appboy.storage.usercache")).append(ev.b(s, s1)).toString(), 0);
        d = em1;
    }
            ...
            do
            {
                ...
                if (map.containsKey(obj2))
                {
                    ...
                    if (obj4 instanceof JSONObject)
                    {
                        try
                        {
                            if (ld.a(String.valueOf(obj3), obj4.toString(), le.c).a)
                            {
                                ((android.content.SharedPreferences.Editor) (obj)).remove(((String) (obj2)));
                            }
                        }
...
_L4:
        ...
        return flag;
_L2:
        month = er.a(er.a(j, month.getValue(), k), af.a);
        android.content.SharedPreferences.Editor editor = c.edit();
...
label4:
        {
            ...
            editor.putString(s, er.a((Date)obj, af.b));
        }
          goto _L5
