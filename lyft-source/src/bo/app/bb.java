    ...
    implements be
{
    ...
    public final void a(Object obj, Class class1)
    {
        ...
        do
        {
            ...
            {
                ((Activity)entry.getKey()).runOnUiThread(new bc(this, class1, copyonwritearrayset, obj));
            }
        } while (true);
        ...
        if (obj1 != null)
        {
            ...
            for (obj1 = b(class1, ((CopyOnWriteArraySet) (obj1))).iterator(); ((Iterator) (obj1)).hasNext(); h.execute(new bd(this, ieventsubscriber, obj)))
            {
...
_L4:
    ...
    static 
    {
        g = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, bo/app/bb.getName()
        });
    }
}
