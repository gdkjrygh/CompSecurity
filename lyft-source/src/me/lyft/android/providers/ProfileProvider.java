...
public class ProfileProvider
{
    ...
    private static final String PHONE_PROFILE_PROJECTION[] = {
        "is_primary", "data3", "data2", "photo_uri"
    };
    private final ContentResolver contentResolver;
    final rx.Observable.OnSubscribe phoneProfileSubscriber = new rx.Observable.OnSubscribe() {
        ...
        {
            Cursor cursor1 = contentResolver.query(Uri.withAppendedPath(android.provider.ContactsContract.Profile.CONTENT_URI, "data"), ProfileProvider.PHONE_PROFILE_PROJECTION, null, null, "is_primary DESC LIMIT 1");
            Cursor cursor;
            if (cursor1 == null)
            {
            ...
            cursor = cursor1;
            phoneprofile.setPhotoUri(Uri.parse(s));
            cursor = cursor1;
...
_L3:
    ...
    public Observable observePhoneProfile()
    {
