    ...
    implements Func1
{
    ...
    // Unreferenced inner class me/lyft/android/ui/placesearch/PlaceSearchPresenter$4

/* anonymous class */
    class PlaceSearchPresenter._cls4
        implements Func1
    {
        ...
        {
            return Iterables.select(list, new PlaceSearchPresenter._cls4._cls1());
        }
