...
//            GooglePlaceItemViewModel, IPlaceItemViewModel, PlaceSearchPresenter
    ...
    implements Func1
{
    ...
    // Unreferenced inner class me/lyft/android/ui/placesearch/PlaceSearchPresenter$5

/* anonymous class */
    class PlaceSearchPresenter._cls5
        implements Func1
    {
        ...
        {
            return Iterables.select(list, new PlaceSearchPresenter._cls5._cls1());
        }
