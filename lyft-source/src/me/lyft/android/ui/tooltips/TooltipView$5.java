    ...
    implements Action1
{
    ...
    public void call(Unit unit)
    {
        ...
        } else
        {
            ...
            tooltipTopArrow.setX(TooltipView.access$200(TooltipView.this, val$anchorView, tooltipTopArrow, getX()));
            setY(TooltipView.access$300(TooltipView.this, val$anchorView) + val$anchorView.getHeight());
            TooltipView.access$400(TooltipView.this, tooltipTopArrow.getX(), tooltipTopArrow.getY());
            return;
        }
    }
