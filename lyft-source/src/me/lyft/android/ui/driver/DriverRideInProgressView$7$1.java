    ...
    implements Func0
{
    ...
    public Boolean call()
    {
        return Boolean.valueOf(DriverRideInProgressView.access$100(_fld0).isPickup());
    }
    ...
    // Unreferenced inner class me/lyft/android/ui/driver/DriverRideInProgressView$7

/* anonymous class */
    class DriverRideInProgressView._cls7
        implements Action1
    {
        ...
        public void call(DriverRide driverride)
        {
            ...
            DriverRideInProgressView.access$2900(DriverRideInProgressView.this).onNext((new DriverRideInProgressView._cls7._cls1()).call());
