    ...
    implements Action1
{
    ...
    public void call(Stop stop)
    {
        if (stop.isPickup())
        {
            displayPickupAddress(DriverRideInProgressView.access$100(_fld0));
            DriverRideInProgressView.access$2000(_fld0, DriverRideInProgressView.access$100(_fld0));
        } else
        if (stop.isDropOff())
        {
            displayDropoffAddress(DriverRideInProgressView.access$100(_fld0));
            DriverRideInProgressView.access$2100(_fld0, DriverRideInProgressView.access$100(_fld0));
            return;
        }
    }
...
/* anonymous class */
        ...
        implements Action1
    {
        ...
        // Unreferenced inner class me/lyft/android/ui/driver/DriverRideInProgressView$5$1

/* anonymous class */
        class DriverRideInProgressView._cls5._cls1
            implements Action1
        {
