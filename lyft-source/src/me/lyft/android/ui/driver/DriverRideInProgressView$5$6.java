    ...
    implements Action1
{
    ...
    {
        if (DriverRideInProgressView.access$100(_fld0).isPickup())
        {
            DriverRideInProgressView.access$2200(_fld0, DriverRideInProgressView.access$100(_fld0));
            return;
        } else
        {
            DriverRideInProgressView.access$2300(_fld0, DriverRideInProgressView.access$100(_fld0));
            return;
        }
    }
