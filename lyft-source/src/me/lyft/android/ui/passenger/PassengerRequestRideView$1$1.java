...
//            PassengerRequestRideView, PaymentWidgetContainerView, PassengerRideAddressInput, RequestRideButton
    ...
    implements Action1
{
    ...
    // Unreferenced inner class me/lyft/android/ui/passenger/PassengerRequestRideView$1

/* anonymous class */
    class PassengerRequestRideView._cls1
        implements Action1
    {
        ...
        public void call(Unit unit)
        {
            ...
            PassengerRequestRideView.access$100(PassengerRequestRideView.this).bind(PassengerRequestRideView.access$4100(PassengerRequestRideView.this), new PassengerRequestRideView._cls1._cls1());
            ...
            PassengerRequestRideView.access$100(PassengerRequestRideView.this).bind(Observable.interval(1L, TimeUnit.MINUTES).flatMap(new PassengerRequestRideView._cls1._cls2()), PassengerRequestRideView.access$4500(PassengerRequestRideView.this));
        }
        ...
        // Unreferenced inner class me/lyft/android/ui/passenger/PassengerRequestRideView$1$2

/* anonymous class */
        class PassengerRequestRideView._cls1._cls2
            implements Func1
        {
