    ...
    implements Func1
{
    ...
    {
        boolean flag;
        if (rideRequestSession.getCurrentRideType().isCourier() && PassengerRequestRideView.access$5400(_fld0))
        {
            flag = true;
        } else
        {
...
/* anonymous class */
        ...
        implements Action1
    {
        ...
        // Unreferenced inner class me/lyft/android/ui/passenger/PassengerRequestRideView$44$1

/* anonymous class */
        class PassengerRequestRideView._cls44._cls1
            implements Action0
        {
