...
//            ConfirmModule, ConfirmPresenter
    ...
    implements Provider
{
    ...
    {
        passengerRequestRidePresenter = linker.requestBinding("me.lyft.android.ui.passenger.v2.PassengerRequestRidePresenterV2", me/lyft/android/ui/passenger/v2/confirm/ConfirmModule, getClass().getClassLoader());
        ...
        locationService = linker.requestBinding("me.lyft.android.infrastructure.location.ILocationService", me/lyft/android/ui/passenger/v2/confirm/ConfirmModule, getClass().getClassLoader());
        ...
        geoService = linker.requestBinding("me.lyft.android.application.geo.IGeoService", me/lyft/android/ui/passenger/v2/confirm/ConfirmModule, getClass().getClassLoader());
        ...
        constantsProvider = linker.requestBinding("me.lyft.android.application.IConstantsProvider", me/lyft/android/ui/passenger/v2/confirm/ConfirmModule, getClass().getClassLoader());
    }
    ...
    {
        return module.provideSetDestinationController((PassengerRequestRidePresenterV2)passengerRequestRidePresenter.get(), (RideMap)rideMap.get(), (ILocationService)locationService.get(), (IRideRequestSession)rideRequestSession.get(), (IGeoService)geoService.get(), (PassengerRequestRideRouter)displayManager.get(), (IConstantsProvider)constantsProvider.get());
    }
    ...
    public y(ConfirmModule confirmmodule)
    {
        super("me.lyft.android.ui.passenger.v2.confirm.ConfirmPresenter", true, "me.lyft.android.ui.passenger.v2.confirm.ConfirmModule", "provideSetDestinationController");
