    ...
    implements Provider
{
    ...
    {
        return module.provideSplitFareRequestRepository((ISimpleStorage)simpleStorage.get());
    }
    ...
    {
        super("me.lyft.android.infrastructure.splitfare.ISplitFareRequestRepository", true, "me.lyft.android.application.ApplicationServicesModule", "provideSplitFareRequestRepository");
