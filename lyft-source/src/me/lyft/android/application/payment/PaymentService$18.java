    ...
    implements Func1
{
    ...
    {
        s = PaymentService.access$200(PaymentService.this).makePayPalDefault(PaymentService.access$100(PaymentService.this).getUser().getId(), val$chargeAccountId, s);
        return PaymentService.access$500(PaymentService.this, s);
    }
