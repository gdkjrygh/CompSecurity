    ...
    implements Provider
{
    ...
    public IVehicleProvider get()
    {
        return module.provideVehicleProvider((ISimpleStorage)simpleStorage.get());
    }
    ...
    {
        super("me.lyft.android.application.driver.IVehicleProvider", false, "me.lyft.android.application.ApplicationServicesModule", "provideVehicleProvider");
