    ...
    implements Provider
{
    ...
    public ITopDestinationProvider get()
    {
        return module.provideTopDestinationsProvider((IUserSession)userSession.get());
    }
    ...
    {
        super("me.lyft.android.application.topdestinations.ITopDestinationProvider", true, "me.lyft.android.application.ApplicationServicesModule", "provideTopDestinationsProvider");
