    ...
    implements Func1
{
    ...
    {
        return DriverRouteService.access$100(DriverRouteService.this).changePartySizeAndStatus(val$passenger.getRideId(), "canceledWrongPartySize", val$partySize, LocationMapper.fromLocationDomain(location));
    }
