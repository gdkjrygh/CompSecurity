    ...
    implements Provider
{
    ...
    {
        locationUpdateService = linker.requestBinding("me.lyft.android.application.polling.ILocationUpdateService", me/lyft/android/application/ApplicationServicesModule, getClass().getClassLoader());
