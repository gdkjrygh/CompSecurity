    ...
    implements Provider
{
    ...
    {
        return module.providePreRideInfoRepository((ISimpleStorage)simpleStorage.get());
    }
    ...
    {
        super("me.lyft.android.application.ride.IPreRideInfoRepository", true, "me.lyft.android.application.ApplicationServicesModule", "providePreRideInfoRepository");
