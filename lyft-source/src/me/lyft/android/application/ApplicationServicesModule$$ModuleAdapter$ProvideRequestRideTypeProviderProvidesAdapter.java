    ...
    implements Provider
{
    ...
    {
        return module.provideRequestRideTypeProvider((ISimpleStorage)simpleStorage.get());
    }
    ...
    {
        super("me.lyft.android.application.ride.IRequestRideTypeProvider", true, "me.lyft.android.application.ApplicationServicesModule", "provideRequestRideTypeProvider");
