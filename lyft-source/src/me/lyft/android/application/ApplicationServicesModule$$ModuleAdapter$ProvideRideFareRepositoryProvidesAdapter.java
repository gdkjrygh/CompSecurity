    ...
    implements Provider
{
    ...
    {
        return module.provideRideFareRepository((ISimpleStorage)simpleStorage.get());
    }
    ...
    {
        super("me.lyft.android.application.ride.IRideFareRepository", true, "me.lyft.android.application.ApplicationServicesModule", "provideRideFareRepository");
