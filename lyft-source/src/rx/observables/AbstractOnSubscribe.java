    ...
    implements rx.Observable.OnSubscribe
{
    ...
    private class LambdaOnSubscribe extends AbstractOnSubscribe
    {
...
*/
        ...
        private SubscriptionState(Subscriber subscriber1, Object obj)
        {
            parent = AbstractOnSubscribe.this;
    ...
    private class SubscriptionCompleter extends AtomicBoolean
    ...
    private class SubscriptionProducer
        implements Producer
    {
