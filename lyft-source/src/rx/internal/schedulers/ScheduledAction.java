    ...
    implements Runnable, Subscription
{
    ...
    {
        action = action0;
        cancel = new SubscriptionList(new Remover2(subscriptionlist));
    }

    public ScheduledAction(Action0 action0, CompositeSubscription compositesubscription)
    {
        action = action0;
        cancel = new SubscriptionList(new Remover(compositesubscription));
    }
    ...
    {
        cancel.add(new Remover2(subscriptionlist));
    }

    public void addParent(CompositeSubscription compositesubscription)
    {
        cancel.add(new Remover(compositesubscription));
    }
...
_L1:
    ...
    private class Remover2 extends AtomicBoolean
        implements Subscription
    {
        ...
        public Remover2(SubscriptionList subscriptionlist)
        {
            s = ScheduledAction.this;
            parent = subscriptionlist;
        }
    }


    private class Remover extends AtomicBoolean
        implements Subscription
    {
        ...
        public Remover(CompositeSubscription compositesubscription)
        {
            s = ScheduledAction.this;
