...
final class subscriber
{
    ...
    public void run()
    {
        ...
        class LeftSubscriber extends Subscriber
        {
            ...
            public void onNext(Object obj)
            {
                ...
                class LeftDurationSubscriber extends Subscriber
                {
...
_L1:
        ...
        class RightSubscriber extends Subscriber
        {
            ...
            public void onNext(Object obj)
            {
                ...
                class RightDurationSubscriber extends Subscriber
                {
...
_L1:
    ...
    public RightSubscriber(Subscriber subscriber1)
    {
