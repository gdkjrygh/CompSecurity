    ...
    implements rx.Observable.OnSubscribe
{
    ...
    {
        subscriber.setProducer(new RangeProducer(subscriber, start, end));
    }

    private class RangeProducer extends AtomicLong
        implements Producer
    {
...
_L7:
        ...
        private RangeProducer(Subscriber subscriber, int i, int j)
        {
            o = subscriber;
            index = i;
            end = j;
