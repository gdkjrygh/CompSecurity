...
public final class OperatorSequenceEqual
{
    ...
    public static Observable sequenceEqual(Observable observable, Observable observable1, final Func2 equality)
    {
        return Observable.zip(materializeLite(observable), materializeLite(observable1), new Func2() {
