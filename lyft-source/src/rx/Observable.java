...
//            Subscriber, Single, Subscription, Scheduler, 
...
public class Observable
{
    ...
    private static Subscription subscribe(Subscriber subscriber, Observable observable)
    {
        ...
        catch (Subscriber subscriber)
        {
            ...
            {
                subscriber = new RuntimeException((new StringBuilder()).append("Error occurred attempting to subscribe [").append(subscriber.getMessage()).append("] and then again while trying to pass to onError.").toString(), observable);
    ...
    public final Observable lift(final Operator operator)
    {
        return new Observable(new OnSubscribe() {
            ...
            public void call(Subscriber subscriber)
            {
                ...
                try
                {
                    obj = (Subscriber)Observable.hook.onLift(operator).call(subscriber);
                }
                // Misplaced declaration of an exception variable
                catch (Object obj)
                {
    ...
    public final Observable replay(final Func1 selector, final int bufferSize, final Scheduler scheduler)
    {
        return OperatorReplay.multicastSelector(new Func0() {
            ...
            public Observable call(Observable observable)
            {
                return ((Observable)selector.call(observable)).observeOn(scheduler);
            }
    ...
    public final Observable replay(final Func1 selector, final Scheduler scheduler)
    {
        return OperatorReplay.multicastSelector(new Func0() {
    ...
    public Object x(Func1 func1)
    {
        return func1.call(new OnSubscribe() {
    ...
    private class ThrowObservable extends Observable
    {
    ...
    private class NeverObservable extends Observable
    {
    ...
    private class HolderAnyForEmpty
    {
