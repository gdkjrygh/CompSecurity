...
public class Single
{
    ...
    public static final Single error(final Throwable exception)
    {
    ...
    public static final Single just(final Object value)
    {
        return create(new OnSubscribe() {
    ...
    public static final Single merge(final Single source)
    {
        return create(new OnSubscribe() {
