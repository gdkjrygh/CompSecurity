...
public class ViewPager extends ViewGroup
{
    ...
    private static final Comparator COMPARATOR = new Comparator() {
        ...
        public int a(ItemInfo iteminfo, ItemInfo iteminfo1)
        {
            return iteminfo.b - iteminfo1.b;
        }

        public int compare(Object obj, Object obj1)
        {
            return a((ItemInfo)obj, (ItemInfo)obj1);
        }
    ...
    private void calculatePageOffsets(ItemInfo iteminfo, int i, ItemInfo iteminfo1)
    {
        ...
        if (iteminfo1 != null)
        {
            ...
            if (j < iteminfo.b)
            {
                float f = iteminfo1.e + iteminfo1.d + f3;
                j++;
                int j1;
                for (int k = 0; j <= iteminfo.b && k < mItems.size(); j = j1 + 1)
                {
            ...
            {
                int l = mItems.size() - 1;
                float f1 = iteminfo1.e;
                int k1;
                for (j--; j >= iteminfo.b && l >= 0; j = k1 - 1)
                {
                    ...
                    for (; k1 > iteminfo1.b; k1--)
                    {
                        f5 -= mAdapter.getPageWidth(k1) + f3;
                    }

                    f1 = f5 - (iteminfo1.d + f3);
                    iteminfo1.e = f1;
                }
        ...
        for (; i1 >= 0; i1--)
        {
            for (iteminfo1 = (ItemInfo)mItems.get(i1); j > iteminfo1.b; j--)
            {
        ...
        f2 = iteminfo.e + iteminfo.d + f3;
        i1 = iteminfo.b + 1;
        j = i + 1;
        i = i1;
        for (; j < l1; j++)
        {
            for (iteminfo = (ItemInfo)mItems.get(j); i < iteminfo.b; i++)
            {
            ...
            if (iteminfo.b == i2 - 1)
            {
                mLastOffset = (iteminfo.d + f2) - 1.0F;
            }
            iteminfo.e = f2;
            f2 += iteminfo.d + f3;
            i++;
...
label0:
        {
            ...
            if (flag1)
            {
                ...
                ViewCompat.a(this, mEndScrollRunnable);
            }
            return;
        }
    ...
    private int determineTargetPage(int i, float f, int j, int k)
    {
        ...
        if (mItems.size() > 0)
        {
            ...
            j = Math.max(iteminfo.b, Math.min(i, iteminfo1.b));
        }
        return j;
    }
    ...
    private void enableLayers(boolean flag)
    {
        ...
        while (i < j) 
        {
            ...
            ViewCompat.a(getChildAt(i), byte0, null);
            i++;
        }
    }
...
label1:
                {
                    ...
                    if (!flag && iteminfo.b != j + 1)
                    {
                        iteminfo = mTempItem;
                        iteminfo.e = f3 + f2 + f1;
                        iteminfo.b = j + 1;
                        iteminfo.d = mAdapter.getPageWidth(iteminfo.b);
                        i--;
                    }
                    f2 = iteminfo.e;
                    f3 = iteminfo.d;
    ...
    private void onSecondaryPointerUp(MotionEvent motionevent)
    {
        ...
        if (MotionEventCompat.b(motionevent, i) == mActivePointerId)
        {
            if (i == 0)
            {
                i = 1;
            ...
            mLastMotionX = MotionEventCompat.c(motionevent, i);
            mActivePointerId = MotionEventCompat.b(motionevent, i);
            if (mVelocityTracker != null)
            {
    ...
    private boolean pageScrolled(int i)
    {
        ...
        } else
        {
            ...
            int j = iteminfo.b;
            f = ((float)i / (float)k - iteminfo.e) / (iteminfo.d + f);
            i = (int)((float)(l + k) * f);
            mCalledSuper = false;
    ...
    private boolean performDrag(float f)
    {
        ...
        if (iteminfo.b != 0)
        {
            f = iteminfo.e * (float)i;
            flag = false;
        } else
        {
            flag = true;
        }
        if (iteminfo1.b != mAdapter.getCount() - 1)
        {
            f1 = iteminfo1.e * (float)i;
            flag1 = false;
        } else
        {
            f1 *= f3;
...
_L1:
        ...
        if (flag)
        {
            flag2 = mLeftEdge.a(Math.abs(f - f2) / (float)i);
            f1 = f;
        }
_L4:
...
_L2:
        if (f2 > f1)
        {
            ...
            if (flag1)
            {
                flag2 = mRightEdge.a(Math.abs(f2 - f1) / (float)i);
            }
        } else
        {
            f1 = f2;
...
_L3:
    ...
    private void recomputeScrollPosition(int i, int j, int k, int l)
    {
        if (j > 0 && !mItems.isEmpty())
        {
            ...
            if (!mScroller.isFinished())
            {
                ...
                mScroller.startScroll(j, 0, (int)(iteminfo.e * (float)i), 0, k - l);
            }
        } else
        {
            ...
            if (iteminfo1 != null)
            {
                f1 = Math.min(iteminfo1.e, mLastOffset);
            } else
            {
                f1 = 0.0F;
            }
    ...
    private void scrollToItem(int i, boolean flag, int j, boolean flag1)
    {
        ...
        if (iteminfo != null)
        {
            ...
            k = (int)(Math.max(mFirstOffset, Math.min(iteminfo.e, mLastOffset)) * f);
        } else
        {
            k = 0;
        }
        ...
        if (i1 != 0x60000)
        {
            for (int k = 0; k < getChildCount(); k++)
            {
                ...
                if (view.getVisibility() == 0)
                {
                    ...
                    if (iteminfo != null && iteminfo.b == mCurItem)
                    {
    ...
    ItemInfo addNewItem(int i, int j)
    {
        ...
        iteminfo.b = i;
        iteminfo.a = mAdapter.instantiateItem(this, i);
        iteminfo.d = mAdapter.getPageWidth(i);
    ...
    public void addView(View view, int i, android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        layoutparams1.a = layoutparams1.a | (view instanceof Decor);
        if (mInLayout)
        {
...
_L2:
        if (flag && ViewCompat.a(view, -i)) goto _L4; else goto _L6
_L6:
        return false;
...
_L7:
    ...
    void dataSetChanged()
    {
        ...
        while (k < mItems.size()) 
        {
            ...
            int i1 = mAdapter.getItemPosition(((ItemInfo) (obj)).a);
            int k1;
            if (i1 == -1)
            {
                i1 = k;
            ...
            if (i1 == -2)
            {
                ...
                mAdapter.destroyItem(this, ((ItemInfo) (obj)).b, ((ItemInfo) (obj)).a);
                int l1;
                if (mCurItem == ((ItemInfo) (obj)).b)
                {
            ...
            if (((ItemInfo) (obj)).b != i1)
            {
                if (((ItemInfo) (obj)).b == mCurItem)
                {
                    i = i1;
                }
                obj.b = i1;
...
_L2:
        ...
        do
        {
            ...
            {
                ItemInfo iteminfo = infoForChild(view);
                if (iteminfo != null && iteminfo.b == mCurItem && view.dispatchPopulateAccessibilityEvent(accessibilityevent))
                {
                    return true;
                }
            }
...
_L3:
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (k == 0 || k == 1 && mAdapter != null && mAdapter.getCount() > 1)
        {
            ...
            if (!mRightEdge.a())
            {
                ...
                mRightEdge.a(j1 - k1 - l1, j);
                j = i | mRightEdge.a(canvas);
    ...
    public void endFakeDrag()
    {
        ...
        } else
        {
            ...
            int i = (int)VelocityTrackerCompat.a(((VelocityTracker) (obj)), mActivePointerId);
            mPopulatePending = true;
            int j = getClientWidth();
            int k = getScrollX();
            obj = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(((ItemInfo) (obj)).b, ((float)k / (float)j - ((ItemInfo) (obj)).e) / ((ItemInfo) (obj)).d, i, (int)(mLastMotionX - mInitialMotionX)), true, true, i);
            endDrag();
            mFakeDragging = false;
            return;
        }
...
_L6:
    ...
    public void fakeDragBy(float f)
    {
        ...
        if (((ItemInfo) (obj)).b != 0)
        {
            f = ((ItemInfo) (obj)).e * (float)i;
        } else
        {
            f *= f4;
        }
        if (iteminfo.b != mAdapter.getCount() - 1)
        {
            f1 = iteminfo.e * (float)i;
        } else
        {
            f1 *= f3;
        }
    ...
    protected int getChildDrawingOrder(int i, int j)
    {
        ...
        return ((LayoutParams)((View)mDrawingOrderedChildren.get(k)).getLayoutParams()).f;
    }
    ...
    ItemInfo infoForChild(View view)
    {
        ...
        {
            ItemInfo iteminfo = (ItemInfo)mItems.get(i);
            if (mAdapter.isViewFromObject(view, iteminfo.a))
            {
                return iteminfo;
            }
        }
...
_L1:
        ...
        i1 = mItems.size();
        i = ((ItemInfo) (obj)).b;
        j1 = ((ItemInfo)mItems.get(i1 - 1)).b;
        j = 0;
_L6:
        if (i >= j1) goto _L2; else goto _L3
_L3:
        for (; i > ((ItemInfo) (obj)).b && j < i1; obj = (ItemInfo)((ArrayList) (obj)).get(j))
        {
            obj = mItems;
            j++;
        }
        ...
        if (i == ((ItemInfo) (obj)).b)
        {
            f1 = (((ItemInfo) (obj)).e + ((ItemInfo) (obj)).d) * (float)l;
            f = ((ItemInfo) (obj)).e + ((ItemInfo) (obj)).d + f2;
        } else
        {
...
_L7:
        ...
        j = MotionEventCompat.a(motionevent, j);
        f2 = MotionEventCompat.c(motionevent, j);
        f = f2 - mLastMotionX;
        f4 = Math.abs(f);
        f3 = MotionEventCompat.d(motionevent, j);
...
_L6:
        ...
        mInitialMotionY = f1;
        mLastMotionY = f1;
        mActivePointerId = MotionEventCompat.b(motionevent, 0);
        mIsUnableToDrag = false;
...
_L2:
        ...
        for (l = 0; l < l3; l++)
        {
            ...
            float f = i1;
            int l1 = (int)(iteminfo.e * f) + j;
            if (layoutparams1.d)
            {
                layoutparams1.d = false;
                float f1 = i1;
                view1.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)(layoutparams1.c * f1), 0x40000000), android.view.View.MeasureSpec.makeMeasureSpec(i4 - i - k, 0x40000000));
            }
...
label1:
            ...
            for (j = 0; j < k; j++)
            {
                ...
                {
                    f = i;
                    view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)(layoutparams.c * f), 0x40000000), mChildHeightMeasureSpec);
                }
            }
...
_L4:
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect)
    {
        ...
        for (; j != k; j += byte0)
        {
            ...
            ItemInfo iteminfo = infoForChild(view);
            if (iteminfo != null && iteminfo.b == mCurItem && view.requestFocus(i, rect))
            {
                return true;
            }
        }
...
_L4:
        if (!mIsBeingDragged)
        {
            i = MotionEventCompat.a(motionevent, mActivePointerId);
            float f1 = MotionEventCompat.c(motionevent, i);
            float f3 = Math.abs(f1 - mLastMotionX);
            float f2 = MotionEventCompat.d(motionevent, i);
        ...
        if (mIsBeingDragged)
        {
            i = false | performDrag(MotionEventCompat.c(motionevent, MotionEventCompat.a(motionevent, mActivePointerId)));
        }
        continue; /* Loop/switch isn't completed */
_L3:
        i = j;
        if (mIsBeingDragged)
        {
            Object obj = mVelocityTracker;
            ((VelocityTracker) (obj)).computeCurrentVelocity(1000, mMaximumVelocity);
            i = (int)VelocityTrackerCompat.a(((VelocityTracker) (obj)), mActivePointerId);
            mPopulatePending = true;
            j = getClientWidth();
            int k = getScrollX();
            obj = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(((ItemInfo) (obj)).b, ((float)k / (float)j - ((ItemInfo) (obj)).e) / ((ItemInfo) (obj)).d, i, (int)(MotionEventCompat.c(motionevent, MotionEventCompat.a(motionevent, mActivePointerId)) - mInitialMotionX)), true, true, i);
            mActivePointerId = -1;
            endDrag();
...
_L8:
        onSecondaryPointerUp(motionevent);
        mLastMotionX = MotionEventCompat.c(motionevent, MotionEventCompat.a(motionevent, mActivePointerId));
        i = j;
...
_L20:
        ...
        if (((ItemInfo) (obj)).b < mCurItem) goto _L6; else goto _L5
_L5:
        if (((ItemInfo) (obj)).b != mCurItem)
        {
            break MISSING_BLOCK_LABEL_1273;
...
_L7:
        ...
        {
            f1 = (2.0F - ((ItemInfo) (obj2)).d) + (float)getPaddingLeft() / (float)i2;
        }
        j = mCurItem;
        f2 = 0.0F;
        l = j - 1;
...
_L13:
        ...
        if (l == ((ItemInfo) (obj3)).b)
        {
            ...
            {
                mItems.remove(i1);
                mAdapter.destroyItem(this, l, ((ItemInfo) (obj3)).a);
                i = i1 - 1;
                j = k - 1;
                if (i >= 0)
                {
...
_L22:
        ...
        k = j;
          goto _L21
_L12:
        if (obj3 != null && l == ((ItemInfo) (obj3)).b)
        {
            f = f2 + ((ItemInfo) (obj3)).d;
            i = i1 - 1;
            if (i >= 0)
            {
                obj = (ItemInfo)mItems.get(i);
        ...
        } else
        {
          ...
          goto _L22
_L19:
        if (j == ((ItemInfo) (obj)).b && !((ItemInfo) (obj)).c)
        {
            mItems.remove(i);
            mAdapter.destroyItem(this, j, ((ItemInfo) (obj)).a);
            if (i < mItems.size())
            {
                obj = (ItemInfo)mItems.get(i);
            } else
...
_L24:
        j++;
          goto _L23
_L18:
        if (obj != null && j == ((ItemInfo) (obj)).b)
        {
            float f3 = ((ItemInfo) (obj)).d;
            i++;
            if (i < mItems.size())
            {
                obj = (ItemInfo)mItems.get(i);
...
_L8:
        ...
        for (i = 0; i < j; i++)
        {
            ...
            if (!((LayoutParams) (obj)).a && ((LayoutParams) (obj)).c == 0.0F)
            {
                ...
                if (obj1 != null)
                {
                    obj.c = ((ItemInfo) (obj1)).d;
                    obj.e = ((ItemInfo) (obj1)).b;
                }
            }
        }
...
_L25:
        ...
        if (obj != null && ((ItemInfo) (obj)).b == mCurItem) goto _L4; else goto _L26
_L26:
        i = 0;
_L29:
...
_L27:
        ...
        if (obj1 != null && ((ItemInfo) (obj1)).b == mCurItem && ((View) (obj)).requestFocus(byte1)) goto _L4; else goto _L28
_L28:
        i++;
          goto _L29
        obj = null;
    ...
    public void setAdapter(PagerAdapter pageradapter)
    {
        if (mAdapter != null)
        {
            ...
            {
                ItemInfo iteminfo = (ItemInfo)mItems.get(i);
                mAdapter.destroyItem(this, iteminfo.b, iteminfo.a);
            }
        ...
        {
            mAdapterChangeListener.a(pageradapter1, pageradapter);
        }
    }
...
_L3:
    ...
    private class MyAccessibilityDelegate extends AccessibilityDelegateCompat
    {
        ...
        private boolean b()
        {
            return b.mAdapter != null && b.mAdapter.getCount() > 1;
        }
        ...
        public void d(View view, AccessibilityEvent accessibilityevent)
        {
            ...
            view.a(b());
            if (accessibilityevent.getEventType() == 4096 && b.mAdapter != null)
            {
                view.a(b.mAdapter.getCount());
                view.b(b.mCurItem);
                view.c(b.mCurItem);
            }
        }
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = ParcelableCompat.a(new ParcelableCompatCreatorCallbacks() {
    ...
    private class OnAdapterChangeListener
    {
        ...
        public abstract void a(PagerAdapter pageradapter, PagerAdapter pageradapter1);
    }
