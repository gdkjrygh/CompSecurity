...
final class a extends android.view.ellyBean._cls1
{

    final cessibilityDelegateBridgeJellyBean a;
    ...
    cessibilityDelegateBridgeJellyBean(cessibilityDelegateBridgeJellyBean cessibilitydelegatebridgejellybean)
    {
        a = cessibilitydelegatebridgejellybean;
        super();
    }
}
