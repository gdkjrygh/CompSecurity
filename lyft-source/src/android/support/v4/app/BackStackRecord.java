...
label0:
        ...
        arraymap.a(mSharedElementTargetNames);
        return arraymap;
    }
    ...
    private ArrayMap remapSharedElements(TransitionState transitionstate, Fragment fragment, boolean flag)
    {
        ...
        if (mSharedElementSourceNames != null)
        {
            ...
            if (flag)
            {
                arraymap1.a(mSharedElementTargetNames);
                arraymap = arraymap1;
            } else
            {
...
_L6:
        ...
        if (!s.equals(arraymap.c(i))) goto _L4; else goto _L3
_L3:
        arraymap.a(i, s1);
_L2:
        return;
...
_L5:
    ...
    private void setNameOverrides(TransitionState transitionstate, ArrayMap arraymap, boolean flag)
    {
        ...
        while (i < j) 
        {
            String s = (String)arraymap.b(i);
            String s1 = FragmentTransitionCompat21.getTransitionName((View)arraymap.c(i));
            if (flag)
            {
