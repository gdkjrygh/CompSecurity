    ...
    implements Cloneable
{
    ...
    public SparseArrayCompat(int i)
    {
        ...
        if (i == 0)
        {
            c = ContainerHelpers.a;
            d = ContainerHelpers.c;
        } else
        {
            i = ContainerHelpers.a(i);
            c = new int[i];
            d = new Object[i];
        }
        e = 0;
    ...
    {
        int j = ContainerHelpers.a(c, e, i);
        if (j >= 0)
        {
            d[j] = obj;
            return;
        ...
        if (b)
        {
            ...
            {
                d();
                j = ~ContainerHelpers.a(c, e, i);
            }
        }
        if (e >= c.length)
        {
            int l = ContainerHelpers.a(e + 1);
            int ai[] = new int[l];
    ...
    public int g(int i)
    {
        ...
        return ContainerHelpers.a(c, e, i);
    }
