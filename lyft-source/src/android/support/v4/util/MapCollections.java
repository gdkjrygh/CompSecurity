...
_L8:
        ...
        implements Set
    {
        ...
        public boolean contains(Object obj)
        {
            if (obj instanceof java.util.Map.Entry)
            {
                ...
                if (i >= 0)
                {
                    return ContainerHelpers.a(a.a(i, 1), ((java.util.Map.Entry) (obj)).getValue());
                }
            }
            return false;
        }
            ...
            implements Iterator, java.util.Map.Entry
        {
            ...
            public final boolean equals(Object obj)
            {
                ...
                obj = (java.util.Map.Entry)obj;
                if (!ContainerHelpers.a(((java.util.Map.Entry) (obj)).getKey(), d.a(b, 0)) || !ContainerHelpers.a(((java.util.Map.Entry) (obj)).getValue(), d.a(b, 1)))
                {
                    flag = false;
                }
                return flag;
            ...
            MapIterator()
            {
                d = MapCollections.this;
                super();
                c = false;
                a = MapCollections.this.a() - 1;
                b = -1;
            }
        }
        ...
        implements Set
    {
            ...
            implements Iterator
        {
            ...
            ArrayIterator(int i)
            {
                e = MapCollections.this;
                super();
                d = false;
                a = i;
                b = MapCollections.this.a();
            }
        }
