...
_L6:
    ...
    public static File[] getExternalCacheDirs(Context context)
    {
        ...
        if (i >= 8)
        {
            context = ContextCompatFroyo.a(context);
        } else
        {
    ...
    public static File[] getExternalFilesDirs(Context context, String s)
    {
        ...
        if (i >= 19)
        {
            return ContextCompatKitKat.a(context, s);
        }
        if (i >= 8)
        {
            context = ContextCompatFroyo.a(context, s);
        } else
        {
            context = buildPath(Environment.getExternalStorageDirectory(), new String[] {
    ...
    public static File[] getObbDirs(Context context)
    {
        ...
        if (i >= 11)
        {
            context = ContextCompatHoneycomb.a(context);
        } else
        {
            context = buildPath(Environment.getExternalStorageDirectory(), new String[] {
    ...
    public static boolean startActivities(Context context, Intent aintent[], Bundle bundle)
    {
        ...
        if (i >= 16)
        {
            ContextCompatJellybean.a(context, aintent, bundle);
            return true;
        }
        if (i >= 11)
        {
            ContextCompatHoneycomb.a(context, aintent);
            return true;
        } else
        {
            return false;
