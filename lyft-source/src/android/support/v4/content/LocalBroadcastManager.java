...
_L2:
        if (i < abroadcastrecord.length)
        {
            ...
            for (int j = 0; j < ((BroadcastRecord) (obj)).b.size(); j++)
            {
                ((ReceiverRecord)((BroadcastRecord) (obj)).b.get(j)).b.onReceive(a, ((BroadcastRecord) (obj)).a);
            }
...
_L7:
        if (((ReceiverRecord)arraylist1.get(i)).b != broadcastreceiver) goto _L10; else goto _L9
_L9:
        arraylist1.remove(i);
        i--;
          goto _L10
...
_L5:
        ...
        Log.v("LocalBroadcastManager", (new StringBuilder()).append("Matching against filter ").append(((ReceiverRecord) (obj)).a).toString());
        if (!((ReceiverRecord) (obj)).c) goto _L8; else goto _L7
_L7:
...
_L9:
        Log.v("LocalBroadcastManager", "  Filter's target already added");
          goto _L10
_L8:
        k = ((ReceiverRecord) (obj)).a.match(s, s1, s2, uri, set, "LocalBroadcastManager");
...
_L19:
        ...
        ((ReceiverRecord)arraylist.get(i)).c = false;
        i++;
          goto _L19
        d.add(new BroadcastRecord(intent, arraylist));
        if (!e.hasMessages(1))
        {
