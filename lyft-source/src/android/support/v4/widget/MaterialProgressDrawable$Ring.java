...
class c
{
    ...
    private void a(Canvas canvas, float f1, float f2, Rect rect)
    {
        if (o)
        {
            ...
            {
                p = new Path();
                p.setFillType(android.graphics.ble.Ring.p);
            } else
            {
                p.reset();
            }
    ...
    public (android.graphics.drawable. )
    {
        ...
        i = 2.5F;
        d = ;
        b.setStrokeCap(android.graphics.ble.Ring.b);
        b.setAntiAlias(true);
        b.setStyle(android.graphics.ble.Ring.b);
        c.setStyle(android.graphics.ble.Ring.c);
        c.setAntiAlias(true);
    }
}
