    ...
    implements NestedScrollingChild, NestedScrollingParent
{
    ...
    private static final AccessibilityDelegate v = new AccessibilityDelegate();
...
_L1:
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (MotionEventCompat.b(motionevent, i1) == q)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            f = (int)MotionEventCompat.d(motionevent, i1);
            q = MotionEventCompat.b(motionevent, i1);
            if (k != null)
            {
                k.clear();
            }
    ...
    private void f()
    {
        if (ViewCompat.a(this) != 2)
        {
            if (d == null)
            {
                ...
                d = new EdgeEffectCompat(context);
                e = new EdgeEffectCompat(context);
            }
            return;
        } else
        {
...
_L7:
    ...
    {
        if ((MotionEventCompat.d(motionevent) & 2) == 0) goto _L2; else goto _L1
_L1:
...
_L3:
        ...
        int l1;
        float f1;
        if (j || (f1 = MotionEventCompat.e(motionevent, 9)) == 0.0F)
        {
...
_L2:
        ...
        {
            f = l1;
            q = MotionEventCompat.b(motionevent, 0);
            b();
            k.addMovement(motionevent);
            if (c.a())
            {
...
_L8:
        d.a((float)i1 / (float)getHeight(), MotionEventCompat.c(motionevent, i2) / (float)getWidth());
        if (!e.a())
        {
            e.c();
        }
...
_L9:
        if (l1 > j2)
        {
            e.a((float)i1 / (float)getHeight(), 1.0F - MotionEventCompat.c(motionevent, i2) / (float)getWidth());
            if (!d.a())
            {
                d.c();
            }
...
_L3:
        if (j)
        {
            ...
            int j1 = (int)VelocityTrackerCompat.b(motionevent, q);
            if (Math.abs(j1) > o)
            {
                f(-j1);
            }
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L6:
        int k1 = MotionEventCompat.b(motionevent);
        f = (int)MotionEventCompat.d(motionevent, k1);
        q = MotionEventCompat.b(motionevent, k1);
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        f = (int)MotionEventCompat.d(motionevent, MotionEventCompat.a(motionevent, q));
