...
final class CertificateChainCleaner
{
    ...
    public static X509Certificate[] a(X509Certificate ax509certificate[], SystemKeyStore systemkeystore)
    {
        boolean flag2 = true;
        ...
        boolean flag1;
        int i;
        if (systemkeystore.a(ax509certificate[0]))
        {
            flag = true;
        } else
        {
        ...
        do
        {
            ...
            if (systemkeystore.a(ax509certificate[i]))
            {
                flag = true;
            }
            flag1 = flag;
        ...
        ax509certificate = systemkeystore.b(ax509certificate[i - 1]);
