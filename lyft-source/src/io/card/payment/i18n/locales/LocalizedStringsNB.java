    ...
    implements SupportedLocale
{
    ...
    public LocalizedStringsNB()
    {
        ...
        mDisplay.put(StringKey.DONE, "Fullf\370rt");
        mDisplay.put(StringKey.ENTRY_CVV, "CVV");
        mDisplay.put(StringKey.ENTRY_POSTAL_CODE, "Postnummer");
        mDisplay.put(StringKey.ENTRY_EXPIRES, "Utl\370per");
        ...
        mDisplay.put(StringKey.ERROR_NO_DEVICE_SUPPORT, "Denne enheten kan ikke bruke kameraet til \345 lese kortnumre.");
