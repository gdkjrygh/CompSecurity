    ...
    implements SupportedLocale
{
    ...
    public LocalizedStringsES()
    {
        ...
        mDisplay.put(StringKey.SCAN_GUIDE, "Mantenga la tarjeta aqu\355.\nSe escanear\341 autom\341ticamente.");
        ...
        mDisplay.put(StringKey.ERROR_CAMERA_UNEXPECTED_FAIL, "Al abrir la c\341mara, el dispositivo ha experimentado un error inesperado.");
    }
