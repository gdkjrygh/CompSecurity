...
//            CardIOActivity, aa, DetectionInfo
...
_L2:
    ...
    private native void nGetFrameCounts(int ai[]);

    private native void nGetGuideFrame(int i1, int j1, int k1, Rect rect);

    private native void nResetAnalytics();

    private native void nScanFrame(byte abyte0[], int i1, int j1, int k1, DetectionInfo detectioninfo, Bitmap bitmap);
...
_L2:
    ...
    final Map e()
    {
        ...
        int ai[] = new int[6];
        nGetFrameCounts(ai);
        hashmap.put("num_frames_total", Integer.valueOf(ai[0]));
        hashmap.put("num_frames_captured", Integer.valueOf(ai[1]));
        hashmap.put("num_frames_processed", Integer.valueOf(ai[2]));
        hashmap.put("num_frames_in_focus", Integer.valueOf(ai[3]));
        hashmap.put("num_frames_scanned", Integer.valueOf(ai[4]));
        hashmap.put("num_frames_usable", Integer.valueOf(ai[5]));
        hashmap.put("elapsed_time", Double.valueOf(nGetElapsedTime()));
        hashmap.put("elapsed_clock", Long.valueOf(nGetElapsedClock()));
        hashmap.put("num_manual_refocusings", Integer.valueOf(m));
        hashmap.put("num_auto_triggered_refocusings", Integer.valueOf(n));
        hashmap.put("num_manual_torch_changes", Integer.valueOf(o));
        return hashmap;
    }
    ...
    {
        ((CardIOActivity)c.get()).a(detectioninfo);
    }
...
_L3:
        ...
        nScanFrame(abyte0, 640, 480, e, detectioninfo, a);
        boolean flag;
...
_L8:
        ...
        return;
_L6:
        if (detectioninfo.b() || d && detectioninfo.a())
        {
            (new StringBuilder("detected card: ")).append(detectioninfo.c()).toString();
            ((CardIOActivity)c.get()).a(a, detectioninfo);
        }
