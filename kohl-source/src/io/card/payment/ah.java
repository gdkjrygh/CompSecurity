...
//            ak, ae, ao, an, 
//            al, DetectionInfo, CreditCard, CardIOActivity
...
final class ah extends View
{
    ...
    public ah(CardIOActivity cardioactivity, AttributeSet attributeset, boolean flag)
    {
        ...
        p = new ak(70F * v, 50F * v);
        q = new ae(cardioactivity);
        m.clearShadowLayer();
    ...
    public final void a(Rect rect, int i1)
    {
        ...
        if (o != null)
        {
            ...
            r = al.a(new Point(o.left + ((Point) (rect)).x, o.top + ((Point) (rect)).y), (int)(70F * v), (int)(v * 50F));
            i1 = o.right;
            int j1 = ((Point) (rect)).x;
            int k1 = o.top;
            s = al.a(new Point(i1 - j1, ((Point) (rect)).y + k1), (int)(100F * v), (int)(v * 50F));
    ...
    public final void b()
    {
        ...
        if (d != null)
        {
            ...
            int j1 = f.cardNumber.length();
            float f1 = (float)d.getWidth() / 428F;
            int k1 = (int)((float)f.yoff * f1 - 6F);
            while (i1 < j1) 
            {
                int l1 = (int)((float)f.xoff[i1] * f1);
                canvas.drawText((new StringBuilder()).append(f.cardNumber.charAt(i1)).toString(), l1, k1, paint);
                i1++;
            }
        }
    }
...
label0:
        {
            ...
            Rect rect = al.a(motionevent, 20, 20);
