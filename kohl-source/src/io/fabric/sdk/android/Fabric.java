...
//            InitializationTask, Onboarding, InitializationCallback, Logger
...
public class Fabric
{
    public static class Builder
    {
        ...
        public Fabric build()
        {
            ...
            return new Fabric(context, map, threadPoolExecutor, handler, logger, debuggable, initializationCallback, idmanager);
        }
...
label0:
    ...
    void initializeKits(Context context1)
    {
        ...
        for (Iterator iterator = ((List) (obj)).iterator(); iterator.hasNext(); ((Kit)iterator.next()).injectParameters(context1, this, kitInitializationCallback, idManager)) { }
