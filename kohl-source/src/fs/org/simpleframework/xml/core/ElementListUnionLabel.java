...
//            Label, ElementListLabel, GroupExtractor, UnionException, 
//            CompositeListUnion, Contact, Expression, Context, 
//            Converter, Decorator
    ...
    implements Label
{
    ...
    public ElementListUnionLabel(Contact contact1, ElementListUnion elementlistunion, ElementList elementlist)
        throws Exception
    {
        label = new ElementListLabel(contact1, elementlist);
        extractor = new GroupExtractor(contact1, elementlistunion);
        contact = contact1;
    }
        ...
        throws Exception
    {
        ...
        {
            return new CompositeListUnion(context, extractor, expression1, contact1);
        }
    }
