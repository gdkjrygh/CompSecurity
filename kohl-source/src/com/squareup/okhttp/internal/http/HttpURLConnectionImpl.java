...
//            RequestHeaders, RouteSelector, HttpsEngine, ResponseHeaders, 
//            HttpAuthenticator
        ...
        throws IOException
    {
        ...
        do
        {
            ...
            do
            {
                ...
                String s = method;
                outputstream = httpEngine.getRequestBody();
...
_L2:
        ...
        throw ioexception;
_L4:
        if (method.equals("POST") || method.equals("PUT") || method.equals("PATCH")) goto _L2; else goto _L5
_L5:
