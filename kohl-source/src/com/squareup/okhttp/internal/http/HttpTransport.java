...
_L1:
    ...
    private static class FixedLengthInputStream extends AbstractHttpInputStream
    {
        ...
        public FixedLengthInputStream(InputStream inputstream, CacheRequest cacherequest, HttpEngine httpengine, long l)
            throws IOException
        {
...
_L3:
        ...
        throws IOException
    {
        ...
        {
            return new FixedLengthInputStream(socketIn, cacherequest, httpEngine, 0L);
        }
