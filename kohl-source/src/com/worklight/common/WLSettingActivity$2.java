    ...
    implements android.preference.nceChangeListener
{
    ...
    public boolean onPreferenceChange(Preference preference, Object obj)
    {
            ...
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            final WLSettingActivity._cls2 this$1;
            ...
            {
                this$1 = WLSettingActivity._cls2.this;
                super();
            }
        }
        ...
        catch (Preference preference)
        {
            ...
            {
                (new android.app.<init>(WLSettingActivity.this)).setTitle(WLUtils.getResourceString("titleInvalidWLServerUrl", WLSettingActivity.this)).setMessage(WLUtils.getResourceString("errorInvalidWLServerUrl", WLSettingActivity.access$100(WLSettingActivity.this), WLSettingActivity.this)).setNeutralButton(WLUtils.getResourceString("OKTitleWLServerUrl", WLSettingActivity.this), new _cls1()).show();
            }
            return false;
        }
