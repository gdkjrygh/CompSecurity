...
public class JSONStoreTransactionInProgressException extends JSONStoreException
{
    ...
    public JSONStoreTransactionInProgressException(String s)
    {
        super(s);
    }

    public JSONStoreTransactionInProgressException(String s, Throwable throwable)
    {
        super(s, throwable);
    }

    public JSONStoreTransactionInProgressException(Throwable throwable)
    {
        super(throwable);
    }
}
