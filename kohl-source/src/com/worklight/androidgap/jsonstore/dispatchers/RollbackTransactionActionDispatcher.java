...
public class RollbackTransactionActionDispatcher extends BaseActionDispatcher
{
    ...
    public RollbackTransactionActionDispatcher(Context context)
    {
        ...
        throws Throwable
    {
        try
        {
            WLJSONStore.getInstance(getAndroidContext()).rollbackTransaction();
        }
        ...
        {
            return new PluginResult(org.apache.cordova.PluginResult.Status.ERROR, -48);
        }
        // Misplaced declaration of an exception variable
        catch (JSONStoreContext jsonstorecontext)
        {
