...
private class <init> extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (intent != null)
        {
            ...
            if (Utility.isNullOrEmpty(s) || Utility.areObjectsEqual(LikeView.access$500(LikeView.this), s))
            {
                flag = true;
            } else
            {
...
_L2:
        ...
        {
            LikeView.access$600(LikeView.this);
...
_L3:
        LikeView.access$800(LikeView.this)._mth0(intent);
        return;
        if (!"com.facebook.sdk.LikeActionController.DID_RESET".equals(context)) goto _L1; else goto _L4
_L4:
        LikeView.access$900(LikeView.this, LikeView.access$500(LikeView.this));
        LikeView.access$600(LikeView.this);
        LikeView.access$700(LikeView.this);
        return;
    }
