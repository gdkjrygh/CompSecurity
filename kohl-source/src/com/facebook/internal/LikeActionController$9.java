    ...
    implements ompletedListener
{
    ...
    public void completed(Bundle bundle)
    {
        ...
        {
            s = LikeActionController.access$900(LikeActionController.this);
        }
        ...
        {
            s1 = LikeActionController.access$1000(LikeActionController.this);
        }
        ...
        {
            s2 = LikeActionController.access$1100(LikeActionController.this);
        }
        ...
        {
            s3 = LikeActionController.access$1200(LikeActionController.this);
        }
