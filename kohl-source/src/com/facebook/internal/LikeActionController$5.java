    ...
    implements com.facebook.widget.
{
    ...
    public void onComplete(com.facebook.widget.all all, Bundle bundle)
    {
        ...
        String s = LikeActionController.access$900(LikeActionController.this);
        String s1 = LikeActionController.access$1000(LikeActionController.this);
        if (bundle.containsKey("like_count_string"))
        {
            s = bundle.getString("like_count_string");
            s1 = s;
        }
        String s2 = LikeActionController.access$1100(LikeActionController.this);
        String s3 = LikeActionController.access$1200(LikeActionController.this);
        ...
        {
            bundle = LikeActionController.access$1300(LikeActionController.this);
        }
        ...
        LikeActionController.access$1400(LikeActionController.this).logSdkEvent("fb_like_control_dialog_did_succeed", null, bundle1);
        LikeActionController.access$1500(LikeActionController.this, flag, s, s1, s2, s3, bundle);
    }

    public void onError(com.facebook.widget.all all, Exception exception, Bundle bundle)
    {
        Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1600(), "Like Dialog failed with error : %s", new Object[] {
            exception
        });
        if (val$analyticsParameters == null)
        {
        ...
        LikeActionController.access$1700(LikeActionController.this, "present_dialog", exception);
