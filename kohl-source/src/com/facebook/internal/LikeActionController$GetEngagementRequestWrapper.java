...
private class setRequest extends setRequest
{
    ...
    {
        Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1600(), "Error fetching engagement for object '%s' : %s", new Object[] {
    ...
    (String s)
    {
        ...
        likeCountStringWithLike = LikeActionController.access$900(LikeActionController.this);
        likeCountStringWithoutLike = LikeActionController.access$1000(LikeActionController.this);
        socialSentenceStringWithLike = LikeActionController.access$1100(LikeActionController.this);
        socialSentenceStringWithoutLike = LikeActionController.access$1200(LikeActionController.this);
