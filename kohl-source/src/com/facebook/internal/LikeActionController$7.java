    ...
    implements com.facebook.roller._cls7
{
    ...
    public void onBatchCompleted(RequestBatch requestbatch)
    {
        ...
        {
            LikeActionController.access$2100(LikeActionController.this, true);
            return;
        } else
        {
            LikeActionController.access$1302(LikeActionController.this, null);
            LikeActionController.access$2202(LikeActionController.this, false);
            LikeActionController.access$1400(LikeActionController.this).logSdkEvent("fb_like_control_did_unlike", null, val$analyticsParameters);
            LikeActionController.access$2300(LikeActionController.this, val$analyticsParameters);
            return;
        }
    }
