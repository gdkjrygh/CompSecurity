...
_L2:
    ...
    {
        if (!isNullOrEmpty(s) && !fetchedAppSettings.containsKey(s) && initialAppSettingsLoadTask == null) goto _L2; else goto _L1
_L1:
        return;
_L2:
        Object obj;
        ...
        initialAppSettingsLoadTask = new AsyncTask(s, context, ((String) (obj))) {
...
_L3:
    ...
    {
        jsonobject = new FetchedAppSettings(jsonobject.optBoolean("supports_implicit_sdk_logging", false), jsonobject.optString("gdpv4_nux_content", ""), jsonobject.optBoolean("gdpv4_nux_enabled", false), parseDialogConfigurations(jsonobject.optJSONObject("android_dialog_configs")));
