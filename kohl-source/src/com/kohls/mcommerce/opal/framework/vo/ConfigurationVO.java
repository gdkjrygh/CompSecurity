    ...
    implements IValueObject
{
    public class PayLoad
    {
        ...
        public PayLoad()
        {
            this$0 = ConfigurationVO.this;
            super();
        }
    }

    public class PayLoad.Config
    {
        ...
        private String CreateLoyaltyProfile_migration;
        ...
        private String KillSwitchFlagReferFriend;
        private String KillSwitchFlagSocial;
        ...
        private String WalletandLoyaltyBaseURL_migration;
        ...
        private String isMFPNotificationEnabled;
        ...
        private String loyaltyProfileAppend_migration;
        ...
        private String walletPriceURL_migration;
        ...
        {
            return CreateLoyaltyProfile_migration;
        }
        ...
        {
            return KillSwitchFlagReferFriend;
        }

        public String getKillSwitchFlagSocial()
        {
            return KillSwitchFlagSocial;
        }
        ...
        {
            return LoyaltyFriendInviteRewardAmt;
        }

        public String getLoyaltyProfileAppend()
        {
            return loyaltyProfileAppend_migration;
        }
        ...
        {
            return walletPriceURL_migration;
        }
        ...
        {
            return WalletandLoyaltyBaseURL_migration;
        }
        ...
        public String isMFPNotificationEnabled()
        {
            return isMFPNotificationEnabled;
        }
        ...
        public void setAddToListUrl(String s)
        {
            AddToListUrl = s;
        }

        public void setAddToRegistryUrl(String s)
        {
            AddToRegistryUrl = s;
        }

        public void setAlertUpgradeInterval(String s)
        {
            alertUpgradeInterval = s;
        }

        public void setAppAndroidVersion(String s)
        {
            appAndroidVersion = s;
        }

        public void setAppDisplayName(String s)
        {
            appDisplayName = s;
        }

        public void setAppIOSVersion(String s)
        {
            appIOSVersion = s;
        }

        public void setAppMode(String s)
        {
            appMode = s;
        }

        public void setBaseUrlList(String s)
        {
            baseUrlList = s;
        }

        public void setBaseUrlRegistry(String s)
        {
            baseUrlRegistry = s;
        }

        public void setBazaarVoiceApiKey(String s)
        {
            bazaarVoiceApiKey = s;
        }

        public void setBazaarVoiceApiVersion(String s)
        {
            bazaarVoiceApiVersion = s;
        }

        public void setBazaarVoiceURL(String s)
        {
            bazaarVoiceURL = s;
        }

        public void setBugsenseAPIKeyAndroid(String s)
        {
            BugsenseAPIKeyAndroid = s;
        }

        public void setBugsenseAPIKeyHybrid(String s)
        {
            BugsenseAPIKeyHybrid = s;
        }

        public void setBugsenseAPIKeyIos(String s)
        {
            BugsenseAPIKeyIos = s;
        }
        ...
        public void setCmsURL(String s)
        {
            cmsURL = s;
        }

        public void setConfigFileVersion(String s)
        {
            configFileVersion = s;
        }

        public void setCrashlyticsURL(String s)
        {
            crashlyticsURL = s;
        }

        public void setCreateLoyaltyProfile(String s)
        {
            CreateLoyaltyProfile_migration = s;
        }

        public void setCustomerCarePhone(String s)
        {
            CustomerCarePhone = s;
        }

        public void setCustomerServiceUrl(String s)
        {
            customerServiceUrl = s;
        }

        public void setDefaultShippingMethod(String s)
        {
            defaultShippingMethod = s;
        }

        public void setDigbyURL(String s)
        {
            digbyURL = s;
        }
        ...
        public void setFacebook_page(String s)
        {
            facebook_page = s;
        }

        public void setFeatureBOPUSEnabled(String s)
        {
            FeatureBOPUSEnabled = s;
        }

        public void setForceAndroidUpgrade(String s)
        {
            forceAndroidUpgrade = s;
        }

        public void setForceAndroidUpgradeReferenceUrl(String s)
        {
            forceAndroidUpgradeReferenceUrl = s;
        }

        public void setForceUpgradeDisplayMessage(String s)
        {
            forceUpgradeDisplayMessage = s;
        }

        public void setForceUpgradeTitle(String s)
        {
            forceUpgradeTitle = s;
        }

        public void setForseeEnabled(String s)
        {
            isForseeEnabled = s;
        }

        public void setForseeFeedbackURL(String s)
        {
            forseeFeedbackURL = s;
        }

        public void setForsee_DefaultDaysSinceFirstLaunch(String s)
        {
            forsee_DefaultDaysSinceFirstLaunch = s;
        }

        public void setForsee_DefaultLaunchCount(String s)
        {
            forsee_DefaultLaunchCount = s;
        }

        public void setForsee_DefaultRepeatDaysAfterComplete(String s)
        {
            forsee_DefaultRepeatDaysAfterComplete = s;
        }

        public void setForsee_DefaultRepeatDaysAfterDecline(String s)
        {
            forsee_DefaultRepeatDaysAfterDecline = s;
        }

        public void setGIftCardCNNumber(String s)
        {
            GIftCardCNNumber = s;
        }

        public void setGeoCodeUrl(String s)
        {
            geoCodeUrl = s;
        }

        public void setGoogleMapsURL(String s)
        {
            googleMapsURL = s;
        }

        public void setGooglePlayLink(String s)
        {
            googlePlayLink = s;
        }

        public void setHeaderApikey(String s)
        {
            headerApikey = s;
        }

        public void setIdleTimeout(String s)
        {
            idleTimeout = s;
        }

        public void setIsBeaconsEnabled(String s)
        {
            isBeaconsEnabled = s;
        }

        public void setIsBugsense(String s)
        {
            isBugsense = s;
        }

        public void setIsMFPNotificationEnabled(String s)
        {
            isMFPNotificationEnabled = s;
        }

        public void setIsScanningEnabled(String s)
        {
            isScanningEnabled = s;
        }

        public void setKohlsChargeApplyNowUrl(String s)
        {
            kohlsChargeApplyNowUrl = s;
        }

        public void setKohlsChargeSignInUrl(String s)
        {
            kohlsChargeSignInUrl = s;
        }

        public void setKrj(String s)
        {
            krj = s;
        }

        public void setListShareURL(String s)
        {
            ListShareURL = s;
        }

        public void setListUrl(String s)
        {
            listAndroidUrl = s;
        }

        public void setLnrItemImageURL(String s)
        {
            lnrItemImageURL = s;
        }

        public void setLoggingMode(String s)
        {
            loggingMode = s;
        }

        public void setLoyaltyEnrollmentScanningUrl(String s)
        {
            LoyaltyEnrollmentScanningUrl = s;
        }

        public void setLoyaltyProfileAppend(String s)
        {
            loyaltyProfileAppend_migration = s;
        }

        public void setLoyaltyReward(String s)
        {
            loyaltyReward = s;
        }

        public void setLoyaltySignupPoints(String s)
        {
            loyaltySignupPoints = s;
        }

        public void setNetworktimeout(String s)
        {
            networktimeout = s;
        }

        public void setNewPaymentPreference(String s)
        {
            NewPaymentPreference = s;
        }

        public void setNextKohlsCashEarning(String s)
        {
            nextKohlsCashEarning = s;
        }

        public void setOmnitureAPIKey(String s)
        {
            omnitureAPIKey = s;
        }

        public void setOmnitureEnabled(String s)
        {
            isOmnitureEnabled = s;
        }

        public void setOmnitureURL(String s)
        {
            omnitureURL = s;
        }

        public void setPDPTTLOverrideTime(String s)
        {
            PDPTTLOverrideTime = s;
        }

        public void setPMPCacheSessions(String s)
        {
            PMPCacheSessions = s;
        }

        public void setPercentAvailableSpaceUsed(String s)
        {
            PercentAvailableSpaceUsed = s;
        }

        public void setPromoCodeLimit(String s)
        {
            promoCodeLimit = s;
        }

        public void setRedLaserURL(String s)
        {
            redLaserURL = s;
        }

        public void setRedirectErrorURL(String s)
        {
            redirectErrorURL = s;
        }

        public void setRegistryEnabled(String s)
        {
            isRegistryEnabled = s;
        }

        public void setRegistryShareURL(String s)
        {
            RegistryShareURL = s;
        }

        public void setRegistryTypeSearch(String s)
        {
            registryTypeSearch = s;
        }

        public void setRegistryUrl(String s)
        {
            registryUrl = s;
        }

        public void setRestrictedAPIErrors(String s)
        {
            restrictedAPIErrors = s;
        }

        public void setSaltValue(String s)
        {
            saltValue = s;
        }
        ...
        public void setServerLog(String s)
        {
            serverLog = s;
        }

        public void setShowListItemsUrl(String s)
        {
            ShowListItemsUrl = s;
        }

        public void setShowRegistryItemsUrl(String s)
        {
            ShowRegistryItemsUrl = s;
        }

        public void setSignInRefreshInterval(String s)
        {
            signInRefreshInterval = s;
        }

        public void setSigninTimeout(String s)
        {
            signinTimeout = s;
        }

        public void setSpecificOfferButtonColor(String s)
        {
            specificOfferButtonColor = s;
        }

        public void setSpecificOfferButtonDisplayName(String s)
        {
            specificOfferButtonDisplayName = s;
        }

        public void setSpecificOfferListName(String s)
        {
            specificOfferListName = s;
        }

        public void setSpecificOfferListOn(String s)
        {
            specificOfferListOn = s;
        }

        public void setSpecificOfferListUrl(String s)
        {
            specificOfferListUrl = s;
        }

        public void setSpecificOfferPDPDisplayTextColor(String s)
        {
            specificOfferPDPDisplayTextColor = s;
        }

        public void setSpecificOfferPDPPriceDisplayName(String s)
        {
            specificOfferPDPPriceDisplayName = s;
        }

        public void setSpecificOfferPDPUpcomingPriceeColor(String s)
        {
            specificOfferPDPUpcomingPriceColor = s;
        }

        public void setSpecificOfferPDPUpcomingSaleColor(String s)
        {
            specificOfferPDPUpcomingSaleColor = s;
        }

        public void setSpecificOfferPMPBackgroundColor(String s)
        {
            specificOfferPMPBackgroundColor = s;
        }

        public void setSpecificOfferPMPDisplayTextColor(String s)
        {
            specificOfferPMPDisplayTextColor = s;
        }

        public void setSpecificOfferPMPPriceColor(String s)
        {
            specificOfferPMPPriceColor = s;
        }

        public void setSpecificOfferPriceCode(String s)
        {
            specificOfferPriceCode = s;
        }

        public void setStoreRadius(String s)
        {
            storeRadius = s;
        }

        public void setTIntSocialFeedUrl(String s)
        {
            TIntSocialFeedUrl = s;
        }

        public void setTodaysDealsUrl(String s)
        {
            TodaysDealsUrl = s;
        }
        ...
        public void setTwitter_page(String s)
        {
            twitter_page = s;
        }

        public void setTypeaheadUrl(String s)
        {
            TypeaheadUrl = s;
        }

        public void setWalletPriceURL(String s)
        {
            walletPriceURL_migration = s;
        }

        public void setWalletTimeout(String s)
        {
            walletTimeout = s;
        }

        public void setWalletVideoURL(String s)
        {
            WalletVideoURL = s;
        }

        public void setWalletVideoVersion(String s)
        {
            walletVideoVersion = s;
        }

        public void setWalletandLoyaltyBaseURL(String s)
        {
            WalletandLoyaltyBaseURL_migration = s;
        }

        public void setWeeklyAdURL(String s)
        {
            weeklyAdURL = s;
        }
        ...
        public void setwalletHelpURL(String s)
        {
            WalletHelpURL = s;
        }
