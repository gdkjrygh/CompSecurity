...
_L3:
        ...
        ((Intent) (obj)).putExtra("android.intent.extra.SUBJECT", (new StringBuilder()).append(getString(com.google.zxing.client.android.R.string.app_name)).append(" - ").append(qrcodeencoder.getTitle()).toString());
        ((Intent) (obj)).putExtra("android.intent.extra.TEXT", s);
        ((Intent) (obj)).putExtra("android.intent.extra.STREAM", Uri.parse((new StringBuilder()).append("file://").append(file.getAbsolutePath()).toString()));
...
_L8:
        obj = obj1;
        Log.w(TAG, (new StringBuilder()).append("Couldn't access file ").append(file).append(" due to ").append(obj2).toString());
        obj = obj1;
        showErrorMessage(com.google.zxing.client.android.R.string.msg_unmount_usb);
