...
final class HistoryItemAdapter extends ArrayAdapter
{
    ...
    {
        super(context, com.google.zxing.client.android.R.layout.history_list_item, new ArrayList());
        activity = context;
    }
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        {
            view = LayoutInflater.from(activity).inflate(com.google.zxing.client.android.R.layout.history_list_item, viewgroup, false);
        }
