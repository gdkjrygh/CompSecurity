...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever
{
        ...
        throws IOException
    {
        ...
        s = (new StringBuilder()).append("http://www.google.").append(LocaleManager.getProductSearchCountryTLD(context)).append("/m/products?ie=utf8&oe=utf8&scoring=p&source=zxing&q=").append(s).toString();
