...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            android.content.DialogInterface.OnClickListener onclicklistener = new Crashlytics._cls7._cls1();
            ...
            {
                android.content.DialogInterface.OnClickListener onclicklistener1 = new Crashlytics._cls7._cls2();
                builder.setNegativeButton(stringResolver.getCancelButtonTitle(), onclicklistener1);
            }
            if (promptData.showAlwaysSendButton)
            {
                Crashlytics._cls7._cls3 _lcls3 = new Crashlytics._cls7._cls3();
        ...
        // Unreferenced inner class com/crashlytics/android/Crashlytics$7$1

/* anonymous class */
        class Crashlytics._cls7._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Crashlytics._cls7 this$1;
