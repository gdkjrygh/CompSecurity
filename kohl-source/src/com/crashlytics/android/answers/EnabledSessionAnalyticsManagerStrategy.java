    ...
    implements SessionAnalyticsManagerStrategy
{
    ...
    {
        filesSender = new DefaultSessionAnalyticsFilesSender(Answers.getInstance(), s, analyticssettingsdata.analyticsURL, httpRequestFactory, (new ApiKey()).getValue(context));
