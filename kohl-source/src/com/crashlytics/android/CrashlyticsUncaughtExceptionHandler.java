...
//            Crashlytics, LogFileManager, ClsFileOutputStream, CLSUUID, 
//            CodedOutputStream, ExceptionUtils, CrashlyticsListener, CrashlyticsExecutorServiceWrapper, 
//            Utils, SessionDataWriter, NativeCrashWriter, ReportUploader, 
//            SessionReport
    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    CrashlyticsUncaughtExceptionHandler(Thread.UncaughtExceptionHandler uncaughtexceptionhandler, CrashlyticsListener crashlyticslistener, CrashlyticsExecutorServiceWrapper crashlyticsexecutorservicewrapper, IdManager idmanager, SessionDataWriter sessiondatawriter, Crashlytics crashlytics1)
    {
        ...
        logFileManager = new LogFileManager(crashlytics1.getContext(), filesDir);
        ...
        crashlyticsexecutorservicewrapper = crashlytics1.getContext();
...
_L1:
        ...
        obj = obj1;
        obj3 = obj1;
        NativeCrashWriter.writeNativeCrash(sessioneventdata, ((CodedOutputStream) (obj1)));
...
_L3:
        ...
        sessioneventdata = obj4;
_L8:
        obj = sessioneventdata;
        obj1 = obj2;
        Fabric.getLogger().e("Fabric", "An error occurred in the native crash logger", ((Throwable) (obj3)));
        obj = sessioneventdata;
        obj1 = obj2;
...
_L5:
        Exception exception;
        exception;
        sessioneventdata = ((SessionEventData) (obj3));
        obj3 = exception;
...
_L7:
        ...
        throws Exception
    {
        ...
        s = ((String) (obj1));
        obj = obj1;
        obj3 = crashlytics.getPackageName();
        s = ((String) (obj1));
        obj = obj1;
        s1 = crashlytics.getVersionCode();
        s = ((String) (obj1));
        obj = obj1;
        s2 = crashlytics.getVersionName();
        s = ((String) (obj1));
        obj = obj1;
...
_L4:
        ...
        return;
_L2:
        Map map1 = crashlytics.getAttributes();
        date = map1;
        if (map1 != null)
        {
            date = map1;
...
_L3:
        ...
        throws Exception
    {
        ...
        s = ((String) (obj1));
        obj = obj1;
        boolean flag = CommonUtils.isRooted(crashlytics.getContext());
        s = ((String) (obj1));
        obj = obj1;
...
_L2:
        ...
        throws Exception
    {
        ...
        s = ((String) (obj1));
        obj = obj1;
        obj3 = crashlytics.getUserIdentifier();
        s = ((String) (obj1));
        obj = obj1;
        s1 = crashlytics.getUserName();
        s = ((String) (obj1));
        obj = obj1;
        s2 = crashlytics.getUserEmail();
        if (obj3 == null && s1 == null && s2 == null)
        {
        ...
        s = ((String) (obj1));
        obj = obj1;
        sessionDataWriter.writeSessionUser(((CodedOutputStream) (obj1)), ((String) (obj3)), s1, s2);
        CommonUtils.flushOrLog(((java.io.Flushable) (obj1)), "Failed to flush session user file.");
        CommonUtils.closeOrLog(((java.io.Closeable) (obj2)), "Failed to close session user file.");
        return;
        s;
    ...
    boolean finalizeSessions()
    {
        return ((Boolean)executorServiceWrapper.executeSyncLoggingException(new Callable() {
                ...
                throws Exception
            {
                ...
                {
                    SessionEventData sessioneventdata = crashlytics.getExternalCrashEventData();
