        ...
        implements com.apptentive.android.sdk.module.messagecenter.view.MessageCenterView.OnSendMessageListener
    {
        ...
        public void onSendFileMessage(Uri uri)
        {
            ...
            if (message.internalCreateStoredImage(context, uri.toString()))
            {
                ...
                ApptentiveMessageCenter.messageCenterView.post(new ApptentiveMessageCenter._cls1._cls2());
        ...
        public void onSendTextMessage(String s)
        {
            ...
            textmessage.setCustomData(ApptentiveMessageCenter.access$000());
            java.util.Map _tmp = ApptentiveMessageCenter.access$002(null);
            MessageManager.sendMessage(context, textmessage);
            ApptentiveMessageCenter.messageCenterView.post(textmessage. new ApptentiveMessageCenter._cls1._cls1());
            ApptentiveMessageCenter.scrollToBottom();
        }
        ...
        // Unreferenced inner class com/apptentive/android/sdk/module/messagecenter/ApptentiveMessageCenter$1$2

/* anonymous class */
        class ApptentiveMessageCenter._cls1._cls2
            implements Runnable
        {
