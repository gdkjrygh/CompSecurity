...
public class Extension
{
    ...
    public Extension(ASN1ObjectIdentifier asn1objectidentifier, boolean flag, byte abyte0[])
    {
        this(asn1objectidentifier, flag, ((ASN1OctetString) (new DEROctetString(abyte0))));
    }
        ...
        throws IllegalArgumentException
    {
        try
        {
            extension = ASN1Primitive.fromByteArray(extension.getExtnValue().getOctets());
        }
        // Misplaced declaration of an exception variable
        catch (Extension extension)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("can't convert extension: ").append(extension).toString());
        }
        return extension;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (((Extension) (obj = (Extension)obj)).getExtnValue().equals(getExtnValue()) && ((Extension) (obj)).isCritical() == isCritical())
            {
                return true;
            }
        }
