...
//            X509Extension, Time, CRLReason, TBSCertList, 
...
public class V2TBSCertListGenerator
{
    ...
    public void addCRLEntry(ASN1Integer asn1integer, Time time, int i, DERGeneralizedTime dergeneralizedtime)
    {
        ...
        if (dergeneralizedtime != null)
        {
            dergeneralizedtime = new ASN1EncodableVector();
            dergeneralizedtime.add(createInvalidityDateExtension(time));
            internalAddCRLEntry(asn1integer, time, new DERSequence(dergeneralizedtime));
            return;
        } else
        {
