...
_L1:
        ...
        while (enumeration.hasMoreElements()) 
        {
            ...
            {
                _dumpAsString(s5, flag, (ASN1Primitive)s, stringbuffer);
            } else
            {
                _dumpAsString(s5, flag, ((ASN1Encodable)s).toASN1Primitive(), stringbuffer);
            }
        }
          goto _L3
_L2:
...
_L5:
        ...
        asn1primitive = ((ASN1Set)asn1primitive).getObjects();
...
_L9:
        ...
        if (asn1primitive instanceof BERConstructedOctetString)
        {
            ...
            stringbuffer.append((new StringBuilder()).append(s).append("BER Constructed Octet String").append("[").append(asn1primitive.getOctets().length).append("] ").toString());
            if (flag)
            {
                stringbuffer.append(dumpBinaryDataAsString(s, asn1primitive.getOctets()));
                return;
            } else
            {
                stringbuffer.append(s1);
        ...
        {
            asn1primitive = (ASN1OctetString)asn1primitive;
            stringbuffer.append((new StringBuilder()).append(s).append("DER Octet String").append("[").append(asn1primitive.getOctets().length).append("] ").toString());
            if (flag)
            {
                stringbuffer.append(dumpBinaryDataAsString(s, asn1primitive.getOctets()));
                return;
