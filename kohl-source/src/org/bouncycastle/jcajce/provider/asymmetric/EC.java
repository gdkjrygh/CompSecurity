...
public class EC
{
    public static class Mappings extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider configurableprovider)
        {
            ...
            registerOid(configurableprovider, X9ObjectIdentifiers.mqvSinglePass_sha1kdf_scheme, "ECMQV", new org.bouncycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.ECMQV());
