...
class X509Util
{
    ...
    {
        return new RSASSAPSSparams(algorithmidentifier, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, algorithmidentifier), new ASN1Integer(i), new ASN1Integer(1));
    }
