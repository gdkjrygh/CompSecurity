...
public class PrivateKeyFactory
{
        ...
        throws IOException
    {
        ...
        if (((AlgorithmIdentifier) (obj2)).getAlgorithm().equals(PKCSObjectIdentifiers.dhKeyAgreement))
        {
            ...
            privatekeyinfo = (DERInteger)privatekeyinfo.parsePrivateKey();
        ...
        {
            Object obj1 = (DERInteger)privatekeyinfo.parsePrivateKey();
            ...
            return new DSAPrivateKeyParameters(((DERInteger) (obj1)).getValue(), privatekeyinfo);
        }
