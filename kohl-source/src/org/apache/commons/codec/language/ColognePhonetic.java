...
_L3:
        ...
        if (!arrayContains(AEIJOUY, c1)) goto _L2; else goto _L1
_L1:
        c = '0';
        i = j;
_L5:
...
_L4:
        ...
        if ((c1 == 'D' || c1 == 'T') && !arrayContains(SCZ, c2))
        {
            c = '2';
            i = j;
        } else
        if (arrayContains(WFPV, c1))
        {
            c = '3';
            i = j;
        } else
        if (arrayContains(GKQ, c1))
        {
            c = '4';
            i = j;
        } else
        if (c1 == 'X' && !arrayContains(CKQ, c))
        {
            c = '4';
        ...
        if (c1 == 'C')
        {
            ...
            if (arrayContains(SZ, c) || !arrayContains(AHOUKQX, c2))
            {
                c = '8';
                i = j;
            } else
