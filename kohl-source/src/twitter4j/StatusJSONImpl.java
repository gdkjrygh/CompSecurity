...
_L2:
        if (!jsonobject.isNull("metadata"))
        {
            ...
            if (!((JSONObject) (obj)).isNull("iso_language_code"))
            {
                isoLanguageCode = ParseUtil.getUnescapedString("iso_language_code", ((JSONObject) (obj)));
            }
        }
...
_L27:
        ...
        if (jsonobject.isNull("place_ids")) goto _L28; else goto _L29
_L29:
