...
//            BinaryConstants, RationalNumber
    ...
    implements BinaryConstants
{
    ...
    private int a(String s, int i, byte abyte0[], int j)
    {
        ...
        {
            throw new ImageReadException((new StringBuilder("Index out of bounds. Array size: ")).append(abyte0.length).append(", index: ").append(i).toString());
        }
...
_L1:
        ...
        return false;
_L2:
        if (abyte0.length < (j = abyte0.length) + 0 || abyte1.length < j + 0)
        {
            continue;
        }
        int i = 0;
...
_L3:
    ...
    protected static byte[] a(RationalNumber rationalnumber, int i)
    {
        byte abyte0[] = new byte[8];
        a(rationalnumber.a, abyte0, 0, i);
        a(rationalnumber.b, abyte0, 4, i);
        return abyte0;
    }
    ...
    protected static byte[] a(RationalNumber arationalnumber[], int i)
    {
        byte abyte0[] = new byte[arationalnumber.length * 8];
        int j = 0;
        do
        {
            if (j >= arationalnumber.length)
            {
                return abyte0;
            }
            a(arationalnumber[j].a, abyte0, j * 8, i);
            a(arationalnumber[j].b, abyte0, j * 8 + 4, i);
            j++;
        } while (true);
    }
...
_L3:
    ...
    private RationalNumber e(String s, byte abyte0[], int i, int j)
    {
        return new RationalNumber(f(s, abyte0, i + 0, j), f(s, abyte0, i + 4, j));
    }
    ...
    protected final RationalNumber a(String s, byte abyte0[], int i)
    {
...
_L2:
    ...
    protected final byte[] a(String s, byte abyte0[])
    {
        ...
        {
            throw new ImageReadException((new StringBuilder("Invalid read. bytes.length: ")).append(abyte0.length).append(", start: 6, count: ").append(i).toString());
        }
    ...
    protected final RationalNumber[] a(String s, byte abyte0[], int i, int j)
    {
        int k = i * 8 + 0;
        if (abyte0.length >= k) goto _L2; else goto _L1
_L1:
        RationalNumber arationalnumber[];
        System.out.println((new StringBuilder(String.valueOf(s))).append(": expected length: ").append(k).append(", actual length: ").append(abyte0.length).toString());
        arationalnumber = null;
_L4:
        return arationalnumber;
_L2:
        RationalNumber arationalnumber1[] = new RationalNumber[i];
        int l = 0;
        do
        {
            arationalnumber = arationalnumber1;
            if (l >= i)
            {
                continue;
            }
            arationalnumber1[l] = e(s, abyte0, l * 8 + 0, j);
            l++;
        } while (true);
        if (true) goto _L4; else goto _L3
_L3:
