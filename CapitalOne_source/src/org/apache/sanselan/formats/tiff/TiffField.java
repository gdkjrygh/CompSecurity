    ...
    implements TiffConstants
{
    ...
    public TiffField(int k, int l, int i1, int j1, int k1, byte abyte0[], int l1)
    {
        i = null;
        go = -1;
        c = k;
    ...
    private static final Map a(TagInfo ataginfo[])
    {
        Hashtable hashtable = new Hashtable();
        int k = 0;
        do
        {
            if (k >= ataginfo.length)
            {
                return hashtable;
            }
            TagInfo taginfo = ataginfo[k];
            Integer integer = new Integer(taginfo.b);
            ...
            ((List) (obj)).add(taginfo);
            k++;
        } while (true);
    }

    private static TagInfo a(int k, List list)
    {
        boolean flag = false;
...
_L2:
        int l = 0;
_L17:
        if (l < list.size()) goto _L4; else goto _L3
_L3:
        l = 0;
_L20:
        if (l < list.size()) goto _L6; else goto _L5
_L5:
        k = ((flag) ? 1 : 0);
_L22:
        TagInfo taginfo1;
        ...
        taginfo1 = (TagInfo)list.get(k);
        taginfo = taginfo1;
          goto _L7
_L4:
        taginfo1 = (TagInfo)list.get(l);
        if (taginfo1.e == gf)
        {
        ...
        taginfo = taginfo1;
        if (taginfo1.e == gd) goto _L9; else goto _L8
_L8:
        if (k != -4)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == gb) goto _L9; else goto _L10
_L10:
        if (k != -3)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == ge) goto _L9; else goto _L11
_L11:
        if (k != -5)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == gc) goto _L9; else goto _L12
_L12:
        if (k != 0)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == b_) goto _L9; else goto _L13
_L13:
        if (k != 1)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == d_) goto _L9; else goto _L14
_L14:
        if (k != 2)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == e_) goto _L9; else goto _L15
_L15:
        if (k != 3)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (taginfo1.e == f_) goto _L9; else goto _L16
_L16:
        l++;
          goto _L17
_L6:
        ...
        taginfo = taginfo1;
        if (taginfo1.e.a()) goto _L9; else goto _L18
_L18:
        if (k >= 0)
        {
            break; /* Loop/switch isn't completed */
        ...
        taginfo = taginfo1;
        if (!taginfo1.e.a()) goto _L9; else goto _L19
_L19:
        l++;
          goto _L20
_L7:
        if (taginfo1.e == gf) goto _L9; else goto _L21
_L21:
        k++;
          goto _L22
    }

    private static FieldType b(int k)
    {
        int l = 0;
        do
        {
    ...
    private String e()
    {
        ...
        {
            return (new StringBuilder("Invalid value: ")).append(((ImageReadException) (obj)).getMessage()).toString();
        }
        if (obj == null)
        {
            return null;
...
_L7:
        ...
        stringbuffer.append(", ");
        stringbuffer.append((new StringBuilder()).append(l).toString());
        k++;
...
_L30:
    ...
    public final TiffElement a()
    {
        ...
        {
            return new OversizeValueElement(g, i.length);
        }
    }
    ...
    public final void a(ByteSource bytesource)
    {
        if (b.a(this))
        {
            return;
    ...
    public final int[] d()
    {
        ...
        {
            throw new ImageReadException((new StringBuilder("Unknown value: ")).append(obj).append(" for: ").append(a.a()).toString());
        }
    }
    ...
    private class OversizeValueElement extends TiffElement
    {

        final TiffField a;

        public OversizeValueElement(int k, int l)
        {
            a = TiffField.this;
            super(k, l);
        }
