    ...
    implements SensorEventListener
{
        ...
        throws JSONException
    {
        ...
        {
            int i = getStatus();
            callbackcontext.sendPluginResult(new PluginResult(org.apache.cordova.api.PluginResult.Status.OK, i));
            return true;
        }
        if (s.equals("getHeading"))
        {
            if (status != RUNNING)
            {
                ...
                {
                    callbackcontext.sendPluginResult(new PluginResult(org.apache.cordova.api.PluginResult.Status.IO_EXCEPTION, ERROR_FAILED_TO_START));
                    return true;
                }
            ...
            callbackcontext.sendPluginResult(new PluginResult(org.apache.cordova.api.PluginResult.Status.OK, getCompassHeading()));
            return true;
        }
