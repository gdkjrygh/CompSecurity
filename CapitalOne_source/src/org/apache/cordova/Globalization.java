...
_L4:
        ...
        throws GlobalizationError
    {
        ...
        obj2 = (SimpleDateFormat)DateFormat.getDateFormat(cordova.getActivity());
        simpledateformat = (SimpleDateFormat)DateFormat.getTimeFormat(cordova.getActivity());
        obj = (new StringBuilder()).append(((SimpleDateFormat) (obj2)).toLocalizedPattern()).append(" ").append(simpledateformat.toLocalizedPattern()).toString();
        if (jsonarray.getJSONObject(0).length() <= 1) goto _L2; else goto _L1
_L1:
        Object obj1 = obj2;
        if (((JSONObject)jsonarray.getJSONObject(0).get("options")).isNull("formatLength")) goto _L4; else goto _L3
_L3:
        obj = (String)((JSONObject)jsonarray.getJSONObject(0).get("options")).get("formatLength");
        if (!((String) (obj)).equalsIgnoreCase("medium")) goto _L6; else goto _L5
_L5:
        obj1 = (SimpleDateFormat)DateFormat.getMediumDateFormat(cordova.getActivity());
_L4:
        obj2 = (new StringBuilder()).append(((SimpleDateFormat) (obj1)).toLocalizedPattern()).append(" ").append(simpledateformat.toLocalizedPattern()).toString();
        obj = obj2;
        if (((JSONObject)jsonarray.getJSONObject(0).get("options")).isNull("selector")) goto _L2; else goto _L7
_L7:
        jsonarray = (String)((JSONObject)jsonarray.getJSONObject(0).get("options")).get("selector");
        if (!jsonarray.equalsIgnoreCase("date")) goto _L9; else goto _L8
_L8:
        obj = ((SimpleDateFormat) (obj1)).toLocalizedPattern();
_L2:
...
_L11:
        obj1 = (SimpleDateFormat)DateFormat.getLongDateFormat(cordova.getActivity());
          goto _L4
_L9:
        obj = obj2;
        if (!jsonarray.equalsIgnoreCase("time")) goto _L2; else goto _L12
_L12:
...
_L2:
        ...
        {
            callbackcontext.sendPluginResult(new PluginResult(org.apache.cordova.api.PluginResult.Status.ERROR, s.toJson()));
            break MISSING_BLOCK_LABEL_285;
        }
        // Misplaced declaration of an exception variable
        catch (String s)
