...
label0:
        {
            ...
            if (CameraActivity.access$200(CameraActivity.this) != null)
            {
                ...
                CameraActivity.access$200(CameraActivity.this).autoFocus(new android.hardware.Camera.AutoFocusCallback() {

                    final CameraActivity._cls1 this$1;

                    public void onAutoFocus(boolean flag, Camera camera)
                    {
                        camera.takePicture(null, null, CameraActivity.access$500(this$0));
                    }

            
            {
                this$1 = CameraActivity._cls1.this;
                super();
            }
                });
            }
