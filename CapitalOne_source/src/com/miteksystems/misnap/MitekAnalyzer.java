...
class MitekAnalyzer
{
    ...
    private native void argbBitmapToYUVN21(Bitmap bitmap, int i1, int j1, byte abyte0[]);
...
_L4:
    ...
    final int a(byte abyte0[], int i1, int j1, int k1, int l1, int i2, String s1)
    {
...
label0:
        ...
        int l1 = ((Point)abyte0.get(3)).x;
        int i2 = ((Point)abyte0.get(0)).y;
        int j2 = ((Point)abyte0.get(1)).y;
        int k2 = ((Point)abyte0.get(2)).y;
        abyte0 = new Point(l1 + (i1 + j1 + k1) >> 2, ((Point)abyte0.get(3)).y + (i2 + j2 + k2) >> 2);
        float f3 = 0.7F * a(t);
        float f1 = f3;
        if (f3 == 0.0F)
        {
        ...
        i1 = (int)((float)((Point) (abyte0)).x - f1 / 2.0F);
        j1 = (int)((float)((Point) (abyte0)).y - f1 / 2.0F);
        k1 = (int)((float)((Point) (abyte0)).x + f1 / 2.0F);
        f3 = ((Point) (abyte0)).y;
        abyte0 = new Rect(i1, j1, k1, (int)(f1 / 2.0F + f3));
        byte abyte1[] = H;
        i1 = C;
        j1 = D;
        int ai[] = new int[4];
...
_L2:
        ...
        if (flag)
        {
            ...
            x = a(H, C, I.left, I.top, I.right - I.left, I.bottom - I.top, a);
        }
        c = 0.8F * c + 0.2F * (float)v;
        d = 0.8F * d + 0.2F * (float)y;
        e = 0.8F * e + 0.2F * (float)z;
        s();
        K = true;
...
_L4:
    ...
    final byte[] a(Bitmap bitmap, int i1, int j1)
    {
        byte abyte0[] = new byte[(i1 * j1 * 3) / 2];
        argbBitmapToYUVN21(bitmap, i1, j1, abyte0);
        return abyte0;
    }
