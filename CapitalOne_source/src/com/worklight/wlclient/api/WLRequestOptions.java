...
public class WLRequestOptions
{
    ...
    protected void addParameter(String s, String s1)
    {
        parameters.put(s, s1);
    }

    protected void addParameters(Map map)
    {
    ...
    protected void setResponseListener(WLResponseListener wlresponselistener)
    {
