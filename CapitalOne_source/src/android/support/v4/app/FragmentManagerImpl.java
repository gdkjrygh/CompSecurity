...
_L2:
        ...
        fragment.mState;
        JVM INSTR tableswitch 1 5: default 1168
    //                   1 1174
    //                   2 1450
    //                   3 1409
    //                   4 1322
    ...
    Parcelable saveAllState()
    {
        ...
        if (mActive != null && mActive.size() > 0)
        {
            ...
            while (i < j1) 
            {
                ...
                {
                    obj = (new StringBuilder()).append("Failure saving state: active ").append(obj).append(" has cleared index: ").append(((Fragment) (obj)).mIndex).toString();
                ...
                if (mAdded != null)
                {
                    ...
                    if (l > 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (aobj[j] < 0)
                            {
                                ai = (new StringBuilder()).append("Failure saving state: active ").append(mAdded.get(j)).append(" has cleared index: ").append(aobj[j]).toString();
                                Log.e("FragmentManager", ai);
                                dump("  ", null, new PrintWriter(new LogWriter("FragmentManager")), new String[0]);
