    ...
    implements InvocationHandler
{
    ...
    private Object invokeRequest(RequestInterceptor requestinterceptor, RestMethodInfo restmethodinfo, Object aobj[])
    {
        ...
        obj = RestAdapter.access$200(RestAdapter.this).beforeCall();
_L16:
        int i;
        long l;
        l = System.nanoTime();
        obj1 = RestAdapter.access$300(RestAdapter.this).t().execute(((Request) (aobj)));
        l = TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - l);
        i = ((Response) (obj1)).getStatus();
        if (RestAdapter.access$200(RestAdapter.this) != null)
        {
            aobj = RestAdapter.access$400(((String) (obj2)), restmethodinfo, ((Request) (aobj)));
            RestAdapter.access$200(RestAdapter.this).afterCall(((ion) (aobj)), l, i, obj);
        }
...
_L9:
        Thread.currentThread().setName("Retrofit-Idle");
        return ((Object) (aobj));
        obj2 = new ExceptionCatchingTypedInput(((retrofit.mime.TypedInput) (obj)));
