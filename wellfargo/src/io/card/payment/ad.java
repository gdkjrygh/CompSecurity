...
_L3:
    ...
    {
        (new StringBuilder("Native memory stats: ")).append((new StringBuilder("(free/alloc'd/total)")).append(Debug.getNativeHeapFreeSize()).append("/").append(Debug.getNativeHeapAllocatedSize()).append("/").append(Debug.getNativeHeapSize()).toString()).toString();
    }
