...
_L10:
    ...
    private void callSharedElementEnd(TransitionState transitionstate, Fragment fragment, Fragment fragment1, boolean flag, a a1)
    {
        if (flag)
        {
        ...
        {
            transitionstate.onSharedElementEnd(new ArrayList(a1.keySet()), new ArrayList(a1.values()), null);
        }
    }

    private static Object captureExitingViews(Object obj, Fragment fragment, ArrayList arraylist, a a1, View view)
    {
        Object obj1 = obj;
        if (obj != null)
        {
            obj1 = FragmentTransitionCompat21.captureExitingViews(obj, fragment.getView(), arraylist, a1, view);
        }
        return obj1;
    }
    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        if (obj2 != null)
        {
            ...
            {
                sparsearray1.onSharedElementStart(new ArrayList(((a) (obj)).keySet()), new ArrayList(((a) (obj)).values()), null);
                sparsearray = ((SparseArray) (obj));
            }
        }
    ...
    private a mapEnteringSharedElements(TransitionState transitionstate, Fragment fragment, boolean flag)
    {
        a a1;
label0:
        {
            ...
            if (fragment != null)
            {
                ...
                {
                    FragmentTransitionCompat21.findNamedViews(a1, fragment);
                    if (!flag)
                    {
                        break label0;
                    }
                    transitionstate = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, a1);
                }
            }
            return transitionstate;
        }
        a1.a(mSharedElementTargetNames);
        return a1;
    }

    private a mapSharedElementsIn(TransitionState transitionstate, boolean flag, Fragment fragment)
    {
        a a1 = mapEnteringSharedElements(transitionstate, fragment, flag);
        if (flag)
        {
            if (fragment.mExitTransitionCallback != null)
            {
                fragment.mExitTransitionCallback.onMapSharedElements(mSharedElementTargetNames, a1);
            }
            setBackNameOverrides(transitionstate, a1, true);
            return a1;
        }
        if (fragment.mEnterTransitionCallback != null)
        {
            fragment.mEnterTransitionCallback.onMapSharedElements(mSharedElementTargetNames, a1);
        }
        setNameOverrides(transitionstate, a1, true);
        return a1;
    }
    ...
    private static a remapNames(ArrayList arraylist, ArrayList arraylist1, a a1)
    {
        if (a1.isEmpty())
        {
            return a1;
        ...
        for (int i = 0; i < j; i++)
        {
            View view = (View)a1.get(arraylist.get(i));
            if (view != null)
            {
                a2.put(arraylist1.get(i), view);
            }
        }
    ...
    private a remapSharedElements(TransitionState transitionstate, Fragment fragment, boolean flag)
    {
        a a2 = new a();
        a a1 = a2;
        if (mSharedElementSourceNames != null)
        {
            FragmentTransitionCompat21.findNamedViews(a2, fragment.getView());
            if (flag)
            {
                a2.a(mSharedElementTargetNames);
                a1 = a2;
            } else
            {
                a1 = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, a2);
            }
        }
        if (flag)
        {
            ...
            setBackNameOverrides(transitionstate, a1, false);
            return a1;
        }
        if (fragment.mExitTransitionCallback != null)
        {
        ...
        setNameOverrides(transitionstate, a1, false);
        return a1;
    }

    private void setBackNameOverrides(TransitionState transitionstate, a a1, boolean flag)
    {
        int i;
        int j;
        ...
        while (j < i) 
        {
            ...
            Object obj = (View)a1.get((String)mSharedElementTargetNames.get(j));
            if (obj != null)
            {
    ...
    private void setEpicenterIn(a a1, TransitionState transitionstate)
    {
        if (mSharedElementTargetNames != null && !a1.isEmpty())
        {
            a1 = (View)a1.get(mSharedElementTargetNames.get(0));
            if (a1 != null)
            {
                transitionstate.enteringEpicenterView.epicenter = a1;
            }
        }
    }
    ...
    private static void setNameOverride(a a1, String s, String s1)
    {
...
_L6:
        ...
        if (!s.equals(a1.c(i))) goto _L4; else goto _L3
_L3:
        a1.a(i, s1);
_L2:
        return;
...
_L5:
    ...
    private void setNameOverrides(TransitionState transitionstate, a a1, boolean flag)
    {
        int j = a1.size();
        int i = 0;
        while (i < j) 
        {
            String s = (String)a1.b(i);
            String s1 = FragmentTransitionCompat21.getTransitionName((View)a1.c(i));
            if (flag)
            {
        ...
        implements android.view.ViewTreeObserver.OnPreDrawListener
    {
        ...
        public boolean onPreDraw()
        {
            ...
            if (sharedElementTransition != null)
            {
                ...
                a a1 = mapSharedElementsIn(state, isBack, inFragment);
                sharedElementTargets.add(state.nonExistentView);
                sharedElementTargets.addAll(a1.values());
                FragmentTransitionCompat21.addTargets(sharedElementTransition, sharedElementTargets);
                setEpicenterIn(a1, state);
                callSharedElementEnd(state, inFragment, outFragment, isBack, a1);
            }
            return true;
        }
