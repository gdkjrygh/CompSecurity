...
public class n extends DataSetObservable
{
    ...
    private static final String a = android/support/v7/internal/widget/n.getSimpleName();
    ...
    private boolean a(r r1)
    {
        boolean flag = f.add(r1);
        if (flag)
        {
            n = true;
            i();
    ...
    private void d()
    {
        ...
        if (n)
        {
            ...
            {
                android.support.v4.c.a.a(new t(this, null), new Object[] {
                    f, h
                });
                return;
            }
...
_L9:
        ...
        list.add(new r(((XmlPullParser) (obj1)).getAttributeValue(null, "activity"), Long.parseLong(((XmlPullParser) (obj1)).getAttributeValue(null, "time")), Float.parseFloat(((XmlPullParser) (obj1)).getAttributeValue(null, "weight"))));
          goto _L8
        exception;
...
_L2:
        ...
        if (((p)list.get(i1)).a != resolveinfo)
        {
...
label0:
        ...
        e();
        obj1 = (p)e.get(i1);
        obj1 = new ComponentName(((p) (obj1)).a.activityInfo.packageName, ((p) (obj1)).a.activityInfo.name);
        intent = new Intent(i);
        ...
        JVM INSTR monitorexit ;
        return null;
        a(new r(((ComponentName) (obj1)), System.currentTimeMillis(), 1.0F));
        obj;
        JVM INSTR monitorexit ;
        return intent;
        exception;
    ...
    public void c(int i1)
    {
        ...
        float f1 = (p2.b - p1.b) + 5F;
_L1:
        a(new r(new ComponentName(p1.a.activityInfo.packageName, p1.a.activityInfo.name), System.currentTimeMillis(), f1));
        obj;
        JVM INSTR monitorexit ;
        return;
        Exception exception;
