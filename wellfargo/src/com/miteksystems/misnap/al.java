    ...
    implements a
{
    ...
    private al(MiSnap misnap, Handler handler)
    {
        super(misnap, null, 0);
        a = null;
        e = new ArrayList();
    ...
    private al(MiSnap misnap, Handler handler, byte byte0)
    {
        this(misnap, handler);
    }

    al(MiSnap misnap, Handler handler, char c1)
    {
...
_L2:
        ...
        try
        {
            ...
            jsonarray1.put(am1.a);
            jsonobject.put(am1.c, jsonarray1);
        }
...
_L1:
    ...
    {
        e.size();
        e.add(new am(this, s, System.currentTimeMillis() - f, i));
    }
}
