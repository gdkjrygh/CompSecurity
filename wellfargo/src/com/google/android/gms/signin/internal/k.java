    ...
    implements i
{
    ...
    public void a(int j, Account account, f f1)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L2:
    ...
    public void a(AuthAccountRequest authaccountrequest, f f1)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L2:
    ...
    public void a(ResolveAccountRequest resolveaccountrequest, ao ao1)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L3:
        ...
        resolveaccountrequest = ao1.asBinder();
_L4:
...
_L2:
    ...
    public void a(ae ae1, int j, boolean flag)
    {
        Parcel parcel;
        Parcel parcel1;
        boolean flag1;
...
_L1:
    ...
    public void a(RecordConsentRequest recordconsentrequest, f f1)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
