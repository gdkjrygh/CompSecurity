    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!d.equals(((PlacesParams) (obj)).d) || !c.equals(((PlacesParams) (obj)).c) || !ar.a(e, ((PlacesParams) (obj)).e) || !ar.a(f, ((PlacesParams) (obj)).f) || !ar.a(g, ((PlacesParams) (obj)).g))
            {
                return false;
            }
        }
    ...
    {
        return ar.a(this).a("clientPackageName", c).a("locale", d).a("accountName", e).a("gCoreClientName", f).a("chargedPackageName", g).toString();
    }

    public void writeToParcel(Parcel parcel, int i)
    {
        g g1 = CREATOR;
        com.google.android.gms.location.places.internal.g.a(this, parcel, i);
    }
