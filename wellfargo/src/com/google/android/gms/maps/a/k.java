...
public abstract class k extends Binder
    implements com.google.android.gms.maps.a.j
{

    public static com.google.android.gms.maps.a.j a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof com.google.android.gms.maps.a.j))
        {
            return (com.google.android.gms.maps.a.j)iinterface;
        } else
        {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int i1)
    {
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
            j j1 = com.google.android.gms.a.k.a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
            j j2 = com.google.android.gms.a.k.a(parcel.readStrongBinder());
            j j3 = com.google.android.gms.a.k.a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.createFromParcel(parcel);
            } else
        ...
        case 12: // '\f'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
            a(bl.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
