...
public class j extends ae
{
    ...
    {
        return Pattern.compile("/accounts/static/webassets/unavailable/temporarily_unavailable.html$");
    }
    ...
    public ac b(BaseWebViewActivity basewebviewactivity, WebView webview, String s)
    {
        ...
        webview.a(false);
        webview.b(true);
        basewebviewactivity.returnWithErrorWithIcon(basewebviewactivity.getString(0x7f080105), basewebviewactivity.getString(0x7f080100, new Object[] {
            WFApp.ag()
        }), 0x7f0200fb);
        return webview;
    }
