    ...
    implements ECPublicKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPublicKey
{
    ...
    {
        algorithm = "ECGOST3410";
        q = bcecgost3410publickey.q;
        ecSpec = bcecgost3410publickey.ecSpec;
        withCompression = bcecgost3410publickey.withCompression;
        gostParams = bcecgost3410publickey.gostParams;
    }
...
label0:
        {
            if (subjectpublickeyinfo.getAlgorithm().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001))
            {
                ...
                gostParams = new GOST3410PublicKeyAlgParameters((ASN1Sequence)subjectpublickeyinfo.getAlgorithm().getParameters());
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (engineGetQ().equals(((BCECGOST3410PublicKey) (obj = (BCECGOST3410PublicKey)obj)).engineGetQ()) && engineGetSpec().equals(((BCECGOST3410PublicKey) (obj)).engineGetSpec()))
            {
                return true;
            }
        }
