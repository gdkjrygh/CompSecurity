...
public class KeyPairGeneratorSpi extends KeyPairGenerator
{
    ...
    public KeyPair generateKeyPair()
    {
        ...
        if (ecParams instanceof ECParameterSpec)
        {
            ...
            obj1 = new BCDSTU4145PublicKey(algorithm, ((ECPublicKeyParameters) (obj1)), ecparameterspec);
            return new KeyPair(((java.security.PublicKey) (obj1)), new BCDSTU4145PrivateKey(algorithm, ((ECPrivateKeyParameters) (obj)), ((BCDSTU4145PublicKey) (obj1)), ecparameterspec));
        }
        if (ecParams == null)
        {
            return new KeyPair(new BCDSTU4145PublicKey(algorithm, ((ECPublicKeyParameters) (obj1))), new BCDSTU4145PrivateKey(algorithm, ((ECPrivateKeyParameters) (obj))));
        } else
        {
            java.security.spec.ECParameterSpec ecparameterspec1 = (java.security.spec.ECParameterSpec)ecParams;
            obj1 = new BCDSTU4145PublicKey(algorithm, ((ECPublicKeyParameters) (obj1)), ecparameterspec1);
            return new KeyPair(((java.security.PublicKey) (obj1)), new BCDSTU4145PrivateKey(algorithm, ((ECPrivateKeyParameters) (obj)), ((BCDSTU4145PublicKey) (obj1)), ecparameterspec1));
        }
    }
    ...
    public void initialize(AlgorithmParameterSpec algorithmparameterspec, SecureRandom securerandom)
    {
        ...
        if ((algorithmparameterspec instanceof ECGenParameterSpec) || (algorithmparameterspec instanceof ECNamedCurveGenParameterSpec))
        {
            ...
            obj = DSTU4145NamedCurves.getByOID(new ASN1ObjectIdentifier(algorithmparameterspec));
            if (obj == null)
            {
