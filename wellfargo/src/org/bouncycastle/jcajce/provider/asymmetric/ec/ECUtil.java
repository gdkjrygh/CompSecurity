...
public class ECUtil
{
    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privatekey)
    {
        ...
        if (privatekey instanceof java.security.interfaces.ECPrivateKey)
        {
            ...
            ECParameterSpec ecparameterspec = EC5Util.convertSpec(privatekey.getParams(), false);
            return new ECPrivateKeyParameters(privatekey.getS(), new ECDomainParameters(ecparameterspec.getCurve(), ecparameterspec.getG(), ecparameterspec.getN(), ecparameterspec.getH(), ecparameterspec.getSeed()));
        }
        try
        {
        ...
        {
            throw new InvalidKeyException((new StringBuilder()).append("cannot identify EC private key: ").append(privatekey.toString()).toString());
        }
        if (privatekey != null)
        {
        ...
        privatekey = BouncyCastleProvider.getPrivateKey(PrivateKeyInfo.getInstance(privatekey));
        if (!(privatekey instanceof java.security.interfaces.ECPrivateKey))
        {
            break MISSING_BLOCK_LABEL_211;
        }
        privatekey = generatePrivateKeyParameter(privatekey);
        return privatekey;
    ...
    public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey publickey)
    {
        ...
        {
            throw new InvalidKeyException((new StringBuilder()).append("cannot identify EC public key: ").append(publickey.toString()).toString());
        }
        if (publickey != null)
        {
        ...
        publickey = BouncyCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(publickey));
        if (!(publickey instanceof java.security.interfaces.ECPublicKey))
        {
            break MISSING_BLOCK_LABEL_263;
        }
        publickey = generatePublicKeyParameter(publickey);
        return publickey;
