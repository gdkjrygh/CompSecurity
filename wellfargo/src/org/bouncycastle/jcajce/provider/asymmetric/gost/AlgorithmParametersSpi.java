...
public class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi
{
    ...
    {
        GOST3410PublicKeyAlgParameters gost3410publickeyalgparameters = new GOST3410PublicKeyAlgParameters(new ASN1ObjectIdentifier(currentSpec.getPublicKeyParamSetOID()), new ASN1ObjectIdentifier(currentSpec.getDigestParamSetOID()), new ASN1ObjectIdentifier(currentSpec.getEncryptionParamSetOID()));
        byte abyte0[];
        try
        {
    ...
    protected void engineInit(byte abyte0[])
    {
        try
        {
            currentSpec = GOST3410ParameterSpec.fromPublicKeyAlg(new GOST3410PublicKeyAlgParameters((ASN1Sequence)ASN1Primitive.fromByteArray(abyte0)));
            return;
        }
