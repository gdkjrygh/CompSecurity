...
public class Q extends AlgorithmParametersSpi
{
    ...
    {
        Object obj = new AlgorithmIdentifier(DigestFactory.getOID(currentSpec.getDigestAlgorithm()), DERNull.INSTANCE);
        Object obj1 = (MGF1ParameterSpec)currentSpec.getMGFParameters();
        obj1 = new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, new AlgorithmIdentifier(DigestFactory.getOID(((MGF1ParameterSpec) (obj1)).getDigestAlgorithm()), DERNull.INSTANCE));
