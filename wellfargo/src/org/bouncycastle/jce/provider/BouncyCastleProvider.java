...
_L2:
    ...
    private void setup()
    {
        ...
        put((new StringBuilder()).append("SecretKeyFactory.").append(CryptoProObjectIdentifiers.gostR3411).toString(), "org.bouncycastle.jce.provider.JCESecretKeyFactory$PBEWithGOST3411");
    ...
    public void setParameter(String s, Object obj)
    {
        ...
        {
            ((BouncyCastleProviderConfiguration)CONFIGURATION).setParameter(s, obj);
        }
        return;
        s;
