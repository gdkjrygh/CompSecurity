...
_L2:
        ...
        if (extension == null) goto _L4; else goto _L3
_L3:
        int i;
        try
        {
            x500name = GeneralNames.getInstance(extension.getParsedValue()).getNames();
        }
    ...
    {
        s = getExtension(new ASN1ObjectIdentifier(s));
        if (s != null)
        {
            try
            {
...
_L4:
        ...
        {
            stringbuffer.append(CRLReason.getInstance(ASN1Enumerated.getInstance(asn1inputstream.readObject()))).append(s);
