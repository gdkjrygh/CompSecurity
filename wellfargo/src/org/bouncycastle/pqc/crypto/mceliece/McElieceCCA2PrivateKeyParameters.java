...
public class McElieceCCA2PrivateKeyParameters extends McElieceCCA2KeyParameters
{
    ...
    public McElieceCCA2PrivateKeyParameters(String s, int i, int j, byte abyte0[], byte abyte1[], byte abyte2[], byte abyte3[], 
            byte abyte4[][], McElieceCCA2Parameters mceliececca2parameters)
    {
        super(true, mceliececca2parameters);
        oid = s;
        n = i;
