...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters
{
    ...
    public McEliecePrivateKeyParameters(String s, int i, int j, byte abyte0[], byte abyte1[], byte abyte2[], byte abyte3[], 
            byte abyte4[], byte abyte5[], byte abyte6[][], McElieceParameters mcelieceparameters)
    {
        super(true, mcelieceparameters);
        oid = s;
        n = i;
