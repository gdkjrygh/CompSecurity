...
public class McEliecePKCSDigestCipher
{
    ...
    {
        mcElieceCipher = messageencryptor;
        messDigest = digest;
    }
    ...
    public void init(boolean flag, CipherParameters cipherparameters)
    {
        ...
        {
            reset();
            mcElieceCipher.init(flag, cipherparameters);
            return;
        }
    }
    ...
    public byte[] messageDecrypt(byte abyte0[])
    {
        ...
        try
        {
            abyte0 = mcElieceCipher.messageDecrypt(abyte0);
        }
    ...
    public byte[] messageEncrypt()
    {
        ...
        try
        {
            abyte0 = mcElieceCipher.messageEncrypt(abyte0);
        }
