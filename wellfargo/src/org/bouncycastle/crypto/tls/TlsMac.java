...
public class TlsMac
{
    ...
    public byte[] calculateMacConstantTime(short word0, byte abyte0[], int i, int j, int k, byte abyte1[])
    {
        abyte0 = calculateMac(word0, abyte0, i, j);
