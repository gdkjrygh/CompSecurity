...
_L5:
        ...
        i = j + 1;
        producedAt = ASN1GeneralizedTime.getInstance(asn1sequence.getObjectAt(j));
        j = i + 1;
...
_L2:
    ...
    {
        this(V1, responderid, ASN1GeneralizedTime.getInstance(dergeneralizedtime), asn1sequence, Extensions.getInstance(x509extensions));
    }
