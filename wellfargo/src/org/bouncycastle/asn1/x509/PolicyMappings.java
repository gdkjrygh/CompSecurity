...
public class PolicyMappings extends ASN1Object
{
    ...
    public PolicyMappings(CertPolicyId certpolicyid, CertPolicyId certpolicyid1)
    {
        seq = null;
        ASN1EncodableVector asn1encodablevector = new ASN1EncodableVector();
        asn1encodablevector.add(certpolicyid);
        asn1encodablevector.add(certpolicyid1);
        seq = new DERSequence(new DERSequence(asn1encodablevector));
    }

    public PolicyMappings(CertPolicyId acertpolicyid[], CertPolicyId acertpolicyid1[])
    {
        seq = null;
        ASN1EncodableVector asn1encodablevector = new ASN1EncodableVector();
        for (int i = 0; i != acertpolicyid.length; i++)
        {
            ASN1EncodableVector asn1encodablevector1 = new ASN1EncodableVector();
            asn1encodablevector1.add(acertpolicyid[i]);
            asn1encodablevector1.add(acertpolicyid1[i]);
