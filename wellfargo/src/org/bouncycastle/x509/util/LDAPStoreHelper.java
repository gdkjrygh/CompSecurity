...
_L5:
        ...
        obj1 = new X509CertificatePair(new CertificatePair(Certificate.getInstance((new ASN1InputStream(((byte []) (obj1)))).readObject()), Certificate.getInstance((new ASN1InputStream(abyte0)).readObject())));
        i++;
          goto _L4
_L2:
        return hashset;
