    ...
    implements Selector
{
    ...
    public boolean match(Object obj)
    {
        ...
        asn1integer = DERInteger.getInstance(X509ExtensionUtil.fromExtensionValue(abyte1));
        ...
        if (asn1integer != null && maxBaseCRLNumber != null && asn1integer.getPositiveValue().compareTo(maxBaseCRLNumber) == 1)
        {
            return false;
        }
