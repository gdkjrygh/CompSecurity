    ...
    implements com.walmartlabs.ui.recycler.ckListener
{
    ...
    {
        PaymentNavigationUtil.viewCreditCard(PaymentMethodsController.access$000(PaymentMethodsController.this), PaymentMethodsController.access$200(PaymentMethodsController.this).getItem(i));
    }
