...
class this._cls1 extends OnSingleClickListener
{
    ...
    {
        DialogFactory.createAlertDialog(getString(com.walmartlabs.android.payment.w_safe_title), getString(com.walmartlabs.android.payment.w_safe_body), getActivity()).show();
    }
