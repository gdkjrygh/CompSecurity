...
class val.webView extends WebViewClient
{
    ...
    public void onPageFinished(WebView webview, String s)
    {
        ...
        rootView.findViewById(com.walmartlabs.android.payment.ent._cls1.val.rootView).setVisibility(8);
        ...
        implements android.widget.TabHost.TabContentFactory
    {
        ...
        public View createTabContent(final String tab)
        {
            ...
            } else
            {
                ...
                WebView webview = (WebView)tab.findViewById(com.walmartlabs.android.payment.R.id.webView);
                webview.setWebViewClient(webview. new MoreInfoFragment._cls1._cls4());
