    ...
    implements com.walmartlabs.ereceipt.service.ck
{
    ...
    public void onResult(List list)
    {
        if (!isPopped())
        {
            EReceiptDetailPresenter.access$800(_fld0).setItems((com.walmartlabs.ereceipt.service.[])list.toArray(new com.walmartlabs.ereceipt.service.[list.size()]));
        }
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/walmartlabs/ereceipt/EReceiptDetailPresenter$4$3

/* anonymous class */
        class EReceiptDetailPresenter._cls4._cls3
            implements com.walmartlabs.ereceipt.service.EReceiptManager.ResultCallback
        {
