...
class <init> extends OnItemSingleClickListener
{
    ...
    {
        receipt = (EReceipt)EReceiptListPresenter.access$400(EReceiptListPresenter.this).getItem(i);
        if (receipt != null)
        {
            view = new EReceiptDetailPresenter(EReceiptListPresenter.access$700(EReceiptListPresenter.this), receipt, EReceiptListPresenter.access$800(EReceiptListPresenter.this));
            ...
            view.setDeleteHandler(new EReceiptDetailPresenter.DeleteHandler() {

                final EReceiptListPresenter._cls4 this$1;
                final EReceipt val$receipt;

                public void deleteReceipt(String s, boolean flag)
                {
                    EReceiptListPresenter.access$502(this$0, receipt);
                    EReceiptListPresenter.access$1000(this$0);
                }

            
            {
                this$1 = EReceiptListPresenter._cls4.this;
                receipt = ereceipt;
                super();
            }
            });
