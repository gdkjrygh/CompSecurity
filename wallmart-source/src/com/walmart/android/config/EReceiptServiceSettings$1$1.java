...
//            ServiceConfigChangedEvent, EReceiptServiceSettings
    ...
    implements com.walmartlabs.ereceipt.service.ck
{
    ...
    // Unreferenced inner class com/walmart/android/config/EReceiptServiceSettings$1

/* anonymous class */
    static final class EReceiptServiceSettings._cls1
        implements android.content.DialogInterface.OnClickListener
    {
        ...
        public void onClick(DialogInterface dialoginterface, int i)
        {
            if (i != selectedIndex)
            {
                EReceiptServiceSettings.access$000(context, "ereceipt_server_setting", i);
                EReceiptManager.get().clearAllReceipts(new EReceiptServiceSettings._cls1._cls1());
            }
