...
public class ReceiptsSummaryResponse extends StatusResponse
{
    public static class OverallSavingsSummary
    {
        ...
        public OverallSavingsSummary()
        {
        }
    }

    public static class OverallSavingsSummary.RedeemMethod
    {
        ...
        public OverallSavingsSummary.RedeemMethod()
        {
        }
    }
    ...
    public static class Payload
    {
        ...
        public ArrayList receiptSummaries;
    ...
    public ReceiptsSummaryResponse()
    {
    }
}
