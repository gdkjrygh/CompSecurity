    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        list = list1;
        list1 = (List)WalmartNetServiceImpl.access$600(WalmartNetServiceImpl.this).readValue(((java.io.InputStream) (obj)), new TypeReference() {

            final WalmartNetServiceImpl._cls9 this$1;

            
            {
                this$1 = WalmartNetServiceImpl._cls9.this;
                super();
            }
        });
        obj = list1;
...
_L2:
        ...
        {
            val$asyncCallback.onSuccess(obj);
            return;
        } else
        {
            val$asyncCallback.onFailure(Integer.valueOf(0x15f91), obj);
            return;
        }
