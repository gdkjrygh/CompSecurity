...
class aHandlerMain extends aHandlerMain
{
    ...
    {
        s = (ePickerDialogData)JSBridgeAdapter.access$200(JSBridgeAdapter.this, s, com/walmart/android/app/hybrid/JSBridgeAdapter$DatePickerDialogData);
        JSBridgeAdapter.access$300(JSBridgeAdapter.this).onDateDialog(s, new dgeCallback(jscallback));
    }
