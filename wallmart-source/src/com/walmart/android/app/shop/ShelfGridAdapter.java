...
//            ShelfAdapter, ShelfItemCardView

public class ShelfGridAdapter extends ShelfAdapter
{
    ...
    {
        super.cleanup();
        Picasso.with(getContext()).cancelTag(ShelfItemCardView.TAG);
    }
    ...
    {
        ((ShelfItemCardView)shelfitemviewholder.itemView).setItem((com.walmart.android.data.StoreQueryResult.Item)getItem(i), isShippingPassEligible());
    }
    ...
    {
        return new ShelfAdapter.ShelfItemViewHolder(ViewUtil.inflate(getContext(), 0x7f040191, viewgroup));
    }
