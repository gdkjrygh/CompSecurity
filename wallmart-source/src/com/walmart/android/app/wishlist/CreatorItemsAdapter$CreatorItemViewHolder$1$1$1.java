...
class this._cls3 extends CallbackSameThread
{
...
/* anonymous class */
    ...
    // Unreferenced inner class com/walmart/android/app/wishlist/CreatorItemsAdapter$CreatorItemViewHolder$1$1

/* anonymous class */
    class CreatorItemsAdapter.CreatorItemViewHolder._cls1._cls1
        implements QuantityEditorDialogFragment.OnNewQuantityListener
    {
        ...
        public void onNewQuantity(int i)
        {
            ...
            WishListManager.get().updateItemQuantities(((ListItemModel) (obj)).getListId(), ((ListItemModel) (obj)).getId(), i, ((ListItemModel) (obj)).getHasQuantity(), new CreatorItemsAdapter.CreatorItemViewHolder._cls1._cls1._cls1());
