...
class this._cls0 extends CallbackSameThread
{
    ...
    public void onResultSameThread(Request request, Result result)
    {
        ...
        if (isVisible() && !getActivity().isFinishing())
        {
            ...
            request.setOnDismissListener(new android.content.DialogInterface.OnDismissListener() {

                final DeepLinkFragment._cls1 this$1;
            ...
            {
                this$1 = DeepLinkFragment._cls1.this;
                super();
            }
            });
            request.show();
