...
class val.buttonsCallback
    implements io.theholygrail.dingo.navigationbar.llback.OnClickListener
{
    ...
    {
        s = new JSValue(s);
        val$buttonsCallback.callFunction(BridgeController.access$700(_fld0), new Object[] {
            s
        }, null);
    }
    ...
    l.handler()
    {
        ...
        val$buttonsCallback = JSValue.this;
        super();
    }
...
/* anonymous class */
        ...
        implements NavigationBridgeCallback
    {
        ...
        public void presentModal(NavigationOptions navigationoptions)
        {
            ...
            if (navigationoptions != null)
            {
                ...
                if (navigationoptions.onNavigationBarButtonTap != null)
                {
                    ...
                    page.setButtons(navigationoptions.navigationBarButtons, jsvalue. new BridgeController._cls4._cls1());
                }
                if (navigationoptions.onAppear != null)
                {
                    page.setOnAppearListener(new BridgeController._cls4._cls2());
                }
            }
        ...
        // Unreferenced inner class com/walmart/android/app/bridge/BridgeController$4$2

/* anonymous class */
        class BridgeController._cls4._cls2
            implements io.theholygrail.dingo.view.ViewBridgeCallback.OnAppearListener
        {
            ...
            {
                onAppearCallback.callFunction(BridgeController.access$700(this$0), null, null);
            }

                    
                    {
                        this$1 = BridgeController._cls4.this;
                        onAppearCallback = jsvalue;
                        super();
                    }
        }
