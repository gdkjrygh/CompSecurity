...
class val.url
    implements io.theholygrail.dingo.nimationListener
{
    ...
    {
        BridgeController.access$1500(_fld0, BridgeController.access$1400(_fld0), val$url);
    }
        ...
        implements NavigationBridgeCallback
    {
        ...
        public void presentExternalUrl(ExternalUrlOptions externalurloptions)
        {
            if (externalurloptions != null && externalurloptions.url != null)
            {
                ...
                BridgeController.access$1100(BridgeController.this, page, s. new BridgeController._cls4._cls4());
            }
        }
