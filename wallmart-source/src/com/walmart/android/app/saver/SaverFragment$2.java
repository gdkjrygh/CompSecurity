...
_L4:
        if (flag != SaverFragment.access$000(SaverFragment.this))
        {
            ...
            SaverFragment.access$300(SaverFragment.this).post(new Runnable() {

                final SaverFragment._cls2 this$1;

                public void run()
                {
                    SaverFragment.access$200(this$0).requestLayout();
                }

            
            {
                this$1 = SaverFragment._cls2.this;
                super();
            }
            });
        }
