    ...
    implements Runnable
{
    ...
    public void run()
    {
        ViewUtil.findViewById(SaverDashboardPresenter.access$700(_fld0), 0x7f100498).setVisibility(0);
        rollToContent();
        SaverDashboardPresenter.access$502(_fld0, true);
    }
...
/* anonymous class */
    class SaverDashboardPresenter._cls8 extends OnSingleClickListener
    {
        ...
        private void scrollToContent()
        {
            ...
            scrollView.post(new SaverDashboardPresenter._cls8._cls2());
        }
        ...
        // Unreferenced inner class com/walmart/android/app/saver/SaverDashboardPresenter$8$2

/* anonymous class */
        class SaverDashboardPresenter._cls8._cls2
            implements Runnable
        {
