...
class this._cls0 extends OnSingleClickListener
{
    ...
    public void onSingleClick(View view)
    {
        ...
        view = new android.app.DatePickerDialog.OnDateSetListener() {
            ...
            final SaverFeedbackPresenter._cls5 this$1;

            public void onDateSet(DatePicker datepicker, int i, int j, int k)
            {
                SaverFeedbackPresenter.access$800(this$0).set(1, i);
                SaverFeedbackPresenter.access$800(this$0).set(2, j);
                SaverFeedbackPresenter.access$800(this$0).set(5, k);
                SaverFeedbackPresenter.access$900(this$0).setText(SaverFeedbackPresenter.access$400().format(SaverFeedbackPresenter.access$800(this$0).getTime()));
            }

            
            {
                this$1 = SaverFeedbackPresenter._cls5.this;
                super();
            }
        };
