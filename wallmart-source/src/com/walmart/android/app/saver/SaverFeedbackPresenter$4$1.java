    ...
    implements android.app.istener
{
    ...
    {
        SaverFeedbackPresenter.access$300(_fld0).set(1, i);
        SaverFeedbackPresenter.access$300(_fld0).set(2, j);
        SaverFeedbackPresenter.access$300(_fld0).set(5, k);
        SaverFeedbackPresenter.access$500(_fld0).setText(SaverFeedbackPresenter.access$400().format(SaverFeedbackPresenter.access$300(_fld0).getTime()));
    }
    ...
    // Unreferenced inner class com/walmart/android/app/saver/SaverFeedbackPresenter$4

/* anonymous class */
    class SaverFeedbackPresenter._cls4 extends OnSingleClickListener
    {
        ...
        public void onSingleClick(View view)
        {
            ...
            view = new SaverFeedbackPresenter._cls4._cls1();
