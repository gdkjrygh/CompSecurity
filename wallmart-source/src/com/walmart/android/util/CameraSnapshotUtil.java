...
{
    private static class StoreImageDataTask extends AsyncTask
    {
...
_L2:
        ...
        public StoreImageDataTask(Context context, String s)
        {
            mContext = context;
            mUpc = s;
        }
    ...
    private static final String TAG = com/walmart/android/util/CameraSnapshotUtil.getSimpleName();
    private final Context mContext;
    ...
    public void storeImageData(String s, byte abyte0[])
    {
        (new StoreImageDataTask(mContext, s)).execute(new byte[][] {
            abyte0
        });
    }
