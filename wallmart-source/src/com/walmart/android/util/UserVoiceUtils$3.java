    ...
    implements android.content.nClickListener
{
    ...
    {
        dialoginterface = (new com.walmartlabs.anivia..Builder("popUpModal")).putString("modalType", val$context.getString(0x7f09011e)).putString("modalAction", val$context.getString(0x7f09011f));
