    ...
    implements android.content.nClickListener
{
    ...
    {
        dialoginterface = (new com.walmartlabs.anivia..Builder("popUpModal")).putString("modalType", val$context.getString(0x7f090124)).putString("modalAction", val$context.getString(0x7f090125));
