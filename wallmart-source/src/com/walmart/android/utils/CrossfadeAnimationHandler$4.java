    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (!CrossfadeAnimationHandler.access$300(CrossfadeAnimationHandler.this).hasEnded())
        {
            CrossfadeAnimationHandler.access$100(CrossfadeAnimationHandler.this).setVisibility(0);
            CrossfadeAnimationHandler.access$300(CrossfadeAnimationHandler.this).cancel();
        }
    }
