    ...
    implements com.walmart.android.wmservice.allback
{
    ...
    public void onSuccess()
    {
        MobilePayManager.get().getUserInfo(new com.walmartlabs.payment.service.mpay.MobilePayManager.UserInfoInterface() {
            ...
            final MobilePayFragment._cls1 this$1;
                ...
                if (flag)
                {
                    ...
                    if (bundle != null && bundle.getString("transaction_id") != null)
                    {
                        ...
                        if (transaction != null)
                        {
                            ...
                            MobilePayController.startTransactionConfirmation(this$0, 7, transaction, bundle.getString("transaction_id"));
                    ...
                    {
                        MobilePayPinController.launchPin(this$0, 2);
                        return;
                    }
                } else
                {
                    MobilePayController.startValueProposition(this$0, 4);
                    return;
                }
            }
            ...
            {
                this$1 = MobilePayFragment._cls1.this;
                super();
            }
        });
    }
