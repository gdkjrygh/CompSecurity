...
class zzdj
{
    ...
    private static zzbw zza(zzbw zzbw1)
    {
        ...
        try
        {
            zzbw2 = new zzbw(zzdf.zzK(zzff(zzdf.zzg((com.google.android.gms.internal.zzag.zza)zzbw1.getObject()))), zzbw1.zzAq());
        }
    ...
    private static zzbw zza(zzbw zzbw1, int i)
    {
        ...
        {
        default:
            zzbg.e((new StringBuilder()).append("Unsupported Value Escaping: ").append(i).toString());
            return zzbw1;
