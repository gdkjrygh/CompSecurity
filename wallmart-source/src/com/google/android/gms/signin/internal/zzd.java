        ...
        implements zzd
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                zza(parcel.readString(), parcel.createTypedArrayList(Scope.CREATOR), zzf.zza.zzdH(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.signin.internal.IOfflineAccessCallbacks");
                zza(parcel.readString(), parcel.readString(), zzf.zza.zzdH(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
