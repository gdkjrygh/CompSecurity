    ...
    extends IInterface
{
        ...
        implements zzcv
    {
        ...
        public static zzcv zzB(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof zzcv))
            {
                return (zzcv)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                zza(zzcr.zza.zzy(parcel.readStrongBinder()), parcel.readString());
...
_L1:
    ...
    public abstract void zza(zzcr zzcr, String s)
        throws RemoteException;
}
