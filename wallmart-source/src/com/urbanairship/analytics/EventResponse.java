...
class EventResponse
{
    ...
    public Integer getMaxBatchSize()
    {
        if (response.getResponseHeaders() != null)
        {
            ...
            {
                return Integer.valueOf(UAMathUtil.constrain(Integer.parseInt((String)list.get(0)), 1024, 0x7d000));
            }
        }
    ...
    public Integer getMaxTotalSize()
    {
        if (response.getResponseHeaders() != null)
        {
            ...
            if (list != null && list.size() > 0)
            {
                return Integer.valueOf(UAMathUtil.constrain(Integer.parseInt((String)list.get(0)), 10240, 0x500000));
            }
        }
    ...
    public Integer getMaxWait()
    {
        if (response.getResponseHeaders() != null)
        {
            ...
            if (list != null && list.size() > 0)
            {
                return Integer.valueOf(UAMathUtil.constrain(Integer.parseInt((String)list.get(0)), 0x240c8400, 0x48190800));
            }
        }
    ...
    public Integer getMinBatchInterval()
    {
        if (response.getResponseHeaders() != null)
        {
            ...
            if (list != null && list.size() > 0)
            {
                return Integer.valueOf(UAMathUtil.constrain(Integer.parseInt((String)list.get(0)), 60000, 0x240c8400));
            }
        }
