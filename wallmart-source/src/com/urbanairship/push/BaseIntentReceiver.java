...
public abstract class BaseIntentReceiver extends BroadcastReceiver
{
    ...
    {
        android.os.Bundle bundle = intent.getBundleExtra("com.urbanairship.push.EXTRA_PUSH_BUNDLE");
        ...
        {
            onNotificationDismissed(context, new PushMessage(bundle), i);
            return;
        }
    }
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        Logger.debug((new StringBuilder()).append("Received intent with action: ").append(s).toString());
        ...
        } else
        {
            ...
            if ("com.urbanairship.push.DISMISSED".equals(s))
            {
