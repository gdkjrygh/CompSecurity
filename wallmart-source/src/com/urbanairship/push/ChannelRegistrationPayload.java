...
class ChannelRegistrationPayload
{
    ...
    class Builder {}
        ...
        optIn = Builder.access._mth100(builder);
        backgroundEnabled = Builder.access._mth200(builder);
        alias = Builder.access._mth300(builder);
        deviceType = Builder.access._mth400(builder);
        pushAddress = Builder.access._mth500(builder);
        setTags = Builder.access._mth600(builder);
        Set set;
        if (Builder.access._mth600(builder))
        {
            set = Builder.access._mth700(builder);
        } else
        {
            set = null;
        }
        tags = set;
        userId = Builder.access._mth800(builder);
        apid = Builder.access._mth900(builder);
    }
...
_L2:
        ...
        if (jsonobject.has("identity_hints"))
        {
            ...
            builder.setUserId(getStringFromJSON(jsonobject, "user_id")).setApid(getStringFromJSON(jsonobject, "apid"));
        }
    ...
    public int hashCode()
    {
        ...
        return ((((((((i + 527) * 31 + j) * 31 + k) * 31 + l) * 31 + i1) * 31 + j1) * 31 + k1) * 31 + l1) * 31 + i2;
    }
