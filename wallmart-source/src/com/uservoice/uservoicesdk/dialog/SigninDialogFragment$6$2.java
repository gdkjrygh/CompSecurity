...
class this._cls1 extends Callback
{
    ...
    {
        Toast.makeText(activity, com.uservoice.uservoicesdk._error, 0).show();
    }
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        // Unreferenced inner class com/uservoice/uservoicesdk/dialog/SigninDialogFragment$6$1

/* anonymous class */
        class SigninDialogFragment._cls6._cls1 extends DefaultCallback
        {
