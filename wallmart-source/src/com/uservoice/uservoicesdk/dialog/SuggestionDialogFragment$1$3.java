    ...
    implements Runnable
{
    ...
    public void run()
    {
        SuggestionDialogFragment.access$000(_fld0).subscribe(val$callback);
    }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View callback)
        {
            ...
            if (SuggestionDialogFragment.access$000(SuggestionDialogFragment.this).isSubscribed())
            {
                ...
                {
                    SigninManager.signinForSubscribe(getActivity(), Session.getInstance().getEmail(), new SuggestionDialogFragment._cls1._cls2());
                    return;
                }
            }
            if (Session.getInstance().getEmail() != null)
            {
                SigninManager.signinForSubscribe(getActivity(), Session.getInstance().getEmail(), callback. new SuggestionDialogFragment._cls1._cls3());
                return;
            } else
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/uservoice/uservoicesdk/dialog/SuggestionDialogFragment$1$2

/* anonymous class */
        class SuggestionDialogFragment._cls1._cls2
            implements Runnable
        {
