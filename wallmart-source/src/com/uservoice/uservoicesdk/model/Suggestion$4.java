...
class ck extends RestTaskCallback
{
    ...
    {
        Babayaga.track(com.uservoice.uservoicesdk.babayaga.t.VOTE_IDEA, getId());
        Babayaga.track(com.uservoice.uservoicesdk.babayaga.t.SUBSCRIBE_IDEA, getId());
        load(jsonobject.getJSONObject("suggestion"));
        val$callback.onModel(Suggestion.this);
    }

    vent(Callback callback2)
    {
