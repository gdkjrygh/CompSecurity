...
_L10:
    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        Object obj1 = (Fragment)sparsearray1.get(i);
        Object obj4 = (Fragment)sparsearray.get(i);
        Object obj2 = getEnterTransition(((Fragment) (obj1)), flag);
        Object obj3 = getSharedElementTransition(((Fragment) (obj1)), ((Fragment) (obj4)), flag);
        ...
        if (obj3 != null)
        {
            Object obj = remapSharedElements(transitionstate, ((Fragment) (obj4)), flag);
        ...
        obj = captureExitingViews(obj5, ((Fragment) (obj4)), sparsearray1, sparsearray, transitionstate.nonExistentView);
        if (mSharedElementTargetNames != null && sparsearray != null)
        {
            ...
            if (sparsearray != null)
            {
                ...
                if (obj3 != null)
                {
                    FragmentTransitionCompat21.setEpicenter(obj3, sparsearray);
                }
            }
        }
        ...
        if (obj3 != null)
        {
            prepareSharedElementTransition(transitionstate, viewgroup, obj3, ((Fragment) (obj1)), ((Fragment) (obj4)), flag, arraylist);
        }
        obj4 = new ArrayList();
        obj5 = new ArrayMap();
        if (flag)
        ...
        obj1 = FragmentTransitionCompat21.mergeTransitions(obj2, obj, obj3, flag);
        if (obj1 != null)
        {
            FragmentTransitionCompat21.addTransitionTargets(obj2, obj3, viewgroup, sparsearray, transitionstate.nonExistentView, transitionstate.enteringEpicenterView, transitionstate.nameOverrides, ((ArrayList) (obj4)), ((java.util.Map) (obj5)), arraylist);
            excludeHiddenFragmentsAfterEnter(viewgroup, transitionstate, i, obj1);
            FragmentTransitionCompat21.excludeTarget(obj1, transitionstate.nonExistentView, true);
            excludeHiddenFragments(transitionstate, i, obj1);
            FragmentTransitionCompat21.beginDelayedTransition(viewgroup, obj1);
            FragmentTransitionCompat21.cleanupTransitions(viewgroup, transitionstate.nonExistentView, obj2, ((ArrayList) (obj4)), obj, sparsearray1, obj3, arraylist, obj1, transitionstate.hiddenFragmentViews, ((java.util.Map) (obj5)));
        }
        return obj1 != null;
    }
