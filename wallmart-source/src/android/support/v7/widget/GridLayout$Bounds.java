...
static class <init>
{
    ...
    {
        return before - nt.getAlignmentValue(view, i, ViewGroupCompat.getLayoutMode(gridlayout));
    }
    ...
    protected final void include(GridLayout gridlayout, View view, after after1, after after2, int i)
    {
        ...
        int j = after1.tAbsoluteAlignment(after2.rizontal).getAlignmentValue(view, i, ViewGroupCompat.getLayoutMode(gridlayout));
        include(j, i - j);
    }
