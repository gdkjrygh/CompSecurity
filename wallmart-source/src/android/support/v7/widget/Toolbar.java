...
public class Toolbar extends ViewGroup
{
        ...
        implements MenuPresenter
    {
        ...
        public boolean expandItemActionView(a a1, MenuItemImpl menuitemimpl)
        {
            ...
            {
                a1 = generateDefaultLayoutParams();
                a1.gravity = 0x800003 | mButtonGravity & 0x70;
                a1.mViewType = 2;
                mExpandedActionView.setLayoutParams(a1);
...
_L8:
    ...
    private android.support.v7.internal.view.menu.a.a mMenuBuilderCallback;
    ...
    private void ensureMenu()
    {
        ...
        {
            a a1 = (a)mMenuView.getMenu();
            if (mExpandedMenuPresenter == null)
            {
                mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
            }
            mMenuView.setExpandedActionViewsExclusive(true);
            a1.a(mExpandedMenuPresenter, mPopupContext);
        }
    }
...
_L3:
    ...
    public void setMenu(a a1, ActionMenuPresenter actionmenupresenter)
    {
        if (a1 != null || mMenuView != null)
        {
            ensureMenuView();
            a a2 = mMenuView.peekMenu();
            if (a2 != a1)
            {
                if (a2 != null)
                {
                    a2.b(mOuterActionMenuPresenter);
                    a2.b(mExpandedMenuPresenter);
                }
                if (mExpandedMenuPresenter == null)
                {
                    mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
                ...
                if (a1 != null)
                {
                    a1.a(actionmenupresenter, mPopupContext);
                    a1.a(mExpandedMenuPresenter, mPopupContext);
                } else
                {
    ...
    public void setMenuCallbacks(android.support.v7.internal.view.menu.MenuPresenter.Callback callback, android.support.v7.internal.view.menu.a.a a1)
    {
