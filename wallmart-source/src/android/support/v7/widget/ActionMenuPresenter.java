    ...
    implements android.support.v4.view.ActionProvider.SubUiVisibilityListener
{
        ...
        implements android.support.v7.internal.view.menu.MenuPresenter.Callback
    {
        ...
        public boolean onOpenSubMenu(a a1)
        {
            ...
            mOpenSubMenuId = ((b)a1).getItem().getItemId();
            android.support.v7.internal.view.menu.MenuPresenter.Callback callback = getCallback();
            boolean flag;
            if (callback != null)
            {
                flag = callback.onOpenSubMenu(a1);
            } else
            {
                flag = false;
            }
...
_L8:
    ...
    public void initForMenu(Context context, a a1)
    {
        ...
        mMinCellSize = (int)(56F * a1.getDisplayMetrics().density);
    ...
    public void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if (((SavedState) (parcelable)).openSubMenuId > 0)
        {
            ...
            if (parcelable != null)
            {
                onSubMenuSelected((b)parcelable.getSubMenu());
            }
        }
    }
    ...
    {
        if (b1.hasVisibleItems()) goto _L2; else goto _L1
_L1:
        return false;
_L2:
        Object obj;
        for (obj = b1; ((b) (obj)).t() != mMenu; obj = (b)((b) (obj)).t()) { }
        View view = findViewForItem(((b) (obj)).getItem());
        obj = view;
        if (view != null)
        {
            break; /* Loop/switch isn't completed */
...
_L3:
        mOpenSubMenuId = b1.getItem().getItemId();
        mActionButtonPopup = new ActionButtonSubmenu(mContext, b1);
        mActionButtonPopup.setAnchorView(((View) (obj)));
        mActionButtonPopup.show();
        onSubMenuSelected(b1);
        return true;
    }
