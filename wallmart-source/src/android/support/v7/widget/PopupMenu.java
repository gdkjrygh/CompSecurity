...
public class PopupMenu
    implements android.support.v7.internal.view.menu.MenuPresenter.Callback, android.support.v7.internal.view.menu.a.a
{
    ...
    public void onCloseSubMenu(b b)
    {
    }
    ...
    public boolean onOpenSubMenu(a a1)
    {
        ...
        {
            (new MenuPopupHelper(mContext, a1, mAnchor)).show();
            return true;
        }
        return flag;
    }
