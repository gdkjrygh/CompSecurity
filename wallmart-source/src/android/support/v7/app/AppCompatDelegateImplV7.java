...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase
    implements LayoutInflaterFactory, android.support.v7.internal.view.menu.a.a
{
...
label0:
            {
                ...
                a1 = appcompatdelegateimplv7.findMenuPanel(a1);
                if (a1 != null)
                {
                    if (!flag1)
                    {
                    ...
                    callOnPanelClosed(((PanelFeatureState) (a1)).featureId, a1, a2);
                    closePanel(a1, true);
                }
                return;
            }
    ...
    private void checkCloseActionMenu(a a1)
    {
...
label0:
        ...
        obj = new a(((Context) (obj)));
        ((a) (obj)).a(this);
        panelfeaturestate.setMenu(((a) (obj)));
        return true;
    }
...
_L3:
    ...
    private void reopenMenu(a a1, boolean flag)
    {
...
_L1:
        if (a1 != null && !isDestroyed())
        {
            ...
            if (panelfeaturestate.menu != null && !panelfeaturestate.refreshMenuContent && a1.onPreparePanel(0, panelfeaturestate.createdPanelView, panelfeaturestate.menu))
            {
                a1.onMenuOpened(8, panelfeaturestate.menu);
...
_L3:
        a1.onPanelClosed(8, getPanelState(0, true).menu);
        return;
        a1 = getPanelState(0, true);
        a1.refreshDecorView = true;
        closePanel(a1, false);
        openPanel(a1, null);
        return;
    }
...
_L4:
    ...
    public boolean onMenuItemSelected(a a1, MenuItem menuitem)
    {
        android.view.Window.Callback callback = getWindowCallback();
        if (callback != null && !isDestroyed())
        {
            a1 = findMenuPanel(a1.q());
            if (a1 != null)
            {
                return callback.onMenuItemSelected(((PanelFeatureState) (a1)).featureId, menuitem);
            }
        }
        return false;
    }

    public void onMenuModeChange(a a1)
    {
        reopenMenu(a1, true);
    }
