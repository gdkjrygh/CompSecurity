...
public class ToolbarActionBar extends ActionBar
{
        ...
        implements android.support.v7.internal.view.menu.MenuPresenter.Callback
    {
        ...
        public void onCloseMenu(a a1, boolean flag)
        {
            ...
            {
                mWindowCallback.onPanelClosed(8, a1);
            }
        ...
        public boolean onOpenSubMenu(a a1)
        {
            if (mWindowCallback != null)
            {
                mWindowCallback.onMenuOpened(8, a1);
                return true;
            } else
            {
                return false;
        ...
        implements android.support.v7.internal.view.menu.a.a
    {
        ...
        public void onMenuModeChange(a a1)
        {
            if (mWindowCallback != null)
            {
                ...
                if (mWindowCallback.onPreparePanel(0, null, a1))
                {
                    mWindowCallback.onMenuOpened(8, a1);
                    return;
                }
        ...
        implements android.support.v7.internal.view.menu.MenuPresenter.Callback
    {
        ...
        public void onCloseMenu(a a1, boolean flag)
        {
            if (mWindowCallback != null)
            {
                mWindowCallback.onPanelClosed(0, a1);
            }
        }

        public boolean onOpenSubMenu(a a1)
        {
            if (a1 == null && mWindowCallback != null)
            {
                mWindowCallback.onMenuOpened(0, a1);
            }
            return true;
        }
...
_L3:
    ...
    {
        if (mListMenuPresenter == null && (menu instanceof a))
        {
            menu = (a)menu;
