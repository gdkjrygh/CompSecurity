...
//            MenuPresenter, a, b, MenuItemImpl, 
    ...
    implements MenuPresenter, android.view.View.OnKeyListener, android.view.ViewTreeObserver.OnGlobalLayoutListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
    ...
    public MenuPopupHelper(Context context, a a1)
    {
        this(context, a1, null, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, a a1, View view)
    {
        this(context, a1, view, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, a a1, View view, boolean flag, int i)
    {
        this(context, a1, view, flag, i, 0);
    }

    public MenuPopupHelper(Context context, a a1, View view, boolean flag, int i, int j)
    {
        mDropDownGravity = 0;
        mContext = context;
...
label0:
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        ((MenuAdapter) (adapterview)).mAdapterMenu.a(adapterview.getItem(i), 0);
    }
    ...
    public boolean onSubMenuSelected(b b1)
    {
        ...
        {
            MenuPopupHelper menupopuphelper = new MenuPopupHelper(mContext, b1, mAnchorView);
...
label1:
                {
                    ...
                    if (i < j)
                    {
                        MenuItem menuitem = b1.getItem(i);
                    ...
                    if (menupopuphelper.tryShow())
                    {
                        if (mPresenterCallback != null)
                        {
                            mPresenterCallback.onOpenSubMenu(b1);
                        }
                        return true;
                    }
                    break label0;
