    ...
    implements SupportMenuItem
{
    ...
    MenuItemImpl(a a1, int i, int j, int k, int l, CharSequence charsequence, int i1)
    {
        mIconResId = 0;
        mFlags = 16;
        mShowAsAction = 0;
    ...
    public Drawable getIcon()
    {
        ...
        if (mIconResId != 0)
        {
            Drawable drawable = TintManager.getDrawable(mMenu.f(), mIconResId);
            mIconResId = 0;
...
_L2:
        return true;
        if (mClickListener != null && mClickListener.onMenuItemClick(this) || mMenu.a(mMenu.q(), this)) goto _L2; else goto _L1
_L1:
...
_L5:
    ...
    void setSubMenu(b b1)
    {
        mSubMenu = b1;
        b1.setHeaderTitle(getTitle());
    }
