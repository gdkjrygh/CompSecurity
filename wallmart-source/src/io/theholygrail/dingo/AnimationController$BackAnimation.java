...
private class <init>
{
    ...
    public boolean start(final ner listener)
    {
        JSLog.d(AnimationController.access$400(), "BackAnimation start()");
        boolean flag = false;
        ...
        if (bitmap != null)
        {
            ...
            ((ObjectAnimator) (obj)).addListener(new AnimatorListenerAdapter() {
                ...
                final AnimationController.BackAnimation this$1;
                ...
                public void onAnimationEnd(Animator animator)
                {
                    ...
                    AnimationController.access$1002(this$0, null);
                    if (listener != null)
                    {
            ...
            {
                this$1 = AnimationController.BackAnimation.this;
                imageView = imageview;
