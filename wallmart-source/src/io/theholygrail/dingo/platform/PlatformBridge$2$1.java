        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            while (i < j) 
            {
                ...
                {
                    dialog.setNegativeButton(action.label, action. new PlatformBridge._cls2._cls1());
                    flag1 = true;
                    flag2 = flag;
                } else
                {
                    ...
                    if (!TextUtils.isEmpty(action.id))
                    {
                        ...
                        if (flag)
                        {
                            dialog.setPositiveButton(action.label, onclicklistener);
                        } else
                        {
                            dialog.setNeutralButton(action.label, onclicklistener);
                            flag = true;
                        }
                        flag1 = true;
                        flag2 = flag;
