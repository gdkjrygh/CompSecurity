...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
    ...
    public static final class TabType extends Enum
    {

        private static final TabType $VALUES[];
        public static final TabType ICON_TAB;
        public static final TabType TEXT_TAB;

        public static TabType valueOf(String s)
        {
            return (TabType)Enum.valueOf(com/astuetz/PagerSlidingTabStrip$TabType, s);
        }
        ...
        static 
        {
            TEXT_TAB = new TabType("TEXT_TAB", 0);
            ICON_TAB = new TabType("ICON_TAB", 1);
            $VALUES = (new TabType[] {
                TEXT_TAB, ICON_TAB
            });
        }

        private TabType(String s, int i)
        {
            super(s, i);
        }
    }
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attributeset, int i)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, com.contextlogic.wish.R.styleable.PagerSlidingTabStrip);
    ...
    {
        if (tabCount != 0 && i < tabsContainer.getChildCount()) goto _L2; else goto _L1
_L1:
        return;
_L2:
...
_L3:
    ...
    public void notifyDataSetChanged()
    {
        ...
        while (i < tabCount) 
        {
            if ((pager.getAdapter() instanceof IconTabProvider) && tabTypes != null && tabTypes[i] == TabType.ICON_TAB)
            {
    ...
    public void setTabTypes(TabType atabtype[])
    {
        tabTypes = atabtype;
    }
