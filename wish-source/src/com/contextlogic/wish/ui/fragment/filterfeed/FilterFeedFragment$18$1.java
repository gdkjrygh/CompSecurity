    ...
    implements com.contextlogic.wish.api.service.ssCallback
{
    ...
    {
        trackEvent(com.contextlogic.wish.analytics.Product, com.contextlogic.wish.analytics.ess);
    }
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/filterfeed/FilterFeedFragment$18

/* anonymous class */
    class FilterFeedFragment._cls18
...
_L3:
        ...
        public void onProductsRemoved(ArrayList arraylist)
        {
            ...
            for (obj = arraylist.iterator(); ((Iterator) (obj)).hasNext(); (new HideProductService()).requestService(s, new FilterFeedFragment._cls18._cls1(), null))
            {
