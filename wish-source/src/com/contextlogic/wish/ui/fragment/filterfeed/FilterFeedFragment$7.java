    ...
    implements android.view.animation.stener
{
    ...
    public void onAnimationEnd(Animation animation)
    {
        ...
        updateSelectedFilters(FilterFeedFragment.access$800(FilterFeedFragment.this).getCurrentIndex(), FilterFeedFragment.access$800(FilterFeedFragment.this).getSelectedFilters());
