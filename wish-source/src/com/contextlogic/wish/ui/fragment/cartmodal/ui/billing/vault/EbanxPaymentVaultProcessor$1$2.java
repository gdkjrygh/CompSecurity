    ...
    implements com.contextlogic.wish.api.service.ailureCallback
{
    ...
    public void onServiceFailed(String s)
    {
        ...
        CommerceLogger.logError(com.contextlogic.wish.analytics.VE_TABBED_BILLING_INFO, com.contextlogic.wish.analytics., hashmap);
...
/* anonymous class */
        ...
        implements com.contextlogic.wish.api.service.EbanxTokenService.SuccessCallback
    {
        ...
        // Unreferenced inner class com/contextlogic/wish/ui/fragment/cartmodal/ui/billing/vault/EbanxPaymentVaultProcessor$1$1

/* anonymous class */
        class EbanxPaymentVaultProcessor._cls1._cls1
            implements com.contextlogic.wish.api.service.UpdateEbanxBillingInfoService.SuccessCallback
        {
