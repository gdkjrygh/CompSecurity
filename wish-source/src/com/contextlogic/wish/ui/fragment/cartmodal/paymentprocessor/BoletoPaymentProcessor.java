...
public class BoletoPaymentProcessor extends CartPaymentProcessor
{
    ...
    {
        super(cartmanager);
        initiateBoletoPaymentService = new InitiateBoletoPaymentService();
    }
    ...
    public void checkout(final CartPaymentProcessor.SuccessListener successListener, final CartPaymentProcessor.FailureListener failureListener)
    {
        ...
        initiateBoletoPaymentService.requestService(cartManager.getCurrencyCode(), cartManager.getCheckoutOfferId(), new com.contextlogic.wish.api.service.InitiateBoletoPaymentService.SuccessCallback() {
            ...
            {
                this$0 = BoletoPaymentProcessor.this;
                successListener = successlistener;
                paymentProcessor = cartpaymentprocessor;
                super();
            }
        }, new com.contextlogic.wish.api.service.InitiateBoletoPaymentService.FailureCallback() {
            ...
            {
                trackEvent(WishAnalyticsEvent.CLICK_MOBILE_NATIVE_BOLETO_PLACE_ORDER_FAILURE);
                Bundle bundle = new Bundle();
                String s1 = s;
                if (s == null)
                {
