...
public class EbanxCreditCardPaymentProcessor extends CartPaymentProcessor
{
    ...
    public EbanxCreditCardPaymentProcessor(CartManager cartmanager)
    {
        super(cartmanager);
        initiateEbanxPaymentService = new InitiateEbanxPaymentService();
    }
    ...
    public void checkout(final CartPaymentProcessor.SuccessListener successListener, final CartPaymentProcessor.FailureListener failureListener)
    {
        ...
        initiateEbanxPaymentService.requestService(cartManager.getCurrencyCode(), cartManager.getCheckoutOfferId(), null, null, new com.contextlogic.wish.api.service.InitiateEbanxPaymentService.SuccessCallback() {
            ...
            {
                this$0 = EbanxCreditCardPaymentProcessor.this;
                successListener = successlistener;
                paymentProcessor = cartpaymentprocessor;
                super();
            }
        }, new com.contextlogic.wish.api.service.InitiateEbanxPaymentService.FailureCallback() {
