...
//            CartAddToCartOfferAppliedModal

class this._cls0
    implements android.view.animation.CartOfferAppliedModal._cls1
{
    ...
    {
        CartAddToCartOfferAppliedModal.access$000(CartAddToCartOfferAppliedModal.this).setVisibility(0);
    }
