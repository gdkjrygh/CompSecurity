    ...
    implements Runnable
{
    ...
    public void run()
    {
        DealDashView.access$200(DealDashView.this).setVisibility(0);
        DealDashView.access$300(DealDashView.this).setVisibility(0);
        DealDashView.access$400(DealDashView.this).setVisibility(0);
        DealDashView.access$500(DealDashView.this).setVisibility(0);
