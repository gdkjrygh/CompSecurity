    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/profile/ProfileFragment$15

/* anonymous class */
    class ProfileFragment._cls15
        implements com.contextlogic.wish.api.service.GetProfileService.SuccessCallback
    {
        ...
        {
            postDelayed(wishuser. new ProfileFragment._cls15._cls1(), getAnimationTimeRemaining());
        }
