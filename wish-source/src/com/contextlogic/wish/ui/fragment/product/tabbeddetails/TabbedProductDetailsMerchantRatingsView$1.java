...
class this._cls0
    implements com.contextlogic.wish.api.service.MerchantRatingsView._cls1
{
    ...
    public void onServiceSucceeded(final WishRatingSummary summary, final ArrayList items, final int ratingsCount, final int nextOffset, final boolean noMoreRatings)
    {
        ...
        queuePagerSettledTask(new Runnable() {
            ...
            final TabbedProductDetailsMerchantRatingsView._cls1 this$1;
            ...
            {
                this$1 = TabbedProductDetailsMerchantRatingsView._cls1.this;
