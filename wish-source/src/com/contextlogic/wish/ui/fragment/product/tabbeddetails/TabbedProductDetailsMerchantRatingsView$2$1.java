    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/product/tabbeddetails/TabbedProductDetailsMerchantRatingsView$2

/* anonymous class */
    class TabbedProductDetailsMerchantRatingsView._cls2
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            updatingList = true;
            queuePagerSettledTask(new TabbedProductDetailsMerchantRatingsView._cls2._cls1());
        }
