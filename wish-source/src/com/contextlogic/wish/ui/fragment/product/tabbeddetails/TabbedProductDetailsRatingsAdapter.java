...
public class TabbedProductDetailsRatingsAdapter extends ArrayAdapter
{
    ...
    public TabbedProductDetailsRatingsAdapter(Context context, ArrayList arraylist, ListView listview)
    {
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (rating.getImageThumbnailUrlString() != null)
        {
            ...
            ((ItemRowHolder) (viewgroup)).ratingImage.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                final TabbedProductDetailsRatingsAdapter this$0;
            ...
            {
                this$0 = TabbedProductDetailsRatingsAdapter.this;
                rating = wishrating;
                super();
            }
            });
