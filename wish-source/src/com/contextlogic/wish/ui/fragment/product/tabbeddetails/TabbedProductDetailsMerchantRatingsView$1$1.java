    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/product/tabbeddetails/TabbedProductDetailsMerchantRatingsView$1

/* anonymous class */
    class TabbedProductDetailsMerchantRatingsView._cls1
        implements com.contextlogic.wish.api.service.GetMerchantRatingsService.SuccessCallback
    {
        ...
        {
            updatingList = true;
            queuePagerSettledTask(i. new TabbedProductDetailsMerchantRatingsView._cls1._cls1());
        }
