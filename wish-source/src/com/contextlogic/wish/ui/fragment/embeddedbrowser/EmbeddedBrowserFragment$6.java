    ...
    implements ValueCallback
{
    ...
    public void onReceiveValue(Uri uri)
    {
        ...
        try
        {
            uri = BitmapUtil.decodeBitmapFile(FileUtil.getPath(val$rootActivity, uri), 1024, 1024);
        }
        ...
        {
            EmbeddedBrowserFragment.access$900(EmbeddedBrowserFragment.this).requestService(uri, "ticket-image-uploads", new com.contextlogic.wish.api.service.UploadImageService.SuccessCallback() {
