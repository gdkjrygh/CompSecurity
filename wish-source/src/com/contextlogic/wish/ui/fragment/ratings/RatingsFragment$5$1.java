    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/ratings/RatingsFragment$5

/* anonymous class */
    class RatingsFragment._cls5
        implements com.contextlogic.wish.api.service.GetMerchantRatingsService.SuccessCallback
    {
        ...
        public void onServiceSucceeded(final WishRatingSummary summary, final ArrayList items, final int ratingsCount, int i, final boolean noMoreRatings)
        {
            ...
            postDelayed(i. new RatingsFragment._cls5._cls1(), getAnimationTimeRemaining());
        }
