    ...
    implements Runnable
{
    ...
    public void run()
    {
        RatingsFragment.access$600(_fld0);
        RatingsFragment.access$700(_fld0);
    }
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/ratings/RatingsFragment$6

/* anonymous class */
    class RatingsFragment._cls6
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        public void onServiceFailed()
        {
            ...
            postDelayed(new RatingsFragment._cls6._cls1(), getAnimationTimeRemaining());
        }
