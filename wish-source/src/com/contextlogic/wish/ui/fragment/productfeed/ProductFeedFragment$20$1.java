    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$20

/* anonymous class */
    class ProductFeedFragment._cls20
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            postDelayed(new ProductFeedFragment._cls20._cls1(), getAnimationTimeRemaining());
        }
