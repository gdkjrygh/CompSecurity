    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$22

/* anonymous class */
    class ProductFeedFragment._cls22
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            postDelayed(new ProductFeedFragment._cls22._cls1(), getAnimationTimeRemaining());
        }
