    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$28

/* anonymous class */
    class ProductFeedFragment._cls28
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            postDelayed(new ProductFeedFragment._cls28._cls1(), getAnimationTimeRemaining());
        }
