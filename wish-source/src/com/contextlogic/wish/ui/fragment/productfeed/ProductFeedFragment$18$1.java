    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$18

/* anonymous class */
    class ProductFeedFragment._cls18
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            postDelayed(new ProductFeedFragment._cls18._cls1(), getAnimationTimeRemaining());
        }
