    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$24

/* anonymous class */
    class ProductFeedFragment._cls24
        implements com.contextlogic.wish.api.service.ApiService.FailureCallback
    {
        ...
        {
            postDelayed(new ProductFeedFragment._cls24._cls1(), getAnimationTimeRemaining());
        }
