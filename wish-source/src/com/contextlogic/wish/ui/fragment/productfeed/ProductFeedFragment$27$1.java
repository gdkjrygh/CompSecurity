    ...
    implements Runnable
{
    ...
    public void run()
    {
        ProductFeedFragment.access$2200(_fld0, val$merchant);
    ...
    // Unreferenced inner class com/contextlogic/wish/ui/fragment/productfeed/ProductFeedFragment$27

/* anonymous class */
    class ProductFeedFragment._cls27
        implements com.contextlogic.wish.api.service.GetMerchantFeedService.SuccessCallback
    {
        ...
        {
            postDelayed(s. new ProductFeedFragment._cls27._cls1(), getAnimationTimeRemaining());
        }
