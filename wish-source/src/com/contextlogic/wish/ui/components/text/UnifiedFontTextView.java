...
public class UnifiedFontTextView extends TextView
{

    public UnifiedFontTextView(Context context)
    {
        super(context);
        init(null);
    }

    public UnifiedFontTextView(Context context, AttributeSet attributeset)
    {
        super(context, attributeset);
        init(attributeset);
    }

    public UnifiedFontTextView(Context context, AttributeSet attributeset, int i)
    {
    ...
    {
        Typeface typeface = TransientCache.getInstance().getTypefaceForStyle(getContext(), 1);
        if (typeface != null)
        {
