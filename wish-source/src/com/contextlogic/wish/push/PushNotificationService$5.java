    ...
    implements com.contextlogic.wish.api.service.
{
    ...
    {
        PushNotificationService.access$300(val$context, val$notification, val$notificationId, val$notificationIntent, val$alert, val$image, PushNotificationService.access$400(val$context, val$notificationIntent));
    }
