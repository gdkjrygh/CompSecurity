    ...
    implements com.contextlogic.wish.api.service.ack
{
    ...
    public void onServiceSucceeded(ArrayList arraylist, String s, boolean flag, WishFeedPromotionItem wishfeedpromotionitem, int i, int j, WishFeedEndedButtonSpec wishfeedendedbuttonspec, 
            String s1)
    {
        if (arraylist.size() > 0)
        {
    ...
    (Context context1, Notification notification1, int i, Intent intent, String s, Bitmap bitmap)
    {
