...
public class GetAppListService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().getAppList(new WishApiCallback() {

            final GetAppListService this$0;
...
_L6:
                return;
_L2:
                wishapirequest = wishapiresponse.getData().getJSONArray("apps");
...
_L4:
                ...
                wishapiresponse.add(new WishCrossPromoBanner(wishapirequest.getJSONObject(i)));
                i++;
...
/*
    static WishApiRequest access$002(GetAppListService getapplistservice, WishApiRequest wishapirequest)
    {
        getapplistservice.apiRequest = wishapirequest;
