...
public class InitiateOxxoPaymentService extends ApiService
{
    ...
    public InitiateOxxoPaymentService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().initiateOxxoPayment(s, s1, new WishApiCallback() {

            final InitiateOxxoPaymentService this$0;
            ...
            {
                this$0 = InitiateOxxoPaymentService.this;
...
/*
    static WishApiRequest access$002(InitiateOxxoPaymentService initiateoxxopaymentservice, WishApiRequest wishapirequest)
    {
        initiateoxxopaymentservice.apiRequest = wishapirequest;
