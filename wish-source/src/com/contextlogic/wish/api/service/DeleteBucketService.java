...
public class DeleteBucketService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().deleteBucket(s, new WishApiCallback() {
            ...
            {
                this$0 = DeleteBucketService.this;
...
/*
    static WishApiRequest access$002(DeleteBucketService deletebucketservice, WishApiRequest wishapirequest)
    {
        deletebucketservice.apiRequest = wishapirequest;
