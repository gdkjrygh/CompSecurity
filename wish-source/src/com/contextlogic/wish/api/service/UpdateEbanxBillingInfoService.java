...
public class UpdateEbanxBillingInfoService extends ApiService
{
    ...
    public UpdateEbanxBillingInfoService()
    {
    }
    ...
    public void requestService(String s, String s1, String s2, String s3, String s4, WishShippingInfo wishshippinginfo, final SuccessCallback successCallback, 
            final FailureCallback failureCallback)
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().updateEbanxBillingInfo(s, s1, s2, s3, s4, wishshippinginfo, new WishApiCallback() {

            final UpdateEbanxBillingInfoService this$0;
...
_L5:
            ...
            {
                this$0 = UpdateEbanxBillingInfoService.this;
...
/*
    static WishApiRequest access$002(UpdateEbanxBillingInfoService updateebanxbillinginfoservice, WishApiRequest wishapirequest)
    {
        updateebanxbillinginfoservice.apiRequest = wishapirequest;
