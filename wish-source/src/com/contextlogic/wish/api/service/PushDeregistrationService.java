...
public class PushDeregistrationService extends ApiService
{
    ...
    public PushDeregistrationService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().unregisterForPushNotifications(s, s1, new WishApiCallback() {
            ...
            {
                this$0 = PushDeregistrationService.this;
...
/*
    static WishApiRequest access$002(PushDeregistrationService pushderegistrationservice, WishApiRequest wishapirequest)
    {
        pushderegistrationservice.apiRequest = wishapirequest;
