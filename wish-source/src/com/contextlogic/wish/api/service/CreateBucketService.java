...
public class CreateBucketService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().createBucket(s, new WishApiCallback() {

            final CreateBucketService this$0;
            ...
            {
                this$0 = CreateBucketService.this;
...
/*
    static WishApiRequest access$002(CreateBucketService createbucketservice, WishApiRequest wishapirequest)
    {
        createbucketservice.apiRequest = wishapirequest;
