...
public class InitiateBoletoPaymentService extends ApiService
{
    ...
    public InitiateBoletoPaymentService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().initiateBoletoPayment(s, s1, new WishApiCallback() {

            final InitiateBoletoPaymentService this$0;
            ...
            {
                this$0 = InitiateBoletoPaymentService.this;
...
/*
    static WishApiRequest access$002(InitiateBoletoPaymentService initiateboletopaymentservice, WishApiRequest wishapirequest)
    {
        initiateboletopaymentservice.apiRequest = wishapirequest;
