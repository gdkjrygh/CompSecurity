...
public class UpdateBoletoBillingInfoService extends ApiService
{
    ...
    public UpdateBoletoBillingInfoService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().updateBoletoBillingInfo(s, s1, s2, new WishApiCallback() {

            final UpdateBoletoBillingInfoService this$0;
...
_L5:
            ...
            {
                this$0 = UpdateBoletoBillingInfoService.this;
...
/*
    static WishApiRequest access$002(UpdateBoletoBillingInfoService updateboletobillinginfoservice, WishApiRequest wishapirequest)
    {
        updateboletobillinginfoservice.apiRequest = wishapirequest;
