...
public class GetSignupCategoriesService extends ApiService
{
    ...
    public GetSignupCategoriesService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().getSignupFeedCategories(new WishApiCallback() {
...
_L5:
            ...
            {
                this$0 = GetSignupCategoriesService.this;
...
/*
    static WishApiRequest access$002(GetSignupCategoriesService getsignupcategoriesservice, WishApiRequest wishapirequest)
    {
        getsignupcategoriesservice.apiRequest = wishapirequest;
