...
public class UpdateStripeBillingInfoService extends ApiService
{
    ...
    public UpdateStripeBillingInfoService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().updateStripeBillingInfo(s, wishshippinginfo, new WishApiCallback() {

            final UpdateStripeBillingInfoService this$0;
...
_L5:
            ...
            {
                this$0 = UpdateStripeBillingInfoService.this;
...
/*
    static WishApiRequest access$002(UpdateStripeBillingInfoService updatestripebillinginfoservice, WishApiRequest wishapirequest)
    {
        updatestripebillinginfoservice.apiRequest = wishapirequest;
