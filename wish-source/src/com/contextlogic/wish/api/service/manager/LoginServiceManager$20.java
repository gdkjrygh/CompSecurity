    ...
    implements com.contextlogic.wish.api.service.ack
{
    ...
    public void onServiceFailed()
    {
        if (val$isNewUser)
        {
            Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.UserLoginStepFour, com.contextlogic.wish.analytics.Api, com.contextlogic.wish.analytics.lure);
        } else
        {
            Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.inStepFour, com.contextlogic.wish.analytics.Api, com.contextlogic.wish.analytics.lure);
        }
