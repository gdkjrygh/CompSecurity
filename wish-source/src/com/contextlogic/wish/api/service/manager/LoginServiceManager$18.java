    ...
    implements com.contextlogic.wish.api.service.ack
{
    ...
    public void onServiceFailed()
    {
        if (val$isNewUser)
        {
            Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.UserLoginStepThree, com.contextlogic.wish.analytics.Api, com.contextlogic.wish.analytics.lure);
        } else
        {
            Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.inStepThree, com.contextlogic.wish.analytics.Api, com.contextlogic.wish.analytics.lure);
        }
