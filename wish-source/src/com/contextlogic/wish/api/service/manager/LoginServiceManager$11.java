    ...
    implements com.contextlogic.wish.api.service.allback
{
    ...
    {
        Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.inStepOne, com.contextlogic.wish.analytics.Api, com.contextlogic.wish.analytics.lure);
        LoginServiceManager.access$100(LoginServiceManager.this, flag, false, s);
    }
