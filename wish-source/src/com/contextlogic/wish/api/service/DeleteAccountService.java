...
public class DeleteAccountService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().deleteAccount(new WishApiCallback() {

            final DeleteAccountService this$0;
            ...
            {
                this$0 = DeleteAccountService.this;
...
/*
    static WishApiRequest access$002(DeleteAccountService deleteaccountservice, WishApiRequest wishapirequest)
    {
        deleteaccountservice.apiRequest = wishapirequest;
