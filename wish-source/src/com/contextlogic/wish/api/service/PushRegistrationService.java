...
public class PushRegistrationService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().registerForPushNotifications(s, new WishApiCallback() {
            ...
            {
                this$0 = PushRegistrationService.this;
...
/*
    static WishApiRequest access$002(PushRegistrationService pushregistrationservice, WishApiRequest wishapirequest)
    {
        pushregistrationservice.apiRequest = wishapirequest;
