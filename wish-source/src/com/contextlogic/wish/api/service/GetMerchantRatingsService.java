...
public class GetMerchantRatingsService extends ApiService
{
    ...
    public GetMerchantRatingsService()
    {
    }
...
_L6:
            ...
            {
                this$0 = GetMerchantRatingsService.this;
                failureCallback = failurecallback;
                successCallback = successcallback;
                super();
            }
        };
        apiRequest = WishApi.getInstance().getMerchantRatings(s, i, j, successCallback);
    }


/*
    static WishApiRequest access$002(GetMerchantRatingsService getmerchantratingsservice, WishApiRequest wishapirequest)
    {
        getmerchantratingsservice.apiRequest = wishapirequest;
