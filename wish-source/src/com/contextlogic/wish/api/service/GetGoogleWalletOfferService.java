...
public class GetGoogleWalletOfferService extends ApiService
{
    ...
    public GetGoogleWalletOfferService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().getGoogleWalletOffer(new WishApiCallback() {
            ...
            {
                this$0 = GetGoogleWalletOfferService.this;
...
/*
    static WishApiRequest access$002(GetGoogleWalletOfferService getgooglewalletofferservice, WishApiRequest wishapirequest)
    {
        getgooglewalletofferservice.apiRequest = wishapirequest;
