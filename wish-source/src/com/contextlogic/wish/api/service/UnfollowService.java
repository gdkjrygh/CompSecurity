...
public class UnfollowService extends ApiService
{
    ...
    {
        successCallback = WishApi.getInstance().unfollowUser(userId, new WishApiCallback() {

            final UnfollowService this$0;
            ...
            public void onFailure(WishApiRequest wishapirequest, WishApiResponse wishapiresponse)
            {
                ...
                if (wishapiresponse != null && wishapiresponse.getCode() != 10 && wishapiresponse.getCode() != 11)
                {
                    ...
                    ApiDataChangeNotificationManager.getInstance().notifyListenersForUserUnfollow(userId);
                ...
                {
                    Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.Analytics.EventType.Unfollow, com.contextlogic.wish.analytics.Analytics.PageViewType.Api, com.contextlogic.wish.analytics.Analytics.LabelType.Failure);
            ...
            public void onSuccess(WishApiRequest wishapirequest, WishApiResponse wishapiresponse)
            {
                ...
                {
                    Analytics.getInstance().trackEvent(com.contextlogic.wish.analytics.Analytics.EventType.Unfollow, com.contextlogic.wish.analytics.Analytics.PageViewType.Api, com.contextlogic.wish.analytics.Analytics.LabelType.Success);
                    if (LoggedInUser.getInstance().isLoggedIn())
                    {
                        LoggedInUser.getInstance().getFollowingManager().setNotFollowing(userId);
                    }
