...
public class GetProfileProductsService extends ApiService
{
    ...
    public GetProfileProductsService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().getProductSet(s, i, j, new WishApiCallback() {
...
_L3:
                ...
                k = wishapiresponse.getData().getInt("offset");
...
_L5:
                successCallback.onServiceSucceeded(arraylist, flag, k, wishfeedendedbuttonspec, wishapirequest);
                return;
                wishapirequest;
                if (failureCallback != null)
                {
...
_L7:
            ...
            {
                this$0 = GetProfileProductsService.this;
...
/*
    static WishApiRequest access$002(GetProfileProductsService getprofileproductsservice, WishApiRequest wishapirequest)
    {
        getprofileproductsservice.apiRequest = wishapirequest;
