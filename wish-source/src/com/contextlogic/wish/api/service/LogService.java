...
public class LogService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().logImpression(s, s1, new WishApiCallback() {

            final LogService this$0;
...
/*
    static WishApiRequest access$002(LogService logservice, WishApiRequest wishapirequest)
    {
        logservice.apiRequest = wishapirequest;
