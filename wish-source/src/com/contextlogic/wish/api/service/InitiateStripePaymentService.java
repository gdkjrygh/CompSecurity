...
public class InitiateStripePaymentService extends ApiService
{
    ...
    public InitiateStripePaymentService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().initiateStripePayment(s, s1, s2, s3, new WishApiCallback() {
            ...
            {
                this$0 = InitiateStripePaymentService.this;
...
/*
    static WishApiRequest access$002(InitiateStripePaymentService initiatestripepaymentservice, WishApiRequest wishapirequest)
    {
        initiatestripepaymentservice.apiRequest = wishapirequest;
