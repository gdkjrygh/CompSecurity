...
public class PreAuthorizePayPalPaymentService extends ApiService
{
    ...
    public PreAuthorizePayPalPaymentService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().updatePayPalBraintreeBillingInfo(s, new WishApiCallback() {

            final PreAuthorizePayPalPaymentService this$0;
...
_L5:
            ...
            {
                this$0 = PreAuthorizePayPalPaymentService.this;
...
/*
    static WishApiRequest access$002(PreAuthorizePayPalPaymentService preauthorizepaypalpaymentservice, WishApiRequest wishapirequest)
    {
        preauthorizepaypalpaymentservice.apiRequest = wishapirequest;
