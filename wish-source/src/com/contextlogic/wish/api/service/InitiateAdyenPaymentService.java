...
public class InitiateAdyenPaymentService extends ApiService
{
    ...
    public InitiateAdyenPaymentService()
    {
    }
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().initiateAdyenPayment(s, s1, s2, s3, new WishApiCallback() {

            final InitiateAdyenPaymentService this$0;
            ...
            {
                this$0 = InitiateAdyenPaymentService.this;
...
/*
    static WishApiRequest access$002(InitiateAdyenPaymentService initiateadyenpaymentservice, WishApiRequest wishapirequest)
    {
        initiateadyenpaymentservice.apiRequest = wishapirequest;
