...
public class GetSignupFeedService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().getSignupFeed(new WishApiCallback() {
...
_L5:
            ...
            {
                this$0 = GetSignupFeedService.this;
...
/*
    static WishApiRequest access$002(GetSignupFeedService getsignupfeedservice, WishApiRequest wishapirequest)
    {
        getsignupfeedservice.apiRequest = wishapirequest;
