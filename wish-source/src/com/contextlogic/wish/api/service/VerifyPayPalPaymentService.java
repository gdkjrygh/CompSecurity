...
public class VerifyPayPalPaymentService extends ApiService
{
    ...
    public VerifyPayPalPaymentService()
    {
    }
    ...
    public void requestService(String s, String s1, String s2, String s3, final SuccessCallback successCallback, final FailureCallback failureCallback)
    {
        ...
        apiRequest = WishApi.getInstance().initiatePayPalBraintreePayment(s, s1, s2, s3, new WishApiCallback() {

            final VerifyPayPalPaymentService this$0;
            ...
            {
                this$0 = VerifyPayPalPaymentService.this;
...
/*
    static WishApiRequest access$002(VerifyPayPalPaymentService verifypaypalpaymentservice, WishApiRequest wishapirequest)
    {
        verifypaypalpaymentservice.apiRequest = wishapirequest;
