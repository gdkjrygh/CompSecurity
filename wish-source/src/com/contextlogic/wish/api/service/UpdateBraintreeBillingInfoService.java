...
public class UpdateBraintreeBillingInfoService extends ApiService
{
    ...
    public UpdateBraintreeBillingInfoService()
    {
    }
    ...
    public void requestService(String s, WishShippingInfo wishshippinginfo, final SuccessCallback successCallback, final FailureCallback failureCallback)
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().updateBraintreeBillingInfo(s, wishshippinginfo, new WishApiCallback() {

            final UpdateBraintreeBillingInfoService this$0;
...
_L5:
            ...
            {
                this$0 = UpdateBraintreeBillingInfoService.this;
...
/*
    static WishApiRequest access$002(UpdateBraintreeBillingInfoService updatebraintreebillinginfoservice, WishApiRequest wishapirequest)
    {
        updatebraintreebillinginfoservice.apiRequest = wishapirequest;
