...
public class DealDashFeedService extends ApiService
{
    ...
    {
        cancelAllRequests();
        apiRequest = WishApi.getInstance().startDealDash(new WishApiCallback() {

            final DealDashFeedService this$0;
            ...
            {
                this$0 = DealDashFeedService.this;
...
/*
    static WishApiRequest access$002(DealDashFeedService dealdashfeedservice, WishApiRequest wishapirequest)
    {
        dealdashfeedservice.apiRequest = wishapirequest;
