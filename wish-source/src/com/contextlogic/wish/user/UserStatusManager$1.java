    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        obj3 = null;
        obj4 = null;
        Object obj = WishApplication.getAppInstance().openFileOutput("serialized_status", 0);
        obj1 = obj;
        obj2 = obj;
        ObjectOutputStream objectoutputstream = new ObjectOutputStream(((java.io.OutputStream) (obj)));
        objectoutputstream.writeObject(val$statusObject.toString());
...
_L3:
    ...
    ()
    {
        this$0 = final_userstatusmanager;
        val$statusObject = JSONObject.this;
        super();
    }
}
