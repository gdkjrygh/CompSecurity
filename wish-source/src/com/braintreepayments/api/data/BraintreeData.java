...
public final class BraintreeData
{
    ...
    public BraintreeData(Activity activity, String s, String s1)
    {
        ...
        mDeviceCollector.setCollectorUrl(s1);
    }
    ...
    private String getCorrelationId(Activity activity)
    {
        try
        {
            activity = (String)getClass().getClassLoader().loadClass("com.paypal.android.sdk.onetouch.core.PayPalOneTouchCore").getMethod("getClientMetadataId", new Class[] {
