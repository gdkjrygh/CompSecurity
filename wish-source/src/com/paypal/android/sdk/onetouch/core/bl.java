...
public final class bl
{
    ...
    public bl()
    {
        ...
        c.addRequestInterceptor(new bm(this));
        c.addResponseInterceptor(new bn(this));
        c.setHttpRequestRetryHandler(new bu(5));
    ...
    private void a(DefaultHttpClient defaulthttpclient, HttpContext httpcontext, HttpUriRequest httpurirequest, String s, bq bq, Context context)
    {
        if (s != null)
        {
            httpurirequest.addHeader("Content-Type", s);
        }
        httpurirequest = e.submit(new bp(defaulthttpclient, httpcontext, httpurirequest, bq));
        if (context != null)
        {
    ...
    public final void a(Context context, String s, Header aheader[], bq bq)
    {
        s = new HttpDelete(s);
        if (aheader != null)
        {
        ...
        a(c, d, ((HttpUriRequest) (s)), ((String) (null)), bq, context);
    }

    public final void a(Context context, String s, Header aheader[], bt bt, bq bq)
    {
        if (false)
        {
    ...
    public final void a(Context context, String s, Header aheader[], HttpEntity httpentity, String s1, bq bq)
    {
        s = new HttpPost(s);
        if (httpentity != null)
        {
