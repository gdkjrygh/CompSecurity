...
public class ay extends ck
{
    ...
    public ay(cj cj, cm cm1, c c1, az az1)
    {
        super(cj, cm1, c1, null);
        a = az1;
    ...
    {
        Object obj = com.paypal.android.sdk.onetouch.core.c.a(q().b().d());
        String s = a.a;
    ...
    static 
    {
        com/paypal/android/sdk/onetouch/core/ay.getSimpleName();
    }
}
