    ...
    implements Serializable
{
    ...
    public Session(Context context, String s, TokenCachingStrategy tokencachingstrategy)
    {
...
_L3:
    ...
    static PermissionsPair handlePermissionResponse(Response response)
    {
        ...
        {
            if ((response = (GraphMultiResult)response.getGraphObjectAs(com/facebook/model/GraphMultiResult)) != null && ((obj = response.getData()) != null && ((GraphObjectList) (obj)).size() != 0))
            {
...
_L4:
        ...
        if (obj != null)
        {
            bundle.putString("6_extras", ((JSONObject) (obj)).toString());
            code = bundle;
        }
