...
public class LoginActivity extends Activity
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        authorizationClient.setBackgroundProcessingListener(new AuthorizationClient.BackgroundProcessingListener() {
            ...
            {
                findViewById(com.facebook.android.R.id.com_facebook_login_activity_progress_bar_container).setVisibility(0);
            }

            public void onBackgroundProcessingStopped()
            {
                findViewById(com.facebook.android.R.id.com_facebook_login_activity_progress_bar_container).setVisibility(8);
            }
