    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(CommonWalletObject commonwalletobject, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, commonwalletobject.zzaII, false);
        zzb.zza(parcel, 4, commonwalletobject.name, false);
        zzb.zza(parcel, 5, commonwalletobject.zzaIC, false);
        zzb.zza(parcel, 6, commonwalletobject.zzaIE, false);
        zzb.zza(parcel, 7, commonwalletobject.zzaIF, false);
        zzb.zza(parcel, 8, commonwalletobject.zzaIG, false);
        zzb.zza(parcel, 9, commonwalletobject.zzaIH, false);
        zzb.zzc(parcel, 10, commonwalletobject.state);
        zzb.zzc(parcel, 11, commonwalletobject.zzaIJ, false);
        zzb.zza(parcel, 12, commonwalletobject.zzaIK, i, false);
        zzb.zzc(parcel, 13, commonwalletobject.zzaIL, false);
        zzb.zza(parcel, 14, commonwalletobject.zzaIM, false);
        zzb.zza(parcel, 15, commonwalletobject.zzaIN, false);
        zzb.zza(parcel, 17, commonwalletobject.zzaIP);
        zzb.zzc(parcel, 16, commonwalletobject.zzaIO, false);
        zzb.zzc(parcel, 19, commonwalletobject.zzaIR, false);
        zzb.zzc(parcel, 18, commonwalletobject.zzaIQ, false);
        zzb.zzc(parcel, 20, commonwalletobject.zzaIS, false);
        zzb.zzH(parcel, j);
    }
    ...
    public CommonWalletObject[] zzip(int i)
    {
