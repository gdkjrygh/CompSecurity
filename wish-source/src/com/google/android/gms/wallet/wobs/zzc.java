    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(LabelValueRow labelvaluerow, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, labelvaluerow.zzaKq, false);
        zzb.zza(parcel, 3, labelvaluerow.zzaKr, false);
        zzb.zzc(parcel, 4, labelvaluerow.zzaKs, false);
        zzb.zzH(parcel, i);
    }
    ...
    public LabelValueRow[] zzir(int i)
    {
