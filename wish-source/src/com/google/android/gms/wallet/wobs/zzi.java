    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(WalletObjectMessage walletobjectmessage, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, walletobjectmessage.zzaKC, false);
        zzb.zza(parcel, 3, walletobjectmessage.zzzr, false);
        zzb.zza(parcel, 4, walletobjectmessage.zzaKF, i, false);
        zzb.zza(parcel, 5, walletobjectmessage.zzaKG, i, false);
        zzb.zza(parcel, 6, walletobjectmessage.zzaKH, i, false);
        zzb.zzH(parcel, j);
    }
    ...
    public WalletObjectMessage[] zzix(int i)
    {
