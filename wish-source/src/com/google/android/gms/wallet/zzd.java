    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(CreateWalletObjectsRequest createwalletobjectsrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, createwalletobjectsrequest.zzaHW, i, false);
        zzb.zza(parcel, 3, createwalletobjectsrequest.zzaHX, i, false);
        zzb.zza(parcel, 4, createwalletobjectsrequest.zzaHY, i, false);
        zzb.zzH(parcel, j);
    }
    ...
    public CreateWalletObjectsRequest zzfl(Parcel parcel)
    {
...
_L4:
    ...
    public CreateWalletObjectsRequest[] zzhQ(int i)
    {
