    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(MaskedWalletRequest maskedwalletrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, maskedwalletrequest.zzaIY);
        zzb.zza(parcel, 4, maskedwalletrequest.zzaIZ);
        zzb.zza(parcel, 5, maskedwalletrequest.zzaJa);
        zzb.zza(parcel, 6, maskedwalletrequest.zzaJb, false);
        zzb.zza(parcel, 7, maskedwalletrequest.zzaHT, false);
        zzb.zza(parcel, 8, maskedwalletrequest.zzaJc, false);
        zzb.zza(parcel, 9, maskedwalletrequest.zzaIk, i, false);
        zzb.zza(parcel, 10, maskedwalletrequest.zzaJd);
        zzb.zza(parcel, 11, maskedwalletrequest.zzaJe);
        zzb.zza(parcel, 12, maskedwalletrequest.zzaJf, i, false);
        zzb.zza(parcel, 13, maskedwalletrequest.zzaJg);
        zzb.zza(parcel, 14, maskedwalletrequest.zzaJh);
        zzb.zzc(parcel, 15, maskedwalletrequest.zzaJi, false);
        zzb.zza(parcel, 16, maskedwalletrequest.zzaJj, i, false);
        zzb.zzH(parcel, j);
    }
