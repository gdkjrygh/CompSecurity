    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(FastJsonResponse.Field field, Parcel parcel, int i)
    {
        ...
        zzb.zzc(parcel, 2, field.zzmv());
        zzb.zza(parcel, 3, field.zzmB());
        zzb.zzc(parcel, 4, field.zzmw());
        zzb.zza(parcel, 5, field.zzmC());
        zzb.zza(parcel, 6, field.zzmD(), false);
        zzb.zzc(parcel, 7, field.zzmE());
        zzb.zza(parcel, 8, field.zzmG(), false);
        zzb.zza(parcel, 9, field.zzmI(), i, false);
        zzb.zzH(parcel, j);
    }
