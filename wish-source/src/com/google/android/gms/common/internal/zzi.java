...
_L3:
    ...
    protected zzi(Context context, Looper looper, int i, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
    {
        ...
        zzQg = (new com.google.android.gms.common.api.GoogleApiClient.Builder(context)).zzkJ();
...
label0:
    ...
    private void zzlR()
    {
        if (zzTu != null)
        {
            ...
            zzTo.zzb(zzeq(), zzTu, zzlQ());
        }
        zzTu = new zze();
        if (!zzTo.zza(zzeq(), zzTu, zzlQ()))
        {
...
_L5:
    ...
    public void zza(zzo zzo, Set set)
    {
        ...
        if (!zzjL()) goto _L2; else goto _L1
_L1:
        ((GetServiceRequest) (obj)).zzb(zzlD()).zzc(zzo);
_L4:
...
_L3:
    ...
    protected final com.google.android.gms.common.internal.zze zzlT()
    {
        return zzQg;
    }
