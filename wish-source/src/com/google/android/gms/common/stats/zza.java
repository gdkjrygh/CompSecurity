    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(ConnectionEvent connectionevent, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, connectionevent.zzmR(), false);
        zzb.zza(parcel, 4, connectionevent.zzmS(), false);
        zzb.zza(parcel, 5, connectionevent.zzmT(), false);
        zzb.zza(parcel, 6, connectionevent.zzmU(), false);
        zzb.zza(parcel, 7, connectionevent.zzmV(), false);
        zzb.zza(parcel, 8, connectionevent.zzmW(), false);
        zzb.zza(parcel, 9, connectionevent.zzmX());
        zzb.zza(parcel, 10, connectionevent.zzmZ());
        zzb.zza(parcel, 11, connectionevent.zzmY());
        zzb.zzH(parcel, i);
    }
