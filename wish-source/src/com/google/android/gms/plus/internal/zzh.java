    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(PlusSession plussession, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, plussession.zzvA(), false);
        zzb.zza(parcel, 3, plussession.zzvB(), false);
        zzb.zza(parcel, 4, plussession.zzvC(), false);
        zzb.zza(parcel, 5, plussession.zzvD(), false);
        zzb.zza(parcel, 6, plussession.zzvE(), false);
        zzb.zza(parcel, 7, plussession.zzvF(), false);
        zzb.zza(parcel, 8, plussession.zzvG(), false);
        zzb.zza(parcel, 9, plussession.zzvH(), i, false);
        zzb.zzH(parcel, j);
    }
