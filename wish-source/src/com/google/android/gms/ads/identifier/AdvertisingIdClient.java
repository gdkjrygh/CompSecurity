...
public class AdvertisingIdClient
{
        ...
        throws IOException
    {
        try
        {
            context = com.google.android.gms.internal.zzs.zza.zzb(zza1.zzkt());
        }
        ...
        throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException
    {
        ...
        if (com.google.android.gms.common.stats.zzb.zzna().zza(context, intent, zza1, 1))
        {
            return zza1;
        } else
        {
    ...
    public void finish()
    {
        ...
        if (zzmh)
        {
            com.google.android.gms.common.stats.zzb.zzna().zza(mContext, zzmf);
        }
_L1:
        zzmh = false;
        zzmg = null;
