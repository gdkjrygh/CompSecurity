...
public class zzd extends zzg
{
    ...
    private zzn zzb(Context context, AdSizeParcel adsizeparcel, String s, zzcq zzcq)
    {
        try
        {
            ...
            context = com.google.android.gms.ads.internal.client.zzn.zza.zzg(((zzo)zzX(context)).zza(zzd1, adsizeparcel, s, zzcq, 0x6fd4e8));
        }
...
label0:
        {
            ...
            obj = new com.google.android.gms.ads.internal.zza(context, adsizeparcel, s, zzcq, new VersionInfoParcel(0x6fd4e8, 0x6fd4e8, true));
        }
        return ((zzn) (obj));
    }
