    ...
    implements zzkm
{
    ...
    public static Map zzc(zzkg zzkg1)
    {
        ...
        if (obj != null)
        {
            zza(hashmap, "cd", ((zzkv) (obj)).zzuJ());
            zza(hashmap, "a", ((zzkv) (obj)).zzaJ());
            zza(hashmap, "dr", ((zzkv) (obj)).zzuM());
        }
        obj = (zzkt)zzkg1.zzd(com/google/android/gms/internal/zzkt);
        if (obj != null)
        {
            zza(hashmap, "ec", ((zzkt) (obj)).zzuG());
        ...
        if (obj != null)
        {
            ...
            zza(hashmap, "cm", ((zzkq) (obj)).zzur());
            zza(hashmap, "ck", ((zzkq) (obj)).zzus());
            zza(hashmap, "cc", ((zzkq) (obj)).getContent());
            zza(hashmap, "ci", ((zzkq) (obj)).getId());
            zza(hashmap, "anid", ((zzkq) (obj)).zzut());
            zza(hashmap, "gclid", ((zzkq) (obj)).zzuu());
            zza(hashmap, "dclid", ((zzkq) (obj)).zzuv());
            zza(hashmap, "aclid", ((zzkq) (obj)).zzuw());
        }
        obj = (zzku)zzkg1.zzd(com/google/android/gms/internal/zzku);
        if (obj != null)
        {
            zza(hashmap, "exd", ((zzku) (obj)).getDescription());
            zza(hashmap, "exf", ((zzku) (obj)).zzuH());
        }
        obj = (zzkw)zzkg1.zzd(com/google/android/gms/internal/zzkw);
        if (obj != null)
        {
            zza(hashmap, "sn", ((zzkw) (obj)).zzuQ());
        ...
        if (obj != null)
        {
            zza(hashmap, "utv", ((zzkx) (obj)).zzuR());
            zza(hashmap, "utt", ((zzkx) (obj)).getTimeInMillis());
            zza(hashmap, "utc", ((zzkx) (obj)).zzuG());
        ...
        if (obj != null)
        {
            ...
            obj = ((zzks) (obj)).zzuE().entrySet().iterator();
        ...
        if (obj != null)
        {
            ...
            zza(hashmap, "sd", ((zzkr) (obj)).zzux());
            zza(hashmap, "sr", ((zzkr) (obj)).zzuy(), ((zzkr) (obj)).zzuz());
            zza(hashmap, "vp", ((zzkr) (obj)).zzuA(), ((zzkr) (obj)).zzuB());
        }
        zzkg1 = (zzkp)zzkg1.zzd(com/google/android/gms/internal/zzkp);
        if (zzkg1 != null)
        {
            zza(hashmap, "an", zzkg1.zziD());
            zza(hashmap, "aid", zzkg1.zzqS());
            zza(hashmap, "aiid", zzkg1.zzuq());
            zza(hashmap, "av", zzkg1.zziF());
        }
        return hashmap;
    }
    ...
    {
        zzv.zzr(zzkg1);
        zzv.zzb(zzkg1.zzuc(), "Can't deliver not submitted measurement");
        zzv.zzbJ("deliver should be called on worker thread");
        Object obj1 = zzkg1.zztX();
        ...
        } else
        {
            ...
            if (!zzEb.zzgV().getAppOptOut())
            {
                ...
                if (obj2 != null)
                {
                    zzal.zzb(hashmap, "an", ((zzkp) (obj2)).zziD());
                    zzal.zzb(hashmap, "aid", ((zzkp) (obj2)).zzqS());
                    zzal.zzb(hashmap, "av", ((zzkp) (obj2)).zziF());
                    zzal.zzb(hashmap, "aiid", ((zzkp) (obj2)).zzuq());
                }
                ...
                zzkg1 = new zzaa(zzgH(), ((Map) (obj1)), zzkg1.zzua(), true);
                zzfZ().zza(zzkg1);
                return;
            }
        }
