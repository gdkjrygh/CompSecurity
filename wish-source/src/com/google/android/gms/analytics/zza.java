...
public class zza extends zzkj
{
    ...
    protected void zza(zzkg zzkg1)
    {
        ...
        {
            zzkg1.setClientId(zzEb.zzgY().zzhH());
        }
    ...
    public void zzat(String s)
    {
        zzv.zzbS(s);
        zzau(s);
        zzuj().add(new zzb(zzEb, s));
    }

    public void zzau(String s)
    {
        s = zzb.zzav(s);
        ListIterator listiterator = zzuj().listIterator();
        do
        {
    ...
    public zzkg zzfP()
    {
        zzkg zzkg1 = zzui().zztX();
        zzkg1.zzb(zzEb.zzgO().zzhp());
        zzkg1.zzb(zzEb.zzgP().zziw());
        zzd(zzkg1);
        return zzkg1;
    }
}
