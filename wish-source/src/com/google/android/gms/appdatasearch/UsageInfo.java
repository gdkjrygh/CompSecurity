    ...
    implements SafeParcelable
{
    ...
    {
        return new DocumentSection(s, (new RegisterSectionInfo.zza("title")).zzaa(1).zzK(true).zzbe("name").zzjF(), "text1");
    }
    ...
    {
        return new DocumentSection(uri.toString(), (new RegisterSectionInfo.zza("web_url")).zzaa(4).zzJ(true).zzbe("url").zzjF());
    }
    ...
    private static DocumentSection zzi(List list)
    {
        ...
        zza1.zzaoY = azza;
        return new DocumentSection(zzny.zzf(zza1), (new RegisterSectionInfo.zza("outlinks")).zzJ(true).zzbe(".private:outLinks").zzbd("blob").zzjF());
    }
    ...
    {
        return new DocumentSection(s1, (new RegisterSectionInfo.zza(s)).zzJ(true).zzjF(), s);
    }
