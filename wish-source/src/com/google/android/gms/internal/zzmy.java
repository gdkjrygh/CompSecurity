...
public abstract class zzmy
{
    ...
    public void zza(zza zza1)
    {
        ...
        zza1 = (zzmj)zzaHH.zzyj().get(0);
        zzb zzb1 = zza(((zzmj) (zza1)));
        if (zzb1 != null && (zzb1.zzyL() instanceof zzmq.zzc))
        {
            zza1 = new zzmp.zza(Status.zzQU, zza1, null, (zzmq.zzc)zzb1.zzyL(), zzb1.zzyl(), zzb1.zzyp());
        } else
        {
