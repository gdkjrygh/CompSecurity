...
public class zzgu
{
    ...
    {
        s = (new com.google.android.gms.appdatasearch.RegisterSectionInfo.zza(s)).zzJ(true).zzbe(s).zzbd("blob").zzjF();
    ...
    public static UsageInfo zza(Action action, long l, String s, int i)
    {
        ...
        return (new com.google.android.gms.appdatasearch.UsageInfo.zza()).zza(UsageInfo.zza(s, ((android.content.Intent) (obj)))).zzu(l).zzac(byte0).zza(action.zzjC()).zzL(flag).zzad(i).zzjG();
    }
