    ...
    public void onActivitySaveInstanceState(Activity activity, Bundle bundle)
    {
        if (bundle != null)
        {
            if ((activity = (zzkv)zzawZ.get(activity)) != null)
            {
                ...
                bundle1.putString("name", activity.zzuJ());
                bundle1.putInt("referrer_id", activity.zzuK());
                bundle1.putString("referrer_name", activity.zzuL());
                bundle1.putBoolean("interstitial", activity.zzuO());
