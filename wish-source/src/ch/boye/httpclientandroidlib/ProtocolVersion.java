    ...
    implements Serializable, Cloneable
{
    ...
    public int compareToVersion(ProtocolVersion protocolversion)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Versions for different protocols cannot be compared. ").append(this).append(" ").append(protocolversion).toString());
        }
