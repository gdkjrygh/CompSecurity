...
.method public final synthetic a(Lb/a/gn;Lb/a/fm;)V
    ...
    check-cast p2, Lb/a/bi;

    invoke-virtual {p2}, Lb/a/bi;->g()V

    invoke-static {}, Lb/a/bi;->h()Lb/a/gs;

    invoke-virtual {p1}, Lb/a/gn;->a()V

    iget-object v0, p2, Lb/a/bi;->a:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-static {}, Lb/a/bi;->i()Lb/a/gk;
    ...
    :cond_0
    iget-object v0, p2, Lb/a/bi;->b:Ljava/lang/String;

    if-eqz v0, :cond_1

    invoke-virtual {p2}, Lb/a/bi;->b()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lb/a/bi;->j()Lb/a/gk;
    ...
    :cond_1
    iget-object v0, p2, Lb/a/bi;->c:Ljava/lang/String;

    if-eqz v0, :cond_2

    invoke-static {}, Lb/a/bi;->k()Lb/a/gk;
    ...
    :cond_2
    invoke-static {}, Lb/a/bi;->l()Lb/a/gk;

    move-result-object v0

    invoke-virtual {p1, v0}, Lb/a/gn;->a(Lb/a/gk;)V

    iget-wide v0, p2, Lb/a/bi;->d:J
...
.method public final synthetic b(Lb/a/gn;Lb/a/fm;)V
    ...
    iput-object v0, p2, Lb/a/bi;->a:Ljava/lang/String;

    invoke-static {}, Lb/a/bi;->a()V
    ...
    iput-object v0, p2, Lb/a/bi;->b:Ljava/lang/String;

    invoke-static {}, Lb/a/bi;->c()V
    ...
    iput-object v0, p2, Lb/a/bi;->c:Ljava/lang/String;

    invoke-static {}, Lb/a/bi;->d()V
    ...
    iput-wide v0, p2, Lb/a/bi;->d:J

    invoke-virtual {p2}, Lb/a/bi;->f()V
