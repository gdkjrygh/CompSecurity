...
_L3:
    ...
    public void dump(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        ...
        if (m != null)
        {
            ...
            printwriter.println(":");
            m.a((new StringBuilder()).append(s).append("  ").toString(), printwriter);
        }
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        if (context == null)
        {
            ...
            s.p = true;
            s.s = b;
            context = ((Fragment) (s)).d;
            s.h();
            b.a(s, true);
        } else
        {
            if (((Fragment) (context)).p)
            {
            ...
            context.p = true;
            if (!((Fragment) (context)).C)
            {
                s = ((Fragment) (context)).d;
                context.h();
            }
            b.a(context);
            s = context;
        }
        if (((Fragment) (s)).I == null)
        {
            throw new IllegalStateException((new StringBuilder("Fragment ")).append(s1).append(" did not create a view.").toString());
        }
        if (j1 != 0)
        {
            ((Fragment) (s)).I.setId(j1);
        }
        if (((Fragment) (s)).I.getTag() == null)
        {
            ((Fragment) (s)).I.setTag(s2);
        }
        return ((Fragment) (s)).I;
    }
