...
public final class aj
{
    ...
    private aj(Context context, ViewGroup viewgroup, am am1)
    {
        c = -1;
        if (viewgroup == null)
        {
        ...
        } else
        {
            ...
            q = android.support.v4.widget.m.a(context, v);
            return;
        }
    }
    ...
    public static aj a(ViewGroup viewgroup, float f1, am am1)
    {
        viewgroup = new aj(viewgroup.getContext(), viewgroup, am1);
        viewgroup.b = (int)((float)((aj) (viewgroup)).b * (1.0F / f1));
        return viewgroup;
    }
    ...
    {
        int j1 = android.support.v4.view.w.c(motionevent);
        for (int i1 = 0; i1 < j1; i1++)
        {
            int k1 = android.support.v4.view.w.b(motionevent, i1);
            float f1 = android.support.v4.view.w.c(motionevent, i1);
            float f2 = android.support.v4.view.w.d(motionevent, i1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void i()
    {
        ...
        float f1 = a(android.support.v4.view.aj.a(l, c), n, m);
        a(android.support.v4.view.aj.b(l, c), n, m);
        b(f1);
    }
    ...
    public final boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)android.support.v4.view.aj.a(l, c), (int)android.support.v4.view.aj.b(l, c));
        }
    }
...
_L2:
        f1 = motionevent.getX();
        f4 = motionevent.getY();
        i1 = android.support.v4.view.w.b(motionevent, 0);
        a(f1, f4, i1);
...
_L5:
        ...
        float f5 = android.support.v4.view.w.d(motionevent, i1);
        a(f2, f5, k1);
        if (a == 0)
        {
            if ((h[k1] & p) != 0)
        ...
        if (a == 2)
        {
          ...
          goto _L7
_L4:
        int l1 = android.support.v4.view.w.c(motionevent);
        i1 = 0;
        do
        {
            if (i1 >= l1)
            ...
            int i2 = android.support.v4.view.w.b(motionevent, i1);
            float f3 = android.support.v4.view.w.c(motionevent, i1);
            float f6 = android.support.v4.view.w.d(motionevent, i1);
            float f7 = f3 - d[i2];
            b(f7, f6 - e[i2], i2);
            if (a == 1)
            {
            ...
            if (view != null && a(view, f7) && b(view, i2))
            {
                break;
            }
            i1++;
        ...
        c(motionevent);
          goto _L7
_L6:
        c(android.support.v4.view.w.b(motionevent, i1));
          goto _L7
        e();
          goto _L7
    }
    ...
    public final void b(MotionEvent motionevent)
    {
        ...
        i1 = 0;
        j1 = 0;
        l1 = android.support.v4.view.w.a(motionevent);
...
_L6:
        float f2;
        float f4;
        i1 = android.support.v4.view.w.b(motionevent, k1);
        f2 = android.support.v4.view.w.c(motionevent, k1);
        f4 = android.support.v4.view.w.d(motionevent, k1);
        a(f2, f4, i1);
        if (a != 0)
        {
            break; /* Loop/switch isn't completed */
...
_L4:
        if (a == 1)
        {
            i1 = android.support.v4.view.w.a(motionevent, c);
            f2 = android.support.v4.view.w.c(motionevent, i1);
            f4 = android.support.v4.view.w.d(motionevent, i1);
            k1 = (int)(f2 - f[c]);
            l1 = (int)(f4 - g[c]);
            j1 = s.getLeft() + k1;
            s.getTop();
        ...
        k1 = android.support.v4.view.w.c(motionevent);
        i1 = j1;
        do
        {
            if (i1 >= k1)
            ...
            j1 = android.support.v4.view.w.b(motionevent, i1);
            f2 = android.support.v4.view.w.c(motionevent, i1);
            f4 = android.support.v4.view.w.d(motionevent, i1);
            float f5 = f2 - d[j1];
            b(f5, f4 - e[j1], j1);
        ...
        return;
_L7:
        j1 = android.support.v4.view.w.b(motionevent, k1);
...
_L11:
        l1 = android.support.v4.view.w.b(motionevent, i1);
