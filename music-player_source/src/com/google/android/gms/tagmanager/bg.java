    ...
    implements g
{
    ...
    {
        this(context, ih.b(), "google_tagmanager.db", ((Executor) (Executors.newSingleThreadExecutor())));
    }

    private bg(Context context, ig ig1, String s, Executor executor)
    {
        c = context;
        e = ig1;
        f = 2000;
...
_L7:
    ...
    private List a(int i)
    {
        ...
        if (i <= 0)
        {
            t.b("Invalid maxEntries specified. Skipping.");
            return arraylist;
        }
...
_L6:
        obj = obj1;
        t.b((new StringBuilder("Error in peekEntries fetching entryIds: ")).append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
...
_L4:
    ...
    private void a(long l)
    {
        ...
        try
        {
            ...
            t.d((new StringBuilder("Deleted ")).append(i).append(" expired items").toString());
            return;
        }
        catch (SQLiteException sqliteexception)
        {
            t.b("Error deleting old entries.");
        }
    }

    static void a(bg bg1, List list, long l)
    {
        bg1.b(list, l);
    }
...
_L5:
    ...
    private List b()
    {
        ...
        obj = new ArrayList();
        bk bk1;
        for (obj1 = ((List) (obj1)).iterator(); ((Iterator) (obj1)).hasNext(); ((List) (obj)).add(new e(bk1.a, a(bk1.b))))
        {
            bk1 = (bk)((Iterator) (obj1)).next();
        }
...
_L1:
        String as[];
        List list1 = a(i);
        t.c((new StringBuilder("DataLayer store full, deleting ")).append(list1.size()).append(" entries to make room.").toString());
...
_L5:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        t.b((new StringBuilder("Error deleting entries ")).append(Arrays.toString(as)).toString());
          goto _L2
        list;
        e();
        throw list;
    ...
    private List c()
    {
        ...
        {
            ((List) (obj)).add(new bk(((Cursor) (obj1)).getString(0), ((Cursor) (obj1)).getBlob(1)));
        }
    ...
    private void c(List list, long l)
    {
        ...
        if (sqlitedatabase != null)
        {
            ...
            while (list.hasNext()) 
            {
                ...
                contentvalues.put("key", bk1.a);
                contentvalues.put("value", bk1.b);
...
_L3:
        obj;
        obj = cursor;
        t.b("Error getting numStoredEntries");
...
_L4:
    ...
    public final void a(List list, long l)
    {
        ...
        e e1;
        for (list = list.iterator(); list.hasNext(); arraylist.add(new bk(e1.a, a(e1.b))))
        {
            e1 = (e)list.next();
        }

        b.execute(new bh(this, arraylist, l));
    }
