...
public final class et extends Button
{
    ...
    public final void a(Resources resources, int i, int j)
    {
        ...
        gt.a(flag, (new StringBuilder("Unknown button size ")).append(i).toString());
        if (j >= 0 && j < 2)
        {
            flag = flag1;
        } else
        ...
        gt.a(flag, (new StringBuilder("Unknown color scheme ")).append(j).toString());
...
_L4:
        ...
        case 0: // '\0'
            setText(resources.getString(d.b));
            return;
