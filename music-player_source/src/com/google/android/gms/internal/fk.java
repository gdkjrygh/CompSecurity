    ...
    implements android.graphics.drawable.Drawable.Callback
{
    ...
    public fk(Drawable drawable, Drawable drawable1)
    {
        this(null);
        Object obj = drawable;
        if (drawable == null)
        ...
        drawable = j;
        drawable.b = ((fn) (drawable)).b | ((Drawable) (obj)).getChangingConfigurations();
        drawable = drawable1;
        if (drawable1 == null)
        {
            drawable = fl.a();
        ...
        drawable1 = j;
        drawable1.b = ((fn) (drawable1)).b | drawable.getChangingConfigurations();
    }
