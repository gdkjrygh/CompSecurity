...
public final class kw
{
    ...
    public static String a(kv kv1)
    {
        ...
        try
        {
            a(null, kv1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (kv kv1)
        {
            return (new StringBuilder("Error printing proto: ")).append(kv1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (kv kv1)
        {
...
_L1:
        if (!(obj instanceof kv)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
