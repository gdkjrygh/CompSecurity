    ...
    implements android.media.MediaPlayer.OnCompletionListener, android.media.MediaPlayer.OnErrorListener, android.media.MediaPlayer.OnPreparedListener
{
    ...
    private final bx c = new bx(this);
    private final VideoView d;
    private long e;
    private String f;

    public bw(Context context, em em1)
    {
        super(context);
        a = em1;
        d = new VideoView(context);
        em1 = new android.widget.FrameLayout.LayoutParams(-1, -1, 17);
        addView(d, em1);
    ...
    public static void a(em em1, String s, String s1)
    {
        HashMap hashmap;
        boolean flag;
        byte byte0;
        ...
        a(em1, "error", ((Map) (hashmap)));
    }

    private static void a(em em1, String s, String s1, String s2)
    {
    ...
    private static void a(em em1, String s, Map map)
    {
        map.put("event", s);
        em1.a("onVideoEvent", map);
    }
