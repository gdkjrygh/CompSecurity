...
public final class g
{
    ...
    public static int a(Context context)
    {
        ...
        try
        {
            context.getResources().getString(d.a);
        }
        ...
        if (context != null)
        {
            ...
            if (i1 != 0x41f6b8)
            {
                throw new IllegalStateException((new StringBuilder("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4323000 but found ")).append(i1).append(".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />").toString());
            }
        } else
        {
    ...
    abyte0
        ...
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder("Google Play services out of date.  Requires 4323000 but found ")).append(((PackageInfo) (context)).versionCode).toString());
            return 2;
        }
        try
        {
...
_L2:
        context = gg.b("com.google.android.gms");
          goto _L5
_L3:
        context = gg.a("com.google.android.gms");
          goto _L5
        context = gg.a();
          goto _L5
    }
