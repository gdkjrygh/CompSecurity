...
_L10:
        ...
        method2 = context.getClass().getMethod("getTimeMillis", null);
        method3 = context.getClass().getMethod("close", null);
_L16:
        if (context == null) goto _L13; else goto _L12
_L12:
        String s1;
        long l1;
        l1 = ((Long)method2.invoke(context, null)).longValue();
        time.set(l1);
