...
public final class Provider_TriState_DalvikGcInstrumentationEnabledGatekeeperAutoProvider__com_facebook_common_util_TriState__com_facebook_dalvikgc_DalvikGcInstrumentationEnabled__INJECTED_BY_TemplateInjector extends AbstractDefaultScopeProvider
{
    ...
    private Provider_TriState_DalvikGcInstrumentationEnabledGatekeeperAutoProvider__com_facebook_common_util_TriState__com_facebook_dalvikgc_DalvikGcInstrumentationEnabled__INJECTED_BY_TemplateInjector(InjectorLike injectorlike)
    {
    ...
    {
        return new Provider_TriState_DalvikGcInstrumentationEnabledGatekeeperAutoProvider__com_facebook_common_util_TriState__com_facebook_dalvikgc_DalvikGcInstrumentationEnabled__INJECTED_BY_TemplateInjector(injectorlike);
    }
