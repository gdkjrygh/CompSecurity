...
public class ProcessName
{
    ...
    public static ProcessName g()
    {
        ProcessName processname1 = a;
        ProcessName processname = processname1;
        if (processname1 == null)
        {
            processname = a(ActivityThread.currentActivityThread().getProcessName());
            a = processname;
        }
        return processname;
    }
