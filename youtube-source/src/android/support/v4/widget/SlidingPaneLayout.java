...
public class SlidingPaneLayout extends ViewGroup
{
    ...
    public SlidingPaneLayout(Context context, AttributeSet attributeset, int i1)
    {
        ...
        aw.a(this, new x(this));
        aw.b(this, 1);
        p = ag.a(this, 0.5F, new z(this, (byte)0));
        p.a(1);
        p.a(f1 * 400F);
    }
    ...
    static ag b(SlidingPaneLayout slidingpanelayout)
    {
...
_L1:
        if (!aw.g(view)) goto _L4; else goto _L3
_L3:
        int i1 = 1;
_L6:
        int j1;
...
_L5:
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionevent)
    {
        ...
        if (!f && i1 == 0 && getChildCount() > 1)
        {
            ...
            {
                ag ag2 = p;
                if (!ag.b(view, (int)motionevent.getX(), (int)motionevent.getY()))
                {
                    flag = true;
                } else
                {
...
_L4:
        ...
        n = f3;
        ag ag1 = p;
        if (!ag.b(g, (int)f1, (int)f3) || !d(g)) goto _L3; else goto _L8
_L8:
        i1 = 1;
          goto _L9
_L5:
...
_L20:
    ...
    protected void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        q = ((SavedState) (parcelable)).isOpen;
    }
...
_L4:
    ...
    public void setPanelSlideListener(aa aa)
    {
        o = aa;
    }
    ...
    static 
    {
        ...
        if (i1 >= 17)
        {
            a = new android.support.v4.widget.af();
        } else
        if (i1 >= 16)
        {
            a = new ae();
