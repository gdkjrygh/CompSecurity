...
public class GservicesKeys
{
    ...
    public static final String ANDROID_CAMERA_GCAM_ENABLED = "android_camera_gcam_enabled";
    public static final String ANDROID_CAMERA_REFOCUS_ENABLED = "android_camera_refocus_enabled";
    public static final String ANDROID_CAMERA_SMARTCAM_ENABLED = "android_camera_smartcam_enabled";
    ...
    public static final String BOOKS_HEAP_DUMP_ON_OOM = "books_heap_dump_on_oom";
    public static final String BOOKS_PREFIX = "books_";
    ...
    public static final String DIALER_REVERSE_LOOKUP_DISCOVERY_MAX_DISPLAY_COUNT = "dialer_reverse_lookup_discovery_max_display_count";
    public static final String DIALER_REVERSE_LOOKUP_ENABLED_VISIBILITIES = "dialer_reverse_lookup_enabled_visibilities";
    ...
    public static final String GMAIL_GVIEW_SUPPORTED_TYPES = "gmail_gview_supported_types";
    ...
    public static final String PHOTOSPHERE_FIELD_OF_VIEW_MILLIDEGREES = "photosphere_field_of_view_millidegrees";
