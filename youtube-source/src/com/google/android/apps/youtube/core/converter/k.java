...
final class k extends o
{
    ...
    {
        ((com.google.android.apps.youtube.datalib.legacy.model.Page.Builder)l1.a(com/google/android/apps/youtube/datalib/legacy/model/Page$Builder)).totalResults(m.b(s, 0));
    }
}
