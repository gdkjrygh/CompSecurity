...
final class cv extends o
{
    ...
    {
        attributes = ((com.google.android.apps.youtube.datalib.legacy.model.Subscription.Builder)l1.b(com/google/android/apps/youtube/datalib/legacy/model/Subscription$Builder)).build();
