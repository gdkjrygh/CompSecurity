...
final class j extends o
{
    ...
    {
        ((com.google.android.apps.youtube.datalib.legacy.model.Page.Builder)l1.a(com/google/android/apps/youtube/datalib/legacy/model/Page$Builder)).startIndex(m.b(s, 0));
    }
}
