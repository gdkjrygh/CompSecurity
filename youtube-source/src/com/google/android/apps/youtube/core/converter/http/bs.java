...
final class bs extends o
{
    ...
    public final void a(l l1, Attributes attributes, String s)
    {
        ...
        ((com.google.android.apps.youtube.datalib.legacy.model.LiveEvent.Builder)l1.a(com/google/android/apps/youtube/datalib/legacy/model/LiveEvent$Builder)).video(attributes.build());
    }
}
