    ...
    implements m
{
    ...
    public final void a(Object obj, Object obj1, a a1)
    {
        ...
        Video video;
        for (obj1 = ((Page)((Timestamped) (obj)).element).iterator(); ((Iterator) (obj1)).hasNext(); a1.a(com.google.android.apps.youtube.core.client.v.a(a).a(video.id), new Timestamped(video, ((Timestamped) (obj)).timestamp)))
        {
