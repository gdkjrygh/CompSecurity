...
final class o extends com.google.android.apps.youtube.core.converter.o
{
    ...
    {
        attributes = ((com.google.android.apps.youtube.datalib.legacy.model.Channel.Builder)l1.b(com/google/android/apps/youtube/datalib/legacy/model/Channel$Builder)).build();
