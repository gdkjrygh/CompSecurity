...
final class dr extends o
{
    ...
    {
        l1.offer(new com.google.android.apps.youtube.core.identity.UserProfile.Builder());
    }

    public final void a(l l1, Attributes attributes, String s)
    {
        attributes = ((com.google.android.apps.youtube.core.identity.UserProfile.Builder)l1.b(com/google/android/apps/youtube/core/identity/UserProfile$Builder)).build();
