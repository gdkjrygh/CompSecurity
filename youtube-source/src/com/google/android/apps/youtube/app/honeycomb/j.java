    ...
    implements android.preference.Preference.OnPreferenceClickListener
{
    ...
    j(SettingsActivity.DeveloperPrefsFragment developerprefsfragment)
    {
    ...
    {
        preference = new Intent(a.getActivity(), com/google/android/apps/youtube/app/DebugOfflineResyncActivity);
