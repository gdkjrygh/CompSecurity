    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static GroundOverlayOptions a(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < j)
            {
                ...
                case 4: // '\004'
                    f7 = com.google.android.gms.common.internal.safeparcel.a.j(parcel, k);
                    break;
            ...
            {
                return new GroundOverlayOptions(i, ibinder, latlng, f7, f6, latlngbounds, f5, f4, flag, f3, f2, f1);
            }
        } while (true);
    }
    ...
    {
        int j = b.a(parcel);
        b.a(parcel, 1, groundoverlayoptions.getVersionCode());
        b.a(parcel, 2, groundoverlayoptions.eC(), false);
