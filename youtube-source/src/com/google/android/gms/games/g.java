...
final class g
{
    ...
    public g(String s)
    {
        ...
        } else
        {
            ...
            d = (new StringBuilder()).append(s).append("profile_hi_res_image_uri").toString();
            e = (new StringBuilder()).append(s).append("last_updated").toString();
            f = (new StringBuilder()).append(s).append("is_in_circles").toString();
            g = (new StringBuilder()).append(s).append("played_with_timestamp").toString();
            return;
        }
    }
}
