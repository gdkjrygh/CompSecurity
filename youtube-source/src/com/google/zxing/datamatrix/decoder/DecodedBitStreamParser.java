...
_L10:
        if (obj == Mode.PAD_ENCODE || ((c) (obj1)).c() <= 0)
        {
...
_L3:
        ...
        {
            throw new IllegalStateException((new StringBuilder("Platform does not support required encoding: ")).append(c1).toString());
        }
    }
