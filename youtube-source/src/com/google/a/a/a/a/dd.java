...
public final class dd extends b
{
    ...
    public static final dd a[] = new dd[0];
    public String b;
    public sx c;
    public fk d;
    public fk e;
    ...
    public final int a()
    {
        ...
        if (k != null)
        {
            j1 = k1 + CodedOutputByteBufferNano.b(10, k);
        }
        i1 = j1;
        if (l != null)
        {
            ...
            do
            {
                ...
                i1 = CodedOutputByteBufferNano.b(11, aak[l1]);
                l1++;
                j1 = i1 + j1;
            } while (true);
        }
        ...
        if (m != null)
        {
            ...
            do
            {
                ...
                i1 += CodedOutputByteBufferNano.b(12, aak1[i2]);
                i2++;
            } while (true);
        }
        i1 = j1;
