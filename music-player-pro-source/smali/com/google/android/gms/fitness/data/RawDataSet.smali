...
.field final UM:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method constructor <init>(IIILjava/util/List;Z)V
    ...
    iput p1, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->CK:I

    iput p2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I

    iput p3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I

    iput-object p4, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UM:Ljava/util/List;

    iput-boolean p5, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Uc:Z
...
.method public constructor <init>(Lcom/google/android/gms/fitness/data/DataSet;Ljava/util/List;Ljava/util/List;)V
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->CK:I

    invoke-virtual {p1, p2}, Lcom/google/android/gms/fitness/data/DataSet;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UM:Ljava/util/List;

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/DataSet;->jn()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Uc:Z
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I
...
.method private a(Lcom/google/android/gms/fitness/data/RawDataSet;)Z
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Uc:Z

    iget-boolean v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->Uc:Z

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UM:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->UM:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UJ:I
    ...
    iget v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UL:I
    ...
    iget-object v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->UM:Ljava/util/List;
