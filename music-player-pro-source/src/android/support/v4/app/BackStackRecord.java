...
_L9:
        ...
        if (mManager.mAdded != null)
        {
            for (int i = 0; i < mManager.mAdded.size(); i++)
            {
                ...
                if (FragmentManagerImpl.DEBUG)
                {
                    Log.v("BackStackEntry", (new StringBuilder()).append("OP_REPLACE: adding=").append(fragment1).append(" old=").append(fragment7).toString());
                }
                if (fragment7.mContainerId != fragment1.mContainerId)
                {
                    continue;
                }
                if (op.removed == null)
                ...
                if (mAddToBackStack)
                {
                    fragment7.mBackStackNesting = fragment7.mBackStackNesting + 1;
                    if (FragmentManagerImpl.DEBUG)
                    {
                        Log.v("BackStackEntry", (new StringBuilder()).append("Bump nesting of ").append(fragment7).append(" to ").append(fragment7.mBackStackNesting).toString());
                    }
                }
