...
//            SuperNotCalledException, NoSaveStateFrameLayout, FragmentManagerState, FragmentState, 
    ...
    public void attachFragment(Fragment fragment, int i, int j)
    {
        ...
        if (fragment.mDetached)
        {
            ...
            if (!fragment.mAdded)
            {
                ...
                moveToState(fragment, mCurState, i, j);
            }
        }
    }
...
_L3:
        ...
        if (fragment == null || fragment.mFragmentId != i) goto _L6; else goto _L5
_L5:
        return fragment;
_L6:
        j--;
...
_L7:
        ...
        fragment = fragment1;
        if (fragment1.mFragmentId == i) goto _L5; else goto _L8
_L8:
        j--;
          goto _L9
_L2:
...
_L3:
        Fragment fragment = (Fragment)mAdded.get(i);
        if (fragment == null || !s.equals(fragment.mTag)) goto _L6; else goto _L5
_L5:
        return fragment;
_L6:
        i--;
...
_L7:
        ...
        fragment = fragment1;
        if (s.equals(fragment1.mTag)) goto _L5; else goto _L8
_L8:
        i--;
          goto _L9
_L2:
...
_L10:
    ...
    void makeActive(Fragment fragment)
    {
        ...
        {
            fragment.setIndex(((Integer)mAvailIndices.remove(mAvailIndices.size() - 1)).intValue());
    ...
    void makeInactive(Fragment fragment)
    {
        ...
        if (DEBUG)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("Freeing fragment index ").append(fragment.mIndex).toString());
        }
    ...
    void moveToState(final Fragment fragment, int i, int j, int k)
    {
        int l = i;
        if (!fragment.mAdded)
        {
...
_L5:
        if (i > 1)
        {
            ...
            if (!fragment.mFromLayout)
            {
                ...
                {
                    viewgroup1 = (ViewGroup)mActivity.findViewById(fragment.mContainerId);
                    viewgroup = viewgroup1;
                    if (viewgroup1 == null)
                    {
                        viewgroup = viewgroup1;
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).mActive != null)
        {
            ...
            while (j < ((FragmentManagerState) (parcelable)).mActive.length) 
            {
                ...
                if (fragmentstate != null)
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: adding #").append(j).append(": ").append(fragment2).toString());
                    }
                ...
                } else
                {
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: adding #").append(j).append(": (null)").toString());
                    }
                    mActive.add(null);
                    if (mAvailIndices == null)
                    {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: adding avail #").append(j).toString());
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mAdded != null)
            {
                ...
                for (int l = 0; l < ((FragmentManagerState) (parcelable)).mAdded.length; l++)
                {
                    ...
                    if (arraylist == null)
                    {
                        throw new IllegalStateException((new StringBuilder()).append("No instantiated fragment for index #").append(((FragmentManagerState) (parcelable)).mAdded[l]).toString());
                    }
                    arraylist.mAdded = true;
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: making added #").append(l).append(": ").append(arraylist).toString());
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mBackStack != null)
            {
                ...
                while (i1 < ((FragmentManagerState) (parcelable)).mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: adding bse #").append(i1).append(" (index ").append(((BackStackRecord) (arraylist)).mIndex).append("): ").append(arraylist).toString());
                    }
            ...
            while (i < j1) 
            {
                ...
                if (((Fragment) (obj)).mState > 0 && fragmentstate.mSavedFragmentState == null)
                {
                    ...
                    if (((Fragment) (obj)).mTarget != null)
                    {
                        ...
                        {
                            obj = (new StringBuilder()).append("Failure saving state: ").append(obj).append(" has target not in fragment manager: ").append(((Fragment) (obj)).mTarget).toString();
                            Log.e("FragmentManager", ((String) (obj)));
