...
//            GiftEntity, PromotionSDK, HttpService, BitmapService
...
_L5:
    ...
    public Bitmap loadImage(GiftEntity giftentity, Callback callback)
    {
        ...
        String s = (new StringBuilder(String.valueOf(PromotionSDK.DOWNLOAD_ICON_PATH))).append(giftentity.getPackagename()).append(".png").toString();
        bitmap1 = getBitmap(s);
        if (bitmap1 != null)
        {
            return bitmap1;
