...
public class Widget4x1Transparent extends AppWidgetProvider
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (views == null)
        {
            views = new RemoteViews(context.getPackageName(), 0x7f030028);
        }
        if ("com.MediaPlayer.action.MEDIAPLAYER_INFO".equals(intent.getAction()))
        {
            ...
            appwidgetmanager.updateAppWidget(new ComponentName(context, com/arist/Widget/Widget4x1Transparent), views);
            return;
        }
