...
public final class GamesContract
{
    ...
    public static interface AppContentActionColumns
    {
        ...
        public static final String ZM[] = {
            "action_id", "action_conditions", "action_content_description", "action_data", "action_description", "action_label", "action_label_style", "action_type"
        };
    ...
    public static interface AppContentAnnotationColumns
    {
        ...
        public static final String ZM[] = {
            "annotation_id", "annotation_description", "annotation_image_uri", "annotation_title", "annotation_type"
        };
    ...
    public static interface AppContentCardColumns
    {
        ...
        public static final String ZM[] = {
            "card_actions", "card_annotations", "card_id", "card_conditions", "card_content_description", "card_current_steps", "card_data", "card_description", "card_icon_image_uri", "card_image_uri", 
            "card_overflow_actions", "card_subtitle", "card_title", "card_total_steps", "card_type"
        };
    ...
    public static interface AppContentSectionColumns
    {
        ...
        public static final String ZM[] = {
            "section_actions", "section_background_image_uri", "section_content_description", "section_data", "section_description", "section_id", "section_subtitle", "section_title", "section_type"
        };
    ...
    public static interface GameInstancesColumns
    {
        ...
        public static final String ZN[] = {
            "installed", "package_name", "real_time_support", "turn_based_support"
        };
    ...
    public static interface PlayersColumns
    {
        ...
        public static final String ZM[] = {
            ...
            "has_all_public_acls", "is_profile_visible", "current_xp_total", "current_level", "current_level_min_xp", "current_level_max_xp", "next_level", "next_level_max_xp", "last_level_up_timestamp", "player_title", 
            "most_recent_external_game_id", "most_recent_game_name", "most_recent_activity_timestamp", "most_recent_game_icon_id", "most_recent_game_icon_uri", "most_recent_game_hi_res_id", "most_recent_game_hi_res_uri", "most_recent_game_featured_id", "most_recent_game_featured_uri"
        };
    ...
    public static interface SnapshotColumns
    {
        ...
        public static final String ZM[] = {
            ...
            "title", "description", "last_modified_timestamp", "duration", "unique_name", "visible", "pending_change_count"
        };
