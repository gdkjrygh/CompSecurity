...
private static abstract class <init> extends com.google.android.gms.games.ateMatchImpl
{
    ...
    public com.google.android.gms.games.multiplayer.turnbased._cls9 ax(Status status)
    {
        return new com.google.android.gms.games.multiplayer.turnbased.TurnBasedMultiplayer.UpdateMatchResult(status) {

            final Status DS;
            final TurnBasedMultiplayerImpl.UpdateMatchImpl acf;
            ...
            {
                acf = TurnBasedMultiplayerImpl.UpdateMatchImpl.this;
                DS = status;
                super();
            }
        };
