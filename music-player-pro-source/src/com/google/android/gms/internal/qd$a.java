...
_L6:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            d = com.google.android.gms.dynamic.p(parcel.readStrongBinder());
            c = com.google.android.gms.dynamic.o(parcel.readStrongBinder());
            break;
        }
        Object obj;
        if (parcel.readInt() != 0)
        ...
        obj = a(d, c, ((WalletFragmentOptions) (obj)), bQ(parcel.readStrongBinder()));
