...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            d d1 = com.google.android.gms.dynamic.p(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.wallet.fragment.internal.IWalletFragmentDelegate");
            d d2 = com.google.android.gms.dynamic.p(parcel.readStrongBinder());
            d d3 = com.google.android.gms.dynamic.p(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.createFromParcel(parcel);
            } else
