...
public final class PlusShare
{
    public static class Builder
    {
        ...
        {
            jx.a(anE, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            Bundle bundle;
            boolean flag;
            ...
            jx.b(flag, "Must provide a call to action URL");
            bundle = new Bundle();
            ...
            {
                jx.a(PlusShare.cg(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            jx.a(flag1, "Call-to-action buttons are only available for URLs.");
            ...
            jx.a(flag1, "The content URL is required for interactive posts.");
            flag1 = flag2;
            if (flag4)
            {
                flag1 = flag2;
            ...
            jx.a(flag1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
                jx.a(PlusShare.cg(mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
            if (!flag && flag3)
            {
                ...
                {
                    mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)anF.get(0));
                } else
                {
            ...
            if (flag && !flag3)
            {
                ...
                if (anF != null && !anF.isEmpty())
                {
                    mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", anF);
                } else
                {
                    mIntent.removeExtra("android.intent.extra.STREAM");
                }
        ...
        {
            jx.b(anE, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean flag;
            if (!TextUtils.isEmpty(s))
            {
                flag = true;
            ...
            jx.b(flag, "The deepLinkId parameter is required.");
        ...
        public Builder(Activity activity, PlusClient plusclient)
        {
            ...
            jx.a(flag, "PlusClient must not be null.");
            jx.a(plusclient.isConnected(), "PlusClient must be connected to create an interactive post.");
            jx.a(plusclient.os().cj("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
