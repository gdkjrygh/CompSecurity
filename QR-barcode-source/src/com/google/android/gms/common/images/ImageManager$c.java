    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        boolean flag;
        boolean flag1;
        a.aU("LoadBitmapFromDiskRunnable can't be executed in the main thread");
        flag = false;
        flag1 = false;
        obj = null;
        countdownlatch = null;
...
_L2:
        ...
        ImageManager.g(KD).post(new <init>(KD, mUri, ((android.graphics.Bitmap) (obj)), flag, countdownlatch));
        try
        {
