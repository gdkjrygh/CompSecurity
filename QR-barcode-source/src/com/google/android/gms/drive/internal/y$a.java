...
private static class <init> extends Handler
{
    ...
    public void handleMessage(Message message)
    {
        ...
        case 1: // '\001'
            if (message instanceof com.google.android.gms.drive.events.eEvent.Listener)
            {
                ((com.google.android.gms.drive.events.eEvent.Listener)message).onEvent((ChangeEvent)obj);
                return;
            } else
            {
