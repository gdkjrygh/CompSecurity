...
_L1:
    ...
    public static com.google.android.gms.maps.internal.c aP(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            i(com.google.android.gms.dynamic.am(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = j(com.google.android.gms.dynamic.am(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj2;
            if (obj != null)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj1 = com.google.android.gms.dynamic.am(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            a(com.google.android.gms.dynamic.am(parcel.readStrongBinder()), parcel.readInt());
            parcel1.writeNoException();
            return true;

        case 7: // '\007'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = com.google.android.gms.dynamic.am(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 8: // '\b'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            obj = k(com.google.android.gms.dynamic.am(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj5;
            break;
        }
