    ...
    implements IStreetViewPanoramaFragmentDelegate
{
        ...
        implements IStreetViewPanoramaFragmentDelegate
    {
            ...
            throws RemoteException
        {
            ...
            istreetviewpanoramadelegate = IStreetViewPanoramaDelegate.a.bl(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            d d1 = com.google.android.gms.dynamic.nder(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                streetviewpanoramaoptions = StreetViewPanoramaOptions.CREATOR.cH(parcel);
            } else
            {
            ...
            onInflate(d1, streetviewpanoramaoptions, parcel);
            parcel1.writeNoException();
            return true;
        ...
        case 3: // '\003'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.ions(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 4: // '\004'
            ...
            d d3 = com.google.android.gms.dynamic.ate.a.onCreate(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.onCreate(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 10: // '\n'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.onLowMemory(parcel);
            } else
            {
                parcel = null;
            }
