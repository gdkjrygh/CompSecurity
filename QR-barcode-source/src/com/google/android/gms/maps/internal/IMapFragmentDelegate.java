    ...
    extends IInterface
{
        ...
        implements IMapFragmentDelegate
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    googlemapoptions = GoogleMapOptions.CREATOR.cG(parcel);
                } else
                {
                ...
                onInflate(d1, googlemapoptions, parcel);
                parcel1.writeNoException();
                return true;
        ...
        implements IMapFragmentDelegate
    {
            ...
            throws RemoteException
        {
            ...
            igooglemapdelegate = IGoogleMapDelegate.a.aQ(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
