    ...
    extends IInterface
{
        ...
        implements IGoogleMapDelegate
    {
            ...
            throws RemoteException
        {
            ...
            case 4: // '\004'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                moveCamera(com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 5: // '\005'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                animateCamera(com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 6: // '\006'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                animateCameraWithCallback(com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()), b.a.aO(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 7: // '\007'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                animateCameraWithDurationAndCallback(com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()), parcel.readInt(), b.a.aO(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 9: // '\t'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = PolylineOptions.CREATOR.cP(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 10: // '\n'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = PolygonOptions.CREATOR.cO(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 11: // '\013'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = MarkerOptions.CREATOR.cN(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 12: // '\f'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = GroundOverlayOptions.CREATOR.cK(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 13: // '\r'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = TileOverlayOptions.CREATOR.cV(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 28: // '\034'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                setOnMapClickListener(com.google.android.gms.maps.internal.i.a.aZ(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 35: // '#'
                ...
                if (parcel.readInt() != 0)
                {
                    parcel = CircleOptions.CREATOR.cJ(parcel);
                } else
                {
                    parcel = null;
                }
            ...
            case 38: // '&'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                snapshot(s.a.bk(parcel.readStrongBinder()), com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 42: // '*'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                setOnMapLoadedCallback(com.google.android.gms.maps.internal.j.a.ba(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void setOnMapLongClickListener(com.google.android.gms.maps.internal.k k)
        throws RemoteException;

    public abstract void setOnMarkerClickListener(l l)
        throws RemoteException;

    public abstract void setOnMarkerDragListener(com.google.android.gms.maps.internal.m m)
        throws RemoteException;

    public abstract void setOnMyLocationButtonClickListener(n n)
        throws RemoteException;

    public abstract void setOnMyLocationChangeListener(com.google.android.gms.maps.internal.o o)
        throws RemoteException;
