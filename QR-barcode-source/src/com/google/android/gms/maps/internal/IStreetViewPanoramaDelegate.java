        ...
        implements IStreetViewPanoramaDelegate
    {
            ...
            throws RemoteException
        {
            ...
            case 9: // '\t'
                ...
                if (parcel.readInt() != 0)
                {
                    obj = StreetViewPanoramaCamera.CREATOR.cQ(parcel);
                } else
                {
                    obj = null;
                }
            ...
            case 18: // '\022'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                parcel = pointToOrientation(com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder()));
                parcel1.writeNoException();
                if (parcel != null)
                {
                    parcel1.writeInt(1);
            ...
            if (parcel.readInt() != 0)
            {
                parcel = StreetViewPanoramaOrientation.CREATOR.cT(parcel);
            } else
            {
                parcel = null;
            }
...
_L1:
            StreetViewPanoramaCamera streetviewpanoramacamera = StreetViewPanoramaCamera.CREATOR.cQ(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
...
_L3:
            ...
            throws RemoteException
        {
            ...
            if (parcel1.readInt() == 0) goto _L2; else goto _L1
_L1:
            StreetViewPanoramaLocation streetviewpanoramalocation = StreetViewPanoramaLocation.CREATOR.cS(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            parcel1.readException();
            streetviewpanoramaorientation = com.google.android.gms.dynamic.d.a.am(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            {
                d1 = StreetViewPanoramaOrientation.CREATOR.cT(parcel1);
            }
            parcel1.recycle();
            parcel.recycle();
            return d1;
...
_L1:
        ...
        public void setOnStreetViewPanoramaChangeListener(com.google.android.gms.maps.internal.q q1)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L1:
    ...
    public abstract void setOnStreetViewPanoramaChangeListener(com.google.android.gms.maps.internal.q q)
        throws RemoteException;
