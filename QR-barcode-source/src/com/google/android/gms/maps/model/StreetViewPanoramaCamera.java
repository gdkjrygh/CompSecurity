    ...
    implements SafeParcelable
{
    ...
    StreetViewPanoramaCamera(int i, float f, float f1, float f2)
    {
        ...
        o.b(flag, "Tilt needs to be between -90 and 90 inclusive");
        BR = i;
        zoom = f;
        tilt = 0.0F + f1;
        if ((double)f2 <= 0.0D)
        ...
        bearing = f % 360F;
        akp = (new StreetViewPanoramaOrientation.Builder()).tilt(f1).bearing(f2).build();
    }
    ...
    {
        return n.h(this).a("zoom", Float.valueOf(zoom)).a("tilt", Float.valueOf(tilt)).a("bearing", Float.valueOf(bearing)).toString();
    }
