    ...
    implements SafeParcelable
{
    ...
    public static final Comparator aee = new Comparator() {
    ...
    {
        return (new StringBuilder()).append("DetectedActivity [type=").append(getType()).append(", confidence=").append(aeg).append("]").toString();
    }
