...
class ba
{
    ...
    public static cr.c cG(String s)
        throws JSONException
    {
        ...
        {
            d.a(cr.a.oT().b(b.df.toString(), ((com.google.android.gms.internal.d.a) (s)).gx[i]).b(b.cU.toString(), di.cX(m.nQ())).b(m.nR(), ((com.google.android.gms.internal.d.a) (s)).gy[i]).oW());
        }
