...
abstract class j
{
    public static interface a
    {
        ...
        public abstract void d(String s, boolean flag);

        public abstract i dW();
...
_L10:
        xV.g(s, s2);
          goto _L4
        xmlresourceparser;
        z.T((new StringBuilder()).append("Error parsing tracker configuration file: ").append(xmlresourceparser).toString());
_L2:
        return xV.dW();
_L9:
...
_L14:
        ...
        z.T((new StringBuilder()).append("Error parsing bool configuration value: ").append(s).toString());
          goto _L4
        xmlresourceparser;
        z.T((new StringBuilder()).append("Error parsing tracker configuration file: ").append(xmlresourceparser).toString());
          goto _L2
...
_L17:
        ...
        xV.c(numberformatexception, k);
          goto _L4
        numberformatexception;
        z.T((new StringBuilder()).append("Error parsing int configuration value: ").append(s).toString());
          goto _L4
    }
    ...
    public i w(int i)
    {
        ...
        try
        {
            k = a(mContext.getResources().getXml(i));
        }
        catch (android.content.res.Resources.NotFoundException notfoundexception)
        {
            z.W((new StringBuilder()).append("inflate() called with unknown resourceId: ").append(notfoundexception).toString());
            return null;
        }
        return k;
    }
