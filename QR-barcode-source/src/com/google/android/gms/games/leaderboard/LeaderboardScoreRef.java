    ...
    implements LeaderboardScore
{
    ...
    {
        super(dataholder, i);
        abL = new PlayerRef(dataholder, i);
    }
    ...
    public void getScoreHolderDisplayName(CharArrayBuffer chararraybuffer)
    {
        ...
        {
            abL.getDisplayName(chararraybuffer);
            return;
        }
    }
