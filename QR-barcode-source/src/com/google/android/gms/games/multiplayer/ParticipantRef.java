    ...
    implements Participant
{
    ...
    {
        super(dataholder, i);
        aci = new PlayerRef(dataholder, i);
    }
    ...
    public void getDisplayName(CharArrayBuffer chararraybuffer)
    {
        ...
        {
            aci.getDisplayName(chararraybuffer);
            return;
        }
    }
