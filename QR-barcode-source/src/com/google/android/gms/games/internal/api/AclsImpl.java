    ...
    implements Acls
{
    private static abstract class LoadNotifyAclImpl extends com.google.android.gms.games.Games.BaseGamesApiMethodImpl
    {
        ...
        public com.google.android.gms.games.internal.game.Acls.LoadAclResult N(Status status)
        {
            return AclsImpl.M(status);
        }
    ...
    private static com.google.android.gms.games.internal.game.Acls.LoadAclResult L(Status status)
    {
    ...
    static com.google.android.gms.games.internal.game.Acls.LoadAclResult M(Status status)
    {
        return L(status);
    }
