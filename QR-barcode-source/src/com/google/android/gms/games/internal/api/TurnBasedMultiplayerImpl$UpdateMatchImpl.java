...
private static abstract class <init> extends com.google.android.gms.games.ateMatchImpl
{
    ...
    public com.google.android.gms.games.multiplayer.turnbased.Q ax(Status status)
    {
        return new com.google.android.gms.games.multiplayer.turnbased.TurnBasedMultiplayer.UpdateMatchResult(status) {

            final Status CW;
            final TurnBasedMultiplayerImpl.UpdateMatchImpl aal;
            ...
            {
                aal = TurnBasedMultiplayerImpl.UpdateMatchImpl.this;
                CW = status;
                super();
            }
        };
