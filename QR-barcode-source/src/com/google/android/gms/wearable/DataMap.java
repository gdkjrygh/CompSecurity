...
public class DataMap
{
    ...
    private final HashMap auW = new HashMap();
...
_L8:
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        try
        {
            abyte0 = pc.a(new com.google.android.gms.internal.pc.a(pd.n(abyte0), new ArrayList()));
        }
    ...
    public double getDouble(String s, double d1)
    {
        Object obj = auW.get(s);
        if (obj == null)
        {
    ...
    {
        String s;
        for (Iterator iterator = datamap.keySet().iterator(); iterator.hasNext(); auW.put(s, datamap.get(s)))
        {
            s = (String)iterator.next();
        }
    ...
    {
        auW.put(s, Boolean.valueOf(flag));
    }

    public void putByte(String s, byte byte0)
    {
        auW.put(s, Byte.valueOf(byte0));
    }
    ...
    {
        auW.put(s, Double.valueOf(d1));
    }

    public void putFloat(String s, float f)
    {
        auW.put(s, Float.valueOf(f));
    }
    ...
    public Bundle toBundle()
    {
        ...
        String s;
        for (Iterator iterator = auW.keySet().iterator(); iterator.hasNext(); a(bundle, s, auW.get(s)))
        {
            s = (String)iterator.next();
        }
