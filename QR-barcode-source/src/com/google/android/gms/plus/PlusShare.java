...
public final class PlusShare
{
    public static class Builder
    {
        ...
        {
            o.a(alr, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            Bundle bundle;
            boolean flag;
            ...
            o.b(flag, "Must provide a call to action URL");
            bundle = new Bundle();
            ...
            {
                o.a(PlusShare.cd(s1), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent()
        {
            ...
            o.a(flag1, "Call-to-action buttons are only available for URLs.");
            ...
            o.a(flag1, "The content URL is required for interactive posts.");
            flag1 = flag2;
            if (flag4)
            {
                flag1 = flag2;
            ...
            o.a(flag1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
            {
                o.a(PlusShare.cd(mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
            if (!flag && flag3)
            {
                ...
                {
                    mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)als.get(0));
                } else
                {
            ...
            if (flag && !flag3)
            {
                ...
                if (als != null && !als.isEmpty())
                {
                    mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", als);
                } else
                {
                    mIntent.removeExtra("android.intent.extra.STREAM");
                }
        ...
        {
            o.b(alr, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean flag;
            if (!TextUtils.isEmpty(s))
            {
                flag = true;
            ...
            o.b(flag, "The deepLinkId parameter is required.");
        ...
        public Builder(Activity activity, PlusClient plusclient)
        {
            ...
            o.a(flag, "PlusClient must not be null.");
    ...
    protected static boolean cd(String s)
    {
        if (TextUtils.isEmpty(s))
        {
    ...
    public static Person createPerson(String s, String s1)
    {
        ...
        {
            return new nz(s1, s, null, 0, null);
        }
    }
