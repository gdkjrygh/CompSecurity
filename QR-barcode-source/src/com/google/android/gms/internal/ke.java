...
public class ke extends j
{
    ...
    {
        return (AppVisibleCustomProperties)dataholder.gy().getSparseParcelableArray("customPropertiesExtra").get(i, AppVisibleCustomProperties.PG);
    }
}
