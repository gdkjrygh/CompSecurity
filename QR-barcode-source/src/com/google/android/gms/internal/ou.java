    ...
    extends IInterface
{
        ...
        implements ou
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                d = com.google.android.gms.dynamic.d.a.am(parcel.readStrongBinder());
                c = com.google.android.gms.dynamic.c.a.al(parcel.readStrongBinder());
                break;
            }
            Object obj;
            if (parcel.readInt() != 0)
            ...
            obj = a(d, c, ((WalletFragmentOptions) (obj)), os.a.bK(parcel.readStrongBinder()));
            parcel1.writeNoException();
            parcel = obj1;
            if (obj != null)
            {
                parcel = ((or) (obj)).asBinder();
            }
        ...
        implements ou
    {
        ...
        public or a(d d1, c c1, WalletFragmentOptions walletfragmentoptions, os os1)
            throws RemoteException
        {
            Object obj;
            Parcel parcel;
...
_L9:
            ...
            d1 = or.a.bJ(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return d1;
_L2:
...
_L6:
    ...
    public abstract or a(d d, c c, WalletFragmentOptions walletfragmentoptions, os os)
        throws RemoteException;
}
