    ...
    extends IInterface
{
        ...
        implements ow
    {
            ...
            throws RemoteException
        {
            ...
            if (parcel.readInt() != 0)
            {
                op1 = (op)op.CREATOR.createFromParcel(parcel);
            } else
            {
                op1 = null;
            }
...
_L1:
        ...
        public void a(Status status, op op1, Bundle bundle)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L5:
            if (op1 == null) goto _L4; else goto _L3
_L3:
            parcel.writeInt(1);
...
_L1:
    ...
    public abstract void a(Status status, op op, Bundle bundle)
        throws RemoteException;
