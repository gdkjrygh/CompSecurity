...
_L1:
        return;
_L2:
        if (!(obj instanceof pn)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(dj(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String bf(String s)
    {
        int j = s.length();
    ...
    private static String dj(String s)
    {
    ...
    public static String g(pn pn1)
    {
        ...
        try
        {
            a(null, pn1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (pn pn1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(pn1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (pn pn1)
        {
