...
public interface ll
{
    ...
    public static final class a.a extends ph
    {
        ...
        private static volatile a.a adF[];
        public String adG;
        public String adH;
        public int viewId;

        public static a.a[] lQ()
        {
            if (adF == null)
            {
                synchronized (pl.awT)
...
_L5:
            flag = flag1;
            if (((a.a) (obj)).adG != null) goto _L4; else goto _L7
_L7:
            if (adH != null)
            {
            ...
            flag = flag1;
            if (((a.a) (obj)).adH != null) goto _L4; else goto _L8
_L8:
            flag = flag1;
            if (viewId == ((a.a) (obj)).viewId)
            {
              ...
              goto _L4
_L6:
            if (!adG.equals(((a.a) (obj)).adG))
            {
                return false;
            }
              goto _L7
            if (!adH.equals(((a.a) (obj)).adH))
            {
                return false;
            }
              goto _L8
