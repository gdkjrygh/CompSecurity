...
public static final class s extends ph
{

    private static volatile awU gu[];
    public String gA;
    public long gB;
    public boolean gC;
    public awU gD[];
...
_L8:
        flag = flag1;
        if (!pl.equals(gw, ((gw) (obj)).gw)) goto _L4; else goto _L9
_L9:
        flag = flag1;
        if (!pl.equals(gx, ((gx) (obj)).gx)) goto _L4; else goto _L10
_L10:
        flag = flag1;
        if (!pl.equals(gy, ((gy) (obj)).gy)) goto _L4; else goto _L11
_L11:
...
_L13:
    ...
    public int hashCode()
    {
        ...
        return ((((c1 + (((j + ((((i + (i1 + 527) * 31) * 31 + j1) * 31 + k1) * 31 + l1) * 31) * 31 + k) * 31 + i2) * 31) * 31 + j2) * 31 + k2) * 31 + c2) * 31 + qz();
    }
...
_L1:
        if (a(pf1, i)) goto _L16; else goto _L2
_L2:
        return this;
_L3:
        i = pf1.ql();
...
_L5:
        ...
        if (i != 0)
        {
            System.arraycopy(gw, 0, aqz, 0, i);
            k = i;
        }
        for (; k < aqz.length - 1; k++)
        {
            aqz[k] = new <init>();
            pf1.a(aqz[k]);
            pf1.qi();
...
_L6:
        ...
        if (i != 0)
        {
            System.arraycopy(gx, 0, aqz1, 0, i);
            i1 = i;
        }
        for (; i1 < aqz1.length - 1; i1++)
        {
            aqz1[i1] = new <init>();
            pf1.a(aqz1[i1]);
            pf1.qi();
...
_L7:
        ...
        if (i != 0)
        {
            System.arraycopy(gy, 0, aqz2, 0, i);
            j1 = i;
        }
        for (; j1 < aqz2.length - 1; j1++)
        {
            aqz2[j1] = new <init>();
            pf1.a(aqz2[j1]);
            pf1.qi();
...
_L14:
        ...
        if (j != 0)
        {
            System.arraycopy(gD, 0, aqz3, 0, j);
            l1 = j;
        }
        for (; l1 < aqz3.length - 1; l1++)
        {
            aqz3[l1] = new <init>();
            pf1.a(aqz3[l1]);
            pf1.qi();
