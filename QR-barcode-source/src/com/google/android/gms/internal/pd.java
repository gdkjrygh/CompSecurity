...
public final class pd extends ph
{
...
_L7:
            ...
            flag = flag1;
            if (((a) (obj)).awf != null) goto _L4; else goto _L8
_L8:
            return a(((ph) (obj)));
_L6:
    ...
    public static final class a.a extends ph
    {

        private static volatile a.a awg[];
        public a awh;
        public int type;

        public static a.a[] qf()
        {
            if (awg == null)
            {
                synchronized (pl.awT)
...
_L6:
            flag = flag1;
            if (((a.a) (obj)).awh != null) goto _L4; else goto _L8
_L8:
            return a(((ph) (obj)));
_L7:
            if (!awh.equals(((a.a) (obj)).awh))
            {
                return false;
            }
...
_L6:
    ...
    public static final class a.a.a extends ph
    {
...
_L2:
            ...
            obj = (a.a.a)obj;
            flag = flag1;
            if (!Arrays.equals(awi, ((a.a.a) (obj)).awi))
            {
                continue; /* Loop/switch isn't completed */
            }
            if (awj != null)
            ...
            flag = flag1;
            if (((a.a.a) (obj)).awj != null)
            {
                continue; /* Loop/switch isn't completed */
            }
_L5:
            flag = flag1;
            if (Double.doubleToLongBits(awk) == Double.doubleToLongBits(((a.a.a) (obj)).awk))
            {
                flag = flag1;
                if (Float.floatToIntBits(awl) == Float.floatToIntBits(((a.a.a) (obj)).awl))
                {
                    flag = flag1;
                    if (awm == ((a.a.a) (obj)).awm)
                    {
                        flag = flag1;
                        if (awn == ((a.a.a) (obj)).awn)
                        {
                            flag = flag1;
                            if (awo == ((a.a.a) (obj)).awo)
                            {
                                flag = flag1;
                                if (awp == ((a.a.a) (obj)).awp)
                                {
                                    flag = flag1;
                                    if (pl.equals(awq, ((a.a.a) (obj)).awq))
                                    {
                                        flag = flag1;
                                        if (pl.equals(awr, ((a.a.a) (obj)).awr))
                                        {
                                            flag = flag1;
                                            if (pl.equals(aws, ((a.a.a) (obj)).aws))
                                            {
                                                flag = flag1;
                                                if (pl.equals(awt, ((a.a.a) (obj)).awt))
                                                {
                                                    flag = flag1;
                                                    if (pl.equals(awu, ((a.a.a) (obj)).awu))
                                                    {
                                                        flag = flag1;
                                                        if (awv == ((a.a.a) (obj)).awv)
                                                        {
                                                            return a(((ph) (obj)));
                                                        }
                                                    }
...
_L6:
    ...
    public static pd n(byte abyte0[])
        throws pm
    {
        return (pd)pn.a(new pd(), abyte0);
    }
    ...
    public int hashCode()
    {
        return (pl.hashCode(awd) + 527) * 31 + qz();
    }
