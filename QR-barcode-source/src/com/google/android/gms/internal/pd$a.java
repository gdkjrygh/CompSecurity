...
public static final class qe extends ph
{
...
_L6:
            flag = flag1;
            if (((a) (obj)).awh != null) goto _L4; else goto _L8
_L8:
            return a(((ph) (obj)));
_L7:
            if (!awh.equals(((a) (obj)).awh))
            {
                return false;
            }
...
_L2:
            ...
            obj = (a.a)obj;
            flag = flag1;
            if (!Arrays.equals(awi, ((a.a) (obj)).awi))
            {
                continue; /* Loop/switch isn't completed */
            }
            if (awj != null)
...
_L5:
            flag = flag1;
            if (Double.doubleToLongBits(awk) == Double.doubleToLongBits(((a.a) (obj)).awk))
            {
                flag = flag1;
                if (Float.floatToIntBits(awl) == Float.floatToIntBits(((a.a) (obj)).awl))
                {
                    flag = flag1;
                    if (awm == ((a.a) (obj)).awm)
                    {
                        ...
                        if (awn == ((a.a) (obj)).awn)
                        {
                            ...
                            if (awo == ((a.a) (obj)).awo)
                            {
                                ...
                                {
                                    flag = flag1;
                                    if (pl.equals(awq, ((a.a) (obj)).awq))
                                    {
                                        flag = flag1;
                                        if (pl.equals(awr, ((a.a) (obj)).awr))
                                        {
                                            flag = flag1;
                                            if (pl.equals(aws, ((a.a) (obj)).aws))
                                            {
                                                flag = flag1;
                                                if (pl.equals(awt, ((a.a) (obj)).awt))
                                                {
                                                    flag = flag1;
                                                    if (pl.equals(awu, ((a.a) (obj)).awu))
                                                    {
                                                        flag = flag1;
                                                        if (awv == ((a.a) (obj)).awv)
                                                        {
...
_L6:
    ...
    private static volatile awf awe[];
    public a awf;
    public String name;
...
_L2:
        flag = flag1;
        if (!(obj instanceof awf)) goto _L4; else goto _L3
_L3:
        obj = (awf)obj;
...
_L7:
        ...
        flag = flag1;
        if (((awf) (obj)).awf != null) goto _L4; else goto _L8
_L8:
        return a(((ph) (obj)));
_L6:
        if (!name.equals(((name) (obj)).name))
        {
          ...
          goto _L7
        if (!awf.equals(((a.equals) (obj)).awf))
        {
            return false;
        }
          goto _L8
