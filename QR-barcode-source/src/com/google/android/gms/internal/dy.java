...
public final class dy extends eg.a
{
    ...
    public dy(String s, ArrayList arraylist, Context context, String s1)
    {
        su = s;
        sv = arraylist;
        mv = s1;
    ...
    private void cq()
    {
        try
        {
            mContext.getClassLoader().loadClass("com.google.ads.conversiontracking.IAPConversionReporter").getDeclaredMethod("reportWithProductId", new Class[] {
                ...
                mContext, su, "", Boolean.valueOf(true)
            });
            return;
        }
        ...
        {
            gs.d("Fail to report a conversion.", exception);
        }
    }
    ...
    protected String a(String s, HashMap hashmap)
    {
        ...
        {
            gs.d("Error to retrieve app version", ((Throwable) (obj)));
            obj = "";
        }
    ...
    public void recordPlayBillingResolution(int i)
    {
        ...
        hashmap.put("sku", su);
        hashmap.put("status", String.valueOf(o(i)));
        String s;
        for (Iterator iterator = sv.iterator(); iterator.hasNext(); (new gq(mContext, mv, a(s, hashmap))).start())
        {
