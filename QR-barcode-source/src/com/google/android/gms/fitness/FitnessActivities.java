...
public class FitnessActivities
{
    ...
    private static final SparseArray So;
    ...
    public static int bp(String s)
    {
        int i = So.indexOfValue(s);
        if (i >= 0)
        {
            if ((i = So.keyAt(i)) <= 108)
            {
    ...
    {
        return getName(datapoint.getValue(Field.FIELD_ACTIVITY).asInt());
    }

    public static void setValue(DataPoint datapoint, String s)
    {
        datapoint.getValue(Field.FIELD_ACTIVITY).setInt(bp(s));
    }

    static 
    {
        So = new SparseArray(109);
        So.put(9, "aerobics");
        So.put(10, "badminton");
        So.put(11, "baseball");
