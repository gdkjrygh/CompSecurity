    ...
    implements SafeParcelable
{
    ...
    private static final Map SV = new HashMap() {
    ...
    {
        this(1, s, ((List) (jr.b(afield))));
    }

    private boolean a(DataType datatype)
    {
        return mName.equals(datatype.mName) && SY.equals(datatype.SY);
    }

    public static List getAggregatesForInput(DataType datatype)
    {
        datatype = (List)SV.get(datatype);
        if (datatype == null)
        {
    ...
    static 
    {
        ...
        ST = new DataType("com.google.activity.edge", new Field[] {
            Field.FIELD_ACTIVITY, Field.Td
        });
        SU = new DataType("com.google.accelerometer", new Field[] {
            Field.Te, Field.Tf, Field.Tg
        });
        ...
        SW = (new DataType[] {
            SU, ST, TYPE_ACTIVITY_SAMPLE, TYPE_ACTIVITY_SEGMENT, AGGREGATE_ACTIVITY_SUMMARY, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, TYPE_CYCLING_PEDALING_CADENCE, TYPE_CYCLING_PEDALING_CUMULATIVE, TYPE_CYCLING_WHEEL_REVOLUTION, 
        ...
        SX = (new String[] {
            SU.getName(), ST.getName(), TYPE_ACTIVITY_SAMPLE.getName(), TYPE_ACTIVITY_SEGMENT.getName(), AGGREGATE_ACTIVITY_SUMMARY.getName(), TYPE_CALORIES_CONSUMED.getName(), TYPE_CALORIES_EXPENDED.getName(), TYPE_CYCLING_PEDALING_CADENCE.getName(), TYPE_CYCLING_PEDALING_CUMULATIVE.getName(), TYPE_CYCLING_WHEEL_REVOLUTION.getName(), 
