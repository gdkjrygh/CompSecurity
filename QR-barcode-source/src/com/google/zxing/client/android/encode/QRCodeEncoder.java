...
final class QRCodeEncoder
{
    ...
    QRCodeEncoder(Activity activity1, Intent intent, int i, boolean flag)
        throws WriterException
    {
        activity = activity1;
        dimension = i;
        useVCard = flag;
        activity1 = intent.getAction();
        if (activity1.equals("com.google.zxing.client.android.ENCODE"))
        {
            encodeContentsFromZXingIntent(intent);
        } else
        if (activity1.equals("android.intent.action.SEND"))
        {
...
_L2:
        ...
        if (intent != null)
        {
            contents = (new StringBuilder("mailto:")).append(intent).toString();
            displayContents = intent;
...
_L3:
        ...
        if (intent != null)
        {
            contents = (new StringBuilder("tel:")).append(intent).toString();
...
_L5:
        ...
        if (intent != null)
        {
            contents = (new StringBuilder("sms:")).append(intent).toString();
            displayContents = PhoneNumberUtils.formatNumber(intent);
...
_L6:
        ...
        s1 = s.getString("name");
        s2 = s.getString("company");
        s3 = s.getString("postal");
        arraylist = new ArrayList(Contents.PHONE_KEYS.length);
        i = 0;
_L9:
        if (i < Contents.PHONE_KEYS.length) goto _L8; else goto _L7
_L7:
...
_L8:
        ...
        i++;
          goto _L9
        arraylist1.add(s.getString(Contents.EMAIL_KEYS[i]));
        i++;
          goto _L10
        if (!s.equals("LOCATION_TYPE")) goto _L4; else goto _L11
_L11:
...
_L12:
    ...
    private void encodeQRCodeContents(AddressBookParsedResult addressbookparsedresult)
    {
        ...
        if (addressbookparsedresult[1].length() > 0)
        {
