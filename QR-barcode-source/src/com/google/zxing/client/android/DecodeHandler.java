...
final class DecodeHandler extends Handler
{
    ...
    private void decode(byte abyte0[], int i, int j)
    {
        ...
        obj = null;
        PlanarYUVLuminanceSource planaryuvluminancesource = activity.getCameraManager().buildLuminanceSource(abyte0, i, j);
        abyte0 = ((byte []) (obj));
...
_L1:
        ...
        Log.d(TAG, (new StringBuilder("Found barcode in ")).append(l1 - l).append(" ms").toString());
        if (obj != null)
        {
