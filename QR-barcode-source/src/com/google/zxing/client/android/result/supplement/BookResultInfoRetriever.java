...
final class BookResultInfoRetriever extends SupplementalInfoRetriever
{
    ...
    void retrieveSupplementalInfo()
        throws IOException
    {
        Object obj = HttpHelper.downloadViaHttp((new StringBuilder("https://www.googleapis.com/books/v1/volumes?q=isbn:")).append(isbn).toString(), com.google.zxing.client.android.HttpHelper.ContentType.JSON);
...
_L7:
        ...
        {
            obj = (new StringBuilder(String.valueOf(s1))).append("pp.").toString();
        }
        maybeAddText(((String) (obj)), arraylist);
        obj = (new StringBuilder("http://www.google.")).append(LocaleManager.getBookSearchCountryTLD(context)).append("/search?tbm=bks&source=zxing&q=").toString();
        append(isbn, source, (String[])arraylist.toArray(new String[arraylist.size()]), (new StringBuilder(String.valueOf(obj))).append(isbn).toString());
        return;
_L9:
...
_L10:
        obj;
_L13:
        throw new IOException(((JSONException) (obj)).toString());
        obj;
