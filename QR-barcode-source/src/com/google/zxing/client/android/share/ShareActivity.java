...
public final class ShareActivity extends Activity
{
    ...
    private final android.view.View.OnClickListener clipboardListener = new android.view.View.OnClickListener() {
        ...
        public void onClick(View view)
        {
            ...
            if (view.hasText())
            {
                launchSearch(view.getText().toString());
            }
        }
...
_L4:
        obj1 = ((ContentResolver) (obj)).query(android.provider.ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, (new StringBuilder("contact_id=")).append(s).toString(), null, null);
...
_L7:
        k = Contents.PHONE_KEYS.length;
        if (i < k) goto _L9; else goto _L8
_L8:
        ((Cursor) (obj1)).close();
_L5:
        obj1 = ((ContentResolver) (obj)).query(android.provider.ContactsContract.CommonDataKinds.StructuredPostal.CONTENT_URI, null, (new StringBuilder("contact_id=")).append(s).toString(), null, null);
        if (obj1 == null)
        {
        ...
        if (s1.length() > 0)
        {
            uri.putString("postal", massageContactData(s1));
        }
        ((Cursor) (obj1)).close();
        obj = ((ContentResolver) (obj)).query(android.provider.ContactsContract.CommonDataKinds.Email.CONTENT_URI, null, (new StringBuilder("contact_id=")).append(s).toString(), null, null);
        if (obj == null) goto _L11; else goto _L10
_L10:
        i = 0;
        j = ((Cursor) (obj)).getColumnIndex("data1");
_L16:
        if (!((Cursor) (obj)).moveToNext()) goto _L13; else goto _L12
_L12:
        k = Contents.EMAIL_KEYS.length;
        if (i < k) goto _L14; else goto _L13
_L13:
        ((Cursor) (obj)).close();
_L11:
        ...
        Log.i(TAG, (new StringBuilder("Sending bundle for encoding: ")).append(uri).toString());
        ...
        throw obj;
_L9:
        String s2 = ((Cursor) (obj1)).getString(j);
        if (s2 == null)
        {
        ...
        if (s2.length() > 0)
        {
            uri.putString(Contents.PHONE_KEYS[i], massageContactData(s2));
        }
        i++;
          goto _L15
        uri;
...
_L4:
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        clipboardButton = (Button)findViewById(com.google.zxing.client.android.R.id.share_clipboard_button);
    ...
    protected void onResume()
    {
        ...
        clipboardButton.setEnabled(clipboardmanager.hasText());
    }
