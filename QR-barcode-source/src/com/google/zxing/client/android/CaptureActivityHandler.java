        ...
        } else
        {
            ...
            if (message.what == R.id.launch_product_query)
            {
                ...
                if (resolveinfo.activityInfo != null)
                {
                    ...
                    Log.d(TAG, (new StringBuilder("Using browser in package ")).append(message).toString());
                }
                ...
                {
                    Log.w(TAG, (new StringBuilder("Can't find anything to handle VIEW of URI ")).append(s).toString());
                }
                return;
            }
        }
