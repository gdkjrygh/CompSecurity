...
_L4:
        ...
        int i = findDesiredDimensionInRange(((Point) (obj)).x, 240, 1920);
        int j = findDesiredDimensionInRange(((Point) (obj)).y, 240, 1080);
...
_L5:
        ...
        throws IOException
    {
        ...
        camera1 = ((OpenCameraInterface)(new OpenCameraManager()).build()).open();
        if (camera1 != null)
        {
...
_L2:
        ...
        Log.i(TAG, (new StringBuilder("Resetting to saved camera params: ")).append(surfaceholder).toString());
...
_L1:
        ...
        j = (point.x - k) / 2;
        int l = (point.y - i) / 2;
        framingRect = new Rect(j, l, j + k, l + i);
        Log.d(TAG, (new StringBuilder("Calculated manual framing rect: ")).append(framingRect).toString());
        framingRectInPreview = null;
_L4:
        this;
        JVM INSTR monitorexit ;
