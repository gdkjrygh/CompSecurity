...
_L7:
    ...
    private DecodedChar decodeIsoIec646(int i)
    {
        ...
        j;
        JVM INSTR tableswitch 232 252: default 228
    //                   232 255
    //                   233 271
    //                   234 277
    //                   235 283
...
_L1:
        throw new IllegalArgumentException((new StringBuilder()).append("Decoding invalid ISO/IEC 646 value: ").append(j).toString());
_L2:
        char c = '!';
_L24:
