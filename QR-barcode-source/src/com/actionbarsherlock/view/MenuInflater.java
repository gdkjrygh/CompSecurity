...
public class MenuInflater
{
    ...
    private class MenuState
    {
        ...
        public void readItem(AttributeSet attributeset)
        {
            ...
            itemCategoryOrder = 0xffff0000 & typedarray.getInt(com.actionbarsherlock.R.styleable.SherlockMenuItem_android_menuCategory, groupCategory) | 0xffff & typedarray.getInt(com.actionbarsherlock.R.styleable.SherlockMenuItem_android_orderInCategory, groupOrder);
            ...
            int i;
            if (typedarray.hasValue(com.actionbarsherlock.R.styleable.SherlockMenuItem_android_checkable))
            {
                if (typedarray.getBoolean(com.actionbarsherlock.R.styleable.SherlockMenuItem_android_checkable, false))
                {
                    i = 1;
                } else
                {
