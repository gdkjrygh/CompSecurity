    ...
    implements Authorization, Serializable, OAuthSupport
{
    ...
    static Class class$twitter4j$auth$OAuthAuthorization;
...
_L5:
    ...
    public static String normalizeRequestParameters(HttpParameter ahttpparameter[])
    {
...
_L7:
    ...
    public static List toParamList(HttpParameter ahttpparameter[])
    {
    ...
    String generateAuthorizationHeader(String s, String s1, HttpParameter ahttpparameter[], String s2, String s3, OAuthToken oauthtoken)
    {
        ...
        s = (new StringBuffer(s)).append("&").append(HttpParameter.encode(constructRequestURL(s1))).append("&");
        ...
        return "OAuth " + encodeParameters(ahttpparameter, ",", true);
    }
...
_L1:
        secretkeyspec = new SecretKeySpec((HttpParameter.encode(consumerSecret) + "&").getBytes(), "HmacSHA1");
_L4:
...
_L3:
        secretkeyspec = new SecretKeySpec((HttpParameter.encode(consumerSecret) + "&" + HttpParameter.encode(oauthtoken.getTokenSecret())).getBytes(), "HmacSHA1");
    ...
    static 
    {
        ...
        {
            class1 = _mthclass$("twitter4j.auth.OAuthAuthorization");
            class$twitter4j$auth$OAuthAuthorization = class1;
        } else
        {
            class1 = class$twitter4j$auth$OAuthAuthorization;
        }
