...
label1:
            {
                ...
                if (!flag && -1L != l)
                {
                    throw new IllegalStateException("Paging parameter [" + s + "] is not supported with this operation.");
                }
                break label0;
            }
            i++;
    ...
    public void setMaxId(long l)
    {
        if (l < 1L)
        {
            throw new IllegalArgumentException("max_id should be positive integer. passed:" + l);
        } else
        {
            maxId = l;
            return;
    ...
    public void setSinceId(long l)
    {
        if (l < 1L)
        {
            throw new IllegalArgumentException("since_id should be positive integer. passed:" + l);
        } else
        {
            sinceId = l;
            return;
