    ...
    implements DynamicMBean
{
        ...
        throws AttributeNotFoundException, MBeanException, ReflectionException
    {
        ...
        {
            return new Long(API_STATISTICS.getCallCount());
        }
        if (s.equals("errorCount"))
        {
            return new Long(API_STATISTICS.getErrorCount());
        }
        if (s.equals("totalTime"))
        {
            return new Long(API_STATISTICS.getTotalTime());
        }
        if (s.equals("averageTime"))
        {
            return new Long(API_STATISTICS.getAverageTime());
        } else
        {
            throw new AttributeNotFoundException("Cannot find " + s + " attribute ");
        }
    }
...
_L1:
        ...
        obj1 = (InvocationStatistics)iterator.next();
        s = ((InvocationStatistics) (obj1)).getName();
        long1 = new Long(((InvocationStatistics) (obj1)).getCallCount());
        long2 = new Long(((InvocationStatistics) (obj1)).getErrorCount());
        long3 = new Long(((InvocationStatistics) (obj1)).getTotalTime());
        obj1 = new Long(((InvocationStatistics) (obj1)).getAverageTime());
        ((TabularDataSupport) (obj)).put(new CompositeDataSupport(METHOD_STATS_TYPE, ITEM_NAMES, new Object[] {
            s, long1, long2, long3, obj1
        }));
          goto _L1
        obj;
        ...
        throws MBeanException, ReflectionException
    {
        ...
        {
            throw new ReflectionException(new NoSuchMethodException(s), "Cannot find the operation " + s);
        }
    }
