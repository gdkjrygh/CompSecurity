...
_L4:
    ...
    public static String encodeUrl(Bundle bundle)
    {
        ...
        do
        {
            ...
            stringbuilder.append((new StringBuilder(String.valueOf(s))).append("=").append(bundle.getString(s)).toString());
        } while (true);
    }
        ...
        throws MalformedURLException, IOException
    {
        ...
        Log.d("Twitter-Util", (new StringBuilder(String.valueOf(s1))).append(" URL: ").append(s2).toString());
        s = (HttpURLConnection)(new URL(s2)).openConnection();
        s.setRequestProperty("User-Agent", (new StringBuilder(String.valueOf(System.getProperties().getProperty("http.agent")))).append(" TwitterAndroidSDK").toString());
...
_L4:
        ...
        throws JSONException, TwitterError
    {
        ...
        if (s.has("error"))
        {
            ...
            throw new TwitterError(s.getString("message"), s.getString("type"), 0);
        }
        if (s.has("error_code") && s.has("error_msg"))
        {
            throw new TwitterError(s.getString("error_msg"), "", Integer.parseInt(s.getString("error_code")));
        }
        if (s.has("error_code"))
        {
            throw new TwitterError("request failed", "", Integer.parseInt(s.getString("error_code")));
        }
        if (s.has("error_msg"))
        {
            throw new TwitterError(s.getString("error_msg"));
        }
        if (s.has("error_reason"))
        {
            throw new TwitterError(s.getString("error_reason"));
        } else
        {
            return s;
        }
