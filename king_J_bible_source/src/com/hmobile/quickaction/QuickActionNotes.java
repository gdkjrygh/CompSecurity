...
public class QuickActionNotes extends CustomPopupWindow
{
    ...
    public QuickActionNotes(View view)
    {
        super(view);
        actionList = new ArrayList();
        context = view.getContext();
        inflater = (LayoutInflater)context.getSystemService("layout_inflater");
        root = (ViewGroup)inflater.inflate(0x7f030029, null);
        setContentView(root);
    ...
    {
        drawable = (RelativeLayout)inflater.inflate(0x7f030001, null);
