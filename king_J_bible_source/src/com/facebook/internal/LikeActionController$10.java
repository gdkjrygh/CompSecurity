    ...
    implements com.facebook.oller._cls10
{
    ...
    public void onBatchCompleted(RequestBatch requestbatch)
    {
        ...
        if (Utility.isNullOrEmpty(LikeActionController.access$26(LikeActionController.this)))
        {
            Logger.log(LoggingBehavior.DEVELOPER_ERRORS, LikeActionController.access$1(), "Unable to verify the FB id for '%s'. Verify that it is a valid FB object or page", new Object[] {
                LikeActionController.access$32(LikeActionController.this)
            });
            ...
            LikeActionController.access$2(likeactioncontroller, "get_verified_id", requestbatch);
        }
