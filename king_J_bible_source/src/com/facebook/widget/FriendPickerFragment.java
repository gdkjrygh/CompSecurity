...
public class FriendPickerFragment extends PickerFragment
{
    public static final class FriendPickerType extends Enum
    {
        ...
        static 
        {
            ...
            ENUM$VALUES = (new FriendPickerType[] {
    ...
    {
        s = Request.newGraphPathRequest(session, (new StringBuilder(String.valueOf(s))).append(friendPickerType.getRequestPath()).toString(), null);
        set = new HashSet(set);
