        ...
        public void onClick(View view)
        {
            ...
            if (session2 != null)
            {
                if (confirmLogout)
                {
                    ...
                    ((android.app.AlertDialog.Builder) (obj3)).setMessage(((CharSequence) (obj))).setCancelable(true).setPositiveButton(((CharSequence) (obj1)), session2. new android.content.DialogInterface.OnClickListener() {
