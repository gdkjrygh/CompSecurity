...
_L1:
        return true;
        if (!(((Request)requestbatch.next()).getCallback() instanceof OnProgressCallback)) goto _L4; else goto _L3
_L3:
        return true;
    }
    ...
    public static Request newCustomAudienceThirdPartyIdRequest(Session session1, Context context, String s, Callback callback1)
    {
        ...
        s = (new StringBuilder(String.valueOf(session1))).append("/custom_audience_third_party_id").toString();
...
_L6:
        ...
        if (!((JSONObject) (obj)).has("fbsdk:create_object")) goto _L7; else goto _L10
_L10:
        ...
        if (i == 1)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    obj = ((Request) (requestbatch)).parameters.get(s);
