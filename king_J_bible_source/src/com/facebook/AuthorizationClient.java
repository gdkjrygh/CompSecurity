...
_L5:
    ...
    class WebViewAuthHandler extends AuthHandler
    {
        ...
        boolean tryAuthorize(AuthorizationRequest authorizationrequest)
        {
            ...
            obj = authorizationrequest. new com.facebook.widget.WebDialog.OnCompleteListener() {
            ...
            loginDialog = ((com.facebook.widget.WebDialog.Builder)(new AuthDialogBuilder(getStartActivityDelegate().getActivityContext(), applicationId, bundle)).setE2E(e2e).setIsRerequest(authorizationrequest.isRerequest()).setOnCompleteListener(((com.facebook.widget.WebDialog.OnCompleteListener) (obj)))).build();
            loginDialog.show();
            return true;
        }
