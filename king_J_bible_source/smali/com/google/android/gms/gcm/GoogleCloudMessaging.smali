...
.field static Nq:Lcom/google/android/gms/gcm/GoogleCloudMessaging;


# instance fields
.field private Nr:Landroid/app/PendingIntent;

.field final Ns:Ljava/util/concurrent/BlockingQueue;
...
.field private Nt:Landroid/os/Handler;

.field private Nu:Landroid/os/Messenger;

.field private kI:Landroid/content/Context;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ns:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nt:Landroid/os/Handler;

    new-instance v0, Landroid/os/Messenger;

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nt:Landroid/os/Handler;

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nu:Landroid/os/Messenger;
...
.method private a(Ljava/lang/String;Ljava/lang/String;JILandroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kI:Landroid/content/Context;
...
.method private varargs c([Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nu:Landroid/os/Messenger;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kI:Landroid/content/Context;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nq:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nq:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nq:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    iput-object p0, v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kI:Landroid/content/Context;
...
.method private hL()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ns:Ljava/util/concurrent/BlockingQueue;

    invoke-interface {v1}, Ljava/util/concurrent/BlockingQueue;->clear()V

    const-string v1, "google.messenger"

    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nu:Landroid/os/Messenger;
...
.method declared-synchronized c(Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nr:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nr:Landroid/app/PendingIntent;

    :cond_0
    const-string v0, "app"

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Nr:Landroid/app/PendingIntent;
...
.method public close()V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->hM()V
...
.method declared-synchronized hM()V
    .locals 1
...
.method public varargs register([Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ns:Ljava/util/concurrent/BlockingQueue;
...
.method public unregister()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->hL()V
