...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->jS()Lcom/google/android/gms/plus/model/people/Person;
...
.method public getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/is;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    new-instance v0, Lcom/google/android/gms/internal/ih$c;

    const-string v1, "image"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/is;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/ih$c;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/ih$e;->bi(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->jP()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->jQ()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->jR()Ljava/util/ArrayList;
...
.method public jQ()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public jS()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/ih;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/ih$c;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/is;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/ih;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/ih$c;ILjava/lang/String;)V
