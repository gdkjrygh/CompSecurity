...
.method private init(Lorg/json/JSONObject;)V
    ...
    iput v2, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->start:I
    ...
    iput v2, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->end:I
    :try_end_0
    ...
    iput-object v2, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->url:Ljava/net/URL;
    :try_end_1
    ...
    iput-object v2, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->expandedURL:Ljava/net/URL;
    :try_end_3
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->end:I

    iget v4, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->end:I
    ...
    .line 117
    :cond_4
    iget v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->start:I

    iget v4, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->start:I
    ...
    .line 120
    :cond_8
    iget-object v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->expandedURL:Ljava/net/URL;

    if-eqz v3, :cond_a

    iget-object v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->expandedURL:Ljava/net/URL;

    iget-object v4, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->expandedURL:Ljava/net/URL;
    ...
    .line 120
    :cond_a
    iget-object v3, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->expandedURL:Ljava/net/URL;

    if-nez v3, :cond_9

    .line 122
    :cond_b
    iget-object v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->url:Ljava/net/URL;

    if-eqz v3, :cond_c

    iget-object v3, p0, Ltwitter4j/internal/json/URLEntityJSONImpl;->url:Ljava/net/URL;

    iget-object v4, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->url:Ljava/net/URL;
    ...
    .line 122
    :cond_c
    iget-object v3, v0, Ltwitter4j/internal/json/URLEntityJSONImpl;->url:Ljava/net/URL;
