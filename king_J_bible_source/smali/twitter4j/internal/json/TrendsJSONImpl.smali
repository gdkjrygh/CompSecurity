...
.method static createTrendsList(Ltwitter4j/internal/http/HttpResponse;Z)Ltwitter4j/ResponseList;
    ...
    invoke-static {v10}, Ltwitter4j/internal/util/z_T4JInternalParseUtil;->parseTrendsDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-static {v3, p1}, Ltwitter4j/internal/json/TrendsJSONImpl;->extractLocation(Lorg/json/JSONObject;Z)Ltwitter4j/Location;
    ...
    invoke-static {v0, p1}, Ltwitter4j/internal/json/TrendsJSONImpl;->jsonArrayToTrendArray(Lorg/json/JSONArray;Z)[Ltwitter4j/Trend;
    ...
    invoke-static {v5, v11}, Ltwitter4j/internal/util/z_T4JInternalParseUtil;->getDate(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Date;
...
.method private static extractLocation(Lorg/json/JSONObject;Z)Ltwitter4j/Location;
    ...
    invoke-static {v3, p1}, Ltwitter4j/internal/json/LocationJSONImpl;->createLocationList(Lorg/json/JSONArray;Z)Ltwitter4j/ResponseList;
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static jsonArrayToTrendArray(Lorg/json/JSONArray;Z)[Ltwitter4j/Trend;
    ...
    invoke-direct {v3, v1, p1}, Ltwitter4j/internal/json/TrendJSONImpl;-><init>(Lorg/json/JSONObject;Z)V
...
.method init(Ljava/lang/String;Z)V
    ...
    invoke-static {v3}, Ltwitter4j/internal/util/z_T4JInternalParseUtil;->parseTrendsDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    .line 86
    invoke-static {v1, p2}, Ltwitter4j/internal/json/TrendsJSONImpl;->extractLocation(Lorg/json/JSONObject;Z)Ltwitter4j/Location;
    ...
    .line 89
    invoke-static {v0, p2}, Ltwitter4j/internal/json/TrendsJSONImpl;->jsonArrayToTrendArray(Lorg/json/JSONArray;Z)[Ltwitter4j/Trend;
