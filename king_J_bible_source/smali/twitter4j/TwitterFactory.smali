...
.field static class$twitter4j$auth$Authorization:Ljava/lang/Class; = null
...
.method static constructor <clinit>()V
    ...
    sget-object v5, Ltwitter4j/TwitterFactory;->class$twitter4j$conf$Configuration:Ljava/lang/Class;

    if-nez v5, :cond_2

    const-string v5, "twitter4j.conf.Configuration"

    invoke-static {v5}, Ltwitter4j/TwitterFactory;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v5

    sput-object v5, Ltwitter4j/TwitterFactory;->class$twitter4j$conf$Configuration:Ljava/lang/Class;
    ...
    sget-object v5, Ltwitter4j/TwitterFactory;->class$twitter4j$auth$Authorization:Ljava/lang/Class;

    if-nez v5, :cond_3

    const-string v5, "twitter4j.auth.Authorization"

    invoke-static {v5}, Ltwitter4j/TwitterFactory;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v5

    sput-object v5, Ltwitter4j/TwitterFactory;->class$twitter4j$auth$Authorization:Ljava/lang/Class;
