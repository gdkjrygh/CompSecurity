...
_L1:
        ...
        {
            return convertToAbsoluteDirection(getMovementFlags(recyclerview, viewholder), x.h(recyclerview));
        }
...
_L1:
            return;
            if (obj != null && mCallback.hasDragFlag(mRecyclerView, ((android.support.v7.widget.RecyclerView.ViewHolder) (obj))) && n.b(motionevent, 0) == mActivePointerId)
            {
                int i = n.a(motionevent, mActivePointerId);
                float f = n.c(motionevent, i);
                float f1 = n.d(motionevent, i);
                mInitialTouchX = f;
                mInitialTouchY = f1;
    ...
    private final android.support.v7.widget.RecyclerView.OnItemTouchListener mOnItemTouchListener = new android.support.v7.widget.RecyclerView.OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerview, MotionEvent motionevent)
        {
            ...
            {
                int j = n.a(motionevent, mActivePointerId);
                if (j >= 0)
                {
...
_L4:
            if (n.b(motionevent, j) != mActivePointerId) goto _L1; else goto _L5
_L5:
            if (mVelocityTracker != null)
            {
                mVelocityTracker.computeCurrentVelocity(1000, mRecyclerView.getMaxFlingVelocity());
            ...
            mActivePointerId = n.b(motionevent, i);
...
_L1:
        ...
        if (mVelocityTracker == null || mActivePointerId < 0) goto _L4; else goto _L3
_L3:
        float f = w.a(mVelocityTracker, mActivePointerId);
        if (f <= 0.0F)
        {
            byte1 = 4;
        }
...
_L1:
        ...
        float f = n.c(motionevent, j);
        f1 = n.d(motionevent, j);
        f -= mInitialTouchX;
        f1 -= mInitialTouchY;
        float f2 = Math.abs(f);
...
_L1:
        ...
        if (mVelocityTracker == null || mActivePointerId < 0) goto _L4; else goto _L3
_L3:
        float f = w.b(mVelocityTracker, mActivePointerId);
        if (f <= 0.0F)
        {
            byte1 = 1;
        }
...
_L3:
    ...
    private List findSwapTargets(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
    {
        ...
        j1 = Math.round(mSelectedStartX + mDx) - i;
        k1 = Math.round(mSelectedStartY + mDy) - i;
        l1 = viewholder.itemView.getWidth() + j1 + i * 2;
        i2 = viewholder.itemView.getHeight() + k1 + i * 2;
        j2 = (j1 + l1) / 2;
        k2 = (k1 + i2) / 2;
        layoutmanager = mRecyclerView.getLayoutManager();
        l2 = layoutmanager.getChildCount();
        for (int j = 0; j < l2; j++)
        {
            ...
            int i1 = view.getTop();
            i1 = Math.abs(k2 - (view.getBottom() + i1) / 2);
            int i3 = k * k + i1 * i1;
            ...
            mSwapTargets.add(i1, viewholder1);
            mDistances.add(i1, Integer.valueOf(i3));
        }
    ...
    private android.support.v7.widget.RecyclerView.ViewHolder findSwipedView(MotionEvent motionevent)
    {
        ...
        {
            int i = n.a(motionevent, mActivePointerId);
            float f2 = n.c(motionevent, i);
            float f3 = mInitialTouchX;
            float f = n.d(motionevent, i);
...
_L6:
        ...
        final_viewholder = new RecoverAnimation(k, f2, f3, f, f1, j, ((android.support.v7.widget.RecyclerView.ViewHolder) (final_viewholder))) {
            ...
            public void onAnimationEnd(g g)
            {
                super.onAnimationEnd(g);
...
_L2:
        ...
        i = (mCallback.convertToAbsoluteDirection(j, x.h(mRecyclerView)) & 0xff00) >> 8;
        if (i == 0)
        {
            continue; /* Loop/switch isn't completed */
        }
        ...
        if (k > 0)
        {
            if ((j & k) == 0)
            {
                return Callback.convertToRelativeDirection(k, x.h(mRecyclerView));
            } else
            {
                return k;
            }
...
_L3:
        ...
        if (i > 0)
        {
            if ((j & i) == 0)
            {
                return Callback.convertToRelativeDirection(i, x.h(mRecyclerView));
            } else
            {
                return i;
            }
