    ...
    android.view.View.OnKeyListener mTextKeyListener = new android.view.View.OnKeyListener() {
        ...
        public boolean onKey(View view, int j, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mSearchSrcTextView.isEmpty() && g.b(keyevent) && keyevent.getAction() == 1 && j == 66)
                {
...
_L6:
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && g.b(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
