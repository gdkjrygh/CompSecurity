...
_L6:
    ...
    private void logChildren()
    {
        ...
        for (int i = 0; i < getChildCount(); i++)
        {
            ...
            Log.d("LinearLayoutManager", (new StringBuilder("item ")).append(getPosition(view)).append(", coord:").append(mOrientationHelper.getDecoratedStart(view)).toString());
        }
...
_L3:
    ...
    void validateChildOrder()
    {
        ...
        flag2 = true;
        flag = true;
        Log.d("LinearLayoutManager", (new StringBuilder("validating child count ")).append(getChildCount()).toString());
