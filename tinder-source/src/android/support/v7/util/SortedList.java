...
_L5:
    ...
    private void addToData(int i, Object obj)
    {
        if (i > mSize)
        {
            throw new IndexOutOfBoundsException((new StringBuilder("cannot add item to ")).append(i).append(" because size is ").append(mSize).toString());
        }
...
_L1:
        Object obj1 = mData[l];
        if (mCallback.compare(obj1, obj) != 0) goto _L2; else goto _L3
_L3:
        if (!mCallback.areItemsTheSame(obj1, obj)) goto _L5; else goto _L4
_L4:
        return l;
_L5:
        l--;
...
label0:
        ...
        throws IndexOutOfBoundsException
    {
        if (i >= mSize || i < 0)
        {
            throw new IndexOutOfBoundsException((new StringBuilder("Asked to get item at ")).append(i).append(" but size is ").append(mSize).toString());
        }
