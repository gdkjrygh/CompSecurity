...
public class ActionBarOverlayLayout extends ViewGroup
    implements q, DecorContentParent
{
    ...
    private android.support.v4.widget.r mFlingEstimator;
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeset)
    {
        ...
        mRemoveActionBarHideOffset = new Runnable() {
            ...
            public void run()
            {
                ...
                mCurrentActionBarTopAnimator = x.s(mActionBarTop).c(0.0F).a(mTopAnimatorListener);
            }
        ...
        mAddActionBarHideOffset = new Runnable() {
            ...
            {
                haltActionBarHideOffsetAnimations();
                mCurrentActionBarTopAnimator = x.s(mActionBarTop).c(-mActionBarTop.getHeight()).a(mTopAnimatorListener);
            }
    ...
    private void init(Context context)
    {
        ...
        mFlingEstimator = android.support.v4.widget.r.a(context, null);
    }
    ...
    {
        boolean flag = false;
        mFlingEstimator.a(0, 0, (int)f1, 0, 0, 0x80000000, 0x7fffffff);
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (mWindowContentOverlay != null && !mIgnoreWindowContentOverlay)
        {
            ...
            {
                i = (int)((float)mActionBarTop.getBottom() + x.p(mActionBarTop) + 0.5F);
            } else
            {
                i = 0;
            }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        int k1 = ViewUtils.combineMeasuredStates(0, x.l(mActionBarTop));
        int j1;
        if ((x.v(this) & 0x100) != 0)
        {
            l = 1;
        ...
        j1 = ViewUtils.combineMeasuredStates(k1, x.l(mContent));
        k1 = getPaddingLeft();
        l1 = getPaddingRight();
        l = Math.max(l + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(x.a(Math.max(k + (k1 + l1), getSuggestedMinimumWidth()), i, j1), x.a(l, j, j1 << 16));
    }
    ...
    public void setMenu(Menu menu, android.support.v7.internal.view.menu.l.a a)
    {
        pullChildren();
...
/*
    static af access$002(ActionBarOverlayLayout actionbaroverlaylayout, af af1)
    {
        actionbaroverlaylayout.mCurrentActionBarTopAnimator = af1;
        return af1;
    }
