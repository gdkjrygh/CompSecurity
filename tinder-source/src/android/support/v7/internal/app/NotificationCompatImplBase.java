...
public class NotificationCompatImplBase
{
            ...
            long l, List list, boolean flag1, PendingIntent pendingintent)
    {
        ...
        if (j > 0)
        {
            for (i = 0; i < j; i++)
            {
                charsequence1 = generateMediaActionButton(context, (android.support.v4.app.ad.a)list.get(i));
            ...
            long l, List list, int ai[], boolean flag1, PendingIntent pendingintent)
    {
        ...
        if (i > 0)
        {
            for (int j = 0; j < i; j++)
            {
                ...
                charsequence1 = generateMediaActionButton(context, (android.support.v4.app.ad.a)list.get(ai[j]));
                charsequence.addView(android.support.v7.appcompat.R.id.media_actions, charsequence1);
            }
    ...
    private static RemoteViews generateMediaActionButton(Context context, android.support.v4.app.ad.a a)
    {
        boolean flag;
        if (a.c() == null)
        {
        ...
        context.setImageViewResource(android.support.v7.appcompat.R.id.action0, a.a());
        if (!flag)
        {
            context.setOnClickPendingIntent(android.support.v7.appcompat.R.id.action0, a.c());
        }
        if (android.os.Build.VERSION.SDK_INT >= 15)
        {
            context.setContentDescription(android.support.v7.appcompat.R.id.action0, a.b());
        }
        return context;
    }
    ...
    public static void overrideContentView(z z1, Context context, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, int i, Bitmap bitmap, CharSequence charsequence3, 
            boolean flag, long l, List list, int ai[], boolean flag1, PendingIntent pendingintent)
    {
        ...
        z1.a().setContent(context);
        if (flag1)
        {
            z1.a().setOngoing(true);
        }
    }
}
