...
public final class android.support.v4.c.a.a
{
        ...
        implements b
    {
        ...
        {
            Object obj = drawable;
            if (!(drawable instanceof android.support.v4.c.a.e))
            {
    ...
    static class c extends a
    {
        ...
        {
            Object obj = drawable;
            if (!(drawable instanceof android.support.v4.c.a.f))
            {
                obj = new android.support.v4.c.a.f(drawable);
            }
            return ((Drawable) (obj));
        }
        ...
        public void b(Drawable drawable, int i)
        {
            if (!android.support.v4.c.a.c.b)
            {
                try
                {
                    ...
                    android.support.v4.c.a.c.a = method;
                ...
                android.support.v4.c.a.c.b = true;
            }
            if (android.support.v4.c.a.c.a == null)
            {
                break MISSING_BLOCK_LABEL_62;
            }
            android.support.v4.c.a.c.a.invoke(drawable, new Object[] {
                Integer.valueOf(i)
            });
            return;
            drawable;
            Log.i("DrawableCompatJellybeanMr1", "Failed to invoke setLayoutDirection(int) via reflection", drawable);
            android.support.v4.c.a.c.a = null;
            return;
        }

        public int d(Drawable drawable)
        {
            int i = android.support.v4.c.a.c.a(drawable);
            if (i < 0)
            {
                return i;
            } else
    ...
    static class e extends d
    {
        ...
        {
            Object obj = drawable;
            if (!(drawable instanceof android.support.v4.c.a.g))
            {
                obj = new android.support.v4.c.a.g(drawable);
            }
            return ((Drawable) (obj));
        }
    ...
    static class f extends e
    {
        ...
        {
            if (drawable instanceof android.support.v4.c.a.h)
            {
                android.support.v4.c.a.b.a(drawable, i);
                return;
            } else
...
label0:
            {
                ...
                obj = new android.support.v4.c.a.h(drawable);
            }
            return ((Drawable) (obj));
        }
    ...
    public static Drawable d(Drawable drawable)
    {
        ...
        if (drawable instanceof android.support.v4.c.a.d)
        {
            drawable1 = ((android.support.v4.c.a.d)drawable).a();
        }
        return drawable1;
    }
