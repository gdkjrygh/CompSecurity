...
_L4:
        ...
        if (Log.isLoggable("NotifManCompat", 3))
        {
            Log.d("NotifManCompat", (new StringBuilder("Sending task ")).append(ction).toString());
        }
        ction.a(a1.c);
        a1.d.remove();
...
_L5:
            ...
            if (!((Set) (obj1)).equals(e))
            {
                ...
                do
                {
                    ...
                    if (!hashset.contains(ntry.getKey()))
                    {
                        if (Log.isLoggable("NotifManCompat", 3))
                        {
                            Log.d("NotifManCompat", (new StringBuilder("Removing listener record for ")).append(ntry.getKey()).toString());
                        }
                        a((a)ntry.getValue());
    ...
    public final void onServiceConnected(ComponentName componentname, IBinder ibinder)
    {
        ...
        a.obtainMessage(1, new <init>(componentname, ibinder)).sendToTarget();
    }
