...
//            m, Fragment, l, e, 
//            v, FragmentManagerState, FragmentState, BackStackState, 
//            SuperNotCalledException, j, x, q
...
_L2:
        ...
        animation = AnimationUtils.loadAnimation(o.c, fragment.mNextAnim);
        fragment = animation;
...
_L1:
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder("Setting back stack index ")).append(i1).append(" to ").append(e1).toString());
        }
        k.set(i1, e1);
_L4:
        this;
...
_L3:
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder("Adding back stack index ")).append(i1).append(" with ").append(e1).toString());
        }
        k.add(e1);
          goto _L4
        e1;
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).a != null)
        {
            ...
            while (j1 < ((FragmentManagerState) (parcelable)).a.length) 
            {
                ...
                if (fragmentstate != null)
                {
                    ...
                    if (fragmentstate.k == null)
                    {
                        ...
                        fragmentstate.k.mFragmentManager = ((l) (obj)).f;
                        if (a)
                        {
            ...
            if (((FragmentManagerState) (parcelable)).b != null)
            {
                ...
                for (int l1 = 0; l1 < ((FragmentManagerState) (parcelable)).b.length; l1++)
                {
                    ...
                    if (a)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: added #")).append(l1).append(": ").append(list).toString());
                    }
                    if (g.contains(list))
                    {
            ...
            if (((FragmentManagerState) (parcelable)).c != null)
            {
                ...
                while (i2 < ((FragmentManagerState) (parcelable)).c.length) 
                {
                    ...
                    if (a)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: back stack #")).append(i2).append(" (index ").append(((e) (list)).p).append("): ").append(list).toString());
...
_L4:
        ...
        {
            fragment.mSavedFragmentState.setClassLoader(o.c.getClassLoader());
        ...
        if (q != null)
        {
            n1 = q.mChildFragmentManager;
        } else
        {
            n1 = o.f;
        }
        fragment.mFragmentManager = n1;
        fragment.mCalled = false;
        fragment.onAttach(o.c);
        if (!fragment.mCalled)
        {
        ...
        if (fragment.mFromLayout)
        {
            ...
            if (fragment.mView != null)
            {
                ...
                {
                    fragment.mView = android.support.v4.app.x.a(fragment.mView);
                }
                if (fragment.mHidden)
                {
...
_L2:
        ...
        fragment.mState;
        JVM INSTR tableswitch 1 5: default 1108
    //                   1 1114
    //                   2 1288
    //                   3 1250
    //                   4 1212
        ...
        if (i1 < 2)
        {
            ...
            if (fragment.mView != null && fragment.mContainer != null)
            {
                ...
                if (obj != null)
                {
                    ...
                    fragment.mStateAfterAnimating = i1;
                    ((Animation) (obj)).setAnimationListener(new a(fragment.mView, ((Animation) (obj)), fragment) {
...
_L15:
    ...
    public final void a(l l1, j j1, Fragment fragment)
    {
        if (o != null)
        {
...
_L4:
        ...
        do
        {
            ...
            e e1 = (e)i.get(l1);
            if (s1 != null && s1.equals(e1.n) || i1 >= 0 && i1 == e1.p)
            {
                break;
            }
            l1--;
...
_L7:
        ...
        while (i1 <= j1) 
        {
            ...
            s1 = e3.a(flag, s1, sparsearray2, sparsearray3);
            i1++;
        }
          goto _L8
    }
...
label0:
        ...
        if (i != null)
        {
            ...
            if (i2 > 0)
            {
                ...
                do
                {
                    ...
                    abackstackstate1[j1] = new BackStackState((e)i.get(j1));
                    if (a)
                    {
    ...
    public final View onCreateView(View view, String s1, Context context, AttributeSet attributeset)
    {
        ...
        s1 = context.obtainStyledAttributes(attributeset, b.a);
        if (s2 == null)
        {
            s2 = s1.getString(0);
        }
        ...
        s1.recycle();
        if (!Fragment.isSupportFragmentClass(o.c, s2))
        {
            return null;
        }
        int i1;
        ...
        if (s1 == null)
        {
            ...
            view.mHost = o;
            view.onInflate(o.c, attributeset, ((Fragment) (view)).mSavedFragmentState);
            a(view, true);
        } else
        {
            ...
            {
                s1.onInflate(o.c, attributeset, ((Fragment) (s1)).mSavedFragmentState);
            }
            view = s1;
        }
    ...
    public final String toString()
    {
        ...
        if (q != null)
        {
            android.support.v4.g.c.a(q, stringbuilder);
        } else
        {
            android.support.v4.g.c.a(o, stringbuilder);
        }
