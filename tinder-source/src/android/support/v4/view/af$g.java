...
public static interface olator
{
    ...
    public abstract void a(af af1, View view, float f);
    ...
    public abstract void b(af af1, View view, float f);

    public abstract void b(View view, long l);

    public abstract void c(af af1, View view, float f);
}
