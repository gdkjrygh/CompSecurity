...
public final class u
{
    ...
    private u(Context context, ViewGroup viewgroup, a a1)
    {
        ...
        } else
        {
            ...
            r = android.support.v4.widget.r.a(context, v);
            return;
        }
    }
    ...
    private void d()
    {
        ...
        float f1 = a(android.support.v4.view.w.a(p, l), h, q);
        a(android.support.v4.view.w.b(p, l), h, q);
        a(f1);
    }
    ...
    public final boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)android.support.v4.view.w.a(p, l), (int)android.support.v4.view.w.b(p, l));
        }
    }
...
_L13:
        i1++;
          goto _L14
_L6:
        b(android.support.v4.view.n.b(motionevent, i1));
          goto _L7
        a();
          goto _L7
    }
...
_L4:
        if (a == 1)
        {
            i1 = android.support.v4.view.n.a(motionevent, l);
