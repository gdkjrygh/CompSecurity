    ...
    implements o, q
{
    ...
    static final class a extends android.support.v4.view.a
    {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityevent)
        {
            ...
            i1 = view.getScrollX();
            g.a.c(((g) (accessibilityevent)).b, i1);
            i1 = view.getScrollY();
            g.a.d(((g) (accessibilityevent)).b, i1);
            i1 = view.getScrollX();
            g.a.f(((g) (accessibilityevent)).b, i1);
            i1 = NestedScrollView.a(view);
            g.a.g(((g) (accessibilityevent)).b, i1);
        }
    ...
    private void a(int i1, int j1)
    {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - a > 250L)
        {
            ...
            android.support.v4.widget.r r1 = c;
            k1 = getScrollX();
            r1.b.a(r1.a, k1, i1, j1 - i1);
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (android.support.v4.view.n.b(motionevent, i1) == q)
        {
            if (i1 == 0)
            {
                i1 = 1;
            ...
            f = (int)android.support.v4.view.n.d(motionevent, i1);
            q = android.support.v4.view.n.b(motionevent, i1);
            if (k != null)
            {
                k.clear();
            }
...
_L10:
    ...
    {
        if ((android.support.v4.view.n.d(motionevent) & 2) == 0) goto _L2; else goto _L1
_L1:
...
_L3:
        ...
        int l1;
        float f1;
        if (j || (f1 = android.support.v4.view.n.e(motionevent, 9)) == 0.0F)
        {
...
_L2:
        ...
        {
            f = j2;
            q = android.support.v4.view.n.b(motionevent, 0);
            if (k == null)
            {
                k = VelocityTracker.obtain();
            } else
...
_L8:
        d.a((float)i1 / (float)getHeight(), android.support.v4.view.n.c(motionevent, i2) / (float)getWidth());
        if (!e.a())
        {
            e.c();
        }
...
_L9:
        if (l1 > j2)
        {
            e.a((float)i1 / (float)getHeight(), 1.0F - android.support.v4.view.n.c(motionevent, i2) / (float)getWidth());
            if (!d.a())
            {
                d.c();
            }
...
_L6:
        ...
        f = (int)android.support.v4.view.n.d(motionevent, k1);
        q = android.support.v4.view.n.b(motionevent, k1);
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        f = (int)android.support.v4.view.n.d(motionevent, android.support.v4.view.n.a(motionevent, q));
...
label0:
    ...
    public final void setFillViewport(boolean flag)
    {
        if (flag != l)
        {
            l = flag;
    ...
    public final void setSmoothScrollingEnabled(boolean flag)
    {
        m = flag;
    }
