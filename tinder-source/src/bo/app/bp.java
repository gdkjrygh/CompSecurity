    ...
    implements cb
{
    ...
    public bp(Context context, bx bx1, XmlAppConfigurationProvider xmlappconfigurationprovider, eg eg1)
    {
        k = false;
        l = 0x36ee80L;
        m = 50F;
        ...
        f = PermissionUtils.hasPermission(context, "android.permission.ACCESS_COARSE_LOCATION");
        g = PermissionUtils.hasPermission(context, "android.permission.ACCESS_FINE_LOCATION");
        boolean flag;
...
_L3:
    ...
    public final boolean a(cz cz)
    {
        ...
        {
            AppboyLogger.w(a, "Failed to log location recorded event.", cz);
            return false;
        }
        return true;
    }
