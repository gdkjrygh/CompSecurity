...
public final class dl extends dp
{
    ...
    public dl(String s, Feedback feedback)
    {
    ...
    {
        az1.a(new SubmitFeedbackSucceeded(b), com/appboy/events/SubmitFeedbackSucceeded);
    }

    public final void a(az az1, ResponseError responseerror)
    {
        ErrorType errortype;
        String s;
...
_L4:
        az1.a(new SubmitFeedbackFailed(b, responseerror), com/appboy/events/SubmitFeedbackFailed);
        return;
_L2:
