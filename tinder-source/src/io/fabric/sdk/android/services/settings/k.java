    ...
    implements u
{
    ...
    public final s a(j j1, JSONObject jsonobject)
        throws JSONException
    {
        int i = jsonobject.optInt("settings_version", 0);
        int l = jsonobject.optInt("cache_duration", 3600);
        ...
        obj5 = new f(((JSONObject) (obj5)).optString("update_endpoint", t.a), ((JSONObject) (obj5)).optInt("update_suspend_duration", 3600));
        long l1 = l;
        ...
        return new s(l1, ((e) (obj)), ((p) (obj1)), ((o) (obj2)), ((m) (obj3)), ((b) (obj4)), ((f) (obj5)), i, l);
    }
}
