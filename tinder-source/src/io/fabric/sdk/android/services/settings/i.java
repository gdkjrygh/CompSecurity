    ...
    implements g
{
    ...
    public final JSONObject a()
    {
        ...
        obj2 = null;
        obj1 = null;
        c.a().a("Fabric", "Reading cached settings...");
...
_L2:
        c.a().a("Fabric", "No cached settings found.");
        obj = null;
...
_L8:
        obj1 = obj;
        c.a().c("Fabric", "Failed to fetch cached settings", ((Throwable) (obj2)));
...
_L7:
    ...
    {
        Object obj;
        c.a().a("Fabric", "Writing settings to cache file...");
        if (jsonobject == null)
        {
...
_L4:
        obj = jsonobject;
        c.a().c("Fabric", "Failed to cache settings", exception);
