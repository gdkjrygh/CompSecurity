...
final class a
{
    ...
    public static X509Certificate[] a(X509Certificate ax509certificate[], f f1)
        throws CertificateException
    {
        ...
        ax509certificate = f1.b(ax509certificate[i - 1]);
