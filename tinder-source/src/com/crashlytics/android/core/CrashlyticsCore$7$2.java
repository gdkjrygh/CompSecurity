...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (d.d)
            {
                CrashlyticsCore._cls7._cls2 _lcls2 = new CrashlyticsCore._cls7._cls2(this);
                DialogStringResolver dialogstringresolver = c;
                builder.setNegativeButton(dialogstringresolver.a("com.crashlytics.CrashSubmissionCancelTitle", dialogstringresolver.a.e), _lcls2);
            }
            if (d.f)
            {
