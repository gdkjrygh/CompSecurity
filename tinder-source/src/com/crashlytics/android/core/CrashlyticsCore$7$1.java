...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            CrashlyticsCore._cls7._cls1 _lcls1 = new CrashlyticsCore._cls7._cls1(this);
            ...
            obj1 = c;
            ((android.app.AlertDialog.Builder) (obj)).setNeutralButton(((DialogStringResolver) (obj1)).a("com.crashlytics.CrashSubmissionSendTitle", ((DialogStringResolver) (obj1)).a.c), _lcls1);
            if (d.d)
            {
                ...
                builder.setNegativeButton(dialogstringresolver.a("com.crashlytics.CrashSubmissionCancelTitle", dialogstringresolver.a.e), onclicklistener);
            }
            if (d.f)
            {
                ...
                builder.setPositiveButton(dialogstringresolver1.a("com.crashlytics.CrashSubmissionAlwaysSendTitle", dialogstringresolver1.a.g), onclicklistener1);
            }
            builder.show();
        }
