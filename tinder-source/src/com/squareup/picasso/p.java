...
final class p extends BitmapDrawable
{
    ...
    private p(Context context, Bitmap bitmap, Drawable drawable, Picasso.LoadedFrom loadedfrom, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, Picasso.LoadedFrom loadedfrom, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new p(context, bitmap, drawable, loadedfrom, flag, flag1));
    }
