...
final class k
{
    ...
    private static final String a = com/facebook/k.getSimpleName();
    private String b;
...
_L5:
    ...
    public final Bundle a()
    {
        ...
        do
        {
            ...
            {
                h.a(LoggingBehavior.d, 5, a, (new StringBuilder("Error reading cached value for key: '")).append(s).append("' -- ").append(obj).toString());
                return null;
            }
        } while (true);
        return ((Bundle) (obj));
