...
static interface 
{
    ...
    public abstract l a(ah ah, Resources resources);

    public abstract l a(l l, Resources resources);

    public abstract l b(Resources resources);

    public abstract l b(ah ah, Resources resources);

    public abstract l c(ah ah, Resources resources);
}
