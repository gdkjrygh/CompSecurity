    ...
    implements af.b, aq.b
{
    ...
    public ap(Context context, Resources resources, TextView textview, q q1, e e1, com.google.android.m4b.maps.bw.g g1, bc bc1)
    {
        super(context);
        ...
        if (super.j == null)
        {
            super.j = new as.l(this);
        }
        if (super.k == null)
        {
            super.k = new as.c(this, (byte)0);
        }
        if (super.l == null)
        {
            super.l = new as.f((byte)0);
        }
        super.i = context;
        super.h = new as.h(super.g);
        super.h.start();
        super.h.a(0);
    }
