...
_L8:
            ...
            throws Throwable
        {
            if (!c)
            {
                ...
                ez.c("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
...
_L3:
        ...
        if (aobj[i].getClass().equals(com/google/android/gms/internal/ez)) goto _L2; else goto _L1
_L1:
