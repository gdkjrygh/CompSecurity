...
public class dc extends WebChromeClient
{
    ...
    private static Context a(WebView webview)
    {
        ...
        {
            cw cw1 = (cw)webview;
            Activity activity = cw1.c();
            webview = activity;
            if (activity == null)
            {
                return cw1.getContext();
            }
        }
        return webview;
    }
    ...
    protected final void a(View view, int i, android.webkit.WebChromeClient.CustomViewCallback customviewcallback)
    {
        ...
        {
            zzd1.h = new FrameLayout(zzd1.b);
            zzd1.h.setBackgroundColor(0xff000000);
            zzd1.h.addView(view, -1, -1);
            zzd1.b.setContentView(zzd1.h);
            zzd1.o = true;
            zzd1.i = customviewcallback;
            zzd1.g = true;
            zzd1.a(i);
            return;
        }
...
_L1:
        d.c();
        if (cl.a(a.getContext().getPackageManager(), a.getContext().getPackageName(), "android.permission.ACCESS_FINE_LOCATION")) goto _L4; else goto _L3
_L3:
        d.c();
        if (!cl.a(a.getContext().getPackageManager(), a.getContext().getPackageName(), "android.permission.ACCESS_COARSE_LOCATION")) goto _L5; else goto _L4
_L4:
        boolean flag = true;
_L7:
