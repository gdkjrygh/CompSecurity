    ...
    implements Thread.UncaughtExceptionHandler
{
    ...
    private static boolean a(String s)
    {
        ...
        try
        {
            flag = Class.forName(s).isAnnotationPresent(com/google/android/gms/internal/cd);
        }
        catch (Exception exception)
        {
            com.google.android.gms.ads.internal.util.client.b.a((new StringBuilder("Fail to check class type for class ")).append(s).toString(), exception);
            return false;
        }
        return flag;
    }
    ...
    {
        r r = v.g;
        if (((Boolean)com.google.android.gms.ads.internal.d.i().a(r)).booleanValue()) goto _L2; else goto _L1
_L1:
        return;
_L2:
        r r1 = v.h;
        if (!((Boolean)com.google.android.gms.ads.internal.d.i().a(r1)).booleanValue())
        {
...
_L4:
        if (throwable != null)
        {
            ...
            arraylist.add(throwable.appendQueryParameter("device", com.google.android.gms.internal.cl.b()).appendQueryParameter("js", d.b).appendQueryParameter("appid", c.getApplicationContext().getPackageName()).appendQueryParameter("stacktrace", stringwriter.toString()).appendQueryParameter("eids", TextUtils.join(",", v.a())).appendQueryParameter("trapped", String.valueOf(flag)).toString());
            com.google.android.gms.ads.internal.d.c();
            cl.a(c, d.b, arraylist, com.google.android.gms.ads.internal.d.f().b());
            return;
        }
