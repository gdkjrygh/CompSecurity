...
_L6:
    ...
    public static final class a.a.a extends ex
    {
...
label0:
        ...
        public final boolean equals(Object obj)
        {
            if (obj != this)
            {
                ...
                if (!fc.a(i, ((a.a.a) (obj)).i))
                {
                    return false;
                }
                if (!fc.a(j, ((a.a.a) (obj)).j))
                {
                    return false;
                }
                if (!fc.a(k, ((a.a.a) (obj)).k))
                {
                    return false;
                }
                if (!fc.a(l, ((a.a.a) (obj)).l))
                {
                    return false;
                }
                if (!fc.a(m, ((a.a.a) (obj)).m))
                {
                    return false;
                }
                if (n != ((a.a.a) (obj)).n)
                ...
                if (o == null || o.c())
                {
                    if (((a.a.a) (obj)).o != null && !((a.a.a) (obj)).o.c())
                    {
                        return false;
                    }
                } else
                {
                    return o.equals(((a.a.a) (obj)).o);
                }
            }
            return true;
        }
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (o == null || o.c())
            {
                if (((ev) (obj)).o != null && !((ev) (obj)).o.c())
                {
                    return false;
                }
            } else
            {
                return o.equals(((ev) (obj)).o);
            }
        }
        return true;
    }
