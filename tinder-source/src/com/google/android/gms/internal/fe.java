...
public final class fe
{
    ...
    public static String a(fd fd1)
    {
        ...
        try
        {
            a(null, fd1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (fd fd1)
        {
            return (new StringBuilder("Error printing proto: ")).append(fd1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (fd fd1)
        {
...
_L1:
        if (!(obj instanceof fd)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
