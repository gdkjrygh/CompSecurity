...
_L4:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            a1 = com.google.android.gms.dynamic.a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                obj = AdSizeParcel.CREATOR;
                obj = h.a(parcel);
            }
            parcel = a(a1, ((AdSizeParcel) (obj)), parcel.readString(), com.google.android.gms.internal..a(parcel.readStrongBinder()), parcel.readInt());
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManagerCreator");
            a2 = com.google.android.gms.dynamic.a(parcel.readStrongBinder());
            obj = a1;
            break;
        }
        if (parcel.readInt() != 0)
        ...
        parcel = a(a2, ((AdSizeParcel) (obj)), parcel.readString(), com.google.android.gms.internal..a(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
        parcel1.writeNoException();
        parcel1.writeStrongBinder(parcel);
        return true;
    }
