...
public abstract class com.google.android.gms.common.images.a
{
    ...
    public static final class b extends com.google.android.gms.common.images.a
    {
        ...
        public final boolean equals(Object obj)
        {
            ...
            return a2 != null && a1 != null && t.a(a2, a1) && t.a(((b) (obj)).a, a);
        }
    ...
    final void a(Context context, du du1)
    {
        if (b != 0)
        {
            int i = b;
            ...
            if (c > 0)
            {
                com.google.android.gms.internal.du.a a1 = new com.google.android.gms.internal.du.a(i, c);
                if ((Drawable)du1.b(a1) == null)
                {
                    ...
                    if ((c & 1) != 0)
                    {
                        ...
                        context = new BitmapDrawable(resources, dt.a(context));
                    }
                    du1.a(a1, context);
                }
            } else
