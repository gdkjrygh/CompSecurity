    ...
    implements SafeParcelable
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (c != ((ConnectionResult) (obj)).c || !t.a(d, ((ConnectionResult) (obj)).d) || !t.a(e, ((ConnectionResult) (obj)).e))
            {
                return false;
            }
        }
    ...
    {
        return t.a(this).a("statusCode", a(c)).a("resolution", d).a("message", e).toString();
    }

    public final void writeToParcel(Parcel parcel, int i)
    {
        com.google.android.gms.common.e.a(this, parcel, i);
    }
