...
public final class b
{
    ...
    public static Dialog a(Activity activity, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        ...
        ((android.app.AlertDialog.Builder) (obj)).setMessage(activity.getResources().getString(com.google.android.gms.a.b.common_google_play_services_updating_text, new Object[] {
            obj1
        }));
        ((android.app.AlertDialog.Builder) (obj)).setTitle(com.google.android.gms.a.b.common_google_play_services_updating_title);
    ...
    public static Intent a(Context context, int i, String s)
    {
        ...
        case 1: // '\001'
        case 2: // '\002'
            return n.a("com.google.android.gms", b(context, s));
