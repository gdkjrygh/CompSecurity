...
//            y, AddListenerRequest, RemoveListenerRequest, AncsNotificationParcelable, 
//            w, v
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w2 = a(parcel.readStrongBinder());
            obj = w15;
            if (parcel.readInt() != 0)
            {
        ...
        case 7: // '\007'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w3 = a(parcel.readStrongBinder());
            obj = obj2;
            if (parcel.readInt() != 0)
            {
        ...
        case 9: // '\t'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w4 = a(parcel.readStrongBinder());
            obj = obj3;
            if (parcel.readInt() != 0)
            {
                obj = (Uri)Uri.CREATOR.createFromParcel(parcel);
        ...
        case 40: // '('
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w5 = a(parcel.readStrongBinder());
            obj = obj4;
            if (parcel.readInt() != 0)
            {
                obj = (Uri)Uri.CREATOR.createFromParcel(parcel);
        ...
        case 11: // '\013'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w6 = a(parcel.readStrongBinder());
            obj = obj5;
            if (parcel.readInt() != 0)
            {
                obj = (Uri)Uri.CREATOR.createFromParcel(parcel);
        ...
        case 41: // ')'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w7 = a(parcel.readStrongBinder());
            obj = obj6;
            if (parcel.readInt() != 0)
            {
                obj = (Uri)Uri.CREATOR.createFromParcel(parcel);
        ...
        case 13: // '\r'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w8 = a(parcel.readStrongBinder());
            obj = obj7;
            if (parcel.readInt() != 0)
            {
        ...
        case 16: // '\020'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w9 = a(parcel.readStrongBinder());
            obj = obj8;
            if (parcel.readInt() != 0)
            {
        ...
        case 17: // '\021'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w10 = a(parcel.readStrongBinder());
            obj = obj9;
            if (parcel.readInt() != 0)
            {
        ...
        case 27: // '\033'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w11 = a(parcel.readStrongBinder());
            obj = obj10;
            if (parcel.readInt() != 0)
            {
        ...
        case 38: // '&'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w12 = a(parcel.readStrongBinder());
        ...
        case 39: // '\''
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w13 = a(parcel.readStrongBinder());
        ...
        case 50: // '2'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w1 = a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                flag = true;
            }
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.wearable.internal.IWearableService");
            w w14 = a(parcel.readStrongBinder());
