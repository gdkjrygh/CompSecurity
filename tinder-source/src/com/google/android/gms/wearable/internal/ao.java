...
//            a, DeleteDataItemsResponse, al, PutDataResponse, 
//            SendMessageResponse
...
final class ao
{
    static abstract class a extends com.google.android.gms.wearable.internal.a
    {
        ...
        {
            com.google.android.gms.internal.dg.b b1 = a;
            if (b1 != null)
            {
                b1.a(obj);
                a = null;
        ...
        public a(com.google.android.gms.internal.dg.b b1)
        {
            a = b1;
        }
    }
    ...
    static final class b extends a
    {
        ...
        {
            a(new bi.b(al.a(deletedataitemsresponse.b), deletedataitemsresponse.c));
        }

        public b(com.google.android.gms.internal.dg.b b1)
        {
            super(b1);
        }
    }
    ...
    static final class d extends a
    {
        ...
        {
            a(new bi.a(al.a(putdataresponse.b), putdataresponse.c));
        ...
        d(com.google.android.gms.internal.dg.b b1, List list)
        {
            super(b1);
            a = list;
        }
    ...
    static final class e extends a
    {
        ...
        {
            a(new aa.b(al.a(sendmessageresponse.b), sendmessageresponse.c));
        }

        public e(com.google.android.gms.internal.dg.b b1)
        {
            super(b1);
        }
    }
