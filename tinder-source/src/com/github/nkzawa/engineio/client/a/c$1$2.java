    ...
    implements Runnable
{
    ...
    final com.squareup.okhttp.ws.ket.PayloadType a;
    final pe b;

    public final void run()
    {
        com.github.nkzawa.engineio.client.a.c.a(b.b, (new StringBuilder("Unknown payload type: ")).append(a).toString(), new IllegalStateException());
    }

    pe(pe pe, com.squareup.okhttp.ws.ket.PayloadType payloadtype)
    {
        b = pe;
        a = payloadtype;
        super();
...
/* anonymous class */
        ...
        implements b
    {
        ...
        {
            com.github.nkzawa.f.a.a(new c._cls1._cls5(ioexception));
        }
        ...
        //                       2 75;
               goto _L1 _L2 _L3
_L1:
            com.github.nkzawa.f.a.a(new c._cls1._cls2(this, payloadtype));
            payloadtype = obj;
_L5:
            e1.close();
...
/* anonymous class */
        ...
        // Unreferenced inner class com/github/nkzawa/engineio/client/a/c$1$5

/* anonymous class */
        final class c._cls1._cls5
            implements Runnable
        {
