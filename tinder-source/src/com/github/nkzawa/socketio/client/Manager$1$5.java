        ...
        implements Runnable
    {
        ...
        public final void run()
        {
            ...
            if (Manager.g(b) >= 0L)
            {
                ...
                timer.schedule(new Manager._cls1._cls4(l, a1, socket, manager), l);
                Manager.h(b).add(new Manager._cls1._cls5(this, timer));
            }
            Manager.h(b).add(a1);
            Manager.h(b).add(a2);
...
/* anonymous class */
        ...
        // Unreferenced inner class com/github/nkzawa/socketio/client/Manager$1$4

/* anonymous class */
        final class Manager._cls1._cls4 extends TimerTask
        {
            ...
            final Socket c;
            final Manager d;
            final Manager._cls1 e;

            public final void run()
            {
                com.github.nkzawa.f.a.a(new Manager._cls1._cls4._cls1(this));
            }

                    
                    {
                        e = Manager._cls1.this;
                        a = l;
                        b = a1;
                        c = socket;
                        d = manager;
        ...
        // Unreferenced inner class com/github/nkzawa/socketio/client/Manager$1$4$1

/* anonymous class */
        final class Manager._cls1._cls4._cls1
            implements Runnable
        {
