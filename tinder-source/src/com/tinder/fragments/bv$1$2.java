...
/* anonymous class */
        ...
        implements ak
    {
        ...
        public final void a()
        {
            ...
            bv.b(a).b.post(new bv._cls1._cls1());
            bv.b(a).b.postDelayed(new bv._cls1._cls2(this), 300L);
        }
        ...
        // Unreferenced inner class com/tinder/fragments/bv$1$1

/* anonymous class */
        final class bv._cls1._cls1
            implements Runnable
        {
