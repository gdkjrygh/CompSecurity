        ...
        implements android.view.View.OnClickListener
    {
        ...
        public final void onClick(View view)
        {
            ...
            if (FragmentUsername.c(a).isEmpty())
            {
                ...
                z z1 = a.a;
                FragmentUsername._cls2._cls1 _lcls1 = new FragmentUsername._cls2._cls1(this, view);
                view = new com.tinder.a.a(1, z1.a.T, com.tinder.a.a.k(), z.b(view), _lcls1);
                ManagerApp.b().a(view);
            } else
            {
                com.tinder.managers.a.a("DeepLink.ChangeID");
                z z2 = a.a;
                ax ax1 = new FragmentUsername._cls2._cls2(view);
                view = new com.tinder.a.a(2, z2.a.V, com.tinder.a.a.k(), z.b(view), ax1);
                ManagerApp.b().a(view);
            }
        ...
        // Unreferenced inner class com/tinder/fragments/FragmentUsername$2$2

/* anonymous class */
        final class FragmentUsername._cls2._cls2
            implements ax
        {
