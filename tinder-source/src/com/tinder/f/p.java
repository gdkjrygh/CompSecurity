    ...
    implements a
{
    ...
    private p(m m, a.a.a a1, a.a.a a2, a.a.a a3, a.a.a a4, a.a.a a5, a.a.a a6)
    {
        if (!a && m == null)
        {
    ...
    {
        return new p(m, a1, a2, a3, a4, a5, a6);
    }

    public final Object a()
    {
        return new d((ae)c.a(), (UserParse)d.a(), (z)e.a(), (c)f.a(), (f)g.a(), (com.tinder.d.a)h.a());
    }

    static 
    {
        boolean flag;
        if (!com/tinder/f/p.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
