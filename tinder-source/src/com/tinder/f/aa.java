    ...
    implements a
{
    ...
    private aa(m m, a.a.a a1, a.a.a a2, a.a.a a3, a.a.a a4, a.a.a a5, a.a.a a6)
    {
        if (!a && m == null)
        {
    ...
    {
        return new aa(m, a1, a2, a3, a4, a5, a6);
    }

    public final Object a()
    {
        return new com.tinder.managers.aa((d)c.a(), (ae)d.a(), (h)e.a(), (f)f.a(), (ab)g.a(), (c)h.a());
    }

    static 
    {
        boolean flag;
        if (!com/tinder/f/aa.desiredAssertionStatus())
        {
            flag = true;
        } else
        {
