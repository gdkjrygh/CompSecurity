...
class dapter extends AnimatorListenerAdapter
{
    ...
    {
        MatchListLayout.access$300(MatchListLayout.this).setVisibility(8);
        MatchListLayout.access$502(MatchListLayout.this, false);
    }

    public void onAnimationStart(Animator animator)
    {
        MatchListLayout.access$400(MatchListLayout.this).setVisibility(0);
