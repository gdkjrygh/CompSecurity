...
final class a extends WebViewClient
{
    ...
    public final void onPageFinished(WebView webview, String s)
    {
        ...
        if (!com.tinder.activities.ActivityCallToActionBrowser.e(a))
        {
            ...
            ActivityCallToActionBrowser.i(a).post(new Runnable() {
            ...
            {
                a = ActivityCallToActionBrowser._cls3.this;
                super();
            }
            });
    ...
    {
        com.tinder.activities.ActivityCallToActionBrowser.a(a, ilToLoadReason.d);
    }

    public final void onReceivedHttpAuthRequest(WebView webview, HttpAuthHandler httpauthhandler, String s, String s1)
    {
        com.tinder.activities.ActivityCallToActionBrowser.a(a, com.tinder.activities.ilToLoadReason.e);
    }

    public final void onReceivedSslError(WebView webview, SslErrorHandler sslerrorhandler, SslError sslerror)
    {
        com.tinder.activities.ActivityCallToActionBrowser.a(a, ilToLoadReason.f);
    }

    public final void onTooManyRedirects(WebView webview, Message message, Message message1)
    {
        com.tinder.activities.ActivityCallToActionBrowser.a(a, com.tinder.activities.ilToLoadReason.g);
    }
...
_L4:
    ...
    _cls1.a(ActivityCallToActionBrowser activitycalltoactionbrowser)
    {
