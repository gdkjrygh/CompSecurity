...
final class t> extends u
{
    ...
    // Unreferenced inner class com/tinder/managers/z$8

/* anonymous class */
    final class z._cls8 extends AsyncTask
    {
        ...
        {
            Object obj;
            obj = (new com.squareup.okhttp.t.a()).a(e.a.e).a("DELETE", new z._cls8._cls1(this)).b("User-Agent", f.a);
            ManagerApp.h().g();
