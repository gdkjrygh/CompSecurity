        ...
        implements com.android.volley.i.a
    {
        ...
        public final void a(VolleyError volleyerror)
        {
            ...
            if (!TextUtils.isEmpty(s) && s.contains("you must have a registered position before getting recs"))
            {
                a.a(false);
                a.d = false;
                ManagerApp.h().l().a(new ab._cls12._cls1(), true);
                return;
            }
            if (i == 403)
            {
            ...
            {
                a.o.a(volleyerror.getMessage(), new ab._cls12._cls2(this));
                return;
            }
        }
        ...
        // Unreferenced inner class com/tinder/managers/ab$12$1

/* anonymous class */
        final class ab._cls12._cls1
            implements z
        {
