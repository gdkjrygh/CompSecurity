...
class a extends ArrayList
{
    ...
    // Unreferenced inner class com/tinder/managers/ManagerLiveRail$2

/* anonymous class */
    final class ManagerLiveRail._cls2
...
_L3:
            ...
            for (obj = (new ManagerLiveRail._cls2._cls1(this)).iterator(); ((Iterator) (obj)).hasNext();)
            {
