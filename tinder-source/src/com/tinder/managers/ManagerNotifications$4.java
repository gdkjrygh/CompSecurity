...
_L10:
        ...
        d.g.add(toast);
        toast.show();
        textview.setOnClickListener(new android.view.View.OnClickListener(toast) {

            final Toast a;
            final ManagerNotifications._cls4 b;
            ...
            {
                b = ManagerNotifications._cls4.this;
                a = toast;
                super();
            }
        });
...
_L9:
    ...
    tificationType(ManagerNotifications managernotifications, String s, tificationType tificationtype, String s1)
    {
