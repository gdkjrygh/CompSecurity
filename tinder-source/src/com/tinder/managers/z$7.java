...
final class it> extends AsyncTask
{
    ...
    {
        Object obj;
        obj = (new com.squareup.okhttp.<init>()).a(i.a.e).a("DELETE", new u() {
    ...
    Photo(z z1, JSONObject jsonobject, boolean flag, boolean flag1, int j, int k, String s1, 
            y y1, ProfilePhoto profilephoto)
    {
        i = z1;
        a = jsonobject;
        b = flag;
