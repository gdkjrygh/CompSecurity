...
{
    class AsyncInAppMessageDisplayer extends AsyncTask
    {
...
_L2:
            try
            {
                AppboyLogger.w(AppboyInAppMessageManager.TAG, (new StringBuilder("Fresco disk prefetch failed with cause: ")).append(datasource.getFailureCause().getMessage()).append(" with image url: ").append(s).toString());
            }
        ...
        protected void onPostExecute(IInAppMessage iinappmessage)
        {
            ...
            {
                mActivity.runOnUiThread(iinappmessage. new Runnable() {
            ...
            {
                this$1 = final_asyncinappmessagedisplayer;
                inAppMessage = IInAppMessage.this;
                super();
            }
                });
                return;
        ...
        void prepareInAppMessageWithHtml(IInAppMessage iinappmessage)
        {
            ...
            if (!StringUtils.isNullOrBlank(s))
            {
                AppboyLogger.d(AppboyInAppMessageManager.TAG, (new StringBuilder("Local url for html in-app message is ")).append(s).toString());
...
_L2:
    ...
    final AsyncInAppMessageDisplayer createAsyncInAppMessageDisplayer()
    {
        return new AsyncInAppMessageDisplayer();
    }

    public final void hideCurrentInAppMessage(boolean flag)
    {
    ...
    public final void hideCurrentInAppMessage(boolean flag, boolean flag1)
    {
        InAppMessageViewWrapper inappmessageviewwrapper = mInAppMessageViewWrapper;
    ...
    public final void registerSlideupManager(Activity activity)
    {
    ...
    public final void setCustomHtmlInAppMessageActionListener(IHtmlInAppMessageActionListener ihtmlinappmessageactionlistener)
    {
        mCustomHtmlInAppMessageActionListener = ihtmlinappmessageactionlistener;
    }

    public final void setCustomInAppMessageAnimationFactory(IInAppMessageAnimationFactory iinappmessageanimationfactory)
    {
    ...
    public final void setCustomInAppMessageViewFactory(IInAppMessageViewFactory iinappmessageviewfactory)
    {
    ...
    public final void unregisterSlideupManager(Activity activity)
    {
