    ...
    implements IAction
{
    ...
    public final void execute(Context context)
    {
        ...
        if (mUseAppboyWebView)
        {
            ...
            if (mAppStore == AppStore.KINDLE_STORE)
            {
                obj = (new StringBuilder("http://www.amazon.com/gp/mas/dl/android?asin=")).append(mKindleId).toString();
            } else
            {
                obj = (new StringBuilder("https://play.google.com/store/apps/details?id=")).append(mPackageName).toString();
            }
        ...
        if (mAppStore == AppStore.KINDLE_STORE)
        {
            s = (new StringBuilder("amzn://apps/android?asin=")).append(mKindleId).toString();
        } else
        {
            s = (new StringBuilder("market://details?id=")).append(mPackageName).toString();
        }
