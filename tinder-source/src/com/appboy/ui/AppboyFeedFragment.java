...
public class AppboyFeedFragment extends t
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        mFeedUpdatedSubscriber = new IEventSubscriber() {
            ...
            public void trigger(FeedUpdatedEvent feedupdatedevent)
            {
                ...
                {
                    i.runOnUiThread(feedupdatedevent. new Runnable() {
                        ...
                        public void run()
                        {
                            AppboyLogger.d(AppboyFeedFragment.TAG, (new StringBuilder("Updating feed views in response to FeedUpdatedEvent: ")).append(event).toString());
