    ...
    implements Runnable
{
    ...
    public void run()
    {
        AppboyLogger.d(AppboyXamarinFormsFeedFragment.access$700(), (new StringBuilder("Updating feed views in response to FeedUpdatedEvent: ")).append(val$event).toString());
