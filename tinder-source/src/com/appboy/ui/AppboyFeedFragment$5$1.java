    ...
    implements Runnable
{
    ...
    public void run()
    {
        AppboyLogger.d(AppboyFeedFragment.access$700(), (new StringBuilder("Updating feed views in response to FeedUpdatedEvent: ")).append(val$event).toString());
...
/* anonymous class */
        ...
        implements IEventSubscriber
    {
        ...
        public void trigger(FeedUpdatedEvent feedupdatedevent)
        {
            ...
            {
                i.runOnUiThread(feedupdatedevent. new AppboyFeedFragment._cls5._cls1());
                return;
            }
        }
