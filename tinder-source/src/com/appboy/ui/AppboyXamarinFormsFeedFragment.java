    ...
    implements android.support.v4.widget.SwipeRefreshLayout.a
{
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        mFeedUpdatedSubscriber = new IEventSubscriber() {
            ...
            public void trigger(FeedUpdatedEvent feedupdatedevent)
            {
                ...
                {
                    activity.runOnUiThread(feedupdatedevent. new Runnable() {
                        ...
                        public void run()
                        {
                            AppboyLogger.d(AppboyXamarinFormsFeedFragment.TAG, (new StringBuilder("Updating feed views in response to FeedUpdatedEvent: ")).append(event).toString());
                            ...
                            {
                                AppboyLogger.i(AppboyXamarinFormsFeedFragment.TAG, String.format("Feed received was older than the max time to live of %d seconds, displaying it for now, but requesting an updated view from the server.", new Object[] {
                                    Integer.valueOf(60)
                                }));
                                mAppboy.requestFeedRefresh();
                                if (event.getCardCount(mCategories) == 0)
                                {
                                    AppboyLogger.d(AppboyXamarinFormsFeedFragment.TAG, String.format("Old feed was empty, putting up a network spinner and registering the network error message on a delay of %dms.", new Object[] {
    ...
    public void onAttach(Activity activity)
    {
        ...
        mGestureDetector = new e(activity, new FeedGestureListener());
    }
...
_L5:
    ...
    static 
    {
        TAG = String.format("%s.%s", new Object[] {
            Constants.APPBOY_LOG_TAG_PREFIX, com/appboy/ui/AppboyXamarinFormsFeedFragment.getName()
        });
    }
