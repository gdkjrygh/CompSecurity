...
public class XmlAppConfigurationProvider extends CachedConfigurationProvider
{
    ...
    public cs getAppboyApiKey()
    {
        cs cs2 = (cs)mConfigurationCache.get("com_appboy_api_key");
        cs cs1 = cs2;
        if (cs2 == null)
        {
            ...
            {
                cs1 = new cs(s);
                mConfigurationCache.put("com_appboy_api_key", cs1);
            }
        }
        if (cs1 == null)
        {
...
_L1:
        ...
        return null;
_L2:
        if ((as = readStringArrayResourceValue("com_appboy_locale_api_key_map", null)) != null)
        {
            int j = as.length;
            int i = 0;
            while (i < j) 
