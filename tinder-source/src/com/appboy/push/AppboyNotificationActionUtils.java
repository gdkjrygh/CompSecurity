...
{
    private static class ShareTask extends AsyncTask
    {
...
label0:
    ...
    private static void addNotificationAction(Context context, android.support.v4.app.aa.d d, Bundle bundle, int i)
    {
        ...
        context = new android.support.v4.app.aa.a.a(getIconDrawableResourceId(context, s), bundle, ((PendingIntent) (obj)));
        bundle = new Bundle(bundle1);
        ((android.support.v4.app.aa.a.a) (context)).a.putAll(bundle);
        d.addAction(context.a());
    }

    public static void addNotificationActions(Context context, android.support.v4.app.aa.d d, Bundle bundle)
    {
...
_L5:
        ...
        addNotificationAction(context, d, bundle, i);
        i++;
...
_L1:
    ...
    private static void logNotificationActionClicked(Context context, Intent intent)
    {
        ...
        {
            AppboyLogger.i(TAG, String.format((new StringBuilder("Logging push action click to Appboy. Campaign Id: ")).append(s).append(" Action Button Id: ").append(intent).toString(), new Object[0]));
