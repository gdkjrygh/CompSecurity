...
public class ActionMenuItemView extends AppCompatTextView
    implements android.support.v7.internal.view.menu.y, h, android.view.View.OnClickListener, android.view.View.OnLongClickListener
{
...
label0:
    ...
    public boolean onLongClick(View view)
    {
        ...
        {
            view.setGravity(0x800035, i1, (ai[1] + k1) - rect.top);
        } else
        {
