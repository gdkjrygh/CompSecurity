    ...
    implements az, bb
{
    ...
    private android.support.v4.widget.bc c;
    private ae d;
    private ae e;
    private int f;
    private boolean g;
    ...
    private NestedScrollView(Context context, AttributeSet attributeset, byte byte0)
    {
        ...
        r = new int[2];
        s = new int[2];
        c = new android.support.v4.widget.bc(getContext(), null);
        setFocusable(true);
        ...
        context = context.obtainStyledAttributes(attributeset, w, 0, 0);
    ...
    private void a(int i1, int j1)
    {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - a > 250L)
        {
            ...
            android.support.v4.widget.bc bc1 = c;
            k1 = getScrollX();
            bc1.b.a(bc1.a, k1, i1, j1 - i1);
            bt.b(this);
        } else
        {
            if (!c.a())
