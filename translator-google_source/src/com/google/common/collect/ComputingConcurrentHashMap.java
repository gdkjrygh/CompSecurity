...
class ComputingConcurrentHashMap extends MapMakerInternalMap
{
    ...
    ComputingConcurrentHashMap(MapMaker mapmaker, d d1)
    {
        super(mapmaker);
    ...
    private class ComputingSegment extends MapMakerInternalMap.Segment
    {
...
_L3:
        ...
        final Object getOrCompute(Object obj, int i, d d1)
        {
_L19:
...
_L10:
    ...
    private class ComputingSerializationProxy extends MapMakerInternalMap.AbstractSerializationProxy
    {
        ...
        ComputingSerializationProxy(MapMakerInternalMap.Strength strength, MapMakerInternalMap.Strength strength1, Equivalence equivalence, Equivalence equivalence1, long l, long l1, int i, int j, bu bu, ConcurrentMap concurrentmap, d d1)
        {
            super(strength, strength1, equivalence, equivalence1, l, l1, i, j, bu, concurrentmap);
            computingFunction = d1;
        }
    }
