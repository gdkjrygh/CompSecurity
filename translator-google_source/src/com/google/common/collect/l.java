    ...
    implements SortedSet
{
    ...
    l(AbstractMapBasedMultimap abstractmapbasedmultimap, SortedMap sortedmap)
    {
    ...
    {
        return new l(b, ((SortedMap)super.c).headMap(obj));
    }
    ...
    {
        return new l(b, ((SortedMap)super.c).subMap(obj, obj1));
    }

    public final SortedSet tailSet(Object obj)
    {
        return new l(b, ((SortedMap)super.c).tailMap(obj));
    }
}
