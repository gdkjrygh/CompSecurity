...
public abstract class axp extends Binder
    implements axo
{
    ...
    public static axo a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof axo))
        {
            return (axo)iinterface;
        } else
        {
            return new axq(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(aus.a(parcel.readStrongBinder()));
