    ...
    implements icg
{
    ...
    final SurgeActivityDeprecated a;

    private foo(SurgeActivityDeprecated surgeactivitydeprecated)
    {
        a = surgeactivitydeprecated;
        super();
    }

    public foo(SurgeActivityDeprecated surgeactivitydeprecated, byte byte0)
    {
        this(surgeactivitydeprecated);
    }
    ...
    private DynamicFare b()
    {
        ...
        if (obj != null)
        {
            dynamicfare = (DynamicFare)((Map) (obj)).get(SurgeActivityDeprecated.a(a));
        }
        return dynamicfare;
    }
