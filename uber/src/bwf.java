...
public class bwf extends bui
{

    private static final String a = bwf.getSimpleName();
    private Map b;
    private String c;
    private String d;
    private String e;

    public bwf(buk buk, bus bus, String s, String s1, String s2)
    {
        buo buo1 = new buo(bup.l);
        ...
        super(buo1, buk, bus, stringbuilder.append(s3).toString(), (new StringBuilder("/")).append(s2).toString());
        b = new HashMap();
    ...
    private static void a(JSONArray jsonarray, Map map)
    {
        if (jsonarray != null)
        {
            for (int i = 0; i < jsonarray.length(); i++)
            {
                ...
                if (bwq.d(s) && bwq.d(((CharSequence) (obj))))
                {
                    map.put(s, obj);
                }
            }
