...
public abstract class bwk extends bwl
{
    ...
    public bwk(bup bup, buk buk, bus bus, String s, String s1, String s2, ca ca1, 
            Map map, bwj abwj[], String s3, boolean flag, String s4, String s5, String s6)
    {
        super(bup, buk, bus, s);
        a = s2;
        b = ca1;
...
_L2:
        ...
        if (d != null && d.length > 0)
        {
            ...
            jsonobject1.accumulate("items", bwj.a(d));
