...
public final class bwb extends bwl
{
    ...
    public bwb(buk buk, bus bus, String s, String s1, ca ca1, Map map, bwj abwj[], 
            String s2, String s3, String s4, String s5, boolean flag)
    {
        super(bup.h, buk, bus, s);
        f = ca1;
        g = map;
        h = abwj;
        i = s2;
        ...
        if (bwq.d(s3))
        {
            a("PayPal-Partner-Attribution-Id", s3);
        }
        if (bwq.d(s4))
        {
            a("PayPal-Client-Metadata-Id", s4);
        }
    }
...
_L2:
        ...
        if (h != null && h.length > 0)
        {
            ...
            jsonobject1.accumulate("items", bwj.a(h));
        ...
        jsonobject = new JSONObject();
        jsonobject.accumulate("device_info", bwq.a(bto.a().toString()));
        jsonobject.accumulate("app_info", bwq.a(btl.a().toString()));
        jsonobject.accumulate("risk_data", bwq.a(bqw.a().c().toString()));
        obj1 = new JSONObject();
