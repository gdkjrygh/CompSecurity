...
public class htz extends View
{

    private static final String a = htz.getSimpleName();
    ...
    public htz(CardIOActivity cardioactivity, boolean flag)
    {
        ...
        q = new hub(70F * w, 50F * w);
        r = new hts(cardioactivity);
        n.clearShadowLayer();
    ...
    public final void a(Rect rect, int i1)
    {
        ...
        if (p != null)
        {
            ...
            s = huc.a(new Point(p.left + ((Point) (rect)).x, p.top + ((Point) (rect)).y), (int)(70F * w), (int)(w * 50F));
            i1 = p.right;
            int j1 = ((Point) (rect)).x;
            int k1 = p.top;
            t = huc.a(new Point(i1 - j1, ((Point) (rect)).y + k1), (int)(100F * w), (int)(w * 50F));
    ...
    public final void a(DetectionInfo detectioninfo)
    {
        if (d != null)
        {
            DetectionInfo detectioninfo1 = d;
            boolean flag;
            if (detectioninfo.topEdge == detectioninfo1.topEdge && detectioninfo.bottomEdge == detectioninfo1.bottomEdge && detectioninfo.leftEdge == detectioninfo1.leftEdge && detectioninfo.rightEdge == detectioninfo1.rightEdge)
            {
                flag = true;
            } else
            {
    ...
    public final void c()
    {
        ...
        if (e != null)
        {
            ...
            int j1 = g.cardNumber.length();
            float f1 = (float)e.getWidth() / 428F;
            int k1 = (int)((float)g.yoff * f1 - 6F);
            while (i1 < j1) 
            {
                int l1 = (int)((float)g.xoff[i1] * f1);
                canvas.drawText((new StringBuilder()).append(g.cardNumber.charAt(i1)).toString(), l1, k1, paint);
                i1++;
            }
        }
    }
...
label0:
        {
            ...
            Rect rect = huc.a(motionevent, 20, 20);
