...
final class hz extends Drawable
{
    ...
    hz(Resources resources, int i1, float f1, float f2, float f3)
    {
        n = true;
        q = true;
        r = false;
        o = resources.getColor(bo.cardview_shadow_start_color);
        p = resources.getColor(bo.cardview_shadow_end_color);
        b = resources.getDimensionPixelSize(bp.cardview_compat_inset_shadow);
        d = new Paint(5);
        d.setColor(i1);
        e = new Paint(5);
