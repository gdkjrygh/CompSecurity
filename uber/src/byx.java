...
public final class byx
{
    ...
    public byx(Context context, byw byw1)
    {
        d = new ScrollView(context);
        d.setBackgroundColor(bul.d);
...
_L1:
        byw1 = null;
_L7:
        webview.loadData(stringbuilder.append(byw1).append("</body><html>").toString(), "text/html; charset=UTF-8", null);
        webview.setClickable(true);
        linearlayout.addView(webview);
        bum.a(webview, -1, -2);
        bum.b(webview, null, null, null, "10dip");
        c = new Button(context);
        linearlayout.addView(c);
        bum.a(c, true, context);
        bum.b(c, null, "20dip", null, "4dip");
        a = d;
        return;
_L2:
        String s2 = bux.a(buz.am);
    ...
    "nl", "de", "it", "fr", "gb", "us"
        ...
        {
            byw1 = String.format("https://www.paypal.com/%s/webapps/mpp/ua/useragreement-full", new Object[] {
                byw1
            });
        } else
        {
        ...
        byw1 = String.format(s2, new Object[] {
            byw1
        });
...
_L3:
        ...
        continue; /* Loop/switch isn't completed */
_L4:
        byw1 = String.format(bux.a(buz.aH), new Object[] {
            bux.a(buz.aG)
        });
        continue; /* Loop/switch isn't completed */
_L5:
