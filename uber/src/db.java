    ...
    implements SupportMenuItem
{
    ...
    db(cx cx1, int i1, int j1, int k1, int l1, CharSequence charsequence, int i2)
    {
        k = 0;
        p = 16;
        q = 0;
    ...
    private SupportMenuItem a(int i1)
    {
        Context context = l.e();
    ...
    private SupportMenuItem b(int i1)
    {
        setShowAsAction(i1);
        return this;
    }

    public final CharSequence a(do do1)
    {
        if (do1 != null && do1.b())
        {
