    ...
    implements Parcelable
{
    ...
    public ce(bvv bvv1, g g1, String s)
    {
        a(g1, bvv1.a(bvu.e(s)));
    }

    public ce(bvv bvv1, String s)
    {
        a(bvv1.d(), bvv1.a(bvu.e(s)));
    }

    public static ce a(bvv bvv1, String s)
    {
        s = s.split("[|]");
        if (s.length != 2)
        {
        ...
        {
            return new ce(bvv1, new g(s[0]), s[1]);
        }
    }
    ...
    public final String a(bvv bvv1)
    {
        if (bvv1.b().equals(Locale.US))
        {
