...
//            PayPalPaymentDetails, PayPalItem, ShippingAddress

public final class PayPalPayment
    implements Parcelable
{

    public static final android.os.Parcelable.Creator CREATOR = new cbh();
    ...
    public PayPalPayment(Parcel parcel, byte byte0)
    {
        this(parcel);
    }
    ...
    {
        boolean flag;
        boolean flag4 = btm.a(c);
        boolean flag5 = btm.a(b, c, true);
        boolean flag6 = bwq.b(d);
        boolean flag1;
        boolean flag2;
        boolean flag3;
        if (bwq.d(g) && (g.equals("sale") || g.equals("authorize") || g.equals("order")))
        {
            flag1 = true;
        } else
        {
