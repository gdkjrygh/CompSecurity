...
//            PayPalPayment, ProofOfPayment

public final class PaymentConfirmation
    implements Parcelable
{

    public static final android.os.Parcelable.Creator CREATOR = new cbx();
    ...
    public PaymentConfirmation(Parcel parcel, byte byte0)
    {
        this(parcel);
    }

    public PaymentConfirmation(String s, PayPalPayment paypalpayment, ProofOfPayment proofofpayment)
    {
        b = s;
        c = paypalpayment;
        d = proofofpayment;
