...
public final class RealtimeTripBalancesAdapter extends BaseAdapter
{

    private List a;
    private LayoutInflater b;

    RealtimeTripBalancesAdapter(Context context)
    {
        a = new ArrayList();
    ...
    public final View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view1.setTag(new RealtimeTripBalancesViewHolder(view1));
        }
        ((RealtimeTripBalancesViewHolder)view1.getTag()).a(a(i));
        return view1;
    }
    ...
    private class RealtimeTripBalancesViewHolder
    {
