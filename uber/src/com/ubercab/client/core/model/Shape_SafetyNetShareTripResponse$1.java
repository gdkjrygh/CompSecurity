...
//            Shape_SafetyNetShareTripResponse, SafetyNetShareTripResponse

final class 
    implements android.os.hareTripResponse._cls1
{

    public final SafetyNetShareTripResponse createFromParcel(Parcel parcel)
    {
        return new Shape_SafetyNetShareTripResponse(parcel, null);
    }
