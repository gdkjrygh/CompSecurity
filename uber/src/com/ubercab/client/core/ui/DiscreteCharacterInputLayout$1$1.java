    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/ubercab/client/core/ui/DiscreteCharacterInputLayout$1

/* anonymous class */
    final class DiscreteCharacterInputLayout._cls1 extends hpb
    {
...
_L2:
            ...
            case 1: // '\001'
                DiscreteCharacterInputLayout.f(a).postDelayed(new DiscreteCharacterInputLayout._cls1._cls1(this), 500L);
                charsequence = DiscreteCharacterInputLayout.d(a).iterator();
