...
public abstract class awi extends Binder
    implements awh
{

    public static awh a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof awh))
        {
            return (awh)iinterface;
        } else
        {
            return new awj(ibinder);
        }
    }
