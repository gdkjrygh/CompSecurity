...
public abstract class ayu extends Binder
    implements ayt
{

    public static ayt a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ayt))
        {
            return (ayt)iinterface;
        } else
        {
            return new ayv(ibinder);
        }
    }
