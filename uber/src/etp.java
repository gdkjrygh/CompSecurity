    ...
    implements hsr
{
    ...
    private etp(hsr hsr1, hzb hzb1, hzb hzb2)
    {
        if (!a && hsr1 == null)
        {
    ...
    private void a(PaytmAddFundsActivity paytmaddfundsactivity)
    {
        ...
        } else
        {
            ...
            paytmaddfundsactivity.h = (chp)c.a();
            paytmaddfundsactivity.i = (czq)d.a();
            return;
        }
    }
