...
public final class bwq
{
    ...
    public static void a(Activity activity, TextView textview, String s, String s1, Drawable drawable)
    {
        ...
        if (b())
        {
            ...
            s1.setBackgroundDrawable(bul.c);
            s1.setTitle(s);
