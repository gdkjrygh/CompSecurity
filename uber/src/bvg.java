...
public final class bvg
{
    ...
    public bvg(Context context)
    {
        ...
        bum.a(f, "0dp");
        bum.a(f, 1, 0.5F);
        bum.a(f, "2dip", "5dip", "2dip", "5dip");
        k = new TextView(context);
        k.setTextSize(16F);
        k.setTypeface(bul.p);
        k.setGravity(51);
        k.setTextColor(bul.g);
        linearlayout.addView(k);
        bum.a(k, -2, -2);
        bum.a(k, "6dip", "2dip", "6dip", "2dip");
        bum.b(k, null, null, null, "10dip");
        o = new bvl(context);
        bum.b(o.a, null, null, null, "10dip");
        linearlayout.addView(o.a);
        l = new EditText(context);
        l.setId(43025);
        l.setInputType(2);
        l.setTextColor(bul.k);
        l.setTypeface(bul.s);
        ...
        bum.a(l, -1, -2);
        bum.b(l, null, null, null, "10dip");
        m = bum.a(context, true, 43026, linearlayout);
