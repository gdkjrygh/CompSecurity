...
public final class bvk extends ArrayAdapter
{

    private int a;

    public bvk(Context context, List list, int i)
    {
    ...
    public final View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        viewgroup = bum.a(viewgroup.getContext(), "20dip", "20dip", 9);
        viewgroup.addRule(0, 2303);
        relativelayout.addView(((View) (obj)), viewgroup);
        bum.b(((View) (obj)), "6dip", "6dip", "6dip", "6dip");
