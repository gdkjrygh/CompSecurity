...
_L1:
        ...
        if (bwq.a(((CharSequence) (obj1))))
        {
            obj1 = null;
        } else
        {
            obj1 = bta.valueOf(((String) (obj1)));
        }
        obj1 = new bB(s, ((ce) (obj)), ((bta) (obj1)));
        obj = obj2;
        if (((bB) (obj1)).d())
        {
            obj = obj1;
