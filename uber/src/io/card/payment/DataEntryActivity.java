    ...
    implements TextWatcher
{
    ...
    private void a()
    {
        ...
        if (f != null)
        {
            o.expiryMonth = ((htv)g).a;
            o.expiryYear = ((htv)g).b;
        }
    ...
    public static void a(DataEntryActivity dataentryactivity)
    {
        dataentryactivity.a();
    }
...
_L3:
    ...
    protected final void onCreate(Bundle bundle)
    {
        ...
        if (!r)
        {
            relativelayout.setBackgroundColor(bxa.c);
        }
        ...
        } else
        {
            ...
            if (!r)
            {
                c.setTextColor(bxa.a);
            }
            linearlayout1.addView(c);
            bxb.a(c, null, null, null, "8dip");
            bxb.a(c, -2);
            bundle = new LinearLayout(this);
            bundle.setOrientation(1);
            bxb.a(bundle, null, "4dip", null, "4dip");
            obj1 = new TextView(this);
            bxb.a(((android.view.View) (obj1)), q, null, null, null);
            ((TextView) (obj1)).setText(bxg.a(bxh.n));
            if (!r)
            {
                ((TextView) (obj1)).setTextColor(bxa.e);
            }
        ...
        bxb.a(linearlayout2, null, "4dip", null, null);
        ...
        if (flag)
        {
            ...
            if (!r)
            {
                ((TextView) (obj3)).setTextColor(bxa.e);
            }
            ((TextView) (obj3)).setText(bxg.a(bxh.j));
            bxb.a(((android.view.View) (obj3)), q, null, null, null);
            ...
            f.setInputType(3);
            f.setHint(bxg.a(bxh.k));
            if (o != null)
            {
                g = new htv(o.expiryMonth, o.expiryYear);
            } else
            {
                g = new htv();
            }
            ...
            bxb.b(((android.view.View) (obj)), null, null, bundle, null);
        } else
        {
            g = new htm();
        }
        if (flag1)
        {
            ...
            if (!r)
            {
                ((TextView) (obj)).setTextColor(bxa.e);
            }
            bxb.a(((android.view.View) (obj)), q, null, null, null);
            ((TextView) (obj)).setText(bxg.a(bxh.h));
            ...
            bxb.b(((android.view.View) (obj3)), bundle, null, ((String) (obj1)), null);
        } else
        {
            i = new htm();
        }
        if (flag2)
        {
            ...
            bxb.a(((android.view.View) (obj3)), q, null, null, null);
            ((TextView) (obj3)).setText(bxg.a(bxh.i));
            ...
            bxb.b(((android.view.View) (obj1)), bundle, null, null, null);
        } else
        {
            k = new htm();
        }
        ...
        bxb.b(linearlayout1, "16dip", "20dip", "16dip", "20dip");
        bundle = new LinearLayout(this);
        j1 = a;
        a = j1 + 1;
        bundle.setId(j1);
        ...
        m.setText(bxg.a(bxh.g));
        m.setOnClickListener(new htt(this));
        m.setEnabled(false);
        bundle.addView(m, ((android.view.ViewGroup.LayoutParams) (obj2)));
        bxb.a(m, true, this);
        bxb.a(m, "5dip", null, "5dip", null);
        bxb.b(m, "8dip", "8dip", "4dip", "8dip");
        m.setTextSize(16F);
        n = new Button(this);
        obj2 = new android.widget.LinearLayout.LayoutParams(-1, -2, 1.0F);
        n.setText(bxg.a(bxh.a));
        n.setOnClickListener(new htu(this));
        bundle.addView(n, ((android.view.ViewGroup.LayoutParams) (obj2)));
        bxb.a(n, false, this);
        bxb.a(n, "5dip", null, "5dip", null);
        bxb.b(n, "4dip", "8dip", "8dip", "8dip");
        n.setTextSize(16F);
        ...
        bqr.a(this, c, bxg.a(bxh.o), "card.io - ", bundle);
    }
