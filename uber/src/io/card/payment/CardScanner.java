...
_L3:
        i1 = j1;
        if (System.currentTimeMillis() - l1 < (long)j1) goto _L1; else goto _L2
_L2:
    ...
    final boolean a(SurfaceHolder surfaceholder)
    {
        ...
        if (m && l == null)
        {
            ...
            l = new byte[(ImageFormat.getBitsPerPixel(k.getParameters().getPreviewFormat()) / 8) * 0x4b000 * 3];
...
_L2:
    ...
    {
        ((CardIOActivity)d.get()).a(detectioninfo);
    }
...
_L3:
        ...
        if (h)
        {
            h = false;
            g = 1;
            ((CardIOActivity)d.get()).b();
        }
        detectioninfo = new DetectionInfo();
        nScanFrame(abyte0, 640, 480, g, detectioninfo, b, f);
        boolean flag;
...
_L6:
        ...
        (new StringBuilder("detected card: ")).append(detectioninfo.a());
        ((CardIOActivity)d.get()).a(b, detectioninfo);
