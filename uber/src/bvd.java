...
public final class bvd extends ArrayAdapter
{

    private int a;

    public bvd(Context context, ArrayList arraylist, int i)
    {
        super(context, 0, arraylist);
        a = i;
    }

    private static void a(Context context, RelativeLayout relativelayout, bvc bvc1)
    {
        Object obj1 = new LinearLayout(context);
        ((LinearLayout) (obj1)).setId(2304);
        char c = '\u0900';
        ((LinearLayout) (obj1)).setOrientation(0);
        Object obj = bum.a(1, 2301);
        ...
        bum.b(((TextView) (obj)), 83);
        ((LinearLayout) (obj1)).addView(((View) (obj)));
        bum.b(((View) (obj)), "6dip", null, null, null);
        TextView textview = new TextView(context);
        bum.c(textview, 83);
        ((LinearLayout) (obj1)).addView(textview);
        bum.b(textview, "6dip", null, "6dip", null);
        if (bvc1.e())
        {
            ...
            c = '\u0902';
            bum.c(((TextView) (obj1)));
            android.widget.RelativeLayout.LayoutParams layoutparams = bum.a(1, 2301);
            layoutparams.addRule(0, 2303);
            layoutparams.addRule(3, 2304);
            relativelayout.addView(((View) (obj1)), layoutparams);
            bum.b(((View) (obj1)), "6dip", null, null, null);
            ((TextView) (obj1)).setText(bux.a(buz.av));
        }
        obj1 = bvc1.f().iterator();
        int j = 2400;
        int i = 2500;
        while (((Iterator) (obj1)).hasNext()) 
        {
            Object obj2 = (bve)((Iterator) (obj1)).next();
            TextView textview1 = new TextView(context);
            textview1.setId(j);
            textview1.setText((new StringBuilder()).append(((bve) (obj2)).a()).append(" ").append(((bve) (obj2)).b()).toString());
            android.widget.RelativeLayout.LayoutParams layoutparams1 = bum.a(1, 2301);
            ...
            bum.c(textview1, 85);
            bum.b(textview1, "6dip", null, "6dip", null);
            j++;
            i++;
        }
        ((TextView) (obj)).setText(bvc1.c());
        ((TextView) (obj)).setEllipsize(android.text.TextUtils.TruncateAt.END);
        textview.setText(bvc1.d());
    ...
    public final View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view.g())
        {
            ...
            bum.b(viewgroup, "6dip", null, null, null);
            if (view.e())
            {
