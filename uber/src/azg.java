...
public abstract class azg extends Binder
    implements azf
{

    public static azf a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof azf))
        {
            return (azf)iinterface;
        } else
        {
            return new azh(ibinder);
        }
    }
