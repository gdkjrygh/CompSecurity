...
public class bmj
{
    ...
    public static bmj get(Class class1)
    {
        return new bmj(class1);
    }

    public static bmj get(Type type1)
    {
        return new bmj(type1);
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return bky.a(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L4:
    ...
    {
        return (obj instanceof bmj) && bky.a(type, ((bmj)obj).type);
    }
    ...
    public boolean isAssignableFrom(bmj bmj1)
    {
        return isAssignableFrom(bmj1.getType());
    }
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(bky.b(type1));
        }
        ...
        {
            return rawType.isAssignableFrom(bky.b(type1)) && isAssignableFrom(type1, (GenericArrayType)type);
        } else
        {
