...
public abstract class azd extends Binder
    implements azc
{

    public static azc a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof azc))
        {
            return (azc)iinterface;
        } else
        {
            return new aze(ibinder);
        }
    }
