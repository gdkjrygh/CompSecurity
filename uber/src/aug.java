...
public abstract class aug extends Binder
    implements auf
{

    public static auf a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof auf))
        {
            return (auf)iinterface;
        } else
        {
            return new auh(ibinder);
        }
    }
