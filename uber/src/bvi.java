...
public final class bvi
{
    ...
    public bvi(Context context)
    {
        ...
        if (bux.a)
        {
            ...
            bum.b(((android.view.View) (obj)), "4dip", "2.5dip", null, null);
            bum.a(((android.view.View) (obj)), -2, "28dip");
        }
        ...
        bum.b(((android.view.View) (obj)), null, null, null, "16dip");
        d = new TextView(context);
        d.setTextSize(14F);
        d.setTextColor(bul.l);
        d.setGravity(17);
        ((LinearLayout) (obj)).addView(d, new android.widget.LinearLayout.LayoutParams(-1, -2));
        bum.b(d, null, "8dip", null, "4dip");
        b = new Button(context);
        ((LinearLayout) (obj)).addView(b);
        bum.a(b);
        bum.a(b, -2, "24dip");
        bum.a(b, 17, 1.0F);
        h = bum.a(context, false, 42043, linearlayout);
