...
public final class htl extends Enum
{
    ...
    private static final htl m[];
    public final String j;

    private htl(String s, int i1, String s1)
    {
        super(s, i1);
        j = s1;
    }
...
_L3:
        ...
        htl1 = htl2;
        if (s.equalsIgnoreCase(htl2.toString())) goto _L6; else goto _L5
_L5:
        i1++;
          goto _L7
_L4:
    ...
    public static htl b(String s)
    {
        ...
        do
        {
            ...
            } else
            {
                ...
                if (hashset.size() == 1)
                {
                    return (htl)hashset.iterator().next();
                }
                return h;
            }
        } while (true);
    ...
    public static htl valueOf(String s)
    {
        return (htl)Enum.valueOf(htl, s);
    }
...
_L7:
    ...
    static 
    {
        a = new htl("AMEX", 0, "AmEx");
        b = new htl("DINERSCLUB", 1, "DinersClub");
        c = new htl("DISCOVER", 2, "Discover");
        d = new htl("JCB", 3, "JCB");
        e = new htl("MASTERCARD", 4, "MasterCard");
        f = new htl("VISA", 5, "Visa");
        g = new htl("MAESTRO", 6, "Maestro");
        h = new htl("UNKNOWN", 7, "Unknown");
        i = new htl("INSUFFICIENT_DIGITS", 8, "More digits required");
        m = (new htl[] {
            a, b, c, d, e, f, g, h, i
        });
        k = 1;
