...
public abstract class ayr extends Binder
    implements ayq
{

    public static ayq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof ayq))
        {
            return (ayq)iinterface;
        } else
        {
            return new ays(ibinder);
        }
    }
