...
public abstract class axg extends Binder
    implements axf
{

    public static axf a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof axf))
        {
            return (axf)iinterface;
        } else
        {
            return new axh(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        if (parcel.readInt() != 0)
        {
            azt azt1 = StreetViewPanoramaLocation.CREATOR;
            parcel = azt.a(parcel);
        } else
        {
            parcel = null;
