...
public abstract class ayf extends Binder
    implements aye
{

    public static aye a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof aye))
        {
            return (aye)iinterface;
        } else
        {
            return new ayg(ibinder);
        }
    }
