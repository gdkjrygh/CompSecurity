...
_L6:
    ...
    {
        if (ac1.b instanceof Number)
        {
            ac1 = (Number)ac1.b;
            return (ac1 instanceof BigInteger) || (ac1 instanceof Long) || (ac1 instanceof Integer) || (ac1 instanceof Short) || (ac1 instanceof Byte);
        } else
        {
            return false;
        }
...
_L3:
        ...
        if (b().longValue() != ((ac) (obj)).b().longValue())
        {
            return false;
        }
        if (true) goto _L1; else goto _L4
_L4:
        if ((b instanceof Number) && (((ac) (obj)).b instanceof Number))
        {
            double d1 = b().doubleValue();
            double d2 = ((ac) (obj)).b().doubleValue();
