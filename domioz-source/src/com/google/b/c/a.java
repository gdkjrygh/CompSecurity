...
public class a
{
    ...
    a(Type type1)
    {
        type = b.a((Type)com.google.b.b.a.a(type1));
        rawType = b.b(type);
        hashCode = type.hashCode();
    }
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return b.a(((ParameterizedType)class1).getActualTypeArguments()[0]);
        }
    }
...
_L4:
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(b.b(type1));
        }
        ...
        {
            return rawType.isAssignableFrom(b.b(type1)) && isAssignableFrom(type1, (GenericArrayType)type);
        } else
        {
