    ...
    implements bg
{
    ...
    public final void a(fl fl1, Map map)
    {
        ...
        {
            fl1.a("openableIntents", new JSONObject());
            return;
        }
        try
        {
...
label1:
            {
                ...
                {
                    fj.b("Error parsing the intent data.", jsonexception);
                    break label1;
                }
                ...
                {
                    fj.b("Error constructing openable urls response.", jsonexception1);
                }
            }
            i++;
        } while (true);
        fl1.a("openableIntents", jsonobject);
    }
}
