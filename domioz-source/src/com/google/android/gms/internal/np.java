...
public final class np
{
    ...
    public static String a(no no1)
    {
        ...
        try
        {
            a(null, no1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (no no1)
        {
            return (new StringBuilder("Error printing proto: ")).append(no1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (no no1)
        {
...
_L1:
        if (!(obj instanceof no)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
