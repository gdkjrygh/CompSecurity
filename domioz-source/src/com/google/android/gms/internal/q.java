...
public final class q
{
    ...
    private static String a(String as[], int i, int j)
    {
        if (as.length < i + j)
        {
            fj.b("Unable to construct shingle");
            return "";
        }
    ...
    private static void a(int i, long l, String s, PriorityQueue priorityqueue)
    {
        ...
        if ((priorityqueue.size() != i || ((r)priorityqueue.peek()).a <= ((r) (s)).a) && !priorityqueue.contains(s))
        {
            priorityqueue.add(s);
    ...
    {
        long l1 = ((long)o.a(as[0]) + 0x7fffffffL) % 0x4000ffffL;
        for (int k = 1; k < j + 0; k++)
        {
            l1 = ((l1 * 0x1001fffL) % 0x4000ffffL + ((long)o.a(as[k]) + 0x7fffffffL) % 0x4000ffffL) % 0x4000ffffL;
        }
