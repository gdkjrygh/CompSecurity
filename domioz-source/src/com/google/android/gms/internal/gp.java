    ...
    public static zziv.zzb a(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < j)
            {
                ...
                case 2: // '\002'
                    arraylist = com.google.android.gms.common.internal.safeparcel.a.c(parcel, k, zzjb.CREATOR);
                    break;
            ...
            {
                return new zziv.zzb(i, status, arraylist, as);
            }
        } while (true);
    }

    static void a(zziv.zzb zzb, Parcel parcel, int i)
    {
        int j = c.a(parcel);
        c.a(parcel, 1000, zzb.d);
        c.a(parcel, 1, zzb.a, i);
        c.c(parcel, 2, zzb.b);
        c.a(parcel, 3, zzb.c);
        c.a(parcel, j);
    }
