    ...
    implements a
{
    ...
    public final j a(float f, float f1)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
    ...
    public final j a(float f, int i, int j)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
    ...
    public final j a(CameraPosition cameraposition)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L1:
    ...
    public final j a(LatLngBounds latlngbounds, int i)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L1:
    ...
    public final j a(LatLngBounds latlngbounds, int i, int j, int l)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
