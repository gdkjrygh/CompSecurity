...
abstract class ag
{
    ...
    public ag(Context context, ah ah1)
    {
        a = context;
        b = ah1;
    }

    private af a(XmlResourceParser xmlresourceparser)
    {
        int i;
...
_L10:
        b.a(s, s2);
          goto _L4
        xmlresourceparser;
        h.a((new StringBuilder("Error parsing tracker configuration file: ")).append(xmlresourceparser).toString());
_L2:
        return b.a();
_L9:
...
_L14:
        ...
        h.a((new StringBuilder("Error parsing bool configuration value: ")).append(s).toString());
          goto _L4
        xmlresourceparser;
        h.a((new StringBuilder("Error parsing tracker configuration file: ")).append(xmlresourceparser).toString());
          goto _L2
...
_L17:
        ...
        b.a(numberformatexception, j);
          goto _L4
        numberformatexception;
        h.a((new StringBuilder("Error parsing int configuration value: ")).append(s).toString());
          goto _L4
    }
    ...
    public final af a(int i)
    {
        ...
        try
        {
            af = a(a.getResources().getXml(i));
        }
        catch (android.content.res.Resources.NotFoundException notfoundexception)
        {
            h.d((new StringBuilder("inflate() called with unknown resourceId: ")).append(notfoundexception).toString());
            return null;
        }
        return af;
    }
