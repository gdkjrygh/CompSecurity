    ...
    implements h
{
    ...
    {
        this(context, ip.c(), "google_tagmanager.db", ((Executor) (Executors.newSingleThreadExecutor())));
    }

    private bn(Context context, io io1, String s, Executor executor)
    {
        c = context;
        e = io1;
        f = 2000;
...
_L4:
    ...
    private void a(long l)
    {
        ...
        try
        {
            ...
            y.d((new StringBuilder("Deleted ")).append(i).append(" expired items").toString());
            return;
        }
        catch (SQLiteException sqliteexception)
        {
