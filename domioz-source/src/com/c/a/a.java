...
final class a
{
    ...
    static Map a(Object obj)
    {
        ...
        if (!((Map) (obj1)).isEmpty())
        {
            ...
            h h1;
            for (obj1 = ((Map) (obj1)).entrySet().iterator(); ((Iterator) (obj1)).hasNext(); hashmap.put(entry.getKey(), h1))
            {
                entry = (java.util.Map.Entry)((Iterator) (obj1)).next();
                h1 = new h(obj, (Method)entry.getValue());
            }
    ...
    private static void a(Class class1)
    {
        ...
        while (i < j) 
        {
            ...
            if (!method.isBridge())
            {
                if (method.isAnnotationPresent(com/c/a/l))
                {
                ...
                if (method.isAnnotationPresent(com/c/a/k))
                {
    ...
    static Map b(Object obj)
    {
        ...
        if (!((Map) (obj1)).isEmpty())
        {
            ...
            for (obj1 = ((Map) (obj1)).entrySet().iterator(); ((Iterator) (obj1)).hasNext(); hashmap.put(entry.getKey(), hashset))
            {
                entry = (java.util.Map.Entry)((Iterator) (obj1)).next();
                hashset = new HashSet();
                for (Iterator iterator = ((Set)entry.getValue()).iterator(); iterator.hasNext(); hashset.add(new g(obj, (Method)iterator.next()))) { }
            }
