...
final class at extends BitmapDrawable
{
    ...
    private at(Context context, Bitmap bitmap, Drawable drawable, ap ap1, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, ap ap1, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new at(context, bitmap, drawable, ap1, flag, flag1));
    }
