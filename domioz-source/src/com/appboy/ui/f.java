    ...
    implements Runnable
{
    ...
    final com.appboy.c.a a;
    final e b;

    f(e e1, com.appboy.c.a a1)
    {
        b = e1;
        a = a1;
        super();
    ...
    {
        com.appboy.f.a.a(AppboyFeedFragment.c(), (new StringBuilder("Updating feed views in response to FeedUpdatedEvent: ")).append(a).toString());
        ...
        {
            com.appboy.f.a.b(AppboyFeedFragment.c(), String.format("Feed received was older than the max time to live of %d seconds, displaying it for now, but requesting an updated view from the server.", new Object[] {
                Integer.valueOf(60)
            }));
            AppboyFeedFragment.l(b.b).d();
            if (a.b(AppboyFeedFragment.i(b.b)) == 0)
            {
                com.appboy.f.a.a(AppboyFeedFragment.c(), String.format("Old feed was empty, putting up a network spinner and registering the network error message on a delay of %dms.", new Object[] {
