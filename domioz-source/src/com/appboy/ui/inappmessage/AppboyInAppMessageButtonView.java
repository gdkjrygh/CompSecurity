...
public class AppboyInAppMessageButtonView extends Button
{
    ...
    public AppboyInAppMessageButtonView(Context context, AttributeSet attributeset)
    {
        ...
        try
        {
            attributeset = context.obtainStyledAttributes(attributeset, v.a);
        }
        ...
        if (attributeset.getIndex(i) != v.b)
        {
...
_L1:
    ...
    static 
    {
        a = String.format("%s.%s", new Object[] {
            f.a, com/appboy/ui/inappmessage/AppboyInAppMessageButtonView.getName()
        });
    }
}
