...
class allback extends PowerRestCallback
{
    ...
    public void onSuccess(String s)
    {
        ...
        if (s == null)
        {
            RemoteOrderManager.access$500(RemoteOrderManager.this, val$client, ResponseErrorCode.UNAUTHORIZED_USER);
            return;
        } else
        {
            RemoteOrderManager.access$600(RemoteOrderManager.this).saveNewCurrentUser(s);
            RemoteOrderManager.access$700(RemoteOrderManager.this, val$client);
            return;
        }
    }
