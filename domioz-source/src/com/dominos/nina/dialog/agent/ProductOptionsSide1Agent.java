...
public class ProductOptionsSide1Agent extends BaseAgent
{

    public static String CONCEPT;
    public static final String NAME = com/dominos/nina/dialog/agent/ProductOptionsSide1Agent.getSimpleName();
    DomProductManager mNinaHelper;

    public ProductOptionsSide1Agent(String s, com.dominos.nina.dialog.DialogModelBuilder.SlotMode slotmode)
    {
    ...
    public void onBind(SpeechContext speechcontext)
    {
        ...
        {
            mNinaHelper.getCurrentPartialProduct().setOptionsSide1(speechcontext);
        }
    }
