...
public final class NewsFeedActivity_ extends NewsFeedActivity
    implements a, b
{
    ...
    {
        mTopBarView = (ToolBarView)a1.findViewById(0x7f0f00cd);
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/news/activity/NewsFeedActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/news/activity/NewsFeedActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final NewsFeedActivity_ this$0;
