    ...
    implements Parcelable
{
    ...
    LabsFlavor(Parcel parcel, _cls1 _pcls1)
    {
        this(parcel);
    }
        ...
        implements android.os.Parcelable.Creator
    {
        ...
        public final LabsFlavor createFromParcel(Parcel parcel)
        {
            return new LabsFlavor(parcel, null);
        }
        ...
        public final LabsFlavor[] newArray(int i)
        {
