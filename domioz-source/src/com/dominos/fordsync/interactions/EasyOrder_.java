...
public final class EasyOrder_ extends EasyOrder
{

    private Context context_;

    private EasyOrder_(Context context)
    {
        super(context);
        context_ = context;
        init_();
    ...
    public static EasyOrder_ getInstance_(Context context)
    {
        return new EasyOrder_(context);
    }
