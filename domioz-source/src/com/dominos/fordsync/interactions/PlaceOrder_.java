...
public final class PlaceOrder_ extends PlaceOrder
{

    private Context context_;

    private PlaceOrder_(Context context)
    {
        context_ = context;
        init_();
    }

    public static PlaceOrder_ getInstance_(Context context)
    {
        return new PlaceOrder_(context);
    }
