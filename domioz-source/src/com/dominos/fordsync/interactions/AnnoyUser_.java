...
public final class AnnoyUser_ extends AnnoyUser
{

    private Context context_;

    private AnnoyUser_(Context context)
    {
        context_ = context;
        init_();
    }

    public static AnnoyUser_ getInstance_(Context context)
    {
        return new AnnoyUser_(context);
    }
