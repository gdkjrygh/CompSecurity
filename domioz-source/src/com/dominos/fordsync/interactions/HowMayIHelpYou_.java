...
public final class HowMayIHelpYou_ extends HowMayIHelpYou
{

    private Context context_;

    private HowMayIHelpYou_(Context context)
    {
        context_ = context;
        init_();
    }

    public static HowMayIHelpYou_ getInstance_(Context context)
    {
        return new HowMayIHelpYou_(context);
    }
