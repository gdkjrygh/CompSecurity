...
public final class RecentOrder_ extends RecentOrder
{

    private Context context_;

    private RecentOrder_(Context context)
    {
        super(context);
        context_ = context;
        init_();
    ...
    public static RecentOrder_ getInstance_(Context context)
    {
        return new RecentOrder_(context);
    }
    ...
    private void init_()
    {
        ...
        mResourceUtility = ResUtils_.getInstance_(context_);
