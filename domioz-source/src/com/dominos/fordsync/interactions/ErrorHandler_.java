...
public final class ErrorHandler_ extends ErrorHandler
{

    private Context context_;

    private ErrorHandler_(Context context)
    {
        context_ = context;
        init_();
    }

    public static ErrorHandler_ getInstance_(Context context)
    {
        return new ErrorHandler_(context);
    }
