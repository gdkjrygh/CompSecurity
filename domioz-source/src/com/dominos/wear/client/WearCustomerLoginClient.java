...
public class WearCustomerLoginClient extends WearBaseOrderClient
{
    ...
    private static final String TAG = com/dominos/wear/client/WearCustomerLoginClient.getSimpleName();

    public WearCustomerLoginClient()
    {
    }

    public void onResponseReceived(ResponseEvent responseevent)
    {
        WearBaseOrderClient.DataMapEvent datamapevent = createDataMapRequest(16, responseevent);
