...
public class WearEasyOrderClient extends WearBaseOrderClient
{
    ...
    private static final String TAG = com/dominos/wear/client/WearEasyOrderClient.getSimpleName();

    public WearEasyOrderClient()
    {
    }

    public void onResponseReceived(ResponseEvent responseevent)
    {
        WearBaseOrderClient.DataMapEvent datamapevent = createDataMapRequest(17, responseevent);
