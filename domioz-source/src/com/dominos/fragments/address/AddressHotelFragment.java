...
public class AddressHotelFragment extends AddressBaseFragment
{
    ...
    public LabsAddress getFormObject()
    {
        ...
        String s1 = mRoomEntry.getText().toString().trim().replace("#", " ");
        ...
        labsaddress.setAddressType(AddressType.TYPE_HOTEL.getName());
        return labsaddress;
    }
...
/*
    static boolean access$002(AddressHotelFragment addresshotelfragment, boolean flag)
    {
        addresshotelfragment.mIsInitializing = flag;
        return flag;
    }
