...
public class AddressOtherFragment extends AddressBaseFragment
{
    ...
    public LabsAddress getFormObject()
    {
        ...
        String s1 = mUnitEntry.getText().toString().trim().replace("#", " ");
        ...
        labsaddress.setAddressType(AddressType.TYPE_OTHER.getName());
        return labsaddress;
    }
...
/*
    static boolean access$002(AddressOtherFragment addressotherfragment, boolean flag)
    {
        addressotherfragment.mIsInitializing = flag;
        return flag;
    }
