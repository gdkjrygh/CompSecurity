...
public class AddressDormitoryFragment extends AddressBaseFragment
{
    ...
    public AddressDormitoryFragment()
    {
    ...
    public LabsAddress getFormObject()
    {
        ...
        labsaddress.setAddressType(AddressType.TYPE_DORMITORY.getName());
        return labsaddress;
    }
...
/*
    static boolean access$002(AddressDormitoryFragment addressdormitoryfragment, boolean flag)
    {
        addressdormitoryfragment.mIsInitializing = flag;
        return flag;
    }
