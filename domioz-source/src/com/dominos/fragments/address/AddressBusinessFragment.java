...
public class AddressBusinessFragment extends AddressBaseFragment
{
    ...
    public AddressBusinessFragment()
    {
    ...
    public LabsAddress getFormObject()
    {
        ...
        labsaddress.setAddressType(AddressType.TYPE_BUSINESS.getName());
        return labsaddress;
    }
...
/*
    static boolean access$002(AddressBusinessFragment addressbusinessfragment, boolean flag)
    {
        addressbusinessfragment.mIsInitializing = flag;
        return flag;
    }
