...
public class AddressApartmentFragment extends AddressBaseFragment
{
    ...
    EditText mLocationEntry;
    Spinner mStateSpinner;
    EditText mStreetAddressEntry;
    EditText mSuitAptEntry;
    EditText mZipEntry;

    public AddressApartmentFragment()
    {
    ...
    public LabsAddress getFormObject()
    {
        ...
        labsaddress.setOrganizationName(mLocationEntry.getText().toString().trim());
        ...
        labsaddress.setAddressType(AddressType.TYPE_APARTMENT.getName());
        return labsaddress;
    }
    ...
    public List validate()
    {
        ...
        if (StringHelper.isEmpty(mSuitAptEntry.getText().toString()))
        {
            arraylist.add(AddressFormValidation.EMPTY_SUIT_APT);
        }
...
/*
    static boolean access$002(AddressApartmentFragment addressapartmentfragment, boolean flag)
    {
        addressapartmentfragment.mIsInitializing = flag;
        return flag;
    }
...
*/
        ...
        implements android.widget.TextView.OnEditorActionListener
    {
        ...
        final AddressApartmentFragment this$0;
        ...
        _cls1()
        {
            this$0 = AddressApartmentFragment.this;
            super();
        }
    }
