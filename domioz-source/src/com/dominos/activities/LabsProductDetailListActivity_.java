...
//            LabsProductDetailListActivity, BaseActivity

public final class LabsProductDetailListActivity_ extends LabsProductDetailListActivity
    implements a, b
{
    ...
    public LabsProductDetailListActivity_()
    {
    ...
    private void init_(Bundle bundle)
    {
        ...
        resourceUtility = ResUtils_.getInstance_(this);
        onBaseAfterInject();
        initialize();
        onAfterInject();
    }
    ...
    {
        productLineImage = (ImageView)a1.findViewById(0x7f0f0362);
        productLineTitle = (TextView)a1.findViewById(0x7f0f0365);
        saveButton = (Button)a1.findViewById(0x7f0f0119);
        titleText = (TextView)a1.findViewById(0x7f0f0360);
        flashAnimationLayout = (LinearLayout)a1.findViewById(0x7f0f0363);
        productToppingsList = (TextView)a1.findViewById(0x7f0f0366);
        View view = a1.findViewById(0x7f0f007f);
        if (view != null)
        {
            view.setOnClickListener(new _cls1());
        }
        a1 = a1.findViewById(0x7f0f035f);
        if (a1 != null)
        {
    ...
    public final void updateProductLine(final CountDownLatch asyncWaitLatch)
    {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LabsProductDetailListActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LabsProductDetailListActivity_);
        }
        ...
        implements Runnable
    {
        ...
        _cls6()
        {
            this$0 = LabsProductDetailListActivity_.this;
            super();
        }
    }
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            updateProductLine(asyncWaitLatch);
        }

        _cls7()
        {
            this$0 = LabsProductDetailListActivity_.this;
            asyncWaitLatch = countdownlatch;
            super();
        }
    }
