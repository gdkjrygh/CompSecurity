...
//            StoreProfileActivity, BaseActivity

public final class StoreProfileActivity_ extends StoreProfileActivity
    implements a, b
{
    ...
    {
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f00e3);
        mStoreNumberText = (TextView)a1.findViewById(0x7f0f00e4);
        mStoreAddressText = (TextView)a1.findViewById(0x7f0f00e5);
        mLoadingMapView = (LinearLayout)a1.findViewById(0x7f0f00e9);
        mStoreInfoText = (TextView)a1.findViewById(0x7f0f00e6);
        mMapErrorText = (TextView)a1.findViewById(0x7f0f00ea);
        View view = a1.findViewById(0x7f0f007f);
        if (view != null)
        {
            view.setOnClickListener(new _cls1());
        }
        view = a1.findViewById(0x7f0f00e8);
        if (view != null)
        {
            view.setOnClickListener(new _cls2());
        }
        if (mStoreInfoText != null)
        {
            mStoreInfoText.setOnClickListener(new _cls3());
        }
        a1 = a1.findViewById(0x7f0f00eb);
        if (a1 != null)
        {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/StoreProfileActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/StoreProfileActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final StoreProfileActivity_ this$0;
        ...
        _cls7()
        {
            this$0 = StoreProfileActivity_.this;
            super();
        }
    }
