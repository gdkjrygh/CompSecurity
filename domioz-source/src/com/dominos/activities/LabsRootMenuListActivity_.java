...
import com.dominos.adapters.LabsProductGridAdapter_;
...
//            LabsRootMenuListActivity, BaseActivity

public final class LabsRootMenuListActivity_ extends LabsRootMenuListActivity
    implements a, b
{
    ...
    public LabsRootMenuListActivity_()
    {
    ...
    private void init_(Bundle bundle)
    {
        ...
        mProductGridAdapter = LabsProductGridAdapter_.getInstance_(this);
        injectExtras_();
        initialize();
        onBaseAfterInject();
        onAfterInject();
    ...
    private void injectExtras_()
    {
        ...
        {
            category = (LabsCategory)bundle.getParcelable("category");
        }
    }
    ...
    {
        productGrid = (GridView)a1.findViewById(0x7f0f0380);
        buildYourOwnPizzaButton = (Button)a1.findViewById(0x7f0f0382);
        productList = (ListView)a1.findViewById(0x7f0f0381);
        menuListTitleText = (TextView)a1.findViewById(0x7f0f01db);
        a1 = a1.findViewById(0x7f0f007f);
        if (a1 != null)
        {
            a1.setOnClickListener(new _cls1());
        }
        if (buildYourOwnPizzaButton != null)
        {
            buildYourOwnPizzaButton.setOnClickListener(new _cls2());
        }
        setupFonts();
        setupMenuList();
    }
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        public IntentBuilder_ category(LabsCategory labscategory)
        {
            return (IntentBuilder_)super.extra("category", labscategory);
        }
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LabsRootMenuListActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LabsRootMenuListActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final LabsRootMenuListActivity_ this$0;
        ...
        _cls6()
        {
            this$0 = LabsRootMenuListActivity_.this;
            super();
        }
    }
