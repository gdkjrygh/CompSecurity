...
public class fragmentSupport_ extends a
{
    ...
    public fragmentSupport_ mHistoryLoyalty(HistoryLoyalty historyloyalty)
    {
        return (fragmentSupport_)super.extra("mHistoryLoyalty", historyloyalty);
    }
