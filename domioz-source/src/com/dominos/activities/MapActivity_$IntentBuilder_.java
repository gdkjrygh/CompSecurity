...
public class fragmentSupport_ extends a
{
    ...
    public fragmentSupport_ mAddress(String s)
    {
        return (fragmentSupport_)super.extra("mAddress", s);
    }

    public fragmentSupport_ mLatLng(LatLng latlng)
    {
        return (fragmentSupport_)super.extra("mLatLng", latlng);
    }
