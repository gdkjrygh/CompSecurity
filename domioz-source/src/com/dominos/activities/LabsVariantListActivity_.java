...
//            LabsVariantListActivity, BaseActivity

public final class LabsVariantListActivity_ extends LabsVariantListActivity
    implements a, b
{

    public static final String IS_EDIT_MODE_EXTRA = "isEditMode";
    public static final String IS_RESTORE_PRODUCT_LINE_IN_EDIT_EXTRA = "isRestoreProductLineInEdit";
    public static final String PRODUCT_LINE_ID_EXTRA = "productLineId";
    public static final String PRODUCT_NAME_EXTRA = "productName";
    private Handler handler_;
    private final c onViewChangedNotifier_ = new c();

    public LabsVariantListActivity_()
    {
    ...
    private void injectExtras_()
    {
        ...
        if (bundle != null)
        {
            if (bundle.containsKey("productLineId"))
            {
                productLineId = bundle.getInt("productLineId");
            }
            if (bundle.containsKey("isRestoreProductLineInEdit"))
            {
                isRestoreProductLineInEdit = bundle.getBoolean("isRestoreProductLineInEdit");
            }
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        public IntentBuilder_ isEditMode(boolean flag)
        {
            return (IntentBuilder_)super.extra("isEditMode", flag);
        }

        public IntentBuilder_ isRestoreProductLineInEdit(boolean flag)
        {
            return (IntentBuilder_)super.extra("isRestoreProductLineInEdit", flag);
        }

        public IntentBuilder_ productLineId(int i)
        {
            return (IntentBuilder_)super.extra("productLineId", i);
        }

        public IntentBuilder_ productName(String s)
        {
            return (IntentBuilder_)super.extra("productName", s);
        }
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LabsVariantListActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LabsVariantListActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final LabsVariantListActivity_ this$0;
        ...
        _cls5()
        {
            this$0 = LabsVariantListActivity_.this;
            super();
        }
    }
