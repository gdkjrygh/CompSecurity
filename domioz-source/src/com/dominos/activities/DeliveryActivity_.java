...
//            DeliveryActivity, BaseActivity

public final class DeliveryActivity_ extends DeliveryActivity
    implements a, b
{

    public static final String M_ADDRESS_TYPE_INDEX_EXTRA = "mAddressTypeIndex";
    private Handler handler_;
    private final c onViewChangedNotifier_ = new c();

    public DeliveryActivity_()
    {
    ...
    private void injectExtras_()
    {
        ...
        if (bundle != null && bundle.containsKey("mAddressTypeIndex"))
        {
            mAddressTypeIndex = bundle.getInt("mAddressTypeIndex");
        }
    }
    ...
    public final void clearAddressFrom()
    {
    ...
    {
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f00b1);
        mNickNameLayout = (LinearLayout)a1.findViewById(0x7f0f03a2);
        mSaveToProfileCheckBox = (CheckBox)a1.findViewById(0x7f0f03a0);
        mAddressTypeNameView = (TextView)a1.findViewById(0x7f0f00b4);
        mMakeDefaultAddressCheckBox = (CheckBox)a1.findViewById(0x7f0f03a5);
        mNickNameEntry = (EditText)a1.findViewById(0x7f0f03a3);
        mScrollViewChildLayout = (LinearLayout)a1.findViewById(0x7f0f00b3);
        mMakeThisPrimaryAddressLayout = (LinearLayout)a1.findViewById(0x7f0f03a4);
        View view = a1.findViewById(0x7f0f007f);
        if (view != null)
        {
            view.setOnClickListener(new _cls1());
        }
        a1 = a1.findViewById(0x7f0f00b8);
        if (a1 != null)
        {
        ...
        {
            mSaveToProfileCheckBox.setOnClickListener(new _cls3());
        }
        setupFonts();
        afterViews();
    }

    public final void popLoginDialog(final LabsAddress address)
    {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        public IntentBuilder_ mAddressTypeIndex(int i)
        {
            return (IntentBuilder_)super.extra("mAddressTypeIndex", i);
        }
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/DeliveryActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/DeliveryActivity_);
        }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            saveDeliveryAddressCheckBoxClicked(view);
        }
