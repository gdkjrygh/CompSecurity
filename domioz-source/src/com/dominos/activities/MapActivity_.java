...
public final class MapActivity_ extends MapActivity
    implements a, b
{

    public static final String M_ADDRESS_EXTRA = "mAddress";
    public static final String M_LAT_LNG_EXTRA = "mLatLng";
    ...
    private void injectExtras_()
    {
        ...
        if (bundle != null)
        {
            if (bundle.containsKey("mAddress"))
            {
    ...
    {
        mSatelliteViewBtn = (Button)a1.findViewById(0x7f0f00c9);
        mStreetViewBtn = (Button)a1.findViewById(0x7f0f00cb);
        View view = a1.findViewById(0x7f0f007f);
        if (view != null)
        {
            view.setOnClickListener(new _cls1());
        }
        if (mStreetViewBtn != null)
        {
            mStreetViewBtn.setOnClickListener(new _cls2());
        }
        if (mSatelliteViewBtn != null)
        {
            mSatelliteViewBtn.setOnClickListener(new _cls3());
        }
        a1 = a1.findViewById(0x7f0f00ca);
        if (a1 != null)
        {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        public IntentBuilder_ mAddress(String s)
        {
            return (IntentBuilder_)super.extra("mAddress", s);
        }

        public IntentBuilder_ mLatLng(LatLng latlng)
        {
            return (IntentBuilder_)super.extra("mLatLng", latlng);
        }
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/MapActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/MapActivity_);
        }
