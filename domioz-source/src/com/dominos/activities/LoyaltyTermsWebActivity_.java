...
//            LoyaltyTermsWebActivity, BaseActivity

public final class LoyaltyTermsWebActivity_ extends LoyaltyTermsWebActivity
    implements a, b
{
    ...
    public LoyaltyTermsWebActivity_()
    {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LoyaltyTermsWebActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LoyaltyTermsWebActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final LoyaltyTermsWebActivity_ this$0;
        ...
        _cls2()
        {
            this$0 = LoyaltyTermsWebActivity_.this;
            super();
        }
    }
