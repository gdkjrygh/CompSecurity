...
import com.dominos.adapters.LabsCouponListAdapter_;
import com.dominos.adapters.LabsCouponSpinnerAdapter_;
...
//            LabsCouponListActivity, BaseActivity

public final class LabsCouponListActivity_ extends LabsCouponListActivity
    implements a, b
{
    ...
    public LabsCouponListActivity_()
    {
    ...
    private void init_(Bundle bundle)
    {
        ...
        couponListAdapter = LabsCouponListAdapter_.getInstance_(this);
        couponSpinnerAdapter = LabsCouponSpinnerAdapter_.getInstance_(this);
        initialize();
        onBaseAfterInject();
        onAfterInject();
    }
    ...
    {
        promoCodeField = (EditText)a1.findViewById(0x7f0f01dc);
        couponFilter = (Spinner)a1.findViewById(0x7f0f01de);
        screenTitle = (TextView)a1.findViewById(0x7f0f01db);
        ...
        setupFonts();
        setupCouponListActivity();
    }

    public final void onVoiceClick(final int position)
    {
        handler_.post(new _cls8());
    }

    public final void selectCoupon(final Coupon selectedCoupon)
    {
    ...
    public final void showCouponErrorAlert(final LabsCouponLine couponLine, final com.dominos.android.sdk.core.coupon.CouponWizardManager.CouponErrorType couponErrorType)
    {
    ...
    public final void showLoginDialogForLoyalty(final String couponCode)
    {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LabsCouponListActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LabsCouponListActivity_);
        }
        ...
        implements Runnable
    {
        ...
        _cls3()
        {
            this$0 = LabsCouponListActivity_.this;
            super();
        }
    }
        ...
        implements Runnable
    {
        ...
        final LabsCouponListActivity_ this$0;
        final com.dominos.android.sdk.core.coupon.CouponWizardManager.CouponErrorType val$couponErrorType;
        final LabsCouponLine val$couponLine;

        public void run()
        {
            showCouponErrorAlert(couponLine, couponErrorType);
        }
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            showLoginDialogForLoyalty(couponCode);
        }
