...
//            LoyaltyFAQActivity, BaseActivity

public final class LoyaltyFAQActivity_ extends LoyaltyFAQActivity
    implements a, b
{
    ...
    {
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f00bc);
        mFaqListView = (RecyclerView)a1.findViewById(0x7f0f00bd);
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LoyaltyFAQActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LoyaltyFAQActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final LoyaltyFAQActivity_ this$0;
        ...
        _cls3()
        {
            this$0 = LoyaltyFAQActivity_.this;
            super();
        }
    }
