...
public class fragmentSupport_ extends a
{
    ...
    public fragmentSupport_ mBeaconLaunchMode(boolean flag)
    {
        return (fragmentSupport_)super.extra("mBeaconLaunchMode", flag);
    }

    public fragmentSupport_ mPushCampaignId(String s)
    {
        return (fragmentSupport_)super.extra("mPushCampaignId", s);
    }
