...
//            UserEditInfoActivity, BaseActivity

public final class UserEditInfoActivity_ extends UserEditInfoActivity
    implements a, b
{
    ...
    public final void onViewChanged(a a1)
    {
        ...
        lastName = (EditText)a1.findViewById(0x7f0f03f9);
        phoneNumber = (EditText)a1.findViewById(0x7f0f02a4);
        saveAccount = (Button)a1.findViewById(0x7f0f03bd);
        firstName = (EditText)a1.findViewById(0x7f0f03f8);
        phoneExtension = (EditText)a1.findViewById(0x7f0f03fa);
        ...
        if (saveAccount != null)
        {
            saveAccount.setOnClickListener(new _cls2());
        }
        setupFonts();
        onAfterViews();
    }
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/UserEditInfoActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/UserEditInfoActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final UserEditInfoActivity_ this$0;
        ...
        _cls4()
        {
            this$0 = UserEditInfoActivity_.this;
            super();
        }
    }
