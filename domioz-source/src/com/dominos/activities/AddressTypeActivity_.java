...
//            AddressTypeActivity, BaseActivity

public final class AddressTypeActivity_ extends AddressTypeActivity
    implements a, b
{
    ...
    {
        mFragmentContainer = (FrameLayout)a1.findViewById(0x7f0f009a);
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f0097);
        mScrollViewChildLayout = (LinearLayout)a1.findViewById(0x7f0f0099);
        mAddressTypeContainer = (LinearLayout)a1.findViewById(0x7f0f009c);
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/AddressTypeActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/AddressTypeActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final AddressTypeActivity_ this$0;
        ...
        _cls3()
        {
            this$0 = AddressTypeActivity_.this;
            super();
        }
    }
