...
//            LoyaltyRewardDetailsActivity, BaseActivity

public final class LoyaltyRewardDetailsActivity_ extends LoyaltyRewardDetailsActivity
    implements a, b
{

    public static final String M_HISTORY_CALL_FAILED_EXTRA = "mHistoryCallFailed";
    private Handler handler_;
    private final c onViewChangedNotifier_ = new c();

    public LoyaltyRewardDetailsActivity_()
    {
    ...
    private void injectExtras_()
    {
        ...
        if (bundle != null && bundle.containsKey("mHistoryCallFailed"))
        {
            mHistoryCallFailed = bundle.getBoolean("mHistoryCallFailed");
        }
    }
    ...
    {
        mLoyaltyHistoryLayout = (LinearLayout)a1.findViewById(0x7f0f00c4);
        mLoyaltyHistoryListView = (LinearLayout)a1.findViewById(0x7f0f00bf);
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f00c0);
        mLoyaltyPointsExpireHolder = (FrameLayout)a1.findViewById(0x7f0f00c7);
        mNoHistoryTextView = (TextView)a1.findViewById(0x7f0f00c3);
        View view = a1.findViewById(0x7f0f007f);
        if (view != null)
        {
            view.setOnClickListener(new _cls1());
        }
        a1 = a1.findViewById(0x7f0f00c6);
        if (a1 != null)
        {
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        public IntentBuilder_ mHistoryCallFailed(boolean flag)
        {
            return (IntentBuilder_)super.extra("mHistoryCallFailed", flag);
        }
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/LoyaltyRewardDetailsActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/LoyaltyRewardDetailsActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final LoyaltyRewardDetailsActivity_ this$0;
        ...
        _cls3()
        {
            this$0 = LoyaltyRewardDetailsActivity_.this;
            super();
        }
    }
