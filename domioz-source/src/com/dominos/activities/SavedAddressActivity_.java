...
//            SavedAddressActivity, BaseActivity

public final class SavedAddressActivity_ extends SavedAddressActivity
    implements a, b
{
    ...
    public final void navigateToNewAddress()
    {
    ...
    {
        mScrollViewChild = (LinearLayout)a1.findViewById(0x7f0f00d3);
        mSavedAddressLayout = (LinearLayout)a1.findViewById(0x7f0f00d6);
        mToolBar = (ToolBarView)a1.findViewById(0x7f0f00d1);
    ...
    private class IntentBuilder_ extends org.androidannotations.api.a.a
    {
        ...
        {
            super(fragment.getActivity(), com/dominos/activities/SavedAddressActivity_);
            fragment_ = fragment;
        }

        public IntentBuilder_(Context context)
        {
            super(context, com/dominos/activities/SavedAddressActivity_);
        }
        ...
        implements Runnable
    {
        ...
        final SavedAddressActivity_ this$0;
        ...
        _cls2()
        {
            this$0 = SavedAddressActivity_.this;
            super();
        }
    }
