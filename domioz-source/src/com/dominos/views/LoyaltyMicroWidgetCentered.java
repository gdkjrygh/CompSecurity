...
public class LoyaltyMicroWidgetCentered extends LoyaltyWidgetBaseLayout
{
    ...
    public LoyaltyMicroWidgetCentered(Context context)
    {
        super(context);
    }

    private void notifyListenerOfRedeemClick()
    {
        if (mListener != null)
        {
    ...
    public void afterView()
    {
        ...
        updateView();
        mParentLayout.setBackgroundResource(0x7f02004b);
    }
