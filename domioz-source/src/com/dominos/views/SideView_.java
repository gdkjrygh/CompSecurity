...
//            SideView, ProductSpinner

public final class SideView_ extends SideView
    implements a, b
{
    ...
    public SideView_(Context context)
    {
        super(context);
    ...
    public static SideView build(Context context)
    {
        context = new SideView_(context);
    ...
    {
        quantityLabel = (TextView)a1.findViewById(0x7f0f049e);
        ...
        decrementButton = (ImageButton)a1.findViewById(0x7f0f049d);
        partRadioGroup = (RadioGroup)a1.findViewById(0x7f0f036f);
        label = (TextView)a1.findViewById(0x7f0f049c);
        detailLayout = (RelativeLayout)a1.findViewById(0x7f0f049b);
        controlLayout = (RelativeLayout)a1.findViewById(0x7f0f036e);
        incrementButton = (ImageButton)a1.findViewById(0x7f0f049f);
