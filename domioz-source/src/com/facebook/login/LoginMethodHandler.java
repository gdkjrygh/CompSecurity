    ...
    implements Parcelable
{
    ...
    public static AccessToken a(Collection collection, Bundle bundle, g g, String s)
    {
        Date date = aw.a(bundle, "expires_in", new Date());
        ...
        {
            return new AccessToken(s1, s, b(bundle.getString("signed_request")), collection, ((Collection) (obj)), g, date, new Date());
        }
    }
