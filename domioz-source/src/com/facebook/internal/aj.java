...
final class aj
{
    ...
    static JSONObject a(InputStream inputstream)
    {
        ...
        for (; j < 3; j++)
        {
            ...
            if (i1 == -1)
            {
                ak.a(am.d, y.a, "readHeader: stream.read returned -1 while reading header size");
                return null;
            }
            i = (i << 8) + (i1 & 0xff);
        }
        ...
        for (int k = l; k < i; k += l)
        {
            ...
            if (l <= 0)
            {
                ak.a(am.d, y.a, (new StringBuilder("readHeader: stream.read stopped at ")).append(Integer.valueOf(k)).append(" when expected ").append(i).toString());
                return null;
            }
        }
        ...
        ak.a(am.d, y.a, (new StringBuilder("readHeader: expected JSONObject, got ")).append(inputstream.getClass().getCanonicalName()).toString());
        return null;
        try
        {
