    ...
    implements d
{
    ...
    private static String b(Context context)
    {
        ...
        {
            f.c().c("Beta", "Failed to close the APK file", context);
        }
_L2:
        d1 = (double)(System.nanoTime() - l) / 1000000D;
        f.c().a("Beta", (new StringBuilder("Beta device token load took ")).append(d1).append("ms").toString());
        return ((String) (obj));
        obj1;
        context = null;
_L9:
        obj = context;
        f.c().c("Beta", "Failed to find this app in the PackageManager", ((Throwable) (obj1)));
        obj = s;
...
_L8:
        obj = context;
        f.c().c("Beta", "Failed to find the APK file", ((Throwable) (obj1)));
        obj = s;
...
_L7:
        obj = context;
        f.c().c("Beta", "Failed to read the APK file", ioexception1);
        obj = s;
...
_L6:
        if (obj != null)
        {
            ...
            {
                f.c().c("Beta", "Failed to close the APK file", ioexception);
            }
        }
        throw context;
        context;
