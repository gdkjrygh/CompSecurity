...
_L7:
        obj = s;
        b.a.a.a.f.c().c("Fabric", (new StringBuilder("Error parsing ")).append(file).toString(), exception);
...
_L6:
    ...
    private static String a(byte abyte0[], String s)
    {
        ...
        {
            b.a.a.a.f.c().c("Fabric", (new StringBuilder("Could not create hashing algorithm: ")).append(s).append(", returning empty string.").toString(), abyte0);
            return "";
        }
    ...
    public static void a(Closeable closeable, String s)
    {
        ...
        return;
        closeable;
        b.a.a.a.f.c().c("Fabric", s, closeable);
        return;
    }
    ...
    public static void a(Flushable flushable, String s)
    {
        ...
        return;
        flushable;
        b.a.a.a.f.c().c("Fabric", s, flushable);
        return;
    }
...
label1:
        {
          ...
          goto _L5
        b.a.a.a.f.c().a("Fabric", (new StringBuilder("Unexpected meminfo format while computing RAM: ")).append(s).toString());
        l1 = 0L;
          goto _L5
        NumberFormatException numberformatexception;
        numberformatexception;
        b.a.a.a.f.c().c("Fabric", (new StringBuilder("Unexpected meminfo format while computing RAM: ")).append(s).toString(), numberformatexception);
        l1 = 0L;
          goto _L5
        Exception exception;
        exception;
...
label0:
        {
            ...
            {
                b.a.a.a.f.c().c("Fabric", "Could not calculate hash for app icon.", inputstream);
                return "";
            }
        }
          goto _L1
    ...
    public static Cipher c(String s)
    {
        ...
        {
            b.a.a.a.f.c().c("Fabric", "Could not create Cipher for AES/ECB/PKCS7Padding - should never happen.", s);
...
_L4:
        obj = context;
        b.a.a.a.f.c().c("Fabric", "Could not calculate hash for app icon.", exception);
        a(context, "Failed to close icon input stream.");
        return null;
        context;
        obj = null;
...
_L3:
    ...
    public static String l(Context context)
    {
        ...
        if (i1 != 0)
        {
            ...
            b.a.a.a.f.c().a("Fabric", (new StringBuilder("Build ID is: ")).append(s).toString());
        }
        return s;
    }
