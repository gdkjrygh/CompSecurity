    ...
    implements android.view.View.OnTouchListener
{
    ...
    private boolean a(MotionEvent motionevent)
    {
        ...
        } else
        {
            ...
            boolean flag2 = ((aj) (obj)).a(motionevent1, i);
            motionevent1.recycle();
            int k = ay.a(motionevent);
            boolean flag;
            if (k != 1 && k != 3)
            {
                flag = true;
    ...
    static void b(ak ak1)
    {
        ak1.d();
        View view;
        for (view = ak1.d; !view.isEnabled() || view.isLongClickable() || !ak1.b();)
        {
            return;
        }
...
_L6:
        ...
        if (e == null)
        {
            e = new al(this, (byte)0);
        }
        view.postDelayed(e, b);
        if (f == null)
        {
            f = new am(this, (byte)0);
        }
