    ...
    implements r
{
    ...
    public s(Context context, android.view.GestureDetector.OnGestureListener ongesturelistener)
    {
        i = ongesturelistener;
    ...
    static MotionEvent a(s s1)
    {
        return s1.p;
    }

    static android.view.GestureDetector.OnGestureListener b(s s1)
    {
        return s1.i;
    }
    ...
    static void c(s s1)
    {
        s1.h.removeMessages(3);
        s1.l = false;
        s1.m = true;
        s1.i.onLongPress(s1.p);
    }

    static android.view.GestureDetector.OnDoubleTapListener d(s s1)
    {
        return s1.j;
    }
    ...
    public final boolean a(MotionEvent motionevent)
    {
        ...
        for (f2 = 0.0F; i3 < k3; f2 = f3)
        {
            ...
            if (i2 != i3)
            {
                f3 = f2 + ay.c(motionevent, i3);
                f6 = f1 + ay.d(motionevent, i3);
            }
            i3++;
            f1 = f6;
        }
...
_L7:
        ...
        int j2 = ay.b(motionevent);
        int j1 = ay.b(motionevent, j2);
        f1 = bl.a(x, j1);
        f2 = bl.b(x, j1);
        j1 = 0;
        while (j1 < k3) 
        {
            if (j1 != j2)
            {
                int j3 = ay.b(motionevent, j1);
                float f4 = bl.a(x, j3);
                if (bl.b(x, j3) * f2 + f4 * f1 < 0.0F)
                {
                    x.clear();
                    return false;
                }
...
_L3:
        ...
        {
            velocitytracker = x;
            l1 = ay.b(motionevent, 0);
            velocitytracker.computeCurrentVelocity(1000, d);
            f1 = bl.b(velocitytracker, l1);
            f2 = bl.a(velocitytracker, l1);
