    ...
    implements ComponentCallbacks, android.view.View.OnCreateContextMenuListener
{
    ...
    private static final p sClassMap = new p();
    ...
    ct mEnterTransitionCallback;
    Object mExitTransition;
    ct mExitTransitionCallback;
    int mFragmentId;
    x mFragmentManager;
    boolean mFromLayout;
    boolean mHasMenu;
    ...
    public static Fragment instantiate(Context context, String s, Bundle bundle)
    {
        ...
        {
            throw new o((new StringBuilder("Unable to instantiate fragment ")).append(s).append(": make sure class name exists, is public, and has an empty constructor that is public").toString(), context);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
...
_L5:
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle)
    {
        ...
        ae.a(bundle, mChildFragmentManager);
        return bundle;
    }

    public as getLoaderManager()
    {
        if (mLoaderManager != null)
        {
    ...
    {
        mChildFragmentManager = new x();
        mChildFragmentManager.a(mActivity, new n(this), this);
    }
...
label0:
    ...
    void performSaveInstanceState(Bundle bundle)
    {
        ...
        if (mChildFragmentManager != null)
        {
            android.os.Parcelable parcelable = mChildFragmentManager.j();
            if (parcelable != null)
            {
        ...
        implements Parcelable
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = new android.support.v4.app.p();
        final Bundle a;
