...
public final class jt
{
    ...
    public static File a(Context context, boolean flag)
    {
        ...
        if (file1 == null)
        {
            ...
            js.c("Can't define system cache directory! '%s' will be used.", new Object[] {
                context
            });
...
label0:
        {
            ...
            if (!file.exists())
            {
                ...
                js.c("Unable to create external cache directory", new Object[0]);
                context = null;
            }
            return context;
        }
        ...
        {
            js.b("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return file;
        }
        return file;
    }
