    ...
    implements jf
{
    ...
    public final InputStream a(String s, Object obj)
    {
        ...
        case 2: // '\002'
            ...
            return new hz(new BufferedInputStream(s.getInputStream(), 32768), s.getContentLength());

        case 3: // '\003'
            s = jg.c.c(s);
            return new hz(new BufferedInputStream(new FileInputStream(s), 32768), (new File(s)).length());
        ...
        case 6: // '\006'
            int j = Integer.parseInt(jg.f.c(s));
