...
class Mx extends a
{
    ...
    public void nO()
    {
        ...
        obj = x.S(nB).k(e.k(nB));
        akW.a(new <init>(Mx, ((com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate) (obj))));
        obj = alq.iterator();
        do
        {
            ...
            ((alq)je()).getStreetViewPanoramaAsync(onstreetviewpanoramareadycallback);
        } while (i == 0);
        alq.clear();
        return;
        remoteexception;
