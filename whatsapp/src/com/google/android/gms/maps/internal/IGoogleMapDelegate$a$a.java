...
//            IGoogleMapDelegate, f, h, j, 
//            n, IProjectionDelegate, IUiSettingsDelegate
    ...
    implements IGoogleMapDelegate
{
    ...
    public l addMarker(MarkerOptions markeroptions)
    {
        ...
        if (com.google.android.gms.maps.internal.l == 0)
        {
...
_L1:
    ...
    public CameraPosition getCameraPosition()
    {
        ...
        i = com.google.android.gms.maps.internal.le;
        if (i == 0)
        {
    ...
    public Location getMyLocation()
    {
        ...
        location = (Location)Location.CREATOR.teFromParcel(parcel1);
        i = com.google.android.gms.maps.internal.le;
        if (i == 0)
        {
