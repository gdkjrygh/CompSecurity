...
public class PictureParameterSet extends BitstreamElement
{
        ...
        throws IOException
    {
        ...
        pictureparameterset.pic_order_present_flag = inputstream.readBool("PPS: pic_order_present_flag");
...
_L11:
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (pic_order_present_flag != ((PictureParameterSet) (obj)).pic_order_present_flag)
            {
                return false;
            }
        ...
        throws IOException
    {
        ...
        outputstream.writeBool(pic_order_present_flag, "PPS: pic_order_present_flag");
