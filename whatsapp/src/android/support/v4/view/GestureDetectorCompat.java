...
_L14:
            ...
            j2 = j | mListener.onDown(motionevent);
            i2 = j2;
...
_L16:
            j2 |= mDoubleTapListener.onDoubleTapEvent(motionevent);
            i2 = j2;
...
_L17:
            ...
            {
                j2 = mListener.onScroll(mCurrentDownEvent, motionevent, f3, f5);
                mLastFocusX = f;
                mLastFocusY = f1;
                mAlwaysInTapRegion = false;
                mHandler.removeMessages(3);
...
_L20:
            flag1 = mListener.onScroll(mCurrentDownEvent, motionevent, f3, f5);
            mLastFocusX = f;
            mLastFocusY = f1;
            i2 = ((flag1) ? 1 : 0);
...
_L3:
            ...
            if (mIsDoubleTapping)
            {
                i2 = flag1 | mDoubleTapListener.onDoubleTapEvent(motionevent);
                flag = i2;
                if (!flag4)
                {
...
_L21:
            i2 = mListener.onSingleTapUp(motionevent);
            try
            {
...
_L24:
            flag = mListener.onFling(mCurrentDownEvent, motionevent, f1, f);
            try
            {
