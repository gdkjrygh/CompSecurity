...
public static final class rx extends qq
{
...
_L2:
            ...
            obj = (a)obj;
            flag = flag1;
            if (!Arrays.equals(ayv, ((a) (obj)).ayv))
            {
                continue; /* Loop/switch isn't completed */
            }
            if (ayw != null)
...
_L5:
            flag = flag1;
            if (Double.doubleToLongBits(ayx) == Double.doubleToLongBits(((a) (obj)).ayx))
            {
                flag = flag1;
                if (Float.floatToIntBits(ayy) == Float.floatToIntBits(((a) (obj)).ayy))
                {
                    flag = flag1;
                    if (ayz == ((a) (obj)).ayz)
                    {
                        ...
                        if (ayA == ((a) (obj)).ayA)
                        {
                            ...
                            if (ayB == ((a) (obj)).ayB)
                            {
                                ...
                                {
                                    flag = flag1;
                                    if (qu.equals(ayD, ((a) (obj)).ayD))
                                    {
                                        flag = flag1;
                                        if (qu.equals(ayE, ((a) (obj)).ayE))
                                        {
                                            flag = flag1;
                                            if (qu.equals(ayF, ((a) (obj)).ayF))
                                            {
                                                flag = flag1;
                                                if (qu.equals(ayG, ((a) (obj)).ayG))
                                                {
                                                    flag = flag1;
                                                    if (qu.equals(ayH, ((a) (obj)).ayH))
                                                    {
                                                        flag = flag1;
                                                        if (ayI == ((a) (obj)).ayI)
                                                        {
...
_L6:
    ...
    private static volatile ayu ayt[];
    public a ayu;
    public int type;

    public static a.ayH[] rw()
    {
        if (ayt == null)
        {
            synchronized (qu.azg)
...
_L2:
        flag = flag1;
        if (!(obj instanceof ayu)) goto _L4; else goto _L3
_L3:
        obj = (ayu)obj;
        flag = flag1;
...
_L6:
        flag = flag1;
        if (((ayu) (obj)).ayu != null) goto _L4; else goto _L8
_L8:
        return a(((qq) (obj)));
_L7:
        if (!ayu.equals(((a.equals) (obj)).ayu))
        {
            return false;
        }
