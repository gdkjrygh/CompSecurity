    ...
    extends IInterface
{
        ...
        implements qf
    {
        ...
        public static qf bU(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof qf))
            {
                return (qf)iinterface;
            } else
            {
            ...
            throws RemoteException
        {
            ...
            if (parcel.readInt() != 0)
            {
                py1 = (py)py.CREATOR.createFromParcel(parcel);
            } else
            {
                py1 = null;
            }
...
_L1:
        ...
        public void a(Status status, py py1, Bundle bundle)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L5:
            if (py1 == null) goto _L4; else goto _L3
_L3:
            parcel.writeInt(1);
            py1.writeToParcel(parcel, 0);
_L6:
            if (bundle == null)
            {
...
_L1:
    ...
    public abstract void a(Status status, py py, Bundle bundle)
        throws RemoteException;
