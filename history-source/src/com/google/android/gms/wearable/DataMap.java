...
_L8:
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        try
        {
            abyte0 = ql.a(new com.google.android.gms.internal.ql.a(qm.n(abyte0), new ArrayList()));
        }
    ...
    {
        String s;
        for (Iterator iterator = datamap.keySet().iterator(); iterator.hasNext(); axg.put(s, datamap.get(s)))
        {
            s = (String)iterator.next();
        }
    ...
    {
        axg.put(s, Boolean.valueOf(flag));
    }

    public void putByte(String s, byte byte0)
    {
        axg.put(s, Byte.valueOf(byte0));
    }
    ...
    {
        axg.put(s, Double.valueOf(d1));
    }

    public void putFloat(String s, float f)
    {
        axg.put(s, Float.valueOf(f));
    }
    ...
    public Bundle toBundle()
    {
        ...
        String s;
        for (Iterator iterator = axg.keySet().iterator(); iterator.hasNext(); a(bundle, s, axg.get(s)))
        {
            s = (String)iterator.next();
        }
