...
public class an
{
    ...
    public static void a(Map map, String s, q q1)
    {
        if (!map.containsKey(s))
        {
            map.put(s, q1.getValue(s));
        }
    }
    ...
    public static MessageDigest ap(String s)
    {
        int i = 0;
_L3:
...
_L2:
    ...
    public static boolean f(String s, boolean flag)
    {
        boolean flag1 = flag;
