...
//            LocalyticsProvider, LocalyticsAmpSession, SessionHandler, DatapointHelper

class this._cls1
    implements Callable
{

    final l.provider this$1;
...
/* anonymous class */
    class LocalyticsAmpSession._cls3 extends AsyncTask
    {
        ...
        // Unreferenced inner class com/localytics/android/LocalyticsAmpSession$3$2

/* anonymous class */
        class LocalyticsAmpSession._cls3._cls2
            implements Runnable
        {
