    ...
    implements Runnable
{
    ...
    public void run()
    {
        holder.holder.setImageDrawable(getActivity().getResources().getDrawable(0x7f02013b));
        holder.holder.setBackgroundColor(getActivity().getResources().getColor(0x7f090037));
    }
    ...
    // Unreferenced inner class com/aetn/history/android/historyhere/fragment/TourHomeListViewFragment$TourHomeListAdapter$2

/* anonymous class */
    class TourHomeListViewFragment.TourHomeListAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new Handler()).postDelayed(new TourHomeListViewFragment.TourHomeListAdapter._cls2._cls1(), 50L);
        }
