    ...
    implements android.view.animation.ionListener
{
    ...
    {
        MenuFragment.access$1200(MenuFragment.this).setVisibility(8);
        ...
        MenuFragment.access$1000(MenuFragment.this).setBackgroundDrawable(getActivity().getResources().getDrawable(0x7f020102));
