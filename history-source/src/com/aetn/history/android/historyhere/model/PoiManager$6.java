    ...
    implements com.android.volley.rListener
{
    ...
    {
        Utils.logger(PoiManager.access$200(PoiManager.this), (new StringBuilder()).append("loadLimitedListFromDataDump: signedRequest: error: ").append(volleyerror).toString());
    }
