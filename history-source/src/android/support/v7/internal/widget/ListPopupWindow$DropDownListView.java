...
_L2:
        ...
        for (int k1 = 0; k1 < k2;)
        {
            ...
            android.view.ndow.DropDownListView dropdownlistview = ((View) (obj)).getLayoutParams();
            if (dropdownlistview != null && dropdownlistview.getAdapter > 0)
            {
                i2 = android.view.ndow.DropDownListView.getAdapter(dropdownlistview.getAdapter, 0x40000000);
            } else
            {
