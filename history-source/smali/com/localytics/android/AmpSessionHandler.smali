...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 135
    .local v5, "ignoredMessages":[Ljava/lang/Integer;
    ...
    const-string v8, "Handler received %s"
    ...
    .line 232
    .end local v5    # "ignoredMessages":[Ljava/lang/Integer;
    :cond_2
    :goto_0
    return-void

    .line 149
    .restart local v5    # "ignoredMessages":[Ljava/lang/Integer;
    :sswitch_0
    sget-boolean v7, Lcom/localytics/android/Constants;->IS_LOGGABLE:Z
    ...
    const-string v8, "Handler received MESSAGE_TRIGGER_AMP"
    ...
    invoke-virtual {p0, v4, v2}, Lcom/localytics/android/AmpSessionHandler;->ampTrigger(Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    const-string v8, "Localytics library threw an uncaught exception"
    ...
    const-string v8, "Amp Session Handler received MESSAGE_TAG_EVENT"
    ...
    .line 180
    .restart local v2    # "attributes":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    invoke-virtual {p0, v4, v2}, Lcom/localytics/android/AmpSessionHandler;->ampTrigger(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-string v8, "Amp Session Handler received MESSAGE_SHOW_AMP_TEST"
    ...
    new-instance v8, Lcom/localytics/android/AmpSessionHandler$1;

    invoke-direct {v8, p0}, Lcom/localytics/android/AmpSessionHandler$1;-><init>(Lcom/localytics/android/AmpSessionHandler;)V
    ...
    const-string v8, "Amp Session Handler received MESSAGE_DELETE_AMP_RESOURCES"
    ...
    iget-object v7, p0, Lcom/localytics/android/AmpSessionHandler;->mProvider:Lcom/localytics/android/LocalyticsProvider;

    const/4 v8, 0x1

    invoke-static {v7, v1, v8}, Lcom/localytics/android/AmpHelper;->destroyLocalAmp(Lcom/localytics/android/LocalyticsProvider;Ljava/util/Map;Z)V
    :try_end_1
