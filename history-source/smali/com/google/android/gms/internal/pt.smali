...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->oZ()Lcom/google/android/gms/plus/model/people/Person;
...
.method public getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/pt;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    new-instance v0, Lcom/google/android/gms/internal/pi$c;

    const-string v1, "image"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/pt;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/pi$c;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/pi$e;->ck(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->oW()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->oX()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->oY()Ljava/util/ArrayList;
...
.method public oW()Ljava/util/ArrayList;
    .locals 1
...
.method public oX()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public oY()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public oZ()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/pi;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/pi$c;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/pt;->getUrl()Ljava/lang/String;
