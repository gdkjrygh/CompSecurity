...
.method private declared-synchronized eC()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->yV:Lcom/google/android/gms/analytics/f;

    invoke-interface {v1}, Lcom/google/android/gms/analytics/f;->dX()Ljava/util/concurrent/LinkedBlockingQueue;

    move-result-object v1

    new-instance v2, Lcom/google/android/gms/analytics/w$1;

    invoke-direct {v2, p0}, Lcom/google/android/gms/analytics/w$1;-><init>(Lcom/google/android/gms/analytics/w;)V
    ...
    :cond_1
    :try_start_1
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/w;->zr:Z
    ...
    :cond_2
    sget-object v1, Lcom/google/android/gms/analytics/w$2;->zw:[I

    iget-object v2, p0, Lcom/google/android/gms/analytics/w;->zi:Lcom/google/android/gms/analytics/w$a;

    invoke-virtual {v2}, Lcom/google/android/gms/analytics/w$a;->ordinal()I
    ...
    :goto_1
    :pswitch_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->zm:Ljava/util/Queue;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->yU:Lcom/google/android/gms/analytics/d;

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/w$d;->eH()Ljava/util/Map;

    move-result-object v2

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/w$d;->eI()J

    move-result-wide v3

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/w$d;->getPath()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/w$d;->eJ()Ljava/util/List;
    ...
    :cond_3
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/w;->yX:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->zl:Lcom/google/android/gms/analytics/GoogleAnalytics;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->zj:Lcom/google/android/gms/analytics/b;
    ...
    :cond_5
    iget-object v1, p0, Lcom/google/android/gms/analytics/w;->wb:Lcom/google/android/gms/internal/ld;

    invoke-interface {v1}, Lcom/google/android/gms/internal/ld;->elapsedRealtime()J

    move-result-wide v1

    iput-wide v1, p0, Lcom/google/android/gms/analytics/w;->zh:J
...
.method public dQ()V
    ...
    iput-boolean v3, p0, Lcom/google/android/gms/analytics/w;->zr:Z
