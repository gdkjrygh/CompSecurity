...
public final class ProcReader
{
    ...
    {
        return a(s, ai, null, al, null);
    }

    private static boolean a(String s, int ai[], String as[], long al[], float af[])
    {
        Method method;
        method = a();
        if (method == null)
...
_L1:
    ...
    private static Method b()
    {
        ...
        catch (NoSuchMethodException nosuchmethodexception)
        {
            ...
            {
                Log.w(a, "Warning! Could not get access to JNI method - readProcFile", nosuchmethodexception);
            }
            return null;
        }
        return method;
