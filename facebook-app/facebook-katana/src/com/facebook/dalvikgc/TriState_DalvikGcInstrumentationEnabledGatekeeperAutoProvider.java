...
public class TriState_DalvikGcInstrumentationEnabledGatekeeperAutoProvider extends AbstractProvider
{
    ...
    private TriState a()
    {
        return ((GatekeeperStore)GatekeeperStoreImplMethodAutoProvider.a(this)).a(GK.iW);
    }
    ...
    {
        return ((GatekeeperStore)GatekeeperStoreImplMethodAutoProvider.a(injectorlike)).a(GK.iW);
    }
