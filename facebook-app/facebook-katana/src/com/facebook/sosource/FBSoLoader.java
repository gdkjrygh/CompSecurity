...
_L3:
        ...
        StrictMode.setThreadPolicy(threadpolicy);
        throw context;
        DirectorySoSourceWithAssets directorysosourcewithassets = new DirectorySoSourceWithAssets(context, new File(context.getApplicationInfo().nativeLibraryDir), 1);
