...
public class NodexSplashActivity extends AbstractNodexSplashActivity
{
    ...
    {
        int k = Logger.a(2, com.facebook.loom.logger.LogEntry.EntryType.LIFECYCLE_ACTIVITY_START, 0x5454f3f5);
        super.onCreate(bundle);
        ColdStartPrimingInformation.a().b(a);
        Logger.a(2, com.facebook.loom.logger.LogEntry.EntryType.LIFECYCLE_ACTIVITY_END, 0xbbb52807, k);
    }
}
