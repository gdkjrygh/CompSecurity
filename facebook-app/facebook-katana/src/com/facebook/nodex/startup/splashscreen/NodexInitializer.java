...
public class NodexInitializer
{
    ...
    public final NodexError a()
    {
        ...
        if (!dexdiagnostics.b())
        {
            return NodexError.b(b).a("nodex_cannot_launch_fb_app_string").b(d()).a(new IOException("Directory owner uid does not match process uid")).a(NodexErrorActivity.Action.UNINSTALL).a();
        }
        try
        {
