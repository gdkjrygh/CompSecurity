...
public class SimpleArrayMap
{
    ...
    {
        f = ContainerHelpers.a;
        g = ContainerHelpers.c;
        h = 0;
    }
...
_L2:
        int k;
        int j = ContainerHelpers.a(f, l, 0);
        i = j;
        if (j >= 0)
        {
            i = j;
...
_L2:
        int l;
        int k = ContainerHelpers.a(f, i1, i);
        j = k;
        if (k >= 0)
        {
            j = k;
...
_L3:
    ...
    {
        int i = 0;
        int j = simplearraymap.h;
        a(h + j);
        if (h == 0)
        {
            if (j > 0)
            {
                System.arraycopy(simplearraymap.f, 0, f, 0, j);
                System.arraycopy(((Object) (simplearraymap.g)), 0, ((Object) (g)), 0, j << 1);
                h = j;
            }
        } else
        {
            while (i < j) 
            {
                put(simplearraymap.b(i), simplearraymap.c(i));
                i++;
            }
        }
    }
