...
//            ValueAnimatorCompat, ViewUtilsLollipop
...
class ViewUtils
{
        ...
        implements ViewUtilsImpl
    {
        ...
        ViewUtilsImplBase(_cls1 _pcls1)
        {
            this();
        }
    }
        ...
        implements ViewUtilsImpl
    {
        ...
        ViewUtilsImplLollipop(_cls1 _pcls1)
        {
            this();
        }
    }
    ...
    static final ValueAnimatorCompat.Creator DEFAULT_ANIMATOR_CREATOR = new _cls1();
