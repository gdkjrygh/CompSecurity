...
//            ValueAnimatorCompat, AnimationUtils
    ...
    implements UpdateListener
{
    ...
    public void onAnimationUpdate(ValueAnimatorCompat valueanimatorcompat)
    {
        ...
        cess._mth1600(this._cls1.this, AnimationUtils.lerp(val$startLeft, val$targetLeft, f), AnimationUtils.lerp(val$startRight, val$targetRight, f));
    }
