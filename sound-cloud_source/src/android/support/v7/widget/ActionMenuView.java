...
public class ActionMenuView extends LinearLayoutCompat
    implements android.support.v7.internal.view.menu.f.b, n
{
    ...
    private android.support.v7.internal.view.menu.m.a mActionMenuPresenterCallback;
...
_L7:
    ...
    public Menu getMenu()
    {
        if (mMenu == null)
        {
            ...
            actionmenupresenter.setCallback(((android.support.v7.internal.view.menu.m.a) (obj)));
