...
_L1:
        ...
        ItemTouchHelperGestureListener(_cls1 _pcls1)
        {
            this();
        }
    }
...
// JavaClassFileOutputException: Invalid index accessing method local variables table of <init>
    ...
    private final Runnable mScrollRunnable = new _cls1();
    ...
    private void addChildDrawingOrderCallback()
    {
        ...
        {
            mChildDrawingOrderCallback = new _cls5();
        }
...
_L6:
        ...
        f2 = mTmpPosition[0];
        f3 = mTmpPosition[1];
        final_viewholder = new _cls3(k, f2, f3, f, f1, j, ((android.support.v7.widget.RecyclerView.ViewHolder) (final_viewholder)));
...
_L4:
    ...
    {
        while (!mCallback.hasDragFlag(mRecyclerView, viewholder) || viewholder.itemView.getParent() != mRecyclerView) 
        {
            return;
        }
    ...
    {
        while (!mCallback.hasSwipeFlag(mRecyclerView, viewholder) || viewholder.itemView.getParent() != mRecyclerView) 
        {
            return;
        }
        obtainVelocityTracker();
