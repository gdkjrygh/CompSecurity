...
_L5:
            (new StringBuilder("Scrap view for position ")).append(i).append(" isn't dirty but has wrong view type! (found ").append(((ViewHolder) (obj)).getItemViewType()).append(" but expected ").append(j).append(")");
_L2:
            if (!flag)
            {
...
_L2:
        return;
        if (mAdapter == null || mLayout == null) goto _L2; else goto _L1
_L1:
...
label0:
        ...
        i = 0;
        if (k == 0 && i == 0 || dispatchNestedPreFling(k, i)) goto _L1; else goto _L3
_L3:
        if (flag || flag1)
        {
            flag = true;
...
_L6:
        ...
        if (k < 0)
        {
            (new StringBuilder("Error processing scroll; pointer index for id ")).append(mScrollPointerId).append(" not found. Did any MotionEvents get skipped?");
            return false;
        }
...
_L3:
        ...
        j;
        JVM INSTR tableswitch 0 6: default 172
    //                   0 179
    //                   1 759
    //                   2 330
    //                   3 862
