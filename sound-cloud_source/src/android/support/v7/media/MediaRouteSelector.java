...
public final class MediaRouteSelector
{
    public static final class Builder
    {
        ...
        public final Builder addControlCategories(Collection collection)
        {
            if (collection == null)
            {
        ...
        public final Builder addControlCategory(String s)
        {
            if (s == null)
            {
        ...
        public final Builder addSelector(MediaRouteSelector mediarouteselector)
        {
    ...
    public final boolean contains(MediaRouteSelector mediarouteselector)
    {
        if (mediarouteselector != null)
        {
    ...
    public final boolean hasControlCategory(String s)
    {
        if (s != null)
        {
            ensureControlCategories();
    ...
    public final boolean matchesControlFilters(List list)
    {
        if (list != null)
        {
            ensureControlCategories();
