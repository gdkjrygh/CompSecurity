...
public static final class _cls00
{
    ...
    public final mBundle setContentDuration(long l)
    {
        mBundle.putLong("contentDuration", l);
        return this;
    }

    public final mBundle setContentPosition(long l)
    {
    ...
    public final mBundle setPlaybackState(int i)
    {
        mBundle.putInt("playbackState", i);
        return this;
    }

    public final mBundle setTimestamp(long l)
    {
