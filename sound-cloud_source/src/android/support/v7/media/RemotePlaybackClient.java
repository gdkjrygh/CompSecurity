...
_L4:
    ...
    private void handleError(Intent intent, ActionCallback actioncallback, String s, Bundle bundle)
    {
        ...
        if (DEBUG)
        {
            (new StringBuilder("Received error from ")).append(intent.getAction()).append(": error=").append(s).append(", code=").append(i).append(", data=").append(bundleToString(bundle));
        }
    ...
    {
        (new StringBuilder("Received invalid result data from ")).append(intent.getAction()).append(": data=").append(bundleToString(bundle));
    ...
    private void performItemAction(final Intent intent, final String sessionId, final String itemId, Bundle bundle, final ItemActionCallback callback)
    {
        ...
        logRequest(intent);
        mRoute.sendControlRequest(intent, new _cls1());
    }
    ...
    private void performSessionAction(final Intent intent, final String sessionId, Bundle bundle, final SessionActionCallback callback)
    {
        ...
        logRequest(intent);
        mRoute.sendControlRequest(intent, new _cls2());
    }
    ...
    private class _cls1 extends MediaRouter.ControlRequestCallback
    {
        ...
        {
            handleError(intent, callback, s, bundle);
        }
        ...
        public void onResult(Bundle bundle)
        {
            if (bundle != null)
            {
                ...
                if (s != null && s1 != null && mediaitemstatus != null)
                {
                    if (RemotePlaybackClient.DEBUG)
                    {
                        (new StringBuilder("Received result from ")).append(intent.getAction()).append(": data=").append(RemotePlaybackClient.bundleToString(bundle)).append(", sessionId=").append(s).append(", sessionStatus=").append(mediasessionstatus).append(", itemId=").append(s1).append(", itemStatus=").append(mediaitemstatus);
                    }
                    callback.onResult(bundle, s, mediasessionstatus, s1, mediaitemstatus);
                    return;
                }
            }
            handleInvalidResult(intent, callback, bundle);
        }
    ...
    private class _cls2 extends MediaRouter.ControlRequestCallback
    {
        ...
        public void onResult(Bundle bundle)
        {
            ...
            if (RemotePlaybackClient.DEBUG)
            {
                (new StringBuilder("Received result from ")).append(intent.getAction()).append(": data=").append(RemotePlaybackClient.bundleToString(bundle)).append(", sessionId=").append(s).append(", sessionStatus=").append(mediasessionstatus);
            }
