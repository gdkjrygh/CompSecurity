...
public static final class _cls00
{
    ...
    public final _cls00 addControlCategories(Collection collection)
    {
        if (collection == null)
        {
    ...
    public final addControlCategory addControlCategory(String s)
    {
        if (s == null)
        {
    ...
    public final mControlCategories addSelector(MediaRouteSelector mediarouteselector)
    {
