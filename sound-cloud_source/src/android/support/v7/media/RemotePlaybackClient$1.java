    ...
    public void onResult(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            if (s != null && s1 != null && mediaitemstatus != null)
            {
                ...
                {
                    (new StringBuilder("Received result from ")).append(val$intent.getAction()).append(": data=").append(RemotePlaybackClient.access$400(bundle)).append(", sessionId=").append(s).append(", sessionStatus=").append(mediasessionstatus).append(", itemId=").append(s1).append(", itemStatus=").append(mediaitemstatus);
                }
