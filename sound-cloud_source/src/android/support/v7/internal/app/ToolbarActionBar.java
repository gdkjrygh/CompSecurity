...
public class ToolbarActionBar extends ActionBar
{
        ...
        implements android.support.v7.internal.view.menu.m.a
    {
        ...
        public final void onCloseMenu(f f1, boolean flag)
        {
            ...
            {
                mWindowCallback.onPanelClosed(8, f1);
            }
        ...
        public final boolean onOpenSubMenu(f f1)
        {
            if (mWindowCallback != null)
            {
                mWindowCallback.onMenuOpened(8, f1);
                return true;
            } else
            {
                return false;
...
_L3:
    ...
    private void ensureListMenuPresenter(Menu menu)
    {
        if (mListMenuPresenter == null && (menu instanceof f))
        {
            ...
            mListMenuPresenter.g = new PanelMenuPresenterCallback(null);
    ...
    {
        ViewCompat.setElevation(mDecorToolbar.getViewGroup(), f1);
    }
