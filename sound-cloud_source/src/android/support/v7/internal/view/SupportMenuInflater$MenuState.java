...
private class resetGroup
{
    ...
    private Object newInstance(String s, Class aclass[], Object aobj[])
    {
        try
        {
            s = ((String) (SupportMenuInflater.access$100(SupportMenuInflater.this).getClassLoader().loadClass(s).getConstructor(aclass).newInstance(aobj)));
        }
        ...
        if (itemCheckable >= 2)
        {
            ...
            if (menuitem instanceof j)
            {
                ...
                try
                {
                    if (j1.e == null)
                    {
                        j1.e = ((SupportMenuItem)j1.d).getClass().getDeclaredMethod("setExclusiveCheckable", new Class[] {
                            Boolean.TYPE
                        });
                    }
                    j1.e.invoke(j1.d, new Object[] {
