...
public class l
    implements m, android.view.View.OnKeyListener, android.view.ViewTreeObserver.OnGlobalLayoutListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
    private final class a extends BaseAdapter
    {
        ...
        public final View getView(int i, View view, ViewGroup viewgroup)
        {
            if (view == null)
            {
                view = a.mInflater.inflate(l.ITEM_LAYOUT, viewgroup, false);
            }
            viewgroup = (n.a)view;
            if (a.mForceShowIcon)
            {
    ...
    public l(Context context, f f1)
    {
        this(context, f1, null, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public l(Context context, f f1, View view)
    {
        this(context, f1, view, false, android.support.v7.appcompat.R.attr.popupMenuStyle);
    }

    public l(Context context, f f1, View view, boolean flag, int i)
    {
        this(context, f1, view, flag, i, 0);
    }

    public l(Context context, f f1, View view, boolean flag, int i, int j)
    {
        mDropDownGravity = 0;
        mContext = context;
...
label0:
    ...
    {
        if (!q1.hasVisibleItems()) goto _L2; else goto _L1
_L1:
        l l1;
        int i;
        int j;
        l1 = new l(mContext, q1, mAnchorView);
        l1.setCallback(mPresenterCallback);
        j = q1.size();
        i = 0;
_L5:
        MenuItem menuitem;
        ...
        menuitem = q1.getItem(i);
        if (!menuitem.isVisible() || menuitem.getIcon() == null) goto _L4; else goto _L3
_L3:
        boolean flag = true;
_L6:
        l1.setForceShowIcon(flag);
        if (l1.tryShow())
        {
            if (mPresenterCallback != null)
            {
                mPresenterCallback.onOpenSubMenu(q1);
            }
            return true;
        }
          goto _L2
...
_L2:
    ...
    public void setCallback(m.a a1)
    {
