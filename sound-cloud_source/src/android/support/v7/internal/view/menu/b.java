    ...
    implements m
{
    ...
    public abstract void bindItemView(h h1, n.a a);
    ...
    {
        return (n.a)mSystemInflater.inflate(mItemLayoutRes, viewgroup, false);
    }
    ...
    public n getMenuView(ViewGroup viewgroup)
    {
        if (mMenuView == null)
        {
            mMenuView = (n)mSystemInflater.inflate(mMenuLayoutRes, viewgroup, false);
    ...
    public boolean onSubMenuSelected(q q)
    {
        if (mCallback != null)
        {
            return mCallback.onOpenSubMenu(q);
        } else
        {
            return false;
        }
