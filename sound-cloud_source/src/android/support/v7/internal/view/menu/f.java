...
_L4:
        ...
        if (!y.isEmpty())
        {
            ...
            do
            {
                ...
                } else
                {
                    ...
                    if (i1 > 0)
                    {
                        Parcelable parcelable = m1.onSaveInstanceState();
                        if (parcelable != null)
                        {
    ...
    public final void a(m m1, Context context)
    {
        y.add(new WeakReference(m1));
        m1.initForMenu(context, this);
        s = true;
    }
...
label0:
            do
            {
                ...
                flag = m1.expandItemActionView(this, h1);
            } while (!flag);
            e();
            flag1 = flag;
            if (flag)
    ...
    public final boolean a(MenuItem menuitem, m m1, int i1)
    {
        boolean flag1;
        boolean flag2;
        flag2 = false;
...
_L3:
        if (menuitem.hasSubMenu() || flag)
        {
            ...
            {
                menuitem.a(new q(a, this, menuitem));
            }
            menuitem = (q)menuitem.getSubMenu();
            if (flag)
            {
            ...
            if (!y.isEmpty())
            {
                ...
                if (m1 != null)
                {
                    flag1 = m1.onSubMenuSelected(menuitem);
                }
                m1 = y.iterator();
                while (m1.hasNext()) 
                {
                    WeakReference weakreference = (WeakReference)m1.next();
                    ...
                    if (!flag1)
                    {
                        flag1 = m2.onSubMenuSelected(menuitem);
                    }
                }
            }
            flag2 = flag3 | flag1;
...
_L5:
    ...
    public SubMenu addSubMenu(int i1, int j1, int k1, CharSequence charsequence)
    {
        ...
        q q1 = new q(a, this, charsequence);
        charsequence.a(q1);
        return q1;
    }
            ...
            while (iterator.hasNext()) 
            {
                ...
                } else
                {
                    ...
                    if (i1 > 0)
                    {
                        ...
                        if (parcelable != null)
                        {
                            m1.onRestoreInstanceState(parcelable);
                        }
                    }
                }
            }
...
label0:
                do
                {
                    ...
                    flag1 = m1.collapseItemActionView(this, h1);
                } while (!flag1);
                e();
                flag2 = flag1;
                if (flag1)
    ...
    public final void c(Bundle bundle)
    {
        ...
        for (sparsearray = null; i1 < j1; sparsearray = sparsearray2)
        {
            ...
            if (menuitem.hasSubMenu())
            {
                ((q)menuitem.getSubMenu()).c(bundle);
            }
            i1++;
        }
    ...
    public final void d(Bundle bundle)
    {
        if (bundle != null)
        {
            ...
            for (int i1 = 0; i1 < k1; i1++)
            {
                ...
                if (menuitem.hasSubMenu())
                {
                    ((q)menuitem.getSubMenu()).d(bundle);
                }
            }
...
_L2:
    ...
    {
        return a(findItem(i1), ((m) (null)), j1);
    }
