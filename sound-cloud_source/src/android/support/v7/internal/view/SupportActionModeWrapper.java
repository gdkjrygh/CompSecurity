...
public class SupportActionModeWrapper extends ActionMode
{
        ...
        implements android.support.v7.view.ActionMode.Callback
    {
        ...
        private Menu getMenuWrapper(Menu menu)
        {
            ...
            if (menu2 == null)
            {
                menu1 = o.a(mContext, (SupportMenu)menu);
        ...
        {
            return mWrappedCallback.onActionItemClicked(getActionModeWrapper(actionmode), o.a(mContext, (SupportMenuItem)menuitem));
        }
    ...
    public Menu getMenu()
    {
        return o.a(mContext, (SupportMenu)mWrappedObject.getMenu());
    }
