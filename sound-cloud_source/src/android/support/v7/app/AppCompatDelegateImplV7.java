...
_L3:
    ...
    private static final class PanelFeatureState
    {
        ...
        final n getListMenuView(android.support.v7.internal.view.menu.m.a a)
        {
            if (menu == null)
            {
                return null;
        ...
        implements Parcelable
    {
        ...
        PanelFeatureState.SavedState(_cls1 _pcls1)
        {
            this();
        }
...
_L1:
        if (f1 != null && !isDestroyed())
        {
            ...
            {
                f1.onMenuOpened(8, panelfeaturestate.menu);
...
_L3:
        f1.onPanelClosed(8, getPanelState(0, true).menu);
        return;
