    ...
    implements Parcelable
{
    public static final class Builder
    {
        ...
        public final Builder addCustomAction(String s, String s1, int i)
        {
        ...
        public final Builder setActions(long l)
        {
            mActions = l;
            return this;
        }

        public final Builder setActiveQueueItemId(long l)
        {
            mActiveItemId = l;
            return this;
        }

        public final Builder setBufferedPosition(long l)
        {
            mBufferedPosition = l;
            return this;
        }
        ...
        public final Builder setState(int i, long l, float f)
        {
            return setState(i, l, f, SystemClock.elapsedRealtime());
        }

        public final Builder setState(int i, long l, float f, long l1)
        {
            mState = i;
            mPosition = l;
            mUpdateTime = l1;
    ...
    public static final class CustomAction.Builder
    {
        ...
        public final CustomAction.Builder setExtras(Bundle bundle)
        {
            mExtras = bundle;
            return this;
        }
