...
_L3:
        ...
        implements MediaControllerImpl
    {
        ...
        public void adjustVolume(int i, int j)
        {
            ...
            {
                (new StringBuilder("Dead object in adjustVolume. ")).append(remoteexception);
            }
        }
        ...
        public boolean dispatchMediaButtonEvent(KeyEvent keyevent)
        {
            ...
            {
                (new StringBuilder("Dead object in dispatchMediaButtonEvent. ")).append(keyevent);
            }
            return false;
        }
        ...
        public Bundle getExtras()
        {
            ...
            {
                (new StringBuilder("Dead object in getExtras. ")).append(remoteexception);
                return null;
            }
            return bundle;
        }
        ...
        public long getFlags()
        {
            ...
            {
                (new StringBuilder("Dead object in getFlags. ")).append(remoteexception);
                return 0L;
            }
            return l;
        }
        ...
        public MediaMetadataCompat getMetadata()
        {
            ...
            {
                (new StringBuilder("Dead object in getMetadata. ")).append(remoteexception);
                return null;
            }
        ...
        public String getPackageName()
        {
            ...
            {
                (new StringBuilder("Dead object in getPackageName. ")).append(remoteexception);
                return null;
            }
            return s;
        }
        ...
        public PlaybackInfo getPlaybackInfo()
        {
            ...
            {
                (new StringBuilder("Dead object in getPlaybackInfo. ")).append(remoteexception);
                return null;
            }
        ...
        public PlaybackStateCompat getPlaybackState()
        {
            ...
            {
                (new StringBuilder("Dead object in getPlaybackState. ")).append(remoteexception);
                return null;
            }
        ...
        public List getQueue()
        {
            ...
            {
                (new StringBuilder("Dead object in getQueue. ")).append(remoteexception);
                return null;
            }
            return list;
        }
        ...
        public CharSequence getQueueTitle()
        {
            ...
            {
                (new StringBuilder("Dead object in getQueueTitle. ")).append(remoteexception);
                return null;
            }
            return charsequence;
        }
        ...
        public int getRatingType()
        {
            ...
            {
                (new StringBuilder("Dead object in getRatingType. ")).append(remoteexception);
                return 0;
            }
            return i;
        }
        ...
        public PendingIntent getSessionActivity()
        {
            ...
            {
                (new StringBuilder("Dead object in getSessionActivity. ")).append(remoteexception);
                return null;
            }
        ...
        public void registerCallback(Callback callback, Handler handler)
        {
            ...
            {
                (new StringBuilder("Dead object in registerCallback. ")).append(handler);
            }
        ...
        public void sendCommand(String s, Bundle bundle, ResultReceiver resultreceiver)
        {
            ...
            {
                (new StringBuilder("Dead object in sendCommand. ")).append(s);
            }
        }
        ...
        public void setVolumeTo(int i, int j)
        {
            ...
            {
                (new StringBuilder("Dead object in setVolumeTo. ")).append(remoteexception);
            }
        }
        ...
        public void unregisterCallback(Callback callback)
        {
            ...
            {
                (new StringBuilder("Dead object in unregisterCallback. ")).append(callback);
            }
        }
