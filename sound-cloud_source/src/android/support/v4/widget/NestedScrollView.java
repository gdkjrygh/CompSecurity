...
_L4:
        ...
        if (j != -1)
        {
            ...
            if (i1 == -1)
            {
                (new StringBuilder("Invalid pointerId=")).append(j).append(" in onInterceptTouchEvent");
            } else
            {
...
_L4:
        ...
        if (i1 == -1)
        {
            (new StringBuilder("Invalid pointerId=")).append(mActivePointerId).append(" in onTouchEvent");
            continue; /* Loop/switch isn't completed */
        }
