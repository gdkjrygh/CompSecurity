...
public final class kv
{
    ...
    public static File a(Context context, boolean flag)
    {
        ...
        if (file1 == null)
        {
            ...
            ku.c("Can't define system cache directory! '%s' will be used.", new Object[] {
                context
            });
...
label0:
        {
            ...
            if (!file.exists())
            {
                ...
                ku.c("Unable to create external cache directory", new Object[0]);
                context = null;
            }
            return context;
        }
        ...
        {
            ku.b("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return file;
        }
        return file;
    }
