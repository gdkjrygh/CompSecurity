...
_L1:
        String.format("Error: Attempted to add a null subscriber for eventClass %s. This subscriber is being ignored. Please check your calling code to ensure that all potential subscriptions are valid.", new Object[] {
            class1.getName()
        });
_L3:
        obj1;
