...
_L4:
        ...
        ag1;
        String.format("Could not read from response stream [%s]", new Object[] {
            ag1.getMessage()
        });
_L8:
        if (jsonobject != null)
        ...
        String.format("Failed to get result from [%s]. Returning null.", new Object[] {
            String.valueOf(url)
        });
        return null;
        ag1;
        String.format("Unable to parse response [%s]", new Object[] {
            ag1
        });
          goto _L8
        url;
