...
_L2:
    ...
    {
        String.format("Creating %s table", new Object[] {
            "ab_sessions"
        });
    ...
    {
        String.format("Downgrading storage from version %d to %d. Dropping all current tables.", new Object[] {
    ...
    public final void onUpgrade(SQLiteDatabase sqlitedatabase, int i, int j)
    {
        ...
        {
            String.format("Received call to onUpgrade with unknown upgrade version %d.  Please contact Appboy to report this error.", new Object[] {
                Integer.valueOf(j)
            });
            return;
        }
