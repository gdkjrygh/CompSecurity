...
public class cm
{
    ...
    {
        this(cr, d1, null, new cf(gr.g()), true, false, false);
    }
    ...
    public final cf e()
    {
        ...
        synchronized (i)
        {
            cf1 = new cf((new gs()).b(gr.a(b)).b(gr.a(c)).a());
        }
        return cf1;
    }
    ...
    public final ch f()
    {
        ...
        obj = a();
_L1:
        obj = new ch(this, Double.valueOf(d1), ((Double) (obj)), gr.a(j()), d, flag1);
        c.addAll(b);
        b.clear();
        obj1;
