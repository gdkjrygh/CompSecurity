...
_L7:
        ...
        b.a.a.a.d.a();
        obj = s;
        (new StringBuilder("Error parsing ")).append(file);
        a(((Closeable) (s)));
        return null;
        file;
        obj = null;
...
_L6:
    ...
    private static String a(byte abyte0[], String s)
    {
        ...
        {
            b.a.a.a.d.a();
            (new StringBuilder("Could not create hashing algorithm: ")).append(s).append(", returning empty string.");
            return "";
        }
