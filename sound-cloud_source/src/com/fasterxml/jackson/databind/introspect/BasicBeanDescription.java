...
public class BasicBeanDescription extends BeanDescription
{
        ...
        for (Iterator iterator = _properties.iterator(); iterator.hasNext();)
        {
            ...
            if (annotatedmember != null)
            {
                ...
                if (obj != null && ((com.fasterxml.jackson.databind.AnnotationIntrospector.ReferenceProperty) (obj)).isBackReference())
                {
                    ...
                    {
                        throw new IllegalArgumentException((new StringBuilder("Multiple back-reference properties with name '")).append(((String) (obj))).append("'").toString());
                    }
                }
            }
        }
    ...
    public Object instantiateBean(boolean flag)
    {
        ...
        catch (Object obj1)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder("Failed to instantiate bean of type ")).append(_classInfo.getAnnotated().getName()).append(": (").append(obj1.getClass().getName()).append(") ").append(((Throwable) (obj1)).getMessage()).toString(), ((Throwable) (obj1)));
            }
        }
        return obj;
    }
