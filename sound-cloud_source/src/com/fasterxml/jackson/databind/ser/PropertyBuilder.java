    ...
    protected JavaType findSerializationType(Annotated annotated, boolean flag, JavaType javatype)
    {
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                {
                    throw new IllegalArgumentException((new StringBuilder("Illegal concrete-type annotation for method '")).append(annotated.getName()).append("': class ").append(((Class) (obj)).getName()).append(" not a super-type of (declared) class ").append(class1.getName()).toString());
                }
