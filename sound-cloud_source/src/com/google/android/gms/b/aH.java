...
public final class aH
{
    ...
    public static String a(aG ag)
    {
        ...
        try
        {
            a(null, ag, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (aG ag)
        {
            return (new StringBuilder("Error printing proto: ")).append(ag.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (aG ag)
        {
...
_L1:
        if (!(obj instanceof aG)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int j;
