        ...
        implements f
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                a(authaccountrequest, e.a.zzdG(parcel.readStrongBinder()));
            ...
            case 5: // '\005'
                ...
                a(resolveaccountrequest, com.google.android.gms.common.internal.zzt.zza.zzaL(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 8: // '\b'
                ...
                a(i, account, e.a.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 9: // '\t'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                zzp zzp = com.google.android.gms.common.internal.zzp.zza.zzaH(parcel.readStrongBinder());
                i = parcel.readInt();
                if (parcel.readInt() != 0)
                {
                    flag = true;
            ...
            case 10: // '\n'
                ...
                a(recordconsentrequest, e.a.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 11: // '\013'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                a(e.a.zzdG(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L2:
        ...
        public final void a(ResolveAccountRequest resolveaccountrequest, zzt zzt1)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L2:
        ...
        public final void a(zzp zzp1, int i, boolean flag)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L1:
    ...
    public abstract void a(ResolveAccountRequest resolveaccountrequest, zzt zzt)
        throws RemoteException;

    public abstract void a(zzp zzp, int i, boolean flag)
        throws RemoteException;
