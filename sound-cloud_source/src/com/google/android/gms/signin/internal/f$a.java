...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            ...
            a(authaccountrequest, zzdG(parcel.readStrongBinder()));
        ...
        case 5: // '\005'
            ...
            a(resolveaccountrequest, com.google.android.gms.common.internal.zza.zzaL(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 8: // '\b'
            ...
            a(i, account, zzdG(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 9: // '\t'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            zzp zzp = com.google.android.gms.common.internal.zza.zzaH(parcel.readStrongBinder());
            i = parcel.readInt();
            if (parcel.readInt() != 0)
            {
                flag = true;
        ...
        case 10: // '\n'
            ...
            a(recordconsentrequest, zzdG(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 11: // '\013'
            parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
            a(zzdG(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
