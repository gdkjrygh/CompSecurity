...
_L10:
        a.a(s1, s3);
          goto _L4
        xmlresourceparser;
        d("Error parsing tracker configuration file", xmlresourceparser);
_L2:
        return a.a();
_L9:
...
_L17:
    ...
    public final P a(int i)
    {
        ...
        try
        {
            p = a(super.i.b.getResources().getXml(i));
        }
        catch (android.content.res.Resources.NotFoundException notfoundexception)
        {
            c("inflate() called with unknown resourceId", notfoundexception);
            return null;
        }
        return p;
    }
