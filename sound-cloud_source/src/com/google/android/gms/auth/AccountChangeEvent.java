    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            {
                if (a != ((AccountChangeEvent) (obj = (AccountChangeEvent)obj)).a || b != ((AccountChangeEvent) (obj)).b || !zzw.equal(c, ((AccountChangeEvent) (obj)).c) || d != ((AccountChangeEvent) (obj)).d || e != ((AccountChangeEvent) (obj)).e || !zzw.equal(f, ((AccountChangeEvent) (obj)).f))
                {
                    return false;
                }
            } else
