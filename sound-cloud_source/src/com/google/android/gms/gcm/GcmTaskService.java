...
public abstract class GcmTaskService extends Service
{
    private class zza extends Thread
    {
        ...
        public void run()
        {
            ...
            Object obj;
            obj;
            (new StringBuilder("Error reporting result of operation to scheduler for ")).append(mTag);
            GcmTaskService.zza(zzazQ, mTag);
            return;
            obj;
            GcmTaskService.zza(zzazQ, mTag);
...
_L3:
        (new StringBuilder()).append(getPackageName()).append(" ").append(s).append(": Could not process request, invalid callback.");
_L6:
        return 2;
_L4:
        synchronized (zzazN)
