...
public interface GoogleApiClient
{
    public static final class Builder
    {
        ...
        private com.google.android.gms.signin.g.a zzZm;
        ...
        private transient void zza(Api api, Api.ApiOptions apioptions, int i, Scope ascope[])
        {
            ...
            if (i != 1)
            {
                ...
                {
                    throw new IllegalArgumentException((new StringBuilder("Invalid resolution mode: '")).append(i).append("', use a constant from GoogleApiClient.ResolutionMode").toString());
                }
            }
        ...
        class _cls1 {}
                ...
                (new Handler(mContext.getMainLooper())).post(new _cls1(zzi1));
                return zzi1;
            } else
            {
                zza(zzp1, zzi1);
        ...
        public final Builder requestServerAuthCode(String s, ServerAuthCodeCallbacks serverauthcodecallbacks)
        {
            boolean flag1 = true;
            com.google.android.gms.signin.g.a a = zzZm;
            a.a = true;
            a.b = true;
            zzx.zzv(s);
            boolean flag = flag1;
        /* block-local class not found */
        class ServerAuthCodeCallbacks {}
            ...
            a.c = s;
            a.d = (ServerAuthCodeCallbacks)zzx.zzv(serverauthcodecallbacks);
            return this;
        }
        ...
        public final zzf zzni()
        {
            return new zzf(zzOY, zzYY, zzZc, zzYZ, zzZa, zzQl, zzZb, zzZm.a());
        }
        ...
        public Builder(Context context)
        {
            ...
            zzZk = new ArrayList();
            zzZl = new ArrayList();
            zzZm = new com.google.android.gms.signin.g.a();
            mContext = context;
    ...
    // Unreferenced inner class com/google/android/gms/common/api/GoogleApiClient$zza
    /* block-local class not found */
    class zza {}
