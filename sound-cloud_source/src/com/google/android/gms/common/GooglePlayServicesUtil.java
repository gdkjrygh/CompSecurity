...
_L3:
    ...
    {
        byte byte0 = 9;
        if (!zzd.zzacF) goto _L2; else goto _L1
_L1:
        int i = 0;
_L6:
        return i;
_L2:
        ...
        try
        {
            context.getResources().getString(com.google.android.gms.a.d.common_google_play_services_unknown_issue);
        }
        ...
        if (!T.b(((PackageInfo) (obj)).versionCode) && !T.a(context)) goto _L4; else goto _L3
_L3:
        i = byte0;
        if (zzd1.zza(((PackageInfo) (obj)), zzc.zzbu.zzYt) == null) goto _L6; else goto _L5
_L5:
        i = T.a(GOOGLE_PLAY_SERVICES_VERSION_CODE);
        if (T.a(((PackageInfo) (obj)).versionCode) < i)
        {
...
_L4:
        zza1 = zzd1.zza(packagemanager.getPackageInfo("com.android.vending", 64), zzc.zzbu.zzYt);
        i = byte0;
        if (zza1 == null) goto _L6; else goto _L7
_L7:
        zza1 = zzd1.zza(((PackageInfo) (obj)), new zzc.zza[] {
            zza1
        });
        if (zza1 == null)
        {
...
_L8:
    ...
    private static void zza(int i, Context context, String s)
    {
        ...
        if (s1 == null)
        {
            obj = resources.getString(com.google.android.gms.a.d.common_google_play_services_notification_ticker);
        }
        ...
        {
            zzx.zzY(aa.a(16));
            obj = (new android.app.Notification.Builder(context)).setSmallIcon(com.google.android.gms.a.b.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle((new android.app.Notification.BigTextStyle()).bigText((new StringBuilder()).append(((String) (obj))).append(" ").append(s2).toString())).addAction(com.google.android.gms.a.b.common_full_open_on_phone, resources.getString(com.google.android.gms.a.d.common_open_on_phone), pendingintent).build();
        } else
        {
            Object obj1 = resources.getString(com.google.android.gms.a.d.common_google_play_services_notification_ticker);
            if (aa.a(11))
            {
...
_L6:
    ...
    public static boolean zzag(Context context)
    {
        ...
        return aa.a(21) && context.hasSystemFeature("com.google.sidewinder");
    }
