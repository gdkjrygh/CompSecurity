    ...
    implements e
{
    ...
    public b call()
    {
        com.soundcloud.propeller.QueryResult queryresult = PropellerRx.access$000(PropellerRx.this).query(val$query);
        return b.from(queryresult).doOnUnsubscribe(PropellerRx.access$100(queryresult));
    }
