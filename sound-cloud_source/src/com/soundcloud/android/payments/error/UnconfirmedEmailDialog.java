...
public class UnconfirmedEmailDialog extends UnrecoverableErrorDialog
{
    ...
    public UnconfirmedEmailDialog()
    {
    }

    public static void show(FragmentManager fragmentmanager)
    {
        (new UnconfirmedEmailDialog()).show(fragmentmanager, "payment_error");
    }

    public Dialog onCreateDialog(Bundle bundle)
    {
        return (new ImageAlertDialog(getActivity())).setContent(0x7f0200f8, 0x7f0702ee, 0x7f0702f3).setPositiveButton(0x104000a, listener).create();
    }
        ...
        implements android.content.DialogInterface.OnClickListener
    {
        ...
        final UnconfirmedEmailDialog this$0;
        ...
        _cls1()
        {
            this$0 = UnconfirmedEmailDialog.this;
            super();
        }
    }
