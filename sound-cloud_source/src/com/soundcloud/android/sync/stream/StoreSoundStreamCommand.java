...
class StoreSoundStreamCommand extends DefaultWriteStorageCommand
{

    StoreSoundStreamCommand(PropellerDatabase propellerdatabase)
    {
    ...
    {
        return propellerdatabase.runTransaction(new SoundStreamInsertTransaction(iterable));
    }
