    ...
    implements Provider
{
    ...
    {
        preferences = l1.a("@javax.inject.Named(value=StreamSync)/android.content.SharedPreferences", com/soundcloud/android/sync/SyncModule, getClass().getClassLoader());
    }

    public final TimelineSyncStorage get()
    {
        return module.soundStreamSyncStorage((SharedPreferences)preferences.get());
    }
    ...
    public a(SyncModule syncmodule)
    {
