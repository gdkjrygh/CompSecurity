    ...
    implements PropertySetSource
{
    ...
    public ApiPost(Urn urn, Date date)
    {
        targetUrn = urn;
        createdAt = date;
    }
    ...
    public PropertySet toPropertySet()
    {
        return PropertySet.from(new PropertyBinding[] {
            PostProperty.TARGET_URN.bind(targetUrn), PostProperty.CREATED_AT.bind(createdAt), PostProperty.IS_REPOST.bind(Boolean.valueOf(false))
        });
    }
}
