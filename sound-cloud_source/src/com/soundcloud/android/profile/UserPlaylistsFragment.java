...
//            ScrollableProfileFragment, ProfileArguments, UserPlaylistsPresenter

public class UserPlaylistsFragment extends ScrollableProfileFragment
{

    UserPlaylistsPresenter presenter;
    ...
    public static UserPlaylistsFragment create(Urn urn, Screen screen, SearchQuerySourceInfo searchquerysourceinfo)
    {
        UserPlaylistsFragment userplaylistsfragment = new UserPlaylistsFragment();
        userplaylistsfragment.setArguments(ProfileArguments.from(urn, screen, searchquerysourceinfo));
