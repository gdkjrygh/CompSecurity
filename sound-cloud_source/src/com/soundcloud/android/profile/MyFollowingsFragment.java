...
//            ScrollableProfileFragment, MyFollowingsPresenter

public class MyFollowingsFragment extends ScrollableProfileFragment
    implements RefreshableScreen
{

    MyFollowingsPresenter presenter;
    ...
    public static MyFollowingsFragment create(Screen screen, SearchQuerySourceInfo searchquerysourceinfo)
    {
        ...
        screen = new MyFollowingsFragment();
