...
//            ScrollableProfileFragment, ProfileArguments, UserLikesPresenter
...
public class UserLikesFragment extends ScrollableProfileFragment
{
    ...
    public static UserLikesFragment create(Urn urn, Screen screen, SearchQuerySourceInfo searchquerysourceinfo)
    {
        UserLikesFragment userlikesfragment = new UserLikesFragment();
        userlikesfragment.setArguments(ProfileArguments.from(urn, screen, searchquerysourceinfo));
