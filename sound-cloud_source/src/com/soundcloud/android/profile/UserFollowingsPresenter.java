...
class UserFollowingsPresenter extends RecyclerViewPresenter
{
    ...
    UserFollowingsPresenter(ImagePauseOnScrollListener imagepauseonscrolllistener, SwipeRefreshAttacher swiperefreshattacher, UserProfileOperations userprofileoperations, UserRecyclerItemAdapter userrecycleritemadapter, Navigator navigator1)
    {
    ...
    protected CollectionBinding onBuildBinding(Bundle bundle)
    {
        ...
        return CollectionBinding.from(profileOperations.pagedFollowings(bundle), pageTransformer).withAdapter(adapter).withPager(profileOperations.followingsPagingFunction()).build();
    }
    ...
    public void onViewCreated(Fragment fragment, View view, Bundle bundle)
    {
        ...
        getEmptyView().setMessageText(0x7f070162);
        getEmptyView().setImage(0x7f0200fe);
    }
