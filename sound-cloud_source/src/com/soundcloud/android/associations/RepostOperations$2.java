    ...
    implements f
{
    ...
    public b call(PropertySet propertyset)
    {
        ...
        return RepostOperations.access$200(RepostOperations.this, urn).map(RxUtils.returning(propertyset)).onErrorResumeNext(RepostOperations.access$100(RepostOperations.this, urn));
    }
