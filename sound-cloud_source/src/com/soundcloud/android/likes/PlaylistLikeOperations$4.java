...
//            LikeProperty, PlaylistLikeOperations
    ...
    implements com.soundcloud.rx.erations._cls4
{
    ...
    public b call(List list)
    {
        ...
        {
            return PlaylistLikeOperations.access$400(PlaylistLikeOperations.this, ((Date)((PropertySet)Iterables.getLast(list)).get(LikeProperty.CREATED_AT)).getTime());
        }
    }
