...
class this._cls0
    implements android.view.tTagsPresenter._cls1
{
    ...
    {
        PlaylistTagsPresenter.access$000(PlaylistTagsPresenter.this).publish(EventQueue.TRACKING, SearchEvent.recentTagSearch((String)view.getTag()));
