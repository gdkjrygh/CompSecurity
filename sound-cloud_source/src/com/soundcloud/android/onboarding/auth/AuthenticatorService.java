...
public class AuthenticatorService extends Service
{
    public static class SoundCloudAuthenticator extends AbstractAccountAuthenticator
    {
            ...
            throws NetworkErrorException
        {
            ...
            } else
            {
                    ...
                    implements Runnable
                {
                    ...
                    final SoundCloudAuthenticator this$0;
                ...
                _cls1()
                {
                    this$0 = SoundCloudAuthenticator.this;
                    super();
                }
                }
        ...
        public SoundCloudAuthenticator(Context context1, AccountOperations accountoperations)
        {
            super(context1);
            context = context1;
    ...
    public IBinder onBind(Intent intent)
    {
        ...
        {
            ibinder = authenticator.getIBinder();
        }
        return ibinder;
    }
