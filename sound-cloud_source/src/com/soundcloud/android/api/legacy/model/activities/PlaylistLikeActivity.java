...
public class PlaylistLikeActivity extends PlaylistActivity
    implements PlayableHolder
{
    ...
    {
        return super.toPropertySet().put(ActivityProperty.KIND, ActivityKind.PLAYLIST_LIKE).put(ActivityProperty.PLAYABLE_TITLE, playlist.getTitle());
    }
}
