...
public class PromotedPlaylistItem extends PlaylistItem
    implements PromotedListItem
{

    PromotedPlaylistItem(PropertySet propertyset)
    {
        super(propertyset);
    }

    public static PromotedPlaylistItem from(PropertySet propertyset)
    {
        return new PromotedPlaylistItem(propertyset);
    }
