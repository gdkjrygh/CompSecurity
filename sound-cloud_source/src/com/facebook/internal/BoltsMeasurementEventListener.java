...
public class BoltsMeasurementEventListener extends BroadcastReceiver
{
    ...
    public static BoltsMeasurementEventListener a(Context context)
    {
        ...
        } else
        {
            ...
            a = context;
            LocalBroadcastManager.getInstance(((BoltsMeasurementEventListener) (context)).b).registerReceiver(context, new IntentFilter("com.parse.bolts.measurement_event"));
            return a;
        }
    }
