    ...
    implements Parcelable
{
    ...
    public static AccessToken a(Collection collection, Bundle bundle, h h, String s)
        throws p
    {
        Date date = U.a(bundle, "expires_in", new Date());
        ...
        {
            return new AccessToken(s1, s, b(bundle.getString("signed_request")), collection, ((Collection) (obj)), h, date, new Date());
        }
    }
...
_L1:
    ...
    protected final void a(String s)
    {
        ...
        a1.a("fb_dialogs_web_login_dialog_complete", bundle, true);
    }
