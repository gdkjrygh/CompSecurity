...
public final class OnGestureListener extends android.view.eOnGestureListener
{
    ...
    public final boolean onFling(MotionEvent motionevent, MotionEvent motionevent1, float f, float f1)
    {
        ...
        a.getListView().smoothScrollBy(-i, (int)(l * 2L));
        return true;
    }

    public final boolean onScroll(MotionEvent motionevent, MotionEvent motionevent1, float f, float f1)
    {
        a.getListView().smoothScrollBy((int)f1, 0);
        return true;
    }

    public OnGestureListener(AppboyFeedFragment appboyfeedfragment)
    {
