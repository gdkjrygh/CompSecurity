...
public class AppboyWebViewActivity extends AppboyBaseActivity
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        setContentView(n.d.com_appboy_webview_activity);
        setProgressBarVisibility(true);
        bundle = (WebView)findViewById(n.c.com_appboy_webview_activity_webview);
        ...
        bundle.setWebChromeClient(new l(this));
        bundle.setDownloadListener(new m(this));
