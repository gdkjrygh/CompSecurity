...
public class Request
{
    ...
    private void e()
    {
        CSLog.e(this, (new StringBuilder("Measurement was not transmitted: ")).append(c.retrieveLabelsAsString(d.getMeasurementLabelOrder())).toString());
    ...
    protected HttpURLConnection a(URL url)
    {
        if (b != null)
        {
            url = (HttpURLConnection)url.openConnection(b);
        } else
        {
...
_L5:
        ...
        obj = null;
_L11:
        CSLog.e(this, (new StringBuilder("Exception sending measurement:")).append(((Exception) (obj1)).getLocalizedMessage()).toString());
