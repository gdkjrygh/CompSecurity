...
public class StreamSensePlaylist
{
    ...
    {
        CSLog.d(this, (new StringBuilder("addPlaybackTime(")).append(l).append(")").toString());
        if (a.getPlaybackTimestamp() >= 0L)
        {
            ...
            a.b(a.f() + l1);
            d(d() + l1);
            CSLog.d(this, (new StringBuilder("addPlaybackTime(")).append(l).append(") ->").append(l1).toString());
        }
    }
    ...
    {
        CSLog.d(this, (new StringBuilder("addBufferingTime(")).append(l).append(")").toString());
        if (a.g() >= 0L)
        {
            long l1 = l - a.g();
            a.d(-1L);
            a.a(a.e() + l1);
            c(c() + l1);
            CSLog.d(this, (new StringBuilder("addBufferingTime(")).append(l).append(") ->").append(l1).toString());
        }
    }
