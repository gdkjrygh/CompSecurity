...
public class StreamSenseVideoView extends VideoView
{
    ...
    private void a(HashMap hashmap)
    {
        ...
        if (l == null)
        {
            ...
            CSLog.d("StreamSenseVideoView", (new StringBuilder("startStartTimer:")).append(l1).toString());
            l = new Timer();
...
_L3:
    ...
    {
        super.seekTo(i1);
        CSLog.d("StreamSenseVideoView", (new StringBuilder("seekTo:")).append(i1).toString());
        if (a())
        {
            f();
            d();
