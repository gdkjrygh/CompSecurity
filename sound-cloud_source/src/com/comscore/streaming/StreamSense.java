...
public class StreamSense
{
    ...
    private HashMap a(StreamSenseEventType streamsenseeventtype, HashMap hashmap)
    {
        ...
        CSLog.d(this, (new StringBuilder("createMeasurementLabels(")).append(streamsenseeventtype).append(")").toString());
        ...
        hashmap1.put("ns_st_sv", "4.1508.28");
        return hashmap1;
    }
    ...
    private void a(StreamSenseState streamsensestate, HashMap hashmap)
    {
        ...
        if (a.isEnabled())
        {
            CSLog.d(this, (new StringBuilder("transitionTo(")).append(streamsensestate).append(", ").append(hashmap).append(")").toString());
            l();
    ...
    private void a(StreamSenseState streamsensestate, HashMap hashmap, long l1)
    {
        ...
        {
            CSLog.d(this, (new StringBuilder("transitionTo(")).append(streamsensestate).append(", ").append(hashmap).append(", ").append(l1).append(")").toString());
            l();
...
_L3:
    ...
    private void b(StreamSenseState streamsensestate, HashMap hashmap)
    {
        if (a.isEnabled())
        {
            CSLog.d(this, (new StringBuilder("onExit(")).append(streamsensestate).append(", ").append(hashmap).append(")").toString());
            long l1 = f(hashmap);
...
_L2:
        long l1;
        CSLog.d(this, (new StringBuilder("onEnter(")).append(streamsensestate).append(", ").append(hashmap).append(")").toString());
        l1 = f(hashmap);
        e = e(hashmap);
        if (streamsensestate != StreamSenseState.PLAYING)
        {
...
_L6:
    ...
    private void d()
    {
        if (a.isEnabled())
        {
            ...
            if (w != null)
            {
                ...
                {
                    l1 = n;
                    CSLog.d(this, (new StringBuilder("Resuming heart beat timer. Next event in ")).append(l1).append(" ms").toString());
                } else
                {
                    l1 = a(h.getClip().f());
                    CSLog.d(this, (new StringBuilder("Starting heart beat timer. Next event in ")).append(l1).append(" ms").toString());
                }
                if (l1 > 0L)
                {
    ...
    protected void a(HashMap hashmap, boolean flag)
    {
        if (a.isEnabled())
        {
            CSLog.d(this, (new StringBuilder("dispatch(")).append(hashmap).append(", ").append(flag).append(")").toString());
            if (flag)
            {
                d(hashmap);
            }
    ...
    public void notify(StreamSenseEventType streamsenseeventtype, HashMap hashmap, long l1)
    {
        ...
        CSLog.d(this, (new StringBuilder("notify(")).append(streamsenseeventtype).append(", ").append(hashmap).append(")").toString());
