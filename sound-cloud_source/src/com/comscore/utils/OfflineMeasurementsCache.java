...
public class OfflineMeasurementsCache
{
    ...
    private boolean a(String s, String s1)
    {
        ...
        CSLog.d(this, (new StringBuilder("Response:")).append(i1).toString());
        ...
        break MISSING_BLOCK_LABEL_164;
        s;
        CSLog.e(this, s.getMessage());
        a.allowOfflineTransmission(TransmissionMode.DISABLED, true);
        clear();
_L2:
        return false;
        s;
        CSLog.e(this, (new StringBuilder("Exception in flush:")).append(s.getLocalizedMessage()).toString());
...
label1:
            ...
            CSLog.d(this, (new StringBuilder("Max flushes in a row (")).append(d).append(") reached. Waiting ").append((double)l1 / 1000D / 60D).append(" minutes").toString());
        }
        return false;
    }
...
_L2:
        ...
        flag1 = flag;
        CSLog.d(this, (new StringBuilder("Valid timestamp found: ")).append(l1).toString());
        flag1 = flag;
        NumberFormatException numberformatexception;
        if (!flag1)
        {
            CSLog.d(this, (new StringBuilder("All events in the file ")).append(s).append(" are expired").toString());
            a(s, true);
            return null;
        } else
        {
...
_L1:
    ...
    private void e()
    {
        ...
        for (int i1 = list.size() - 1; i1 >= 0; i1--)
        {
            ...
            {
                CSLog.d(this, (new StringBuilder("Deleting expired cache file ")).append((String)list.get(i1)).toString());
...
_L3:
        Object obj = null;
        CSLog.d(this, (new StringBuilder("Cache is not empty, contains ")).append(i.size()).append(" files").toString());
        if (j != null) goto _L5; else goto _L4
_L4:
        String s;
        String as[];
        s = h();
        CSLog.d(this, (new StringBuilder("reading events from the file ")).append(s).toString());
        as = d(s);
        obj = s;
...
_L8:
        ...
        l = Date.unixTime();
          goto _L1
        CSLog.d(this, (new StringBuilder("Waiting ")).append((double)l1 / 1000D / 60D).append(" minutes").toString());
          goto _L1
    }
    ...
    public void saveEvent(Measurement measurement, boolean flag)
    {
        ...
        if (flag)
        {
            a.getTaskExecutor().execute(new c(this, measurement), true);
            return;
        } else
        {
...
_L3:
        ...
        {
            CSLog.d(this, (new StringBuilder("reached the cache max (")).append(getCacheMaxMeasurements()).append(") size").toString());
            a(g(), true);
        }
        b(s);
          goto _L1
