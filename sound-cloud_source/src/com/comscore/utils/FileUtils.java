...
public class FileUtils
{
    ...
    public static boolean deleteFile(Core core, String s)
    {
        ...
        if (flag)
        {
            CSLog.d(com/comscore/utils/FileUtils, (new StringBuilder("File")).append(s).append(" was removed").toString());
            core.remove(s);
        }
        return flag;
    }
...
_L2:
        ...
        s;
        obj = core;
        CSLog.e(com/comscore/utils/FileUtils, (new StringBuilder("Exception in writeEvent:")).append(s.getLocalizedMessage()).toString());
        obj = core;
        CSLog.printStackTrace(s);
