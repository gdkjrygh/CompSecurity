...
public class InstallReferrerReceiver extends BroadcastReceiver
{
    ...
    public static HashMap retrieveReferrerLabels(Context context)
    {
        ...
        if (((SharedPreferences) (obj)).contains("CS_REFERRER_PREF_KEY"))
        {
            ...
            CSLog.d(comScore.getAppName().toString(), (new StringBuilder("referrer was set as: '")).append(((String) (obj))).append("'").toString());
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        {
            CSLog.e("InstallReferrerReceiver", (new StringBuilder("onReceive()")).append(intent.getMessage()).toString());
            s1 = s;
        }
label0:
        {
            CSLog.d("InstallReferrerReceiver", (new StringBuilder("Received referrer: '")).append(s1).append("'").toString());
            if (s1 != "CS_NONE")
            {
